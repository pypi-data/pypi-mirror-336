...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetIncidentTaskResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, GetIncidentTaskResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Incident Task
     ...
     Get a specific incident task.

    Args:
        curated_incident_task_id (str): Start typing the task number to search for the task
            information.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, GetIncidentTaskResponse]
    """
