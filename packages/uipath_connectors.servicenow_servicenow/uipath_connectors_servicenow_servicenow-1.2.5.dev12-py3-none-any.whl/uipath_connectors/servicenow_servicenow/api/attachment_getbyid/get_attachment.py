...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/attachment_GETBYID/{id}".format(
            id=id,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetAttachmentResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, GetAttachmentResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Get Attachment
     ...
     Returns existing attachment metadata from a record

    Args:
        id (str): Select the sys_ID to retrieve an attachment
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, GetAttachmentResponse]
    """
