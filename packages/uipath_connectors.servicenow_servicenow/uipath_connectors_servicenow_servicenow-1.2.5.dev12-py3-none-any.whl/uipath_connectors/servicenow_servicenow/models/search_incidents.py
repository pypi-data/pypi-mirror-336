...
class SearchIncidents(BaseModel):
    """
    Attributes:
        ...
        impact (Optional[str]): The extent to which resolution of an incident can bear delay Example: 1.
        ...
        state (Optional[str]): Status of the incident
        sys_id (Optional[str]): The ID of incident. Example: 005d500b536073005e0addeeff7b12f4.
        urgency (Optional[str]): The extent to which resolution of an incident can bear delay Example: 1.
    """
    ...
    impact: Optional[str] = Field(alias="impact", default=None)
    ...
    urgency: Optional[str] = Field(alias="urgency", default=None)

    def to_dict(self) -> Dict[str, Any]:
        return self.model_dump(exclude_none=True, by_alias=True)

    @classmethod
    def from_dict(cls: Type["SearchIncidents"], src_dict: Dict[str, Any]):
