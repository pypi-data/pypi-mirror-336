...
from dtpyutils.exception import RequestException
...
class Bucket:
    ...
    def url_generator(self, key: str):
        if self.__s3_mode:
    ...
    def upload(self, file: bytes, key: str, content_type: str, cache_control='no-cache'):
        try:
    ...
    def download_fileobj(self, key: str, file):
        try:
    ...
    def upload_by_path(self, file_path: str, key: str, content_type: str | None = None, cache_control='no-cache'):
        try:
    ...
    def duplicate(self, source_key: str, destination_key: str, cache_control='no-cache'):
        try:
    ...
    def safe_duplicate(self, source_key: str, cache_control='no-cache'):
        try:
