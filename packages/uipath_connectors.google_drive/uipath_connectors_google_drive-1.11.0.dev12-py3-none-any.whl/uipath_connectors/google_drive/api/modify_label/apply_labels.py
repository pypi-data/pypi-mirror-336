...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/ModifyLabel/{file_id}".format(
            file_id=file_id,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ApplyLabelsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ApplyLabelsResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Apply Labels
     ...
     Applies label to the selected file

    Args:
        file_id (str): The File for which labels needs to be added
        body (ApplyLabelsRequest):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[ApplyLabelsResponse, DefaultError]
    """
