...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/RemoveLabels//{file_id}".format(
            file_id=file_id,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = RemoveLabelsResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, RemoveLabelsResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, RemoveLabelsResponse]
    """
