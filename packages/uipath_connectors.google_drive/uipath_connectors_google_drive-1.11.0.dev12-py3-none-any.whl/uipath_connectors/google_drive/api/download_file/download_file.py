...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/hubs/general/download_file",
        "params": params,
    }
...
def sync_detailed(
    *,
    ...
    Args:
        mime_type (Optional[str]): Download document as
        file_id (str): File to download
        file_name (Optional[str]): provide name of the file with extension to override the
            original file name to saveAs
