...
class CommonV1ObjectMeta(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "workspace", "comment", "annotations", "createdTimestamp", "createdBy", "modifiedTimestamp", "lastSuccessfulRunTimestamp", "modifiedBy", "version", "deleted", "resourceStatus", "uiStatus"]
