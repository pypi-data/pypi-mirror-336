...
class WorkspaceV1ExportConfigJiraConfig(BaseModel):
    ...
    summary: Optional[StrictStr] = Field(default=None, description="Spark SQL expression used to compute the title of the Jira tickets to be raised. The description of the ticket will contain the JSON-serialized notable or operational alert. ")
