            ...
            return WorkspaceV1WorkspaceConfigSpec(
                ...
                notable_export = dasl_api.models.workspace/v1/export_config.workspace.v1.ExportConfig(
                    ...
                    slack_config = dasl_api.models.workspace_v1_export_config_slack_config.workspace_v1_ExportConfig_slackConfig(
                        token = dasl_api.models.workspace_v1_export_config_webhook_config_destination.workspace_v1_ExportConfig_webhookConfig_destination(
                            value = '', 
                            scope = '', 
                            key = '', ), 
                        channel = '', 
                ...
                compute_group_limits = [
                    dasl_api.models.workspace_v1_workspace_config_spec_compute_group_limits_inner.workspace_v1_WorkspaceConfigSpec_computeGroupLimits_inner(
                        group_name = '', 
                        limit = 56, )
                    ],
                dasl_storage_path = '',
