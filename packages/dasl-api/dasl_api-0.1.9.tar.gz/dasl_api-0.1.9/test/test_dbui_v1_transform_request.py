    ...
    def make_instance(self, include_optional) -> DbuiV1TransformRequest:
        ...
        if include_optional:
            return DbuiV1TransformRequest(
                input = dasl_api.models.dbui_v1_transform_request_input.dbui_v1_TransformRequest_input(
                    columns = [
                ...
                autoloader_input = dasl_api.models.core/v1/data_source_autoloader_spec.core.v1.DataSourceAutoloaderSpec(
                    format = '', 
                    location = '', 
                    schema_file = '', 
