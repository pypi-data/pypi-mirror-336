...
class TestCoreV1DataSourceSpecGoldPresetOverridesAddTablesInner(unittest.TestCase):
    """CoreV1DataSourceSpecGoldPresetOverridesAddTablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1DataSourceSpecGoldPresetOverridesAddTablesInner:
        """Test CoreV1DataSourceSpecGoldPresetOverridesAddTablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1DataSourceSpecGoldPresetOverridesAddTablesInner`
        """
        model = CoreV1DataSourceSpecGoldPresetOverridesAddTablesInner()
        if include_optional:
    ...
    def testCoreV1DataSourceSpecGoldPresetOverridesAddTablesInner(self):
        """Test CoreV1DataSourceSpecGoldPresetOverridesAddTablesInner"""
