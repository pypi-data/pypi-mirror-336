...
class TestCoreV1DataSourceSpecSilverTransformPresetOverrides(unittest.TestCase):
    """CoreV1DataSourceSpecSilverTransformPresetOverrides unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1DataSourceSpecSilverTransformPresetOverrides:
        """Test CoreV1DataSourceSpecSilverTransformPresetOverrides
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1DataSourceSpecSilverTransformPresetOverrides`
        """
        model = CoreV1DataSourceSpecSilverTransformPresetOverrides()
        if include_optional:
    ...
    def testCoreV1DataSourceSpecSilverTransformPresetOverrides(self):
        """Test CoreV1DataSourceSpecSilverTransformPresetOverrides"""
