...
class TestCoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(unittest.TestCase):
    """CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner:
        """Test CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner`
        """
        model = CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner()
        if include_optional:
    ...
    def testCoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner(self):
        """Test CoreV1DataSourceSpecSilverTransformPresetOverridesAddTablesInner"""
