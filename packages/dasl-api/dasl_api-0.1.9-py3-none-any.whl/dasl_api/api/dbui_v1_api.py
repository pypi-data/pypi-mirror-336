...
class DbuiV1Api:
    ...
    def dbui_v1_autoloader_preview(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DbuiV1AutoloaderPreviewResponse",
            '400': "InvalidRequestError",
            '401': "UnauthorizedError",
            '403': "ForbiddenError",
            '404': "ResourceNotFoundError",
    ...
    def dbui_v1_autoloader_preview_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DbuiV1AutoloaderPreviewResponse]:
        """dbui_v1_autoloader_preview
    ...
    def dbui_v1_get_data_source_summary(
        ...
        rollup_metrics: Annotated[Optional[StrictBool], Field(description="Whether to query for rollup metrics (across all data sources).")] = None,
        ...
        Get a summary of active data sources.

        :param workspace: The name of the workspace. (required)
        :type workspace: str
        :param metrics: Whether to query for metrics or not.
        :type metrics: bool
        :param rollup_metrics: Whether to query for rollup metrics (across all data sources).
    ...
    def dbui_v1_transform_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DbuiV1TransformResponse]:
        """dbui_v1_transform
