...
class DbuiV1TransformRequestTransformsInner(BaseModel):
    ...
    use_pre_transform_preset: Optional[StrictStr] = Field(default=None, description="Indicates which pre-transform preset to use if requested. Only present if transformType is SilverPreTransform", alias="usePreTransformPreset")
    ...
    __properties: ClassVar[List[str]] = ["transformType", "usePreTransformPreset", "usePresetTable", "filter", "postFilter", "presetOverrides", "addFields", "utils"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if use_pre_transform_preset (nullable) is None
        # and model_fields_set contains the field
        if self.use_pre_transform_preset is None and "use_pre_transform_preset" in self.model_fields_set:
            _dict['usePreTransformPreset'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "usePreTransformPreset": obj.get("usePreTransformPreset"),
