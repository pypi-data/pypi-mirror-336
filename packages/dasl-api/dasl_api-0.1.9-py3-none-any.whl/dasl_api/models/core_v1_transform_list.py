...
class CoreV1TransformList(BaseModel):
    """
    The response for GET rules containing a detailed list of transforms in  the account. 
    """ # noqa: E501
    ...
    items: List[CoreV1Transform] = Field(description="A list of Transform")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1TransformList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1TransformList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "items": [CoreV1Transform.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
