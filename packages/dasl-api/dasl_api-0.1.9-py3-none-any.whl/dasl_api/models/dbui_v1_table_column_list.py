...
class DbuiV1TableColumnList(BaseModel):
    """
    DbuiV1TableColumnList
    """ # noqa: E501
    columns: Optional[List[DbuiV1TableColumnDetails]] = Field(default=None, description="List of column names.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DbuiV1TableColumnList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DbuiV1TableColumnList from a dict"""
        if obj is None:
            return None
