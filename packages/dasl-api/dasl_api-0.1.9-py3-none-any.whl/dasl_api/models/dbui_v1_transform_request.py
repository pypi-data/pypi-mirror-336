...
class DbuiV1TransformRequest(BaseModel):
    ...
    autoloader_input: Optional[CoreV1DataSourceAutoloaderSpec] = Field(default=None, alias="autoloaderInput")
    ...
    __properties: ClassVar[List[str]] = ["input", "autoloaderInput", "usePreset", "transforms"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "autoloaderInput": CoreV1DataSourceAutoloaderSpec.from_dict(obj["autoloaderInput"]) if obj.get("autoloaderInput") is not None else None,
