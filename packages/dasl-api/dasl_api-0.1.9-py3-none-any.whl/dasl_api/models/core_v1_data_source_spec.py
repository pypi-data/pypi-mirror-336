...
class CoreV1DataSourceSpec(BaseModel):
    ...
    use_preset: Optional[StrictStr] = Field(default=None, description="The name of the preset to use for this data source. ", alias="usePreset")
    ...
    __properties: ClassVar[List[str]] = ["source", "sourceType", "schedule", "custom", "usePreset", "autoloader", "bronze", "silver", "gold"]
