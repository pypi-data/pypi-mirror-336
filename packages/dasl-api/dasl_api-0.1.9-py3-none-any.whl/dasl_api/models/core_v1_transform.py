...
class CoreV1Transform(BaseModel):
    ...
    spec: CoreV1TransformSpec = Field(description="The desired configuration of this Transform.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CoreV1Transform from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CoreV1Transform from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "spec": CoreV1TransformSpec.from_dict(obj["spec"]) if obj.get("spec") is not None else None,
