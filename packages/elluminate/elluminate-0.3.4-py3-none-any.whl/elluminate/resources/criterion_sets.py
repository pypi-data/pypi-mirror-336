...
class CriterionSetsResource(BaseResource):
    ...
    @retry_request
    async def acreate(
        self, name: str, prompt_template: PromptTemplate | None = None, criteria: List[str] | None = None
    ) -> CriterionSet:
        """Async version of create."""
        # Create the criterion set without a prompt template
    ...
    def create(
        ...
        Args:
            ...
            criteria (List[str], optional): List of criterion strings to create alongside the criterion set.
    ...
    async def aget_or_create(
        self, name: str, prompt_template: PromptTemplate, criteria: List[str] | None = None
