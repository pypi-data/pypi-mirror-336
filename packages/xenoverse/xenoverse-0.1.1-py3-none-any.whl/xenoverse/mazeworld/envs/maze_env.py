...
from xenoverse.mazeworld.envs.maze_continuous_3d import MazeCoreContinuous3D
from xenoverse.mazeworld.envs.dynamics import DEFAULT_ACTION_SPACE_16, DEFAULT_ACTION_SPACE_32
