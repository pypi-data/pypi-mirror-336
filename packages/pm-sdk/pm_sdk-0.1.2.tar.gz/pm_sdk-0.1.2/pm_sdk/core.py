...
class PM:
    ...
    @classmethod
    def Init(cls, photometrica_path=None, port=8080, useGui=False):
        ...
        with cls._lock:
            ...
            if photometrica_path is None:
                photometrica_path = r"C:\Program Files\Westboro Photonics\Photometrica81"
...
class SDK_Helper:
    ...
    def DecodeString(binary):
        ...
        return binary[4:4+length].decode('utf-8')
...
class SDK:
    ...
    @staticmethod
    def AddDataTableFromObjectTable(object_type, new_name, options):
        binary_payload = b""
    ...
    @staticmethod
    def CalculateSpectrumProperty(x, y, z, property_name):
        binary_payload = b""
    ...
    @staticmethod
    def GetMeasurementData(data_length, measurement_name):
        binary_payload = b""
        binary_payload += SDK_Helper.EncodeInt(data_length)
        binary_payload += SDK_Helper.EncodeString(measurement_name)
    ...
    @staticmethod
    def RunNamedScript(script_name):
        binary_payload = b""
        binary_payload += SDK_Helper.EncodeString(script_name)
