...
class TestAdminContact(unittest.TestCase):
    """AdminContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminContact:
        """Test AdminContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AdminContact`
        """
        model = AdminContact()
        if include_optional:
            return AdminContact(
