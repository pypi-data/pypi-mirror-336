...
class TestAbuseContact(unittest.TestCase):
    """AbuseContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbuseContact:
        """Test AbuseContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbuseContact`
        """
        model = AbuseContact()
        if include_optional:
            return AbuseContact(
