...
class TestAnalyzeEmail200Response(unittest.TestCase):
    """AnalyzeEmail200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeEmail200Response:
        """Test AnalyzeEmail200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeEmail200Response`
        """
        model = AnalyzeEmail200Response()
        if include_optional:
            return AnalyzeEmail200Response(
                email_address = 'some-email@domain.com',
                email_provider = 'Google',
                email_type = 'free',
                is_format_valid = True,
                email_correction = 'some-email@domain.com',
                is_deliverable = True,
                is_catch_all = False,
                is_reachable = True,
                email_dns = openapi_client.models.email_dns.EmailDNS(
    ...
    def testAnalyzeEmail200Response(self):
        """Test AnalyzeEmail200Response"""
