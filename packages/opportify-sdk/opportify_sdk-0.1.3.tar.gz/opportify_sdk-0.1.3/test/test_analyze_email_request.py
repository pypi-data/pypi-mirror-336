...
class TestAnalyzeEmailRequest(unittest.TestCase):
    """AnalyzeEmailRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeEmailRequest:
        """Test AnalyzeEmailRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeEmailRequest`
        """
        model = AnalyzeEmailRequest()
        if include_optional:
    ...
    def testAnalyzeEmailRequest(self):
        """Test AnalyzeEmailRequest"""
