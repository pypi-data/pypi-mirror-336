...
class TestMALFORMEDREQUEST1(unittest.TestCase):
    """MALFORMEDREQUEST1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MALFORMEDREQUEST1:
        """Test MALFORMEDREQUEST1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MALFORMEDREQUEST1`
        """
        model = MALFORMEDREQUEST1()
        if include_optional:
            return MALFORMEDREQUEST1(
    ...
    def testMALFORMEDREQUEST1(self):
        """Test MALFORMEDREQUEST1"""
