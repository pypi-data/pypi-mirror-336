...
class TestTrustedProvider(unittest.TestCase):
    """TrustedProvider unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TrustedProvider:
        """Test TrustedProvider
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TrustedProvider`
        """
        model = TrustedProvider()
        if include_optional:
