...
class TestTechContact(unittest.TestCase):
    """TechContact unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TechContact:
        """Test TechContact
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TechContact`
        """
        model = TechContact()
        if include_optional:
            return TechContact(
