...
class TestBlockListed(unittest.TestCase):
    """BlockListed unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BlockListed:
        """Test BlockListed
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BlockListed`
        """
        model = BlockListed()
        if include_optional:
            return BlockListed(
