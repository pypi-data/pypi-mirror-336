...
class TestAnalyzeIp400ResponseError(unittest.TestCase):
    """AnalyzeIp400ResponseError unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AnalyzeIp400ResponseError:
        """Test AnalyzeIp400ResponseError
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalyzeIp400ResponseError`
        """
        model = AnalyzeIp400ResponseError()
        if include_optional:
            return AnalyzeIp400ResponseError(
                message = 'The JSON request doesn’t seem to be correct or valid.',
    ...
    def testAnalyzeIp400ResponseError(self):
        """Test AnalyzeIp400ResponseError"""
