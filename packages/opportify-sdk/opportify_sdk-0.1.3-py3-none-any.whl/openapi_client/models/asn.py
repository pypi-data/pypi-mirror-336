...
class Asn(BaseModel):
    ...
    """ # noqa: E501
    asn_id: Optional[StrictStr] = Field(default=None, description="ASN identifier.", alias="asnId")
    as_name: Optional[StrictStr] = Field(default=None, description="ASN name.", alias="asName")
    descr: Optional[List[StrictStr]] = Field(default=None, description="ASN description. It might return different values based on the data source. Some provide ownership, address, others provide a more abstract description. Our system tries to sanitize removing visual blocks special characters (+++, ---, ...).")
    ...
    __properties: ClassVar[List[str]] = ["asnId", "asName", "descr", "email"]
