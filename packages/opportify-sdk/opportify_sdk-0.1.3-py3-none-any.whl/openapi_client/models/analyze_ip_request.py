...
class AnalyzeIpRequest(BaseModel):
    ...
    AnalyzeIpRequest
    """ # noqa: E501
    ip: StrictStr = Field(description="The IPv4 or IPv6 address to analyze.")
    enable_ai: Optional[StrictBool] = Field(default=None, description="Enable AI-driven analysis for the IP address. Default is `false`.", alias="enableAI")
    __properties: ClassVar[List[str]] = ["ip", "enableAI"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalyzeIpRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalyzeIpRequest from a dict"""
        if obj is None:
            return None
