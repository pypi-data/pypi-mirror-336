...
from planqk.commons.openapi.template import get_template_managed_service, OpenApiVersion
...
def generate_openapi(entrypoint: str = os.environ.get(ENTRYPOINT_ENV, DEFAULT_ENTRYPOINT),
                     ...
                     version: str = "1",
                     openapi_version: OpenApiVersion = OpenApiVersion.V3_0_0) -> None:
    """
    ...
    :param openapi_version: The version of the OpenAPI specification, defaults to OpenApiVersion.V3_0_0
    :return:
    """
    ...
    openapi_template = get_template_managed_service(openapi_version)
