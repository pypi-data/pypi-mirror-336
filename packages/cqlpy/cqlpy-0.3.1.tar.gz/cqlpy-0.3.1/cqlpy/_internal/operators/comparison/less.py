...
def less(left, right) -> Boolean:
    ...
    [Specification](http://cql.hl7.org/09-b-cqlreference.html#less)
    ...
    True if the left argument is less than the right argument, False
    otherwise.

    ## Usage

    ```python
    less(Integer(1), Integer(2))  # True
    ```
    """
