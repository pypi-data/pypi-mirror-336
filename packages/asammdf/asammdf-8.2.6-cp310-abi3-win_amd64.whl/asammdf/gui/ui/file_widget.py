...
class Ui_file_widget(object):
    def setupUi(self, file_widget):
        ...
        self.channels_layout.setSpacing(1)
        ...
        self.raster_channel.setInsertPolicy(QComboBox.InsertPolicy.InsertAtBottom)
        self.raster_channel.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToMinimumContentsLengthWithIcon)
