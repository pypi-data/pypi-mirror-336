...
class Mat3:
	...
	def Rotation(axis: Vec3, angle: float) -> 'Mat3':
		...
		return Mat3(
			...
			Vec3(t*y*x + s*z, t*y*y + c, t*y*z - s*x),
			Vec3(t*z*x - s*y, t*z*y + s*x, t*z*z + c)
		)
...
Vec4.WAxis = Vec4(0, 0, 0, 1)
Vec4.Origin = Vec4(0, 0, 0, 1)
Vec4.One = Vec4(1, 1, 1, 1)

Mat2.Zero = Mat2(Vec2.Zero, Vec2.Zero)
Mat2.Identity = Mat2(Vec2.XAxis, Vec2.YAxis)
Mat2.One = Mat2(Vec2.One, Vec2.One)

Mat3.Zero = Mat3(Vec3.Zero, Vec3.Zero, Vec3.Zero)
Mat3.Identity = Mat3(Vec3.XAxis, Vec3.YAxis, Vec3.ZAxis)
Mat3.One = Mat3(Vec3.One, Vec3.One, Vec3.One)

Mat4.Zero = Mat4(Vec4.Zero, Vec4.Zero, Vec4.Zero, Vec4.Zero)
Mat4.Identity = Mat4(Vec4.XAxis, Vec4.YAxis, Vec4.ZAxis, Vec4.WAxis)
Mat4.One = Mat4(Vec4.One, Vec4.One, Vec4.One, Vec4.One)
