...
from ..models.post_routines_request_set_type import PostRoutinesRequestSetType
from ..types import UNSET, Unset

T = TypeVar("T", bound="PostRoutinesRequestSet")


@_attrs_define
class PostRoutinesRequestSet:
    """
    Attributes:
        type_ (Union[Unset, PostRoutinesRequestSetType]): The type of the set. Example: normal.
    ...
    type_: Union[Unset, PostRoutinesRequestSetType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        type_: Union[Unset, PostRoutinesRequestSetType]
        if isinstance(_type_, Unset):
            type_ = UNSET
        else:
            type_ = PostRoutinesRequestSetType(_type_)
        ...
        post_routines_request_set.additional_properties = d
        return post_routines_request_set
