...
T = TypeVar("T", bound="WorkoutExercisesItemSetsItem")


@_attrs_define
class WorkoutExercisesItemSetsItem:
    """
    Attributes:
        index (Union[Unset, float]): Index indicating the order of the set in the workout.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workout_exercises_item_sets_item = cls(
            index=index,
            type_=type_,
            weight_kg=weight_kg,
            reps=reps,
        ...
        workout_exercises_item_sets_item.additional_properties = d
        return workout_exercises_item_sets_item
