...
if TYPE_CHECKING:
    from ..models.routine_exercises_item_sets_item import RoutineExercisesItemSetsItem


T = TypeVar("T", bound="RoutineExercisesItem")


@_attrs_define
class RoutineExercisesItem:
    """
    Attributes:
        index (Union[Unset, float]): Index indicating the order of the exercise in the routine.
        title (Union[Unset, str]): Title of the exercise Example: Bench Press (Barbell).
        notes (Union[Unset, str]): Routine notes on the exercise Example: Focus on form. Go down to 90 degrees..
        ...
        sets (Union[Unset, list['RoutineExercisesItemSetsItem']]):
    """
    ...
    sets: Union[Unset, list["RoutineExercisesItemSetsItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sets_item_data in _sets or []:
            sets_item = RoutineExercisesItemSetsItem.from_dict(sets_item_data)

            sets.append(sets_item)

        routine_exercises_item = cls(
            index=index,
            title=title,
            notes=notes,
        ...
        routine_exercises_item.additional_properties = d
        return routine_exercises_item
