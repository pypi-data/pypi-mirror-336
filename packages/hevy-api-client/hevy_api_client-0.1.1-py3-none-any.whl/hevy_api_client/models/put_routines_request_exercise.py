...
if TYPE_CHECKING:
    from ..models.put_routines_request_set import PutRoutinesRequestSet


T = TypeVar("T", bound="PutRoutinesRequestExercise")


@_attrs_define
class PutRoutinesRequestExercise:
    """
    Attributes:
        ...
        sets (Union[Unset, list['PutRoutinesRequestSet']]):
    """
    ...
    sets: Union[Unset, list["PutRoutinesRequestSet"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for sets_item_data in _sets or []:
            sets_item = PutRoutinesRequestSet.from_dict(sets_item_data)

            sets.append(sets_item)

        put_routines_request_exercise = cls(
        ...
        put_routines_request_exercise.additional_properties = d
        return put_routines_request_exercise
