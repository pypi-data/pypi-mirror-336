...
from ._stringcase import camelcase
from ._stringcase import pascalcase
from ._stringcase import snakecase

VarMakerStrategy = namedtuple("VarMakerStrategy", "case_func,special_replacer")

_case_map = {
    "snake": VarMakerStrategy(snakecase, "_"),
    "pascal": VarMakerStrategy(pascalcase, ""),
    "camel": VarMakerStrategy(camelcase, ""),
}
