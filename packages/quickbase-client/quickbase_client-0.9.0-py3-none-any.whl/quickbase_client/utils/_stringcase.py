...
This file is copied from https://github.com/okunishinishi/python-stringcase,
with license at
https://github.com/okunishinishi/python-stringcase/tree/master?tab=MIT-1-ov-file
