...
if isprop(fig, "BorderColor");      fig.BorderColor      = BACKGROUND_COLOR;   end
...
if isprop(fig, "EdgeColor") && ...
   isequal(class(fig), 'matlab.graphics.primitive.Text') == false        
                                    fig.EdgeColor        = AXES_COLOR;         end
...
if isprop(fig, "Interpreter"); fig.Interpreter           = 'latex';            end
