...
class MidSlabCreateInfo:
    ...
    def SetSurroundNodes(self, _nodes: PyList, relativeH: int) -> MidSlabCreateInfo: ...
    def SetSurroundNodes(self, nodes: list[Mdl_Joint], relativeH: int) -> MidSlabCreateInfo: ...
    def SetSurroundGrids(self, _grids: PyList) -> MidSlabCreateInfo: ...
...
class SkinCreateInfo:
    ...
    def SetDirection(self, _dir: PyList) -> SkinCreateInfo: ...
    ...
    def SetSurroundPt(self, _joints: PyList) -> SkinCreateInfo: ...
...
class DataFunc:
    ...
    def column_arrange(self, _nodelist: PyList, ColSect: Mdl_ColSect, EccX: int = 0, EccY: int = 0, Rotation: float = 0.0, HDiffB: int = 0) -> PyList: ...
    ...
    def load_arrange(self, _member_list: PyList, loadsect: Mdl_LoadSect, type: int = 1) -> None: ...
    ...
    def add_group(self, Name: str, _nID: PyList, _idNewZRC: PyList) -> None: ...
    ...
    def Test_List(self, input: PyList) -> list[int]: ...
    def Test_List01(self) -> PyList: ...
    @staticmethod
    def PyListToCSharpList(pyList: PyList) -> list[T]: ...
    @staticmethod
    def PyListToCSharpList2nd(pyList: PyList) -> list[list[T]]: ...
    @staticmethod
    def ConvertCSharpListToPythonList(csharpList: Any) -> PyList: ...
    ...
    def node_generate(self, _xspans: PyList, _yspans: PyList, bzc: Mdl_StdFlr, Eon: int = 0) -> PyList: ...
    def node_generate(self, xspans: list[int], yspans: list[int], bzc: Mdl_StdFlr, Eon: int = 0) -> list[list[Mdl_Joint]]: ...
    def merge_nodelist(self, _nodelist1: PyList, _nodelist2: PyList) -> PyList: ...
    ...
    def grid_generate(self, _nodelist: PyList, direct_x: int, direct_y: int) -> PyList: ...
    ...
    def beam_arrange(self, _gridlist: PyList, BeamSect: Mdl_BeamSect, Ecc: int = 0, HDiff1: int = 0, HDiff2: int = 0, Rotation: float = 0.0) -> PyList: ...
    ...
    def wall_arrange(self, _gridlist: PyList, WallSect: Mdl_WallSect, Ecc: int = 0, HDiff1: int = 0, HDiff2: int = 0, HDiffB: int = 0, sloping: int = 0, EccDown: int = 0, offset1: int = 0, offset2: int = 0) -> PyList: ...
    ...
    def wallhole_arrange(self, _gridlist: PyList, defwindow: Mdl_WallHoleDef, Ecc: float = 0.0, HDiff: float = 0.0) -> PyList: ...
    ...
    def brace_arrange(self, _nodelist: PyList, BraceSect: Mdl_BraceSect, EccX1: int = 0, EccY1: int = 0, HDiff1: int = 1, EccX2: int = 0, EccY2: int = 0, HDiff2: int = 1, Rotation: float = 0.0) -> PyList: ...
...
class Link2YJK:
    ...
    def LinkPrepare(self, unionID: int) -> None: ...
