...
class LocalTileServer(TileServer):
    ...
    def __init__(self,
        ...
        origins = [
            f'http://{self.host}',
            f'http://{self.host}:{self.tile_server_port}',
            f'http://{self.host}:{self.tile_server_port-10}',
            f'https://{self.host}',
            f'https://{self.host}:{self.tile_server_port}',
            f'https://{self.host}:{self.tile_server_port-10}',
        ]
        print(origins)
