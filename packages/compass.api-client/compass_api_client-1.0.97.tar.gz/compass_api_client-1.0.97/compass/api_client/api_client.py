...
from compass.api_client.api_response import ApiResponse, T as ApiResponseT
import compass.api_client.models
from compass.api_client import rest
from compass.api_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'OpenAPI-Generator/1.0.97/python'
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(compass.api_client.models, klass)
