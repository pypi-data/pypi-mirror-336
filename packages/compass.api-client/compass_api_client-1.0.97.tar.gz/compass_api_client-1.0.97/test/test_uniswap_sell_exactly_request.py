...
class TestUniswapSellExactlyRequest(unittest.TestCase):
    """UniswapSellExactlyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapSellExactlyRequest:
        """Test UniswapSellExactlyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapSellExactlyRequest`
        """
    ...
    def testUniswapSellExactlyRequest(self):
        """Test UniswapSellExactlyRequest"""
