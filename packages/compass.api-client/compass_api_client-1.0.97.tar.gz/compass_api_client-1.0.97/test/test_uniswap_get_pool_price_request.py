...
class TestUniswapGetPoolPriceRequest(unittest.TestCase):
    """UniswapGetPoolPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapGetPoolPriceRequest:
        """Test UniswapGetPoolPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapGetPoolPriceRequest`
        """
    ...
    def testUniswapGetPoolPriceRequest(self):
        """Test UniswapGetPoolPriceRequest"""
