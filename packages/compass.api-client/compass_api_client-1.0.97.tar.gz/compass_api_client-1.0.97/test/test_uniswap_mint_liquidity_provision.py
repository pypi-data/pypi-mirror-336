...
class TestUniswapMintLiquidityProvision(unittest.TestCase):
    """UniswapMintLiquidityProvision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapMintLiquidityProvision:
        """Test UniswapMintLiquidityProvision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapMintLiquidityProvision`
        """
        model = UniswapMintLiquidityProvision()
        if include_optional:
            return UniswapMintLiquidityProvision(
    ...
    def testUniswapMintLiquidityProvision(self):
        """Test UniswapMintLiquidityProvision"""
