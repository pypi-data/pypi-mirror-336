...
class AerodromeSlipstreamMintLiquidityProvisionCallData(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["token0", "token1", "tick_spacing", "tick_lower", "tick_upper", "amount0_desired", "amount1_desired", "amount0_min", "amount1_min", "recipient"]
