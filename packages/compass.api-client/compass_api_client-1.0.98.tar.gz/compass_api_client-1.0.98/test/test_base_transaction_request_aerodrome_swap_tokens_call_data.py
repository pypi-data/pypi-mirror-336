...
class TestBaseTransactionRequestAerodromeSwapTokensCallData(unittest.TestCase):
    """BaseTransactionRequestAerodromeSwapTokensCallData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BaseTransactionRequestAerodromeSwapTokensCallData:
        """Test BaseTransactionRequestAerodromeSwapTokensCallData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseTransactionRequestAerodromeSwapTokensCallData`
        """
    ...
    def testBaseTransactionRequestAerodromeSwapTokensCallData(self):
        """Test BaseTransactionRequestAerodromeSwapTokensCallData"""
