...
class TestAaveGetUserPositionPerTokenRequest(unittest.TestCase):
    """AaveGetUserPositionPerTokenRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveGetUserPositionPerTokenRequest:
        """Test AaveGetUserPositionPerTokenRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveGetUserPositionPerTokenRequest`
        """
    ...
    def testAaveGetUserPositionPerTokenRequest(self):
        """Test AaveGetUserPositionPerTokenRequest"""
