...
class TestUniswapBuyExactlyRequest(unittest.TestCase):
    """UniswapBuyExactlyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapBuyExactlyRequest:
        """Test UniswapBuyExactlyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapBuyExactlyRequest`
        """
        model = UniswapBuyExactlyRequest()
        if include_optional:
            return UniswapBuyExactlyRequest(
    ...
    def testUniswapBuyExactlyRequest(self):
        """Test UniswapBuyExactlyRequest"""
