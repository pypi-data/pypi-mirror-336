...
class TestUniswapGetSellQuoteRequest(unittest.TestCase):
    """UniswapGetSellQuoteRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UniswapGetSellQuoteRequest:
        """Test UniswapGetSellQuoteRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UniswapGetSellQuoteRequest`
        """
    ...
    def testUniswapGetSellQuoteRequest(self):
        """Test UniswapGetSellQuoteRequest"""
