...
class TestAaveSupplyRequest(unittest.TestCase):
    """AaveSupplyRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveSupplyRequest:
        """Test AaveSupplyRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveSupplyRequest`
        """
    ...
    def testAaveSupplyRequest(self):
        """Test AaveSupplyRequest"""
