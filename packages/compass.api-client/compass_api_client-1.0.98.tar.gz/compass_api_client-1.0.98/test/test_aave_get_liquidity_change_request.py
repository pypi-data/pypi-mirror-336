...
class TestAaveGetLiquidityChangeRequest(unittest.TestCase):
    """AaveGetLiquidityChangeRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveGetLiquidityChangeRequest:
        """Test AaveGetLiquidityChangeRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveGetLiquidityChangeRequest`
        """
    ...
    def testAaveGetLiquidityChangeRequest(self):
        """Test AaveGetLiquidityChangeRequest"""
