...
class TestAaveGetAssetPriceRequest(unittest.TestCase):
    """AaveGetAssetPriceRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AaveGetAssetPriceRequest:
        """Test AaveGetAssetPriceRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AaveGetAssetPriceRequest`
        """
    ...
    def testAaveGetAssetPriceRequest(self):
        """Test AaveGetAssetPriceRequest"""
