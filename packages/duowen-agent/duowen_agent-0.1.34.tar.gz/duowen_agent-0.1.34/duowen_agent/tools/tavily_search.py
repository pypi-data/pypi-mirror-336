...
class Tavily(Tool):
    ...
    parameters: BaseModel = TavilyParameters
            ...
            return [
                {
                    ...
                    "content": res["content"],
                    "score": res["score"],
                    "content_with_weight": f'URL:{res["url"]}  TITLE: {res["title"]}  CONTENT: {res["content"]} SCORE: {res["score"]}',
                }
    ...
    def _run(
        ...
        **kwargs,
        ...
        self.search(query, search_depth=search_depth, **kwargs)
