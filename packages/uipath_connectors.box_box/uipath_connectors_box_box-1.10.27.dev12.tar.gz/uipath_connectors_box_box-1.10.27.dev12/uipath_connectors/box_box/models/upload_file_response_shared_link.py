...
from ..models.upload_file_response_shared_link_access import (
    UploadFileResponseSharedLinkAccess,
)
from ..models.upload_file_response_shared_link_effective_access import (
    UploadFileResponseSharedLinkEffectiveAccess,
)
from ..models.upload_file_response_shared_link_effective_permission import (
    UploadFileResponseSharedLinkEffectivePermission,
)
from ..models.upload_file_response_shared_link_permissions import (
    UploadFileResponseSharedLinkPermissions,
)
import datetime


class UploadFileResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[UploadFileResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[UploadFileResponseSharedLinkEffectiveAccess]): The effective access level for the
                shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[UploadFileResponseSharedLinkEffectivePermission]): The effective permissions for
                this shared link.
        is_password_enabled (Optional[bool]): Defines if the shared link requires a password to access the item.
        permissions (Optional[UploadFileResponseSharedLinkPermissions]):
    ...
    access: Optional["UploadFileResponseSharedLinkAccess"] = Field(
    ...
    effective_access: Optional["UploadFileResponseSharedLinkEffectiveAccess"] = Field(
    ...
    permissions: Optional["UploadFileResponseSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["UploadFileResponseSharedLink"], src_dict: Dict[str, Any]):
