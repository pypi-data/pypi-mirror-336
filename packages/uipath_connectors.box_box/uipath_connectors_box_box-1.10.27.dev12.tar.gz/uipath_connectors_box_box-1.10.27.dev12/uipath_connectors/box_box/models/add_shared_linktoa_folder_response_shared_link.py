...
from ..models.add_shared_linktoa_folder_response_shared_link_access import (
    AddSharedLinktoaFolderResponseSharedLinkAccess,
)
from ..models.add_shared_linktoa_folder_response_shared_link_effective_access import (
    AddSharedLinktoaFolderResponseSharedLinkEffectiveAccess,
)
from ..models.add_shared_linktoa_folder_response_shared_link_effective_permission import (
    AddSharedLinktoaFolderResponseSharedLinkEffectivePermission,
)
from ..models.add_shared_linktoa_folder_response_shared_link_permissions import (
    AddSharedLinktoaFolderResponseSharedLinkPermissions,
)
import datetime


class AddSharedLinktoaFolderResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[AddSharedLinktoaFolderResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[AddSharedLinktoaFolderResponseSharedLinkEffectiveAccess]): The effective access level
                for the shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[AddSharedLinktoaFolderResponseSharedLinkEffectivePermission]): The effective
        ...
        permissions (Optional[AddSharedLinktoaFolderResponseSharedLinkPermissions]):
    ...
    access: Optional["AddSharedLinktoaFolderResponseSharedLinkAccess"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["AddSharedLinktoaFolderResponseSharedLink"], src_dict: Dict[str, Any]
    ):
