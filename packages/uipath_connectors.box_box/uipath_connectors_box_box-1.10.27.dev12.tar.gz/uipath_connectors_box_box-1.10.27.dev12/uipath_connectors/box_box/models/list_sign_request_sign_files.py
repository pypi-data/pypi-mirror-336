...
from ..models.list_sign_request_sign_files_files_array_item_ref import (
    ListSignRequestSignFilesFilesArrayItemRef,
)


class ListSignRequestSignFiles(BaseModel):
    """
    Attributes:
        files (Optional[list['ListSignRequestSignFilesFilesArrayItemRef']]):
    ...
    files: Optional[list["ListSignRequestSignFilesFilesArrayItemRef"]] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["ListSignRequestSignFiles"], src_dict: Dict[str, Any]):
