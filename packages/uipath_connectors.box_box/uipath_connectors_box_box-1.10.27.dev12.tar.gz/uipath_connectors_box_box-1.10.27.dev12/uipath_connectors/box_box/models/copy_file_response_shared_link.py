...
from ..models.copy_file_response_shared_link_access import (
    CopyFileResponseSharedLinkAccess,
)
from ..models.copy_file_response_shared_link_effective_access import (
    CopyFileResponseSharedLinkEffectiveAccess,
)
from ..models.copy_file_response_shared_link_effective_permission import (
    CopyFileResponseSharedLinkEffectivePermission,
)
from ..models.copy_file_response_shared_link_permissions import (
    CopyFileResponseSharedLinkPermissions,
)
import datetime


class CopyFileResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[CopyFileResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[CopyFileResponseSharedLinkEffectiveAccess]): The effective access level for the
                shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[CopyFileResponseSharedLinkEffectivePermission]): The effective permissions for
                this shared link.
        is_password_enabled (Optional[bool]): Defines if the shared link requires a password to access the item.
        permissions (Optional[CopyFileResponseSharedLinkPermissions]):
    ...
    access: Optional["CopyFileResponseSharedLinkAccess"] = Field(
    ...
    effective_access: Optional["CopyFileResponseSharedLinkEffectiveAccess"] = Field(
        alias="effective_access", default=None
    )
    effective_permission: Optional["CopyFileResponseSharedLinkEffectivePermission"] = (
    ...
    permissions: Optional["CopyFileResponseSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CopyFileResponseSharedLink"], src_dict: Dict[str, Any]):
