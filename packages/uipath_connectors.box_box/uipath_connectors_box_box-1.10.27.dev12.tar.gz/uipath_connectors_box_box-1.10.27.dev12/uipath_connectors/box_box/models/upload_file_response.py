...
from ..models.upload_file_response_created_by import UploadFileResponseCreatedBy
from ..models.upload_file_response_file_version import UploadFileResponseFileVersion
from ..models.upload_file_response_item_status import UploadFileResponseItemStatus
from ..models.upload_file_response_modified_by import UploadFileResponseModifiedBy
from ..models.upload_file_response_owned_by import UploadFileResponseOwnedBy
from ..models.upload_file_response_parent import UploadFileResponseParent
from ..models.upload_file_response_path_collection import (
    UploadFileResponsePathCollection,
)
from ..models.upload_file_response_shared_link import UploadFileResponseSharedLink
from ..models.upload_file_response_type import UploadFileResponseType
import datetime
...
class UploadFileResponse(BaseModel):
    ...
    Attributes:
        ...
        created_by (Optional[UploadFileResponseCreatedBy]):
        ...
        file_version (Optional[UploadFileResponseFileVersion]):
        id (Optional[str]): The unique identifier that represent a file.
                ...
                the `file_id` is `123`.
        item_status (Optional[UploadFileResponseItemStatus]): Defines if this item has been deleted or not.
        ...
        modified_by (Optional[UploadFileResponseModifiedBy]):
        name (Optional[str]): The name of the file
        owned_by (Optional[UploadFileResponseOwnedBy]):
        parent (Optional[UploadFileResponseParent]):
        path_collection (Optional[UploadFileResponsePathCollection]):
        ...
        shared_link (Optional[UploadFileResponseSharedLink]):
        ...
        type_ (Optional[UploadFileResponseType]): `file`
    """
    ...
    created_by: Optional["UploadFileResponseCreatedBy"] = Field(
        alias="created_by", default=None
    )
    description: Optional[str] = Field(alias="description", default=None)
    etag: Optional[str] = Field(alias="etag", default=None)
    file_version: Optional["UploadFileResponseFileVersion"] = Field(
        alias="file_version", default=None
    )
    id: Optional[str] = Field(alias="id", default=None)
    item_status: Optional["UploadFileResponseItemStatus"] = Field(
        alias="item_status", default=None
    )
    modified_at: Optional[datetime.datetime] = Field(alias="modified_at", default=None)
    modified_by: Optional["UploadFileResponseModifiedBy"] = Field(
        alias="modified_by", default=None
    )
    name: Optional[str] = Field(alias="name", default=None)
    owned_by: Optional["UploadFileResponseOwnedBy"] = Field(
        alias="owned_by", default=None
    )
    parent: Optional["UploadFileResponseParent"] = Field(alias="parent", default=None)
    path_collection: Optional["UploadFileResponsePathCollection"] = Field(
    ...
    shared_link: Optional["UploadFileResponseSharedLink"] = Field(
        alias="shared_link", default=None
    )
    size: Optional[int] = Field(alias="size", default=None)
    trashed_at: Optional[datetime.datetime] = Field(alias="trashed_at", default=None)
    type_: Optional["UploadFileResponseType"] = Field(alias="type", default=None)
