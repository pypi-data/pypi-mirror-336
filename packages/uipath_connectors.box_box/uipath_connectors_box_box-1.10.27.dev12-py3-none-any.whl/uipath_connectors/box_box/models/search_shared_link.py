...
from ..models.search_shared_link_access import SearchSharedLinkAccess
from ..models.search_shared_link_effective_access import SearchSharedLinkEffectiveAccess
from ..models.search_shared_link_effective_permission import (
    SearchSharedLinkEffectivePermission,
)
from ..models.search_shared_link_permissions import SearchSharedLinkPermissions
import datetime


class SearchSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[SearchSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[SearchSharedLinkEffectiveAccess]): The effective access level for the shared link.
                This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[SearchSharedLinkEffectivePermission]): The effective permissions for this shared
                link.
        is_password_enabled (Optional[bool]): Defines if the shared link requires a password to access the item.
        permissions (Optional[SearchSharedLinkPermissions]):
    ...
    access: Optional["SearchSharedLinkAccess"] = Field(alias="access", default=None)
    ...
    effective_access: Optional["SearchSharedLinkEffectiveAccess"] = Field(
        alias="effective_access", default=None
    )
    effective_permission: Optional["SearchSharedLinkEffectivePermission"] = Field(
        alias="effective_permission", default=None
    )
    is_password_enabled: Optional[bool] = Field(
        alias="is_password_enabled", default=None
    )
    permissions: Optional["SearchSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["SearchSharedLink"], src_dict: Dict[str, Any]):
