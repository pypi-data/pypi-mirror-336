...
from ..models.create_sign_request_response_signers_inputs_type import (
    CreateSignRequestResponseSignersInputsType,
)
import datetime


class CreateSignRequestResponseSignersInputsArrayItemRef(BaseModel):
    """
    Attributes:
        ...
        type_ (Optional[CreateSignRequestResponseSignersInputsType]): Type of input
    """
    ...
    type_: Optional["CreateSignRequestResponseSignersInputsType"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateSignRequestResponseSignersInputsArrayItemRef"],
