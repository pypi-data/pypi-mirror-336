...
from ..models.get_file_info_response_shared_link_access import (
    GetFileInfoResponseSharedLinkAccess,
)
from ..models.get_file_info_response_shared_link_effective_access import (
    GetFileInfoResponseSharedLinkEffectiveAccess,
)
from ..models.get_file_info_response_shared_link_effective_permission import (
    GetFileInfoResponseSharedLinkEffectivePermission,
)
from ..models.get_file_info_response_shared_link_permissions import (
    GetFileInfoResponseSharedLinkPermissions,
)
import datetime


class GetFileInfoResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[GetFileInfoResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[GetFileInfoResponseSharedLinkEffectiveAccess]): The effective access level for the
                shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[GetFileInfoResponseSharedLinkEffectivePermission]): The effective permissions for
                this shared link.
        is_password_enabled (Optional[bool]): Defines if the shared link requires a password to access the item.
        permissions (Optional[GetFileInfoResponseSharedLinkPermissions]):
    ...
    access: Optional["GetFileInfoResponseSharedLinkAccess"] = Field(
    ...
    effective_access: Optional["GetFileInfoResponseSharedLinkEffectiveAccess"] = Field(
    ...
    permissions: Optional["GetFileInfoResponseSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["GetFileInfoResponseSharedLink"], src_dict: Dict[str, Any]):
