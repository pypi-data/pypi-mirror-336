...
from ..models.upload_file_version_response_shared_link_access import (
    UploadFileVersionResponseSharedLinkAccess,
)
from ..models.upload_file_version_response_shared_link_effective_access import (
    UploadFileVersionResponseSharedLinkEffectiveAccess,
)
from ..models.upload_file_version_response_shared_link_effective_permission import (
    UploadFileVersionResponseSharedLinkEffectivePermission,
)
from ..models.upload_file_version_response_shared_link_permissions import (
    UploadFileVersionResponseSharedLinkPermissions,
)
import datetime


class UploadFileVersionResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[UploadFileVersionResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[UploadFileVersionResponseSharedLinkEffectiveAccess]): The effective access level for
                the shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[UploadFileVersionResponseSharedLinkEffectivePermission]): The effective
        ...
        permissions (Optional[UploadFileVersionResponseSharedLinkPermissions]):
    ...
    access: Optional["UploadFileVersionResponseSharedLinkAccess"] = Field(
    ...
    effective_access: Optional["UploadFileVersionResponseSharedLinkEffectiveAccess"] = (
    ...
    permissions: Optional["UploadFileVersionResponseSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["UploadFileVersionResponseSharedLink"], src_dict: Dict[str, Any]
    ):
