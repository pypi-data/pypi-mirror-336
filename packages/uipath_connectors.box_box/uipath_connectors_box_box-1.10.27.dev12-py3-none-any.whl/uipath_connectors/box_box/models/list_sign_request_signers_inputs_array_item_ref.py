...
from ..models.list_sign_request_signers_inputs_type import (
    ListSignRequestSignersInputsType,
)
import datetime


class ListSignRequestSignersInputsArrayItemRef(BaseModel):
    """
    Attributes:
        ...
        type_ (Optional[ListSignRequestSignersInputsType]): Type of input
    """
    ...
    type_: Optional["ListSignRequestSignersInputsType"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["ListSignRequestSignersInputsArrayItemRef"], src_dict: Dict[str, Any]
    ):
