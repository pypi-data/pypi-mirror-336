...
from ..models.create_sign_request_response_sign_files_files_array_item_ref import (
    CreateSignRequestResponseSignFilesFilesArrayItemRef,
)


class CreateSignRequestResponseSignFiles(BaseModel):
    """
    Attributes:
        files (Optional[list['CreateSignRequestResponseSignFilesFilesArrayItemRef']]):
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateSignRequestResponseSignFiles"], src_dict: Dict[str, Any]
    ):
