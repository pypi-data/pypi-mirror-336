...
from ..models.add_shared_linktoa_file_response_shared_link_access import (
    AddSharedLinktoaFileResponseSharedLinkAccess,
)
from ..models.add_shared_linktoa_file_response_shared_link_effective_access import (
    AddSharedLinktoaFileResponseSharedLinkEffectiveAccess,
)
from ..models.add_shared_linktoa_file_response_shared_link_effective_permission import (
    AddSharedLinktoaFileResponseSharedLinkEffectivePermission,
)
from ..models.add_shared_linktoa_file_response_shared_link_permissions import (
    AddSharedLinktoaFileResponseSharedLinkPermissions,
)
import datetime


class AddSharedLinktoaFileResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[AddSharedLinktoaFileResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[AddSharedLinktoaFileResponseSharedLinkEffectiveAccess]): The effective access level
                for the shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[AddSharedLinktoaFileResponseSharedLinkEffectivePermission]): The effective
                permissions for this shared link.
        is_password_enabled (Optional[bool]): Defines if the shared link requires a password to access the item.
        permissions (Optional[AddSharedLinktoaFileResponseSharedLinkPermissions]):
    ...
    access: Optional["AddSharedLinktoaFileResponseSharedLinkAccess"] = Field(
    ...
    effective_access: Optional[
        "AddSharedLinktoaFileResponseSharedLinkEffectiveAccess"
    ] = Field(alias="effective_access", default=None)
    ...
    permissions: Optional["AddSharedLinktoaFileResponseSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["AddSharedLinktoaFileResponseSharedLink"], src_dict: Dict[str, Any]
    ):
