...
from ..models.create_folder_response_shared_link_access import (
    CreateFolderResponseSharedLinkAccess,
)
from ..models.create_folder_response_shared_link_effective_access import (
    CreateFolderResponseSharedLinkEffectiveAccess,
)
from ..models.create_folder_response_shared_link_effective_permission import (
    CreateFolderResponseSharedLinkEffectivePermission,
)
from ..models.create_folder_response_shared_link_permissions import (
    CreateFolderResponseSharedLinkPermissions,
)
import datetime


class CreateFolderResponseSharedLink(BaseModel):
    """
    Attributes:
        access (Optional[CreateFolderResponseSharedLinkAccess]): The access level for this shared link.
        ...
        effective_access (Optional[CreateFolderResponseSharedLinkEffectiveAccess]): The effective access level for the
                shared link. This can be a more
                restrictive access level than the value in the `access` field when the
                enterprise settings restrict the allowed access levels.
        effective_permission (Optional[CreateFolderResponseSharedLinkEffectivePermission]): The effective permissions
                for this shared link.
        is_password_enabled (Optional[bool]): Defines if the shared link requires a password to access the item.
        permissions (Optional[CreateFolderResponseSharedLinkPermissions]):
    ...
    access: Optional["CreateFolderResponseSharedLinkAccess"] = Field(
    ...
    effective_access: Optional["CreateFolderResponseSharedLinkEffectiveAccess"] = Field(
    ...
    permissions: Optional["CreateFolderResponseSharedLinkPermissions"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateFolderResponseSharedLink"], src_dict: Dict[str, Any]
    ):
