...
class AddSharedLinktoaFolderResponseSharedLinkPermissions(BaseModel):
    """
    Attributes:
        ...
        can_edit (Optional[bool]): This value can only be false for items with a type of folder
    ...
    can_edit: Optional[bool] = Field(alias="can_edit", default=None)
    ...
    @classmethod
    def from_dict(
        cls: Type["AddSharedLinktoaFolderResponseSharedLinkPermissions"],
