...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "put",
        "url": "/files/{file_id}/add_shared_link".format(
            file_id=file_id,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = AddSharedLinktoaFileResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[AddSharedLinktoaFileResponse, DefaultError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[AddSharedLinktoaFileResponse, DefaultError]
    """
