...
def _get_kwargs(
    *,
    ...
    params["convertToPDF"] = convert_to_pdf
...
def sync_detailed(
    *,
    ...
    """Download File
     ...
     Downloads a file or folder from OneDrive & SharePoint

    Args:
        convert_to_pdf (Optional[bool]): Convert to PDF format Default: False.
        reference_id (str): Select file to be downloaded
