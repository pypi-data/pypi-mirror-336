    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = CuratedFile.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["CuratedFile"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Curated files
     ...
     API to get a list of CuratedFiles
    ...
    Args:
        ...
        drive_id (Optional[str]): ID of drive. Provide when we want to fetch file from a specific
            drive.
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['CuratedFile']]
    """
