...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateWorkbookResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateWorkbookResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Workbook
     ...
     Creates a new workbook in OneDrive or SharePoint Document Library.

    Args:
        reference_id (str): Folder
        body (CreateWorkbookRequest):
...
def sync(
    *,
    ...
    Returns:
        Union[CreateWorkbookResponse, DefaultError]
    """
