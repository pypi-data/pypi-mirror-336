...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = FileUploadV2Response.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, FileUploadV2Response]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        conflict_behavior (Optional[str]): Indicates the conflict resolution behavior in case
            files with the same name already exist. Fails if an existing item is found
        reference_id (str): Location to upload file
        body (FileUploadV2Body):
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, FileUploadV2Response]
    """
