...
from ..models.get_files_folders_response_owner import GetFilesFoldersResponseOwner


class GetFilesFoldersResponse(BaseModel):
    """
    Attributes:
        ...
        owner (Optional[GetFilesFoldersResponseOwner]):
    ...
    owner: Optional["GetFilesFoldersResponseOwner"] = Field(alias="Owner", default=None)
    ...
    @classmethod
    def from_dict(cls: Type["GetFilesFoldersResponse"], src_dict: Dict[str, Any]):
