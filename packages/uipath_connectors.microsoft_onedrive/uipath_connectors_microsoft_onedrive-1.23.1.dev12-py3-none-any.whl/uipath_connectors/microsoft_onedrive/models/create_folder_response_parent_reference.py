...
class CreateFolderResponseParentReference(BaseModel):
    """
    Attributes:
        ...
        id (Optional[str]):  Example: 01EPMICMLYBRERYZ3CJBAI72NBEPG7B6A2.
        path (Optional[str]):  Example: /drive/root:/Documents/Office Scripts.
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateFolderResponseParentReference"], src_dict: Dict[str, Any]
    ):
