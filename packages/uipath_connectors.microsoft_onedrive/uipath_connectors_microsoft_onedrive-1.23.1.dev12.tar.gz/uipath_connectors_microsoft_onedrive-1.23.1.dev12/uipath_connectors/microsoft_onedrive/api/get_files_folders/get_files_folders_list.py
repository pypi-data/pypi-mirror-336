    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetFilesFoldersList.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["GetFilesFoldersList"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get File or Folders List

     Fetch list of files of folders

    Args:
        reference_id (str): Location to fetch files or/and folders
        return_ (Optional[str]): What to return
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['GetFilesFoldersList']]
    """
