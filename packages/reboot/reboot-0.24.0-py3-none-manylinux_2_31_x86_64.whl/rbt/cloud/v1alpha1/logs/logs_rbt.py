        ...
        *,
        ...
        if self._token_verifier is not None and self._authorizer is None:
            raise IMPORT_reboot.controller.exceptions.InputError(
                ...
                f"'rbt.cloud.v1alpha1.logs.ApplicationLogs'"
            )
...
class ApplicationLogsAuthorizer(
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[ApplicationLogsStateType] = None,
        request: IMPORT_typing.Optional[ApplicationLogsRequestTypes] = None,
        ...
        if method_name == 'rbt.cloud.v1alpha1.logs.ApplicationLogsMethods.Ensure':
            return await self.Ensure(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.ApplicationLogs, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.EnsureRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.logs.ApplicationLogsMethods.RegisterConsensus':
            return await self.RegisterConsensus(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.ApplicationLogs, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.RegisterConsensusRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.logs.ApplicationLogsMethods.Logs':
            return await self.Logs(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.ApplicationLogs, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.LogsRequest, request),
            )
        else:
