...
class SecretAuthorizer(
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[SecretStateType] = None,
        request: IMPORT_typing.Optional[SecretRequestTypes] = None,
    ) -> IMPORT_reboot.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'rbt.cloud.v1alpha1.secrets.SecretMethods.Write':
            return await self.Write(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.secrets.SecretMethods.Read':
            return await self.Read(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
                IMPORT_typing.cast(google.protobuf.empty_pb2.Empty, request),
            )
