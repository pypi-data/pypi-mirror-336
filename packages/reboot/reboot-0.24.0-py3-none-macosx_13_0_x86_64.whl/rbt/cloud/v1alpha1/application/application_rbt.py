...
IMPORT_reboot_versioning.check_generated_code_compatible("0.24.0")
    ...
    def __init__(
        ...
        *,
        ...
        if self._token_verifier is not None and self._authorizer is None:
            raise IMPORT_reboot.controller.exceptions.InputError(
        ...
        *,
        ...
        if method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Create':
            ...
            return await self.PushInfo(
                ...
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest, request),
            )
            ...
            return await self.UpWorkflow(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest, request),
            )
            ...
            return await self.DownWorkflow(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.RevisionStatus':
            return await self.RevisionStatus(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Logs':
            return await self.Logs(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.LogsRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.ActiveRevisions':
            return await self.ActiveRevisions(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.application.ApplicationMethods.Status':
            return await self.Status(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.StatusRequest, request),
            )
        else:
