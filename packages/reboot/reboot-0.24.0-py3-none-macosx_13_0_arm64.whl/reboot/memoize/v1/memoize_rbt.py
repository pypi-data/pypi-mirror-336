...
class MemoizeAuthorizer(
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[MemoizeStateType] = None,
        request: IMPORT_typing.Optional[MemoizeRequestTypes] = None,
    ) -> IMPORT_reboot.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'reboot.memoize.v1.MemoizeMethods.Reset':
            return await self.Reset(
                context,
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.Memoize, state),
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.ResetRequest, request),
            )
        elif method_name == 'reboot.memoize.v1.MemoizeMethods.Start':
            return await self.Start(
                context,
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.Memoize, state),
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.StartRequest, request),
            )
        elif method_name == 'reboot.memoize.v1.MemoizeMethods.Store':
            return await self.Store(
                context,
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.Memoize, state),
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.StoreRequest, request),
            )
        elif method_name == 'reboot.memoize.v1.MemoizeMethods.Fail':
            return await self.Fail(
                context,
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.Memoize, state),
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.FailRequest, request),
            )
        elif method_name == 'reboot.memoize.v1.MemoizeMethods.Status':
            return await self.Status(
                context,
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.Memoize, state),
                IMPORT_typing.cast(reboot.memoize.v1.memoize_pb2.StatusRequest, request),
            )
        else:
