...
class APIKeyAuthorizer(
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[APIKeyStateType] = None,
        request: IMPORT_typing.Optional[APIKeyRequestTypes] = None,
    ) -> IMPORT_reboot.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'rbt.cloud.v1alpha1.auth.APIKeyMethods.Create':
            return await self.Create(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.CreateRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.auth.APIKeyMethods.Revoke':
            return await self.Revoke(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.APIKey, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.RevokeRequest, request),
            )
        elif method_name == 'rbt.cloud.v1alpha1.auth.APIKeyMethods.Authenticate':
            return await self.Authenticate(
                context,
                IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.APIKey, state),
                IMPORT_typing.cast(rbt.cloud.v1alpha1.auth.auth_pb2.AuthenticateRequest, request),
            )
        else:
