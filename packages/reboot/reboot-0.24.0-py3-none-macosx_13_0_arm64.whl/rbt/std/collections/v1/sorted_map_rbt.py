...
class SortedMapAuthorizer(
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[SortedMapStateType] = None,
        request: IMPORT_typing.Optional[SortedMapRequestTypes] = None,
    ) -> IMPORT_reboot.aio.auth.authorizers.Authorizer.Decision:
        if method_name == 'rbt.std.collections.v1.SortedMapMethods.Insert':
            return await self.Insert(
                context,
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.InsertRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.Remove':
            return await self.Remove(
                context,
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RemoveRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.Get':
            return await self.Get(
                context,
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.GetRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.Range':
            return await self.Range(
                context,
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.RangeRequest, request),
            )
        elif method_name == 'rbt.std.collections.v1.SortedMapMethods.ReverseRange':
            return await self.ReverseRange(
                context,
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
                IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, request),
            )
        else:
