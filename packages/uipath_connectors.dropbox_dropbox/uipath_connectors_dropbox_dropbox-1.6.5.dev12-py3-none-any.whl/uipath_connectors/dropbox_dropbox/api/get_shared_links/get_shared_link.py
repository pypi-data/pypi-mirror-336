...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetSharedLinkResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, GetSharedLinkResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Shared Link
     ...
     Gets a shared link for a given file.  This is different than create shared link as it will inherit
    the file’s sharing settings already established.

    Args:
        path (str): Either folder or file path
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, GetSharedLinkResponse]
    """
