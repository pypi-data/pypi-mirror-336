...
from ..models.get_shared_link_response_link_permissions_audience_options_array_item_ref import (
    GetSharedLinkResponseLinkPermissionsAudienceOptionsArrayItemRef,
)
from ..models.get_shared_link_response_link_permissions_requested_visibility import (
    GetSharedLinkResponseLinkPermissionsRequestedVisibility,
)
from ..models.get_shared_link_response_link_permissions_resolved_visibility import (
    GetSharedLinkResponseLinkPermissionsResolvedVisibility,
)
from ..models.get_shared_link_response_link_permissions_visibility_policies_array_item_ref import (
    GetSharedLinkResponseLinkPermissionsVisibilityPoliciesArrayItemRef,
)


class GetSharedLinkResponseLinkPermissions(BaseModel):
    """
    Attributes:
        allow_comments (Optional[bool]):  Example: True.
        allow_download (Optional[bool]):  Example: True.
        audience_options (Optional[list['GetSharedLinkResponseLinkPermissionsAudienceOptionsArrayItemRef']]):
        can_allow_download (Optional[bool]):  Example: True.
        can_disallow_download (Optional[bool]):
        can_remove_expiry (Optional[bool]):  Example: True.
        can_remove_password (Optional[bool]):
        can_revoke (Optional[bool]):  Example: True.
        can_set_expiry (Optional[bool]):
        can_set_password (Optional[bool]):
        requested_visibility (Optional[GetSharedLinkResponseLinkPermissionsRequestedVisibility]):
        resolved_visibility (Optional[GetSharedLinkResponseLinkPermissionsResolvedVisibility]):
        team_restricts_comments (Optional[bool]):
        visibility_policies (Optional[list['GetSharedLinkResponseLinkPermissionsVisibilityPoliciesArrayItemRef']]):
    """
    ...
    audience_options: Optional[
        list["GetSharedLinkResponseLinkPermissionsAudienceOptionsArrayItemRef"]
    ...
    requested_visibility: Optional[
        "GetSharedLinkResponseLinkPermissionsRequestedVisibility"
    ] = Field(alias="requested_visibility", default=None)
    ...
    visibility_policies: Optional[
        list["GetSharedLinkResponseLinkPermissionsVisibilityPoliciesArrayItemRef"]
    ...
    @classmethod
    def from_dict(
        cls: Type["GetSharedLinkResponseLinkPermissions"], src_dict: Dict[str, Any]
    ):
