...
class GetFolderContentSharingInfo(BaseModel):
    ...
    no_access: Optional[bool] = Field(alias="no_access", default=None)
    ...
    traverse_only: Optional[bool] = Field(alias="traverse_only", default=None)

    def to_dict(self) -> Dict[str, Any]:
        return self.model_dump(exclude_none=True, by_alias=True)

    @classmethod
    def from_dict(cls: Type["GetFolderContentSharingInfo"], src_dict: Dict[str, Any]):
