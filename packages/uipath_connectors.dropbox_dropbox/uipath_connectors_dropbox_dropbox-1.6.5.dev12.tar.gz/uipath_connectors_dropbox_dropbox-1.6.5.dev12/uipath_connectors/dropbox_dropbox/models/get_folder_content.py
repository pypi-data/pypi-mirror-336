...
from ..models.get_folder_content_file_lock_info import GetFolderContentFileLockInfo
from ..models.get_folder_content_property_groups_array_item_ref import (
    GetFolderContentPropertyGroupsArrayItemRef,
)
from ..models.get_folder_content_sharing_info import GetFolderContentSharingInfo
import datetime


class GetFolderContent(BaseModel):
    """
    Attributes:
        ...
        file_lock_info (Optional[GetFolderContentFileLockInfo]):
        ...
        property_groups (Optional[list['GetFolderContentPropertyGroupsArrayItemRef']]):
        rev (Optional[str]):  Example: a1c10ce0dd78.
        server_modified (Optional[datetime.datetime]):  Example: 2015-05-12T15:50:38Z.
        sharing_info (Optional[GetFolderContentSharingInfo]):
    ...
    file_lock_info: Optional["GetFolderContentFileLockInfo"] = Field(
    ...
    sharing_info: Optional["GetFolderContentSharingInfo"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["GetFolderContent"], src_dict: Dict[str, Any]):
