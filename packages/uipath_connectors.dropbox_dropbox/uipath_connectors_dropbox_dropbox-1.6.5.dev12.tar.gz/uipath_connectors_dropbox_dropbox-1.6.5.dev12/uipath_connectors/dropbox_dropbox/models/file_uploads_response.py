...
from ..models.file_uploads_response_file_lock_info import (
    FileUploadsResponseFileLockInfo,
)
from ..models.file_uploads_response_property_groups_array_item_ref import (
    FileUploadsResponsePropertyGroupsArrayItemRef,
)
from ..models.file_uploads_response_sharing_info import FileUploadsResponseSharingInfo
import datetime
...
class FileUploadsResponse(BaseModel):
    ...
    Attributes:
        ...
        file_lock_info (Optional[FileUploadsResponseFileLockInfo]):
        has_explicit_shared_members (Optional[bool]):
        id (Optional[str]): ID of the file that was uploaded Example: id:a4ayc_80_OEAAAAAAAAAXw.
        ...
        property_groups (Optional[list['FileUploadsResponsePropertyGroupsArrayItemRef']]):
        rev (Optional[str]):  Example: a1c10ce0dd78.
        server_modified (Optional[datetime.datetime]):  Example: 2015-05-12T15:50:38Z.
        sharing_info (Optional[FileUploadsResponseSharingInfo]):
    ...
    file_lock_info: Optional["FileUploadsResponseFileLockInfo"] = Field(
    ...
    sharing_info: Optional["FileUploadsResponseSharingInfo"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["FileUploadsResponse"], src_dict: Dict[str, Any]):
