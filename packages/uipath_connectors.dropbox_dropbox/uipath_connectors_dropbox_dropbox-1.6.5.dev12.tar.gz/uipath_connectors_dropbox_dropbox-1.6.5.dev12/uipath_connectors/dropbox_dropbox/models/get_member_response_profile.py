...
from ..models.get_member_response_profile_membership_type import (
    GetMemberResponseProfileMembershipType,
)
from ..models.get_member_response_profile_name import GetMemberResponseProfileName
from ..models.get_member_response_profile_secondary_emails_array_item_ref import (
    GetMemberResponseProfileSecondaryEmailsArrayItemRef,
)
from ..models.get_member_response_profile_status import GetMemberResponseProfileStatus
import datetime


class GetMemberResponseProfile(BaseModel):
    """
    Attributes:
        ...
        membership_type (Optional[GetMemberResponseProfileMembershipType]):
        name (Optional[GetMemberResponseProfileName]):
        ...
        secondary_emails (Optional[list['GetMemberResponseProfileSecondaryEmailsArrayItemRef']]):
        status (Optional[GetMemberResponseProfileStatus]):
    ...
    membership_type: Optional["GetMemberResponseProfileMembershipType"] = Field(
        alias="membership_type", default=None
    )
    name: Optional["GetMemberResponseProfileName"] = Field(alias="name", default=None)
    profile_photo_url: Optional[str] = Field(alias="profile_photo_url", default=None)
    secondary_emails: Optional[
        list["GetMemberResponseProfileSecondaryEmailsArrayItemRef"]
    ] = Field(alias="secondary_emails", default=None)
    status: Optional["GetMemberResponseProfileStatus"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["GetMemberResponseProfile"], src_dict: Dict[str, Any]):
