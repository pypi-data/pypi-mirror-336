...
from ..models.get_file_details_response_export_info import (
    GetFileDetailsResponseExportInfo,
)
from ..models.get_file_details_response_file_lock_info import (
    GetFileDetailsResponseFileLockInfo,
)
from ..models.get_file_details_response_property_groups_array_item_ref import (
    GetFileDetailsResponsePropertyGroupsArrayItemRef,
)
from ..models.get_file_details_response_sharing_info import (
    GetFileDetailsResponseSharingInfo,
)
from ..models.get_file_details_response_symlink_info import (
...
class GetFileDetailsResponse(BaseModel):
    ...
    Attributes:
        ...
        export_info (Optional[GetFileDetailsResponseExportInfo]):
        file_lock_info (Optional[GetFileDetailsResponseFileLockInfo]):
        ...
        path_display (Optional[str]):  Example: /Homework/math/Prime_Numbers.txt.
        path_lower (Optional[str]):  Example: /homework/math/prime_numbers.txt.
        property_groups (Optional[list['GetFileDetailsResponsePropertyGroupsArrayItemRef']]):
        rev (Optional[str]):  Example: a1c10ce0dd78.
        server_modified (Optional[datetime.datetime]):  Example: 2015-05-12T15:50:38Z.
        sharing_info (Optional[GetFileDetailsResponseSharingInfo]):
        size (Optional[int]):  Example: 7212.0.
        symlink_info (Optional[GetFileDetailsResponseSymlinkInfo]):
    ...
    export_info: Optional["GetFileDetailsResponseExportInfo"] = Field(
        alias="export_info", default=None
    )
    file_lock_info: Optional["GetFileDetailsResponseFileLockInfo"] = Field(
    ...
    property_groups: Optional[
        list["GetFileDetailsResponsePropertyGroupsArrayItemRef"]
    ...
    sharing_info: Optional["GetFileDetailsResponseSharingInfo"] = Field(
        alias="sharing_info", default=None
    )
    size: Optional[int] = Field(alias="size", default=None)
    symlink_info: Optional["GetFileDetailsResponseSymlinkInfo"] = Field(
        alias="symlink_info", default=None
    )
    ...
    @classmethod
    def from_dict(cls: Type["GetFileDetailsResponse"], src_dict: Dict[str, Any]):
