    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListMembers.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListMembers"]]]:
    return Response(
    ...
    *,
    ...
    Args:
        ...
        next_page (Optional[str]): The next page cursor, taken from the response header: elements-
            next-page-token
        include_removed (Optional[str]): Whether to return removed members. The default for this
            field is False.
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['ListMembers']]
    """
