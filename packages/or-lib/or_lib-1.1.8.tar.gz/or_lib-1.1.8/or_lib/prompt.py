...
PROMPTS["img_response"] = """---Role---

You are a helpful assistant filtering relevant images based on the input image summary and the user query.

---Goal---

1. Validate whether each image summary in the provided CSV data is relevant to the given user query.
2. If the image summary aligns well with the user query, consider the image relevant.
3. Return a list of image IDs that are relevant to the input query.
...
Return a list containing only the image IDs of relevant images. Example:
