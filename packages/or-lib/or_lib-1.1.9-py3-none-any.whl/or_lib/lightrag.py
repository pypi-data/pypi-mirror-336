...
STORAGES = {
    "NetworkXStorage": "or_lib.kg.networkx_impl",
    "JsonKVStorage": "or_lib.kg.json_kv_impl",
    "NanoVectorDBStorage": "or_lib.kg.nano_vector_db_impl",
    "JsonDocStatusStorage": "or_lib.kg.jsondocstatus_impl",
    "Neo4JStorage": "or_lib.kg.neo4j_impl",
    "OracleKVStorage": "or_lib.kg.oracle_impl",
    "OracleGraphStorage": "or_lib.kg.oracle_impl",
    "OracleVectorDBStorage": "or_lib.kg.oracle_impl",
    "MilvusVectorDBStorge": "or_lib.kg.milvus_impl",
    "MongoKVStorage": "or_lib.kg.mongo_impl",
    "MongoGraphStorage": "or_lib.kg.mongo_impl",
    "RedisKVStorage": "or_lib.kg.redis_impl",
    "ChromaVectorDBStorage": "or_lib.kg.chroma_impl",
    "TiDBKVStorage": "or_lib.kg.tidb_impl",
    "TiDBVectorDBStorage": "or_lib.kg.tidb_impl",
    "TiDBGraphStorage": "or_lib.kg.tidb_impl",
    "PGKVStorage": "or_lib.kg.postgres_impl",
    "PGVectorStorage": "or_lib.kg.postgres_impl",
    "AGEStorage": "or_lib.kg.age_impl",
    "PGGraphStorage": "or_lib.kg.postgres_impl",
    "GremlinStorage": "or_lib.kg.gremlin_impl",
    "PGDocStatusStorage": "or_lib.kg.postgres_impl",
    "FaissVectorDBStorage": "or_lib.kg.faiss_impl",
}
...
class LightRAG:
            ...
            for doc_id, doc in tqdm_async(
                ...
                try:
                    ...
                    try:
                        ...
                        if self.vector_storage in {"AstraDBVectorStorage", "WeaviateDBVectorStorage"}:
                            await self.chunks_vdb.upsert_with_centroid(chunks)
                        else:
    ...
    def query(self, query: str, prompt: str = "", param: QueryParam = QueryParam()):
        loop = always_get_an_event_loop()
        return loop.run_until_complete(self.aquery(query.strip(), prompt, param))
    ...
    async def aquery(
        ...
        try:
            image_ids = json.loads(image_ids) if isinstance(image_ids, str) else image_ids
