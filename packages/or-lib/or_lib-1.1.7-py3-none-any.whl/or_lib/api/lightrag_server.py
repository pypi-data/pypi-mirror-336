...
from or_lib import LightRAG, QueryParam
from or_lib.api import __api_version__

from or_lib.utils import EmbeddingFunc
...
def create_app(args):
    ...
    if args.llm_binding == "lollms" or args.embedding_binding == "lollms":
        from or_lib.llm.lollms import lollms_model_complete, lollms_embed
    if args.llm_binding == "ollama" or args.embedding_binding == "ollama":
        from or_lib.llm.ollama import ollama_model_complete, ollama_embed
    if args.llm_binding == "openai" or args.embedding_binding == "openai":
        from or_lib.llm.openai import openai_complete_if_cache, openai_embed
    if args.llm_binding == "azure_openai" or args.embedding_binding == "azure_openai":
        from or_lib.llm.azure_openai import (
            azure_openai_complete_if_cache,
            azure_openai_embed,
        )
    if args.llm_binding_host == "openai-ollama" or args.embedding_binding == "ollama":
        from or_lib.llm.openai import openai_complete_if_cache
        from or_lib.llm.ollama import ollama_embed
