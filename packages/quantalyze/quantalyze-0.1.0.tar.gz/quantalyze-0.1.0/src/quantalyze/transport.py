...
def calculate_resistivity(df, length=None, width=None, thickness=None, resistance=None, voltage=None, current=None, geometric_factor=None):
    """
...
def calculate_hall_resistance(df, hall_voltage, current):
    """
...
def calculate_hall_resistivity(df, hall_resistance=None, hall_voltage=None, current=None, thickness=None):
    """
