...
__all__ = [
    ...
    'AwaitableGetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult',
    'get_transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_group_feature',
    'get_transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_group_feature_output',
]

@pulumi.output_type
class GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult:
    """
    ...
    def __init__(__self__, feature_profile_id=None, id=None, transport_ipv6_tracker_group_feature_id=None, transport_wan_vpn_feature_id=None, transport_wan_vpn_interface_ethernet_feature_id=None):
        ...
        if transport_ipv6_tracker_group_feature_id and not isinstance(transport_ipv6_tracker_group_feature_id, str):
            raise TypeError("Expected argument 'transport_ipv6_tracker_group_feature_id' to be a str")
    ...
    def transport_ipv6_tracker_group_feature_id(self) -> str:
        """
...
class AwaitableGetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult(GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult(
...
def get_transport_wan_vpn_interface_ethernet_feature_associate_ipv6_tracker_group_feature(feature_profile_id: Optional[str] = None,
                                                                                          ...
                                                                                          opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult:
    """
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeature:getTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeature', __args__, opts=opts, typ=GetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult).value

    return AwaitableGetTransportWanVpnInterfaceEthernetFeatureAssociateIpv6TrackerGroupFeatureResult(
