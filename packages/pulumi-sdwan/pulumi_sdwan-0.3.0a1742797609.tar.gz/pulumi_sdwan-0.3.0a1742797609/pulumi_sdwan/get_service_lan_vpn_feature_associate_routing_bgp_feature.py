...
__all__ = [
    'GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult',
    'AwaitableGetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult',
    'get_service_lan_vpn_feature_associate_routing_bgp_feature',
    'get_service_lan_vpn_feature_associate_routing_bgp_feature_output',
]

@pulumi.output_type
class GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult:
    """
...
class AwaitableGetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult(GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult):
    ...
    def __await__(self):
        if False:
            yield self
        return GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult(
...
def get_service_lan_vpn_feature_associate_routing_bgp_feature(feature_profile_id: Optional[str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('sdwan:index/getServiceLanVpnFeatureAssociateRoutingBgpFeature:getServiceLanVpnFeatureAssociateRoutingBgpFeature', __args__, opts=opts, typ=GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult).value

    return AwaitableGetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult(
...
def get_service_lan_vpn_feature_associate_routing_bgp_feature_output(feature_profile_id: Optional[pulumi.Input[str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('sdwan:index/getServiceLanVpnFeatureAssociateRoutingBgpFeature:getServiceLanVpnFeatureAssociateRoutingBgpFeature', __args__, opts=opts, typ=GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult)
    return __ret__.apply(lambda __response__: GetServiceLanVpnFeatureAssociateRoutingBgpFeatureResult(
