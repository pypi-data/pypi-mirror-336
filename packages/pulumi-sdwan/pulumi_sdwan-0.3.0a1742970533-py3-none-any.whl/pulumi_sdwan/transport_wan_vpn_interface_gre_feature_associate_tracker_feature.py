...
class TransportWanVpnInterfaceGreFeatureAssociateTrackerFeatureArgs:
    def __init__(__self__, *,
                 ...
                 transport_wan_vpn_interface_gre_feature_id: pulumi.Input[str]):
        """
    ...
    def transport_wan_vpn_interface_gre_feature_id(self) -> pulumi.Input[str]:
        """
    ...
    def transport_wan_vpn_interface_gre_feature_id(self, value: pulumi.Input[str]):
...
class _TransportWanVpnInterfaceGreFeatureAssociateTrackerFeatureState:
    ...
    @property
    @pulumi.getter(name="transportWanVpnInterfaceGreFeatureId")
    def transport_wan_vpn_interface_gre_feature_id(self) -> Optional[pulumi.Input[str]]:
        """
        Transport WAN VPN Interface GRE Feature ID
        """
        return pulumi.get(self, "transport_wan_vpn_interface_gre_feature_id")
...
class TransportWanVpnInterfaceGreFeatureAssociateTrackerFeature(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            transport_tracker_feature_id: Optional[pulumi.Input[str]] = None,
            transport_wan_vpn_feature_id: Optional[pulumi.Input[str]] = None,
            transport_wan_vpn_interface_gre_feature_id: Optional[pulumi.Input[str]] = None) -> 'TransportWanVpnInterfaceGreFeatureAssociateTrackerFeature':
        """
    ...
    @property
    @pulumi.getter(name="transportWanVpnInterfaceGreFeatureId")
    def transport_wan_vpn_interface_gre_feature_id(self) -> pulumi.Output[str]:
        """
        Transport WAN VPN Interface GRE Feature ID
        """
        return pulumi.get(self, "transport_wan_vpn_interface_gre_feature_id")
