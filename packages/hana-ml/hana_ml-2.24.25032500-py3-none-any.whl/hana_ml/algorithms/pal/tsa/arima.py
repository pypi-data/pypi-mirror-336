...
class ARIMA(_ARIMABase, PermutationImportanceMixin):
    ...
    External part, on the other hand, captures the Shapely Value of each exogenous data by LinearSHAP.
    ...
    def predict(self,
        ...
        trend_mod : double, optional
            The real AR roots with inverse modulus larger than this parameter will be integrated into trend component.
            Valid only when ``show_explainer`` is True.
        ...
        if data is None:
            ...
            if self.massive is not True:
                ...
                data_ = self.conn_context.sql("SELECT TOP 0 * FROM (SELECT NULL {}, NULL {}, NULL Y FROM DUMMY) dt;".format(group_key, key)).cast({group_key: group_key_type, key: "INTEGER", "Y":"DOUBLE"})
