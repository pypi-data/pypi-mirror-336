...
class MassiveAutomaticRegression(_MassiveAutoMLBase):
    ...
    def score(self,
        ...
        DataFrame
            ...
            - 1st column, GROUP_ID, group IDs.
            - 2nd column, ID of input data.
            - 3rd column, PREDICTED_VALUE, predicted value.
...
class MassiveAutomaticTimeSeries(_MassiveAutoMLBase):
    ...
    def score(self,
        ...
        DataFrames
            ...
            - 1st column: GROUP_ID, group IDs.
            - 2nd column: ID of input data.
            - 3rd column: SCORE, forecast value.
            - 4th column: REASON CODE, feature attributions (currently all NULLs).
            - 5th & 6th columns: Placeholder columns for future implementations.
