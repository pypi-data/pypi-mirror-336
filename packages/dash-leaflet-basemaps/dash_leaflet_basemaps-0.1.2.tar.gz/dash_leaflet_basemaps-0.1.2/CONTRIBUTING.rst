...
Thank you for your help improving **Dash Leaflet Basemaps**!

**Dash Leaflet Basemaps** uses `nox <https://nox.thea.codes/en/stable/>`__ to automate several development-related tasks.
...
First off, you'll need your own copy of **Dash Leaflet Basemaps** codebase. You can clone it for local development like so:
...
.. code-block:: console
   ...
   git clone https://github.com/<YOUR USERNAME>/dash-leaflet-basemaps
   cd dash-leaflet-basemaps
...
This will install the **Dash Leaflet Basemaps** library, together with two additional tools:
