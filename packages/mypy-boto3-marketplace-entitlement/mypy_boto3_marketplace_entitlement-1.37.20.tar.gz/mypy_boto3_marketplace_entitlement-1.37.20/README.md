...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-marketplace-entitlement)](https://pypistats.org/packages/mypy-boto3-marketplace-entitlement)
...
`mypy-boto3-marketplace-entitlement` dependency in production. However, there
