...
from typing import BinaryIO, Self, TextIO, overload
...
class Basisfunction:
    ...
    @overload
    def evaluate(self, u: np.floating, v: np.floating, u_from_right: bool, v_from_right: bool) -> float: ...
    @overload
    def evaluate(
        self, u: np.floating, v: np.floating, d: int, u_from_right: bool, v_from_right: bool
    ) -> NDArray[np.double]: ...
    @overload
    def evaluate(
        self,
...
class LRSplineObject:
    ...
    def refineBasisFunction(self, i: int | list[int]) -> None: ...
    def refineElement(self, i: int | list[int]) -> None: ...
    ...
    def read(self, stream: BinaryIO | TextIO | bytes | str) -> None: ...
    def copy(self) -> Self: ...
...
class LRSurface(LRSplineObject):
    ...
    @overload
    def point(self, u: np.floating, v: np.floating, *, iEl: int = ...) -> NDArray[np.double]: ...
    @overload
    def point(
        self, u: np.floating, v: np.floating, ufr: bool, vfr: bool, *, iEl: int = ...
    ) -> NDArray[np.double]: ...
    @overload
    def point(self, u: np.floating, v: np.floating, d: int, *, iEl: int = ...) -> NDArray[np.double]: ...
    @overload
    def point(
        self, u: np.floating, v: np.floating, d: int, ufr: bool, vfr: bool, *, iEl: int = ...
    ) -> NDArray[np.double]: ...
...
class LRVolume(LRSplineObject):
    ...
    @overload
    def point(
        self, u: np.floating, v: np.floating, w: np.floating, *, iEl: int = ...
    ) -> NDArray[np.double]: ...
    @overload
    def point(
        self,
    ...
    @overload
    def point(
        self, u: np.floating, v: np.floating, w: np.floating, d: int, *, iEl: int = ...
    ) -> NDArray[np.double]: ...
    @overload
    def point(
        self,
