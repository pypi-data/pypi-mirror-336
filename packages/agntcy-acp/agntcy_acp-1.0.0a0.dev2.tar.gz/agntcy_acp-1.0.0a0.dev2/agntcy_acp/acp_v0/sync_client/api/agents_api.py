...
class AgentsApi:
    ...
    def get_acp_descriptor_by_id(
        ...
        _param = self._get_acp_descriptor_by_id_serialize(
            agent_id=agent_id,
    ...
    def get_acp_descriptor_by_id_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[AgentACPDescriptor]:
        """Get Agent ACP Descriptor from its id
    ...
    def _get_acp_descriptor_by_id_serialize(
        self,
        agent_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/agents/{agent_id}/descriptor',
