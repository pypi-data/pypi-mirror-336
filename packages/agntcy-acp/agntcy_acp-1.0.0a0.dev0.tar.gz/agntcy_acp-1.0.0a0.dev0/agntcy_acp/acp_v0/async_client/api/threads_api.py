...
class ThreadsApi:
    ...
    @validate_call
    async def copy_thread_with_http_info(
        self,
        thread_id: Annotated[StrictStr, Field(description="The ID of the thread.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def copy_thread_without_preload_content(
        self,
        thread_id: Annotated[StrictStr, Field(description="The ID of the thread.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    async def patch_thread_with_http_info(
        self,
        thread_id: Annotated[StrictStr, Field(description="The ID of the thread.")],
        thread_patch: ThreadPatch,
        _request_timeout: Union[
    ...
    @validate_call
    async def patch_thread_without_preload_content(
        self,
        thread_id: Annotated[StrictStr, Field(description="The ID of the thread.")],
        thread_patch: ThreadPatch,
        _request_timeout: Union[
