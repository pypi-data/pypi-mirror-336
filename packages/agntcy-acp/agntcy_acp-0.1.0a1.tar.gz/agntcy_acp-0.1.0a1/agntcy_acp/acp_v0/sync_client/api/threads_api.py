...
class ThreadsApi:
    ...
    @validate_call
    def get_run_threadstate_with_http_info(
        self,
        run_id: Annotated[StrictStr, Field(description="The ID of the run.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_run_threadstate_without_preload_content(
        self,
        run_id: Annotated[StrictStr, Field(description="The ID of the run.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_thread_state_without_preload_content(
        self,
        thread_id: Annotated[StrictStr, Field(description="The ID of the thread.")],
        _request_timeout: Union[
            None,
