...
class AddressChecker:
    ...
    has_trailing_slash: bool = None      # True if the address ends with '/'
    is_html_file:bool = None             # True if the address ends with '.html(#...)?'
    caller_dir:  str  = None             # Current (relative) directory containing the source file
    src_address: str  = None             # Debugging purpose
    univ_address:Path = None             # OS dependent version of the given address to validate
    full_address:Path = None             # OS dependent version of the real path of the address
    anchor:      str  = None             # Any anchor spotted in the address
    ...
    def __validate_hashtag_and_reassign_address_and_anchor(self, address:str):
        ...
        # Handle direct links to anchors in the current file itself:
            ...
            self.address = None         # will indicate that the address is actually valid
