...
class ListResponseInvoiceItemExternal(BaseModel):
  """
    ...
    """
  data: conlist(InvoiceItemExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseInvoiceItemExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseInvoiceItemExternal:
    """Create an instance of ListResponseInvoiceItemExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseInvoiceItemExternal.parse_obj(obj)

    _obj = ListResponseInvoiceItemExternal.parse_obj(
      {
        'data':
