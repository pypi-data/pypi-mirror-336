...
class ListResponseSubscriptionItemExternal(BaseModel):
  """
    ...
    """
  data: conlist(SubscriptionItemExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseSubscriptionItemExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseSubscriptionItemExternal:
    """Create an instance of ListResponseSubscriptionItemExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseSubscriptionItemExternal.parse_obj(obj)

    _obj = ListResponseSubscriptionItemExternal.parse_obj(
      {
        'data':
