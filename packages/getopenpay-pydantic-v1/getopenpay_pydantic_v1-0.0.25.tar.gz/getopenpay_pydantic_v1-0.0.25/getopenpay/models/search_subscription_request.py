...
class SearchSubscriptionRequest(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SearchSubscriptionRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SearchSubscriptionRequest:
    """Create an instance of SearchSubscriptionRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SearchSubscriptionRequest.parse_obj(obj)

    _obj = SearchSubscriptionRequest.parse_obj(
      {
