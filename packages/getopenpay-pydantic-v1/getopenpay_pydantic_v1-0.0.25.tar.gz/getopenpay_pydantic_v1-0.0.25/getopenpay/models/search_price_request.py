...
class SearchPriceRequest(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SearchPriceRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SearchPriceRequest:
    """Create an instance of SearchPriceRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SearchPriceRequest.parse_obj(obj)

    _obj = SearchPriceRequest.parse_obj(
      {
