...
class CreateCouponRequest(BaseModel):
  ...
  duration: Optional[CouponDuration] = Field(
    None,
    description=
  ...
  is_active: Optional[StrictBool] = Field(
    True, description='Whether the coupon is available to be redeemed.'
  )
  ...
  product_family_ids: Optional[conlist(StrictStr)] = None
  product_ids: Optional[conlist(StrictStr)] = None
  redeem_by: Optional[datetime] = None
  trial_days_off: Optional[conint(strict=True, ge=0)] = None
  __properties = [
    'amount_atom_off', 'currency', 'duration', 'duration_in_months', 'is_active', 'max_redemptions',
    'name', 'percent_off', 'product_family_ids', 'product_ids', 'redeem_by', 'trial_days_off'
  ]
