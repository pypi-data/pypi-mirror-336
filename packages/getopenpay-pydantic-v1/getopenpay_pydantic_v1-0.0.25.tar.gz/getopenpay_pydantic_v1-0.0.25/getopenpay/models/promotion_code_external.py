...
class PromotionCodeExternal(BaseModel):
  ...
  __properties = [
    'code', 'coupon', 'coupon_id', 'created_at', 'customer_ids', 'expires_at', 'id', 'is_active',
    'is_deleted', 'max_redemptions', 'max_redemptions_per_customer', 'metadata', 'object',
    'restrictions', 'times_redeemed', 'updated_at'
  ]
