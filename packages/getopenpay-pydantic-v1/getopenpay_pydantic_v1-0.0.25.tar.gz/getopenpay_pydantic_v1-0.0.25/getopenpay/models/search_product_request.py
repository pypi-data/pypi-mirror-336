...
class SearchProductRequest(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SearchProductRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SearchProductRequest:
    """Create an instance of SearchProductRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SearchProductRequest.parse_obj(obj)

    _obj = SearchProductRequest.parse_obj(
      {
