...
class InvoicePublic(BaseModel):
  ...
  __properties = [
    'applied_balance_amount_atom', 'billed_to', 'billed_to_business_name', 'billing_address',
    'branding', 'card_type', 'created_at', 'currency', 'due_amount_atom', 'due_date', 'id',
    'invoice_pdf_url', 'is_initial_invoice_for_trial_sub', 'last_four', 'lines', 'paid_amount_atom',
    'paid_at', 'provider_type_fee_amount_atom', 'receipt_pdf_url', 'remaining_amount_atom',
    'status', 'tax_amount_atom', 'total_amount_atom', 'total_discount_amount_atoms',
