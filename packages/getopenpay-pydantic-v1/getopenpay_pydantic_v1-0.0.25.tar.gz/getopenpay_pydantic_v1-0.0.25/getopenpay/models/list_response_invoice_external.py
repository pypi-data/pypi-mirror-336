...
class ListResponseInvoiceExternal(BaseModel):
  """
    ...
    """
  data: conlist(InvoiceExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseInvoiceExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseInvoiceExternal:
    """Create an instance of ListResponseInvoiceExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseInvoiceExternal.parse_obj(obj)

    _obj = ListResponseInvoiceExternal.parse_obj(
      {
        'data':
