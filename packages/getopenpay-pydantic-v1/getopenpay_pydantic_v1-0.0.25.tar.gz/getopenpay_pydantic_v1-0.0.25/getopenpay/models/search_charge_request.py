...
class SearchChargeRequest(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SearchChargeRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SearchChargeRequest:
    """Create an instance of SearchChargeRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SearchChargeRequest.parse_obj(obj)

    _obj = SearchChargeRequest.parse_obj(
      {
