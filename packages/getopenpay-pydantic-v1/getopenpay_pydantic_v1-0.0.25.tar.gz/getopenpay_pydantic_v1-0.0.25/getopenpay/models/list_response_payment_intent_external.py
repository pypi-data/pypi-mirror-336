...
class ListResponsePaymentIntentExternal(BaseModel):
  """
    ...
    """
  data: conlist(PaymentIntentExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponsePaymentIntentExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponsePaymentIntentExternal:
    """Create an instance of ListResponsePaymentIntentExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponsePaymentIntentExternal.parse_obj(obj)

    _obj = ListResponsePaymentIntentExternal.parse_obj(
      {
        'data':
