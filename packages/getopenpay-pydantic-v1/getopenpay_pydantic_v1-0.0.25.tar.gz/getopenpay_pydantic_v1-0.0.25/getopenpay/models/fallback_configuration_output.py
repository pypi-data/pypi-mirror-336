...
class FallbackConfigurationOutput(BaseModel):
  ...
  price_groups: Optional[conlist(SelectedPriceQuantity)] = None
  ...
  @classmethod
  def from_json(cls, json_str: str) -> FallbackConfigurationOutput:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> FallbackConfigurationOutput:
    """Create an instance of FallbackConfigurationOutput from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return FallbackConfigurationOutput.parse_obj(obj)

    _obj = FallbackConfigurationOutput.parse_obj(
      {
        'fallback_processor_preferences':
          CheckoutProcessorsPreferences.from_dict(obj.get('fallback_processor_preferences'))
          if obj.get('fallback_processor_preferences') is not None else None,
        'price_groups':
          [SelectedPriceQuantity.from_dict(_item) for _item in obj.get('price_groups')]
          if obj.get('price_groups') is not None else None
      }
    )
    return _obj
