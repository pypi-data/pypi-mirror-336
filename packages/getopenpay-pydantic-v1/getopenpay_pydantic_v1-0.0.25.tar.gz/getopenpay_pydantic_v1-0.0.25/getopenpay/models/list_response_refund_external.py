...
class ListResponseRefundExternal(BaseModel):
  """
    ...
    """
  data: conlist(RefundExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseRefundExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseRefundExternal:
    """Create an instance of ListResponseRefundExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseRefundExternal.parse_obj(obj)

    _obj = ListResponseRefundExternal.parse_obj(
      {
        'data':
