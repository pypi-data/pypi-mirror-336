...
class UpdateCustomerRequest(BaseModel):
  ...
  __properties = [
    'billing_email', 'business_name', 'city', 'country', 'coupon_id', 'custom_fields', 'email',
    'first_name', 'invoice_settings', 'language', 'last_name', 'line1', 'line2', 'line3', 'notes',
    'phone_number', 'promotion_code_id', 'shipping_addresses', 'state', 'zip_code'
  ]
  ...
  @classmethod
  def from_json(cls, json_str: str) -> UpdateCustomerRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> UpdateCustomerRequest:
    """Create an instance of UpdateCustomerRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return UpdateCustomerRequest.parse_obj(obj)

    _obj = UpdateCustomerRequest.parse_obj(
      {
