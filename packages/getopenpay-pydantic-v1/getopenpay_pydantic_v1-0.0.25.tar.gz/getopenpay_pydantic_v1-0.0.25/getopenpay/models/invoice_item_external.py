...
class InvoiceItemExternal(BaseModel):
  ...
  discount_amount_atoms: conlist(InvoiceItemDiscountAmountsExternal) = Field(...)
  ...
  period_start: datetime = Field(
    ..., description="Start of the usage period of the invoice_item. It is in 'ISO 8601' format."
  )
  ...
  __properties = [
    'account_id', 'amount_atom', 'amount_atom_considering_discount_applied', 'created_at',
    'currency', 'customer_id', 'description', 'discount_amount_atoms', 'discounts', 'id',
    'invoice_id', 'is_deleted', 'object', 'period_end', 'period_start', 'price_id', 'price_type',
    'product_id', 'proration', 'proration_details_debit_invoice_item', 'quantity',
    'subscription_cancelled_at', 'subscription_id', 'subscription_item_id', 'updated_at'
  ]
    ...
    _obj = InvoiceItemExternal.parse_obj(
      {
        ...
        'discount_amount_atoms':
          [
            InvoiceItemDiscountAmountsExternal.from_dict(_item)
