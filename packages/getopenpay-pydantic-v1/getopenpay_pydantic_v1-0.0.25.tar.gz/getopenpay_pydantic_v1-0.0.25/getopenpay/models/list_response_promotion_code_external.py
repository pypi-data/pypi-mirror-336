...
class ListResponsePromotionCodeExternal(BaseModel):
  """
    ...
    """
  data: conlist(PromotionCodeExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponsePromotionCodeExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponsePromotionCodeExternal:
    """Create an instance of ListResponsePromotionCodeExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponsePromotionCodeExternal.parse_obj(obj)

    _obj = ListResponsePromotionCodeExternal.parse_obj(
      {
        'data':
