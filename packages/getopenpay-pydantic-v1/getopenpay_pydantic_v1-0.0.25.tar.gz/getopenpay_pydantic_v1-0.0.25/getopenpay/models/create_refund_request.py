...
class CreateRefundRequest(BaseModel):
  ...
  description: Optional[StrictStr] = Field(
    'Manually triggered refund by admin.', description='Description of the refund.'
  )
  payment_intent_id: Optional[StrictStr] = None
  reason: Optional[RefundReasonEnum] = Field(None, description='Reason of the refund.')
  __properties = [
    'amount_atom', 'charge_id', 'currency', 'description', 'payment_intent_id', 'reason'
  ]
