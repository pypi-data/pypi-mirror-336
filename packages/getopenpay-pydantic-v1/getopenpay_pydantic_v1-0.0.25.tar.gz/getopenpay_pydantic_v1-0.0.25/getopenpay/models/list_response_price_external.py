...
class ListResponsePriceExternal(BaseModel):
  """
    ...
    """
  data: conlist(PriceExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponsePriceExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponsePriceExternal:
    """Create an instance of ListResponsePriceExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponsePriceExternal.parse_obj(obj)

    _obj = ListResponsePriceExternal.parse_obj(
      {
        'data':
