...
class ListResponseCustomerExternal(BaseModel):
  """
    ...
    """
  data: conlist(CustomerExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseCustomerExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseCustomerExternal:
    """Create an instance of ListResponseCustomerExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseCustomerExternal.parse_obj(obj)

    _obj = ListResponseCustomerExternal.parse_obj(
      {
        'data':
