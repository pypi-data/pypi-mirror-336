...
class DateTimeFilter(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> DateTimeFilter:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> DateTimeFilter:
    """Create an instance of DateTimeFilter from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return DateTimeFilter.parse_obj(obj)

    _obj = DateTimeFilter.parse_obj(
      {
        'eq': obj.get('eq'),
        'gt': obj.get('gt'),
        'gte': obj.get('gte'),
