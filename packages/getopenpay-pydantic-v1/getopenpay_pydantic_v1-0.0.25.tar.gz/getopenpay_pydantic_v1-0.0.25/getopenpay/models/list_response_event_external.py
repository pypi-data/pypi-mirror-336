...
class ListResponseEventExternal(BaseModel):
  """
    ...
    """
  data: conlist(EventExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseEventExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseEventExternal:
    """Create an instance of ListResponseEventExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseEventExternal.parse_obj(obj)

    _obj = ListResponseEventExternal.parse_obj(
      {
        'data':
