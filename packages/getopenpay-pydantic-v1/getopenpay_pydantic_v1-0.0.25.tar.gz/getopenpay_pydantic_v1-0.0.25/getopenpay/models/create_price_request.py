...
class CreatePriceRequest(BaseModel):
  """
    CreatePriceRequest
    """
  aggregate_usage: Optional[UsageAggMethodEnum] = Field(
    None, description="Specifies a usage aggregation strategy for prices of usage_type 'metered'."
  )
  ...
  currency: Optional[CurrencyEnum] = Field(
    None, description='Three-letter ISO currency code, in lowercase.'
  )
  ...
  pricing_model: PricingModel = Field(
    ..., description='Indicates which pricing model to be used for product.'
  )
  ...
  __properties = [
    'aggregate_usage', 'billing_interval', 'billing_interval_count', 'can_only_be_purchased_with',
    'contract_auto_renew', 'contract_term_multiple', 'currency', 'default_net_d',
    'internal_description', 'is_active', 'is_default', 'is_exclusive',
    'listed_exclusively_for_customers', 'meta', 'meter_id', 'name', 'price_tiers', 'price_type',
    'pricing_model', 'product_id', 'transform_quantity_divide_by', 'trial_period_days',
    'unit_amount_atom', 'usage_type'
  ]
