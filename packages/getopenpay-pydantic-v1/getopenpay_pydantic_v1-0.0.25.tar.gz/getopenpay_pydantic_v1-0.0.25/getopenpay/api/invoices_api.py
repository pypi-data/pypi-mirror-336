...
class InvoicesApi:
  ...
  def add_comment(
    ...
    add_comment_request: AddCommentRequest, **kwargs
    ...
    return self.add_comment_with_http_info(
      invoice_external_id, add_comment_request, **kwargs
    )  # noqa: E501
  ...
  def add_comment_with_http_info(
    ...
    _all_params = ['invoice_external_id', 'add_comment_request']
    _all_params.extend(
      [
    ...
    return self.api_client.call_api(
      '/invoices/{invoice_external_id}/comment',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  def get_invoice_with_http_info(
    ...
    **kwargs
    ...
    _all_params = ['invoice_external_id', 'expand']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def mark_invoice_as_uncollectible(
    ...
    invoice_external_id: Annotated[StrictStr,
                                   Field(..., description='Unique identifier of the invoice.')],
    mark_uncollectible_request: MarkUncollectibleRequest, **kwargs
  ) -> InvoiceExternal:  # noqa: E501
    ...
    return self.mark_invoice_as_uncollectible_with_http_info(
      invoice_external_id, mark_uncollectible_request, **kwargs
    )  # noqa: E501
  ...
  def mark_invoice_as_uncollectible_with_http_info(
    ...
    _all_params = ['invoice_external_id', 'mark_uncollectible_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def mark_invoice_as_void(
    ...
    invoice_external_id: Annotated[StrictStr,
                                   Field(..., description='Unique identifier of the invoice.')],
    mark_void_request: MarkVoidRequest, **kwargs
  ) -> InvoiceExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.mark_invoice_as_void_with_http_info(
      invoice_external_id, mark_void_request, **kwargs
    )  # noqa: E501
  ...
  def mark_invoice_as_void_with_http_info(
    ...
    _all_params = ['invoice_external_id', 'mark_void_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def preview_next_invoice(
    self, subscription_id: StrictStr, **kwargs
  ) -> InvoiceExternal:  # noqa: E501
  ...
  def preview_next_invoice_with_http_info(
    ...
    return self.api_client.call_api(
      '/invoices/preview_next_invoice/{subscription_id}',
      'GET',
      _path_params,
      _query_params,
      _header_params,
