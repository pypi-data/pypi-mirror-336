...
class SubscriptionsApi:
  ...
  def cancel_subscription_trial(
    ...
    **kwargs
  ) -> SubscriptionExternal:  # noqa: E501
  ...
  def cancel_subscription_trial_with_http_info(
    ...
    **kwargs
    ...
    return self.api_client.call_api(
      '/subscriptions/{subscription_id}/cancel-subscription-trial',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  def create_subscriptions(
    self, create_subscription_request: CreateSubscriptionRequest, **kwargs
  ) -> CreateSubscriptionResponse:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.create_subscriptions_with_http_info(
  ...
  def create_subscriptions_with_http_info(
    ...
    _all_params = ['create_subscription_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def delete_subscription(
    ...
    **kwargs
  ) -> DeleteSubscriptionResponse:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.delete_subscription_with_http_info(
      subscription_id, delete_subscription_request, **kwargs
    )  # noqa: E501
  ...
  def delete_subscription_with_http_info(
    ...
    **kwargs
    ...
    _all_params = ['subscription_id', 'delete_subscription_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def list_subscriptions(
    self, subscription_query_params: SubscriptionQueryParams, **kwargs
  ) -> ListResponseSubscriptionExternal:  # noqa: E501
  ...
  def list_subscriptions_with_http_info(
    ...
    _all_params = ['subscription_query_params']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def pause_subscription(
    ...
    subscription_id: Annotated[StrictStr,
                               Field(..., description='Unique identifier of the subscription.')],
    subscription_pause_request: SubscriptionPauseRequest, **kwargs
  ) -> SubscriptionExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.pause_subscription_with_http_info(
      subscription_id, subscription_pause_request, **kwargs
    )  # noqa: E501
  ...
  def pause_subscription_with_http_info(
    ...
    _all_params = ['subscription_id', 'subscription_pause_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def refresh_subscription_status_with_http_info(
    ...
    **kwargs
    ...
    return self.api_client.call_api(
      '/subscriptions/{subscription_id}/refresh-status',
      'POST',
      _path_params,
      _query_params,
      _header_params,
  ...
  def resume_subscription(
    ...
    subscription_id: Annotated[StrictStr,
                               Field(..., description='Unique identifier of the subscription.')],
    subscription_resume_request: SubscriptionResumeRequest, **kwargs
  ) -> ResumeSubscriptionResponse:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.resume_subscription_with_http_info(
      subscription_id, subscription_resume_request, **kwargs
    )  # noqa: E501
  ...
  def resume_subscription_with_http_info(
    ...
    _all_params = ['subscription_id', 'subscription_resume_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def search_subscriptions(
    self, search_subscription_request: SearchSubscriptionRequest, **kwargs
  ) -> ListResponseSubscriptionExternal:  # noqa: E501
    """Search Subscriptions  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.search_subscriptions(search_subscription_request, async_req=True)
        >>> result = thread.get()
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.search_subscriptions_with_http_info(
      search_subscription_request, **kwargs
    )  # noqa: E501
  ...
  def search_subscriptions_with_http_info(
    ...
    """Search Subscriptions  # noqa: E501
        ...
        >>> thread = api.search_subscriptions_with_http_info(search_subscription_request, async_req=True)
        >>> result = thread.get()
    ...
    _all_params = ['search_subscription_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
    ...
    # process the body parameter
    _body_params = None
    if _params['search_subscription_request'] is not None:
      _body_params = _params['search_subscription_request']
  ...
  def update_subscription(
    ...
    subscription_id: Annotated[StrictStr,
                               Field(..., description='Unique identifier of the subscription.')],
    update_subscription_request: UpdateSubscriptionRequest, **kwargs
    ...
    return self.update_subscription_with_http_info(
      subscription_id, update_subscription_request, **kwargs
    )  # noqa: E501
  ...
  def update_subscription_with_http_info(
    ...
    _all_params = ['subscription_id', 'update_subscription_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
