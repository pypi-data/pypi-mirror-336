...
class CreditNotesApi:
  ...
  def create_credit_note(
    self, create_credit_note_request: CreateCreditNoteRequest, **kwargs
  ) -> CreditNoteExternal:  # noqa: E501
    ...
    return self.create_credit_note_with_http_info(
      create_credit_note_request, **kwargs
    )  # noqa: E501
  ...
  def create_credit_note_with_http_info(
    ...
    _all_params = ['create_credit_note_request']
    _all_params.extend(
      [
  ...
  def list_credit_notes(
    self, credit_note_query_params: CreditNoteQueryParams, **kwargs
  ) -> ListResponseCreditNoteExternal:  # noqa: E501
  ...
  def list_credit_notes_with_http_info(
    ...
    _all_params = ['credit_note_query_params']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
