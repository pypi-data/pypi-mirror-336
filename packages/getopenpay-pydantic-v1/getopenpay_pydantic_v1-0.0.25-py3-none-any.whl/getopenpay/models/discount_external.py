...
class DiscountExternal(BaseModel):
  ...
  __properties = [
    'coupon', 'coupon_id', 'created_at', 'customer_id', 'end_date', 'id', 'invoice_id',
    'invoice_item_id', 'is_deleted', 'object', 'promotion_code', 'promotion_code_id', 'start_date',
    ...
    _obj = DiscountExternal.parse_obj(
      {
        ...
        'promotion_code':
          PromotionCodeExternal.from_dict(obj.get('promotion_code'))
          if obj.get('promotion_code') is not None else None,
