...
class ActiveSubResponse(BaseModel):
  """
    ActiveSubResponse
    """
  has_active_subscriptions: StrictBool = Field(...)
  subscriptions: conlist(SubscriptionExternal) = Field(...)
  __properties = ['has_active_subscriptions', 'subscriptions']
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ActiveSubResponse:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ActiveSubResponse:
    """Create an instance of ActiveSubResponse from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ActiveSubResponse.parse_obj(obj)

    _obj = ActiveSubResponse.parse_obj(
      {
