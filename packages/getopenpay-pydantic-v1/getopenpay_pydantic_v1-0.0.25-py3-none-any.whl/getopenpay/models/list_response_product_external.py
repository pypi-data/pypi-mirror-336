...
class ListResponseProductExternal(BaseModel):
  """
    ...
    """
  data: conlist(ProductExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseProductExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseProductExternal:
    """Create an instance of ListResponseProductExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseProductExternal.parse_obj(obj)

    _obj = ListResponseProductExternal.parse_obj(
      {
        'data':
