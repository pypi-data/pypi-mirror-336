...
class PriceExternal(BaseModel):
  ...
  __properties = [
    'billing_interval', 'billing_interval_count', 'billing_scheme', 'can_only_be_purchased_with',
    'contract_auto_renew', 'contract_term_multiple', 'created_at', 'currency',
    'eligible_for_updates', 'id', 'internal_description', 'invoice_settings', 'is_active',
    'is_default', 'is_deleted', 'is_exclusive', 'is_licensed', 'listed_exclusively_for_customers',
    'metadata', 'meter_id', 'name', 'object', 'optional_add_ons', 'price_tiers', 'price_type',
    'product', 'product_id', 'product_name', 'recurring_details', 'tiers_mode',
    'transform_quantity_divide_by', 'unit_amount_atom', 'updated_at'
  ]
...
PriceExternal.update_forward_refs()
