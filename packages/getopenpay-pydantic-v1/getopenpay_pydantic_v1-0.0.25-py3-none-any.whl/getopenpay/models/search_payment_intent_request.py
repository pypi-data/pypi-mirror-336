...
class SearchPaymentIntentRequest(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SearchPaymentIntentRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SearchPaymentIntentRequest:
    """Create an instance of SearchPaymentIntentRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SearchPaymentIntentRequest.parse_obj(obj)

    _obj = SearchPaymentIntentRequest.parse_obj(
      {
