...
class SearchCustomerRequest(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> SearchCustomerRequest:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> SearchCustomerRequest:
    """Create an instance of SearchCustomerRequest from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return SearchCustomerRequest.parse_obj(obj)

    _obj = SearchCustomerRequest.parse_obj(
      {
