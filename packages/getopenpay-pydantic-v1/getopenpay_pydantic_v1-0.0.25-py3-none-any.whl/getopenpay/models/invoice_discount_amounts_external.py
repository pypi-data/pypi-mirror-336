...
class InvoiceDiscountAmountsExternal(BaseModel):
  ...
  @classmethod
  def from_json(cls, json_str: str) -> InvoiceDiscountAmountsExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> InvoiceDiscountAmountsExternal:
    """Create an instance of InvoiceDiscountAmountsExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return InvoiceDiscountAmountsExternal.parse_obj(obj)

    _obj = InvoiceDiscountAmountsExternal.parse_obj(
      {
