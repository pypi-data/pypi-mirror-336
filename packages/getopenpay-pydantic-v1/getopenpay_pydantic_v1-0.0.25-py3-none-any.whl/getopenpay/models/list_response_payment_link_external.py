...
class ListResponsePaymentLinkExternal(BaseModel):
  """
    ...
    """
  data: conlist(PaymentLinkExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponsePaymentLinkExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponsePaymentLinkExternal:
    """Create an instance of ListResponsePaymentLinkExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponsePaymentLinkExternal.parse_obj(obj)

    _obj = ListResponsePaymentLinkExternal.parse_obj(
      {
        'data':
