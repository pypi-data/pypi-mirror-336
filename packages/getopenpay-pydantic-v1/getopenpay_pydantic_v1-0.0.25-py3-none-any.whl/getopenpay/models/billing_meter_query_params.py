...
class BillingMeterQueryParams(BaseModel):
  ...
  __properties = [
    'created_at', 'expand', 'is_active', 'page_number', 'page_size', 'sort_descending', 'sort_key',
    'updated_at'
  ]
  ...
  @classmethod
  def from_json(cls, json_str: str) -> BillingMeterQueryParams:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> BillingMeterQueryParams:
    """Create an instance of BillingMeterQueryParams from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return BillingMeterQueryParams.parse_obj(obj)

    _obj = BillingMeterQueryParams.parse_obj(
      {
        'created_at':
