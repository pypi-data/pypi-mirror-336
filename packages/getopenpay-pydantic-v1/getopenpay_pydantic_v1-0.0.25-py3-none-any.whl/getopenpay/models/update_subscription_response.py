...
class UpdateSubscriptionResponse(BaseModel):
  """
    ...
    """
  invoices: conlist(InvoiceExternal) = Field(...)
  renewal_invoices: Optional[conlist(InvoiceExternal)] = None
    ...
    _obj = UpdateSubscriptionResponse.parse_obj(
      {
        ...
        'renewal_invoices':
          [InvoiceExternal.from_dict(_item) for _item in obj.get('renewal_invoices')]
          if obj.get('renewal_invoices') is not None else None,
        'subscriptions':
