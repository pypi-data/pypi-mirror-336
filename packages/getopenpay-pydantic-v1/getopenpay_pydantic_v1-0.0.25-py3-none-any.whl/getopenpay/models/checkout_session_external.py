...
class CheckoutSessionExternal(BaseModel):
  ...
  __properties = [
    'account_id', 'account_name', 'amount_subtotal_atom', 'amount_total_atom',
    'client_reference_id', 'coupon_id', 'created_at', 'currency', 'customer_email', 'customer_id',
    'id', 'is_deleted', 'line_items', 'mode', 'object', 'return_url', 'secure_token',
    'setup_intent', 'status', 'subscription_id', 'success_url', 'tax_amount_atom', 'trial_end',
    'trial_from_price', 'trial_period_days', 'updated_at', 'url'
  ]
    ...
    _obj = CheckoutSessionExternal.parse_obj(
      {
        ...
        'setup_intent':
          SetupIntentExternal.from_dict(obj.get('setup_intent'))
          if obj.get('setup_intent') is not None else None,
