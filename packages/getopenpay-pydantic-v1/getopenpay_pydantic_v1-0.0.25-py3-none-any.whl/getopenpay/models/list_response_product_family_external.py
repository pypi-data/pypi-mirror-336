...
class ListResponseProductFamilyExternal(BaseModel):
  """
    ...
    """
  data: conlist(ProductFamilyExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseProductFamilyExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseProductFamilyExternal:
    """Create an instance of ListResponseProductFamilyExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseProductFamilyExternal.parse_obj(obj)

    _obj = ListResponseProductFamilyExternal.parse_obj(
      {
        'data':
          [ProductFamilyExternal.from_dict(_item) for _item in obj.get('data')]
