...
class PriceTierPublic(BaseModel):
  ...
  __properties = ['flat_amount_atom', 'unit_amount_atom', 'units_upto']
  ...
  @classmethod
  def from_json(cls, json_str: str) -> PriceTierPublic:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> PriceTierPublic:
    """Create an instance of PriceTierPublic from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return PriceTierPublic.parse_obj(obj)

    _obj = PriceTierPublic.parse_obj(
      {
