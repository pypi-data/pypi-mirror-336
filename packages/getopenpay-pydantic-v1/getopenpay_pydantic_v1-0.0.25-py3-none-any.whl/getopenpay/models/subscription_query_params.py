...
class SubscriptionQueryParams(BaseModel):
  ...
  statuses: Optional[conlist(SubscriptionStatusEnum)] = None
  updated_at: Optional[DateTimeFilter] = None
  __properties = [
    'coupon_id', 'created_at', 'current_period_end', 'current_period_start', 'customer_id',
    'expand', 'page_number', 'page_size', 'price_id', 'product_id', 'search', 'sort_descending',
    'sort_key', 'statuses', 'updated_at'
  ]
