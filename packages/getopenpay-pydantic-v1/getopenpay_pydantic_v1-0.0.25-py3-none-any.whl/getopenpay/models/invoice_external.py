...
class InvoiceExternal(BaseModel):
  ...
  collection_method: CollectionMethodEnum = Field(
    ..., description='Indicates method of payment collection of the invoice.'
  )
  ...
  email_invoice_on_finalization: Optional[StrictBool] = Field(
    False, description='Whether invoice should be sent to the customer upon finalizing the invoice'
  )
  ...
  provider_type_fee_amount_atom: StrictInt = Field(
    ..., description='Total fee amount charged for the payment provider type in atomic units.'
  )
  ...
  total_excluding_taxes_amount_atom: StrictInt = Field(
    ..., description='Total amount excluding taxes. It is in atomic units (in USD this is cents).'
  )
  updated_at: datetime = Field(
    ..., description="DateTime at which the object was updated, in 'ISO 8601' format."
  )
  __properties = [
    'account_id', 'applied_balance_amount_atom', 'billing_reason', 'collection_method', 'comments',
    'created_at', 'credit_note_ids', 'currency', 'custom_fields', 'customer', 'customer_id',
    'default_payment_method_id', 'description', 'discounts', 'due_amount_atom', 'due_date',
    'email_invoice_on_finalization', 'hosted_invoice_url', 'id', 'invoice_number',
    'invoice_pdf_url', 'is_deleted', 'is_initial_invoice_for_trial_sub',
    'latest_payment_attempt_failure_message', 'latest_payment_intent_id', 'lines', 'metadata',
    'net_d', 'object', 'paid_amount_atom', 'paid_at', 'paid_out_of_band', 'period_end',
    'period_start', 'post_payment_credit_notes_amount', 'pre_payment_credit_notes_amount',
    'provider_type_fee_amount_atom', 'receipt_pdf_url', 'refund_ids', 'refunded_amount_atom',
    'remaining_amount_atom', 'status', 'subscription', 'subscription_id', 'tax_amount_atom',
    'tax_processor_updated_at', 'total_amount_atom', 'total_discount_amount_atoms',
