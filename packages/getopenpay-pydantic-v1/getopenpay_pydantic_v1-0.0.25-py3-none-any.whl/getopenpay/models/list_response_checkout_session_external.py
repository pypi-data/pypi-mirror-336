...
class ListResponseCheckoutSessionExternal(BaseModel):
  """
    ...
    """
  data: conlist(CheckoutSessionExternal) = Field(...)
  ...
  @classmethod
  def from_json(cls, json_str: str) -> ListResponseCheckoutSessionExternal:
  ...
  @classmethod
  def from_dict(cls, obj: dict) -> ListResponseCheckoutSessionExternal:
    """Create an instance of ListResponseCheckoutSessionExternal from a dict"""
    if obj is None:
      return None

    if not isinstance(obj, dict):
      return ListResponseCheckoutSessionExternal.parse_obj(obj)

    _obj = ListResponseCheckoutSessionExternal.parse_obj(
      {
        'data':
