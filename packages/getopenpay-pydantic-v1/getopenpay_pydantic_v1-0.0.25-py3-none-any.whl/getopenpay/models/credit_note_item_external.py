...
class CreditNoteItemExternal(BaseModel):
  ...
  quantity: Optional[StrictInt] = Field(1, description='Quantity of the product being credited.')
  type: CreditNoteLineType = Field(
    ...,
    description=
  ...
  __properties = [
    'amount_atom', 'created_at', 'currency', 'id', 'invoice_item_id', 'is_deleted', 'object',
    'quantity', 'type', 'unit_amount_atom', 'updated_at'
  ]
