...
class TokenizedCreditCardExternal(BaseModel):
  ...
  mappings: Optional[conlist(PaymentMethodMappingExternal)] = None
  metadata: Optional[Dict[str, Any]] = None
  object: Optional[ObjectName] = None
  provider: PaymentProviderType = Field(
    ..., description='The provider type for this payment method'
  )
  updated_at: datetime = Field(
    ..., description="DateTime at which the object was updated, in 'ISO 8601' format."
  )
  __properties = [
    'billing_address', 'card_brand', 'card_country', 'card_fingerprint', 'card_iin', 'card_issuer',
    'card_type', 'cde_external_id', 'created_at', 'customer_id', 'display_name', 'expiry_date',
    'id', 'is_deleted', 'is_full_details_known', 'last_four', 'mappings', 'metadata', 'object',
    'provider', 'updated_at'
  ]
    ...
    _obj = TokenizedCreditCardExternal.parse_obj(
      {
        ...
        'mappings':
          [PaymentMethodMappingExternal.from_dict(_item) for _item in obj.get('mappings')]
          if obj.get('mappings') is not None else None,
