...
class SubscriptionItemsApi:
  ...
  def create_subscription_item(
    self, create_subscription_item_request: CreateSubscriptionItemRequest, **kwargs
  ) -> SubscriptionItemExternal:  # noqa: E501
    ...
    return self.create_subscription_item_with_http_info(
      create_subscription_item_request, **kwargs
    )  # noqa: E501
  ...
  def create_subscription_item_with_http_info(
    ...
    _all_params = ['create_subscription_item_request']
    _all_params.extend(
      [
  ...
  def delete_subscription_item(
    self, subscription_item_id: Annotated[
      StrictStr, Field(..., description='Unique identifier of the subscription_item.')],
    delete_subscription_item_request: DeleteSubscriptionItemRequest, **kwargs
  ) -> DeleteSubscriptionItemResponse:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.delete_subscription_item_with_http_info(
      subscription_item_id, delete_subscription_item_request, **kwargs
    )  # noqa: E501
  ...
  def delete_subscription_item_with_http_info(
    ...
    _all_params = ['subscription_item_id', 'delete_subscription_item_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
    ...
    return self.api_client.call_api(
      '/subscription-items/{subscription_item_id}',
      'DELETE',
      _path_params,
      _query_params,
      _header_params,
  ...
  def get_subscription_item(
    self, subscription_item_id: Annotated[
      StrictStr, Field(..., description='Unique identifier of the subscription_item.')], **kwargs
  ) -> SubscriptionItemExternal:  # noqa: E501
  ...
  def get_subscription_item_with_http_info(
    ...
    _all_params = ['subscription_item_id']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def list_subscription_items(
    self, subscription_item_query_params: SubscriptionItemQueryParams, **kwargs
  ) -> ListResponseSubscriptionItemExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.list_subscription_items_with_http_info(
      subscription_item_query_params, **kwargs
    )  # noqa: E501
  ...
  def list_subscription_items_with_http_info(
    ...
    _all_params = ['subscription_item_query_params']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
  ...
  def update_subscription_item(
    self, subscription_item_id: Annotated[
      StrictStr, Field(..., description='Unique identifier of the subscription_item.')],
    update_subscription_item_request: UpdateSubscriptionItemRequest, **kwargs
  ) -> SubscriptionItemExternal:  # noqa: E501
    ...
    if '_preload_content' in kwargs:
      ...
      raise ValueError(message)
    return self.update_subscription_item_with_http_info(
      subscription_item_id, update_subscription_item_request, **kwargs
    )  # noqa: E501
  ...
  def update_subscription_item_with_http_info(
    ...
    _all_params = ['subscription_item_id', 'update_subscription_item_request']
    _all_params.extend(
      [
        'async_req', '_return_http_data_only', '_preload_content', '_request_timeout',
        '_request_auth', '_content_type', '_headers'
