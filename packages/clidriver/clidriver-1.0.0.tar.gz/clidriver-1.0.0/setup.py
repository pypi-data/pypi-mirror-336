...
setup(name='clidriver',
version='1.0.0',
author='Yumito',
author_email='609029250@qq.com',
description=f'Cli driver for linux',
# long_description=open('README.md','r',encoding='utf-8').read(),
long_description_content_type='text/markdown',  
# url='https://github.com/Hello-Mr-Crab/pywechat',
packages=find_packages(),
license='Apache-2.0',
keywords=['cli','linux','wechat','automation'],
install_requires=[
'python-socketio>=5.12.1','websocket-client>=1.8.0','websockets>=13.1']
)
