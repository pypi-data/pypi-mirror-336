...
def tj_resource_details_table(m: models.DescribeTJResourceDetailReply):
    table = PrettyTable()
    table.field_names = ["GPU卡型号", "剩余可用卡数"]
    for d in m.TJResourceDetail:
        table.add_row([d.GpuType, d.Available])
    return table
...
models.DescribeTJResourceDetailReply.__repr__ = tj_resource_details_table_str
models.DescribeTJResourceDetailReply._repr_html_ = tj_resource_details_table_html
