...
class CommonClient(AbstractClient):
    ...
    def __init__(self, service, version, credential, region, profile=None):
        ...
        :type credential: tikit.tencentcloud.common.credential.Credential or tikit.tencentcloud.common.credential.STSAssumeRoleCredential
        :param region: 接口调用地域
        :type region: str
        :param version: 接口版本
        :type version: str
        ...
        :type profile: tikit.tencentcloud.common.profile.client_profile.ClientProfile
        """
