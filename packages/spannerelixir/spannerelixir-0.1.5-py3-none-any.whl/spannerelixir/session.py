"""
Session management for SpannerElixir.
"""
...
from spannerelixir.exceptions import ConnectionError, TransactionError
from spannerelixir.model import SpannerModel
from spannerelixir.query import Query
...
class SpannerSession:
    ...
    def save(self, model: SpannerModel) -> SpannerModel:
        """
    ...
    def update(self, model: SpannerModel) -> SpannerModel:
        """
    ...
    def delete(self, model: SpannerModel) -> bool:
        """
        ...
        """
        try:
            return model.delete(self.database)
        except Exception as e:
