...
class DateLineWrapperCase(unittest.TestCase):
    def test_wrap(self):
        ...
        self.assertEqual(len(wrapped_multi_point.get_points()), 3)
        ...
        self.assertEqual(len(wrapped_polygons), 2)
        ...
        self.assertEqual(len(wrapped_polygons), 1)
        ...
        self.assertEqual(len(wrapped_interior_ring), 4)
        self.assertEqual(len(wrapped_interior_ring_flags), 4)
        ...
        self.assertEqual(len(wrapped_polylines), 3)
        ...
        self.assertEqual(len(wrapped_polylines), 1)
        ...
        wrapped_polylines = date_line_wrapper.wrap(polyline)
        self.assertEqual(len(wrapped_polylines), 2)
        self.assertEqual(len(wrapped_polylines[0].get_points()), 2)
        self.assertEqual(len(wrapped_polylines[1].get_points()), 2)
        self.assertEqual(wrapped_polylines[0].get_is_original_point_flags(), [True, False])
        self.assertEqual(wrapped_polylines[1].get_is_original_point_flags(), [False, True])
        wrapped_polylines = date_line_wrapper.wrap(polyline, 4)
        self.assertEqual(len(wrapped_polylines), 2)
        self.assertEqual(len(wrapped_polylines[0].get_points()), 4)
        self.assertEqual(len(wrapped_polylines[1].get_points()), 4)
        self.assertEqual(wrapped_polylines[0].get_is_original_point_flags(), [True, False, False, False])
        self.assertEqual(wrapped_polylines[1].get_is_original_point_flags(), [False, False, False, True])
        wrapped_polylines = date_line_wrapper_90.wrap(polyline)
        self.assertEqual(len(wrapped_polylines), 1)
        self.assertEqual(len(wrapped_polylines[0].get_points()), 2)
        self.assertEqual(wrapped_polylines[0].get_is_original_point_flags(), [True, True])
        wrapped_polylines = date_line_wrapper_90.wrap(polyline, 6)
        self.assertEqual(len(wrapped_polylines), 1)
        self.assertEqual(len(wrapped_polylines[0].get_points()), 5)
        self.assertEqual(wrapped_polylines[0].get_is_original_point_flags(), [True, False, False, False, True])

        # Test polygon tessellation.
        polygon = pygplates.PolygonOnSphere([(1, 170), (1, -170), (-1, -170), (-1, 170)])
        wrapped_polygons = date_line_wrapper.wrap(polygon)
        self.assertEqual(len(wrapped_polygons), 2)
        self.assertEqual(len(wrapped_polygons[0].get_exterior_points()), 4)
        self.assertEqual(len(wrapped_polygons[1].get_exterior_points()), 4)
        self.assertEqual(len(wrapped_polygons[0].get_is_original_exterior_point_flags()), 4)
        self.assertEqual(len(wrapped_polygons[1].get_is_original_exterior_point_flags()), 4)
        self.assertEqual(len(wrapped_polygons[0].get_points()), 4)
        self.assertEqual(len(wrapped_polygons[1].get_points()), 4)
        self.assertEqual(len(wrapped_polygons[0].get_is_original_point_flags()), 4)
        self.assertEqual(len(wrapped_polygons[1].get_is_original_point_flags()), 4)
        wrapped_polygons = date_line_wrapper.wrap(polygon, 4)
        self.assertEqual(len(wrapped_polygons), 2)
        self.assertEqual(len(wrapped_polygons[0].get_exterior_points()), 8)
        self.assertEqual(len(wrapped_polygons[1].get_exterior_points()), 8)
        self.assertEqual(len(wrapped_polygons[0].get_is_original_exterior_point_flags()), 8)
        self.assertEqual(len(wrapped_polygons[1].get_is_original_exterior_point_flags()), 8)
        wrapped_polygons = date_line_wrapper_90.wrap(polygon)
        self.assertEqual(len(wrapped_polygons), 1)
        self.assertEqual(len(wrapped_polygons[0].get_exterior_points()), 4)
        self.assertEqual(len(wrapped_polygons[0].get_is_original_exterior_point_flags()), 4)
        ...
        self.assertEqual(len(wrapped_polygons), 1)
        self.assertEqual(len(wrapped_polygons[0].get_exterior_points()), 10)
        self.assertEqual(len(wrapped_polygons[0].get_is_original_exterior_point_flags()), 10)
...
class GreatCircleArcCase(unittest.TestCase):
    ...
    def test_get(self):
        self.assertEqual(self.gca.get_start_point(), self.start_point)
        self.assertEqual(self.gca.get_end_point(), self.end_point)
    ...
    def test_uniform_points(self):
        uniform_points = self.gca.to_uniform_points(math.radians(10), first_point_spacing_radians=math.radians(5))
        self.assertTrue(len(uniform_points) == 9)
        for i in range(len(uniform_points)):
            self.assertTrue(uniform_points[i] == pygplates.PointOnSphere(5 + i * 10, 90))
