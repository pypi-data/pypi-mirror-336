...
#include "ExportImageOptionsWidget.h"

#include "QtWidgetUtils.h"


GPlatesQtWidgets::ExportImageOptionsWidget::ExportImageOptionsWidget(
		QWidget *parent_,
...
GPlatesQtWidgets::ExportImageOptionsWidget::create_export_animation_strategy_configuration(
		const QString &filename_template)
{
	...
	return GPlatesGui::ExportImageAnimationStrategy::const_configuration_ptr(
			new GPlatesGui::ExportImageAnimationStrategy::Configuration(
