...
#ifndef GPLATES_QTWIDGETS_EDITDOUBLEWIDGET_H
#define GPLATES_QTWIDGETS_EDITDOUBLEWIDGET_H
...
namespace GPlatesQtWidgets
{
	...
	private:
		 ...
		 */
		boost::intrusive_ptr<GPlatesPropertyValues::XsDouble> d_double_ptr;

	};
}

#endif  // GPLATES_QTWIDGETS_EDITDOUBLEWIDGET_H
