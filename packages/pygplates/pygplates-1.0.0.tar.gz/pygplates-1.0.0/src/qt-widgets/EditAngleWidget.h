...
#ifndef GPLATES_QTWIDGETS_EDITANGLEWIDGET_H
#define GPLATES_QTWIDGETS_EDITANGLEWIDGET_H
...
namespace GPlatesQtWidgets
{
	...
	private:
		 ...
		 */
		boost::intrusive_ptr<GPlatesPropertyValues::GpmlMeasure> d_angle_ptr;

	};
}

#endif  // GPLATES_QTWIDGETS_EDITANGLEWIDGET_H
