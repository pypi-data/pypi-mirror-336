...
#ifndef GPLATES_QTWIDGETS_CREATETOPOLOGYWIDGET_H
#define GPLATES_QTWIDGETS_CREATETOPOLOGYWIDGET_H
...
#include "CreateTopologyWidgetUi.h"
...
namespace GPlatesQtWidgets
{
	...
	class CreateTopologyWidget:
			public QWidget, 
			protected Ui_CreateTopologyWidget
	{
		Q_OBJECT
	public:
	...
	private:
		 ...
		 */
		// This is technically a memory leak, but since the CreateTopologyWidget will
		// never be deleted...
...
#endif  // GPLATES_QTWIDGETS_CREATETOPOLOGYWIDGET_H
