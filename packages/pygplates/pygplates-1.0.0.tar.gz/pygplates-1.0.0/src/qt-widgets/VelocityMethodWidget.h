...
#ifndef GPLATES_QTWIDGETS_VELOCITYMETHODWIDGET_H
#define GPLATES_QTWIDGETS_VELOCITYMETHODWIDGET_H
...
namespace GPlatesQtWidgets
{
	...
	class VelocityMethodWidget :
			public QWidget,
			protected Ui_VelocityMethodWidget
	{
		Q_OBJECT
	...
	public:
		...
		explicit
		VelocityMethodWidget(bool show_threshold_spinboxes = true, QWidget *parent = 0);
	...
	private:
		...
		bool d_show_threshold_spinboxes;
	};

}

#endif // GPLATES_QTWIDGETS_VELOCITYMETHODWIDGET_H
