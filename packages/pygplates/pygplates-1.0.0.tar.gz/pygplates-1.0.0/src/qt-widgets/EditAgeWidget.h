...
#ifndef GPLATES_QTWIDGETS_EDITAGEWIDGET_H
#define GPLATES_QTWIDGETS_EDITAGEWIDGET_H
...
namespace GPlatesQtWidgets
{
	...
	private Q_SLOTS:
		...
		/**
		 * Hides widgets according to the Absolute/Named/Both combobox.
		 */
		void
		handle_name_or_abs_changed(
				int slot);

		/**
		 * Allows an 'other' value to be edited if selected in the timescale combobox.
		 */
		void
		handle_timescale_changed(
				int slot);
	...
	private:
		 ...
		 */
		boost::intrusive_ptr<GPlatesPropertyValues::GpmlAge> d_age_ptr;

	};
}

#endif  // GPLATES_QTWIDGETS_EDITAGEWIDGET_H
