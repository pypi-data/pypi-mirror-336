...
#ifndef GPLATES_GUI_EXPORTSCALARCOVERAGEANIMATIONSTRATEGY_H
#define GPLATES_GUI_EXPORTSCALARCOVERAGEANIMATIONSTRATEGY_H
...
namespace GPlatesGui
{
	...
	/**
	 * Concrete implementation of the ExportAnimationStrategy class for writing scalar coverages.
	 * 
	 * ExportScalarCoverageAnimationStrategy serves as the concrete Strategy role as
	 * described in Gamma et al. p315. It is used by ExportAnimationContext.
	 */
	class ExportScalarCoverageAnimationStrategy:
			public GPlatesGui::ExportAnimationStrategy
	{
	public:
		/**
		 * A convenience typedef for GPlatesUtils::non_null_intrusive_ptr<ExportScalarCoverageAnimationStrategy>.
		 */
		typedef GPlatesUtils::non_null_intrusive_ptr<ExportScalarCoverageAnimationStrategy> non_null_ptr_type;
				...
				const const_configuration_ptr &export_configuration)
		{
			return non_null_ptr_type(
					new ExportScalarCoverageAnimationStrategy(
...
#endif // GPLATES_GUI_EXPORTSCALARCOVERAGEANIMATIONSTRATEGY_H
