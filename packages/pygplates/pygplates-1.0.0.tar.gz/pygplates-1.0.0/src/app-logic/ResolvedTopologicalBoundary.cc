...
GPlatesAppLogic::ResolvedTopologicalBoundary::get_resolved_topology_geometry_point_source_infos() const
{
...
GPlatesAppLogic::ResolvedTopologicalBoundary::get_resolved_topology_geometry_point_source_features() const
{
...
void
GPlatesAppLogic::ResolvedTopologicalBoundary::calc_vertex_source_features() const
{
