...
namespace GPlatesPropertyValues
{
	...
	public:
		 ...
		 */
		const GPlatesModel::RevisionedVector<GpmlTimeSample> &
		time_samples() const
		{
		 ...
		 */
		GPlatesModel::RevisionedVector<GpmlTimeSample> &
		time_samples()
		{
			return *get_current_revision<Revision>().time_samples.get_revisionable();
		}
		...
		/**
		 * Static access to the structural type as GpmlIrregularSampling::STRUCTURAL_TYPE.
		 */
