 ...
 */
#ifndef GPLATES_UNIT_TEST_DA_DATATABLE_H
#define GPLATES_UNIT_TEST_DA_DATATABLE_H
...
namespace GPlatesUnitTest{
	...
	class DataAssociationDataTableTest
	{
	public:
		DataAssociationDataTableTest():
			d_data_table(
					new GPlatesDataMining::DataTable())
		{ }
	...
	class DataAssociationDataTableTestSuite : 
...
#endif //GPLATES_UNIT_TEST_DA_DATATABLE_H
