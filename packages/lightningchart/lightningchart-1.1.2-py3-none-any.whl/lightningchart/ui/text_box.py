...
class TextBox(UIEWithPosition):
    ...
    def add_video(
        ...
        Args:
            ...
            fit_mode (str): How the video should fit ('fit', 'stretch', etc.).
    ...
    def add_image(
        ...
        Args:
            ...
            fit_mode (str): How the image should fit ('Stretch', 'Fill', 'Fit', etc.).
        ...
        Example:
            >>> textbox.add_image("D:/path/to/local_video.mp4")
            >>> textbox.add_image("https://example.com/video.mp4")
        """
        if not source:
            raise ValueError('Image source is required.')

        image_data_uri = convert_source_to_base64(source)
