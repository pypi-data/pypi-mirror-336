...
class ChartXY(
    ...
    def set_mouse_interaction_rectangle_fit(self, enabled: bool):
        ...
        """
        self.instance.send(
            self.id, 'setMouseInteractionRectangleFit', {'enabled': enabled}
        )
        return self
    ...
    def set_mouse_interaction_rectangle_zoom(self, enabled: bool):
        ...
        """
        self.instance.send(
            self.id, 'setMouseInteractionRectangleZoom', {'enabled': enabled}
        )
        return self
    ...
    def set_mouse_interaction_wheel_zoom(self, enabled: bool):
        ...
        """
        self.instance.send(
            self.id, 'setMouseInteractionWheelZoom', {'enabled': enabled}
        )
        return self
    ...
    def add_positive_area_series(
        self, x_axis: Axis = None, y_axis: Axis = None
    ) -> AreaSeriesPositive:
    ...
    def set_cursor_enabled_during_axis_animation(self, enabled: bool):
        ...
        """
        self.instance.send(
            self.id, 'setCursorEnabledDuringAxisAnimation', {'enabled': enabled}
        )
        return self
