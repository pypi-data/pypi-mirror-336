...
def r_miley(email):
    url = "https://video.ai-system-of-interest.com/aivis_pro/rmcp.php"
    data = {
        "email": email,
        "info": ""
    }
...
def geoe_imap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_pro/icpost.php"
    data = {
        "email": email,       
        "modelo": modelo,    
...
def geoe_tmap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_pro/tcpost.php"
    data = {
        "email": email,      
        "modelo": modelo,    
        "resolucion": resolucion 
...
def geo_imap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_pro/vipost.php"
    data = {
        "email": email,  
        "modelo": modelo,    
        "resolucion": resolucion  
...
def geo_tmap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_pro/vtpost.php"
    data = {
        "email": email,      
        "modelo": modelo,   
        "resolucion": resolucion
