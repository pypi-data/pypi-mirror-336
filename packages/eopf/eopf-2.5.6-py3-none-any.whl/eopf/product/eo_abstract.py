...
class EOAbstract(ABC):  # pragma: no cover
    ...
    def update_attrs(self, attrs: dict[str, Any]) -> None:
        """Deprecated setter of self.attrs"""
        from warnings import warn

        from eopf.exceptions.warnings import EOPFDeprecated

        warn("Deprecated method, replace by attrs setter; e.g., x.attrs = new_attrs", EOPFDeprecated)
