    ...
    **kwargs,
    ...
    if request_source == RequestModuleSource.UNKNOWN.value:
        ...
        logging_helper.send_to_agent_log_file(
            f'Unknown request source for function {function_name}. Unable to determine request source. Defaulting to caller module: {request_source=}',
    ...
    for retry in range(max_retries_for_retry_for_status + 1):
        ...
        try:
            ...
            jelly_counter_attributes['retry_attempt'] = retry + 1
