...
def _minimum_flexural_reinforcement_ratio_ACI_318_19(self: 'RectangularBeam', M_u:PlainQuantity) -> PlainQuantity:
    """
...
def _calculate_flexural_reinforcement_ACI_318_19(self: 'RectangularBeam', M_u: PlainQuantity, d: float, d_prima: float) -> tuple[PlainQuantity, PlainQuantity, PlainQuantity, PlainQuantity, float]:
    """
...
def _determine_nominal_moment_simple_reinf_ACI_318_19(self: 'RectangularBeam', A_s: PlainQuantity, d: PlainQuantity) -> PlainQuantity:
    """
...
def _determine_nominal_moment_double_reinf_ACI_318_19(self: 'RectangularBeam', A_s: PlainQuantity, d: PlainQuantity, d_prime: PlainQuantity, A_s_prime: PlainQuantity) -> PlainQuantity:
    """
...
def _determine_nominal_moment_ACI_318_19(self: 'RectangularBeam', force: Forces) -> None:
    ...
    if (self._A_s_bot <= self._A_s_max_bot):
        ...
        M_n_positive = _determine_nominal_moment_double_reinf_ACI_318_19(self, 
    ...
    if (self._A_s_top == 0 * cm**2):
        ...
        M_n_negative = _determine_nominal_moment_double_reinf_ACI_318_19(self, 
...
def _check_flexure_ACI_318_19(self: 'RectangularBeam', force: Forces) -> pd.DataFrame:
    ...
    if self._M_u >= 0:
        ...
        self._c_d_bot) = _calculate_flexural_reinforcement_ACI_318_19(self, self._M_u_bot, self._d_bot, self._c_mec_top)
        self._c_d_top = 0
        ...
        self._c_d_top) = _calculate_flexural_reinforcement_ACI_318_19(self, abs(self._M_u_top), self._d_top, self._c_mec_bot)
        self._c_d_bot = 0
...
def _design_flexure_ACI_318_19(self: 'RectangularBeam', max_M_y_bot: PlainQuantity, max_M_y_top: PlainQuantity) -> Dict[str, Any]:
    """
    ...
    while Err >= tol:
        ...
        if max_M_y_top < 0:
            (
                ...
                A_s_comp_bot,
                self._c_d_top
            ) = _calculate_flexural_reinforcement_ACI_318_19(self, abs(max_M_y_top), self.height-d_prima, rec_mec)
