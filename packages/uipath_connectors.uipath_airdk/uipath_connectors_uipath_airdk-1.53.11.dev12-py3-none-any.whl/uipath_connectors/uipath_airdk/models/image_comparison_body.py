...
class ImageComparisonBody(BaseModel):
    """
    Attributes:
        body (ImageComparisonRequest):
        image_1 (File): First image to be compared (supported image files)
        image_2 (File): Second image to be compared (supported image files)
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "ImageComparisonRequest" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["ImageComparisonBody"], src_dict: Dict[str, Any]):
