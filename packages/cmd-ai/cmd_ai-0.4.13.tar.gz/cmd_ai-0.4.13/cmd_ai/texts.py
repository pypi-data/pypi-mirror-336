...
tool_setMeetingRecord = {
                    ...
                    "function": {
                        ...
                        "description": "For a future meeting/event/task/deadline record the date, name and content to a calendar. If the date is not specified clearly, use getTodaysDateTime.",
                        "parameters": {
                            "type": "object",
                            "properties": {
                                "date_": {
...
tool_getTodaysDateTime = {
                    ...
                    "function": {
                        ...
                        #         "content": {
                        #             "type": "string",
                        #             "description": "The detailed content of the meeting."
                        #         }
                        # },
                        #     "required": ["date_", "time_", "hint", "content"]
                        # }
