...
class AssertUtils:
    ...
    @staticmethod
    def assert_date_has_overlap(period1, period2, label=''):
        # 将字符串转换为 datetime 对象
