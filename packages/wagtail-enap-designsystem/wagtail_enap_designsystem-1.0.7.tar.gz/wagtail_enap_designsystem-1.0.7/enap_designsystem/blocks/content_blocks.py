...
class EnapAccordionBlock(BaseBlock):
    ...
    class Meta:
        template = "enap_designsystem/blocks/draft_accordions.html"
        icon = "bars"
...
class EnapBannerBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "enap_designsystem/blocks/draft_banner.html"
        icon = "image"
        label = _("Hero Banner")
...
class EnapBannerVideoBlock(blocks.StructBlock):
    ...
    class Meta:
        template = "enap_designsystem/blocks/draft_banner-video.html"
        icon = "image"
