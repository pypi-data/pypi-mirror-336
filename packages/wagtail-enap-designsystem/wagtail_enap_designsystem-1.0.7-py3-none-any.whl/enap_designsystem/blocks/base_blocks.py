...
class ButtonGroupBlock(StructBlock):
    ...
    class Meta:
        template = 'enap_designsystem/blocks/draft_buttongroup.html'
        icon = 'grip'
...
class CarouselSlideBlock(StructBlock):
    ...
    title = CharBlock(required=False, help_text="Título do slide (não usado no formato em branco)")
    description = TextBlock(required=False, help_text="Descrição do slide (usado apenas no formato 'Título e descrição à esquerda')")
...
class CarouselBlock(StructBlock):
    ...
    class Meta:
        template = 'enap_designsystem/blocks/draft_carousel.html'
        icon = 'image'
        label = 'Carrossel'