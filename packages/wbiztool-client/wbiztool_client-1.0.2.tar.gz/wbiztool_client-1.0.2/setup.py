...
setup(
    ...
    url='https://github.com/anuragmeena92/wbiztool-client',
    ...
    project_urls={
        ...
        'Source': 'https://github.com/anuragmeena92/wbiztool-client',
        'Tracker': 'https://github.com/anuragmeena92/wbiztool-client/issues',
