...
class MSPApi:
    ...
    def add_active_directory_groups_to_tenant_in_msp_portal(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant to which the user groups will be added. You can add a maximum of 50 user groups at a time.")],
        active_directory_group_create_or_update_input: Annotated[List[ActiveDirectoryGroupCreateOrUpdateInput], Field(min_length=0, max_length=50)],
        ...
        :param tenant_uid: Unique identifier of the tenant to which the user groups will be added. You can add a maximum of 50 user groups at a time. (required)
        :type tenant_uid: str
    ...
    @validate_call
    def delete_user_groups_from_tenant_in_msp_portal(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant from which the user groups will be deleted")],
        msp_delete_user_groups_from_tenant_input: MspDeleteUserGroupsFromTenantInput,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenant_uid: Unique identifier of the tenant from which the user groups will be deleted (required)
        :type tenant_uid: str
        :param msp_delete_user_groups_from_tenant_input: (required)
        :type msp_delete_user_groups_from_tenant_input: MspDeleteUserGroupsFromTenantInput
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_user_groups_from_tenant_in_msp_portal_serialize(
            tenant_uid=tenant_uid,
            msp_delete_user_groups_from_tenant_input=msp_delete_user_groups_from_tenant_input,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def delete_user_groups_from_tenant_in_msp_portal_with_http_info(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant from which the user groups will be deleted")],
        msp_delete_user_groups_from_tenant_input: MspDeleteUserGroupsFromTenantInput,
        _request_timeout: Union[
    ...
    @validate_call
    def delete_user_groups_from_tenant_in_msp_portal_without_preload_content(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant from which the user groups will be deleted")],
        msp_delete_user_groups_from_tenant_input: MspDeleteUserGroupsFromTenantInput,
        _request_timeout: Union[
    ...
    def _delete_user_groups_from_tenant_in_msp_portal_serialize(
        self,
        tenant_uid,
        msp_delete_user_groups_from_tenant_input,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if msp_delete_user_groups_from_tenant_input is not None:
            _body_params = msp_delete_user_groups_from_tenant_input
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/msp/tenants/{tenantUid}/users/groups/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def get_user_groups_in_tenant_in_msp_portal(
        self,
        ...
        :param tenant_uid: Unique identifier of the tenant to retrieve the users groups for. (required)
        :type tenant_uid: str
        :param limit: The number of results to retrieve.
        :type limit: str
        :param offset: The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.
        ...
        _param = self._get_user_groups_in_tenant_in_msp_portal_serialize(
            tenant_uid=tenant_uid,
            limit=limit,
            offset=offset,
            q=q,
    ...
    @validate_call
    def get_user_groups_in_tenant_in_msp_portal_with_http_info(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant to retrieve the users groups for.")],
        limit: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The number of results to retrieve.")] = None,
        offset: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.")] = None,
    ...
    @validate_call
    def get_user_groups_in_tenant_in_msp_portal_without_preload_content(
        self,
        tenant_uid: Annotated[StrictStr, Field(description="Unique identifier of the tenant to retrieve the users groups for.")],
        limit: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The number of results to retrieve.")] = None,
        offset: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The offset of the results retrieved. The Security Cloud Control API uses the offset field to determine the index of the first result retrieved, and will retrieve `limit` results from the offset specified.")] = None,
    ...
    def _get_user_groups_in_tenant_in_msp_portal_serialize(
        self,
        tenant_uid,
        limit,
        offset,
