...
class ActiveDirectoryGroupCreateOrUpdateInput(BaseModel):
    ...
    """ # noqa: E501
    group_identifier: StrictStr = Field(description="The object ID of the Active Directory group in your Identity Provider (IdP), or the group name in the IdP if the ID is unavailable.", alias="groupIdentifier")
    issuer_url: StrictStr = Field(description="The Identity Provider (IdP) URL, which Cisco Security Cloud Control will use to validate SAML assertions during the sign-in process.", alias="issuerUrl")
