...
class TransformPipeline(object):
    ...
    def __init__(self, config_or_fp, training, device):
    ...
    def __call__(self, doc, device=None, use_tensor=False):

        sample = self.impl.Sample(doc, device=device, output_tensor=use_tensor)
