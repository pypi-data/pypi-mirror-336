...
class KISDomesticStock:
    ...
    def inquire_time_itemchartprice(self, fid_input_iscd: str, fid_input_hour_1: dtm.time | int, fid_cond_mrkt_div_code: str = "J", fid_pw_data_incu_yn: str = "Y"):
        """
        ...
        # TODO
        assert fid_cond_mrkt_div_code == "J" and isinstance(fid_input_hour_1, dtm.time) or fid_cond_mrkt_div_code == "U" and isinstance(fid_input_hour_1, int), "fid_input_hour_1 type mismatch"
    ...
    def order_cash(
        ...
        if ord_dvsn in ["22"]:
            assert type(cndt_pric) is int and cndt_pric > 0, "cndt_pric must be a positive integer when stop limit order"
