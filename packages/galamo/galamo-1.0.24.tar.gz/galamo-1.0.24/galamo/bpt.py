...
# Check if column names match
    if all(col in actual_columns for col in required_columns):
        print(GREEN + "✔ Column names are correct." + RESET)
    else:
        incorrect_columns = [col for col in required_columns if col not in actual_columns]
        print(RED + f"❌ Incorrect or missing columns: {incorrect_columns}. Check SDSS format." + RESET)
        print(YELLOW + "Required SDSS format column names:", required_columns, RESET)
