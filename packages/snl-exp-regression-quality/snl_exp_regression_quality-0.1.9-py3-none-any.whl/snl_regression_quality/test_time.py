...
def run_test():
    ...
    path_x_dataset = './data/test_X.csv'
    path_y_dataset = './data/test_Y.csv'
    ...
    x_values,y_values ,x_mean, y_mean = ReadingData(path_x_dataset,path_y_dataset,example=False).run()
