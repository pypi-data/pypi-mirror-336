...
def test_biome_apis():
    ...
    adhoc = AdhocApi(apis=apis, drafter_config=drafter_config)
    pdb.set_trace()
    # for query in REPL(history_file='.chat'):
    ...
    Some Test Cases:
        ...
        adhoc.use_api('Proteomics Data Commons', 'Fetch raw mass spec data for a specific study using study name, data category, and file type in the Proteomics Data Commons (PDC)')
        adhoc.use_api('Proteomics Data Commons', 'Fetch raw mass spec data relating to bone marrow with leukemia')
    """
