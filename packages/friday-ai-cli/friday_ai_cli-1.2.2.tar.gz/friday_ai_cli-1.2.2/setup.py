...
# Define both the project name and normalized name
# The normalized name is used for distribution filenames (PEP 625 compliance)
project_name = "friday-ai-cli"
normalized_name = project_name.replace("-", "_")

setup(
    # Use normalized name directly to ensure PEP 625 compliance
