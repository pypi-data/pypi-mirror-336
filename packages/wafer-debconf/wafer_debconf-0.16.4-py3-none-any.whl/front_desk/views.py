...
class Dashboard(CheckInPermissionMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context.update({
            ...
            'exports': exports,
            "DEBCONF_REVIEW_FREE_ATTENDEES": settings.DEBCONF_REVIEW_FREE_ATTENDEES,
        })
        return context
...
class CheckInView(CheckInPermissionMixin, SingleObjectMixin, FormView):
    ...
    def get_initial(self):
        ...
        return {
            ...
            'meal_vouchers': check_in.meal_vouchers,
            'bedding': check_in.bedding,
...
class CheckOutView(CheckInPermissionMixin, SingleObjectMixin, FormView):
    ...
    def get_initial(self):
        ...
        return {
            ...
            'returned_bedding': check_in.returned_bedding,
            'notes': check_in.notes,
        }
...
class IssueInvoiceView(CheckInPermissionMixin, SingleObjectMixin, View):
    model = Attendee
    slug_field = 'user__username'
    slug_url_kwarg = 'username'
    ...
    def post(self, request, *args, **kwargs):
        ...
        invoice_user(user, save=True)
        return redirect('front_desk.check_in', user.username)
