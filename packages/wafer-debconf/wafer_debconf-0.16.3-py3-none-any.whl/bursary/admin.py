...
class BursaryAdmin(admin.ModelAdmin):
    ...
    list_display = (
        ...
        'attendance_status', 'expenses_status',
        'reimbursed_amount'
    )
    ...
    def shipping_address(self, obj):
        return obj.user.attendee.shipping_address.formatted_address
...
class BursaryRefereeAdmin(admin.ModelAdmin):
    ...
    bursary_travel.short_description = (
        f'Requested travel bursary amount ({settings.DEBCONF_BURSARY_CURRENCY})'
    )
