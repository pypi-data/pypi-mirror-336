import { c as create_ssr_component, v as validate_component, b as add_attribute, m as missing_component, a as createEventDispatcher } from './ssr-FJHii0oS.js';
import { B as Block, S as Static, f as BlockLabel, y as File$1, h as Empty, U as UploadText, i as IconButtonWrapper, j as IconButton, J as Undo, k as Download } from './2-CmHGT4pL.js';
import { U as Upload, M as ModifyUpload } from './ModifyUpload-DMAa4Y5Z.js';
export { default as BaseExample } from './Example17-CGfa42_M.js';
...
async function loadCanvas3D$1() {
  const module = await import('./Canvas3D-B2ylNZzi.js');
  return module.default;
}
async function loadCanvas3DGS$1() {
  const module = await import('./Canvas3DGS-DOGt3iB8.js');
  return module.default;
}
...
//# sourceMappingURL=Index53-4Hhm7Q6A.js.map
