import { c as create_ssr_component, v as validate_component, a as createEventDispatcher, e as escape, n as null_to_empty, b as add_attribute, f as each, d as add_styles, o as onDestroy, m as missing_component } from './ssr-FJHii0oS.js';
...
const Thought = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="thought-group svelte-1qn6r4f"><div class="${["title svelte-1qn6r4f", ""].join(" ").trim()}"${add_attribute("aria-busy", thought_node.content === "" || thought_node.content === null, 0)} role="button" tabindex="0"><span class="arrow svelte-1qn6r4f"${add_styles({
    ...
    {},
    {}
  )} ${thought_node.metadata?.status === "pending" ? `<span class="loading-spinner svelte-1qn6r4f"></span>` : ``} ${thought_node?.metadata?.log || thought_node?.metadata?.duration ? `<span class="duration svelte-1qn6r4f">${thought_node.metadata.log ? `${escape(thought_node.metadata.log)}` : ``} ${thought_node.metadata.duration !== void 0 ? `(${Number.isInteger(thought_node.metadata.duration) ? `${escape(thought_node.metadata.duration)}s` : `${thought_node.metadata.duration >= 0.1 ? `${escape(thought_node.metadata.duration.toFixed(1))}s` : `${escape((thought_node.metadata.duration * 1e3).toFixed(1))}ms`}`})` : ``}</span>` : ``}</div> ${thought_node.metadata?.status !== "done" ? `<div class="${[
    "svelte-1qn6r4f",
    " " + (thought_node.metadata?.status !== "done" ? "content-preview" : "")
  ].join(" ").trim()}"${add_attribute("this", contentPreviewElement, 0)}>${validate_component(MessageContent, "MessageContent").$$render(
    $$result,
    {
      message: thought_node,
      sanitize_html,
...
const css$4 = {
  code: ".message.svelte-yaaj3.svelte-yaaj3{position:relative;width:100%;margin-top:var(--spacing-sm)}.message.display_consecutive_in_same_bubble.svelte-yaaj3.svelte-yaaj3{margin-top:0}.avatar-container.svelte-yaaj3.svelte-yaaj3{flex-shrink:0;border-radius:50%;border:1px solid var(--border-color-primary);overflow:hidden}.avatar-container.svelte-yaaj3 img{object-fit:cover}.flex-wrap.svelte-yaaj3.svelte-yaaj3{display:flex;flex-direction:column;width:calc(100% - var(--spacing-xxl));max-width:100%;color:var(--body-text-color);font-size:var(--chatbot-text-size);overflow-wrap:break-word;width:100%;height:100%}.component.svelte-yaaj3.svelte-yaaj3{padding:0;border-radius:var(--radius-md);width:fit-content;overflow:hidden}.component.gallery.svelte-yaaj3.svelte-yaaj3{border:none}.message-row.svelte-yaaj3 .svelte-yaaj3:not(.avatar-container) img{margin:var(--size-2);max-height:300px}.file-pil.svelte-yaaj3.svelte-yaaj3{display:block;width:fit-content;padding:var(--spacing-sm) var(--spacing-lg);border-radius:var(--radius-md);background:var(--background-fill-secondary);color:var(--body-text-color);text-decoration:none;margin:0;font-family:var(--font-mono);font-size:var(--text-sm)}.file.svelte-yaaj3.svelte-yaaj3{width:auto !important;max-width:fit-content !important}@media(max-width: 600px) or (max-width: 480px){.component.svelte-yaaj3.svelte-yaaj3{width:100%}}.message.svelte-yaaj3 .prose{font-size:var(--chatbot-text-size)}.message-bubble-border.svelte-yaaj3.svelte-yaaj3{border-width:1px;border-radius:var(--radius-md)}.panel-full-width.svelte-yaaj3.svelte-yaaj3{width:100%}.message-markdown-disabled.svelte-yaaj3.svelte-yaaj3{white-space:pre-line}.user.svelte-yaaj3.svelte-yaaj3{border-radius:var(--radius-md);align-self:flex-end;border-bottom-right-radius:0;box-shadow:var(--shadow-drop);border:1px solid var(--border-color-accent-subdued);background-color:var(--color-accent-soft);padding:var(--spacing-sm) var(--spacing-xl)}.bot.svelte-yaaj3.svelte-yaaj3{border:1px solid var(--border-color-primary);border-radius:var(--radius-md);border-color:var(--border-color-primary);background-color:var(--background-fill-secondary);box-shadow:var(--shadow-drop);align-self:flex-start;text-align:right;border-bottom-left-radius:0;padding:var(--spacing-sm) var(--spacing-xl)}.bot.svelte-yaaj3.svelte-yaaj3:has(.table-wrap){border:none;box-shadow:none;background:none}.panel.svelte-yaaj3 .user.svelte-yaaj3 *{text-align:right}.message-row.svelte-yaaj3.svelte-yaaj3{display:flex;position:relative}.bubble.svelte-yaaj3.svelte-yaaj3{margin:calc(var(--spacing-xl) * 2);margin-bottom:var(--spacing-xl)}.bubble.user-row.svelte-yaaj3.svelte-yaaj3{align-self:flex-end;max-width:calc(100% - var(--spacing-xl) * 6)}.bubble.bot-row.svelte-yaaj3.svelte-yaaj3{align-self:flex-start;max-width:calc(100% - var(--spacing-xl) * 6)}.bubble.svelte-yaaj3 .user-row.svelte-yaaj3{flex-direction:row;justify-content:flex-end}.bubble.svelte-yaaj3 .with_avatar.user-row.svelte-yaaj3{margin-right:calc(var(--spacing-xl) * 2) !important}.bubble.svelte-yaaj3 .with_avatar.bot-row.svelte-yaaj3{margin-left:calc(var(--spacing-xl) * 2) !important}.bubble.svelte-yaaj3 .with_opposite_avatar.user-row.svelte-yaaj3{margin-left:calc(var(--spacing-xxl) + 35px + var(--spacing-xxl))}.panel.svelte-yaaj3.svelte-yaaj3{margin:0;padding:calc(var(--spacing-lg) * 2) calc(var(--spacing-lg) * 2)}.panel.bot-row.svelte-yaaj3.svelte-yaaj3{background:var(--background-fill-secondary)}.panel.svelte-yaaj3 .with_avatar.svelte-yaaj3{padding-left:calc(var(--spacing-xl) * 2) !important;padding-right:calc(var(--spacing-xl) * 2) !important}.panel.svelte-yaaj3 .panel-full-width.svelte-yaaj3{width:100%}.panel.svelte-yaaj3 .user.svelte-yaaj3 *{text-align:right}.flex-wrap.svelte-yaaj3.svelte-yaaj3{display:flex;flex-direction:column;max-width:100%;color:var(--body-text-color);font-size:var(--chatbot-text-size);overflow-wrap:break-word}@media(max-width: 480px){.user-row.bubble.svelte-yaaj3.svelte-yaaj3{align-self:flex-end}.bot-row.bubble.svelte-yaaj3.svelte-yaaj3{align-self:flex-start}.message.svelte-yaaj3.svelte-yaaj3{width:100%}}.avatar-container.svelte-yaaj3.svelte-yaaj3{align-self:flex-start;position:relative;display:flex;justify-content:flex-start;align-items:flex-start;width:35px;height:35px;flex-shrink:0;bottom:0;border-radius:50%;border:1px solid var(--border-color-primary)}.user-row.svelte-yaaj3>.avatar-container.svelte-yaaj3{order:2}.user-row.bubble.svelte-yaaj3>.avatar-container.svelte-yaaj3{margin-left:var(--spacing-xxl)}.bot-row.bubble.svelte-yaaj3>.avatar-container.svelte-yaaj3{margin-left:var(--spacing-xxl)}.panel.user-row.svelte-yaaj3>.avatar-container.svelte-yaaj3{order:0}.bot-row.bubble.svelte-yaaj3>.avatar-container.svelte-yaaj3{margin-right:var(--spacing-xxl);margin-left:0}.avatar-container.svelte-yaaj3:not(.thumbnail-item) img{width:100%;height:100%;object-fit:cover;border-radius:50%;padding:var(--size-1-5)}.selectable.svelte-yaaj3.svelte-yaaj3{cursor:pointer}@keyframes svelte-yaaj3-dot-flashing{0%{opacity:0.8}50%{opacity:0.5}100%{opacity:0.8}}.message.svelte-yaaj3 .preview{object-fit:contain;width:95%;max-height:93%}.image-preview.svelte-yaaj3.svelte-yaaj3{position:absolute;z-index:999;left:0;top:0;width:100%;height:100%;overflow:auto;background-color:rgba(0, 0, 0, 0.9);display:flex;justify-content:center;align-items:center}.image-preview.svelte-yaaj3 svg{stroke:white}.image-preview-close-button.svelte-yaaj3.svelte-yaaj3{position:absolute;top:10px;right:10px;background:none;border:none;font-size:1.5em;cursor:pointer;height:30px;width:30px;padding:3px;background:var(--bg-color);box-shadow:var(--shadow-drop);border:1px solid var(--button-secondary-border-color);border-radius:var(--radius-lg)}.message.svelte-yaaj3>div.svelte-yaaj3{width:100%}.html.svelte-yaaj3.svelte-yaaj3{padding:0;border:none;background:none}.panel.svelte-yaaj3 .bot.svelte-yaaj3,.panel.svelte-yaaj3 .user.svelte-yaaj3{border:none;box-shadow:none;background-color:var(--background-fill-secondary)}textarea.svelte-yaaj3.svelte-yaaj3{background:none;border-radius:var(--radius-lg);border:none;display:block;max-width:100%}.user.svelte-yaaj3 textarea.svelte-yaaj3{border-bottom-right-radius:0}.bot.svelte-yaaj3 textarea.svelte-yaaj3{border-bottom-left-radius:0}.user.svelte-yaaj3 textarea.svelte-yaaj3:focus{outline:2px solid var(--border-color-accent)}.bot.svelte-yaaj3 textarea.svelte-yaaj3:focus{outline:2px solid var(--border-color-primary)}.panel.user-row.svelte-yaaj3.svelte-yaaj3{background-color:var(--color-accent-soft)}.panel.svelte-yaaj3 .user-row.svelte-yaaj3,.panel.svelte-yaaj3 .bot-row.svelte-yaaj3{align-self:flex-start}.panel.svelte-yaaj3 .user.svelte-yaaj3 *,.panel.svelte-yaaj3 .bot.svelte-yaaj3 *{text-align:left}.panel.svelte-yaaj3 .user.svelte-yaaj3{background-color:var(--color-accent-soft)}.panel.svelte-yaaj3 .user-row.svelte-yaaj3{background-color:var(--color-accent-soft);align-self:flex-start}.panel.svelte-yaaj3 .message.svelte-yaaj3{margin-bottom:var(--spacing-md)}",
  map: '{"version":3,"file":"Message.svelte","sources":["Message.svelte"],"sourcesContent":["<script lang=\\"ts\\">import { is_component_message } from \\"../shared/utils\\";\\nimport { Image } from \\"@gradio/image/shared\\";\\nimport ButtonPanel from \\"./ButtonPanel.svelte\\";\\nimport MessageContent from \\"./MessageContent.svelte\\";\\nimport Thought from \\"./Thought.svelte\\";\\nexport let value;\\nexport let avatar_img;\\nexport let opposite_avatar_img = null;\\nexport let role = \\"user\\";\\nexport let messages = [];\\nexport let layout;\\nexport let render_markdown;\\nexport let latex_delimiters;\\nexport let sanitize_html;\\nexport let selectable;\\nexport let _fetch;\\nexport let rtl;\\nexport let dispatch;\\nexport let i18n;\\nexport let line_breaks;\\nexport let upload;\\nexport let target;\\nexport let root;\\nexport let theme_mode;\\nexport let _components;\\nexport let i;\\nexport let show_copy_button;\\nexport let generating;\\nexport let feedback_options;\\nexport let show_like;\\nexport let show_edit;\\nexport let show_retry;\\nexport let show_undo;\\nexport let msg_format;\\nexport let handle_action;\\nexport let scroll;\\nexport let allow_file_downloads;\\nexport let in_edit_mode;\\nexport let edit_message;\\nexport let display_consecutive_in_same_bubble;\\nexport let current_feedback = null;\\nexport let allow_tags = false;\\nexport let watermark = null;\\nlet messageElements = [];\\nlet previous_edit_mode = false;\\nlet last_message_width = 0;\\nlet last_message_height = 0;\\n$: if (in_edit_mode && !previous_edit_mode) {\\n    last_message_width = messageElements[messageElements.length - 1]?.clientWidth;\\n    last_message_height = messageElements[messageElements.length - 1]?.clientHeight;\\n}\\nfunction handle_select(i2, message) {\\n    dispatch(\\"select\\", {\\n        index: message.index,\\n        value: message.content\\n    });\\n}\\nfunction get_message_label_data(message) {\\n    if (message.type === \\"text\\") {\\n        return message.content;\\n    }\\n    else if (message.type === \\"component\\" && message.content.component === \\"file\\") {\\n        if (Array.isArray(message.content.value)) {\\n            return `file of extension type: ${message.content.value[0].orig_name?.split(\\".\\").pop()}`;\\n        }\\n        return `file of extension type: ${message.content.value?.orig_name?.split(\\".\\").pop()}` + (message.content.value?.orig_name ?? \\"\\");\\n    }\\n    return `a component of type ${message.content.component ?? \\"unknown\\"}`;\\n}\\nlet button_panel_props;\\n$: button_panel_props = {\\n    handle_action,\\n    likeable: show_like,\\n    feedback_options,\\n    show_retry,\\n    show_undo,\\n    show_edit,\\n    in_edit_mode,\\n    generating,\\n    show_copy_button,\\n    message: msg_format === \\"tuples\\" ? messages[0] : messages,\\n    position: role === \\"user\\" ? \\"right\\" : \\"left\\",\\n    avatar: avatar_img,\\n    layout,\\n    dispatch,\\n    current_feedback,\\n    watermark\\n};\\n<\/script>\\n\\n<div\\n\\tclass=\\"message-row {layout} {role}-row\\"\\n\\tclass:with_avatar={avatar_img !== null}\\n\\tclass:with_opposite_avatar={opposite_avatar_img !== null}\\n>\\n\\t{#if avatar_img !== null}\\n\\t\\t<div class=\\"avatar-container\\">\\n\\t\\t\\t<Image class=\\"avatar-image\\" src={avatar_img?.url} alt=\\"{role} avatar\\" />\\n\\t\\t</div>\\n\\t{/if}\\n\\t<div\\n\\t\\tclass:role\\n\\t\\tclass=\\"flex-wrap\\"\\n\\t\\tclass:component-wrap={messages[0].type === \\"component\\"}\\n\\t>\\n\\t\\t<div\\n\\t\\t\\tclass:message={display_consecutive_in_same_bubble}\\n\\t\\t\\tclass={display_consecutive_in_same_bubble ? role : \\"\\"}\\n\\t\\t>\\n\\t\\t\\t{#each messages as message, thought_index}\\n\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\tclass=\\"message {!display_consecutive_in_same_bubble ? role : \'\'}\\"\\n\\t\\t\\t\\t\\tclass:panel-full-width={true}\\n\\t\\t\\t\\t\\tclass:message-markdown-disabled={!render_markdown}\\n\\t\\t\\t\\t\\tclass:component={message.type === \\"component\\"}\\n\\t\\t\\t\\t\\tclass:html={is_component_message(message) &&\\n\\t\\t\\t\\t\\t\\tmessage.content.component === \\"html\\"}\\n\\t\\t\\t\\t\\tclass:thought={thought_index > 0}\\n\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t{#if in_edit_mode && thought_index === messages.length - 1 && message.type === \\"text\\"}\\n\\t\\t\\t\\t\\t\\t<!-- svelte-ignore a11y-autofocus -->\\n\\t\\t\\t\\t\\t\\t<textarea\\n\\t\\t\\t\\t\\t\\t\\tclass=\\"edit-textarea\\"\\n\\t\\t\\t\\t\\t\\t\\tstyle:width={`max(${last_message_width}px, 160px)`}\\n\\t\\t\\t\\t\\t\\t\\tstyle:min-height={`${last_message_height}px`}\\n\\t\\t\\t\\t\\t\\t\\tautofocus\\n\\t\\t\\t\\t\\t\\t\\tbind:value={edit_message}\\n\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t\\t<!-- svelte-ignore a11y-no-static-element-interactions -->\\n\\t\\t\\t\\t\\t\\t<div\\n\\t\\t\\t\\t\\t\\t\\tdata-testid={role}\\n\\t\\t\\t\\t\\t\\t\\tclass:latest={i === value.length - 1}\\n\\t\\t\\t\\t\\t\\t\\tclass:message-markdown-disabled={!render_markdown}\\n\\t\\t\\t\\t\\t\\t\\tstyle:user-select=\\"text\\"\\n\\t\\t\\t\\t\\t\\t\\tclass:selectable\\n\\t\\t\\t\\t\\t\\t\\tstyle:cursor={selectable ? \\"pointer\\" : \\"auto\\"}\\n\\t\\t\\t\\t\\t\\t\\tstyle:text-align={rtl ? \\"right\\" : \\"left\\"}\\n\\t\\t\\t\\t\\t\\t\\tbind:this={messageElements[thought_index]}\\n\\t\\t\\t\\t\\t\\t\\ton:click={() => handle_select(i, message)}\\n\\t\\t\\t\\t\\t\\t\\ton:keydown={(e) => {\\n\\t\\t\\t\\t\\t\\t\\t\\tif (e.key === \\"Enter\\") {\\n\\t\\t\\t\\t\\t\\t\\t\\t\\thandle_select(i, message);\\n\\t\\t\\t\\t\\t\\t\\t\\t}\\n\\t\\t\\t\\t\\t\\t\\t}}\\n\\t\\t\\t\\t\\t\\t\\tdir={rtl ? \\"rtl\\" : \\"ltr\\"}\\n\\t\\t\\t\\t\\t\\t\\taria-label={role +\\n\\t\\t\\t\\t\\t\\t\\t\\t\\"\'s message: \\" +\\n\\t\\t\\t\\t\\t\\t\\t\\tget_message_label_data(message)}\\n\\t\\t\\t\\t\\t\\t>\\n\\t\\t\\t\\t\\t\\t\\t{#if message?.metadata?.title}\\n\\t\\t\\t\\t\\t\\t\\t\\t<Thought\\n\\t\\t\\t\\t\\t\\t\\t\\t\\tthought={message}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{rtl}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{sanitize_html}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{allow_tags}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{latex_delimiters}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{render_markdown}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{_components}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{upload}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{thought_index}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{target}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{root}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{theme_mode}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{_fetch}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{scroll}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{allow_file_downloads}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{display_consecutive_in_same_bubble}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{i18n}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{line_breaks}\\n\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t{:else}\\n\\t\\t\\t\\t\\t\\t\\t\\t<MessageContent\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{message}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{sanitize_html}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{allow_tags}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{latex_delimiters}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{render_markdown}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{_components}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{upload}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{thought_index}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{target}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{root}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{theme_mode}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{_fetch}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{scroll}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{allow_file_downloads}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{display_consecutive_in_same_bubble}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{i18n}\\n\\t\\t\\t\\t\\t\\t\\t\\t\\t{line_breaks}\\n\\t\\t\\t\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t\\t\\t</div>\\n\\t\\t\\t\\t\\t{/if}\\n\\t\\t\\t\\t</div>\\n\\n\\t\\t\\t\\t{#if layout === \\"panel\\"}\\n\\t\\t\\t\\t\\t<ButtonPanel\\n\\t\\t\\t\\t\\t\\t{...button_panel_props}\\n\\t\\t\\t\\t\\t\\t{current_feedback}\\n\\t\\t\\t\\t\\t\\t{watermark}\\n\\t\\t\\t\\t\\t\\ton:copy={(e) => dispatch(\\"copy\\", e.detail)}\\n\\t\\t\\t\\t\\t/>\\n\\t\\t\\t\\t{/if}\\n\\t\\t\\t{/each}\\n\\t\\t</div>\\n\\t</div>\\n</div>\\n\\n{#if layout === \\"bubble\\"}\\n\\t<ButtonPanel {...button_panel_props} />\\n{/if}\\n\\n<style>\\n\\t.message {\\n\\t\\tposition: relative;\\n\\t\\twidth: 100%;\\n\\t\\tmargin-top: var(--spacing-sm);\\n\\t}\\n\\n\\t.message.display_consecutive_in_same_bubble {\\n\\t\\tmargin-top: 0;\\n\\t}\\n\\n\\t/* avatar styles */\\n\\t.avatar-container {\\n\\t\\tflex-shrink: 0;\\n\\t\\tborder-radius: 50%;\\n\\t\\tborder: 1px solid var(--border-color-primary);\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\t.avatar-container :global(img) {\\n\\t\\tobject-fit: cover;\\n\\t}\\n\\n\\t/* message wrapper */\\n\\t.flex-wrap {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\twidth: calc(100% - var(--spacing-xxl));\\n\\t\\tmax-width: 100%;\\n\\t\\tcolor: var(--body-text-color);\\n\\t\\tfont-size: var(--chatbot-text-size);\\n\\t\\toverflow-wrap: break-word;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t}\\n\\n\\t.component {\\n\\t\\tpadding: 0;\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\twidth: fit-content;\\n\\t\\toverflow: hidden;\\n\\t}\\n\\n\\t.component.gallery {\\n\\t\\tborder: none;\\n\\t}\\n\\n\\t.message-row :not(.avatar-container) :global(img) {\\n\\t\\tmargin: var(--size-2);\\n\\t\\tmax-height: 300px;\\n\\t}\\n\\n\\t.file-pil {\\n\\t\\tdisplay: block;\\n\\t\\twidth: fit-content;\\n\\t\\tpadding: var(--spacing-sm) var(--spacing-lg);\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\tbackground: var(--background-fill-secondary);\\n\\t\\tcolor: var(--body-text-color);\\n\\t\\ttext-decoration: none;\\n\\t\\tmargin: 0;\\n\\t\\tfont-family: var(--font-mono);\\n\\t\\tfont-size: var(--text-sm);\\n\\t}\\n\\n\\t.file {\\n\\t\\twidth: auto !important;\\n\\t\\tmax-width: fit-content !important;\\n\\t}\\n\\n\\t@media (max-width: 600px) or (max-width: 480px) {\\n\\t\\t.component {\\n\\t\\t\\twidth: 100%;\\n\\t\\t}\\n\\t}\\n\\n\\t.message :global(.prose) {\\n\\t\\tfont-size: var(--chatbot-text-size);\\n\\t}\\n\\n\\t.message-bubble-border {\\n\\t\\tborder-width: 1px;\\n\\t\\tborder-radius: var(--radius-md);\\n\\t}\\n\\n\\t.panel-full-width {\\n\\t\\twidth: 100%;\\n\\t}\\n\\t.message-markdown-disabled {\\n\\t\\twhite-space: pre-line;\\n\\t}\\n\\n\\t.user {\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\talign-self: flex-end;\\n\\t\\tborder-bottom-right-radius: 0;\\n\\t\\tbox-shadow: var(--shadow-drop);\\n\\t\\tborder: 1px solid var(--border-color-accent-subdued);\\n\\t\\tbackground-color: var(--color-accent-soft);\\n\\t\\tpadding: var(--spacing-sm) var(--spacing-xl);\\n\\t}\\n\\n\\t.bot {\\n\\t\\tborder: 1px solid var(--border-color-primary);\\n\\t\\tborder-radius: var(--radius-md);\\n\\t\\tborder-color: var(--border-color-primary);\\n\\t\\tbackground-color: var(--background-fill-secondary);\\n\\t\\tbox-shadow: var(--shadow-drop);\\n\\t\\talign-self: flex-start;\\n\\t\\ttext-align: right;\\n\\t\\tborder-bottom-left-radius: 0;\\n\\t\\tpadding: var(--spacing-sm) var(--spacing-xl);\\n\\t}\\n\\n\\t.bot:has(.table-wrap) {\\n\\t\\tborder: none;\\n\\t\\tbox-shadow: none;\\n\\t\\tbackground: none;\\n\\t}\\n\\n\\t.panel .user :global(*) {\\n\\t\\ttext-align: right;\\n\\t}\\n\\n\\t/* Colors */\\n\\n\\t.message-row {\\n\\t\\tdisplay: flex;\\n\\t\\tposition: relative;\\n\\t}\\n\\n\\t/* bubble mode styles */\\n\\t.bubble {\\n\\t\\tmargin: calc(var(--spacing-xl) * 2);\\n\\t\\tmargin-bottom: var(--spacing-xl);\\n\\t}\\n\\n\\t.bubble.user-row {\\n\\t\\talign-self: flex-end;\\n\\t\\tmax-width: calc(100% - var(--spacing-xl) * 6);\\n\\t}\\n\\n\\t.bubble.bot-row {\\n\\t\\talign-self: flex-start;\\n\\t\\tmax-width: calc(100% - var(--spacing-xl) * 6);\\n\\t}\\n\\n\\t.bubble .user-row {\\n\\t\\tflex-direction: row;\\n\\t\\tjustify-content: flex-end;\\n\\t}\\n\\n\\t.bubble .with_avatar.user-row {\\n\\t\\tmargin-right: calc(var(--spacing-xl) * 2) !important;\\n\\t}\\n\\n\\t.bubble .with_avatar.bot-row {\\n\\t\\tmargin-left: calc(var(--spacing-xl) * 2) !important;\\n\\t}\\n\\n\\t.bubble .with_opposite_avatar.user-row {\\n\\t\\tmargin-left: calc(var(--spacing-xxl) + 35px + var(--spacing-xxl));\\n\\t}\\n\\n\\t/* panel mode styles */\\n\\t.panel {\\n\\t\\tmargin: 0;\\n\\t\\tpadding: calc(var(--spacing-lg) * 2) calc(var(--spacing-lg) * 2);\\n\\t}\\n\\n\\t.panel.bot-row {\\n\\t\\tbackground: var(--background-fill-secondary);\\n\\t}\\n\\n\\t.panel .with_avatar {\\n\\t\\tpadding-left: calc(var(--spacing-xl) * 2) !important;\\n\\t\\tpadding-right: calc(var(--spacing-xl) * 2) !important;\\n\\t}\\n\\n\\t.panel .panel-full-width {\\n\\t\\twidth: 100%;\\n\\t}\\n\\n\\t.panel .user :global(*) {\\n\\t\\ttext-align: right;\\n\\t}\\n\\n\\t/* message content */\\n\\t.flex-wrap {\\n\\t\\tdisplay: flex;\\n\\t\\tflex-direction: column;\\n\\t\\tmax-width: 100%;\\n\\t\\tcolor: var(--body-text-color);\\n\\t\\tfont-size: var(--chatbot-text-size);\\n\\t\\toverflow-wrap: break-word;\\n\\t}\\n\\n\\t@media (max-width: 480px) {\\n\\t\\t.user-row.bubble {\\n\\t\\t\\talign-self: flex-end;\\n\\t\\t}\\n\\n\\t\\t.bot-row.bubble {\\n\\t\\t\\talign-self: flex-start;\\n\\t\\t}\\n\\t\\t.message {\\n\\t\\t\\twidth: 100%;\\n\\t\\t}\\n\\t}\\n\\n\\t.avatar-container {\\n\\t\\talign-self: flex-start;\\n\\t\\tposition: relative;\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: flex-start;\\n\\t\\talign-items: flex-start;\\n\\t\\twidth: 35px;\\n\\t\\theight: 35px;\\n\\t\\tflex-shrink: 0;\\n\\t\\tbottom: 0;\\n\\t\\tborder-radius: 50%;\\n\\t\\tborder: 1px solid var(--border-color-primary);\\n\\t}\\n\\t.user-row > .avatar-container {\\n\\t\\torder: 2;\\n\\t}\\n\\n\\t.user-row.bubble > .avatar-container {\\n\\t\\tmargin-left: var(--spacing-xxl);\\n\\t}\\n\\n\\t.bot-row.bubble > .avatar-container {\\n\\t\\tmargin-left: var(--spacing-xxl);\\n\\t}\\n\\n\\t.panel.user-row > .avatar-container {\\n\\t\\torder: 0;\\n\\t}\\n\\n\\t.bot-row.bubble > .avatar-container {\\n\\t\\tmargin-right: var(--spacing-xxl);\\n\\t\\tmargin-left: 0;\\n\\t}\\n\\n\\t.avatar-container:not(.thumbnail-item) :global(img) {\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\tobject-fit: cover;\\n\\t\\tborder-radius: 50%;\\n\\t\\tpadding: var(--size-1-5);\\n\\t}\\n\\n\\t.selectable {\\n\\t\\tcursor: pointer;\\n\\t}\\n\\n\\t@keyframes dot-flashing {\\n\\t\\t0% {\\n\\t\\t\\topacity: 0.8;\\n\\t\\t}\\n\\t\\t50% {\\n\\t\\t\\topacity: 0.5;\\n\\t\\t}\\n\\t\\t100% {\\n\\t\\t\\topacity: 0.8;\\n\\t\\t}\\n\\t}\\n\\n\\t/* Image preview */\\n\\t.message :global(.preview) {\\n\\t\\tobject-fit: contain;\\n\\t\\twidth: 95%;\\n\\t\\tmax-height: 93%;\\n\\t}\\n\\t.image-preview {\\n\\t\\tposition: absolute;\\n\\t\\tz-index: 999;\\n\\t\\tleft: 0;\\n\\t\\ttop: 0;\\n\\t\\twidth: 100%;\\n\\t\\theight: 100%;\\n\\t\\toverflow: auto;\\n\\t\\tbackground-color: rgba(0, 0, 0, 0.9);\\n\\t\\tdisplay: flex;\\n\\t\\tjustify-content: center;\\n\\t\\talign-items: center;\\n\\t}\\n\\t.image-preview :global(svg) {\\n\\t\\tstroke: white;\\n\\t}\\n\\t.image-preview-close-button {\\n\\t\\tposition: absolute;\\n\\t\\ttop: 10px;\\n\\t\\tright: 10px;\\n\\t\\tbackground: none;\\n\\t\\tborder: none;\\n\\t\\tfont-size: 1.5em;\\n\\t\\tcursor: pointer;\\n\\t\\theight: 30px;\\n\\t\\twidth: 30px;\\n\\t\\tpadding: 3px;\\n\\t\\tbackground: var(--bg-color);\\n\\t\\tbox-shadow: var(--shadow-drop);\\n\\t\\tborder: 1px solid var(--button-secondary-border-color);\\n\\t\\tborder-radius: var(--radius-lg);\\n\\t}\\n\\n\\t.message > div {\\n\\t\\twidth: 100%;\\n\\t}\\n\\t.html {\\n\\t\\tpadding: 0;\\n\\t\\tborder: none;\\n\\t\\tbackground: none;\\n\\t}\\n\\n\\t.panel .bot,\\n\\t.panel .user {\\n\\t\\tborder: none;\\n\\t\\tbox-shadow: none;\\n\\t\\tbackground-color: var(--background-fill-secondary);\\n\\t}\\n\\n\\ttextarea {\\n\\t\\tbackground: none;\\n\\t\\tborder-radius: var(--radius-lg);\\n\\t\\tborder: none;\\n\\t\\tdisplay: block;\\n\\t\\tmax-width: 100%;\\n\\t}\\n\\t.user textarea {\\n\\t\\tborder-bottom-right-radius: 0;\\n\\t}\\n\\t.bot textarea {\\n\\t\\tborder-bottom-left-radius: 0;\\n\\t}\\n\\t.user textarea:focus {\\n\\t\\toutline: 2px solid var(--border-color-accent);\\n\\t}\\n\\t.bot textarea:focus {\\n\\t\\toutline: 2px solid var(--border-color-primary);\\n\\t}\\n\\n\\t.panel.user-row {\\n\\t\\tbackground-color: var(--color-accent-soft);\\n\\t}\\n\\n\\t.panel .user-row,\\n\\t.panel .bot-row {\\n\\t\\talign-self: flex-start;\\n\\t}\\n\\n\\t.panel .user :global(*),\\n\\t.panel .bot :global(*) {\\n\\t\\ttext-align: left;\\n\\t}\\n\\n\\t.panel .user {\\n\\t\\tbackground-color: var(--color-accent-soft);\\n\\t}\\n\\n\\t.panel .user-row {\\n\\t\\tbackground-color: var(--color-accent-soft);\\n\\t\\talign-self: flex-start;\\n\\t}\\n\\n\\t.panel .message {\\n\\t\\tmargin-bottom: var(--spacing-md);\\n\\t}</style>\\n"],"names":[],"mappings":"AAsNC,kCAAS,CACR,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,CACX,UAAU,CAAE,IAAI,YAAY,CAC7B,CAEA,QAAQ,6DAAoC,CAC3C,UAAU,CAAE,CACb,CAGA,2CAAkB,CACjB,WAAW,CAAE,CAAC,CACd,aAAa,CAAE,GAAG,CAClB,MAAM,CAAE,GAAG,CAAC,KAAK,CAAC
AAK,CAAC,IAAI,qBAAqB,CAC7C,CACA,iBAAI,CAAC,qBAAQ,MAAO,CACnB,OAAO,CAAE,GAAG,CAAC,KAAK,CAAC,IAAI,sBAAsB,CAC9C,CAEA,MAAM,mCAAU,CACf,gBAAgB,CAAE,IAAI,mBAAmB,CAC1C,CAEA,mBAAM,CAAC,sBAAS,CAChB,mBAAM,CAAC,qBAAS,CACf,UAAU,CAAE,UACb,CAEA,mBAAM,CAAC,kBAAK,CAAS,CAAE,CACvB,mBAAM,CAAC,iBAAI,CAAS,CAAG,CACtB,UAAU,CAAE,IACb,CAEA,mBAAM,CAAC,kBAAM,CACZ,gBAAgB,CAAE,IAAI,mBAAmB,CAC1C,CAEA,mBAAM,CAAC,sBAAU,CAChB,gBAAgB,CAAE,IAAI,mBAAmB,CAAC,CAC1C,UAAU,CAAE,UACb,CAEA,mBAAM,CAAC,qBAAS,CACf,aAAa,CAAE,IAAI,YAAY,CAChC"}'
};
let previous_edit_mode = false;
function get_message_label_data(message) {
  if (message.type === "text") {
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-yaaj3",
    (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
  ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-yaaj3">${validate_component(Image, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
      src: avatar_img?.url,
    ...
    "flex-wrap svelte-yaaj3",
    (role ? "role" : "") + " " + (messages[0].type === "component" ? "component-wrap" : "")
  ].join(" ").trim()}"><div class="${[
    escape(null_to_empty(display_consecutive_in_same_bubble ? role : ""), true) + " svelte-yaaj3",
    display_consecutive_in_same_bubble ? "message" : ""
  ].join(" ").trim()}">${each(messages, (message, thought_index) => {
    return `<div class="${[
      "message " + escape(!display_consecutive_in_same_bubble ? role : "", true) + " svelte-yaaj3",
    ...
    ].join(" ").trim()}">${in_edit_mode && thought_index === messages.length - 1 && message.type === "text" ? ` <textarea class="edit-textarea svelte-yaaj3" autofocus${add_styles({
      ...
      {},
      {}
    )}`} </div>`}</div> ${layout === "panel" ? `${validate_component(ButtonPanel, "ButtonPanel").$$render($$result, Object.assign({}, button_panel_props, { current_feedback }, { watermark }), {}, {})}` : ``}`;
...
const ChatBot = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `${value !== null && value.length > 0 ? `${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, {}, {}, {
      default: () => {
        return `${show_share_button ? `${validate_component(IconButton, "IconButton").$$render($$result, { Icon: Community }, {}, {})}` : ``} ${validate_component(IconButton, "IconButton").$$render($$result, { Icon: Trash, label: "Clear" }, {}, {})} ${show_copy_all_button ? `${validate_component(CopyAll, "CopyAll").$$render($$result, { value, watermark }, {}, {})}` : ``}`;
      }
      ...
      return `     ${validate_component(Message, "Message").$$render(
        ...
        {}
      )} ${generating && messages[messages.length - 1].role === "assistant" && messages[messages.length - 1].metadata?.status === "done" ? `${validate_component(Pending, "Pending").$$render($$result, { layout, avatar_images }, {}, {})}` : ``}`;
...
//# sourceMappingURL=Index57-DLjl40lY.js.map
