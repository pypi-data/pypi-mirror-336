"""A setuptools based setup module for EngCoolProp

See:
http://engcoolprop.readthedocs.org/en/latest/
https://github.com/sonofeft/EngCoolProp

If installing from source, then
the best way to install EngCoolProp is to use pip after navigating to the source directory::
...
target_file = path.join( here, 'engcoolprop','_version.py')
...
setup(
    ...
    download_url='https://github.com/sonofeft/EngCoolProp',
    ...
    package_data = {'engcoolprop':['examples/*.*']},
    ...
    test_suite='engcoolprop.tests', # allows "setup.py test" to work
    ...
    #entry_points = {
    #    'console_scripts': [
    #        'engcoolprop=engcoolprop.main:main',
    #    ],
    #},
)
