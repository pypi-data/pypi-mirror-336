...
from circle.web3.developer_controlled_wallets.models.transactions import Transactions  # noqa: E501
...
class TestTransactions(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.developer_controlled_wallets.models.transactions.Transactions()  # noqa: E501
        if include_optional :
            return Transactions(
                data = circle.web3.developer_controlled_wallets.models.transactions_data.Transactions_data(
                    transactions = [
