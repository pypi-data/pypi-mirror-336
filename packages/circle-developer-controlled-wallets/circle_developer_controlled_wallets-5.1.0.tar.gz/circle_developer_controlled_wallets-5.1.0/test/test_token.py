...
from circle.web3.developer_controlled_wallets.models.token import Token  # noqa: E501
...
class TestToken(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.developer_controlled_wallets.models.token.Token()  # noqa: E501
        if include_optional :
            return Token(
