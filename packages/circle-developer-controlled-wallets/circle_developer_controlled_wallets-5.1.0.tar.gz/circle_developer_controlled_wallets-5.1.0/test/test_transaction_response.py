...
from circle.web3.developer_controlled_wallets.models.transaction_response import TransactionResponse  # noqa: E501
...
class TestTransactionResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional):
        ...
        """
        model = circle.web3.developer_controlled_wallets.models.transaction_response.TransactionResponse()  # noqa: E501
        if include_optional :
            return TransactionResponse(
                data = circle.web3.developer_controlled_wallets.models.transaction_response_data.TransactionResponse_data(
                    transaction = circle.web3.developer_controlled_wallets.models.transaction.Transaction(
                        ...
                        error_reason = '', 
                        error_details = '', 
                        estimated_fee = circle.web3.developer_controlled_wallets.models.transaction_fee.TransactionFee(
                            gas_limit = '21000', 
                            gas_price = '', 
                            max_fee = '5.935224468', 
                        ...
                        transaction_screening_evaluation = circle.web3.developer_controlled_wallets.models.transaction_screening_decision.TransactionScreeningDecision(), ), )
            )
        else :
            return TransactionResponse(
                data = circle.web3.developer_controlled_wallets.models.transaction_response_data.TransactionResponse_data(
