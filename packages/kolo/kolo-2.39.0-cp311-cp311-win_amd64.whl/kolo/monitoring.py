...
from .utils import extract_http_trace_name
    ...
    class KoloMonitor:
        ...
        def save(self, frames_by_thread=None):
            ...
            if self.trace_name is None:
                self._set_http_trace_name(frames_by_thread)
        ...
        def _set_http_trace_name(self, frames_by_thread=None):
            """
            Extract HTTP request/response information from frames to set the trace name.
            """
            if frames_by_thread is None:
                frames_by_thread = self.frames_by_thread
