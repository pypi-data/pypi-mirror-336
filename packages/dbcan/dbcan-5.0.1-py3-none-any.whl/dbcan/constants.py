...
CGC_DEFAULT_ADDITIONAL_GENES = ['TC', 'TF', 'STP']
...
CGC_OUTER_TRACK_RANGE = (99.7, 100)
CGC_CAZYME_TRACK_RANGE = (45, 60)
CGC_FEATURE_TRACK_RANGE = (65, 80)
CGC_RANGE_TRACK_RANGE = (83, 88)
