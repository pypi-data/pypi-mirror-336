...
struct__cef_string_wide_t._fields_ = [
    ('str', ctypes.POINTER(ctypes.c_uint32)),
    ('length', ctypes.c_uint64),
    ('dtor', ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_uint32))),
]
...
struct__cef_string_utf8_t._fields_ = [
    ('str', ctypes.POINTER(ctypes.c_ubyte)),
    ('length', ctypes.c_uint64),
    ('dtor', ctypes.CFUNCTYPE(None, ctypes.POINTER(ctypes.c_ubyte))),
]
...
cef_string_wide_set.argtypes = [ctypes.POINTER(ctypes.c_uint32), size_t, ctypes.POINTER(struct__cef_string_wide_t), ctypes.c_int32]
...
cef_string_utf8_set.argtypes = [ctypes.POINTER(ctypes.c_ubyte), size_t, ctypes.POINTER(struct__cef_string_utf8_t), ctypes.c_int32]
...
cef_string_wide_to_utf8.argtypes = [ctypes.POINTER(ctypes.c_uint32), size_t, ctypes.POINTER(struct__cef_string_utf8_t)]
...
cef_string_utf8_to_wide.argtypes = [ctypes.POINTER(ctypes.c_ubyte), size_t, ctypes.POINTER(struct__cef_string_wide_t)]
...
cef_string_wide_to_utf16.argtypes = [ctypes.POINTER(ctypes.c_uint32), size_t, ctypes.POINTER(struct__cef_string_utf16_t)]
...
cef_string_utf8_to_utf16.argtypes = [ctypes.POINTER(ctypes.c_ubyte), size_t, ctypes.POINTER(struct__cef_string_utf16_t)]
...
cef_string_ascii_to_wide.argtypes = [ctypes.POINTER(ctypes.c_ubyte), size_t, ctypes.POINTER(struct__cef_string_wide_t)]
...
cef_string_ascii_to_utf16.argtypes = [ctypes.POINTER(ctypes.c_ubyte), size_t, ctypes.POINTER(struct__cef_string_utf16_t)]
...
cef_get_xdisplay = _libraries['FIXME_STUB'].cef_get_xdisplay
cef_get_xdisplay.restype = ctypes.POINTER(struct__XDisplay)
# cef_get_xdisplay()
cef_get_xdisplay.argtypes = []
...
struct__cef_main_args_t._fields_ = [
    ...
    ('argv', ctypes.POINTER(ctypes.POINTER(ctypes.c_ubyte))),
]
...
# Structure containing the plane information of the shared texture. Sync with
# native_pixmap_handle.h
class struct__cef_accelerated_paint_native_pixmap_plane_info_t(Structure):
    pass

struct__cef_accelerated_paint_native_pixmap_plane_info_t._pack_ = 1 # source:False
struct__cef_accelerated_paint_native_pixmap_plane_info_t._fields_ = [
...
# Structure containing the plane information of the shared texture. Sync with
# native_pixmap_handle.h
cef_accelerated_paint_native_pixmap_plane_t = struct__cef_accelerated_paint_native_pixmap_plane_info_t
...
struct__cef_accelerated_paint_info_t._fields_ = [
    ('planes', struct__cef_accelerated_paint_native_pixmap_plane_info_t * 4),
...
struct__cef_display_handler_t._fields_ = [
    ...
    ('on_cursor_change', ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct__cef_display_handler_t), ctypes.POINTER(struct__cef_browser_t), ctypes.c_uint64, c__EA_cef_cursor_type_t, ctypes.POINTER(struct__cef_cursor_info_t))),
...
struct__cef_keyboard_handler_t._fields_ = [
    ('base', cef_base_ref_counted_t),
    ('on_pre_key_event', ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct__cef_keyboard_handler_t), ctypes.POINTER(struct__cef_browser_t), ctypes.POINTER(struct__cef_key_event_t), ctypes.POINTER(union__XEvent), ctypes.POINTER(ctypes.c_int32))),
    ('on_key_event', ctypes.CFUNCTYPE(ctypes.c_int32, ctypes.POINTER(struct__cef_keyboard_handler_t), ctypes.POINTER(struct__cef_browser_t), ctypes.POINTER(struct__cef_key_event_t), ctypes.POINTER(union__XEvent))),
]
...
struct__cef_command_line_t._fields_ = [
    ...
    ('init_from_argv', ctypes.CFUNCTYPE(None, ctypes.POINTER(struct__cef_command_line_t), ctypes.c_int32, ctypes.POINTER(ctypes.POINTER(ctypes.c_ubyte)))),
...
cef_platform_thread_handle_t = ctypes.c_uint64
...
__all__ = \
    ...
    'cef_get_path', 'cef_get_temp_directory', 'cef_get_xdisplay',
    ...
    'struct__XDisplay', 'struct__cef_accelerated_paint_info_t',
    'struct__cef_accelerated_paint_native_pixmap_plane_info_t',
    ...
    'struct__cef_zip_reader_t', 'time_t', 'uint16_t', 'uint32_t',
    'union__XEvent']
