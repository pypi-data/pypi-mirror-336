...
def c_scatter(*args, **kwargs):
    ...
    """
def c_softmax_with_cross_entropy(*args, **kwargs):
    """
    C++ interface function for c_softmax_with_cross_entropy in dygraph.
    """
def c_softmax_with_cross_entropy_(*args, **kwargs):
    """
...
def c_softmax_with_multi_label_cross_entropy(*args, **kwargs):
    """
    C++ interface function for c_softmax_with_multi_label_cross_entropy in dygraph.
    """
def c_softmax_with_multi_label_cross_entropy_(*args, **kwargs):
    """
    C++ interface function for c_softmax_with_multi_label_cross_entropy_ in dygraph.
    """
def c_split(*args, **kwargs):
    """
...
def c_sync_calc_stream_(*args, **kwargs):
    ...
    """
def c_sync_comm_stream(*args, **kwargs):
    """
...
def distributed_fused_lamb_init(*args, **kwargs):
    ...
    """
def distributed_lookup_table(*args, **kwargs):
    """
    C++ interface function for distributed_lookup_table in dygraph.
    """
def distributed_push_sparse(*args, **kwargs):
    """
...
def moe_dispatch(*args, **kwargs):
    """
    C++ interface function for moe_dispatch in dygraph.
    """
def moe_ffn(*args, **kwargs):
    """
    C++ interface function for moe_ffn in dygraph.
    """
def moe_reduce(*args, **kwargs):
    """
    C++ interface function for moe_reduce in dygraph.
    """
...
def moving_average_abs_max_scale(*args, **kwargs):
    ...
    """
def mp_allreduce_sum(*args, **kwargs):
    """
    C++ interface function for mp_allreduce_sum in dygraph.
    """
def mp_allreduce_sum_(*args, **kwargs):
    """
...
def partial_concat(*args, **kwargs):
    ...
    """
def partial_recv(*args, **kwargs):
    """
    C++ interface function for partial_recv in dygraph.
    """
def partial_send(*args, **kwargs):
    """
