...
class CreateSwapQuote201Response(BaseModel):
    """
    ...
    quote_id: StrictStr = Field(description="The unique identifier of this quote.")
    __properties: ClassVar[List[str]] = ["pay_amount", "receive_amount", "fee_amount", "min_pay_amount", "max_pay_amount", "min_receive_amount", "max_receive_amount", "quote_expired_timestamp", "quote_id"]
