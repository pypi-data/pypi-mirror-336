...
class MessageSignDestination(BaseModel):
    ...
    # data type: RawMessageSignDestination
    ...
    def actual_instance_must_validate_oneof(cls, v):
        ...
        if not isinstance(v, EvmEIP712MessageSignDestination):
            ...
            match += 1
        # validate data type: RawMessageSignDestination
        if not isinstance(v, RawMessageSignDestination):
            error_messages.append(f"Error! Input type `{type(v)}` is not `RawMessageSignDestination`")
        else:
            match += 1
        # validate data type: BTCEIP191MessageSignDestination
        if not isinstance(v, BTCEIP191MessageSignDestination):
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        # check if data type is `RawMessageSignDestination`
        if _data_type == "RawMessageSignDestination":
            instance.actual_instance = RawMessageSignDestination.from_json(json_str)
            return instance
        ...
        try:
            ...
            error_messages.append(str(e))
        # deserialize data into RawMessageSignDestination
        try:
            instance.actual_instance = RawMessageSignDestination.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
        # deserialize data into BTCEIP191MessageSignDestination
        try:
            instance.actual_instance = BTCEIP191MessageSignDestination.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
