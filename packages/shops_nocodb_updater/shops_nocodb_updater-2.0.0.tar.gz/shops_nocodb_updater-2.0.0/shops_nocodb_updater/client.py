...
class NocodbClient:
    ...
    async def link_synced_records(
        ...
        self.logger.info(f"source_records_map: {source_records_map}")
        self.logger.info(f"target_records_map: {target_records_map}")
        self.logger.info(f"external_records_map: {external_records_map}")
