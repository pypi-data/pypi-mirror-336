...
pyodide_versions = ["0.26.2", "0.26.1", "0.25.1", "0.23.0"]


def main():
    url = os.environ["PYCAFE_CLIENT_URL"]
    ...
    for root, dirs, files in os.walk(args.input_dir):
        for filename in files:
            ...
            try:
                if filename in [".DS_Store", ".git"] or "__pycache__" in sub_path:
                    continue
    ...
    project_string = json.dumps(sorted_project, separators=(",", ":"))
