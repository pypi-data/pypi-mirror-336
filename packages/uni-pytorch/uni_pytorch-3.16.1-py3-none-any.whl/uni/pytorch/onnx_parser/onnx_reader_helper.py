...
KNOWN_DOMAINS = [onnx.defs.ONNX_DOMAIN, MCT_QUANTIZERS_DOMAIN, 'Sony']
...
class OnnxReaderHelper:
    ...
    @classmethod
    def parse_tensor_type(cls, tensor_type: onnx.ValueInfoProto) -> Tuple[str, tuple]:
