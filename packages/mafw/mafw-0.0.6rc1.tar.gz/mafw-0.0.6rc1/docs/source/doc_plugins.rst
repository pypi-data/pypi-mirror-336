...
The clean and effective: turn your library in a plugin
-------------------------------------------------------

It may sound much more difficult that what it is, but it is really not complicated. MAFw uses the plugin system developed by `pluggy <https://pluggy.readthedocs.io/en/stable/>`_, that is very powerful and at the same time relatively easy to deploy.
...
If you are still reading this tutorial, it means that you are aware of the benefits that MAFw can bring to your daily analysis task. And they are not yet finished. In the next page you will learn how to run all your complex analytical processors just be listing them in a steering file.