...
class BusinessProcessStepBlock(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["blockType", "stepType", "logicType", "dataFlowDirection", "interface", "id", "resolvable", "rerunnable", "attempts", "file"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "file": Attachment.from_dict(obj["file"]) if obj.get("file") is not None else None
        })
        return _obj
