...
class PublicPlatformOverviewResponseMtus(BaseModel):
    ...
    values: List[PublicPlatformOverviewResponseMtusValues]
    __properties: ClassVar[List[str]] = ["mtu", "affectedByOutage", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mtu": obj.get("mtu"),
            "affectedByOutage": obj.get("affectedByOutage"),
            "values": [PublicPlatformOverviewResponseMtusValues.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
