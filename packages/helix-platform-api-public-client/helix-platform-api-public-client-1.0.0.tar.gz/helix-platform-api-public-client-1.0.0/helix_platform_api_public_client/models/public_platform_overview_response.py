...
class PublicPlatformOverviewResponse(BaseModel):
    ...
    mtus: List[PublicPlatformOverviewResponseMtus]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mtus": [PublicPlatformOverviewResponseMtus.from_dict(_item) for _item in obj["mtus"]] if obj.get("mtus") is not None else None
        })
        return _obj
