...
class AggregatedNominations(BaseModel):
    ...
    """ # noqa: E501
    mpn: AggregatedNominationsValues
    gb: AggregatedNominationsValues
    fr: AggregatedNominationsValues
    __properties: ClassVar[List[str]] = ["mpn", "gb", "fr"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mpn": AggregatedNominationsValues.from_dict(obj["mpn"]) if obj.get("mpn") is not None else None,
            "gb": AggregatedNominationsValues.from_dict(obj["gb"]) if obj.get("gb") is not None else None,
            "fr": AggregatedNominationsValues.from_dict(obj["fr"]) if obj.get("fr") is not None else None
        })
        return _obj
