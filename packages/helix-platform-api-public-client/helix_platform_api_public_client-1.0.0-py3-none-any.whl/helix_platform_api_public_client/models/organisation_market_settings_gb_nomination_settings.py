...
class OrganisationMarketSettingsGbNominationSettings(BaseModel):
    ...
    bmu_demand_code: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=30)]] = Field(default=None, alias="bmuDemandCode")
    bmu_generation_code: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=30)]] = Field(default=None, alias="bmuGenerationCode")
