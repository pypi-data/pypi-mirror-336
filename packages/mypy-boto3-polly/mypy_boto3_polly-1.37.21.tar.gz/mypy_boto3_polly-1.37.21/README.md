...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-polly)](https://pypistats.org/packages/mypy-boto3-polly)
...
`mypy-boto3-polly` dependency in production. However, there is an issue in
