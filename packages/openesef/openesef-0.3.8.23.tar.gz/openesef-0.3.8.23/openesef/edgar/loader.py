...
def get_ins_facts():
    ins_facts = importlib.import_module('openesef.engines.ins_facts')
...
def get_xbrl_df_by_ticker_year(ticker, year, force_reload=False, memory_threshold_gb=16, 
    ...
    return get_fact_df(filing.url, force_reload=force_reload, edgar_local_path=edgar_local_path)
