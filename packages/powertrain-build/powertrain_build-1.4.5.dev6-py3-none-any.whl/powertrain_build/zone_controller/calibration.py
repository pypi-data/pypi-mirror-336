...
class ZoneControllerCalibration(ProblemLogger):
    ...
    def __init__(self, build_cfg, calib_data):
        ...
        suffix = build_cfg.get_scheduler_prefix().rstrip("_")
        self.calibration_interface_header = f'calibration_interface_{suffix}.h'
        self.calibration_interface_source = f'calibration_interface_{suffix}.c'
