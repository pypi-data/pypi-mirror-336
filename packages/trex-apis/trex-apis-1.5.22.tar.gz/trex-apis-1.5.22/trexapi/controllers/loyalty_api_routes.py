                                ...
                                'setting':[
                                            {
                                                "table_name": "setting",
                                                "version" : 6,
                                                "script": "ALTER TABLE setting ADD COLUMN device_token TEXT DEFAULT '';"
                                            ...
                                            },
                                            {
                                                "table_name": "setting",
                                                "version" : 6,
                                                "script": "ALTER TABLE setting ADD COLUMN enable_lock_screen TEXT DEFAULT 'false';"
                                            ...
                                            },
                                            {
                                                "table_name": "setting",
                                                "version" : 6,
                                                "script": "ALTER TABLE setting ADD COLUMN lock_screen_code TEXT DEFAULT '';"
                                            ...
                                            },
                                            {
                                                "table_name": "setting",
                                                "version" : 6,
                                                "script": 'ALTER TABLE setting ADD COLUMN lock_screen_length_in_second INTEGER DEFAULT 30;'
                                            }
