...
VERSION = "0.0.19"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
PACKAGES = [pack for pack in PACKAGES if "orangecontrib" in pack and "OWInterface" in pack]
...
PACKAGE_DATA = {
    "orangecontrib.OWInterface.widgets": ["icons/*", "designer/*"],
    "orangecontrib.OWInterface.webserver": ["sent_files/*", "received_files/*", "html_examples/*", "file_selection/*", "available_workflows/*"]
}
