...
class Error_OpaqueWithText(Error, NamedTuple('OpaqueWithText', [('obj', Any), ('objMessage', Any)])):
    def __dafnystr__(self) -> str:
        return f'ComAmazonawsDynamodbTypes.Error.OpaqueWithText({_dafny.string_of(self.obj)}, {_dafny.string_of(self.objMessage)})'
    def __eq__(self, __o: object) -> bool:
...
class OpaqueError:
    ...
    def _Is(source__):
        ...
        return ((d_50_e_).is_Opaque) or ((d_50_e_).is_OpaqueWithText)
...
class DummySubsetType:
    ...
    def default():
        return 1
    def _Is(source__):
        d_51_x_: int = source__
        return default__.IsDummySubsetType(d_51_x_)
