...
BASE_URL_FLASK = "http://cstore.servehttp.com:8080"
BASE_URL_HTTP = "http://cstore.servehttp.com:5060"

def load_credentials():
    """
    Lê as credenciais do arquivo e as armazena em variáveis globais.
    """
...
def login():
    """
    Faz login no servidor, usando credenciais já carregadas ou pedindo ao usuário.
    """
    global USER_EMAIL, USER_PASSWORD
    
    # Tenta login automático se já tiver credenciais
...
def cli_loop():
    """
    Loop interativo para quem quiser rodar o script diretamente:
      python cstore.py
    """
    load_credentials()
    while True:
...
if __name__ == "__main__":
    # Se rodar via `python cstore.py`, entra no modo interativo
    cli_loop()
