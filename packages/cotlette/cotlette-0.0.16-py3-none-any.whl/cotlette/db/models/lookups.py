...
from cotlette.core.exceptions import EmptyResultSet, FullResultSet
...
from cotlette.db.models.fields import (
    BooleanField,
    CharField,
    DateTimeField,
    Field,
...
from cotlette.db.models.query_utils import RegisterLookupMixin
...
class YearLookup(Lookup):
    def year_lookup_bounds(self, connection, year):
        from cotlette.db.models.functions import ExtractIsoYear
...
class UUIDTextMixin:
    ...
    def process_rhs(self, qn, connection):
        if not connection.features.has_native_uuid_field:
            from cotlette.db.models.functions import Replace
