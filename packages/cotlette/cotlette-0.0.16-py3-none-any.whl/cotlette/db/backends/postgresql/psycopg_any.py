...
try:
    ...
    class CotletteRangeDumper(RangeDumper):
        """A Range dumper customized for Cotlette."""

        def upgrade(self, obj, format):
            # Dump ranges containing naive datetimes as tstzrange, because
            # Cotlette doesn't use tz-aware ones.
    ...
    def get_adapters_template(use_tz, timezone):
        ...
        ctx.register_dumper(Range, CotletteRangeDumper)
