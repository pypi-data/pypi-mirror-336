...
from cotlette.db import migrations, router
...
class MigrationExecutor:
    ...
    def _create_project_state(self, with_applied_migrations=False):
        ...
        if with_applied_migrations:
            # Create the forwards plan Cotlette would follow on an empty database
    ...
    def migrate(self, targets, plan=None, state=None, fake=False, fake_initial=False):
        ...
        Cotlette first needs to create all project states before a migration is
        (un)applied and in a second step run all the database operations.
        """
        # The cotlette_migrations table must be present to record applied
    ...
    def _migrate_all_backwards(self, plan, full_plan, fake):
        ...
        migration, Cotlette will compute the migration states before each of them
