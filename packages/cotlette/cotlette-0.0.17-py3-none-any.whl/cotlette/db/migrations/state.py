...
from cotlette.apps.registry import apps as global_apps
from cotlette.conf import settings
from cotlette.core.exceptions import FieldDoesNotExist
from cotlette.db import models
from cotlette.db.migrations.utils import field_is_referenced, get_references
from cotlette.db.models import NOT_PROVIDED
from cotlette.db.models.fields.related import RECURSIVE_RELATIONSHIP_CONSTANT
from cotlette.db.models.options import DEFAULT_NAMES, normalize_together
from cotlette.db.models.utils import make_model_tuple
...
class StateApps(Apps):
    ...
    def __init__(self, real_apps, models, ignore_swappable=False):
        ...
        # which is called whenever Cotlette duplicates a StateApps before
        # updating it.
        self._lock = None
        ...
        from cotlette.core.checks.model_checks import _check_lazy_references
...
class ModelState:
    """
    Represent a Cotlette Model. Don't use the actual Model class as it's not
