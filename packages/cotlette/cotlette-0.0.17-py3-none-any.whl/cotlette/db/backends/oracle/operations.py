...
from cotlette.db.backends.utils import split_tzname_delta, strip_quotes, truncate_name
...
from cotlette.db.models.expressions import RawSQL
from cotlette.db.models.sql.where import WhereNode
from cotlette.utils import timezone
from cotlette.utils.encoding import force_bytes, force_str
...
/"""
    ...
    # https://groups.google.com/forum/#!msg/cotlette-developers/zwQju7hbG78/9l934yelwfsJ
    ...
    def get_db_converters(self, expression):
        ...
        # string, undo this to adhere to the Cotlette convention of using
    ...
    # DATE and TIMESTAMP columns, but Cotlette wants to see a
    ...
    def sql_flush(self, style, tables, *, reset_sequences=False, allow_cascade=False):
        ...
        # keys which Cotlette doesn't define. Emulate the PostgreSQL behavior
    ...
    def adapt_datetimefield_value(self, value):
        ...
        If naive datetime is passed assumes that is in UTC. Normally Cotlette
