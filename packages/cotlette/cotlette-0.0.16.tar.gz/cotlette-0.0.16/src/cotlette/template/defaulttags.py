...
from cotlette.utils.html import conditional_escape, escape, format_html
from cotlette.utils.lorem_ipsum import paragraphs, words
from cotlette.utils.safestring import mark_safe
...
class SpacelessNode(Node):
    ...
    def render(self, context):
        from cotlette.utils.html import strip_spaces_between_tags
...
class URLNode(Node):
    ...
    def render(self, context):
        from cotlette.urls import NoReverseMatch, reverse
...
def load(parser, token):
    ...
    ``cotlette/templatetags/news/photos.py``::
