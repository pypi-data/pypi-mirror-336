...
from cotlette.core.exceptions import FieldDoesNotExist, ImproperlyConfigured
from cotlette.core.signals import setting_changed
from cotlette.db import connections
from cotlette.db.models import (
    AutoField,
    CompositePrimaryKey,
    Manager,
    OrderWrt,
...
from cotlette.db.models.query_utils import PathInfo
from cotlette.utils.datastructures import ImmutableList, OrderedSet
from cotlette.utils.functional import cached_property
from cotlette.utils.module_loading import import_string
from cotlette.utils.text import camel_case_to_spaces, format_lazy
from cotlette.utils.translation import override
...
class Options:
    ...
    def contribute_to_class(self, cls, name):
        from cotlette.db import connection
        from cotlette.db.backends.utils import truncate_name
        ...
        if self.meta:
            ...
            for name in self.meta.__dict__:
                # Ignore any private attributes that Cotlette doesn't care about.
    ...
    def fields(self):
        ...
        Private API intended only to be used by Cotlette itself; get_fields()
    ...
    def _forward_fields_map(self):
        ...
        for field in fields:
            ...
            # Due to the way Cotlette's internals work, get_field() should also
    ...
    def _get_fields(
        ...
        * The include_parents argument toggles if fields from parent models
        ...
        # implementation and to provide a fast way for Cotlette's internals to
