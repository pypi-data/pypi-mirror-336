...
from cotlette.core.management import CommandError
from cotlette.db.migrations.graph import MigrationGraph
...
class MigrationLoader:
    ...
    inherit from cotlette.db.migrations.Migration. See
    cotlette.db.migrations.migration for what that looks like.
            ...
            if exc.node in reverse_replacements:
                ...
                if not is_replaced:
                    ...
                    raise NodeNotFoundError(
                        ...
                        "Cotlette tried to replace migration {1}.{2} with any of [{3}] "
