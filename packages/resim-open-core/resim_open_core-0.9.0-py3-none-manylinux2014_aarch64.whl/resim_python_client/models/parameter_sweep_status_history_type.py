...
@_attrs_define
class ParameterSweepStatusHistoryType:
    """ 
        Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        parameter_sweep_status_history_type = cls(
            status=status,
            updated_at=updated_at,
        )


        parameter_sweep_status_history_type.additional_properties = d
        return parameter_sweep_status_history_type
