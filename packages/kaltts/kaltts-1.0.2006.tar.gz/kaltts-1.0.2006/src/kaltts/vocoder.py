...
def griffin_lim(spectrogram, n_iter=60, window='hann', n_fft=1024, hop_length=None):
    ...
    # Iteratively reconstruct the waveform
    ...
    # Final inverse STFT to get the waveform
    waveform = librosa.istft(spectrogram * angles, hop_length=hop_length, window=window)
    return waveform
