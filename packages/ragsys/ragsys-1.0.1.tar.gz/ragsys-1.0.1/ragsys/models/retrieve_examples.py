...
class RetrieveExamples(BaseModel):
    """
    RetrieveExamples
    """ # noqa: E501
    query: StrictStr = Field(description="Text to be retrieved")
    amt: Optional[Annotated[int, Field(le=64, strict=True, ge=0)]] = None
    filters: Optional[StrictStr] = None
    diversity: Optional[Union[Annotated[float, Field(strict=True, ge=0.0)], Annotated[int, Field(strict=True, ge=0)]]] = Field(default=0.01, description="Weight for diversity reranking rules (0-1.5 recommended)")
    __properties: ClassVar[List[str]] = ["query", "amt", "filters", "diversity"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RetrieveExamples from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if amt (nullable) is None
        # and model_fields_set contains the field
        if self.amt is None and "amt" in self.model_fields_set:
            _dict['amt'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RetrieveExamples from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "diversity": obj.get("diversity") if obj.get("diversity") is not None else 0.01
        })
        return _obj
