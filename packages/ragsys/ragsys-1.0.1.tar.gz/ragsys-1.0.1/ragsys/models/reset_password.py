...
class ResetPassword(BaseModel):
    ...
    code: StrictStr = Field(description="Verification code sent to the email")
    code_expiration_timestamp: StrictInt = Field(description="Timestamp when the verification code expires")
    __properties: ClassVar[List[str]] = ["email", "password", "code", "code_expiration_timestamp"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "code": obj.get("code"),
            "code_expiration_timestamp": obj.get("code_expiration_timestamp")
        })
        return _obj
