...
class Usage(BaseModel):
    ...
    Usage
    """ # noqa: E501
    prompt_tokens: StrictInt = Field(description="Number of tokens used in the prompt")
    completion_tokens: StrictInt = Field(description="Number of tokens used in the completion")
