...
class CreateOrPartialUpdateExamplesResponse(BaseModel):
    """
    CreateOrPartialUpdateExamplesResponse
    """ # noqa: E501
    n_created: StrictInt = Field(description="Number of examples created")
    n_modified: StrictInt = Field(description="Number of examples modified")
    n_unmodified: StrictInt = Field(description="Number of examples unmodified")
    task: Optional[TaskResponse] = None
    __properties: ClassVar[List[str]] = ["n_created", "n_modified", "n_unmodified", "task"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateOrPartialUpdateExamplesResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateOrPartialUpdateExamplesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "n_created": obj.get("n_created"),
            "n_modified": obj.get("n_modified"),
            "n_unmodified": obj.get("n_unmodified"),
