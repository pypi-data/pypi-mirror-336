...
class SendResetPasswordRequest(BaseModel):
    ...
    email_redirect_url: StrictStr = Field(description="Email redirect URL. It will send set password email. The email, code and the code expiration will be added to the URL as query parameter")
    __properties: ClassVar[List[str]] = ["email", "email_redirect_url"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SendResetPasswordRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SendResetPasswordRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "email": obj.get("email"),
            "email_redirect_url": obj.get("email_redirect_url")
        })
        return _obj
