...
class InitDatabaseResponse(BaseModel):
    ...
    """ # noqa: E501
    id: StrictStr = Field(description="Database ID")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InitDatabaseResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InitDatabaseResponse from a dict"""
        if obj is None:
            return None
