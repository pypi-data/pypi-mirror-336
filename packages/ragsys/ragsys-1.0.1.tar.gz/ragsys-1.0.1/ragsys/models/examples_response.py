...
class ExamplesResponse(BaseModel):
    ...
    ExamplesResponse
    """ # noqa: E501
    examples: List[ExampleResponse] = Field(description="List of examples where each example is represented as an object with customizable properties. `type` and `item_id` are reserved and cannot be used as custom properties. ")
    next_cursor: Optional[StrictStr] = None
    has_next: Optional[StrictBool] = None
    __properties: ClassVar[List[str]] = ["examples", "next_cursor", "has_next"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExamplesResponse from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if has_next (nullable) is None
        # and model_fields_set contains the field
        if self.has_next is None and "has_next" in self.model_fields_set:
            _dict['has_next'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExamplesResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "examples": [ExampleResponse.from_dict(_item) for _item in obj["examples"]] if obj.get("examples") is not None else None,
