...
class Choice(BaseModel):
    ...
    Choice
    """ # noqa: E501
    finish_reason: StrictStr = Field(description="The reason the model stopped generating tokens")
    index: StrictInt = Field(description="Index of the choice")
    message: MessageCompletionContent = Field(description="Message generated by the model")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "index": obj.get("index"),
            "message": MessageCompletionContent.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
