...
class ValidationErrorDetail(BaseModel):
    ...
    """ # noqa: E501
    type: StrictStr
    loc: List[ValidationErrorDetailLocInner]
    msg: StrictStr
    __properties: ClassVar[List[str]] = ["type", "loc", "msg"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "type": obj.get("type"),
            "loc": [ValidationErrorDetailLocInner.from_dict(_item) for _item in obj["loc"]] if obj.get("loc") is not None else None,
            "msg": obj.get("msg")
        })
        return _obj
