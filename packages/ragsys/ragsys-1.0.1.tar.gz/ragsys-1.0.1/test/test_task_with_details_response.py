...
class TestTaskWithDetailsResponse(unittest.TestCase):
    """TaskWithDetailsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TaskWithDetailsResponse:
        """Test TaskWithDetailsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TaskWithDetailsResponse`
        """
        model = TaskWithDetailsResponse()
        if include_optional:
    ...
    def testTaskWithDetailsResponse(self):
        """Test TaskWithDetailsResponse"""
