...
class TestCompletionBody(unittest.TestCase):
    """CompletionBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CompletionBody:
        """Test CompletionBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CompletionBody`
        """
        model = CompletionBody()
        if include_optional:
            return CompletionBody(
                messages = [
                    ragsys.models.message_content.MessageContent(
                        role = 'user', 
                        content = null, )
                    ],
                retrieval = ragsys.models.retrieval.Retrieval(
                    amt = 0.0, 
                    filters = '', 
                    diversity = 0.0, ),
                model = '',
