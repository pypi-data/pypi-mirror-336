...
class TestRetrieveExamplesResponse(unittest.TestCase):
    """RetrieveExamplesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveExamplesResponse:
        """Test RetrieveExamplesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveExamplesResponse`
        """
        model = RetrieveExamplesResponse()
        if include_optional:
    ...
    def testRetrieveExamplesResponse(self):
        """Test RetrieveExamplesResponse"""
