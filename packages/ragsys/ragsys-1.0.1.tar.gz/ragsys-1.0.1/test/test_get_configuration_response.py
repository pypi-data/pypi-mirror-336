...
class TestGetConfigurationResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetConfigurationResponse:
        """Test GetConfigurationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GetConfigurationResponse`
        """
        model = GetConfigurationResponse()
        if include_optional:
    ...
    def testGetConfigurationResponse(self):
        """Test GetConfigurationResponse"""
