...
class TestExamplesBody(unittest.TestCase):
    """ExamplesBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExamplesBody:
        """Test ExamplesBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExamplesBody`
        """
        model = ExamplesBody()
        if include_optional:
            return ExamplesBody(
