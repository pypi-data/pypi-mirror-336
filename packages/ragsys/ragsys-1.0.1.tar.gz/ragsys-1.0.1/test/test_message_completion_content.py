...
class TestMessageCompletionContent(unittest.TestCase):
    """MessageCompletionContent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MessageCompletionContent:
        """Test MessageCompletionContent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MessageCompletionContent`
        """
        model = MessageCompletionContent()
        if include_optional:
            return MessageCompletionContent(
                role = 'assistant',
                content = ''
            )
        else:
    ...
    def testMessageCompletionContent(self):
        """Test MessageCompletionContent"""
