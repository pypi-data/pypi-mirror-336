...
class TestDatabaseListResponse(unittest.TestCase):
    """DatabaseListResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DatabaseListResponse:
        """Test DatabaseListResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabaseListResponse`
        """
        model = DatabaseListResponse()
        if include_optional:
            return DatabaseListResponse(
                databases = [
                    ragsys.models.database_item.DatabaseItem(
                        id = '', 
                        name = '', )
                    ],
                has_next = True,
    ...
    def testDatabaseListResponse(self):
        """Test DatabaseListResponse"""
