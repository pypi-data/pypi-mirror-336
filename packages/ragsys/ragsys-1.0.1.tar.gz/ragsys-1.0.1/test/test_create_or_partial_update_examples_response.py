...
class TestCreateOrPartialUpdateExamplesResponse(unittest.TestCase):
    """CreateOrPartialUpdateExamplesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrPartialUpdateExamplesResponse:
        """Test CreateOrPartialUpdateExamplesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrPartialUpdateExamplesResponse`
        """
        model = CreateOrPartialUpdateExamplesResponse()
        if include_optional:
            return CreateOrPartialUpdateExamplesResponse(
                n_created = 56,
                n_modified = 56,
                n_unmodified = 56,
                task = ragsys.models.task_response.TaskResponse(
                    task_id = '', 
                    task_type = 'retrieval_model_retrain', )
            )
        else:
            return CreateOrPartialUpdateExamplesResponse(
                n_created = 56,
    ...
    def testCreateOrPartialUpdateExamplesResponse(self):
        """Test CreateOrPartialUpdateExamplesResponse"""
