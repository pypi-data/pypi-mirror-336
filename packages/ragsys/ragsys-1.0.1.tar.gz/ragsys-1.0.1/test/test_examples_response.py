...
class TestExamplesResponse(unittest.TestCase):
    """ExamplesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ExamplesResponse:
        """Test ExamplesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ExamplesResponse`
        """
        model = ExamplesResponse()
        if include_optional:
