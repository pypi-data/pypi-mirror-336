...
class TestDatabaseItem(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DatabaseItem:
        """Test DatabaseItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DatabaseItem`
        """
        model = DatabaseItem()
        if include_optional:
            return DatabaseItem(
