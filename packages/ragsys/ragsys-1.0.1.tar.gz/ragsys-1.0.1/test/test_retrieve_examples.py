...
class TestRetrieveExamples(unittest.TestCase):
    """RetrieveExamples unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RetrieveExamples:
        """Test RetrieveExamples
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RetrieveExamples`
        """
        model = RetrieveExamples()
        if include_optional:
