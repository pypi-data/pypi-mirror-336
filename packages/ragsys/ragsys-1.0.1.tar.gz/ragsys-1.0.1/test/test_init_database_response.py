...
class TestInitDatabaseResponse(unittest.TestCase):
    """InitDatabaseResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> InitDatabaseResponse:
        """Test InitDatabaseResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `InitDatabaseResponse`
        """
        model = InitDatabaseResponse()
        if include_optional:
    ...
    def testInitDatabaseResponse(self):
        """Test InitDatabaseResponse"""
