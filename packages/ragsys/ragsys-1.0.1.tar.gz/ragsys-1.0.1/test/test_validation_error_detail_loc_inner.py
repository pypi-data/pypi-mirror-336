...
class TestValidationErrorDetailLocInner(unittest.TestCase):
    """ValidationErrorDetailLocInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ValidationErrorDetailLocInner:
        """Test ValidationErrorDetailLocInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ValidationErrorDetailLocInner`
        """
        model = ValidationErrorDetailLocInner()
        if include_optional:
            return ValidationErrorDetailLocInner(
            )
        else:
            return ValidationErrorDetailLocInner(
        )
    ...
    def testValidationErrorDetailLocInner(self):
        """Test ValidationErrorDetailLocInner"""
