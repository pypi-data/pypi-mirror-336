...
class TestLlmListModelsResponse(unittest.TestCase):
    """LlmListModelsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LlmListModelsResponse:
        """Test LlmListModelsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LlmListModelsResponse`
        """
        model = LlmListModelsResponse()
        if include_optional:
    ...
    def testLlmListModelsResponse(self):
        """Test LlmListModelsResponse"""
