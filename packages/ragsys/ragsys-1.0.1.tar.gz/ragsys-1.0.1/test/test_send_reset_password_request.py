...
class TestSendResetPasswordRequest(unittest.TestCase):
    """SendResetPasswordRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SendResetPasswordRequest:
        """Test SendResetPasswordRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SendResetPasswordRequest`
        """
        model = SendResetPasswordRequest()
        if include_optional:
            return SendResetPasswordRequest(
                email = '',
                email_redirect_url = ''
            )
        else:
    ...
    def testSendResetPasswordRequest(self):
        """Test SendResetPasswordRequest"""
