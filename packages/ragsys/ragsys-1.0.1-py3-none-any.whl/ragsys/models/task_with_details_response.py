...
class TaskWithDetailsResponse(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["task_id", "task_type", "status", "start_time", "progress"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TaskWithDetailsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TaskWithDetailsResponse from a dict"""
        if obj is None:
            return None
