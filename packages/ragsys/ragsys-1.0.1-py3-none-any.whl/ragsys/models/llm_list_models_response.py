...
class LlmListModelsResponse(BaseModel):
    ...
    """ # noqa: E501
    models: List[StrictStr] = Field(description="Models available to use in chat completion")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of LlmListModelsResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of LlmListModelsResponse from a dict"""
        if obj is None:
            return None
