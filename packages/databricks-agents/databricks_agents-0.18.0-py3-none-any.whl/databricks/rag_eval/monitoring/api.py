...
def create_external_monitor(
    *,
    ...
    monitoring_config = entities.MonitoringConfig.from_assessments_suite_config(
        assessments_config,
    )
    ...
    print(
        f"\nCreated external monitor successfully using experiment_id '{monitor.experiment_id}'.\n\n"
        "You will need this experiment_id when you set your agent's tracing destination to "
        f"`Databricks(experiment_id={monitor.experiment_id})`"
    )
    return monitor
