...
from ..models.send_message_to_user_response_message_attachments_actions_array_item_ref import (
    SendMessageToUserResponseMessageAttachmentsActionsArrayItemRef,
)


class SendMessageToUserResponseMessageAttachmentsArrayItemRef(BaseModel):
    """
    Attributes:
        actions (Optional[list['SendMessageToUserResponseMessageAttachmentsActionsArrayItemRef']]):
    ...
    actions: Optional[
        list["SendMessageToUserResponseMessageAttachmentsActionsArrayItemRef"]
    ] = Field(alias="actions", default=None)
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageToUserResponseMessageAttachmentsArrayItemRef"],
