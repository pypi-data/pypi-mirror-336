...
class SendReplyResponseMessageRoot(BaseModel):
    ...
    blocks: Optional[list["SendReplyResponseMessageRootBlocksArrayItemRef"]] = Field(
        alias="blocks", default=None
    )
    bot_id: Optional[str] = Field(alias="bot_id", default=None)
    icons: Optional["SendReplyResponseMessageRootIcons"] = Field(
    ...
    metadata: Optional["SendReplyResponseMessageRootMetadata"] = Field(
