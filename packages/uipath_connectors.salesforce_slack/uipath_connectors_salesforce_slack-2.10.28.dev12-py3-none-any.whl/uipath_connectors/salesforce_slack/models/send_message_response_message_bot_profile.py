...
from ..models.send_message_response_message_bot_profile_icons import (
    SendMessageResponseMessageBotProfileIcons,
)


class SendMessageResponseMessageBotProfile(BaseModel):
    """
    Attributes:
        app_id (Optional[str]):  Example: A44S6RJ2V.
        deleted (Optional[bool]):
        icons (Optional[SendMessageResponseMessageBotProfileIcons]):
    ...
    icons: Optional["SendMessageResponseMessageBotProfileIcons"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageResponseMessageBotProfile"], src_dict: Dict[str, Any]
    ):
