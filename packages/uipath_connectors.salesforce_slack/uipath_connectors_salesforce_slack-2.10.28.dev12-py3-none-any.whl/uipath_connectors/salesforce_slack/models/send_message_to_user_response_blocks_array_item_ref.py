...
class SendMessageToUserResponseBlocksArrayItemRef(BaseModel):
    """
    Attributes:
        block_id (Optional[str]):  Example: ZU=Pr.
        text (Optional[SendMessageToUserResponseBlocksText]):
    ...
    text: Optional["SendMessageToUserResponseBlocksText"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageToUserResponseBlocksArrayItemRef"],
