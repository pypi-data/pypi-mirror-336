...
class SendMessageResponseRoot(BaseModel):
    ...
    blocks: Optional[list["SendMessageResponseRootBlocksArrayItemRef"]] = Field(
        alias="blocks", default=None
    )
    bot_id: Optional[str] = Field(alias="bot_id", default=None)
    icons: Optional["SendMessageResponseRootIcons"] = Field(alias="icons", default=None)
    ...
    metadata: Optional["SendMessageResponseRootMetadata"] = Field(
