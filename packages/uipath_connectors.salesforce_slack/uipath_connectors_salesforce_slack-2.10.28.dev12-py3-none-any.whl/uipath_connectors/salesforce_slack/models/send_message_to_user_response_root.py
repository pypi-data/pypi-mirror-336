...
class SendMessageToUserResponseRoot(BaseModel):
    """
    Attributes:
        app_id (Optional[str]):  Example: A02CEJTE85R.
        blocks (Optional[list['SendMessageToUserResponseRootBlocksArrayItemRef']]):
        bot_id (Optional[str]):  Example: B02DYM5F1ST.
        icons (Optional[SendMessageToUserResponseRootIcons]):
        is_locked (Optional[bool]):
        latest_reply (Optional[str]):  Example: 1675233584.607969.
        metadata (Optional[SendMessageToUserResponseRootMetadata]):
    ...
    blocks: Optional[list["SendMessageToUserResponseRootBlocksArrayItemRef"]] = Field(
        alias="blocks", default=None
    )
    bot_id: Optional[str] = Field(alias="bot_id", default=None)
    icons: Optional["SendMessageToUserResponseRootIcons"] = Field(
    ...
    metadata: Optional["SendMessageToUserResponseRootMetadata"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["SendMessageToUserResponseRoot"], src_dict: Dict[str, Any]):
