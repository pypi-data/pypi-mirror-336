...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SendReplyResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, SendReplyResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Send Reply
     ...
     Send a reply to a message in channel
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, SendReplyResponse]
    """
