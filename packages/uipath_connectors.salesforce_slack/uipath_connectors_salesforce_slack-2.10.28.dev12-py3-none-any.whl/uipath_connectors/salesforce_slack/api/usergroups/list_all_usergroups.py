    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListAllUsergroups.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        include_disabled (Optional[bool]): Whether to include disabled user groups?
        include_count (Optional[bool]): Whether to include the number of users in each user group?
        include_users (Optional[bool]): Whether to include the list of users for each user group?
