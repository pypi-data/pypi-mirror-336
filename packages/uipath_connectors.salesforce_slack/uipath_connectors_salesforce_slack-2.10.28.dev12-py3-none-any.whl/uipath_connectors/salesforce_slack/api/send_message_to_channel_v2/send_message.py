...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/send_message_to_channel_v2",
        "params": params,
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, SendMessageResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Send Message to Channel
     ...
     Send message to a public or private channel
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, SendMessageResponse]
    """
