...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/respond_to_interaction_messages",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SendButtonResponseResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, SendButtonResponseResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, SendButtonResponseResponse]
    """
