...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ConversationsJoinResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[ConversationsJoinResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        send_as (str): Whether to join the channel as the App bot i.e. using Bot token or yourself
...
def sync(
    *,
    ...
    Returns:
        Union[ConversationsJoinResponse, DefaultError]
    """
