...
from ..models.send_message_response_message_attachments_actions_array_item_ref import (
    SendMessageResponseMessageAttachmentsActionsArrayItemRef,
)


class SendMessageResponseMessageAttachmentsArrayItemRef(BaseModel):
    """
    Attributes:
        actions (Optional[list['SendMessageResponseMessageAttachmentsActionsArrayItemRef']]):
    ...
    actions: Optional[
        list["SendMessageResponseMessageAttachmentsActionsArrayItemRef"]
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageResponseMessageAttachmentsArrayItemRef"],
