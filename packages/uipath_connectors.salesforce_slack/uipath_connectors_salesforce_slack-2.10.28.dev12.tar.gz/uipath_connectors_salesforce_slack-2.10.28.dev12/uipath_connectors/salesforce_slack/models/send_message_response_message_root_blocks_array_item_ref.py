...
class SendMessageResponseMessageRootBlocksArrayItemRef(BaseModel):
    """
    Attributes:
        block_id (Optional[str]):  Example: /5z1a.
        elements (Optional[list['SendMessageResponseMessageRootBlocksElementsArrayItemRef']]):
    ...
    elements: Optional[
        list["SendMessageResponseMessageRootBlocksElementsArrayItemRef"]
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageResponseMessageRootBlocksArrayItemRef"],
