...
from ..models.send_message_request_attachments_actions_array_item_ref import (
    SendMessageRequestAttachmentsActionsArrayItemRef,
)


class SendMessageRequestAttachmentsArrayItemRef(BaseModel):
    """
    Attributes:
        actions (Optional[list['SendMessageRequestAttachmentsActionsArrayItemRef']]):
    ...
    actions: Optional[list["SendMessageRequestAttachmentsActionsArrayItemRef"]] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageRequestAttachmentsArrayItemRef"], src_dict: Dict[str, Any]
    ):
