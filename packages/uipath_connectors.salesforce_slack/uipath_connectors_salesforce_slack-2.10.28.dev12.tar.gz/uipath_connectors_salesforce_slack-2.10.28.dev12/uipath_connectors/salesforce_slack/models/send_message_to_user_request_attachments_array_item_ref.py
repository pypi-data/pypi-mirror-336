...
class SendMessageToUserRequestAttachmentsArrayItemRef(BaseModel):
    """
    Attributes:
        actions (Optional[list['SendMessageToUserRequestAttachmentsActionsArrayItemRef']]):
    ...
    actions: Optional[
        list["SendMessageToUserRequestAttachmentsActionsArrayItemRef"]
    ...
    @classmethod
    def from_dict(
        cls: Type["SendMessageToUserRequestAttachmentsArrayItemRef"],
