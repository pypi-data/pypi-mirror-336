...
# Versioning
FAB_VERSION = "0.1.9"  # change pyproject.toml version too, this must be aligned
...
AUTH_KEYS = {
    FAB_TENANT_ID: [],
    FAB_AUTHORITY: [],
    FAB_AUTH_MODE: ["user", "service_principal", "managed_identity"],
}
...
ERROR_INVALID_GIUD = "InvalidGuid"
