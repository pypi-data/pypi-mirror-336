...
def register_get_parser(subparsers: _SubParsersAction) -> None:
    ...
    get_parser = subparsers.add_parser(
        "get", fab_examples=get_examples, fab_learnmore=get_learnmore
    )
...
def register_import_parser(subparsers: _SubParsersAction) -> None:
    ...
    import_parser.add_argument(
        "-i", "--input", nargs="+", required=True, help="Input JSON path for import"
    )
    import_parser.add_argument(
        "--format",
        metavar="",
...
def register_set_parser(subparsers: _SubParsersAction) -> None:
    ...
    set_parser = subparsers.add_parser(
        "set", fab_examples=set_examples, fab_learnmore=set_learnmore
    )
