...
class BaserowApi:
    ...
    def _get_rows_data(
        ...
        Args:
            ...
            row_id (int, optional): ID of entry of interest. Defaults to None.
                If provided, only the entry is returned. Else, all entries are returned.
    ...
    def get_data(
        ...
        Args:
            ...
            writable_only (bool, optional): Only return fields which can be written to. This
                excludes all formula and computed fields. Defaults to True (only writable fields).
            user_field_names (bool, optional): Whether to reference columns by name or ID.
                Defaults to True (use names).
    ...
    def get_entry(
        ...
        Args:
            ...
            linked (bool, optional): Whether to fully hydrate the output with linked tables.
                Defaults to False (no data of linked tables is loaded).
    ...
    def add_data(
        ...
        """Add or change a single data row in a table.

        Args:
            table_id (int): Table ID of table of interest.
            data (dict): Data to be added or change.
            row_id (int, optional): Row ID where to enter the data in the table.
                Defaults to None (create new row).
            user_field_names (bool, optional): Whether to reference columns by name or ID.
                Defaults to True (use names).

        Returns:
            int: Row ID of the added/changed data row.
        """
        fields = self.get_fields(table_id)
    ...
    def add_data_batch(
        ...
        """Add or change data (multiple rows) to a table.
        ...
        Args:
            ...
            fail_on_error (bool, optional): Whether to fail if error appears.
                Defaults to False (continue on error).
