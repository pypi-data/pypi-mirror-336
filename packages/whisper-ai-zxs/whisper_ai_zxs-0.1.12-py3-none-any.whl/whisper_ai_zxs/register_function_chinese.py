    ...
    def main():
        ...
        tools=[{"type": "file_search"},{"type": "code_interpreter"},
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "reason": {
                            "type": "string",
                            "description": "转接原因，可根据客户实际的问题，简单描述处理不了的原因。"
                        }
                        },
                        "required": [
                        "reason"
            ...
            },
            {
                ...
                "function": {
                    "name": "modify_notes",
                    "description": "当遇到客户提出跟赠送小样、发货包装等相关的小要求时，可通过此接口进行订单备注，通知发货工作人员进行相关特殊操作。相关操作包括 暂不发货、可以发货、包装注意事项、赠送小样等情况。订单需要是‘未付款’或者‘待发货’状态才能调用此函数。如果没有‘未付款’或者‘待发货’订单，则提醒客户下单后，再通知客服添加备注。",
                    "parameters": {
                        "type": "object",
                        "properties": {
                        "order_id": {
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "order_id": {
                            "type": "string",
                            "description": "有商品错发、漏发的订单编号，此订单编号通过订单查询函数进行查询获取。"
                        },
                        "error_type": {
                            "type": "string",
                        ...
                        "name": {
                            "type": "string",
                            "description": "当客户希望补发时，需要客户提供收件人姓名。"
                        },
                        "telephone": {
                            "type": "string",
                            "description": "当客户希望补发时，需要客户提供收件人电话，电话号码必须重新向用户索取，订单查询函数中获取的收件人电话号码是加密后的，不能再次使用。"
                        },
                        "address": {
                            "type": "string",
                            "description": "当客户希望补发时，需要客户提供收件人详细地址。"
                        }
                        },
                        "required": [
                        "order_id",
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "order_id": {
                            "type": "string",
                            "description": "有物流异常的订单编号，此订单编号通过订单查询函数进行查询获取。"
                        },
                        "error_type": {
                            "type": "string",
            ...
            },
            {
                ...
                "function": {
                    ...
                    "parameters": {
                        ...
                        "order_id": {
                            "type": "string",
                            "description": "需要修改的订单ID，此订单编号通过订单查询函数进行查询获取。"
                        },
                        "new_address_name": {
                            "type": "string",
                            "description": "修改后的收件人姓名"
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "Version:0.9 StartHTML:0000000117 EndHTML:0000000315 StartFragment:0000000153 EndFragment:0000000279 SourceURL: 当客户反馈商品质量问题时，调用此函数提交商品质量问题工单。提交后，会有专人和客户联系。",
                    "parameters": {
                        "type": "object",
                        "properties": {
                            "order_id": {
                                "type": "string",
                                "description": "有产品质量问题的订单 ID。此订单 ID 可以通过 get_recently_order 函数获取。"
                            },
                            "products_images": {
                                "type": "array",
                                "items": {
            ...
            },
            {
                ...
                "function": {
                    ...
                    "description": "当客户询问当前的优惠活动、商品是否销售、有哪些折扣/优惠、空瓶回收活动细节时，可调用此函数查询店铺现在进行的所有活动、在售商品的产品编码、产品折扣/优惠、产品具体规格在售情况等信息。当客户隔段时间再问时，需要重新查询最新情况。",
                    "parameters": {
                        "type": "object",
                        "properties": {},
                        "required": []
