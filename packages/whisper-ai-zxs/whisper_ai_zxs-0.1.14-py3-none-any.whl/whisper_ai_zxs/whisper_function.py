...
class modify_address(BaseClass):
    def call(self, user, arguments, agent):
        ...
        if agent.is_register(self.__class__.__name__):
            ...
            agent.report_modify_address_sended(arguments_dict['order_id'], user, service_detail)
            result = "已经提交工单"
        return json.dumps(result)
    pass
...
class report_logistic_error(BaseClass):
    def call(self, user, arguments, agent):
        ...
        if agent.is_register(self.__class__.__name__):
            ...
            agent.report_logistic_error(arguments_dict['order_id'], user, service_detail)
            result = "已经提交工单"
        return json.dumps(result)
    pass
class report_delivery_error(BaseClass):
    def call(self, user, arguments, agent):
        ...
        if agent.is_register(self.__class__.__name__):
            ...
            agent.report_delivery_error(arguments_dict['order_id'], user, service_detail)
            result = "已经提交工单"
        return json.dumps(result)
    pass
...
class report_product_error(BaseClass):
    def call(self, user, arguments, agent):
        ...
        if agent.is_register(self.__class__.__name__):
            ...
            agent.report_product_error(arguments_dict['order_id'], user, service_detail)
            result = "已经提交工单"
        return json.dumps(result)
    pass
