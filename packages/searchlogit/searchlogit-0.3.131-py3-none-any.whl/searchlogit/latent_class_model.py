...
# {
    ...
    # {
        ...
        self.varnames = np.array(list(set(self.class_params_spec_is[i]+self.class_params_spec[i])))
    ...
    # {
        ...
        log_lik_old, log_lik_new = -1E10, -1E10
        iter, max_iter = 0, 1000 #TODO add this as an argument
        terminate, converged = False, False
        self.H = None
        ...
        # {
            ...
            converged = abs(log_lik_new - log_lik_old) < self.ftol_lccm 
            log_lik_old = log_lik_new
            iter += 1
