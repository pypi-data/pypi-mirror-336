...
@server.tool("test_snowflake_connection")
...
@server.tool("list_available_tables")
...
@server.tool("get_merchant_info")
async def get_merchant(merchant_token: str) -> Dict[str, Any]:
