...
class TIKTOK:
    ...
    def CheckEmail(email,st):
        ...
        try:
            ...
            return{"data":{"status":"Session expired. Log in to continue.","programmer":"@ii33cc"}}
    @staticmethod
    def search():
        #while True:
            try:
...
'abcdefghijklmnopqrstuvwxyzéèêëàâäôùûüîïç',
                ...
                for users in response['user_list']:
                    ...
                    return {"data":{"status":True,"username":user,"follower_count":fol,"id":ud,"programmer":"@ii33cc"}}
            except Exception as e:
                 return{"data":{"status":"Try agin ! ","programmer":"@ii33cc"}}
    @staticmethod
    def info(user):
        he={
