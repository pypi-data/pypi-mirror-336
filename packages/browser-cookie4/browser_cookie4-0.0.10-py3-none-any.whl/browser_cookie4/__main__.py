...
import argparse
import browser_cookie4
import json


def parse_args(args=None):
    p = argparse.ArgumentParser(
        description='Extract browser cookies using browser_cookie4.',
    ...
    for browser in browser_cookie4.all_browsers:
...
def main(args=None):
    ...
    try:
        if args.browser:
            ...
            cj = browser_cookie4.load()
    except browser_cookie4.BrowserCookieError as e:
        p.error(e.args[0])
