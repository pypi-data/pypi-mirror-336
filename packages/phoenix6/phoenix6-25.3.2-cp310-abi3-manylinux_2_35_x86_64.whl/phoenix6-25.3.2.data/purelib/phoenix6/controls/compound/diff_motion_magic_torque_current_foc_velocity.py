...
class Diff_MotionMagicTorqueCurrentFOC_Velocity:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® average target and velocity difference
    ...
    def __init__(self, average_request: MotionMagicTorqueCurrentFOC, differential_request: VelocityTorqueCurrentFOC):
        self._name = "Diff_MotionMagicTorqueCurrentFOC_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicTorqueCurrentFOC_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicTorqueCurrentFOC) -> 'Diff_MotionMagicTorqueCurrentFOC_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicTorqueCurrentFOC_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityTorqueCurrentFOC) -> 'Diff_MotionMagicTorqueCurrentFOC_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicTorqueCurrentFOC_Velocity':
        """
