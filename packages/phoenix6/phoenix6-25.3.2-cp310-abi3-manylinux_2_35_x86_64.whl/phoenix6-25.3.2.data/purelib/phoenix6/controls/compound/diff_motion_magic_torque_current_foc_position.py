...
class Diff_MotionMagicTorqueCurrentFOC_Position:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with Motion Magic® average target and position difference
    ...
    def __init__(self, average_request: MotionMagicTorqueCurrentFOC, differential_request: PositionTorqueCurrentFOC):
        self._name = "Diff_MotionMagicTorqueCurrentFOC_Position"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicTorqueCurrentFOC_Position")
    ...
    def with_average_request(self, new_average_request: MotionMagicTorqueCurrentFOC) -> 'Diff_MotionMagicTorqueCurrentFOC_Position':
        ...
        :type new_average_request: MotionMagicTorqueCurrentFOC
        :returns: Itself
        :rtype: Diff_MotionMagicTorqueCurrentFOC_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionTorqueCurrentFOC) -> 'Diff_MotionMagicTorqueCurrentFOC_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicTorqueCurrentFOC_Position':
        """
