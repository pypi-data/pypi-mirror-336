...
class MotionMagicExpoVoltage:
    ...
    honor the Cruise Velocity (optional) and the mechanism kV and kA, specified via
    the Motion Magic® configuration values.  Note that unlike the slot gains, the
    Expo_kV and Expo_kA configs are always in output units of Volts.
    
    Setting Cruise Velocity to 0 will allow the profile to run to the max possible
    velocity based on Expo_kV.  This control mode does not use the Acceleration or
    Jerk configs.
    
    Target position can be changed on-the-fly and Motion Magic® will do its best to
    adjust the profile.  This control mode is voltage-based, so relevant closed-loop
    ...
    def __init__(self, position: rotation, enable_foc: bool = True, feed_forward: volt = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "MotionMagicExpoVoltage"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MotionMagicExpoVoltage")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicExpoVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.position, self.enable_foc, self.feed_forward, self.slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_position(self, new_position: rotation) -> 'MotionMagicExpoVoltage':
        """
        ...
        :returns: Itself
        :rtype: MotionMagicExpoVoltage
        """
        self.position = new_position
        return self
    
    def with_enable_foc(self, new_enable_foc: bool) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_feed_forward(self, new_feed_forward: volt) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_slot(self, new_slot: int) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'MotionMagicExpoVoltage':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'MotionMagicExpoVoltage':
        """
