...
class DifferentialDutyCycle:
    ...
    def __init__(self, target_output: float, differential_position: rotation, enable_foc: bool = True, differential_slot: int = 1, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "DifferentialDutyCycle"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: DifferentialDutyCycle")
        ss.append("    target_output: " + str(self.target_output) + " fractional")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.target_output, self.differential_position, self.enable_foc, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_target_output(self, new_target_output: float) -> 'DifferentialDutyCycle':
        """
        ...
        :type new_target_output: float
        :returns: Itself
        :rtype: DifferentialDutyCycle
        """
        self.target_output = new_target_output
        return self
    
    def with_differential_position(self, new_differential_position: rotation) -> 'DifferentialDutyCycle':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def with_differential_slot(self, new_differential_slot: int) -> 'DifferentialDutyCycle':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'DifferentialDutyCycle':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'DifferentialDutyCycle':
        """
