...
class MotionMagicVelocityDutyCycle:
    ...
    best to adjust the profile.  This control mode is duty cycle based, so relevant
    ...
    def __init__(self, velocity: rotations_per_second, acceleration: rotations_per_second_squared = 0.0, enable_foc: bool = True, feed_forward: float = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "MotionMagicVelocityDutyCycle"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MotionMagicVelocityDutyCycle")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicVelocityDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.velocity, self.acceleration, self.enable_foc, self.feed_forward, self.slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_velocity(self, new_velocity: rotations_per_second) -> 'MotionMagicVelocityDutyCycle':
        """
        ...
        :returns: Itself
        :rtype: MotionMagicVelocityDutyCycle
        """
        self.velocity = new_velocity
        return self
    
    def with_acceleration(self, new_acceleration: rotations_per_second_squared) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_feed_forward(self, new_feed_forward: float) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_slot(self, new_slot: int) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'MotionMagicVelocityDutyCycle':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'MotionMagicVelocityDutyCycle':
        """
