...
class DifferentialVelocityDutyCycle:
    ...
    def __init__(self, target_velocity: rotations_per_second, differential_position: rotation, enable_foc: bool = True, target_slot: int = 0, differential_slot: int = 1, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "DifferentialVelocityDutyCycle"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: DifferentialVelocityDutyCycle")
        ss.append("    target_velocity: " + str(self.target_velocity) + " rotations per second")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialVelocityDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.target_velocity, self.differential_position, self.enable_foc, self.target_slot, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_target_velocity(self, new_target_velocity: rotations_per_second) -> 'DifferentialVelocityDutyCycle':
        """
        ...
        :returns: Itself
        :rtype: DifferentialVelocityDutyCycle
        """
        self.target_velocity = new_target_velocity
        return self
    
    def with_differential_position(self, new_differential_position: rotation) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_target_slot(self, new_target_slot: int) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_differential_slot(self, new_differential_slot: int) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'DifferentialVelocityDutyCycle':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'DifferentialVelocityDutyCycle':
        """
