...
class MotionMagicExpoTorqueCurrentFOC:
    ...
    def __init__(self, position: rotation, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "MotionMagicExpoTorqueCurrentFOC"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MotionMagicExpoTorqueCurrentFOC")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicExpoTorqueCurrentFOC(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.position, self.feed_forward, self.slot, self.override_coast_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_position(self, new_position: rotation) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
        ...
        :returns: Itself
        :rtype: MotionMagicExpoTorqueCurrentFOC
        """
        self.position = new_position
        return self
    
    def with_feed_forward(self, new_feed_forward: ampere) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_slot(self, new_slot: int) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_override_coast_dur_neutral(self, new_override_coast_dur_neutral: bool) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'MotionMagicExpoTorqueCurrentFOC':
        """
