...
class DifferentialMotionMagicDutyCycle:
    ...
    the Cruise Velocity, Acceleration, and (optional) Jerk specified via the Motion
    ...
    def __init__(self, target_position: rotation, differential_position: rotation, enable_foc: bool = True, target_slot: int = 0, differential_slot: int = 1, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "DifferentialMotionMagicDutyCycle"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: DifferentialMotionMagicDutyCycle")
        ss.append("    target_position: " + str(self.target_position) + " rotations")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialMotionMagicDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.target_position, self.differential_position, self.enable_foc, self.target_slot, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_target_position(self, new_target_position: rotation) -> 'DifferentialMotionMagicDutyCycle':
        """
        ...
        :returns: Itself
        :rtype: DifferentialMotionMagicDutyCycle
        """
        self.target_position = new_target_position
        return self
    
    def with_differential_position(self, new_differential_position: rotation) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_target_slot(self, new_target_slot: int) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_differential_slot(self, new_differential_slot: int) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'DifferentialMotionMagicDutyCycle':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'DifferentialMotionMagicDutyCycle':
        """
