...
class DifferentialStrictFollower:
    ...
    def __init__(self, master_id: int):
        self._name = "DifferentialStrictFollower"
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialStrictFollower(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.master_id))

    
    def with_master_id(self, new_master_id: int) -> 'DifferentialStrictFollower':
        """
