...
class Diff_PositionTorqueCurrentFOC_Velocity:
    """
    ...
    def __init__(self, average_request: PositionTorqueCurrentFOC, differential_request: VelocityTorqueCurrentFOC):
        self._name = "Diff_PositionTorqueCurrentFOC_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_PositionTorqueCurrentFOC_Velocity")
    ...
    def with_average_request(self, new_average_request: PositionTorqueCurrentFOC) -> 'Diff_PositionTorqueCurrentFOC_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_PositionTorqueCurrentFOC_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityTorqueCurrentFOC) -> 'Diff_PositionTorqueCurrentFOC_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_PositionTorqueCurrentFOC_Velocity':
        """
