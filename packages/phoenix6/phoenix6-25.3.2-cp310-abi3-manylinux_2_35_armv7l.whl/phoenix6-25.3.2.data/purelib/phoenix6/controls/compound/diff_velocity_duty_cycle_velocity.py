...
class Diff_VelocityDutyCycle_Velocity:
    """
    ...
    def __init__(self, average_request: VelocityDutyCycle, differential_request: VelocityDutyCycle):
        self._name = "Diff_VelocityDutyCycle_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VelocityDutyCycle_Velocity")
    ...
    def with_average_request(self, new_average_request: VelocityDutyCycle) -> 'Diff_VelocityDutyCycle_Velocity':
        ...
        :type new_average_request: VelocityDutyCycle
        :returns: Itself
        :rtype: Diff_VelocityDutyCycle_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityDutyCycle) -> 'Diff_VelocityDutyCycle_Velocity':
        """
        ...
        :type new_differential_request: VelocityDutyCycle
        :returns: Itself
        :rtype: Diff_VelocityDutyCycle_Velocity
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VelocityDutyCycle_Velocity':
        """
