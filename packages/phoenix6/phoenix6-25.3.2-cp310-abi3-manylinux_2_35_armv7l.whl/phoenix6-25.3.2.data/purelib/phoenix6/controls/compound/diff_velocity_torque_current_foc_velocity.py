...
class Diff_VelocityTorqueCurrentFOC_Velocity:
    """
    Requires Phoenix Pro and CANivore;
    Differential control with velocity average target and velocity difference target
    ...
    def __init__(self, average_request: VelocityTorqueCurrentFOC, differential_request: VelocityTorqueCurrentFOC):
        self._name = "Diff_VelocityTorqueCurrentFOC_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VelocityTorqueCurrentFOC_Velocity")
    ...
    def with_average_request(self, new_average_request: VelocityTorqueCurrentFOC) -> 'Diff_VelocityTorqueCurrentFOC_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_VelocityTorqueCurrentFOC_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityTorqueCurrentFOC) -> 'Diff_VelocityTorqueCurrentFOC_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VelocityTorqueCurrentFOC_Velocity':
        """
