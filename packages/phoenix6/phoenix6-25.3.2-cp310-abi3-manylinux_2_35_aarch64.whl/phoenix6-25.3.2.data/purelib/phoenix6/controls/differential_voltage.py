...
class DifferentialVoltage:
    ...
    output the supply voltage. It will also set the motor's differential position
    setpoint to the specified position.
    
    :param target_output:    Voltage to attempt to drive at
    :type target_output: volt
    ...
    def __init__(self, target_output: volt, differential_position: rotation, enable_foc: bool = True, differential_slot: int = 1, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "DifferentialVoltage"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: DifferentialVoltage")
        ss.append("    target_output: " + str(self.target_output) + " Volts")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlDifferentialVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.target_output, self.differential_position, self.enable_foc, self.differential_slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_target_output(self, new_target_output: volt) -> 'DifferentialVoltage':
        """
        Modifies this Control Request's target_output parameter and returns itself for
        ...
        :param new_target_output: Parameter to modify
        :type new_target_output: volt
        :returns: Itself
        :rtype: DifferentialVoltage
        """
        self.target_output = new_target_output
        return self
    
    def with_differential_position(self, new_differential_position: rotation) -> 'DifferentialVoltage':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'DifferentialVoltage':
        """
    ...
    def with_differential_slot(self, new_differential_slot: int) -> 'DifferentialVoltage':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'DifferentialVoltage':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'DifferentialVoltage':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'DifferentialVoltage':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'DifferentialVoltage':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'DifferentialVoltage':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'DifferentialVoltage':
        """
    ...
    def control_info(self) -> dict:
        ...
        control_info["target_output"] = self.target_output
