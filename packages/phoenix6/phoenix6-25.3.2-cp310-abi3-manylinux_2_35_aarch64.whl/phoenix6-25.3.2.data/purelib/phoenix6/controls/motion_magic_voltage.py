...
class MotionMagicVoltage:
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MotionMagicVoltage")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.position, self.enable_foc, self.feed_forward, self.slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'MotionMagicVoltage':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'MotionMagicVoltage':
        """
