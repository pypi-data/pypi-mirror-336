...
class Diff_MotionMagicVoltage_Velocity:
    """
    ...
    def __init__(self, average_request: MotionMagicVoltage, differential_request: VelocityVoltage):
        self._name = "Diff_MotionMagicVoltage_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVoltage_Velocity")
    ...
    def with_average_request(self, new_average_request: MotionMagicVoltage) -> 'Diff_MotionMagicVoltage_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVoltage_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityVoltage) -> 'Diff_MotionMagicVoltage_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVoltage_Velocity':
        """
