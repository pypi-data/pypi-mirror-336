...
class Diff_MotionMagicVoltage_Position:
    """
    ...
    def __init__(self, average_request: MotionMagicVoltage, differential_request: PositionVoltage):
        self._name = "Diff_MotionMagicVoltage_Position"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_MotionMagicVoltage_Position")
    ...
    def with_average_request(self, new_average_request: MotionMagicVoltage) -> 'Diff_MotionMagicVoltage_Position':
        ...
        :returns: Itself
        :rtype: Diff_MotionMagicVoltage_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionVoltage) -> 'Diff_MotionMagicVoltage_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_MotionMagicVoltage_Position':
        """
