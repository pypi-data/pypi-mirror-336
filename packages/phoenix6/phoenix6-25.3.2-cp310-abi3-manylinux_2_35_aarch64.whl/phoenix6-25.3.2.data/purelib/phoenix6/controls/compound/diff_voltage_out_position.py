...
class Diff_VoltageOut_Position:
    """
    ...
    def __init__(self, average_request: VoltageOut, differential_request: PositionVoltage):
        self._name = "Diff_VoltageOut_Position"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VoltageOut_Position")
    ...
    def with_average_request(self, new_average_request: VoltageOut) -> 'Diff_VoltageOut_Position':
        ...
        :returns: Itself
        :rtype: Diff_VoltageOut_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionVoltage) -> 'Diff_VoltageOut_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VoltageOut_Position':
        """
