...
class Diff_DutyCycleOut_Velocity:
    """
    ...
    def __init__(self, average_request: DutyCycleOut, differential_request: VelocityDutyCycle):
        self._name = "Diff_DutyCycleOut_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_DutyCycleOut_Velocity")
        ss.append("    average_request:")
        ss.append("        output: " + str(self.average_request.output) + " fractional")
    ...
    def with_average_request(self, new_average_request: DutyCycleOut) -> 'Diff_DutyCycleOut_Velocity':
        ...
        :type new_average_request: DutyCycleOut
        :returns: Itself
        :rtype: Diff_DutyCycleOut_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityDutyCycle) -> 'Diff_DutyCycleOut_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_DutyCycleOut_Velocity':
        """
