...
class Diff_VelocityVoltage_Position:
    """
    ...
    def __init__(self, average_request: VelocityVoltage, differential_request: PositionVoltage):
        self._name = "Diff_VelocityVoltage_Position"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_VelocityVoltage_Position")
    ...
    def with_average_request(self, new_average_request: VelocityVoltage) -> 'Diff_VelocityVoltage_Position':
        ...
        :type new_average_request: VelocityVoltage
        :returns: Itself
        :rtype: Diff_VelocityVoltage_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionVoltage) -> 'Diff_VelocityVoltage_Position':
        """
        ...
        :type new_differential_request: PositionVoltage
        :returns: Itself
        :rtype: Diff_VelocityVoltage_Position
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_VelocityVoltage_Position':
        """
