...
class MusicTone:
    ...
    def __init__(self, audio_frequency: hertz):
        ...
        frequency range is 10-20000 Hz.  Any nonzero frequency less than 10 Hz will be
        capped to 10 Hz.  Any frequency above 20 kHz will be capped to 20 kHz.
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MusicTone")
        ss.append("    audio_frequency: " + str(self.audio_frequency) + " Hz")
        return "\n".join(ss)
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMusicTone(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.audio_frequency))
