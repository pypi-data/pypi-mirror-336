...
class PositionVoltage:
    ...
    def __init__(self, position: rotation, velocity: rotations_per_second = 0.0, enable_foc: bool = True, feed_forward: volt = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "PositionVoltage"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: PositionVoltage")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlPositionVoltage(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.position, self.velocity, self.enable_foc, self.feed_forward, self.slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_position(self, new_position: rotation) -> 'PositionVoltage':
        """
        ...
        :returns: Itself
        :rtype: PositionVoltage
        """
        self.position = new_position
        return self
    
    def with_velocity(self, new_velocity: rotations_per_second) -> 'PositionVoltage':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'PositionVoltage':
        """
    ...
    def with_feed_forward(self, new_feed_forward: volt) -> 'PositionVoltage':
        """
    ...
    def with_slot(self, new_slot: int) -> 'PositionVoltage':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'PositionVoltage':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'PositionVoltage':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'PositionVoltage':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'PositionVoltage':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'PositionVoltage':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'PositionVoltage':
        """
