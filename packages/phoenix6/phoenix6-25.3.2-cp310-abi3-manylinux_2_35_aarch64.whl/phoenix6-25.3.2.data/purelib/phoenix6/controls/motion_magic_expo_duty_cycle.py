...
class MotionMagicExpoDutyCycle:
    ...
    def __init__(self, position: rotation, enable_foc: bool = True, feed_forward: float = 0.0, slot: int = 0, override_brake_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "MotionMagicExpoDutyCycle"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MotionMagicExpoDutyCycle")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicExpoDutyCycle(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.position, self.enable_foc, self.feed_forward, self.slot, self.override_brake_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_position(self, new_position: rotation) -> 'MotionMagicExpoDutyCycle':
        """
        ...
        :returns: Itself
        :rtype: MotionMagicExpoDutyCycle
        """
        self.position = new_position
        return self
    
    def with_enable_foc(self, new_enable_foc: bool) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_feed_forward(self, new_feed_forward: float) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_slot(self, new_slot: int) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_override_brake_dur_neutral(self, new_override_brake_dur_neutral: bool) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'MotionMagicExpoDutyCycle':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'MotionMagicExpoDutyCycle':
        """
