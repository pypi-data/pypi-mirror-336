...
class TalonFXSConfiguration:
    ...
    def __init__(self):
        ...
        self.external_feedback: ExternalFeedbackConfigs = ExternalFeedbackConfigs()
        """
        ...
        self.commutation: CommutationConfigs = CommutationConfigs()
        """
    ...
    def with_motor_output(self, new_motor_output: MotorOutputConfigs) -> 'TalonFXSConfiguration':
        """
        ...
        :returns: Itself
        :rtype: TalonFXSConfiguration
        """
        self.motor_output = new_motor_output
        return self
    
    def with_current_limits(self, new_current_limits: CurrentLimitsConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_voltage(self, new_voltage: VoltageConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_external_feedback(self, new_external_feedback: ExternalFeedbackConfigs) -> 'TalonFXSConfiguration':
        """
        Modifies this configuration's external_feedback parameter and returns itself for
        method-chaining and easier to use config API.
        ...
        :param new_external_feedback: Parameter to modify
        :type new_external_feedback: ExternalFeedbackConfigs
        :returns: Itself
        :rtype: TalonFXSConfiguration
        """
        self.external_feedback = new_external_feedback
        return self
    
    def with_differential_sensors(self, new_differential_sensors: DifferentialSensorsConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_differential_constants(self, new_differential_constants: DifferentialConstantsConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_open_loop_ramps(self, new_open_loop_ramps: OpenLoopRampsConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_closed_loop_ramps(self, new_closed_loop_ramps: ClosedLoopRampsConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_hardware_limit_switch(self, new_hardware_limit_switch: HardwareLimitSwitchConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_audio(self, new_audio: AudioConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_software_limit_switch(self, new_software_limit_switch: SoftwareLimitSwitchConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_motion_magic(self, new_motion_magic: MotionMagicConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_custom_params(self, new_custom_params: CustomParamsConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_closed_loop_general(self, new_closed_loop_general: ClosedLoopGeneralConfigs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_commutation(self, new_commutation: CommutationConfigs) -> 'TalonFXSConfiguration':
        """
        ...
        :param new_commutation: Parameter to modify
        :type new_commutation: CommutationConfigs
        :returns: Itself
        :rtype: TalonFXSConfiguration
        """
        self.commutation = new_commutation
        return self
    
    def with_slot0(self, new_slot0: Slot0Configs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_slot1(self, new_slot1: Slot1Configs) -> 'TalonFXSConfiguration':
        """
    ...
    def with_slot2(self, new_slot2: Slot2Configs) -> 'TalonFXSConfiguration':
        """
    ...
    def __str__(self) -> str:
        ...
        ss.append(str(self.commutation))
    ...
    def serialize(self) -> str:
        ...
        ss.append(self.external_feedback.serialize())
        ...
        ss.append(self.commutation.serialize())
    ...
    def deserialize(self, to_deserialize: str) -> StatusCode:
        ...
        err = self.external_feedback.deserialize(to_deserialize)
        ...
        err = self.commutation.deserialize(to_deserialize)
...
class TalonFXSConfigurator(ParentConfigurator):
    """
 * Class description for the Talon FXS motor controller.
    ...
    def clear_sticky_fault_using_fused_cancoder_while_unlicensed(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_USING_FUSED_CCWHILE_UNLICENSED.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
    ...
    def clear_sticky_fault_bridge_short(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_BRIDGE_SHORT.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
    ...
    def clear_sticky_fault_hall_sensor_missing(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_HALL_SENSOR_MISSING.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
    ...
    def clear_sticky_fault_drive_disabled_hall_sensor(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_DRIVE_DISABLED_HALL_SENSOR.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
    ...
    def clear_sticky_fault_motor_temp_sensor_missing(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_MOTOR_TEMP_SENSOR_MISSING.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
    ...
    def clear_sticky_fault_motor_temp_sensor_too_hot(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(SpnValue.CLEAR_STICKY_FAULT_TALONFX_MOTOR_TEMP_SENSOR_TOO_HOT.value, 0, ctypes.byref(value))
        if value.value is not None:
            serialized = str(value.value, encoding='utf-8')
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
        else:
