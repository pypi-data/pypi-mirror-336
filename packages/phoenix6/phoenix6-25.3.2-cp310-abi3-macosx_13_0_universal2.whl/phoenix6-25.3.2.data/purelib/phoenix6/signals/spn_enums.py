...
class FeedbackSensorSourceValue(Enum):
    ...
    CTR Electronics' CANdi™. Talon will update its position and velocity whenever
    the CTR Electronics' CANdi™ publishes its information on CAN bus, and the Talon
    internal rotor will not be used.
    """
    ...
    Electronics' CANdi™. Talon will update its position and velocity whenever the
    CTR Electronics' CANdi™ publishes its information on CAN bus, and the Talon
    internal rotor will not be used.
    """
    FUSED_CANDI_PWM1 = 12
    """
...
class ExternalFeedbackSensorSourceValue(Enum):
    ...
    CANdi™. Talon will update its position and velocity whenever CANdi™ publishes
    its information on CAN bus, and the Talon internal rotor will not be used.
    """
    REMOTE_CANDI_PWM2 = 10
    """
    ...
    Talon will update its position and velocity whenever CANdi™ publishes its
