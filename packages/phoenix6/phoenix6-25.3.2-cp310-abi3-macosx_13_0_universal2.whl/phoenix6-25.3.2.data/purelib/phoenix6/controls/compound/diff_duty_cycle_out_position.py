...
class Diff_DutyCycleOut_Position:
    """
    ...
    def __init__(self, average_request: DutyCycleOut, differential_request: PositionDutyCycle):
        self._name = "Diff_DutyCycleOut_Position"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_DutyCycleOut_Position")
    ...
    def with_average_request(self, new_average_request: DutyCycleOut) -> 'Diff_DutyCycleOut_Position':
        ...
        :returns: Itself
        :rtype: Diff_DutyCycleOut_Position
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: PositionDutyCycle) -> 'Diff_DutyCycleOut_Position':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_DutyCycleOut_Position':
        """
