...
class Diff_PositionDutyCycle_Velocity:
    """
    ...
    def __init__(self, average_request: PositionDutyCycle, differential_request: VelocityDutyCycle):
        self._name = "Diff_PositionDutyCycle_Velocity"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: Diff_PositionDutyCycle_Velocity")
    ...
    def with_average_request(self, new_average_request: PositionDutyCycle) -> 'Diff_PositionDutyCycle_Velocity':
        ...
        :returns: Itself
        :rtype: Diff_PositionDutyCycle_Velocity
        """
        self.average_request = new_average_request
        return self
    
    def with_differential_request(self, new_differential_request: VelocityDutyCycle) -> 'Diff_PositionDutyCycle_Velocity':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'Diff_PositionDutyCycle_Velocity':
        """
