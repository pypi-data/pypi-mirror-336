...
class MotionMagicVelocityTorqueCurrentFOC:
    ...
    configuration parameter is used instead.  This allows for runtime adjustment of
    acceleration for advanced users.  Jerk is also specified in the Motion Magic®
    persistent configuration values.  If Jerk is set to zero, Motion Magic® will
    produce a trapezoidal acceleration profile.
    
    Target velocity can also be changed on-the-fly and Motion Magic® will do its
    best to adjust the profile.  This control mode is based on torque current, so
    ...
    :param ignore_hardware_limits:    Set to true to ignore hardware limit switches
    ...
    :param use_timesync:    Set to true to delay applying this control request until
    ...
    def __init__(self, velocity: rotations_per_second, acceleration: rotations_per_second_squared = 0.0, enable_foc: bool = True, feed_forward: ampere = 0.0, slot: int = 0, override_coast_dur_neutral: bool = False, limit_forward_motion: bool = False, limit_reverse_motion: bool = False, ignore_hardware_limits: bool = False, use_timesync: bool = False):
        self._name = "MotionMagicVelocityTorqueCurrentFOC"
    ...
    def __str__(self) -> str:
        ss = []
        ss.append("Control: MotionMagicVelocityTorqueCurrentFOC")
    ...
    def _send_request(self, network: str, device_hash: int) -> StatusCode:
        ...
        :rtype: StatusCode
        """
        return StatusCode(Native.instance().c_ctre_phoenix6_RequestControlMotionMagicVelocityTorqueCurrentFOC(ctypes.c_char_p(bytes(network, 'utf-8')), device_hash, self.update_freq_hz, self.velocity, self.acceleration, self.enable_foc, self.feed_forward, self.slot, self.override_coast_dur_neutral, self.limit_forward_motion, self.limit_reverse_motion, self.ignore_hardware_limits, self.use_timesync))

    
    def with_velocity(self, new_velocity: rotations_per_second) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
        ...
        :returns: Itself
        :rtype: MotionMagicVelocityTorqueCurrentFOC
        """
        self.velocity = new_velocity
        return self
    
    def with_acceleration(self, new_acceleration: rotations_per_second_squared) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_enable_foc(self, new_enable_foc: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_feed_forward(self, new_feed_forward: ampere) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_slot(self, new_slot: int) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_override_coast_dur_neutral(self, new_override_coast_dur_neutral: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_limit_forward_motion(self, new_limit_forward_motion: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_limit_reverse_motion(self, new_limit_reverse_motion: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_ignore_hardware_limits(self, new_ignore_hardware_limits: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_use_timesync(self, new_use_timesync: bool) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
    ...
    def with_update_freq_hz(self, new_update_freq_hz: hertz) -> 'MotionMagicVelocityTorqueCurrentFOC':
        """
