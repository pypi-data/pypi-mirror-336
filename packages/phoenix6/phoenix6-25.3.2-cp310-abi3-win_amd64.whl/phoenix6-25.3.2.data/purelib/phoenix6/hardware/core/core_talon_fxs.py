...
from phoenix6.hardware.traits.common_talon_with_external_motor import CommonTalonWithExternalMotor
...
from phoenix6.configs.talon_fxs_configs import TalonFXSConfigurator
from phoenix6.signals.spn_enums import ForwardLimitValue, ReverseLimitValue, AppliedRotorPolarityValue, ControlModeValue, ExternalMotorTempStatusValue, MotionMagicIsRunningValue, DeviceEnableValue, MotorOutputStatusValue, DifferentialControlModeValue, BridgeOutputValue, ConnectedMotorValue
from phoenix6.sim.talon_fxs_sim_state import TalonFXSSimState

class CoreTalonFXS(ParentDevice, CommonTalonWithExternalMotor):
    """
    ...
    def __init__(self, device_id: int, canbus: str | CANBus = ""):
        if isinstance(canbus, CANBus):
            canbus = canbus.name
        super().__init__(device_id, "talon fxs", canbus)
        self.configurator = TalonFXSConfigurator(self._device_identifier)

        Native.instance().c_ctre_phoenix6_platform_sim_create(DeviceType.P6_TalonFXSType.value, device_id)
        self.__sim_state = None


    @property
    def sim_state(self) -> TalonFXSSimState:
        """
        ...
        :rtype: TalonFXSSimState
        """

        if self.__sim_state is None:
            self.__sim_state = TalonFXSSimState(self)
    ...
    def get_external_motor_temp_status(self, refresh: bool = True) -> StatusSignal[ExternalMotorTempStatusValue]:
        ...
        """
        return self._common_lookup(SpnValue.EXTERNAL_MOTOR_TEMP_STATUS.value, None, "external_motor_temp_status", ExternalMotorTempStatusValue, True, refresh)
    ...
    def get_external_motor_temp(self, refresh: bool = True) -> StatusSignal[celsius]:
        ...
        :rtype: StatusSignal[celsius]
        """
        return self._common_lookup(SpnValue.EXTERNAL_MOTOR_TEMP.value, None, "external_motor_temp", celsius, True, refresh)
    ...
    def get_five_v_rail_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        :rtype: StatusSignal[volt]
        """
        return self._common_lookup(SpnValue.TALON_FXS_5_VRAIL_VOLTAGE.value, None, "five_v_rail_voltage", volt, True, refresh)
    ...
    def get_analog_voltage(self, refresh: bool = True) -> StatusSignal[volt]:
        ...
        :rtype: StatusSignal[volt]
        """
        return self._common_lookup(SpnValue.TALON_FXS_GADGETEER_G3.value, None, "analog_voltage", volt, True, refresh)
    ...
    def get_raw_quadrature_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        :rtype: StatusSignal[rotation]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_QUAD_RAW_QUADRATURE_POSITION.value, None, "raw_quadrature_position", rotation, True, refresh)
    ...
    def get_raw_quadrature_velocity(self, refresh: bool = True) -> StatusSignal[rotations_per_second]:
        ...
        :rtype: StatusSignal[rotations_per_second]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_QUAD_RAW_QUADRATURE_VELOCITY.value, None, "raw_quadrature_velocity", rotations_per_second, True, refresh)
    ...
    def get_raw_pulse_width_position(self, refresh: bool = True) -> StatusSignal[rotation]:
        ...
        :rtype: StatusSignal[rotation]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_PWM_RAW_PWM_POSITION.value, None, "raw_pulse_width_position", rotation, True, refresh)
    ...
    def get_raw_pulse_width_velocity(self, refresh: bool = True) -> StatusSignal[rotations_per_second]:
        ...
        :rtype: StatusSignal[rotations_per_second]
        """
        return self._common_lookup(SpnValue.PRO_GADGETEER_PWM_RAW_PWM_VELOCITY.value, None, "raw_pulse_width_velocity", rotations_per_second, True, refresh)
    ...
    def get_fault_bridge_short(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_BRIDGE_SHORT.value, None, "fault_bridge_short", bool, True, refresh)
    ...
    def get_sticky_fault_bridge_short(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_BRIDGE_SHORT.value, None, "sticky_fault_bridge_short", bool, True, refresh)
    ...
    def get_fault_hall_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_HALL_SENSOR_MISSING.value, None, "fault_hall_sensor_missing", bool, True, refresh)
    ...
    def get_sticky_fault_hall_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_HALL_SENSOR_MISSING.value, None, "sticky_fault_hall_sensor_missing", bool, True, refresh)
    ...
    def get_fault_drive_disabled_hall_sensor(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_DRIVE_DISABLED_HALL_SENSOR.value, None, "fault_drive_disabled_hall_sensor", bool, True, refresh)
    ...
    def get_sticky_fault_drive_disabled_hall_sensor(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_DRIVE_DISABLED_HALL_SENSOR.value, None, "sticky_fault_drive_disabled_hall_sensor", bool, True, refresh)
    ...
    def get_fault_motor_temp_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_MOTOR_TEMP_SENSOR_MISSING.value, None, "fault_motor_temp_sensor_missing", bool, True, refresh)
    ...
    def get_sticky_fault_motor_temp_sensor_missing(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_MOTOR_TEMP_SENSOR_MISSING.value, None, "sticky_fault_motor_temp_sensor_missing", bool, True, refresh)
    ...
    def get_fault_motor_temp_sensor_too_hot(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.FAULT_TALONFX_MOTOR_TEMP_SENSOR_TOO_HOT.value, None, "fault_motor_temp_sensor_too_hot", bool, True, refresh)
    ...
    def get_sticky_fault_motor_temp_sensor_too_hot(self, refresh: bool = True) -> StatusSignal[bool]:
        ...
        :rtype: StatusSignal[bool]
        """
        return self._common_lookup(SpnValue.STICKY_FAULT_TALONFX_MOTOR_TEMP_SENSOR_TOO_HOT.value, None, "sticky_fault_motor_temp_sensor_too_hot", bool, True, refresh)
        ...
        which is supplied by the user.
            ...
            - DutyCycleOut Parameters: 
                ...
                - ignore_hardware_limits: Set to true to ignore hardware limit switches
                                          ...
                                          intake/feeder, where a limit switch stops
                                          motion while intaking but should be ignored
                ...
                - use_timesync: Set to true to delay applying this control request until
                                ...
                                delays in exchange for a larger but deterministic
                                control latency.
                                
                                This requires setting the ControlTimesyncFreqHz config
                                in MotorOutputConfigs. Additionally, when this is
                                enabled, the UpdateFreqHz of this request should be set
                                to 0 Hz.
        ...
        additional duty cycle as an arbitrary feedforward value.
            ...
            - PositionDutyCycle Parameters: 
                ...
                - enable_foc: Set to true to use FOC commutation (requires Phoenix Pro),
                              ...
                              control or phase voltage control which lacks the
                              performance gains.
                - feed_forward: Feedforward to apply in fractional units between -1 and
                                +1.
    ...
    def set_control(self, request: DifferentialDutyCycle) -> StatusCode:
        ...
        differential position setpoint to the specified position.
            ...
            - DifferentialDutyCycle Parameters: 
                - target_output: Proportion of supply voltage to apply in fractional
    ...
    def set_control(self, request: DifferentialPositionDutyCycle) -> StatusCode:
        ...
        differential position setpoint to the specified position.
            ...
            - DifferentialPositionDutyCycle Parameters: 
                ...
                - differential_position: Differential position to drive toward in
                                         rotations.
                - enable_foc: Set to true to use FOC commutation (requires Phoenix Pro),
                              which increases peak power by ~15%. Set to false to use
                              trapezoidal commutation.
                              ...
                              control or phase voltage control which lacks the
                              performance gains.
                - target_slot: Select which gains are applied to the primary controller
    ...
    def set_control(self, request: DifferentialVelocityDutyCycle) -> StatusCode:
        ...
        differential position setpoint to the specified position.
            ...
            - DifferentialVelocityDutyCycle Parameters: 
                - target_velocity: Average velocity to drive toward in rotations per
                                   second.
                - differential_position: Differential position to drive toward in
                                         rotations.
                - enable_foc: Set to true to use FOC commutation (requires Phoenix Pro),
    ...
    def set_control(self, request: Diff_MotionMagicDutyCycle_Position) -> StatusCode:
        ...
        difference target using dutycycle control.
            ...
            - Diff_MotionMagicDutyCycle_Position Parameters: 
                - average_request: Average MotionMagicDutyCycle request of the
                                   mechanism.
                - differential_request: Differential PositionDutyCycle request of the
                                        mechanism.
    ...
    def set_control(self, request: SupportsSendRequest) -> StatusCode:
        if isinstance(request, (DutyCycleOut, VoltageOut, PositionDutyCycle, PositionVoltage, VelocityDutyCycle, VelocityVoltage, MotionMagicDutyCycle, MotionMagicVoltage, DifferentialDutyCycle, DifferentialVoltage, DifferentialPositionDutyCycle, DifferentialPositionVoltage, DifferentialVelocityDutyCycle, DifferentialVelocityVoltage, DifferentialMotionMagicDutyCycle, DifferentialMotionMagicVoltage, Follower, StrictFollower, DifferentialFollower, DifferentialStrictFollower, NeutralOut, CoastOut, StaticBrake, MotionMagicVelocityDutyCycle, MotionMagicVelocityVoltage, MotionMagicExpoDutyCycle, MotionMagicExpoVoltage, DynamicMotionMagicDutyCycle, DynamicMotionMagicVoltage, Diff_DutyCycleOut_Position, Diff_PositionDutyCycle_Position, Diff_VelocityDutyCycle_Position, Diff_MotionMagicDutyCycle_Position, Diff_DutyCycleOut_Velocity, Diff_PositionDutyCycle_Velocity, Diff_VelocityDutyCycle_Velocity, Diff_MotionMagicDutyCycle_Velocity, Diff_VoltageOut_Position, Diff_PositionVoltage_Position, Diff_VelocityVoltage_Position, Diff_MotionMagicVoltage_Position, Diff_VoltageOut_Velocity, Diff_PositionVoltage_Velocity, Diff_VelocityVoltage_Velocity, Diff_MotionMagicVoltage_Velocity)):
    ...
    def clear_sticky_fault_bridge_short(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        return self.configurator.clear_sticky_fault_bridge_short(timeout_seconds)
    ...
    def clear_sticky_fault_hall_sensor_missing(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        return self.configurator.clear_sticky_fault_hall_sensor_missing(timeout_seconds)
    ...
    def clear_sticky_fault_drive_disabled_hall_sensor(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        return self.configurator.clear_sticky_fault_drive_disabled_hall_sensor(timeout_seconds)
    ...
    def clear_sticky_fault_motor_temp_sensor_missing(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        return self.configurator.clear_sticky_fault_motor_temp_sensor_missing(timeout_seconds)
    ...
    def clear_sticky_fault_motor_temp_sensor_too_hot(self, timeout_seconds: second = 0.100) -> StatusCode:
        ...
        return self.configurator.clear_sticky_fault_motor_temp_sensor_too_hot(timeout_seconds)
