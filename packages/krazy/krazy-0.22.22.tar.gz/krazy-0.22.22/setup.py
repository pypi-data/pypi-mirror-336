...
setuptools.setup(
    ...
    install_requires=['pandas','openpyxl','pathlib','pytesseract','gspread','oauth2client','pyodbc','sqlalchemy','configparser','scikit-learn','chardet', 'langchain', 'langchain_community','langchain_experimental'],
)
