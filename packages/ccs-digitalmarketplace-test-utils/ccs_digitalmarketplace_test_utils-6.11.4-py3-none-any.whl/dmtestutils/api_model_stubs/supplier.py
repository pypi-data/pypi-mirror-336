...
class SupplierStub(BaseAPIModelStub):
    ...
    default_data = {
        ...
        "tradingNameSameAsRegisteredName": True,
        "tradingName": "",
    ...
    optional_keys = [
        ...
        ("vatCode", "vat_code"),
        ("tradingNameSameAsRegisteredName", "trading_name_same_as_registered_name"),
        ("tradingName", "trading_name"),
        ("onDebarmentList", "on_debarment_list"),
        ("debarmentDetails", "debarment_details"),
    ]
    ...
    def __init__(self, **kwargs):
        ...
        if kwargs.get("with_cdp_data"):
            self.response_data["centralDigitalPlatformOrganisationId"] = CENTRAL_DIGITAL_PLATFORM_DATA["id"]
            ...
            self.response_data["centralDigitalPlatformData"] = {
                cdp_key: CENTRAL_DIGITAL_PLATFORM_DATA[cdp_key]
                for cdp_key in ["identifier", "additionalIdentifiers", "details", "supplierInformationData"]
            }
            self.response_data["registrationCountryName"] = CENTRAL_DIGITAL_PLATFORM_DATA["address"]["countryName"]
            self.response_data["contactInformation"][0]["url"] = CENTRAL_DIGITAL_PLATFORM_DATA["contactPoint"]["url"]
