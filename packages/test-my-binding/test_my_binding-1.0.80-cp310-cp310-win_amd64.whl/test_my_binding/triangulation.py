...
from test_my_binding.test_my_binding_ext import triangulation
from test_my_binding.types import FacesNumpy
from test_my_binding.types import VerticesFacesNumpy


@plugin(category="triangulation", requires=["test_my_binding"])
def delaunay_triangulation(points: list[Point]) -> FacesNumpy:
    ...
    Returns
    -------
    :attr:`test_my_binding.types.FacesNumpy`
