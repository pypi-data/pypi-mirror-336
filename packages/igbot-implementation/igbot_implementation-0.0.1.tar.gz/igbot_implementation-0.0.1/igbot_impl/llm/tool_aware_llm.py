...
from igbot_base.igbot_base.response_formats import ResponseFormat
from igbot_base.igbot_base.llm import Llm
from igbot_base.igbot_base.llmmemory import LlmMemory
from igbot_base.igbot_base.tool import Tool
...
class ToolAwareLlm(Llm):
    ...
    def get_tool_function(self, tool_name):
        ...
        raise Exception(f"Tool '{tool_name}' not found in llm {super()._name}")
