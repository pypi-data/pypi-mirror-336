...
T = TypeVar("T", bound="ApiOutputEosProperetiesTPnResultResidual")


@attr.s(auto_attribs=True)
class ApiOutputEosProperetiesTPnResultResidual:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        api_output_eospropertiestpn_residual = cls(
            volume=volume,
        ...
        return api_output_eospropertiestpn_residual
