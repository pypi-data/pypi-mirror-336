...
def demofluid1_nHexane_Ethylene_HDPE7() -> ApiFluid:
    ...
    fluid.standards = [
      ApiFluidStandardComponent(name="n-Hexane",is_alkane=True, molar_mass=86.17536,         
        ...
        pc_saft_cp_ig_dippr_c0 = 1.21148319,
        pc_saft_cp_ig_dippr_c1 = 4.088175553,
        pc_saft_cp_ig_dippr_c2 = 1694.6,
        pc_saft_cp_ig_dippr_c3 = 2.749045667,
        pc_saft_cp_ig_dippr_c4 = 761.6,
        pc_saft_cp_ig_dippr_c5 = 200,
        pc_saft_cp_ig_dippr_c6 = 1500),
      ...
      ApiFluidStandardComponent(name="Ethylene", is_alkane=True, molar_mass=28.05316,         
        ...
        pc_saft_cp_ig_dippr_c0 = 1.189883778,
        pc_saft_cp_ig_dippr_c1 = 3.37894198,
        pc_saft_cp_ig_dippr_c2 = 1596,
        pc_saft_cp_ig_dippr_c3 = 1.964128105,
        pc_saft_cp_ig_dippr_c4 = 740.8,
        pc_saft_cp_ig_dippr_c5 = 60,
        pc_saft_cp_ig_dippr_c6 = 1500)
      ]
        ...
        ApiFluidPolymerComponent(short_name="HDPE",
          blocks=[
            ApiFluidComponentBlock(block_massfraction=1, monomer_name="Ethylene", monomer_molar_mass=28.054, 
              ...
              pc_saft_cp_ig_poly_c0 = 0.81694,
              pc_saft_cp_ig_poly_c1 = -0.00030569,
              pc_saft_cp_ig_poly_c2 = 0.000015706,
              pc_saft_cp_ig_poly_c3 = -2.1058E-08,
              pc_saft_cp_ig_poly_c4 = 8.5078E-12,
              pc_saft_cp_ig_poly_c5 = 0,
              pc_saft_cp_ig_poly_c6 = 200,
              pc_saft_cp_ig_poly_c7 = 1000)
      ],
          pseudo_components=[
