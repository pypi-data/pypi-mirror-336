...
from ..models.api_output_eospropertiestpn_result import ApiOutputEosProperetiesTPnResult
...
class EosPropertiesTPnCalculationResult:
    """Holds calculation result for a EoS TPN property"""
    ...
    point: Union[Unset, ApiOutputEosProperetiesTPnResult] = UNSET
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        point: Union[Unset, ApiOutputEosProperetiesTPnResult]
        if isinstance(_point, Unset):
            point = UNSET
        else:
            point = ApiOutputEosProperetiesTPnResult.from_dict(_point)
