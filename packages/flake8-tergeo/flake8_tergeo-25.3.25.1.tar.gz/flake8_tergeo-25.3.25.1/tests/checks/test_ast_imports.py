...
def test_ftp001(runner: Flake8Runner) -> None:
...
def test_ftp087(runner: Flake8Runner) -> None:
...
class TestFTP027:
    def test_ftp027(self, runner: Flake8Runner) -> None:
    ...
    def test_ftp027_braces(self) -> None:
        ...
        # the test would fail if we would use the Flake8Runner
...
def test_ftp026(runner: Flake8Runner) -> None:
