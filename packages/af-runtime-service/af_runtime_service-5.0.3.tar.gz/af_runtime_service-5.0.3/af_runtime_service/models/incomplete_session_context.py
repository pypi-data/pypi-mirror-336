...
class IncompleteSessionContext(object):
    ...
    def __init__(self, sub_class=None, ebp_inst_ref=None, data_context=None, act_instance=None, current_enq=None, replied_enq=None, user_attributes=None):  # noqa: E501
