...
class ExecutableBusinessProcessInstance(object):
    ...
    def __init__(self, sub_class=None, process_type=None, process_template_version=None, process_template_name=None, loc_process_template_name=None, process_instance_name=None, loc_process_instance_name=None, name=None, loc_name=None, desc=None, loc_desc=None, icon_id=None, exec_control_properties=None, conf=None, parameters=None, attached_data_context=None, group_name=None, group_execution_context=None, user_attributes=None):  # noqa: E501
