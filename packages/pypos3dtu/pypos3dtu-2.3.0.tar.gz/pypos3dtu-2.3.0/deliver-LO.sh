...
#
lstfic="../src/pypos3d.ooo/PyPos3D-App-Installer.ods ../src/pypos3d.ooo/PyPos3DLO.ods ../src/pypos3d.ooo/PyPos3DLO-Example.ods ../src/pypos3d.ooo/PyPos3DLO-RyanClothes.ods ../src/pypos3d.ooo/PyPos3DLO-mechanical.ods ../src/pypos3d.ooo/PyPos3DLO-WaveFrontExample.ods ../src/pypos3d.ooo/PyPos3d-manual-en.pdf ../CHANGELOG.md ../README-devtu.md ../README-lib.md ../LICENSE ../src/pypos3dapp.py ../src/pypos3dappext.py ../src/pypos3dinstaller.py"
...
# Create the versioned delivery zip
