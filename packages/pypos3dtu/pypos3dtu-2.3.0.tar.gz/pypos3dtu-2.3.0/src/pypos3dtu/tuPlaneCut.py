...
from pypos3d.wftk.WFBasic import Point3d, Vector3d, Edge, CreateLoop, FaceCut, CoordSyst
...
def EdgeToIdxStr(coordList, EdgeLst):
  ...
  return str( [ ( coordList.index(e.p0), coordList.index(e.p1) ) for e in EdgeLst ] )
...
class Test(unittest.TestCase):
  ...
  def testCreateLoop(self):
    ...
    loop, lst, s = CreateLoop(grandL+ToEdges([p4,p5,p8]) + [ Edge(p3,p7), ])
    self.assertEqual(len(loop), 2)
  ...
  def testFaceCut(self):
    ...
    lstFace, lstEdges, multi = FaceCut( ToBiPoint(triangle), vnorm, False, False, 0.0)
    ...
    lstFace, lstEdges, multi = FaceCut( ToBiPoint(carre), vnorm, False, False, 0.0)
    ...
    lstFace, lstEdges, multi = FaceCut( ToBiPoint(pentagone), vnorm, False, False, 0.0)
    ...
    lstFace, lstEdges, multi = FaceCut( ToBiPoint(hexagone), vnorm, False, False, 0.0)
    ...
    lstFace, lstEdges, multi = FaceCut( ToBiPoint(heptagone), vnorm, False, False, 0.0)
    ...
    lstFace, lstEdges, multi = FaceCut( ToBiPoint(octogone), vnorm, False, False, 0.0)
