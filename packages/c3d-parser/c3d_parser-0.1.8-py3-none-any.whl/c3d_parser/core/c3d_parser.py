...
# TODO: Britney:
#   They handle overflow for more than 255 variables in labels, but not for other data groups (eg angles, forces).
#   This will be an issue for our data as we often overflow on these variables.
#   I also think we occasionally overflow for more than 2 label parameters also (which is currently the maximum handled in trc-data-reader).

# TODO: How is it even possible to have more than 255 angles...???
#   Doesn't matter.
#   We don't use ANGLES or POWERS, right?
def extract_data(file_path, start_frame, end_frame):
    with open(file_path, 'rb') as handle:
        ...
        # TODO: We WILL need to update this to get additional label parameters...?
        #   This is analog-labels...
        #   Will it still overflow...?
...
def add_medial_knee_markers(frame_data, left_knee_width, right_knee_width, marker_diameter=14):
    ...
    for side in ['L', 'R']:
        ...
        if medial_label not in frame.index:
            ...
            # TODO: Britney said this part failed for one of her sessions because the KAX was not found.
            #   But we should only need this marker if there is no medial marker.
            #   Get more information from Britney about this trial.
