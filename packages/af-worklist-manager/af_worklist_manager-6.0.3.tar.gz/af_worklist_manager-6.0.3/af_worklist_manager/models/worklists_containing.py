...
class WorklistsContaining(object):
    ...
    def __init__(self, sub_class=None, agent_id=None, org_pos_id=None, agent_name=None, org_pos_name=None, user_session_id=None, worklist_id=None):  # noqa: E501
