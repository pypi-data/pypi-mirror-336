...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-meteringmarketplace)](https://pypistats.org/packages/mypy-boto3-meteringmarketplace)
...
`mypy-boto3-meteringmarketplace` dependency in production. However, there is an
