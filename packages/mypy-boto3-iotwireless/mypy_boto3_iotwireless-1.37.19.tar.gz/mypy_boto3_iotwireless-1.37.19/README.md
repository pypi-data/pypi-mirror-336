...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-iotwireless)](https://pypistats.org/packages/mypy-boto3-iotwireless)
...
`mypy-boto3-iotwireless` dependency in production. However, there is an issue
