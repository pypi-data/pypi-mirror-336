...
class ReplaceDepositForBurnArgs(typing.TypedDict):
    params: types.replace_deposit_for_burn_params.ReplaceDepositForBurnParams


layout = borsh.CStruct(
    "params" / types.replace_deposit_for_burn_params.ReplaceDepositForBurnParams.layout
)


class ReplaceDepositForBurnAccounts(typing.TypedDict):
    owner: Pubkey
...
def replace_deposit_for_burn(
    args: ReplaceDepositForBurnArgs,
    accounts: ReplaceDepositForBurnAccounts,
    ...
    identifier = b"\x07\x1b]\x84\x01P\x13\xa3"
