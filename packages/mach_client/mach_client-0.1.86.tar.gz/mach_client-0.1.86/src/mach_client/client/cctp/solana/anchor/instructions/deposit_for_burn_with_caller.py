...
class DepositForBurnWithCallerArgs(typing.TypedDict):
    params: types.deposit_for_burn_with_caller_params.DepositForBurnWithCallerParams


layout = borsh.CStruct(
    "params"
    / types.deposit_for_burn_with_caller_params.DepositForBurnWithCallerParams.layout
)


class DepositForBurnWithCallerAccounts(typing.TypedDict):
    owner: Pubkey
...
def deposit_for_burn_with_caller(
    args: DepositForBurnWithCallerArgs,
    accounts: DepositForBurnWithCallerAccounts,
    ...
    identifier = b"\xa7\xde\x13rU\x15\x0ev"
