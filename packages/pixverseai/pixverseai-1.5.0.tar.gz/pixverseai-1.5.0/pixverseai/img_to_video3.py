#@title imagen a video v3 ESTILO TEST
import requests
import os
import uuid

def itv3(prompt, aspect_ratio, negative_prompt, seed, model, duration, quality, motion_mode, lip_sync_tts_speaker_id, style=""):
    ...
    # Añadir el campo "customer_img_url" solo si no está vacío
    if customer_img_url:
        data["customer_img_url"] = customer_img_url
