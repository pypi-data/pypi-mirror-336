#@title texto to video v3.5 con estilo
import requests
import os
import uuid

def ttv35(prompt, aspect_ratio, negative_prompt, seed, model, duration, quality, style, motion_mode, lip_sync_tts_speaker_id, camera_movement):
    # Parámetros fijos
