    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetInstanceList.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["GetInstanceList"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        action (Optional[str]): The action Default: 'DescribeInstances'.
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['GetInstanceList']]
    """
