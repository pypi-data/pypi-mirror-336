...
from ..models.list_workspaces_compute_type import ListWorkspacesComputeType
from ..models.list_workspaces_running_mode import ListWorkspacesRunningMode
...
class ListWorkspaces(BaseModel):
    ...
    Attributes:
        ...
        compute_type (Optional[ListWorkspacesComputeType]): The compute type Default:
                ListWorkspacesComputeType.STANDARD.
        ...
        running_mode (Optional[ListWorkspacesRunningMode]): The running mode Default:
                ListWorkspacesRunningMode.AUTOSTOP.
    ...
    compute_type: Optional["ListWorkspacesComputeType"] = Field(
        alias="ComputeType", default=ListWorkspacesComputeType.STANDARD
    )
    ...
    running_mode: Optional["ListWorkspacesRunningMode"] = Field(
        alias="RunningMode", default=ListWorkspacesRunningMode.AUTOSTOP
    )
    ...
    @classmethod
    def from_dict(cls: Type["ListWorkspaces"], src_dict: Dict[str, Any]):
