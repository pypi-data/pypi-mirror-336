...
from ..models.create_workspace_response_compute_type import (
    CreateWorkspaceResponseComputeType,
)
from ..models.create_workspace_response_running_mode import (
...
class CreateWorkspaceResponse(BaseModel):
    ...
    Attributes:
        ...
        compute_type (Optional[CreateWorkspaceResponseComputeType]): The compute type Default:
                CreateWorkspaceResponseComputeType.STANDARD.
        ...
        running_mode (Optional[CreateWorkspaceResponseRunningMode]): The running mode Default:
                CreateWorkspaceResponseRunningMode.AUTOSTOP.
    ...
    compute_type: Optional["CreateWorkspaceResponseComputeType"] = Field(
        alias="ComputeType", default=CreateWorkspaceResponseComputeType.STANDARD
    )
    ...
    running_mode: Optional["CreateWorkspaceResponseRunningMode"] = Field(
        alias="RunningMode", default=CreateWorkspaceResponseRunningMode.AUTOSTOP
    )
    ...
    @classmethod
    def from_dict(cls: Type["CreateWorkspaceResponse"], src_dict: Dict[str, Any]):
