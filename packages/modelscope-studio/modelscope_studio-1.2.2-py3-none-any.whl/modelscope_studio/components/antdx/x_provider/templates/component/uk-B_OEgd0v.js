import { a as Y, c as h } from "./XProvider-DCnZmHeL.js";
...
(function(u, l) {
  (function(n, t) {
    ...
    function r(_, o, f) {
      var s, i;
      return f === "m" ? o ? "хвилина" : "хвилину" : f === "h" ? o ? "година" : "годину" : _ + " " + (s = +_, i = {
        ss: o ? "секунда_секунди_секунд" : "секунду_секунди_секунд",
        mm: o ? "хвилина_хвилини_хвилин" : "хвилину_хвилини_хвилин",
        hh: o ? "година_години_годин" : "годину_години_годин",
        dd: "день_дні_днів",
        MM: "місяць_місяці_місяців",
        yy: "рік_роки_років"
      }[f].split("_"), s % 10 == 1 && s % 100 != 11 ? i[0] : s % 10 >= 2 && s % 10 <= 4 && (s % 100 < 10 || s % 100 >= 20) ? i[1] : i[2]);
    }
    var m = function(_, o) {
...
var p = c.exports;
const k = /* @__PURE__ */ Y(p), v = /* @__PURE__ */ g({
  __proto__: null,
  default: k
}, [p]);
export {
