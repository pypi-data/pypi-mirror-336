import { a as $ } from "./XProvider-DCnZmHeL.js";
import { i as o, o as b, c as x } from "./config-provider-BQ7E8_YL.js";
function S(s, f) {
...
d.default = void 0;
var g = y(b), h = x, P = (0, g.default)((0, g.default)({}, h.commonLocale), {}, {
  locale: "gl_ES",
  today: "Hoxe",
  now: "Agora",
...
n.default = void 0;
var q = u(i), C = u(c), k = u(t), Y = u(l);
const e = "${label} non é un ${type} válido", F = {
  locale: "gl",
  Pagination: q.default,
...
n.default = F;
var _ = n;
const w = /* @__PURE__ */ $(_), U = /* @__PURE__ */ S({
  __proto__: null,
  default: w
}, [_]);
export {
