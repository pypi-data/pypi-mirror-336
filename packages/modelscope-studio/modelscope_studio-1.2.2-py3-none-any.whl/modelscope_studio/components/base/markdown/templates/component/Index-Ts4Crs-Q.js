var gt = typeof global == "object" && global && global.Object === Object && global, en = typeof self == "object" && self && self.Object === Object && self, j = gt || en || Function("return this")(), P = j.Symbol, dt = Object.prototype, tn = dt.hasOwnProperty, nn = dt.toString, H = P ? P.toStringTag : void 0;
function rn(e) {
...
var At = typeof exports == "object" && exports && !exports.nodeType && exports, q = At && typeof module == "object" && module && !module.nodeType && module, wr = q && q.exports === At, fe = wr && gt.process, z = function() {
  try {
    var e = q && q.require && q.require("util").types;
    return e || fe && fe.binding && fe.binding("util");
  } catch {
  }
}(), ze = z && z.isTypedArray, $t = ze ? Ae(ze) : Tr, Or = Object.prototype, Pr = Or.hasOwnProperty;
function St(e, t) {
  var n = S(e), r = !n && Pe(e), i = !n && !r && te(e), o = !n && !r && !i && $t(e), a = n || r || i || o, s = a ? Hn(e.length, String) : [], u = s.length;
  for (var l in e)
...
var Ct = xt(Object.getPrototypeOf, Object), yi = "[object Object]", mi = Function.prototype, vi = Object.prototype, Et = mi.toString, Ti = vi.hasOwnProperty, wi = Et.call(Object);
function _e(e) {
  if (!M(e) || D(e) != yi)
    return !1;
  var t = Ct(e);
...
E.prototype.clear = Pi;
E.prototype.delete = Ai;
E.prototype.get = $i;
E.prototype.has = Si;
E.prototype.set = Ci;
var jt = typeof exports == "object" && exports && !exports.nodeType && exports, qe = jt && typeof module == "object" && module && !module.nodeType && module, Ei = qe && qe.exports === jt, Je = Ei ? j.Buffer : void 0;
Je && Je.allocUnsafe;
function ji(e, t) {
  return e.slice();
}
...
var he = K(j, "DataView"), be = K(j, "Promise"), ye = K(j, "Set"), Ze = "[object Map]", Di = "[object Object]", We = "[object Promise]", Qe = "[object Set]", Ve = "[object WeakMap]", ke = "[object DataView]", Ni = N(he), Ki = N(X), Ui = N(be), Gi = N(ye), Bi = N(de), $ = D;
...
var nt = z && z.isMap, vo = nt ? Ae(nt) : mo, To = "[object Set]";
function wo(e) {
  return M(e) && $(e) == To;
}
var rt = z && z.isSet, Oo = rt ? Ae(rt) : wo, Lt = "[object Arguments]", Po = "[object Array]", Ao = "[object Boolean]", $o = "[object Date]", So = "[object Error]", Dt = "[object Function]", xo = "[object GeneratorFunction]", Co = "[object Map]", Eo = "[object Number]", Nt = "[object Object]", jo = "[object RegExp]", Io = "[object Set]", Mo = "[object String]", Fo = "[object Symbol]", Ro = "[object WeakMap]", Lo = "[object ArrayBuffer]", Do = "[object DataView]", No = "[object Float32Array]", Ko = "[object Float64Array]", Uo = "[object Int8Array]", Go = "[object Int16Array]", Bo = "[object Int32Array]", zo = "[object Uint8Array]", Ho = "[object Uint8ClampedArray]", qo = "[object Uint16Array]", Jo = "[object Uint32Array]", y = {};
y[Lt] = y[Po] = y[Lo] = y[Do] = y[Ao] = y[$o] = y[No] = y[Ko] = y[Uo] = y[Go] = y[Bo] = y[Co] = y[Eo] = y[Nt] = y[jo] = y[Io] = y[Mo] = y[Fo] = y[zo] = y[Ho] = y[qo] = y[Jo] = !0;
y[So] = y[Dt] = y[Ro] = !1;
function k(e, t, n, r, i, o) {
  ...
  o.set(e, a), Oo(e) ? e.forEach(function(c) {
    a.add(k(c, t, n, c, e, o));
  }) : vo(e) && e.forEach(function(c, p) {
    a.set(p, k(c, t, n, p, e, o));
  });
  var _ = Rt, f = s ? void 0 : _(e);
  return Rn(f || e, function(c, p) {
    f && (p = c, c = e[p]), vt(a, p, k(c, t, n, p, e, o));
  }), a;
}
...
function Kt(e, t, n, r, i, o) {
  ...
  for (o.set(e, t), o.set(t, e); ++_ < s; ) {
    var p = e[_], b = t[_];
    if (r)
      var d = a ? r(b, p, _, t, e, o) : r(p, b, _, e, t, o);
    if (d !== void 0) {
      if (d)
        continue;
      f = !1;
...
var na = 1, ra = 2, ia = "[object Boolean]", oa = "[object Date]", aa = "[object Error]", sa = "[object Map]", ua = "[object Number]", la = "[object RegExp]", fa = "[object Set]", ca = "[object String]", pa = "[object Symbol]", ga = "[object ArrayBuffer]", da = "[object DataView]", it = P ? P.prototype : void 0, ce = it ? it.valueOf : void 0;
...
var va = 1, ot = "[object Arguments]", at = "[object Array]", V = "[object Object]", Ta = Object.prototype, st = Ta.hasOwnProperty;
function wa(e, t, n, r, i, o) {
  var a = S(e), s = S(t), u = a ? at : $(e), l = s ? at : $(t);
  u = u == ot ? V : u, l = l == ot ? V : l;
  var g = u == V, _ = l == V, f = u == l;
  if (f && te(e)) {
    if (!te(t))
      return !1;
    a = !0, g = !1;
  ...
  if (f && !g)
    return o || (o = new E()), a || $t(e) ? Kt(e, t, n, r, i, o) : _a(e, t, u, n, r, i, o);
  if (!(n & va)) {
    var c = g && st.call(e, "__wrapped__"), p = _ && st.call(t, "__wrapped__");
    if (c || p) {
      var b = c ? e.value() : e, d = p ? t.value() : t;
      return o || (o = new E()), i(b, d, n, r, o);
    }
  }
  return f ? (o || (o = new E()), ma(e, t, n, r, i, o)) : !1;
}
...
function Aa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var g = new E(), _;
      if (!(_ === void 0 ? Ie(l, u, Oa | Pa, r, g) : _))
        return !1;
    }
  }
  return !0;
  ...
  return {
    ...Array.from(/* @__PURE__ */ new Set([...Object.keys(r).map((u) => {
      ...
      const g = l.split("_"), _ = (...c) => {
        const p = c.map((d) => c && typeof d == "object" && (d.nativeEvent || d instanceof Event) ? {
          type: d.type,
          detail: d.detail,
...
function Ds(e) {
  ...
  e[21]({
    ...
    p(o, a) {
      const s = a & /*$mergedProps, root, gradio, $slots*/
      15 ? xs(r, [a & /*$mergedProps*/
      4 && {
        style: (
          /*$mergedProps*/
          o[2].elem_style
...
function Us(e) {
  ...
  return {
    ...
    p(i, [o]) {
      ...
      4 && B(r, 1)) : (r = pt(i), r.c(), B(r, 1), r.m(t.parentNode, t)) : r && (Cs(), Y(r, 1, 1, () => {
        r = null;
      }), vs());
    },
    i(i) {
...
function Gs(e, t, n) {
  ...
  const g = Qa(() => import("./markdown-r-1Uj5l0.js"));
  let {
    value: _ = ""
  } = t, {
    as_item: f
  ...
  return pe(e, Fe, (h) => n(2, a = h)), e.$$set = (h) => {
    t = me(me({}, t), As(h)), n(20, i = ct(t, r)), "value" in h && n(8, _ = h.value), "as_item" in h && n(9, f = h.as_item), "props" in h && n(10, c = h.props), "gradio" in h && n(0, b = h.gradio), "root" in h && n(1, d = h.root), "visible" in h && n(11, v = h.visible), "_internal" in h && n(12, T = h._internal), "elem_id" in h && n(13, O = h.elem_id), "elem_classes" in h && n(14, x = h.elem_classes), "elem_style" in h && n(15, A = h.elem_style), "$$scope" in h && n(18, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    1024 && p.update((h) => ({
      ...h,
  ...
  }, [b, d, a, s, g, p, Me, Fe, _, f, c, v, T, O, x, A, o, u, l];
}
class qs extends ms {
  constructor(t) {
    super(), js(this, t, Gs, Us, Ms, {
      value: 8,
      as_item: 9,
      props: 10,
      gradio: 0,
