import { s as F, j as x } from "./sveltify-UGyYojTz.js";
import { i as G, a as P, r as U, d as D, g as S, m as V } from "./Index-Co4nOvDI.js";
...
const ue = B(({
  ...
  return M(() => {
    ...
    if (b && window.MutationObserver) {
      let d = function() {
        var v, y, a;
        (v = o.current) != null && v.contains(c) && ((y = o.current) == null || y.removeChild(c));
        const {
          portals: h,
          clonedElement: R
        } = A(e);
