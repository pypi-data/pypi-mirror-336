import { p as w } from "./chunk-IUKPXING-e0t97HZe.js";
import { _ as n, s as B, g as S, q as F, p as z, a as P, b as W, D as x, H as D, e as T, y as E, E as _, F as A, l as m } from "./mermaid.core-mH_T8-GP.js";
import { p as N } from "./gitGraph-YCYPL57B-Ct4_k1FH.js";
var C = {
  packet: []
  ...
  const i = s.db, a = i.getConfig(), {
    rowHeight: r,
    paddingY: p,
    bitWidth: b,
    bitsPerRow: c
  } = a, u = i.getPacket(), l = i.getDiagramTitle(), g = r + p, d = g * (u.length + 1) - (l ? 0 : r), k = b * c + 2, f = D(e);
