import { aP as un, aQ as I, aR as Q, aS as fn, aT as U } from "./mermaid.core-mH_T8-GP.js";
...
function F(n, t, e) {
  ...
  let u, c, o;
  return i < 0 ? (o = Math.pow(10, -i) / a, u = Math.round(n * o), c = Math.round(t * o), u / o < n && ++u, c / o > t && --c, o = -o) : (o = Math.pow(10, i) * a, u = Math.round(n / o), c = Math.round(t / o), u * o < n && ++u, c * o > t && --c), c < u && 0.5 <= e && e < 2 ? F(n, t, e * 2) : [u, c, o];
}
function pn(n, t, e) {
  if (t = +t, n = +n, e = +e, !(e > 0)) return [];
  if (n === t) return [n];
  const r = t < n, [i, f, a] = r ? F(t, n, e) : F(n, t, e);
  if (!(f >= i)) return [];
...
function C(n, t) {
  var e = typeof t, r;
  return t == null || e === "boolean" ? un(t) : (e === "number" ? I : e === "string" ? (r = U(t)) ? (t = r, Q) : fn : t instanceof U ? Q : t instanceof Date ? An : kn(t) ? Nn : Array.isArray(t) ? xn : typeof t.valueOf != "function" && typeof t.toString != "function" || isNaN(t) ? vn : I)(n, t);
}
function Sn(n, t) {
...
function Fn(n) {
  var t = n.grouping === void 0 || n.thousands === void 0 ? H : Pn(J.call(n.grouping, Number), n.thousands + ""), e = n.currency === void 0 ? "" : n.currency[0] + "", r = n.currency === void 0 ? "" : n.currency[1] + "", i = n.decimal === void 0 ? "." : n.decimal + "", f = n.numerals === void 0 ? H : jn(J.call(n.numerals, String)), a = n.percent === void 0 ? "%" : n.percent + "", u = n.minus === void 0 ? "−" : n.minus + "", c = n.nan === void 0 ? "NaN" : n.nan + "";
  function o(h) {
    h = T(h);
    var l = h.fill, p = h.align, y = h.sign, S = h.symbol, k = h.zero, b = h.width, D = h.comma, w = h.precision, G = h.trim, d = h.type;
    d === "n" ? (D = !0, d = "g") : Z[d] || (w === void 0 && (w = 12), G = !0, d = "g"), (k || l === "0" && p === "=") && (k = !0, l = "0", p = "=");
    var en = S === "$" ? e : S === "#" && /[boxX]/.test(d) ? "0" + d.toLowerCase() : "", on = S === "$" ? r : /[%p]/.test(d) ? a : "", O = Z[d], an = /[defgprs%]/.test(d);
    ...
    function V(m) {
      ...
      if (d === "c")
        ...
        m = +m;
        var j = m < 0 || 1 / m < 0;
        if (m = isNaN(m) ? c : O(Math.abs(m), w), G && (m = Rn(m)), j && +m == 0 && y !== "+" && (j = !1), N = (j ? y === "(" ? y : u : y === "-" || y === "(" ? "" : y) + N, g = (d === "s" ? K[8 + nn / 3] : "") + g + (j && y === "(" ? ")" : ""), an) {
          for (x = -1, X = m.length; ++x < X; )
            if (P = m.charCodeAt(x), 48 > P || P > 57) {
              g = (P === 46 ? i + m.slice(x + 1) : m.slice(x)) + g, m = m.slice(0, x);
              break;
            }
        }
      }
      ...
      switch (D && k && (m = t(M + m, M.length ? b - g.length : 1 / 0), M = ""), p) {
        case "<":
          m = N + m + g + M;
          break;
        case "=":
  ...
  function s(h, l) {
    var p = o((h = T(h), h.type = "f", h)), y = Math.max(-8, Math.min(8, Math.floor(v(l) / 3))) * 3, S = Math.pow(10, -y), k = K[8 + y / 3];
    return function(b) {
      return p(S * b) + k;
    };
  }
...
function En(n) {
  return R = Fn(n), tn = R.format, rn = R.formatPrefix, R;
}
function Tn(n) {
...
function Qn(n, t, e, r) {
  ...
  switch (r = T(r ?? ",f"), r.type) {
    case "s": {
      ...
      return r.precision == null && !isNaN(f = Dn(i, a)) && (r.precision = f), rn(r, a);
    }
    case "":
    case "e":
    case "g":
...
function Un(n) {
  ...
  return n.ticks = function(e) {
    ...
    var i = t();
    return Qn(i[0], i[i.length - 1], e ?? 10, r);
  }, n.nice = function(e) {
    e == null && (e = 10);
