...
import { g as ne, s as le } from "./chunk-2O5F6CEG-BPykxt5C.js";
import { _ as p, l as v, c as A, r as oe, u as ce, S as he, k as j, y as ue, a as de, b as fe, g as pe, s as Se, p as ye, q as ge } from "./mermaid.core-mH_T8-GP.js";
var bt = function() {
  var e = /* @__PURE__ */ p(function(P, l, h, a) {
    ...
    performAction: /* @__PURE__ */ p(function(l, h, a, T, _, i, K) {
      ...
      switch (_) {
        ...
        case 35:
          ...
          break;
        case 36:
          T.setDirection("TB"), this.$ = {
            stmt: "dir",
            value: "TB"
          };
          break;
        case 37:
          T.setDirection("BT"), this.$ = {
            stmt: "dir",
            value: "BT"
          };
          break;
        case 38:
          T.setDirection("RL"), this.$ = {
            stmt: "dir",
            value: "RL"
          };
          break;
        case 39:
          T.setDirection("LR"), this.$ = {
            stmt: "dir",
            value: "LR"
          };
          break;
    ...
    table: [{
      ...
      5: s,
      6: n
    }, e([1, 4, 5, 16, 17, 19, 22, 24, 25, 26, 27, 28, 29, 33, 35, 37, 38, 42, 45, 48, 49, 50, 51, 54], o, {
      7: 7
    }), {
      1: [2, 1]
    }, {
      ...
      51: at,
      54: X
    }, e(y, [2, 7]), e(y, [2, 8]), e(y, [2, 9]), e(y, [2, 10]), e(y, [2, 11]), e(y, [2, 12], {
      14: [1, 39],
      15: [1, 40]
    }), e(y, [2, 16]), {
      18: [1, 41]
      ...
      23: [1, 43]
    }, e(y, [2, 22]), e(y, [2, 23]), e(y, [2, 24]), e(y, [2, 25]), {
      30: 44,
      31: [1, 45],
      56: [1, 46],
      57: [1, 47]
      ...
      55: [1, 55]
    }), e(y, [2, 36]), e(y, [2, 37]), e(y, [2, 38]), e(y, [2, 39]), e(y, [2, 6]), e(y, [2, 13]), {
      13: 56,
      24: m,
      54: X
    }, e(y, [2, 17]), e(At, o, {
      ...
      24: [1, 71]
    }, e(y, [2, 32]), e(y, [2, 33]), e(y, [2, 34]), e(y, [2, 35]), e(nt, [2, 44]), e(nt, [2, 45]), e(y, [2, 15]), e(y, [2, 19]), e(At, o, {
      7: 72
    }), e(y, [2, 26]), e(y, [2, 27]), {
      4: c,
      5: r,
    ...
    parse: /* @__PURE__ */ p(function(l) {
      var h = this, a = [0], T = [], _ = [null], i = [], K = this.table, u = "", V = 0, z = 0, ot = 2, J = 1, yt = i.slice.call(arguments, 1), D = Object.create(this.lexer), M = {
        yy: {}
      };
...
Expecting ` + ht.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Et = "Parse error on line " + (V + 1) + ": Unexpected " + (k == J ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Et, {
        ...
        switch (x[0]) {
          case 1:
            a.push(k), _.push(D.yytext), i.push(D.yylloc), a.push(x[1]), k = null, z = D.yyleng, u = D.yytext, V = D.yylineno, Tt = D.yylloc;
            break;
          case 2:
            ...
            }, se && (W._$.range = [i[i.length - (N || 1)].range[0], i[i.length - 1].range[1]]), _t = this.performAction.apply(W, [u, z, V, M.yy, x[1], _, i].concat(yt)), typeof _t < "u")
              return _t;
...
var Xe = bt, Te = "TB", Mt = "TB", Rt = "dir", dt = "state", vt = "relation", _e = "classDef", Ee = "style", me = "applyClass", Z = "default", Ut = "divider", jt = "fill:none", Ht = "fill: #333", zt = "c", Wt = "text", Xt = "normal", mt = "rect", Dt = "rectWithTitle", De = "stateStart", be = "stateEnd", Ot = "divider", Nt = "roundedWithTitle", ve = "note", ke = "noteGroup", tt = "statediagram", Ce = "state", xe = `${tt}-${Ce}`, Kt = "transition", Ae = "note", Le = "note-edge", Ie = `${Kt} ${Le}`, Re = `${tt}-${Ae}`, Oe = "cluster", Ne = `${tt}-${Oe}`, we = "cluster-alt", $e = `${tt}-${we}`, Jt = "parent", qt = "note", Pe = "state", xt = "----", Be = `${xt}${qt}`, wt = `${xt}${Jt}`, Qt = /* @__PURE__ */ p((e, t = Mt) => {
  ...
  d.type = n.type, d.layoutAlgorithm = r, d.nodeSpacing = (c == null ? void 0 : c.nodeSpacing) || 50, d.rankSpacing = (c == null ? void 0 : c.rankSpacing) || 50, d.markers = ["barb"], d.diagramId = t, await oe(d, f);
  const g = 8;
  ce.insertTitle(f, "statediagramTitleText", (c == null ? void 0 : c.titleTopMargin) ?? 25, n.db.getDiagramTitle()), le(f, g, tt, (c == null ? void 0 : c.useMaxWidth) ?? !0);
}, "draw"), Ke = {
  getClasses: Ge,
  draw: Ye,
  getDir: Qt
...
var Fe = /* @__PURE__ */ p((e, t, s, n, o, c, r, d) => {
  v.trace("items", t), t.forEach((f) => {
    switch (f.stmt) {
      ...
      case vt:
        {
          Q(e, f.state1, s, n, o, c, r, d), Q(e, f.state2, s, n, o, c, r, d);
          const g = {
            id: "edge" + B,
            start: f.state1.id,
            end: f.state2.id,
...
var Vt = /* @__PURE__ */ p(() => ({
  ...
  documents: {}
}), "newDoc"), ut = /* @__PURE__ */ p((e) => JSON.parse(JSON.stringify(e)), "clone"), H, Je = (H = class {
  /**
  ...
  constructor(t) {
     ...
     */
    b(this, "dividerCnt", 0);
    b(this, "getAccTitle", de);
    b(this, "setAccTitle", fe);
    b(this, "getAccDescription", pe);
    b(this, "setAccDescription", Se);
    b(this, "setDiagramTitle", ye);
    b(this, "getDiagramTitle", ge);
  ...
  extract(t) {
    ...
    t.doc ? s = t.doc : s = t, v.info(s), this.clear(!0), v.info("Extract initial document:", s), s.forEach((r) => {
      switch (v.warn("Statement", r.stmt), r.stmt) {
        case dt:
          this.addState(r.id.trim(), r.type, r.doc, r.description, r.note, r.classes, r.styles, r.textStyles);
          break;
        case vt:
    ...
    Ve(), Q(void 0, this.getRootDocV2(), n, this.nodes, this.edges, !0, c, this.classes), this.nodes.forEach((r) => {
  ...
  clear(t) {
    this.nodes = [], this.edges = [], this.documents = {
      root: Vt()
    }, this.currentDocument = this.documents.root, this.startEndCount = 0, this.classes = Ct(), t || ue();
  }
  getState(t) {
  ...
  addRelationObjs(t, s, n) {
    ...
    this.addState(o, c, t.doc, t.description, t.note, t.classes, t.styles, t.textStyles), this.addState(r, d, s.doc, s.description, s.note, s.classes, s.styles, s.textStyles), this.currentDocument.relations.push({
      id1: o,
      id2: r,
   ...
   */
  addStyleClass(t, s = "") {
    this.classes.has(t) || this.classes.set(t, {
      id: t,
      styles: [],
      textStyles: []
    });
  ...
  setDirection(t) {
    ...
    s ? s.value = t : this.rootDoc.unshift({
      stmt: Rt,
      value: t
    });
  }
