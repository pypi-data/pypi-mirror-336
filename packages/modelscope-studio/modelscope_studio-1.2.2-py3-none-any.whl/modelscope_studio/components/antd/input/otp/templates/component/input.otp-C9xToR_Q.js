import { i as ae, a as A, r as ue, b as de, w as P, g as fe, c as me } from "./Index-DXR3vVKH.js";
...
function q(e) {
  ...
  e = ye(e);
  var r = ve.test(e);
  return r || xe.test(e) ? Ce(e.slice(2), r ? 2 : 8) : Ee.test(e) ? U : +e;
}
var L = function() {
  return ue.Date.now();
  ...
  return N(() => {
    ...
    if (h && window.MutationObserver) {
      let m = function() {
        ...
        c = S, u(b), c.style.display = "contents", v && clearTimeout(v), v = setTimeout(() => {
          w();
      ...
      c.style.display = "contents", w(), (x = s.current) == null || x.appendChild(c);
    return () => {
      var m, p;
