import { i as ue, a as B, r as de, b as fe, w as O, g as me, c as _e } from "./Index-axv2pr2-.js";
    ...
    const i = O(), r = new tt({
      ...
      props: {
        svelteInit(o) {
          ...
          return d.nodes = [...d.nodes, l], Z({
            createPortal: M,
            node: A
          }), o.onDestroy(() => {
            d.nodes = d.nodes.filter((f) => f.svelteInstance !== i), Z({
              createPortal: M,
              node: A
            });
          }), l;
...
function U(e) {
  ...
  if (e._reactElement) {
    const i = y.Children.toArray(e._reactElement.props.children).map((r) => {
...
const C = ce(({
  ...
  }, [e, g, n, s, r, i, f]), y.createElement("react-child", {
    ref: o,
    style: {
      display: "contents"
    }
...
function ee({
  ...
  return t[e] ? (...i) => n ? n.map((r, o) => /* @__PURE__ */ p.jsx(y.Fragment, {
    children: $(r, {
      clone: !0,
      params: i,
      forceClone: !0
