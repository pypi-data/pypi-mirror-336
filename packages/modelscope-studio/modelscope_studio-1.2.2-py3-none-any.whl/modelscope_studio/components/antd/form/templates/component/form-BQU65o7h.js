import { i as ue, a as N, r as de, w as P, g as fe, b as me } from "./Index-8zuNz362.js";
    ...
    const s = P(), n = new Ze({
      ...
      props: {
        svelteInit(o) {
          ...
          return a.nodes = [...a.nodes, l], X({
            createPortal: j,
            node: L
          }), o.onDestroy(() => {
            a.nodes = a.nodes.filter((_) => _.svelteInstance !== s), X({
              createPortal: j,
              node: L
            });
          }), l;
