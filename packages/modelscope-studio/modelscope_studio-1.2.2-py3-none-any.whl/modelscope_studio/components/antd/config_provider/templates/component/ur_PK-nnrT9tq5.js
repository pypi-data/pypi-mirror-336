...
import { i as o, o as P, c as g } from "./config-provider-p_NQQ49i.js";
function x(m, f) {
...
c.default = void 0;
var _ = h(P), j = g, T = (0, _.default)((0, _.default)({}, j.commonLocale), {}, {
  locale: "ur_PK",
  today: "آج",
  now: "ابھی",
  backToToday: "آج واپس",
...
n.default = void 0;
var Y = d(u), w = d(i), C = d(r), q = d(t);
const e = "${label} درست نہیں ہے ${type}", A = {
  locale: "ur",
