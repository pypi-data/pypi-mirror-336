...
import { i as n, o as $, c as k } from "./config-provider-p_NQQ49i.js";
function y(m, v) {
    ...
    if (typeof t != "string" && !Array.isArray(t)) {
      for (const r in t)
        if (r !== "default" && !(r in m)) {
          ...
          g && Object.defineProperty(m, r, g.get ? g : {
            enumerable: !0,
            get: () => t[r]
          });
        }
...
s.default = void 0;
var p = h($), x = k, j = (0, p.default)((0, p.default)({}, x.commonLocale), {}, {
  locale: "nb_NO",
  today: "I dag",
  now: "Nå",
