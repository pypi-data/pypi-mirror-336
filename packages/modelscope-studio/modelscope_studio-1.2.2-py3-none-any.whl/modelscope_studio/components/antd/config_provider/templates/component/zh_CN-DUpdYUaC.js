...
import { i as o, o as g, c as x } from "./config-provider-p_NQQ49i.js";
function y(s, f) {
...
d.default = void 0;
var _ = P(g), z = x, N = (0, _.default)((0, _.default)({}, z.commonLocale), {}, {
  locale: "zh_CN",
  today: "今天",
  now: "此刻",
  backToToday: "返回今天",
...
n.default = void 0;
var M = u(i), S = u(c), w = u(t), A = u(r);
const e = "${label}不是一个有效的${type}", F = {
  locale: "zh-cn",
...
n.default = F;
var h = n;
const Y = /* @__PURE__ */ b(h), R = /* @__PURE__ */ y({
  __proto__: null,
  default: Y
}, [h]);
export {
