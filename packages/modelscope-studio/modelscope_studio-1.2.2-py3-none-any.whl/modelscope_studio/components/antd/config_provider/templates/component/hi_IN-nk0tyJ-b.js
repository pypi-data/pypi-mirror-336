...
import { i as o, o as h, c as g } from "./config-provider-p_NQQ49i.js";
function x(m, f) {
...
d.default = void 0;
var _ = P(h), I = g, j = (0, _.default)((0, _.default)({}, I.commonLocale), {}, {
  locale: "hi_IN",
  today: "आज",
  now: "अभी",
  backToToday: "आज तक",
...
const e = "${label} मान्य ${type} नहीं है", q = {
  locale: "hi",
...
i.default = q;
var v = i;
const A = /* @__PURE__ */ b(v), R = /* @__PURE__ */ x({
  __proto__: null,
  default: A
}, [v]);
export {
