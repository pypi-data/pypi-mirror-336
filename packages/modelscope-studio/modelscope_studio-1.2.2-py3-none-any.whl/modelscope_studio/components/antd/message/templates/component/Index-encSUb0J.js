var ft = typeof global == "object" && global && global.Object === Object && global, Wt = typeof self == "object" && self && self.Object === Object && self, x = ft || Wt || Function("return this")(), w = x.Symbol, pt = Object.prototype, Qt = pt.hasOwnProperty, Vt = pt.toString, B = w ? w.toStringTag : void 0;
function kt(e) {
...
var Ot = typeof exports == "object" && exports && !exports.nodeType && exports, z = Ot && typeof module == "object" && module && !module.nodeType && module, yr = z && z.exports === Ot, se = yr && ft.process, G = function() {
  try {
...
var ge = K(x, "DataView"), de = K(x, "Promise"), _e = K(x, "Set"), Xe = "[object Map]", Mi = "[object Object]", Ye = "[object Promise]", Ze = "[object Set]", We = "[object WeakMap]", Qe = "[object DataView]", Fi = N(ge), Ri = N(q), Li = N(de), Di = N(_e), Ni = N(fe), A = D;
(ge && A(new ge(new ArrayBuffer(1))) != Qe || q && A(new q()) != Xe || de && A(de.resolve()) != Ye || _e && A(new _e()) != Ze || fe && A(new fe()) != We) && (A = function(e) {
...
var Vo = 1, ko = 2, ea = "[object Boolean]", ta = "[object Date]", na = "[object Error]", ra = "[object Map]", ia = "[object Number]", oa = "[object RegExp]", aa = "[object Set]", sa = "[object String]", ua = "[object Symbol]", la = "[object ArrayBuffer]", ca = "[object DataView]", nt = w ? w.prototype : void 0, ue = nt ? nt.valueOf : void 0;
...
function ya(e, t, n, r, o, i) {
  ...
  if (c && !g)
    return i || (i = new C()), a || wt(e) ? Dt(e, t, n, r, o, i) : fa(e, t, u, n, r, o, i);
  if (!(n & ba)) {
    var f = g && ot.call(e, "__wrapped__"), d = b && ot.call(t, "__wrapped__");
    if (f || d) {
      var h = f ? e.value() : e, p = d ? t.value() : t;
      return i || (i = new C()), o(h, p, n, r, i);
    }
  }
  return c ? (i || (i = new C()), _a(e, t, n, r, o, i)) : !1;
}
...
function Fs(e, t, n) {
  ...
  const g = Xa(() => import("./message-BLlZZbLg.js"));
  let {
    gradio: b
  } = t, {
    props: c = {}
  ...
  return e.$$set = (_) => {
    t = be(be({}, t), ys(_)), n(20, o = lt(t, r)), "gradio" in _ && n(7, b = _.gradio), "props" in _ && n(8, c = _.props), "_internal" in _ && n(9, d = _._internal), "content" in _ && n(10, h = _.content), "as_item" in _ && n(11, p = _.as_item), "visible" in _ && n(0, v = _.visible), "elem_id" in _ && n(12, T = _.elem_id), "elem_classes" in _ && n(13, O = _.elem_classes), "elem_style" in _ && n(14, S = _.elem_style), "$$scope" in _ && n(18, l = _.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && f.update((_) => ({
      ..._,
  ...
  }, [v, a, s, g, f, j, Ie, b, c, d, h, p, T, O, S, i, u, Zt, l];
}
class Ds extends ps {
  constructor(t) {
