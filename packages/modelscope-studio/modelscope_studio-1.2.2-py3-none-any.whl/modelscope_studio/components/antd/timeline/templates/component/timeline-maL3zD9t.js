import { i as ae, a as W, r as ue, w as O, g as de } from "./Index-Dy3VdlhI.js";
...
var B = NaN, we = /^[-+]0x[0-9a-f]+$/i, xe = /^0b[01]+$/i, Ee = /^0o[0-7]+$/i, Ce = parseInt;
function H(e) {
  if (typeof e == "number")
    return e;
  if (ae(e))
  ...
  e = be(e);
  var s = xe.test(e);
  return s || Ee.test(e) ? Ce(e.slice(2), s ? 2 : 8) : we.test(e) ? B : +e;
}
var L = function() {
  return ue.Date.now();
}, ve = "Expected a function", ye = Math.max, Ie = Math.min;
function Se(e, t, s) {
  var l, o, n, r, i, u, _ = 0, h = !1, c = !1, g = !0;
  if (typeof e != "function")
    throw new TypeError(ve);
  t = H(t) || 0, W(s) && (h = !!s.leading, c = "maxWait" in s, n = c ? ye(H(s.maxWait) || 0, t) : n, g = "trailing" in s ? !!s.trailing : g);
  function f(p) {
    var C = l, T = o;
    return l = o = void 0, _ = p, r = e.apply(T, C), r;
  }
  function b(p) {
    return _ = p, i = setTimeout(m, t), h ? f(p) : r;
  }
  function x(p) {
    var C = p - u, T = p - _, F = t - C;
    return c ? Ie(F, n - T) : F;
  }
  function a(p) {
    var C = p - u, T = p - _;
 ...
 */
var Te = v, Oe = Symbol.for("react.element"), Re = Symbol.for("react.fragment"), ke = Object.prototype.hasOwnProperty, Pe = Te.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, je = {
  key: !0,
  ref: !0,
  __self: !0,
  __source: !0
...
function Ye(e) {
  ...
  return {
    c() {
      t = te("react-portal-target"), s = ze(), n && n.c(), l = V(), this.h();
    },
    l(r) {
      t = ee(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), $(t).forEach(I), s = Ae(r), n && n.l(r), l = V(), this.h();
    },
    h() {
      ne(t, "class", "svelte-1rt0kpf");
    },
    ...
    p(r, [i]) {
      ...
      16 && k(n, 1)) : (n = X(r), n.c(), k(n, 1), n.m(l.parentNode, l)) : n && (Ue(), D(n, 1, 1, () => {
        n = null;
      }), Ne());
    },
    i(r) {
      ...
      props: {
        svelteInit(r) {
          ...
          return u.nodes = [...u.nodes, i], K({
            ...
            u.nodes = u.nodes.filter((_) => _.svelteInstance !== o), K({
              createPortal: A,
              node: N
            });
          }), i;
...
function M(e) {
  ...
  if (e._reactElement) {
    ...
    return o.originalChildren = e._reactElement.props.children, t.push(A(v.cloneElement(e._reactElement, {
  ...
  return ie(() => {
    ...
    if (h && window.MutationObserver) {
      let a = function() {
        ...
        c = S, u(E), c.style.display = "contents", b && clearTimeout(b), b = setTimeout(() => {
          g();
  ...
  if (l.length !== 0)
    return l.map((o, n) => {
      ...
      Object.keys(o.slots).forEach((h) => {
        ...
        const c = h.split(".");
        c.forEach((m, E) => {
          i[m] || (i[m] = {}), E !== c.length - 1 && (i = r[m]);
        });
        const g = o.slots[h];
        let f, b, x = !1, a = t == null ? void 0 : t.forceClone;
        g instanceof Element ? f = g : (f = g.el, b = g.callback, x = g.clone ?? x, a = g.forceClone ?? a), a = a ?? !!b, i[c[c.length - 1]] = f ? b ? (...m) => (b(c[c.length - 1], m), /* @__PURE__ */ w.jsx(U, {
          ...o.ctx,
          params: m,
          forceClone: a,
...
const {
  ...
  useItems: lt,
  ItemHandler: at
} = pe("antd-timeline-items"), ut = Ze(st(["items", "default"], ({
  slots: e,
  items: t,
  children: s,
  ...l
  ...
  const {
    items: o
  } = lt(), n = o.items.length > 0 ? o.items : o.default;
  return /* @__PURE__ */ w.jsxs(w.Fragment, {
    children: [/* @__PURE__ */ w.jsx("div", {
      ...
      ...l,
      items: ce(() => t || re(n), [t, n]),
      pending: e.pending ? /* @__PURE__ */ w.jsx(P, {
        slot: e.pending
      }) : l.pending,
      pendingDot: e.pendingDot ? /* @__PURE__ */ w.jsx(P, {
        slot: e.pendingDot
      }) : l.pendingDot
    })]
  });
