import { i as ae, a as L, r as ce, w as O, g as ue, d as de, b as R } from "./Index-B3DB5Yyb.js";
...
var F = NaN, be = /^[-+]0x[0-9a-f]+$/i, ye = /^0b[01]+$/i, we = /^0o[0-7]+$/i, xe = parseInt;
function U(e) {
  if (typeof e == "number")
    return e;
  if (ae(e))
  ...
  e = he(e);
  var o = ye.test(e);
  return o || we.test(e) ? xe(e.slice(2), o ? 2 : 8) : be.test(e) ? F : +e;
}
var N = function() {
  return ce.Date.now();
...
function Ie(e, t, o) {
  ...
  t = U(t) || 0, L(o) && (g = !!o.leading, a = "maxWait" in o, n = a ? Ee(U(o.maxWait) || 0, t) : n, h = "trailing" in o ? !!o.trailing : h);
  function p(d) {
    var y = s, T = i;
    return s = i = void 0, _ = d, r = e.apply(T, y), r;
  }
  function x(d) {
    return _ = d, l = setTimeout(m, t), g ? p(d) : r;
  }
  function v(d) {
    var y = d - u, T = d - _, D = t - y;
    return a ? Ce(D, n - T) : D;
  }
  function f(d) {
    var y = d - u, T = d - _;
