...
var wt = typeof exports == "object" && exports && !exports.nodeType && exports, H = wt && typeof module == "object" && module && !module.nodeType && module, vr = H && H.exports === wt, ce = vr && pt.process, B = function() {
  try {
...
var ea = 1, ta = 2, na = "[object Boolean]", ra = "[object Date]", ia = "[object Error]", oa = "[object Map]", aa = "[object Number]", sa = "[object RegExp]", ua = "[object Set]", la = "[object String]", ca = "[object Symbol]", fa = "[object ArrayBuffer]", pa = "[object DataView]", rt = w ? w.prototype : void 0, fe = rt ? rt.valueOf : void 0;
...
function Rs(e) {
  ...
  return {
    ...
    p(i, [o]) {
      ...
      1 && G(r, 1)) : (r = ft(i), r.c(), G(r, 1), r.m(t.parentNode, t)) : r && (ws(), X(r, 1, 1, () => {
        r = null;
      }), _s());
    },
    i(i) {
...
function Ls(e, t, n) {
  ...
  const g = Za(() => import("./popover-CARmVpGp.js"));
  let {
    gradio: _
  } = t, {
    props: c = {}
  ...
  }, [a, s, g, f, j, Me, _, c, d, b, p, v, T, P, S, o, u, l];
}
class Ks extends ds {
  constructor(t) {
