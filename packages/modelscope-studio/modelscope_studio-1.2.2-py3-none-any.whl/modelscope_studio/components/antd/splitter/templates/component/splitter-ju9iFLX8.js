...
function xe(e, t, o) {
  ...
  t = H(t) || 0, j(o) && (h = !!o.leading, a = "maxWait" in o, n = a ? Ee(H(o.maxWait) || 0, t) : n, g = "trailing" in o ? !!o.trailing : g);
  function m(u) {
    var b = l, S = s;
  ...
  return {
    ...
    l(r) {
      t = $(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Z(t).forEach(C), o = Le(r), n && n.l(r), l = K(), this.h();
    },
    h() {
      te(t, "class", "svelte-1rt0kpf");
    },
