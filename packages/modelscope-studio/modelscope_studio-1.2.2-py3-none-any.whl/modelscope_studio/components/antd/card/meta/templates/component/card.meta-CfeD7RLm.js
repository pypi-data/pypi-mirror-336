import { i as ie, a as W, r as le, w as R, g as ae } from "./Index-B642s7-1.js";
...
function Ee(e, t, o) {
  ...
  function m(u) {
    var y = i, T = s;
    return i = s = void 0, _ = u, r = e.apply(T, y), r;
  }
  function v(u) {
    return _ = u, l = setTimeout(p, t), h ? m(u) : r;
  }
  function C(u) {
    var y = u - d, T = u - _, F = t - y;
    return a ? we(F, n - T) : F;
  }
  function f(u) {
    var y = u - d, T = u - _;
  ...
  return {
    ...
    l(r) {
      t = $(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Z(t).forEach(I), o = Pe(r), n && n.l(r), i = K(), this.h();
    },
    h() {
      te(t, "class", "svelte-1rt0kpf");
    },
...
const N = ne(({
  ...
  return se(() => {
    ...
    if (h && window.MutationObserver) {
      let f = function() {
        ...
        a = S, d(b), a.style.display = "contents", v && clearTimeout(v), v = setTimeout(() => {
          g();
  ...
  children: [/* @__PURE__ */ w.jsx("div", {
    ...
    children: t
  }), /* @__PURE__ */ w.jsx(ue.Meta, {
    ...o,
    title: e.title ? /* @__PURE__ */ w.jsx(N, {
      slot: e.title
    }) : o.title,
    description: e.description ? /* @__PURE__ */ w.jsx(N, {
      slot: e.description
    }) : o.description,
    avatar: e.avatar ? /* @__PURE__ */ w.jsx(N, {
      slot: e.avatar
    }) : o.avatar
  })]
}));
