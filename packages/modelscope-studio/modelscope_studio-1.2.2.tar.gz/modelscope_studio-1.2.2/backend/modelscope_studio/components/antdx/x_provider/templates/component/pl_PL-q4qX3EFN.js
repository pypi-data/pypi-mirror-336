import { a as w } from "./XProvider-DCnZmHeL.js";
import { i as o, o as _, c as $ } from "./config-provider-BQ7E8_YL.js";
function v(u, y) {
...
i.default = void 0;
var L = p(n), T = p(s), S = p(r), W = p(l);
const e = "${label} nie posiada poprawnej wartości dla typu ${type}", F = {
  locale: "pl",
...
i.default = F;
var z = i;
const U = /* @__PURE__ */ w(z), A = /* @__PURE__ */ v({
  __proto__: null,
  default: U
}, [z]);
export {
