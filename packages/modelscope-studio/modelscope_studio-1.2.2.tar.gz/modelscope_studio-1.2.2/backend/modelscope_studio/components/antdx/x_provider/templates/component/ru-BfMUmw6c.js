import { a as g, c as v } from "./XProvider-DCnZmHeL.js";
...
(function(u, m) {
  (function(o, _) {
    ...
    var f = function(t, a) {
      return M.test(a) ? n[t.month()] : c[t.month()];
    };
    f.s = c, f.f = n;
    var l = function(t, a) {
      return M.test(a) ? d[t.month()] : p[t.month()];
    };
    l.s = p, l.f = d;
    var y = {
      name: "ru",
