import { a as m } from "./XProvider-DCnZmHeL.js";
import { i as $ } from "./config-provider-BQ7E8_YL.js";
import { z as p, a as d, b as f, c as u } from "./zh_TW-CNZTcUuu.js";
function b(o, s) {
  for (var i = 0; i < s.length; i++) {
    ...
    if (typeof l != "string" && !Array.isArray(l)) {
      for (const a in l)
        if (a !== "default" && !(a in o)) {
          const n = Object.getOwnPropertyDescriptor(l, a);
...
t.default = void 0;
var T = r(p), h = r(d), x = r(f), g = r(u);
const e = "${label}不是一個有效的${type}", _ = {
  locale: "zh-tw",
...
t.default = _;
var c = t;
const v = /* @__PURE__ */ m(c), P = /* @__PURE__ */ b({
  __proto__: null,
  default: v
}, [c]);
export {
