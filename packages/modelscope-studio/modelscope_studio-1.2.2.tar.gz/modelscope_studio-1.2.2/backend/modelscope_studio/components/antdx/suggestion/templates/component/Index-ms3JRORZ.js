...
var he = K(C, "DataView"), be = K(C, "Promise"), ye = K(C, "Set"), Ye = "[object Map]", Ri = "[object Object]", Ze = "[object Promise]", We = "[object Set]", Qe = "[object WeakMap]", Ve = "[object DataView]", Li = N(he), Di = N(J), Ni = N(be), Ki = N(ye), Ui = N(de), $ = D;
...
function va(e, t, n, r, i, o) {
  ...
  return f ? (o || (o = new x()), ba(e, t, n, r, i, o)) : !1;
}
...
function Rs(e) {
  ...
  return {
    ...
    p(i, [o]) {
      ...
      2 && G(r, 1)) : (r = ct(i), r.c(), G(r, 1), r.m(t.parentNode, t)) : r && (Ps(), X(r, 1, 1, () => {
        r = null;
      }), _s());
    },
    i(i) {
...
function Ls(e, t, n) {
  ...
  const g = Za(() => import("./suggestion-BViaSobV.js"));
  let {
    gradio: _
  } = t, {
    props: f = {}
  ...
  return pe(e, Me, (h) => n(2, s = h)), e.$$set = (h) => {
    t = me(me({}, t), vs(h)), n(19, i = ft(t, r)), "gradio" in h && n(7, _ = h.gradio), "props" in h && n(8, f = h.props), "_internal" in h && n(9, d = h._internal), "items" in h && n(0, b = h.items), "as_item" in h && n(10, p = h.as_item), "visible" in h && n(11, v = h.visible), "elem_id" in h && n(12, T = h.elem_id), "elem_classes" in h && n(13, w = h.elem_classes), "elem_style" in h && n(14, S = h.elem_style), "$$scope" in h && n(17, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && c.update((h) => ({
      ...h,
  ...
  }, [b, a, s, g, c, j, Me, _, f, d, p, v, T, w, S, o, u, l];
}
class Ks extends ds {
  constructor(t) {
