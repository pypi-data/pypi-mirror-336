var gt = typeof global == "object" && global && global.Object === Object && global, kt = typeof self == "object" && self && self.Object === Object && self, E = gt || kt || Function("return this")(), w = E.Symbol, dt = Object.prototype, en = dt.hasOwnProperty, tn = dt.toString, z = w ? w.toStringTag : void 0;
function nn(e) {
...
var bn = /[\\^$.*+?()[\]{}|]/g, yn = /^\[object .+?Constructor\]$/, mn = Function.prototype, vn = Object.prototype, Tn = mn.toString, Pn = vn.hasOwnProperty, On = RegExp("^" + Tn.call(Pn).replace(bn, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$");
function wn(e) {
  if (!Y(e) || dn(e))
    return !1;
  var t = yt(e) ? On : yn;
...
var Ot = Object.prototype, qn = Ot.hasOwnProperty, Jn = Ot.propertyIsEnumerable, we = Ue(/* @__PURE__ */ function() {
  return arguments;
}()) ? Ue : function(e) {
...
}(), ze = B && B.isTypedArray, $t = ze ? Ae(ze) : vr, Pr = Object.prototype, Or = Pr.hasOwnProperty;
function St(e, t) {
  var n = S(e), r = !n && we(e), i = !n && !r && te(e), o = !n && !r && !i && $t(e), a = n || r || i || o, s = a ? zn(e.length, String) : [], u = s.length;
  for (var l in e)
...
var he = K(E, "DataView"), be = K(E, "Promise"), ye = K(E, "Set"), Ze = "[object Map]", Li = "[object Object]", We = "[object Promise]", Qe = "[object Set]", Ve = "[object WeakMap]", ke = "[object DataView]", Di = N(he), Ni = N(J), Ki = N(be), Ui = N(ye), Gi = N(de), $ = D;
...
var rt = B && B.isSet, Po = rt ? Ae(rt) : To, Lt = "[object Arguments]", Oo = "[object Array]", wo = "[object Boolean]", Ao = "[object Date]", $o = "[object Error]", Dt = "[object Function]", So = "[object GeneratorFunction]", xo = "[object Map]", Co = "[object Number]", Nt = "[object Object]", jo = "[object RegExp]", Eo = "[object Set]", Io = "[object String]", Mo = "[object Symbol]", Fo = "[object WeakMap]", Ro = "[object ArrayBuffer]", Lo = "[object DataView]", Do = "[object Float32Array]", No = "[object Float64Array]", Ko = "[object Int8Array]", Uo = "[object Int16Array]", Go = "[object Int32Array]", Bo = "[object Uint8Array]", zo = "[object Uint8ClampedArray]", Ho = "[object Uint16Array]", qo = "[object Uint32Array]", b = {};
b[Lt] = b[Oo] = b[Ro] = b[Lo] = b[wo] = b[Ao] = b[Do] = b[No] = b[Ko] = b[Uo] = b[Go] = b[xo] = b[Co] = b[Nt] = b[jo] = b[Eo] = b[Io] = b[Mo] = b[Bo] = b[zo] = b[Ho] = b[qo] = !0;
b[$o] = b[Dt] = b[Fo] = !1;
...
var ta = 1, na = 2, ra = "[object Boolean]", ia = "[object Date]", oa = "[object Error]", aa = "[object Map]", sa = "[object Number]", ua = "[object RegExp]", la = "[object Set]", fa = "[object String]", ca = "[object Symbol]", pa = "[object ArrayBuffer]", ga = "[object DataView]", it = w ? w.prototype : void 0, ce = it ? it.valueOf : void 0;
...
function wa(e, t, n, r) {
  ...
  for (; ++i < o; ) {
    ...
    if (a[2]) {
      ...
      var g = new j(), h;
      if (!(h === void 0 ? Ie(l, u, Pa | Oa, r, g) : h))
        return !1;
    }
  }
  return !0;
...
function Ms(e) {
  ...
  e[21]({
    ...
    p(o, a) {
      const s = a & /*$mergedProps, root, proxy_url, $slots*/
      15 ? ws(r, [a & /*$mergedProps*/
      4 && {
        style: (
          /*$mergedProps*/
          o[2].elem_style
...
function Ds(e, t, n) {
  ...
  const g = Wa(() => import("./attachments.file-card-Dm6mPKIO.js"));
  let {
    gradio: h
  } = t, {
    root: f
  ...
  }, [f, c, a, s, g, y, Me, Fe, h, d, p, v, T, O, x, A, o, u, l];
}
class Us extends _s {
  constructor(t) {
