import { w as m, g as G, j as M } from "./Item-Cb7lLwE7.js";
...
function le(n) {
  ...
  return {
    ...
    p(t, [i]) {
      ...
      16 && b(e, 1)) : (e = S(t), e.c(), b(e, 1), e.m(r.parentNode, r)) : e && (X(), I(e, 1, 1, () => {
        e = null;
      }), U());
    },
    i(t) {
...
function re(n, s, l) {
  ...
  const f = m();
  x(n, f, (a) => l(1, o = a));
  const w = [], A = se("$$ms-gr-react-wrapper"), {
    slotKey: H,
    slotIndex: K,
    subSlotIndex: O
  } = G() || {}, q = c({
    ...
    const o = m(), e = new ae({
      ...
      props: {
        svelteInit(t) {
          ...
          return c.nodes = [...c.nodes, i], R({
            createPortal: h,
            node: g
          }), t.onDestroy(() => {
            c.nodes = c.nodes.filter((_) => _.svelteInstance !== o), R({
              createPortal: h,
              node: g
            });
          }), i;
