...
import { i, o as b, c as k } from "./config-provider-BQ7E8_YL.js";
function y(m, c) {
  for (var f = 0; f < c.length; f++) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const r in a)
        if (r !== "default" && !(r in m)) {
          const v = Object.getOwnPropertyDescriptor(a, r);
          v && Object.defineProperty(m, r, v.get ? v : {
            enumerable: !0,
            get: () => a[r]
          });
        }
...
n.default = void 0;
var O = d(o), D = d(s), Y = d(t), H = d(l);
const e = "${label} er ekki gilt ${type}", N = {
  locale: "is",
...
n.default = N;
var _ = n;
const w = /* @__PURE__ */ $(_), q = /* @__PURE__ */ y({
  __proto__: null,
  default: w
}, [_]);
export {
