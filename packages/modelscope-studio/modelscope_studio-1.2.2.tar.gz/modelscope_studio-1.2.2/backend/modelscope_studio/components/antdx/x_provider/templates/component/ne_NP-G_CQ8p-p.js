...
import { i as p, e as d, a as $, b as u, d as f } from "./config-provider-BQ7E8_YL.js";
function b(n, s) {
...
t.default = void 0;
var g = r(d), x = r($), _ = r(u), v = r(f);
const e = "${label} यो एक मान्य ${type} होइन", y = {
  locale: "ne-np",
...
t.default = y;
var c = t;
const P = /* @__PURE__ */ m(c), S = /* @__PURE__ */ b({
  __proto__: null,
  default: P
}, [c]);
export {
