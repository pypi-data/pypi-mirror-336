...
function ma(e, t, n, r, i, o) {
  ...
  return c ? (o || (o = new S()), ba(e, t, n, r, i, o)) : !1;
}
...
function Rs(e, t, n) {
  ...
  const g = Ya(() => import("./prompts-2Iw8O8zI.js"));
  let {
    gradio: _
  } = t, {
    props: c = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), ms(b)), n(18, i = ct(t, r)), "gradio" in b && n(6, _ = b.gradio), "props" in b && n(7, c = b.props), "_internal" in b && n(8, d = b._internal), "as_item" in b && n(9, h = b.as_item), "visible" in b && n(10, p = b.visible), "elem_id" in b && n(11, v = b.elem_id), "elem_classes" in b && n(12, T = b.elem_classes), "elem_style" in b && n(13, O = b.elem_style), "$$scope" in b && n(16, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    128 && f.update((b) => ({
      ...b,
  ...
  }, [a, s, g, f, I, Me, _, c, d, h, p, v, T, O, o, u, l];
}
class Ns extends gs {
  constructor(t) {
