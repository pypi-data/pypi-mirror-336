...
function Ns(e, t, n) {
  ...
  const g = Za(() => import("./bubble-Bj0dh3Px.js"));
  let {
    gradio: _
  } = t, {
    props: f = {}
  ...
  return pe(e, Me, (b) => n(1, s = b)), e.$$set = (b) => {
    t = me(me({}, t), Ps(b)), n(19, i = ft(t, r)), "gradio" in b && n(7, _ = b.gradio), "props" in b && n(8, f = b.props), "_internal" in b && n(9, d = b._internal), "as_item" in b && n(10, h = b.as_item), "visible" in b && n(11, p = b.visible), "elem_id" in b && n(12, v = b.elem_id), "elem_classes" in b && n(13, T = b.elem_classes), "elem_style" in b && n(14, w = b.elem_style), "$$scope" in b && n(17, l = b.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    256 && c.update((b) => ({
      ...b,
  ...
  }, [a, s, g, c, M, Qt, Me, _, f, d, h, p, v, T, w, o, u, l];
}
class Gs extends bs {
  constructor(t) {
