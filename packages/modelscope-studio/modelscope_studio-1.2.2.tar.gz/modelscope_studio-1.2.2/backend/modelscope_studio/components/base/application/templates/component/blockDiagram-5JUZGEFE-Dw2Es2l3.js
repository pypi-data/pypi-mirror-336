import { _ as d, E as at, d as R, e as de, l as L, y as ge, A as ue, c as z, ah as pe, Q as fe, R as xe, ai as Z, aj as Yt, ak as ye, u as tt, k as be, al as we, am as xt, an as me, i as Tt } from "./mermaid.core-mH_T8-GP.js";
import { c as Le } from "./clone-BSRH2tc4.js";
import { G as Se } from "./graph-CgN_eKj8.js";
import { c as ve } from "./channel-Dq92jSU9.js";
var yt = function() {
  var e = /* @__PURE__ */ d(function(N, x, g, u) {
    ...
    performAction: /* @__PURE__ */ d(function(x, g, u, w, S, c, _) {
      ...
      switch (S) {
        ...
        case 13:
          ...
          break;
        case 14:
          w.getLogger().debug("Rule: link: ", c[p], x), this.$ = {
            edgeTypeStr: c[p],
            label: ""
          };
          break;
        case 15:
          w.getLogger().debug("Rule: LABEL link: ", c[p - 3], c[p - 1], c[p]), this.$ = {
            edgeTypeStr: c[p],
            label: c[p - 1]
          };
          break;
        ...
        case 23:
          ...
          this.$ = [{
            ...
            label: c[p - 1].label,
            type: "edge",
            directions: c[p].directions,
            arrowTypeEnd: X,
            arrowTypeStart: "arrow_open"
          }, {
            id: c[p].id,
            label: c[p].label,
            type: w.typeStr2Type(c[p].typeStr),
            directions: c[p].directions
          }];
          break;
        case 24:
          w.getLogger().debug("Rule: nodeStatement (abc88 node size) ", c[p - 1], c[p]), this.$ = {
            id: c[p - 1].id,
            label: c[p - 1].label,
            type: w.typeStr2Type(c[p - 1].typeStr),
            directions: c[p - 1].directions,
            widthInColumns: parseInt(c[p], 10)
          };
          break;
        case 25:
          w.getLogger().debug("Rule: nodeStatement (node) ", c[p]), this.$ = {
            id: c[p].id,
            label: c[p].label,
            type: w.typeStr2Type(c[p].typeStr),
            directions: c[p].directions,
          ...
          break;
        case 26:
          w.getLogger().debug("APA123", this ? this : "na"), w.getLogger().debug("COLUMNS: ", c[p]), this.$ = {
            type: "column-setting",
            columns: c[p] === "auto" ? -1 : parseInt(c[p])
          };
          break;
        case 27:
          w.getLogger().debug("Rule: id-block statement : ", c[p - 2], c[p - 1]), w.generateId(), this.$ = {
            ...c[p - 2],
            type: "composite",
            children: c[p - 1]
          };
        ...
        case 28:
          ...
          break;
        case 29:
          w.getLogger().debug("Rule: node (NODE_ID separator): ", c[p]), this.$ = {
            id: c[p]
          };
          break;
        case 30:
          w.getLogger().debug("Rule: node (NODE_ID nodeShapeNLabel separator): ", c[p - 1], c[p]), this.$ = {
            id: c[p - 1],
            label: c[p].label,
            typeStr: c[p].typeStr,
            directions: c[p].directions
        ...
        case 32:
          ...
          break;
        case 33:
          w.getLogger().debug("Rule: nodeShapeNLabel: ", c[p - 2], c[p - 1], c[p]), this.$ = {
            typeStr: c[p - 2] + c[p],
            label: c[p - 1]
          };
          break;
        case 34:
          w.getLogger().debug("Rule: BLOCK_ARROW nodeShapeNLabel: ", c[p - 3], c[p - 2], " #3:", c[p - 1], c[p]), this.$ = {
            typeStr: c[p - 3] + c[p],
            label: c[p - 2],
            directions: c[p - 1]
          };
    ...
    table: [{
      ...
      15: y,
      16: b
    }), e(h, [2, 17]), e(h, [2, 18]), e(h, [2, 19]), e(h, [2, 20]), e(h, [2, 21]), e(h, [2, 22]), e(m, [2, 25], {
      27: [1, 25]
    }), e(h, [2, 26]), {
      19: 26,
      26: 12,
      ...
      30: [1, 46]
    }, e(h, [2, 28]), e(h, [2, 35]), e(h, [2, 36]), e(h, [2, 37]), e(h, [2, 38]), {
      37: [1, 47]
    }, {
      34: 48,
      35: D
    ...
    parse: /* @__PURE__ */ d(function(x) {
      var g = this, u = [0], w = [], S = [null], c = [], _ = this.table, p = "", A = 0, O = 0, X = 2, W = 1, ce = c.slice.call(arguments, 1), M = Object.create(this.lexer), J = {
        yy: {}
      };
...
Expecting ` + it.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : ft = "Parse error on line " + (A + 1) + ": Unexpected " + (Y == W ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(ft, {
        ...
        switch (U[0]) {
          ...
          case 2:
            ...
            }, oe && ($._$.range = [c[c.length - (q || 1)].range[0], c[c.length - 1].range[1]]), pt = this.performAction.apply($, [p, O, A, J.yy, U[1], S, c].concat(ce)), typeof pt < "u")
              return pt;
...
var Ee = yt, V = /* @__PURE__ */ new Map(), St = [], bt = /* @__PURE__ */ new Map(), Ct = "color", Bt = "fill", _e = "bgFill", Ht = ",", ke = z(), ct = /* @__PURE__ */ new Map(), De = /* @__PURE__ */ d((e) => be.sanitizeText(e, ke), "sanitizeText"), Ne = /* @__PURE__ */ d(function(e, t = "") {
  ...
  r || (r = {
    ...
    styles: [],
    textStyles: []
  }, ct.set(e, r)), t != null && t.split(Ht).forEach((n) => {
  ...
  t.children = n;
}, "populateBlockDatabase"), vt = [], rt = {
  id: "root",
  type: "composite",
  children: [],
  columns: -1
}, Be = /* @__PURE__ */ d(() => {
  L.debug("Clear called"), ge(), rt = {
    id: "root",
    type: "composite",
    children: [],
    columns: -1
  }, V = /* @__PURE__ */ new Map([["root", rt]]), vt = [], ct = /* @__PURE__ */ new Map(), St = [], bt = /* @__PURE__ */ new Map();
}, "clear");
function Xt(e) {
...
var sr = /* @__PURE__ */ d((e) => {
  ...
  for (const n of e.children) {
    ...
    L.debug("getMaxChildSize abc95 child:", n.id, "width:", i, "height:", a, "x:", s, "y:", l, n.type), n.type !== "space" && (i > t && (t = i / (e.widthInColumns ?? 1)), a > r && (r = a));
  }
  return {
    width: t,
    height: r
...
function ot(e, t, r = 0, n = 0) {
  ...
  L.debug("setBlockSizes abc95 (start)", e.id, (s = e == null ? void 0 : e.size) == null ? void 0 : s.x, "block width =", e == null ? void 0 : e.size, "sieblingWidth", r), (l = e == null ? void 0 : e.size) != null && l.width || (e.size = {
    width: r,
    height: n,
    x: 0,
    y: 0
  ...
  if (((o = e.children) == null ? void 0 : o.length) > 0) {
    ...
    for (const S of e.children)
      S.size && (L.debug(`abc95 Setting size of children of ${e.id} id=${S.id} ${i} ${a} ${JSON.stringify(S.size)}`), S.size.width = i * (S.widthInColumns ?? 1) + I * ((S.widthInColumns ?? 1) - 1), S.size.height = a, S.size.x = 0, S.size.y = 0, L.debug(`abc95 updating size of ${e.id} children child:${S.id} maxWidth:${i} maxHeight:${a}`));
    for (const S of e.children)
      ot(S, t, i, a);
    const k = e.columns ?? -1;
    let N = 0;
    ...
    if (u < r) {
      L.debug(`Detected to small siebling: abc95 ${e.id} sieblingWidth ${r} sieblingHeight ${n} width ${u}`), u = r, w = n;
    ...
    if (L.debug(`abc95 (finale calc) ${e.id} xSize ${x} ySize ${g} columns ${k}${e.children.length} width=${Math.max(u, ((f = e.size) == null ? void 0 : f.width) || 0)}`), u < (((h = e == null ? void 0 : e.size) == null ? void 0 : h.width) || 0)) {
  ...
  L.debug("setBlockSizes abc94 (done)", e.id, (m = e == null ? void 0 : e.size) == null ? void 0 : m.x, (E = e == null ? void 0 : e.size) == null ? void 0 : E.width, (D = e == null ? void 0 : e.size) == null ? void 0 : D.y, (v = e == null ? void 0 : e.size) == null ? void 0 : v.height);
}
d(ot, "setBlockSizes");
function Et(e, t) {
  var n, i, a, s, l, o, f, h, y, b, m, E, D, v, T, k, N;
  L.debug(`abc85 layout blocks (=>layoutBlocks) ${e.id} x: ${(n = e == null ? void 0 : e.size) == null ? void 0 : n.x} y: ${(i = e == null ? void 0 : e.size) == null ? void 0 : i.y} width: ${(a = e == null ? void 0 : e.size) == null ? void 0 : a.width}`);
  const r = e.columns ?? -1;
...
var ir = /* @__PURE__ */ d((e, t, r, n) => {
  ...
  const r = z(), n = Z(r.flowchart.htmlLabels), i = t.labelType === "markdown" ? Yt(e, t.label, {
    style: t.labelStyle,
    useHtmlLabels: n,
    addSvgBackground: !0
  }, r) : j(t.label, t.labelStyle), a = e.insert("g").attr("class", "edgeLabel"), s = a.insert("g").attr("class", "label");
...
var or = /* @__PURE__ */ d((e, t) => {
  ...
  if (e.label) {
    ...
    if (r) {
      ...
      L.debug("Moving label " + e.label + " from (", s, ",", l, ") to (", o.x, ",", o.y, ") abc88"), t.updatedPath && (s = o.x, l = o.y);
    }
  ...
  if (e.startLabelRight) {
    ...
    let s = e.x, l = e.y;
    if (r) {
      const o = tt.calcTerminalLabelPosition(e.arrowTypeStart ? 10 : 0, "start_right", r);
      s = o.x, l = o.y;
    }
    a.attr("transform", `translate(${s}, ${l})`);
  }
  ...
  if (Math.abs(i - t.y) * s > Math.abs(n - t.x) * o) {
    ...
    return L.debug(`sides calc abc89, Q ${f}, q ${y}, R ${h}, r ${l}`, {
      _x: b,
      _y: m
    }), l === 0 && (b = t.x, m = t.y), h === 0 && (b = t.x), f === 0 && (m = t.y), {
      x: b,
      y: m
    };
  }
...
function te(e, t, r, n) {
  ...
  if (i = t.y - e.y, s = e.x - t.x, o = t.x * e.y - e.x * t.y, b = i * r.x + s * r.y + o, m = i * n.x + s * n.y + o, !(b !== 0 && m !== 0 && Lt(b, m)) && (a = n.y - r.y, l = r.x - n.x, f = n.x * r.y - r.x * n.y, h = a * e.x + l * e.y + f, y = a * t.x + l * t.y + f, !(h !== 0 && y !== 0 && Lt(h, y)) && (E = i * l - a * s, E !== 0)))
    return D = Math.abs(E / 2), v = s * f - l * o, T = v < 0 ? (v - D) / E : (v + D) / E, v = a * o - i * f, k = v < 0 ? (v - D) / E : (v + D) / E, {
      x: T,
      y: k
    };
}
...
function ee(e, t, r) {
  ...
  for (var o = n - e.width / 2 - s, f = i - e.height / 2 - l, h = 0; h < t.length; h++) {
    var y = t[h], b = t[h < t.length - 1 ? h + 1 : 0], m = yr(e, r, {
      x: o + y.x,
      y: f + y.y
    }, {
      x: o + b.x,
...
var wr = /* @__PURE__ */ d((e, t) => {
  ...
  return Math.abs(a) * s > Math.abs(i) * l ? (a < 0 && (l = -l), o = a === 0 ? 0 : l * i / a, f = l) : (i < 0 && (s = -s), o = s, f = i === 0 ? 0 : s * a / i), {
    x: r + o,
    y: n + f
  };
  ...
  const h = o.node();
  let y;
  t.labelType === "markdown" ? y = Yt(o, Tt(xt(f), i), {
    useHtmlLabels: s,
    width: t.width || i.flowchart.wrappingWidth,
    classes: "markdown-node-label"
  }, i) : y = h.appendChild(j(Tt(xt(f), i), t.labelStyle, !1, n));
  let b = y.getBBox();
  const m = t.padding / 2;
  ...
  return s ? o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")") : o.attr("transform", "translate(0, " + -b.height / 2 + ")"), t.centerLabel && o.attr("transform", "translate(" + -b.width / 2 + ", " + -b.height / 2 + ")"), o.insert("rect", ":first-child"), {
    shapeSvg: l,
    bbox: b,
    halfPadding: m,
    label: o
...
function G(e, t, r, n) {
  return e.insert("polygon", ":first-child").attr("points", n.map(function(i) {
    return i.x + "," + i.y;
...
var Lr = /* @__PURE__ */ d(async (e, t) => {
...
}, "note"), Sr = Lr, zt = /* @__PURE__ */ d((e) => e ? " " + e : "", "formatClass"), K = /* @__PURE__ */ d((e, t) => `${t || "node default"}${zt(e.classes)} ${zt(e.class)}`, "getClassesFromNode"), At = /* @__PURE__ */ d(async (e, t) => {
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, K(t, void 0), !0), i = n.width + t.padding, a = n.height + t.padding, s = i + a, l = [{
    x: s / 2,
    y: 0
  }, {
    x: s,
  ...
  return r.insert("polygon", ":first-child").attr("points", i.map(function(s) {
    return s.x + "," + s.y;
  }).join(" ")).attr("class", "state-start").attr("r", 7).attr("width", 28).attr("height", 28), t.width = 28, t.height = 28, t.intersect = function(s) {
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, K(t, void 0), !0), i = 4, a = n.height + t.padding, s = a / i, l = n.width + 2 * s + t.padding, o = [{
    x: s,
    y: 0
  }, {
    x: l - s,
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, void 0, !0), i = 2, a = n.height + 2 * t.padding, s = a / i, l = n.width + 2 * s + t.padding, o = pr(t.directions, n, t), f = G(r, l, a, o);
  return f.attr("style", t.style), B(t, f), t.intersect = function(h) {
    return C.polygon(t, o, h);
  }, r;
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, K(t, void 0), !0), i = n.width + t.padding, a = n.height + t.padding, s = [{
    x: -a / 2,
    y: 0
  }, {
    x: i,
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, K(t), !0), i = n.width + t.padding, a = n.height + t.padding, s = [{
    x: -2 * a / 6,
    y: 0
  }, {
    x: i - a / 6,
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, K(t, void 0), !0), i = n.width + t.padding, a = i / 2, s = a / (2.5 + i / 50), l = n.height + s + t.padding, o = "M 0," + s + " a " + a + "," + s + " 0,0,0 " + i + " 0 a " + a + "," + s + " 0,0,0 " + -i + " 0 l 0," + l + " a " + a + "," + s + " 0,0,0 " + i + " 0 l 0," + -l, f = r.attr("label-offset-y", s).insert("path", ":first-child").attr("style", t.style).attr("d", o).attr("transform", "translate(" + -i / 2 + "," + -(l / 2 + s) + ")");
  ...
  const {
    ...
    bbox: n,
    halfPadding: i
  } = await F(e, t, "node " + t.classes + " " + t.class, !0), a = r.insert("rect", ":first-child"), s = t.positioned ? t.width : n.width + t.padding, l = t.positioned ? t.height : n.height + t.padding, o = t.positioned ? -s / 2 : -n.width / 2 - i, f = t.positioned ? -l / 2 : -n.height / 2 - i;
  ...
  const {
    ...
    bbox: n,
    halfPadding: i
  } = await F(e, t, "node " + t.classes, !0), a = r.insert("rect", ":first-child"), s = t.positioned ? t.width : n.width + t.padding, l = t.positioned ? t.height : n.height + t.padding, o = t.positioned ? -s / 2 : -n.width / 2 - i, f = t.positioned ? -l / 2 : -n.height / 2 - i;
...
var Ar = /* @__PURE__ */ d((e, t) => {
  ...
  let b = f.getBBox();
  const m = s.node().appendChild(j(y.join ? y.join("<br/>") : y, t.labelStyle, !0, !0));
  if (Z(z().flowchart.htmlLabels)) {
    const D = m.children[0], v = R(m);
    h = D.getBoundingClientRect(), v.attr("width", h.width), v.attr("height", h.height);
  }
  const E = t.padding / 2;
  return R(m).attr("transform", "translate( " + // (titleBox.width - bbox.width) / 2 +
  (h.width > b.width ? 0 : (b.width - h.width) / 2) + ", " + (b.height + E + 5) + ")"), R(f).attr("transform", "translate( " + // (titleBox.width - bbox.width) / 2 +
  (h.width < b.width ? 0 : -(b.width - h.width) / 2) + ", 0)"), h = s.node().getBBox(), s.attr("transform", "translate(" + -h.width / 2 + ", " + (-h.height / 2 - E + 3) + ")"), i.attr("class", "outer title-state").attr("x", -h.width / 2 - E).attr("y", -h.height / 2 - E).attr("width", h.width + t.padding).attr("height", h.height + t.padding), a.attr("class", "divider").attr("x1", -h.width / 2 - E).attr("x2", h.width / 2 + E).attr("y1", -h.height / 2 - E + b.height + E).attr("y2", -h.height / 2 - E + b.height + E), B(t, i), t.intersect = function(D) {
    return C.rect(t, D);
  }, n;
  ...
  const {
    shapeSvg: r,
    bbox: n
  } = await F(e, t, K(t, void 0), !0), i = n.height + t.padding, a = n.width + i / 4 + t.padding, s = r.insert("rect", ":first-child").attr("style", t.style).attr("rx", i / 2).attr("ry", i / 2).attr("x", -a / 2).attr("y", -i / 2).attr("width", a).attr("height", i);
  ...
  const {
    ...
    bbox: n,
    halfPadding: i
  } = await F(e, t, K(t, void 0), !0), a = r.insert("circle", ":first-child");
  ...
  const {
    ...
    bbox: n,
    halfPadding: i
  } = await F(e, t, K(t, void 0), !0), a = 5, s = r.insert("g", ":first-child"), l = s.insert("circle"), o = s.insert("circle");
  ...
  t.classData.members.forEach((c) => {
    ...
    const A = b.node().appendChild(j(p, _.cssStyle ? _.cssStyle : t.labelStyle, !0, !0));
    let O = A.getBBox();
    if (Z(z().flowchart.htmlLabels)) {
  ...
  if (t.classData.methods.forEach((c) => {
    ...
    let c = (h - T.width) / 2;
    R(v).attr("transform", "translate( " + (-1 * h / 2 + c) + ", " + -1 * y / 2 + ")"), m = T.height + n;
  }
  let w = (h - x.width) / 2;
  return R(N).attr("transform", "translate( " + (-1 * h / 2 + w) + ", " + (-1 * y / 2 + m) + ")"), m += x.height + n, o.attr("class", "divider").attr("x1", -h / 2 - r).attr("x2", h / 2 + r).attr("y1", -y / 2 - r + i + m).attr("y2", -y / 2 - r + i + m), m += i, g.forEach((c) => {
    R(c).attr("transform", "translate( " + -h / 2 + ", " + (-1 * y / 2 + m + i / 2) + ")");
    ...
    R(c).attr("transform", "translate( " + -h / 2 + ", " + (-1 * y / 2 + m) + ")");
    const _ = c == null ? void 0 : c.getBBox();
    m += ((_ == null ? void 0 : _.height) ?? 0) + n;
  ...
  return e.clusterNode ? t.attr("transform", "translate(" + (e.x + n - e.width / 2) + ", " + (e.y - e.height / 2 - r) + ")") : t.attr("transform", "translate(" + e.x + ", " + e.y + ")"), n;
}, "positionNode");
function kt(e, t, r = !1) {
  var b, m, E;
  const n = e;
  ...
  const o = me((n == null ? void 0 : n.styles) ?? []), f = n.label, h = n.size ?? {
    width: 0,
    height: 0,
    x: 0,
    y: 0
...
async function ae(e, t, r) {
  ...
  if (n.type === "group")
    return;
  const i = at(), a = await re(e, n, {
    config: i
  }), s = a.node().getBBox(), l = r.getBlock(n.id);
  l.size = {
    width: s.width,
    height: s.height,
    x: 0,
...
async function se(e, t, r) {
  ...
  if (r.getBlock(n.id).type !== "space") {
    ...
    await re(e, n, {
      config: a
    }), t.intersect = n == null ? void 0 : n.intersect, Xr(n);
  }
}
  ...
  for (const s of t)
    if (s.start && s.end) {
      ...
      if (l != null && l.size && (o != null && o.size)) {
        ...
        }, void 0, "block", a, i), s.label && (await cr(e, {
          ...s,
          label: s.label,
...
var Ur = /* @__PURE__ */ d(function(e, t) {
  ...
  if (await ne(E, y, s), await le(E, m, b, s, t), D) {
    const v = D, T = Math.max(1, Math.round(0.125 * (v.width / v.height))), k = v.height + T + 10, N = v.width + 10, {
      useMaxWidth: x
    } = a;
    de(f, k, N, !!x), L.debug("Here Bounds", D, v), f.attr("viewBox", `${v.x - 5} ${v.y - 5} ${v.width + 10} ${v.height + 10}`);
  }
}, "draw"), Vr = {
  draw: jr,
  getClasses: Ur
