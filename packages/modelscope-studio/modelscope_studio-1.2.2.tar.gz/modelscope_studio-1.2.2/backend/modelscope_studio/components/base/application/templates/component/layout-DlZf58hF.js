import { G as g } from "./graph-CgN_eKj8.js";
import { e as ce, a as f, f as C, v as x, r as I } from "./_baseUniq-DNOanyeu.js";
import { b as le, a as Te, c as Me, d as Ie, t as j, m as w, e as N, h as he, f as z, g as Se } from "./_basePickBy-CYTwJ2aT.js";
import { aH as $, az as Fe, aU as q } from "./mermaid.core-mH_T8-GP.js";
import { b as je, L as Ve, j as Ae, x as ve, n as U, M as Be, r as pe, f as ee, o as V, p as we, w as Ge, N as Ye, O as De, P as $e, a as qe, Q as We, v as ze, R as _, c as Ue, i as m, T } from "./Index-XtzQEp5R.js";
var Xe = 1, He = 4;
function Je(e) {
  return je(e, Xe | He);
}
function Qe(e, n) {
  return e == null ? e : Ve(e, ce(n), Ae);
}
function Ze(e, n) {
  return e && ve(e, ce(n));
}
...
function S(e, n) {
  var r = {};
  return n = U(n), ve(e, function(t, a, i) {
    Be(r, a, n(t, a, i));
  }), r;
}
function y(e) {
  return e && e.length ? le(e, pe, Ke) : void 0;
}
function X(e, n) {
  return e && e.length ? le(e, U(n), Te) : void 0;
}
function en(e, n) {
  var r = e.length;
  for (e.sort(n); r--; )
...
function tn(e, n, r) {
  n.length ? n = V(n, function(i) {
    return we(i) ? function(o) {
      return Ge(o, i.length === 1 ? i[0] : i);
    } : i;
  }) : n = [pe];
  var t = -1;
  n = V(n, Ye(U));
  var a = Me(e, function(i, o, u) {
  ...
  return en(a, function(i, o) {
    return rn(i, o, r);
  });
}
function an(e, n) {
  return Ie(e, n, function(r, t) {
    return De(e, t);
  });
}
var M = $e(function(e, n) {
  return e == null ? {} : an(e, n);
}), on = Math.ceil, un = Math.max;
function dn(e, n, r, t) {
  for (var a = -1, i = un(on((n - e) / (r || 1)), 0), o = Array(i); i--; )
    o[++a] = e, e += r;
  return o;
}
function sn(e) {
  return function(n, r, t) {
    return t && typeof t != "number" && $(n, r, t) && (r = t = void 0), n = j(n), r === void 0 ? (r = n, n = 0) : r = j(r), t = t === void 0 ? n < r ? 1 : -1 : j(t), dn(n, r, t);
  };
}
var E = sn(), R = Fe(function(e, n) {
  if (e == null)
    return [];
  var r = n.length;
  return r > 1 && $(e, n[0], n[1]) ? n = [] : r > 2 && $(n[0], n[1], n[2]) && (n = [n[0]]), tn(e, qe(n), []);
}), fn = 0;
function H(e) {
  var n = ++fn;
  return We(e) + n;
...
class hn {
  ...
  toString() {
    for (var n = [], r = this._sentinel, t = r._prev; t !== r; )
      n.push(JSON.stringify(t, vn)), t = t._prev;
    return "[" + n.join(", ") + "]";
  }
}
function ne(e) {
...
function wn(e, n) {
  if (e.nodeCount() <= 1)
    return [];
  var r = mn(e, n || pn), t = bn(r.graph, r.buckets, r.zeroIdx);
  return _(w(t, function(a) {
...
function gn(e) {
  var n = e.graph().acyclicer === "greedy" ? wn(e, r(e)) : yn(e);
  f(n, function(t) {
    var a = e.edge(t);
...
function re(e, n) {
  ...
  var d, s;
  return Math.abs(i) * o > Math.abs(a) * u ? (i < 0 && (u = -u), d = u * a / i, s = u) : (a < 0 && (o = -o), d = o, s = o * i / a), {
    x: r + d,
    y: t + s
  };
}
...
function te(e, n, r, t) {
  ...
  return arguments.length >= 4 && (a.rank = r, a.order = t), O(e, "border", a, n);
}
function me(e) {
  return y(w(e.nodes(), function(n) {
    var r = e.node(n).rank;
    if (!m(r))
      return r;
  }));
...
function ae(e, n, r, t, a, i) {
  var o = {
    ...
    rank: i,
    borderType: n
  }, u = a[n][i - 1], d = O(e, "border", o, r);
  a[n][i] = d, e.setParent(d, t), u && e.setEdge(u, d, {
    weight: 1
  });
}
function Cn(e) {
...
function _n(e) {
  var n = e.graph().rankdir.toLowerCase();
  (n === "bt" || n === "rl") && Rn(e), (n === "lr" || n === "rl") && (Tn(e), ge(e));
}
function ge(e) {
  ...
  if (i !== t + 1) {
    ...
    for (l = 0, ++t; t < i; ++l, ++t)
      u.points = [], s = {
        ...
        edgeObj: n,
        rank: t
      }, c = O(e, "edge", s, "_d"), t === d && (s.width = u.width, s.height = u.height, s.dummy = "edge-label", s.labelpos = u.labelpos), e.setEdge(r, c, {
        weight: u.weight
      }, o), l === 0 && e.graph().dummyChains.push(c), r = c;
    e.setEdge(r, a, {
      weight: u.weight
    }, o);
  }
...
function Sn(e) {
  f(e.graph().dummyChains, function(n) {
    ...
    for (e.setEdge(r.edgeObj, t); r.dummy; )
      a = e.successors(n)[0], e.removeNode(n), t.points.push({
        x: r.x,
        y: r.y
      }), r.dummy === "edge-label" && (t.x = r.x, t.y = r.y, t.width = r.width, t.height = r.height), n = a, r = e.node(n);
  });
}
function J(e) {
  var n = {};
  function r(t) {
    ...
    if (Object.prototype.hasOwnProperty.call(n, t))
      return a.rank;
    n[t] = !0;
    var i = N(w(e.outEdges(t), function(o) {
...
function ye(e) {
  var n = new g({
    directed: !1
  }), r = e.nodes()[0], t = e.nodeCount();
  n.setNode(r, {});
  for (var a, i; Fn(n, e) < t; )
    a = jn(n, e), i = n.hasNode(a.v) ? P(e, a) : -P(e, a), Vn(n, e, i);
  return n;
}
function Fn(e, n) {
  function r(t) {
...
function Pe(e, n, r, t) {
  var a = r.v, i = r.w;
  e.removeEdge(a, i), e.setEdge(t.v, t.w, {}), Z(e), Q(e, n), Dn(e, n);
}
function Dn(e, n) {
...
function Un(e) {
  var n = O(e, "root", {}, "_root"), r = Xn(e), t = y(x(r)) - 1, a = 2 * t + 1;
...
function nr(e, n, r) {
  for (var t = ln(r, w(r, function(s, c) {
    return c;
  })), a = _(w(n, function(s) {
    return R(w(e.outEdges(s), function(c) {
      return {
        pos: t[c.w],
...
function ir(e) {
  ...
  function r(i) {
    return function(o) {
      o.merged || (m(o.barycenter) || m(i.barycenter) || o.barycenter >= i.barycenter) && or(i, o);
    };
  }
  function t(i) {
    return function(o) {
...
function cr(e) {
  var n = me(e), r = se(e, E(1, n + 1), "inEdges"), t = se(e, E(n - 1, -1, -1), "outEdges"), a = rr(e);
  fe(e, a);
  for (var i = Number.POSITIVE_INFINITY, o, u = 0, d = 0; d < 4; ++u, ++d) {
    lr(u % 2 ? r : t, u % 4 >= 2), a = F(e);
    var s = er(e, a);
    s < i && (d = 0, o = Je(a), i = s);
  }
  fe(e, o);
...
function hr(e) {
  ...
  f(e.graph().dummyChains, function(r) {
    for (var t = e.node(r), a = t.edgeObj, i = vr(e, n, a.v, a.w), o = i.path, u = i.lca, d = 0, s = o[d], c = !0; r !== a.w; ) {
      if (t = e.node(r), c) {
...
function wr(e, n) {
  ...
  function t(a, i) {
    ...
    return f(i, function(c, l) {
      var h = mr(e, c), v = h ? e.node(h).order : d;
      (h || c === s) && (f(i.slice(u, l + 1), function(p) {
        f(e.predecessors(p), function(b) {
          var L = e.node(b), K = L.order;
          (K < o || v < K) && !(L.dummy && e.node(p).dummy) && Re(r, b, p);
        });
      }), u = l + 1, o = v);
    }), i;
  }
    ...
    f(u, function(s) {
      ...
      if (c.length) {
        ...
        for (var l = (c.length - 1) / 2, h = Math.floor(l), v = Math.ceil(l); h <= v; ++h) {
          var p = c[h];
          i[s] === s && d < o[p] && !gr(r, s, p) && (i[p] = s, i[s] = a[s] = a[p], d = o[p]);
        }
      }
    });
  }), {
...
function kr(e, n, r, t, a) {
  var i = {}, o = xr(e, n, r, a), u = a ? "borderLeft" : "borderRight";
  function d(l, h) {
...
function xr(e, n, r, t) {
  var a = new g(), i = e.graph(), o = Pr(i.nodesep, i.edgesep, t);
  return f(n, function(u) {
    var d;
    f(u, function(s) {
      var c = r[s];
...
function Nr(e) {
  var n = F(e), r = q(wr(e, n), br(e, n)), t = {}, a;
  f(["u", "d"], function(o) {
    a = o === "u" ? n : x(n).reverse(), f(["l", "r"], function(u) {
      u === "r" && (a = w(a, function(l) {
        return x(l).reverse();
      }));
      var d = (o === "u" ? e.predecessors : e.successors).bind(e), s = yr(e, a, r, d), c = kr(e, a, s.root, s.align, u === "r");
  ...
  var i = Er(e, t);
  return Or(t, i), Lr(t, e.graph().align);
}
function Pr(e, n, r) {
...
function it(e, n) {
  ...
  r("layout", () => {
    ...
    r("  runLayout", () => Tr(t, r)), r("  updateInputGraph", () => Mr(e, t));
  });
}
function Tr(e, n) {
  n("    makeSpaceForEdgeLabels", () => Dr(e)), n("    removeSelfEdges", () => Qr(e)), n("    acyclic", () => gn(e)), n("    nestingGraph.run", () => Un(e)), n("    rank", () => qn(be(e))), n("    injectEdgeLabelProxies", () => $r(e)), n("    removeEmptyRanks", () => On(e)), n("    nestingGraph.cleanup", () => Jn(e)), n("    normalizeRanks", () => En(e)), n("    assignRankMinMax", () => qr(e)), n("    removeEdgeLabelProxies", () => Wr(e)), n("    normalize.run", () => Mn(e)), n("    parentDummyChains", () => hr(e)), n("    addBorderSegments", () => Pn(e)), n("    order", () => cr(e)), n("    insertSelfEdges", () => Zr(e)), n("    adjustCoordinateSystem", () => Cn(e)), n("    position", () => _r(e)), n("    positionSelfEdges", () => Kr(e)), n("    removeBorderNodes", () => Jr(e)), n("    normalize.undo", () => Sn(e)), n("    fixupEdgeLabelCoords", () => Xr(e)), n("    undoCoordinateSystem", () => _n(e)), n("    translateGraph", () => zr(e)), n("    assignNodeIntersects", () => Ur(e)), n("    reversePoints", () => Hr(e)), n("    acyclic.undo", () => kn(e));
}
function Mr(e, n) {
  f(e.nodes(), function(r) {
...
var Ir = ["nodesep", "edgesep", "ranksep", "marginx", "marginy"], Sr = {
  ranksep: 50,
  edgesep: 20,
  nodesep: 50,
  rankdir: "tb"
}, Fr = ["acyclicer", "ranker", "rankdir", "align"], jr = ["width", "height"], Vr = {
  width: 0,
  height: 0
}, Ar = ["minlen", "weight", "width", "height", "labeloffset"], Br = {
  minlen: 1,
  weight: 1,
  width: 0,
  height: 0,
...
function Yr(e) {
  ...
  return n.setGraph(q({}, Sr, Y(r, Ir), M(r, Fr))), f(e.nodes(), function(t) {
    var a = D(e.node(t));
    n.setNode(t, Se(Y(a, jr), Vr)), n.setParent(t, e.parent(t));
  }), f(e.edges(), function(t) {
    var a = D(e.edge(t));
    n.setEdge(t, q({}, Br, Y(a, Ar), M(a, Gr)));
  }), n;
}
function Dr(e) {
  var n = e.graph();
...
function $r(e) {
  f(e.edges(), function(n) {
    var r = e.edge(n);
    if (r.width && r.height) {
      var t = e.node(n.v), a = e.node(n.w), i = {
        rank: (a.rank - t.rank) / 2 + t.rank,
        e: n
      };
      O(e, "edge-proxy", i, "_ep");
    }
  });
}
function qr(e) {
