import { _ as s, c as xt, l as T, d as U, U as kt, V as vt, W as _t, X as bt, B as wt, Y as St, y as Et } from "./mermaid.core-mH_T8-GP.js";
import { d as nt } from "./arc-1m85O0-3.js";
var X = function() {
  var n = /* @__PURE__ */ s(function(f, i, a, d) {
    ...
    table: [{
      ...
      20: g,
      21: m
    }, n(t, [2, 5]), n(t, [2, 6]), n(t, [2, 8]), {
      13: [1, 19]
    }, {
      15: [1, 20]
    }, n(t, [2, 11]), n(t, [2, 12]), n(t, [2, 13]), n(t, [2, 14]), n(t, [2, 15]), n(t, [2, 16]), n(t, [2, 4]), n(t, [2, 9]), n(t, [2, 10])],
    defaultActions: {},
    ...
    parse: /* @__PURE__ */ s(function(i) {
      var a = this, d = [0], u = [], y = [null], o = [], S = this.table, k = "", M = 0, P = 0, B = 2, J = 1, O = o.slice.call(arguments, 1), v = Object.create(this.lexer), E = {
        yy: {}
      };
...
Expecting ` + G.join(", ") + ", got '" + (this.terminals_[w] || w) + "'" : Q = "Parse error on line " + (M + 1) + ": Unexpected " + (w == J ? "end of input" : "'" + (this.terminals_[w] || w) + "'"), this.parseError(Q, {
        ...
        switch (N[0]) {
          ...
          case 2:
            ...
            }, A && (V._$.range = [o[o.length - ($ || 1)].range[0], o[o.length - 1].range[1]]), K = this.performAction.apply(V, [k, P, M, E.yy, N[1], y, o].concat(O)), typeof K < "u")
              return K;
...
var z = "", lt = 0, Y = [], q = [], W = [], ot = /* @__PURE__ */ s(() => St, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  ...
  r.x = t.x, r.y = t.y, r.fill = t.fill, r.width = e.width, r.height = e.height, r.class = "journey-section section-type-" + t.num, r.rx = 3, r.ry = 3, Z(l, r), mt(e)(t.text, l, r.x, r.y, r.width, r.height, {
  ...
  const c = D();
  c.x = t.x, c.y = t.y, c.fill = t.fill, c.width = e.width, c.height = e.height, c.class = "task task-type-" + t.num, c.rx = 3, c.ry = 3, Z(r, c), mt(e)(t.task, r, c.x, c.y, c.width, c.height, {
    class: "task"
  }, e, t.colour);
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  t.section = r, h.attr("class", (t.class ? t.class + " " : "") + "timeline-node " + ("section-" + r));
  ...
  for (const f of t) {
    ...
    if (T.debug("taskHeight after draw", u), a.attr("transform", `translate(${l}, ${r})`), h = Math.max(h, u), f.events) {
      ...
      let o = h;
      r += 100, o = o + Bt(n, f.events, e, l, r, c), r -= 100, y.append("line").attr("x1", l + 190 / 2).attr("y1", r + h).attr("x2", l + 190 / 2).attr("y2", r + h + (x ? h : p) + m + 120).attr("stroke-width", 2).attr("stroke", "black").attr("marker-end", "url(#arrowhead)").attr("stroke-dasharray", "5,5");
    }
