import { $ as ln, a0 as an, a1 as G, a2 as q, a3 as z, a4 as un, a5 as y, a6 as tn, a7 as K, a8 as _, a9 as rn, aa as o, ab as sn, ac as on, ad as fn } from "./mermaid.core-mH_T8-GP.js";
function cn(l) {
...
function V(l, h, I, D, v, A, B) {
  var a = l - I, O = h - D, i = (B ? A : -A) / K(a * a + O * O), n = i * O, d = -i * a, u = l + n, s = h + d, f = I + n, c = D + d, C = (u + f) / 2, t = (s + c) / 2, m = f - u, g = c - s, R = m * m + g * g, T = v - A, P = u * c - f * s, S = (g < 0 ? -1 : 1) * K(on(0, T * T * R - P * P)), $ = (P * g - m * S) / R, j = (-P * m - g * S) / R, w = (P * g + m * S) / R, p = (-P * m + g * S) / R, x = $ - C, e = j - t, r = w - C, F = p - t;
...
function hn() {
  ...
  function i() {
    var n, d, u = +l.apply(this, arguments), s = +h.apply(this, arguments), f = v.apply(this, arguments) - un, c = A.apply(this, arguments) - un, C = rn(c - f), t = c > f;
    if (a || (a = n = O()), s < u && (d = s, s = u, u = d), !(s > y)) a.moveTo(0, 0);
      ...
      var m = f, g = c, R = f, T = c, P = C, S = C, $ = B.apply(this, arguments) / 2, j = $ > y && (D ? +D.apply(this, arguments) : K(u * u + s * s)), w = _(rn(s - u) / 2, +I.apply(this, arguments)), p = w, x = w, e, r;
      if (j > y) {
      ...
      if (w > y) {
        ...
        if (C < an)
          if (E = pn(H, J, W, X, Q, U, M, N)) {
            var Y = H - E[0], Z = J - E[1], b = Q - E[0], k = U - E[1], nn = 1 / q(fn((Y * b + Z * k) / (K(Y * Y + Z * Z) * K(b * b + k * k))) / 2), en = K(E[0] * E[0] + E[1] * E[1]);
