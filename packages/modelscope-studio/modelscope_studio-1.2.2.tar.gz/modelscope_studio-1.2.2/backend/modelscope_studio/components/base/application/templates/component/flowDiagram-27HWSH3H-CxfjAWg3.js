import { _ as m, n as Ot, l as Z, c as G1, d as C1, o as Ht, r as qt, u as it, b as Xt, s as Qt, p as Jt, a as Zt, g as $t, q as te, k as ee, t as se, J as ie, v as re, x as st, y as ae, z as ne, A as ue } from "./mermaid.core-mH_T8-GP.js";
import { g as le, s as oe } from "./chunk-2O5F6CEG-BPykxt5C.js";
import { c as ce } from "./channel-Dq92jSU9.js";
...
` + A + `
  ...
  addSingleLink(i, a, n, u) {
    ...
    if (A !== void 0 && (c.text = this.sanitizeText(A.text.trim()), c.text.startsWith('"') && c.text.endsWith('"') && (c.text = c.text.substring(1, c.text.length - 1)), c.labelType = A.type), n !== void 0 && (c.type = n.type, c.stroke = n.stroke, c.length = n.length > 10 ? 10 : n.length), u && !this.edges.some((r) => r.id === u))
      ...
      r.length === 0 ? c.id = st(c.start, c.end, {
        counter: 0,
        prefix: "L"
      }) : c.id = st(c.start, c.end, {
        counter: r.length + 1,
        prefix: "L"
      });
    }
...
You have to call mermaid.initialize.`);
  ...
  updateLink(i, a) {
    i.forEach((n) => {
      ...
      if (typeof n == "number" && n >= this.edges.length)
        throw new Error(`The index ${n} for linkStyle is out of bounds. Valid indices for linkStyle are between 0 and ${this.edges.length - 1}. (Help: Ensure that the index is within the range of existing edges.)`);
  ...
  addClass(i, a) {
    ...
    i.split(",").forEach((u) => {
      ...
      l === void 0 && (l = {
        ...
        styles: [],
        textStyles: []
      }, this.classes.set(u, l)), n != null && n.forEach((f) => {
        if (/color/.exec(f)) {
  ...
  destructStartLink(i) {
    ...
    let u = "normal";
    return a.includes("=") && (u = "thick"), a.includes(".") && (u = "dotted"), {
      type: n,
      stroke: u
    };
  }
  ...
  getData() {
    ...
    return A.forEach((r, b) => {
      const {
        arrowTypeStart: F,
        arrowTypeEnd: k
      } = this.destructEdgeType(r.type), U = [...A.defaultStyle ?? []];
  ...
  var s = /* @__PURE__ */ m(function(p1, h, p, g) {
    ...
    performAction: /* @__PURE__ */ m(function(h, p, g, o, _, t, O1) {
      ...
      switch (_) {
        ...
        case 44:
          ...
          break;
        case 45:
          o.addVertex(t[e - 1][t[e - 1].length - 1], void 0, void 0, void 0, void 0, void 0, void 0, t[e]), o.addLink(t[e - 3].stmt, t[e - 1], t[e - 2]), this.$ = {
            stmt: t[e - 1],
            nodes: t[e - 1].concat(t[e - 3].nodes)
          };
          break;
        case 46:
          o.addLink(t[e - 2].stmt, t[e], t[e - 1]), this.$ = {
            stmt: t[e],
            nodes: t[e].concat(t[e - 2].nodes)
          };
          break;
        case 47:
          o.addLink(t[e - 3].stmt, t[e - 1], t[e - 2]), this.$ = {
            stmt: t[e - 1],
            nodes: t[e - 1].concat(t[e - 3].nodes)
          };
          break;
        case 48:
          ...
          break;
        case 49:
          o.addVertex(t[e - 1][t[e - 1].length - 1], void 0, void 0, void 0, void 0, void 0, void 0, t[e]), this.$ = {
            stmt: t[e - 1],
            nodes: t[e - 1],
            shapeData: t[e]
          };
    ...
    table: [{
      ...
      123: z1,
      124: j1
    }, s(u, [2, 9]), s(u, [2, 10]), s(u, [2, 11]), {
      8: [1, 54],
      9: [1, 55],
      10: h1,
      15: 53,
      18: 56
    }, s(E, [2, 3]), s(E, [2, 4]), s(E, [2, 5]), s(E, [2, 6]), s(E, [2, 7]), s(E, [2, 8]), {
      8: $,
      9: t1,
      11: e1,
      21: 58,
      ...
      116: L1,
      120: 87
    }, s(E, [2, 185]), s(E, [2, 186]), s(E, [2, 187]), s(E, [2, 188]), s(A1, [2, 51]), s(A1, [2, 54], {
      46: [1, 99]
    }), s(W, [2, 72], {
      113: 112,
      29: [1, 100],
      ...
      115: P,
      116: O
    }), s(H, [2, 181]), s(H, [2, 142]), s(H, [2, 143]), s(H, [2, 144]), s(H, [2, 145]), s(H, [2, 146]), s(H, [2, 147]), s(H, [2, 148]), s(H, [2, 149]), s(H, [2, 150]), s(H, [2, 151]), s(H, [2, 152]), s(u, [2, 12]), s(u, [2, 18]), s(u, [2, 19]), {
      9: [1, 113]
    }, s(nt, [2, 26], {
      18: 114,
      10: h1
      ...
      115: P,
      116: O
    }, s(E, [2, 40]), s(E, [2, 41]), s(E, [2, 42]), s(I1, [2, 76], {
      73: 116,
      62: [1, 118],
      74: [1, 117]
    }), {
      ...
      75: [1, 125],
      77: [1, 126]
    }, s(ot, [2, 83]), s(E, [2, 28]), s(E, [2, 29]), s(E, [2, 30]), s(E, [2, 31]), s(E, [2, 32]), {
      10: ct,
      12: ht,
      14: dt,
      27: pt,
      ...
      10: [1, 168]
    }), s(q, [2, 183]), s(q, [2, 170]), s(q, [2, 171]), s(q, [2, 172]), s(q, [2, 173]), s(q, [2, 174]), s(q, [2, 175]), s(q, [2, 176]), s(q, [2, 177]), s(q, [2, 178]), s(q, [2, 179]), s(q, [2, 180]), {
      44: T,
      47: 169,
      60: d,
      89: V,
      ...
      117: D,
      118: x
    }, s(H, [2, 182]), s(u, [2, 20]), s(nt, [2, 25]), s(S1, [2, 46], {
      39: 191,
      18: 192,
      10: h1,
      40: at
      ...
      116: K1,
      119: Y1
    }, s(w1, [2, 79]), s(w1, [2, 81]), s(w1, [2, 82]), s(w1, [2, 168]), s(w1, [2, 169]), {
      76: 198,
      79: 120,
      80: ut,
      81: lt,
      ...
      115: Bt,
      116: vt
    }, s(y, [2, 101]), s(y, [2, 103]), s(y, [2, 104]), s(y, [2, 157]), s(y, [2, 158]), s(y, [2, 159]), s(y, [2, 160]), s(y, [2, 161]), s(y, [2, 162]), s(y, [2, 163]), s(y, [2, 164]), s(y, [2, 165]), s(y, [2, 166]), s(y, [2, 167]), s(y, [2, 90]), s(y, [2, 91]), s(y, [2, 92]), s(y, [2, 93]), s(y, [2, 94]), s(y, [2, 95]), s(y, [2, 96]), s(y, [2, 97]), s(y, [2, 98]), s(y, [2, 99]), s(y, [2, 100]), {
      6: 11,
      7: 12,
      8: f,
      9: c,
      ...
      117: D,
      118: x
    }, s(d1, [2, 86]), s(d1, [2, 88]), s(d1, [2, 89]), s(d1, [2, 153]), s(d1, [2, 154]), s(d1, [2, 155]), s(d1, [2, 156]), {
      49: [1, 219],
      67: C,
      82: 218,
      116: S,
      ...
      10: [1, 261]
    }), s(B, [2, 119]), s(W, [2, 56]), s(d1, [2, 87]), s(W, [2, 57]), {
      51: [1, 262],
      67: C,
      82: 218,
      116: S,
      117: D,
      118: x
    }, s(W, [2, 64]), s(W, [2, 59]), s(W, [2, 60]), s(W, [2, 61]), {
      109: [1, 263]
    }, s(W, [2, 63]), s(W, [2, 65]), {
      66: [1, 264],
      67: C,
      ...
      117: D,
      118: x
    }, s(W, [2, 67]), s(W, [2, 68]), s(W, [2, 70]), s(W, [2, 69]), s(W, [2, 71]), s([10, 44, 60, 89, 102, 105, 106, 109, 111, 114, 115, 116], [2, 85]), s(I1, [2, 78]), {
      31: [1, 265],
      67: C,
      82: 218,
      116: S,
      ...
      111: l1,
      112: o1
    }), s(J, [2, 132]), s(J, [2, 134]), s(J, [2, 135]), s(J, [2, 136]), s(J, [2, 137]), s(J, [2, 138]), s(J, [2, 139]), s(J, [2, 140]), s(J, [2, 141]), s(B, [2, 122], {
      106: R1
    }), {
      10: [1, 270]
    }, s(B, [2, 123], {
    ...
    parse: /* @__PURE__ */ m(function(h) {
      var p = this, g = [0], o = [], _ = [null], t = [], O1 = this.table, e = "", v = 0, Rt = 0, zt = 2, Nt = 1, jt = t.slice.call(arguments, 1), M = Object.create(this.lexer), k1 = {
        yy: {}
      };
...
Expecting ` + X1.join(", ") + ", got '" + (this.terminals_[Y] || Y) + "'" : et = "Parse error on line " + (v + 1) + ": Unexpected " + (Y == Nt ? "end of input" : "'" + (this.terminals_[Y] || Y) + "'"), this.parseError(et, {
        ...
        switch (Q[0]) {
          ...
          case 2:
            ...
            }, Kt && (N1._$.range = [t[t.length - (c1 || 1)].range[0], t[t.length - 1].range[1]]), tt = this.performAction.apply(N1, [e, Rt, v, k1.yy, Q[1], _, t].concat(jt)), typeof tt < "u")
              return tt;
...
`, "getStyles"), me = ke, xe = {
  ...
  styles: me,
  init: /* @__PURE__ */ m((s) => {
    s.flowchart || (s.flowchart = {}), s.layout && Ot({
      layout: s.layout
    }), s.flowchart.arrowMarkerAbsolute = s.arrowMarkerAbsolute, Ot({
      flowchart: {
