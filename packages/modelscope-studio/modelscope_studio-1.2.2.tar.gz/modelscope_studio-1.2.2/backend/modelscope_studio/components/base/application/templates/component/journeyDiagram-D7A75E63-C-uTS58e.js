import { a as ft, g as at, f as gt, d as mt } from "./chunk-PLTTB2RT--CmcSv6J.js";
import { _ as i, g as xt, s as kt, a as _t, b as vt, q as bt, p as wt, c as A, d as W, e as Tt, y as St } from "./mermaid.core-mH_T8-GP.js";
import { d as tt } from "./arc-1m85O0-3.js";
var H = function() {
  var t = /* @__PURE__ */ i(function(g, r, a, l) {
    ...
    table: [{
      ...
      17: h,
      18: p
    }, t(e, [2, 5]), t(e, [2, 6]), t(e, [2, 8]), {
      13: [1, 16]
    }, {
      15: [1, 17]
    }, t(e, [2, 11]), t(e, [2, 12]), {
      19: [1, 18]
    }, t(e, [2, 4]), t(e, [2, 9]), t(e, [2, 10]), t(e, [2, 13])],
    defaultActions: {},
    ...
    parse: /* @__PURE__ */ i(function(r) {
      var a = this, l = [0], y = [], f = [null], o = [], S = this.table, _ = "", B = 0, J = 0, ut = 2, K = 1, yt = o.slice.call(arguments, 1), k = Object.create(this.lexer), E = {
        yy: {}
      };
...
Expecting ` + j.join(", ") + ", got '" + (this.terminals_[v] || v) + "'" : G = "Parse error on line " + (B + 1) + ": Unexpected " + (v == K ? "end of input" : "'" + (this.terminals_[v] || v) + "'"), this.parseError(G, {
        ...
        switch (w[0]) {
          ...
          case 2:
            ...
            }, dt && (C._$.range = [o[o.length - ($ || 1)].range[0], o[o.length - 1].range[1]]), q = this.performAction.apply(C, [_, J, B, E.yy, w[1], f, o].concat(yt)), typeof q < "u")
              return q;
...
`, "getStyles"), Lt = Rt, Z = /* @__PURE__ */ i(function(t, e) {
  ...
  n.diagramMarginX * (e.taskCount - 1), s.height = n.height, s.class = "journey-section section-type-" + e.num, s.rx = 3, s.ry = 3, Z(c, s), ct(n)(e.text, c, s.x, s.y, s.width, s.height, {
  ...
  e.people.forEach((d) => {
    ...
    lt(s, m), p += 10;
  }), ct(n)(e.task, s, h.x, h.y, h.width, h.height, {
    class: "task"
  }, n, e.colour);
