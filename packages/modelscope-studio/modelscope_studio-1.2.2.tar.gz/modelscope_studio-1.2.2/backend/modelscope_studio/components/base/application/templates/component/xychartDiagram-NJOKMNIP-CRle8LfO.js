import { _ as a, s as ui, g as gi, q as Ft, p as xi, a as di, b as pi, l as Xt, H as fi, e as mi, y as yi, E as At, D as Nt, F as bi, K as Ai, i as wi, aC as Ci, Q as Bt } from "./mermaid.core-mH_T8-GP.js";
import { i as Si } from "./init-DjUOC4st.js";
import { o as _i } from "./ordinal-CDDIbzuo.js";
import { l as Wt } from "./linear-D9KxoXSd.js";
function ki(e, t, i) {
...
var ft = function() {
  var e = /* @__PURE__ */ a(function(B, h, c, g) {
    ...
    table: [e(t, i, {
      ...
      49: l,
      50: E
    }), e(lt, [2, 38]), e(lt, [2, 39]), e(I, [2, 40]), e(I, [2, 42]), e(I, [2, 43]), e(I, [2, 44]), e(I, [2, 45]), e(I, [2, 46]), e(I, [2, 47]), e(I, [2, 48]), e(I, [2, 49]), e(I, [2, 50]), e(I, [2, 51]), e(C, [2, 10]), e(C, [2, 22], {
      30: 41,
      29: 56,
      24: K,
      27: vt
      ...
      17: 65,
      24: et
    }, e(C, [2, 16]), e(C, [2, 17]), e(I, [2, 41]), e(C, [2, 23]), {
      27: [1, 66]
    }, {
      26: [1, 67]
    }, {
    ...
    parse: /* @__PURE__ */ a(function(h) {
      var c = this, g = [0], x = [], A = [null], r = [], Z = this.table, d = "", nt = 0, Et = 0, oi = 2, It = 1, hi = r.slice.call(arguments, 1), T = Object.create(this.lexer), W = {
        yy: {}
      };
...
Expecting ` + rt.join(", ") + ", got '" + (this.terminals_[P] || P) + "'" : dt = "Parse error on line " + (nt + 1) + ": Unexpected " + (P == It ? "end of input" : "'" + (this.terminals_[P] || P) + "'"), this.parseError(dt, {
        ...
        switch (M[0]) {
          ...
          case 2:
            ...
            }, li && (z._$.range = [r[r.length - (V || 1)].range[0], r[r.length - 1].range[1]]), xt = this.performAction.apply(z, [d, Et, nt, W.yy, M[1], A, r].concat(hi)), typeof xt < "u")
              return xt;
...
function yt(e, t, i, s) {
  const n = new Yt(s);
  return wt(e) ? new Ti(t, i, e.categories, e.title, n) : new Di(t, i, [e.min, e.max], e.title, n);
}
a(yt, "getAxis");
var U, vi = (U = class {
  constructor(t, i, s, n) {
  ...
  calculateSpace(t) {
    const i = this.textDimensionCalculator.getMaxDimension([this.chartData.title], this.chartConfig.titleFontSize), s = Math.max(i.width, t.width), n = i.height + 2 * this.chartConfig.titlePadding;
...
var $, Pi = ($ = class {
  ...
  getDrawableElement() {
    const t = this.barData.data.map((o) => [this.xAxis.getScaleValue(o[0]), this.yAxis.getScaleValue(o[1])]), s = Math.min(this.xAxis.getAxisOuterPadding() * 2, this.xAxis.getTickDistance()) * (1 - 0.05), n = s / 2;
  ...
  getDrawableElements() {
    ...
    for (const [i, s] of this.chartData.plots.entries())
      switch (s.type) {
        case "line":
          {
            const n = new Pi(s, this.xAxis, this.yAxis, this.chartConfig.chartOrientation, i);
            t.push(...n.getDrawableElement());
          }
          break;
        case "bar":
          {
            const n = new Li(s, this.boundingRect, this.xAxis, this.yAxis, this.chartConfig.chartOrientation, i);
            t.push(...n.getDrawableElement());
          }
          break;
      }
...
var j, Ii = (j = class {
  ...
  calculateVerticalSpace() {
    let t = this.chartConfig.width, i = this.chartConfig.height, s = 0, n = 0, o = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), u = Math.floor(i * this.chartConfig.plotReservedSpacePercent / 100), f = this.componentStore.plot.calculateSpace({
      width: o,
      height: u
    });
    t -= f.width, i -= f.height, f = this.componentStore.title.calculateSpace({
      ...
      x: s,
      y: n
    }), this.componentStore.xAxis.setRange([s, s + o]), this.componentStore.xAxis.setBoundingBoxXY({
      x: s,
      y: n + u
    }), this.componentStore.yAxis.setRange([n, n + u]), this.componentStore.yAxis.setBoundingBoxXY({
      x: 0,
      y: n
    }), this.chartData.plots.some((p) => mt(p)) && this.componentStore.xAxis.recalculateOuterPaddingToDrawBar();
  }
  calculateHorizontalSpace() {
    let t = this.chartConfig.width, i = this.chartConfig.height, s = 0, n = 0, o = 0, u = Math.floor(t * this.chartConfig.plotReservedSpacePercent / 100), f = Math.floor(i * this.chartConfig.plotReservedSpacePercent / 100), p = this.componentStore.plot.calculateSpace({
      width: u,
      height: f
    });
    t -= p.width, i -= p.height, p = this.componentStore.title.calculateSpace({
      ...
      x: n,
      y: s
    }), this.componentStore.xAxis.setRange([o, o + f]), this.componentStore.xAxis.setBoundingBoxXY({
      x: 0,
      y: o
    }), this.chartData.plots.some((k) => mt(k)) && this.componentStore.xAxis.recalculateOuterPaddingToDrawBar();
  }
  calculateSpace() {
...
function _t() {
  const e = At();
  return Nt(bi.xyChart, e.xyChart);
}
