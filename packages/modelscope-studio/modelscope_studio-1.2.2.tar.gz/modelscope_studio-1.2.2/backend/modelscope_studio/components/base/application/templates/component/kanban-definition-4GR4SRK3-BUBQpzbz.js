import { _ as c, l as te, c as W, H as fe, ae as ye, af as be, ag as me, U as _e, F as Y, i as G, t as Ee, J as ke, V as Se, W as le, X as ce } from "./mermaid.core-mH_T8-GP.js";
var $ = function() {
  var t = /* @__PURE__ */ c(function(_, s, n, a) {
    for (n = n || {}, a = _.length; a--; n[_[a]] = s) ;
    return n;
  }, "o"), g = [1, 4], d = [1, 13], r = [1, 12], p = [1, 15], E = [1, 16], f = [1, 20], h = [1, 19], L = [6, 7, 8], C = [1, 26], w = [1, 24], N = [1, 25], i = [6, 7, 11], U = [1, 31], x = [6, 7, 11, 24], P = [1, 6, 13, 16, 17, 20, 23], H = [1, 35], M = [1, 36], A = [1, 6, 7, 11, 13, 16, 17, 20, 23], j = [1, 38], V = {
    ...
    performAction: /* @__PURE__ */ c(function(s, n, a, o, u, e, B) {
      ...
      switch (u) {
        ...
        case 16:
          ...
          break;
        case 17:
          o.getLogger().trace("Icon: ", e[l]), o.decorateNode({
            icon: e[l]
          });
          break;
        case 18:
        ...
        case 22:
          ...
          break;
        case 27:
          o.getLogger().trace("node found ..", e[l - 2]), this.$ = {
            id: e[l - 1],
            descr: e[l - 1],
            type: o.getType(e[l - 2], e[l])
          };
          break;
        case 28:
          this.$ = {
          ...
          break;
        case 29:
          o.getLogger().trace("node found ..", e[l - 3]), this.$ = {
            id: e[l - 3],
            descr: e[l - 1],
            type: o.getType(e[l - 2], e[l])
          };
    ...
    table: [{
      ...
      15: 30,
      24: U
    }), t(i, [2, 22]), t(i, [2, 23]), t(x, [2, 25]), t(x, [2, 26]), t(x, [2, 28], {
      20: [1, 32]
    }), {
      21: [1, 33]
    }, {
      ...
      7: H,
      11: M
    }), t(A, [2, 8]), t(A, [2, 9]), t(A, [2, 10]), t(i, [2, 16], {
      15: 37,
      24: U
    }), t(i, [2, 17]), t(i, [2, 18]), t(i, [2, 20], {
      24: j
    }), t(x, [2, 31]), {
      21: [1, 39]
    }, {
    ...
    parse: /* @__PURE__ */ c(function(s) {
      var n = this, a = [0], o = [], u = [null], e = [], B = this.table, l = "", z = 0, ie = 0, ue = 2, re = 1, ge = e.slice.call(arguments, 1), b = Object.create(this.lexer), T = {
        yy: {}
      };
...
Expecting ` + K.join(", ") + ", got '" + (this.terminals_[k] || k) + "'" : Z = "Parse error on line " + (z + 1) + ": Unexpected " + (k == re ? "end of input" : "'" + (this.terminals_[k] || k) + "'"), this.parseError(Z, {
        ...
        switch (v[0]) {
          ...
          case 2:
            ...
            }, de && (F._$.range = [e[e.length - (I || 1)].range[0], e[e.length - 1].range[1]]), Q = this.performAction.apply(F, [l, ie, z, T.yy, v[1], u, e].concat(ge)), typeof Q < "u")
              return Q;
...
` + t);
  ...
  let x = 25;
  for (const m of w) {
    const O = ((H = f == null ? void 0 : f.kanban) == null ? void 0 : H.sectionWidth) || 200;
    N = N + 1, m.x = O * N + (N - 1) * i / 2, m.width = O, m.y = 0, m.height = O * 3, m.rx = 5, m.ry = 5, m.cssClasses = m.cssClasses + " section-" + N;
    const _ = await ye(L, m);
    x = Math.max(x, (M = _ == null ? void 0 : _.labelBBox) == null ? void 0 : M.height), U.push(_);
  }
  let P = 0;
  for (const m of w) {
    const O = U[P];
  ...
  _e(void 0, h, ((j = f.mindmap) == null ? void 0 : j.padding) ?? Y.kanban.padding, ((V = f.mindmap) == null ? void 0 : V.useMaxWidth) ?? Y.kanban.useMaxWidth);
}, "draw"), Be = {
  draw: Ve
}, Fe = /* @__PURE__ */ c((t) => {
  let g = "";
