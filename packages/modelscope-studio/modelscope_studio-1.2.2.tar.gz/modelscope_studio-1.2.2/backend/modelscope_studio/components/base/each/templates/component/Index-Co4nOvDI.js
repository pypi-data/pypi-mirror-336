...
function El(e, t, n) {
  ...
  const l = pe(() => import("./fragment-CsG_xT1A.js"));
  let {
    _internal: c = {}
  } = t, {
    as_item: _ = void 0
...
function Yl(e, t, n) {
  ...
  const s = pe(() => import("./each.item-Dtci_zxb.js"));
  let {
    context_value: l
  } = t, {
    index: c
...
function gu(e, t, n) {
  ...
  const c = pe(() => import("./each-D8c5R8Qi.js")), _ = pe(() => import("./each.placeholder-a186vdmV.js"));
  let {
    context_value: p
  } = t, {
    value: u = []
