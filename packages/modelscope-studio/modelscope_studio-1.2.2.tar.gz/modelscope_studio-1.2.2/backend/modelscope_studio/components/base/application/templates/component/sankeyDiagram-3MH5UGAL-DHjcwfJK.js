import { _ as p, p as _t, q as xt, s as vt, g as bt, b as wt, a as St, c as lt, z as Lt, d as H, U as Et, y as At, k as Tt } from "./mermaid.core-mH_T8-GP.js";
import { o as Mt } from "./ordinal-CDDIbzuo.js";
function Nt(t) {
...
var at = function() {
  var t = /* @__PURE__ */ p(function(_, s, o, l) {
    ...
    parse: /* @__PURE__ */ p(function(s) {
      var o = this, l = [0], x = [], v = [null], y = [], b = this.table, M = "", T = 0, N = 0, C = 2, D = 1, R = y.slice.call(arguments, 1), S = Object.create(this.lexer), P = {
        yy: {}
      };
...
Expecting ` + k.join(", ") + ", got '" + (this.terminals_[A] || A) + "'" : w = "Parse error on line " + (T + 1) + ": Unexpected " + (A == D ? "end of input" : "'" + (this.terminals_[A] || A) + "'"), this.parseError(w, {
        ...
        switch (I[0]) {
          ...
          case 2:
            ...
            }, z && (f._$.range = [y[y.length - (c || 1)].range[0], y[y.length - 1].range[1]]), n = this.performAction.apply(f, [M, N, T, P.yy, I[1], v, y].concat(R)), typeof n < "u")
              return n;
...
var K = at, J = [], tt = [], Z = /* @__PURE__ */ new Map(), Zt = /* @__PURE__ */ p(() => {
  ...
  Bt().nodeId((g) => g.id).nodeWidth(10).nodePadding(10 + (T ? 15 : 0)).nodeAlign(C).extent([[0, 0], [l, x]])(N);
  const S = Mt(It);
