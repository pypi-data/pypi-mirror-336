import { c as b } from "./Index-CtL7Z4Ie.js";
import { i as o, o as $, c as O } from "./config-provider-p_NQQ49i.js";
function x(s, f) {
...
c.default = void 0;
var g = P($), z = O, A = (0, g.default)((0, g.default)({}, z.commonLocale), {}, {
  locale: "ro_RO",
  today: "Azi",
  now: "Acum",
...
n.default = void 0;
var M = d(i), k = d(u), w = d(r), C = d(l);
const e = "${label} nu conține tipul corect (${type})", F = {
  locale: "ro",
...
n.default = F;
var _ = n;
const Y = /* @__PURE__ */ b(_), q = /* @__PURE__ */ x({
  __proto__: null,
  default: Y
}, [_]);
export {
