...
function Ks(e, t, n) {
  ...
  const d = Za(() => import("./list.item-61HUA2bF.js"));
  let {
    gradio: _
  } = t, {
    _internal: c = {}
  ...
  return pe(e, Me, (h) => n(1, s = h)), e.$$set = (h) => {
    t = me(me({}, t), Os(h)), n(18, i = ct(t, r)), "gradio" in h && n(6, _ = h.gradio), "_internal" in h && n(7, c = h._internal), "as_item" in h && n(8, f = h.as_item), "props" in h && n(9, p = h.props), "elem_id" in h && n(10, g = h.elem_id), "elem_classes" in h && n(11, v = h.elem_classes), "elem_style" in h && n(12, T = h.elem_style), "visible" in h && n(13, O = h.visible), "$$scope" in h && n(16, l = h.$$scope);
  }, e.$$.update = () => {
    e.$$.dirty & /*props*/
    512 && b.update((h) => ({
      ...h,
  ...
  }, [a, s, d, b, M, Me, _, c, f, p, g, v, T, O, o, u, l];
}
class zs extends hs {
  constructor(t) {
