import { i as ie, a as j, r as le, w as T, g as ae } from "./Index-D4VPbwmM.js";
...
function xe(e, t, o) {
  ...
  t = U(t) || 0, j(o) && (h = !!o.leading, a = "maxWait" in o, n = a ? Ce(U(o.maxWait) || 0, t) : n, g = "trailing" in o ? !!o.trailing : g);
  function m(u) {
    var b = i, R = s;
  ...
  return {
    ...
    l(r) {
      t = Z(r, "REACT-PORTAL-TARGET", {
        class: !0
      }), Q(t).forEach(x), o = Ne(r), n && n.l(r), i = G(), this.h();
    },
    h() {
      ee(t, "class", "svelte-1rt0kpf");
    },
