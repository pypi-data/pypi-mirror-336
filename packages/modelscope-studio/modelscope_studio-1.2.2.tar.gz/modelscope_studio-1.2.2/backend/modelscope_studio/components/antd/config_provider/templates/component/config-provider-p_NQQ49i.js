import { i as vt, a as de, r as xt, w as L, g as St, b as jt, c as Be, d as Ct } from "./Index-CtL7Z4Ie.js";
...
function Ae(t, e) {
  return t ? e != null && e.forceClone || e != null && e.params ? vr((r) => /* @__PURE__ */ v.jsx(Et, {
...
const tn = /* @__PURE__ */ Be(Pt), rn = /* @__PURE__ */ He({
  ...
  ar_EG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ar_EG-B40-H9O3.js").then((e) => e.a), import("./ar-CPGaWs3d.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "ar"
    };
  ...
  az_AZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./az_AZ-BMxdv1GM.js").then((e) => e.a), import("./az-DrlAOpGr.js").then((e) => e.a)]);
    return {
      antd: t,
      dayjs: "az"
    };
  ...
  bg_BG: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bg_BG-DBToyA96.js").then((e) => e.b), import("./bg-CV8RUUDl.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bg"
    };
  ...
  bn_BD: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./bn_BD-B6GE0sOg.js").then((e) => e.b), import("./bn-DxAe21dx.js").then((e) => e.b)]);
    return {
      antd: t,
      dayjs: "bn"
    };
  ...
  by_BY: async () => {
    const [{
      ...
      import("./by_BY-DJBejZoi.js").then((e) => e.b),
      import("./be-CYBNz9Se.js").then((e) => e.b)
      // Belarusian (Belarus)
    ]);
    return {
      antd: t,
  ...
  ca_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ca_ES-5-cDq1X4.js").then((e) => e.c), import("./ca-ClXabUMb.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "ca"
    };
  ...
  cs_CZ: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./cs_CZ-DnEWdVYX.js").then((e) => e.c), import("./cs-CHPj49Av.js").then((e) => e.c)]);
    return {
      antd: t,
      dayjs: "cs"
    };
  ...
  da_DK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./da_DK-_jh6vFrF.js").then((e) => e.d), import("./da-DSTForh7.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "da"
    };
  ...
  de_DE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./de_DE-B1oU8ERl.js").then((e) => e.d), import("./de-DlND5YE5.js").then((e) => e.d)]);
    return {
      antd: t,
      dayjs: "de"
    };
  ...
  el_GR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./el_GR-Dcu9wvWg.js").then((e) => e.e), import("./el-Ce-UDg9A.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "el"
    };
  ...
  en_GB: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./en_GB-BFc4OJZV.js").then((e) => e.e), import("./en-gb-D5UXi7dN.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "en-gb"
    };
  ...
  es_ES: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./es_ES-Bi07IYf_.js").then((e) => e.e), import("./es-mlQKWitd.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "es"
    };
  ...
  et_EE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./et_EE-Bo4TmfH-.js").then((e) => e.e), import("./et-CVEmkL5W.js").then((e) => e.e)]);
    return {
      antd: t,
      dayjs: "et"
    };
  ...
  eu_ES: async () => {
    const [{
      ...
      import("./eu_ES-Bjt6nsFd.js").then((e) => e.e),
      import("./eu-CEr-pt5d.js").then((e) => e.e)
      // Basque
    ]);
    return {
      antd: t,
  ...
  fa_IR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fa_IR-BBIzAP_p.js").then((e) => e.f), import("./fa-CMRFCVdM.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fa"
    };
  ...
  fi_FI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fi_FI-CpPB7kjy.js").then((e) => e.f), import("./fi-DWn42faL.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fi"
    };
  ...
  fr_BE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_BE-C4PuODsv.js").then((e) => e.f), import("./fr-DIA4UyY1.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  fr_CA: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_CA-CxY7Cjxq.js").then((e) => e.f), import("./fr-ca-Diy59p8A.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr-ca"
    };
  ...
  fr_FR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./fr_FR-T2eSI_V0.js").then((e) => e.f), import("./fr-DIA4UyY1.js").then((e) => e.f)]);
    return {
      antd: t,
      dayjs: "fr"
    };
  ...
  ga_IE: async () => {
    const [{
      ...
      import("./ga_IE-DiGGSD8s.js").then((e) => e.g),
      import("./ga-Bm7zw12H.js").then((e) => e.g)
      // Irish
    ]);
    return {
      antd: t,
  ...
  gl_ES: async () => {
    const [{
      ...
      import("./gl_ES-CvPKEOr4.js").then((e) => e.g),
      import("./gl-CMus3P_0.js").then((e) => e.g)
      // Galician
    ]);
    return {
      antd: t,
  ...
  he_IL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./he_IL--mD9NAm3.js").then((e) => e.h), import("./he-CeZwrZEl.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "he"
    };
  ...
  hi_IN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hi_IN-nk0tyJ-b.js").then((e) => e.h), import("./hi-BSET1GEy.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hi"
    };
  ...
  hr_HR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hr_HR-C_15--1A.js").then((e) => e.h), import("./hr-DIVquAWz.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hr"
    };
  ...
  hu_HU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./hu_HU-jsHLeV9F.js").then((e) => e.h), import("./hu-DBJTbt0j.js").then((e) => e.h)]);
    return {
      antd: t,
      dayjs: "hu"
    };
  ...
  hy_AM: async () => {
    const [{
      ...
      import("./hy_AM-CXbO-NWi.js").then((e) => e.h),
      import("./am-Bfbn3Hq2.js").then((e) => e.a)
      // Armenian
    ]);
    return {
      antd: t,
  ...
  id_ID: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./id_ID-wDZ2ib9V.js").then((e) => e.i), import("./id-DinB01HA.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "id"
    };
  ...
  is_IS: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./is_IS-BBFFRLp0.js").then((e) => e.i), import("./is-CPAFKZPN.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "is"
    };
  ...
  it_IT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./it_IT-D7wuH9by.js").then((e) => e.i), import("./it-hyfO4LzT.js").then((e) => e.i)]);
    return {
      antd: t,
      dayjs: "it"
    };
  ...
  ja_JP: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ja_JP-3C0Ozdc0.js").then((e) => e.j), import("./ja-B1USKulB.js").then((e) => e.j)]);
    return {
      antd: t,
      dayjs: "ja"
    };
  ...
  ka_GE: async () => {
    const [{
      ...
      import("./ka_GE-C6T_3tPB.js").then((e) => e.k),
      import("./ka-CpAgzXy6.js").then((e) => e.k)
      // Georgian
    ]);
    return {
      antd: t,
  ...
  kk_KZ: async () => {
    const [{
      ...
      import("./kk_KZ-3DhnmItm.js").then((e) => e.k),
      import("./kk-DcuTQgKg.js").then((e) => e.k)
      // Kazakh
    ]);
    return {
      antd: t,
  ...
  km_KH: async () => {
    const [{
      ...
      import("./km_KH-BnFA_HH9.js").then((e) => e.k),
      import("./km-9ENj-Roy.js").then((e) => e.k)
      // Khmer
    ]);
    return {
      antd: t,
  ...
  kmr_IQ: async () => {
    const [t] = await Promise.all([
      import("./kmr_IQ-C0oiFg6b.js").then((e) => e.k)
  ...
  kn_IN: async () => {
    const [{
      ...
      import("./kn_IN-L7MoYxee.js").then((e) => e.k),
      import("./kn-BvKDWXIR.js").then((e) => e.k)
      // Kannada
    ]);
    return {
      antd: t,
  ...
  ko_KR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ko_KR-BDe33CYP.js").then((e) => e.k), import("./ko-D1LQ9Muz.js").then((e) => e.k)]);
    return {
      antd: t,
      dayjs: "ko"
    };
  ...
  ku_IQ: async () => {
    const [{
      ...
      import("./ku_IQ-QmZ3xLcJ.js").then((e) => e.k),
      import("./ku-COmF4kGN.js").then((e) => e.k)
      // Kurdish (Central)
    ]);
    return {
      antd: t,
  ...
  lt_LT: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lt_LT-C5zLlxpX.js").then((e) => e.l), import("./lt-9JE5-D6x.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lt"
    };
  ...
  lv_LV: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./lv_LV-CU2wSj_2.js").then((e) => e.l), import("./lv-Bm5vvk4k.js").then((e) => e.l)]);
    return {
      antd: t,
      dayjs: "lv"
    };
  ...
  mk_MK: async () => {
    const [{
      ...
      import("./mk_MK-CXZcHiIf.js").then((e) => e.m),
      import("./mk-rDuC5gia.js").then((e) => e.m)
      // Macedonian
    ]);
    return {
      antd: t,
  ...
  ml_IN: async () => {
    const [{
      ...
      import("./ml_IN-D1xJMjM4.js").then((e) => e.m),
      import("./ml-DZ_y1I7o.js").then((e) => e.m)
      // Malayalam
    ]);
    return {
      antd: t,
  ...
  mn_MN: async () => {
    const [{
      ...
      import("./mn_MN-DnTmXiPf.js").then((e) => e.m),
      import("./mn-BpRJHvjl.js").then((e) => e.m)
      // Mongolian
    ]);
    return {
      antd: t,
  ...
  ms_MY: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ms_MY-9Ju3sH60.js").then((e) => e.m), import("./ms-C_h6e1tH.js").then((e) => e.m)]);
    return {
      antd: t,
      dayjs: "ms"
    };
  ...
  my_MM: async () => {
    const [{
      ...
      import("./my_MM-DLnOhVxQ.js").then((e) => e.m),
      import("./my-0HT5uvVX.js").then((e) => e.m)
      // Burmese
    ]);
    return {
      antd: t,
  ...
  nb_NO: async () => {
    const [{
      ...
      import("./nb_NO-D-pSMs-c.js").then((e) => e.n),
      import("./nb-D6K6BOLI.js").then((e) => e.n)
      // Norwegian Bokmål
    ]);
    return {
      antd: t,
  ...
  ne_NP: async () => {
    const [{
      ...
      import("./ne_NP-D589YD8E.js").then((e) => e.n),
      import("./ne-Dtjo_6M0.js").then((e) => e.n)
      // Nepali
    ]);
    return {
      antd: t,
  ...
  nl_BE: async () => {
    const [{
      ...
      import("./nl_BE-BKQKQF_U.js").then((e) => e.n),
      import("./nl-be-CyVTylMs.js").then((e) => e.n)
      // Dutch (Belgium)
    ]);
    return {
      antd: t,
  ...
  nl_NL: async () => {
    const [{
      ...
      import("./nl_NL-C0x4gSEV.js").then((e) => e.n),
      import("./nl-B7B_V9Kr.js").then((e) => e.n)
      // Dutch (Netherlands)
    ]);
    return {
      antd: t,
  ...
  pl_PL: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./pl_PL-BmQvFalF.js").then((e) => e.p), import("./pl-DDMUorFj.js").then((e) => e.p)]);
    return {
      antd: t,
      dayjs: "pl"
    };
  ...
  pt_BR: async () => {
    const [{
      ...
      import("./pt_BR-B1lTn04e.js").then((e) => e.p),
      import("./pt-br-BjStnyvP.js").then((e) => e.p)
      // Portuguese (Brazil)
    ]);
    return {
      antd: t,
  ...
  pt_PT: async () => {
    const [{
      ...
      import("./pt_PT-BGhtDLkl.js").then((e) => e.p),
      import("./pt-DdaB2EGy.js").then((e) => e.p)
      // Portuguese (Portugal)
    ]);
    return {
      antd: t,
  ...
  ro_RO: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ro_RO-BA0oCsBI.js").then((e) => e.r), import("./ro-C7Uf3nVv.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ro"
    };
  ...
  ru_RU: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./ru_RU-Biht0NZ8.js").then((e) => e.r), import("./ru-ikoyegO1.js").then((e) => e.r)]);
    return {
      antd: t,
      dayjs: "ru"
    };
  ...
  si_LK: async () => {
    const [{
      ...
      import("./si_LK-DpPBzUxf.js").then((e) => e.s),
      import("./si-BrNRqezt.js").then((e) => e.s)
      // Sinhala
    ]);
    return {
      antd: t,
  ...
  sk_SK: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sk_SK-BtyjwsFB.js").then((e) => e.s), import("./sk-oc_7eLLR.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sk"
    };
  ...
  sl_SI: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sl_SI-CYBfAATV.js").then((e) => e.s), import("./sl-BCdpPCur.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sl"
    };
  ...
  sr_RS: async () => {
    const [{
      ...
      import("./sr_RS-CEkxm-SR.js").then((e) => e.s),
      import("./sr-OJCAoRtc.js").then((e) => e.s)
      // Serbian
    ]);
    return {
      antd: t,
  ...
  sv_SE: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./sv_SE-BzI6uZ9a.js").then((e) => e.s), import("./sv-BH8n1vDI.js").then((e) => e.s)]);
    return {
      antd: t,
      dayjs: "sv"
    };
  ...
  ta_IN: async () => {
    const [{
      ...
      import("./ta_IN-CEGRPSWD.js").then((e) => e.t),
      import("./ta-_XC0dcVu.js").then((e) => e.t)
      // Tamil
    ]);
    return {
      antd: t,
  ...
  th_TH: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./th_TH-DPqL19xN.js").then((e) => e.t), import("./th-Y-2G97Gf.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "th"
    };
  ...
  tk_TK: async () => {
    const [{
      ...
      import("./tk_TK-CliipKU2.js").then((e) => e.t),
      import("./tk-CjckpHn5.js").then((e) => e.t)
      // Turkmen
    ]);
    return {
      antd: t,
  ...
  tr_TR: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./tr_TR-D5uutmK2.js").then((e) => e.t), import("./tr-Dc19CFaw.js").then((e) => e.t)]);
    return {
      antd: t,
      dayjs: "tr"
    };
  ...
  uk_UA: async () => {
    const [{
      ...
      import("./uk_UA-z_1ILsR-.js").then((e) => e.u),
      import("./uk-BXs2ivli.js").then((e) => e.u)
      // Ukrainian
    ]);
    return {
      antd: t,
  ...
  ur_PK: async () => {
    const [{
      ...
      import("./ur_PK-nnrT9tq5.js").then((e) => e.u),
      import("./ur-Bx-dqD-z.js").then((e) => e.u)
      // Urdu
    ]);
    return {
      antd: t,
  ...
  uz_UZ: async () => {
    const [{
      ...
      import("./uz_UZ-CJJEbVlo.js").then((e) => e.u),
      import("./uz-DD_fZzMQ.js").then((e) => e.u)
      // Uzbek
    ]);
    return {
      antd: t,
  ...
  vi_VN: async () => {
    const [{
      default: t
    }] = await Promise.all([import("./vi_VN-BkpAxxMb.js").then((e) => e.v), import("./vi-__TpGFAD.js").then((e) => e.v)]);
    return {
      antd: t,
      dayjs: "vi"
    };
  ...
  zh_CN: async () => {
    const [{
      ...
      import("./zh_CN-DUpdYUaC.js").then((e) => e.z),
      import("./zh-cn-Dn4jwhJq.js").then((e) => e.z)
      // Chinese (Simplified)
    ]);
    return {
      antd: t,
  ...
  zh_HK: async () => {
    const [{
      ...
      import("./zh_HK-Cd-URM95.js").then((e) => e.z),
      import("./zh-hk-CTZmfLjj.js").then((e) => e.z)
      // Chinese (Hong Kong)
    ]);
    return {
      antd: t,
  ...
  zh_TW: async () => {
    const [{
      ...
      import("./zh_TW-D6gSPxRd.js").then((e) => e.z),
      import("./zh-tw-BE4zNeea.js").then((e) => e.z)
      // Chinese (Taiwan)
    ]);
    return {
      antd: t,
