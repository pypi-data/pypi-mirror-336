...
import { i as o, o as g, c as k } from "./config-provider-p_NQQ49i.js";
function x(p, f) {
    ...
    if (typeof a != "string" && !Array.isArray(a)) {
      for (const l in a)
        if (l !== "default" && !(l in p)) {
          ...
          s && Object.defineProperty(p, l, s.get ? s : {
            enumerable: !0,
            get: () => a[l]
          });
        }
...
c.default = void 0;
var _ = y(g), P = k, I = (0, _.default)((0, _.default)({}, P.commonLocale), {}, {
  locale: "kn_IN",
  today: "ಇಂದು",
  now: "ಈಗ",
...
n.default = F;
var v = n;
const R = /* @__PURE__ */ b(v), E = /* @__PURE__ */ x({
  __proto__: null,
  default: R
}, [v]);
export {
