...
import { i as o, o as $, c as h } from "./config-provider-p_NQQ49i.js";
function P(u, f) {
...
n.default = void 0;
var G = s(c), D = s(i), M = s(r), E = s(l);
const e = "${label} is not a valid ${type}", N = {
  locale: "en-gb",
...
n.default = N;
var g = n;
const Y = /* @__PURE__ */ _(g), A = /* @__PURE__ */ P({
  __proto__: null,
  default: Y
}, [g]);
export {
