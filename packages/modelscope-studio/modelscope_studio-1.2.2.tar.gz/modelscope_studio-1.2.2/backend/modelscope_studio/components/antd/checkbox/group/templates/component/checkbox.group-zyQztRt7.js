import { i as ae, a as A, r as ue, w as O, g as de } from "./Index-CttsIsO4.js";
...
const {
  ...
  useItems: lt,
  ItemHandler: at
} = pe("antd-checkbox-group-options"), ut = Ze(st(["default", "options"], ({
  onValueChange: e,
  onChange: t,
  elRef: s,
  options: l,
  ...
  const {
    items: r
  } = lt(), i = r.options ? r.options : r.default;
