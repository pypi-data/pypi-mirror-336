...
from browser_use_recorder.dom.views import (
	DOMBaseNode,
	DOMElementNode,
	DOMState,
	DOMTextNode,
...
from browser_use_recorder.utils import time_execution_async
...
class DomService:
	def __init__(self, page: 'Page'):
		...
		self.js_code = resources.read_text('browser_use_recorder.dom', 'buildDomTree.js')
