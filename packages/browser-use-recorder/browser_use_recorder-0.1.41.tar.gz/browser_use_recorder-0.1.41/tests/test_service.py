...
from browser_use_recorder.agent.service import Agent
...
from browser_use_recorder.browser.views import BrowserState
from browser_use_recorder.controller.registry.service import Registry
...
class TestAgent:
	...
	async def test_step_error_handling(self):
		...
		with patch('browser_use_services.agent.service.MessageManager') as mock_message_manager:
