...
# <Other primaries>=                                                      
    ...
    # <Process function call>=                                                
        ...
        for one_slice in slice_list:
            print("one_slice {}".format(one_slice))
            if len(one_slice) == 0:
                outstring += ":"
            elif len(one_slice) == 1 and one_slice[0] == []:
                outstring += ":"
            elif len(one_slice) == 2 and one_slice[0] == []:
                outstring += "0:" + traverse_ast(one_slice[1])
            elif one_slice[0] == "EXPR":   #not a slice as such
