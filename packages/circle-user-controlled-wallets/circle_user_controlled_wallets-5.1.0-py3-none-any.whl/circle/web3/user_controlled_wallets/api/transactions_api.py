...
class TransactionsApi(object):
    ...
    def create_user_transaction_contract_execution_challenge(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], create_contract_execution_transaction_for_end_user_request : Annotated[CreateContractExecutionTransactionForEndUserRequest, Field(..., description="Create transaction for end user request")], **kwargs) -> CreateContractExecutionTransactionForEndUserResponse:  # noqa: E501
        ...
        >>> thread = api.create_user_transaction_contract_execution_challenge(x_user_token, create_contract_execution_transaction_for_end_user_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_user_transaction_contract_execution_challenge_with_http_info(x_user_token, create_contract_execution_transaction_for_end_user_request, **kwargs)  # noqa: E501

    @auto_fill
    @validate_arguments
    def create_user_transaction_contract_execution_challenge_with_http_info(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], create_contract_execution_transaction_for_end_user_request : Annotated[CreateContractExecutionTransactionForEndUserRequest, Field(..., description="Create transaction for end user request")], **kwargs) -> ApiResponse:  # noqa: E501
        """Create a challenge for contract execution  # noqa: E501
        ...
        >>> thread = api.create_user_transaction_contract_execution_challenge_with_http_info(x_user_token, create_contract_execution_transaction_for_end_user_request, async_req=True)
        >>> result = thread.get()
