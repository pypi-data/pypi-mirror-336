...
class SocialEmailAuthenticationApi(object):
    ...
    @auto_fill
    @validate_arguments
    def create_device_token_email_login(self, device_token_email_request : Annotated[DeviceTokenEmailRequest, Field(..., description="Request body")], **kwargs) -> DeviceTokenEmail:  # noqa: E501
        ...
        >>> thread = api.create_device_token_email_login(device_token_email_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_device_token_email_login_with_http_info(device_token_email_request, **kwargs)  # noqa: E501

    @auto_fill
    @validate_arguments
    def create_device_token_email_login_with_http_info(self, device_token_email_request : Annotated[DeviceTokenEmailRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a deviceToken to log in with email OTP  # noqa: E501
        ...
        >>> thread = api.create_device_token_email_login_with_http_info(device_token_email_request, async_req=True)
        >>> result = thread.get()
    ...
    @auto_fill
    @validate_arguments
    def create_device_token_social_login(self, device_token_social_request : Annotated[DeviceTokenSocialRequest, Field(..., description="Request body")], **kwargs) -> DeviceTokenSocial:  # noqa: E501
        ...
        >>> thread = api.create_device_token_social_login(device_token_social_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.create_device_token_social_login_with_http_info(device_token_social_request, **kwargs)  # noqa: E501

    @auto_fill
    @validate_arguments
    def create_device_token_social_login_with_http_info(self, device_token_social_request : Annotated[DeviceTokenSocialRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get deviceToken to perform social login  # noqa: E501
        ...
        >>> thread = api.create_device_token_social_login_with_http_info(device_token_social_request, async_req=True)
        >>> result = thread.get()
    ...
    @auto_fill
    @validate_arguments
    def refresh_user_token(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], refresh_user_token_request : Annotated[RefreshUserTokenRequest, Field(..., description="Request body")], **kwargs) -> RefreshUserToken:  # noqa: E501
        ...
        >>> thread = api.refresh_user_token(x_user_token, refresh_user_token_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.refresh_user_token_with_http_info(x_user_token, refresh_user_token_request, **kwargs)  # noqa: E501

    @auto_fill
    @validate_arguments
    def refresh_user_token_with_http_info(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], refresh_user_token_request : Annotated[RefreshUserTokenRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Get a new userToken with the refreshToken  # noqa: E501
        ...
        >>> thread = api.refresh_user_token_with_http_info(x_user_token, refresh_user_token_request, async_req=True)
        >>> result = thread.get()
    ...
    @auto_fill
    @validate_arguments
    def resend_otp(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], resend_otp_request : Annotated[ResendOTPRequest, Field(..., description="Request body")], **kwargs) -> ResentOTP:  # noqa: E501
        ...
        >>> thread = api.resend_otp(x_user_token, resend_otp_request, async_req=True)
        >>> result = thread.get()
        ...
        return self.resend_otp_with_http_info(x_user_token, resend_otp_request, **kwargs)  # noqa: E501

    @auto_fill
    @validate_arguments
    def resend_otp_with_http_info(self, x_user_token : Annotated[StrictStr, Field(..., description="Unique system generated JWT session token for specific user.")], resend_otp_request : Annotated[ResendOTPRequest, Field(..., description="Request body")], **kwargs) -> ApiResponse:  # noqa: E501
        """Resend an OTP email to the user  # noqa: E501
        ...
        >>> thread = api.resend_otp_with_http_info(x_user_token, resend_otp_request, async_req=True)
        >>> result = thread.get()
