...
class Challenge(BaseModel):
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('', 'INITIALIZE', 'SET_PIN', 'CHANGE_PIN', 'SET_SECURITY_QUESTIONS', 'CREATE_WALLET', 'RESTORE_PIN', 'CREATE_TRANSACTION', 'ACCELERATE_TRANSACTION', 'CANCEL_TRANSACTION', 'CONTRACT_EXECUTION', 'SIGN_MESSAGE', 'SIGN_TYPEDDATA', 'SIGN_TRANSACTION'):
            raise ValueError("must be one of enum values ('', 'INITIALIZE', 'SET_PIN', 'CHANGE_PIN', 'SET_SECURITY_QUESTIONS', 'CREATE_WALLET', 'RESTORE_PIN', 'CREATE_TRANSACTION', 'ACCELERATE_TRANSACTION', 'CANCEL_TRANSACTION', 'CONTRACT_EXECUTION', 'SIGN_MESSAGE', 'SIGN_TYPEDDATA', 'SIGN_TRANSACTION')")
        return value
