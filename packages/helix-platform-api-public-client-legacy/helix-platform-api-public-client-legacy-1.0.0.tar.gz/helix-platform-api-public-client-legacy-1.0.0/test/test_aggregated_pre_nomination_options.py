...
from helix_platform_api_public_client_legacy.models.aggregated_pre_nomination_options import AggregatedPreNominationOptions  # noqa: E501
    ...
    def make_instance(self, include_optional) -> AggregatedPreNominationOptions:
        ...
        if include_optional:
            return AggregatedPreNominationOptions(
                long_term = [
                    helix_platform_api_public_client_legacy.models.aggregated_pre_nomination_options_timescale.AggregatedPreNominationOptionsTimescale(
                        direction = 'GB_FR', 
