...
class cli:
    ...
    class exec_gen_:
        ...
        def preparations(self):
            ...
            if not os.path.exists(self.target_file):
                print(f"Error: File '{self.target_file}' does not exist. \033[K\033[E\033[K\033[E\033[K\033[E\033[K\033[E")
                return
    ...
    class find_import:
        ...
        def main(self):
            ...
            self.target_file = os.path.join(current_dir, args.file)
