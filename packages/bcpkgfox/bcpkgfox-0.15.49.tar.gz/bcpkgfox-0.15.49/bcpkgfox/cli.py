        ...
        def run_pyinstaller(self):
            ...
            def print_footer():
                ...
                while not process_finished:
                    ...
                    sys.stdout.flush()
                    s += 1
                print("\033[3A \r\033[K \033[1B \r\033[K\033[1B \r\033[K\033[1B \r\033[K\033[1B \r\033[K")

            process_finished = False
            if self.cli.data_dict:
                command = ["pyinstaller",  "--onefile",  "--clean", "--add-data", '--add-data '.join(self.cli.data_dict), self.target_file]
                print(command)
                print(command)
                print(command)
                print(command)
