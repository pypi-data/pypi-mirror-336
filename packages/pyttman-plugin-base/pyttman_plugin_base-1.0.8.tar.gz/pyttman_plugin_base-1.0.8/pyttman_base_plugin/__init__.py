...
class PyttmanPlugin:
    ...
    class PluginInterceptPoint(enum.StrEnum):
        """
    ...
    def __init__(self,
                 allowed_intercepts: list[PluginInterceptPoint] or None = None,
                 app = None):
    ...
    def allowed_to_intercept_at(self, intercept: PluginInterceptPoint):
        """
    ...
    def before_router(self, message):
        """
    ...
    def before_intent(self, message):
        """
        Implement this method to interact with the processing
    ...
    def before_entity_extraction(self, message):
        """
        Implement this method to interact with the processing
    ...
    def after_entity_extraction(self, message):
        """
    ...
    def no_intent_match(self, message):
        """
