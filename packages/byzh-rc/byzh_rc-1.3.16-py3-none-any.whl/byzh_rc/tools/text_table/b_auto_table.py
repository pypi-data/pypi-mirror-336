...
class MyDict:
    def __init__(self, init_dict = None):
        ...
        if type(init_dict) is dict:
            self.dict = init_dict
        if init_dict is MyDict:
            self.dict = init_dict.dict
...
class BAutoTable:
    ...
    def copy_row(self, old_row:str, new_row:str):
        ...
        self.dict[new_row] = self.dict[old_row].copy()
    ...
    def _update_sidebars(self):
        self.x_sidebars = self.dict.keys()
    ...
    def __setitem__(self, index, value:dict):
