...
clinvar_info_lines = ['##INFO=<ID=clinvar_CLNSIG,Number=1,Type=String,Description="Estimated pathogenicity of genomic alteration">',
                      '##INFO=<clinvar_CLNREVSTAT>,Number=1,Type=String,Description="Review status of the ClinVar clinical significance estimation"',
                      '##INFO=<clinvar_CLINVARID>,Number=1,Type=String,Description="Variant Clinvar ID"',
                      '##INFO=<clinvar_CLNDN>,Number=1,Type=String,Description="Diseases associated with the variant"',
                      '##INFO=<clinvar_ALLELEID>,Number=1,Type=String,Description="Allele ID"'
                      ]
...
# Protein features
protein_features_info_lines = ['##INFO=<ID=PF,Number=1,Type=String,Description="Protein features">']
