...
.. list-table:: Basic terms
   ...
   * - dw_biot
     ...
     - :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio <multi_physics-biot>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`
   * - ev_biot_stress
   ...
   * - dw_diffusion
     ...
     - .. math::
            \int_{\Omega} K_{ij} \nabla_i q \nabla_j p
     - :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`bio <multi_physics-biot>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`
   ...
   * - dw_div_grad
     ...
     - :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`sto <navier_stokes-stokes>`
   * - dw_dot
     ...
     - :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`bor <quantum-boron>`, :ref:`wel <quantum-well>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`osc <quantum-oscillator>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`aco <acoustics-acoustics>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`hyd <quantum-hydrogen>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`bal <large_deformation-balloon>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`adv.2D <dg-advection_2D>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`adv.1D <dg-advection_1D>`
   * - dw_elastic_wave
   ...
   * - dw_integrate
     ...
     - :ref:`aco <acoustics-acoustics>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`dar.flo.mul <diffusion-darcy_flow_multicomp>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`poi.neu <diffusion-poisson_neumann>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`aco <acoustics-acoustics3d>`
   * - ev_integrate_mat
   ...
   * - dw_laplace
     ...
     - .. math::
            \int_{\Omega} c \nabla q \cdot \nabla p
     - :ref:`lap.1d <diffusion-laplace_1d>`, :ref:`lap.tim.ebc <diffusion-laplace_time_ebcs>`, :ref:`sin <diffusion-sinbc>`, :ref:`tim.adv.dif <diffusion-time_advection_diffusion>`, :ref:`bor <quantum-boron>`, :ref:`wel <quantum-well>`, :ref:`poi.fun <diffusion-poisson_functions>`, :ref:`osc <quantum-oscillator>`, :ref:`aco <acoustics-acoustics3d>`, :ref:`lap.2D <dg-laplace_2D>`, :ref:`poi.iga <diffusion-poisson_iga>`, :ref:`aco <acoustics-acoustics>`, :ref:`hel.apa <acoustics-helmholtz_apartment>`, :ref:`tim.poi.exp <diffusion-time_poisson_explicit>`, :ref:`poi.fie.dep.mat <diffusion-poisson_field_dependent_material>`, :ref:`tim.poi <diffusion-time_poisson>`, :ref:`poi.per.bou.con <diffusion-poisson_periodic_boundary_condition>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`ref.evp <miscellaneous-refine_evp>`, :ref:`adv.dif.2D <dg-advection_diffusion_2D>`, :ref:`lap.flu.2d <diffusion-laplace_fluid_2d>`, :ref:`the.ele <multi_physics-thermal_electric>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`bur.2D <dg-burgers_2D>`, :ref:`poi.par.stu <diffusion-poisson_parametric_study>`, :ref:`hyd <quantum-hydrogen>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`cub <diffusion-cube>`, :ref:`tim.hea.equ.mul.mat <diffusion-time_heat_equation_multi_material>`, :ref:`poi.sho.syn <diffusion-poisson_short_syntax>`, :ref:`poi <diffusion-poisson>`, :ref:`lap.cou.lcb <diffusion-laplace_coupling_lcbcs>`
   * - dw_lin_convect
   ...
   * - dw_lin_elastic
     ...
     - :ref:`mat.non <linear_elasticity-material_nonlinearity>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`two.bod.con <linear_elasticity-two_bodies_contact>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`bio.sho.syn <multi_physics-biot_short_syntax>`, :ref:`mul.nod.lcb <linear_elasticity-multi_node_lcbcs>`, :ref:`bio <multi_physics-biot>`, :ref:`lin.ela.mM <homogenization-linear_elastic_mM>`, :ref:`sei.loa <linear_elasticity-seismic_load>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`pie.ela <multi_physics-piezo_elasticity>`, :ref:`lin.ela.dam <linear_elasticity-linear_elastic_damping>`, :ref:`mod.ana.dec <linear_elasticity-modal_analysis_declarative>`, :ref:`bio.npb <multi_physics-biot_npbc>`, :ref:`lin.ela <linear_elasticity-linear_elastic>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`the.ela.ess <multi_physics-thermo_elasticity_ess>`, :ref:`ela.con.pla <linear_elasticity-elastic_contact_planes>`, :ref:`ela.con.sph <linear_elasticity-elastic_contact_sphere>`, :ref:`pre.fib <linear_elasticity-prestress_fibres>`, :ref:`lin.ela.iga <linear_elasticity-linear_elastic_iga>`, :ref:`pie.ela.mac <multi_physics-piezo_elasticity_macro>`, :ref:`the.ela <multi_physics-thermo_elasticity>`, :ref:`vib.aco <acoustics-vibro_acoustic3d>`, :ref:`its.4 <linear_elasticity-its2D_4>`, :ref:`pie.ela <multi_physics-piezo_elastodynamic>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`ela <linear_elasticity-elastodynamic>`, :ref:`bio.npb.lag <multi_physics-biot_npbc_lagrange>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`mul.poi.con <linear_elasticity-multi_point_constraints>`
   * - dw_lin_elastic_iso
   ...
   * - dw_point_load
     ...
     - .. math::
           ...
           \mbox{ in a region }
     - :ref:`she.can <linear_elasticity-shell10x_cantilever>`, :ref:`its.3 <linear_elasticity-its2D_3>`, :ref:`its.2 <linear_elasticity-its2D_2>`, :ref:`tru.bri <linear_elasticity-truss_bridge>`, :ref:`its.1 <linear_elasticity-its2D_1>`, :ref:`its.4 <linear_elasticity-its2D_4>`
   * - dw_point_lspring
   ...
   * - dw_stokes
     ...
     - .. math::
           ...
           \cdot \ul{u}
     - :ref:`lin.ela.up <linear_elasticity-linear_elastic_up>`, :ref:`nav.sto.iga <navier_stokes-navier_stokes2d_iga>`, :ref:`nav.sto <navier_stokes-navier_stokes>`, :ref:`nav.sto <navier_stokes-navier_stokes2d>`, :ref:`sto.sli.bc <navier_stokes-stokes_slip_bc>`, :ref:`sta.nav.sto <navier_stokes-stabilized_navier_stokes>`, :ref:`sto <navier_stokes-stokes>`
   * - dw_stokes_wave
   ...
   * - dw_surface_ltr
     ...
     - :ref:`tru.bri <linear_elasticity-truss_bridge3d>`, :ref:`lin.ela.tra <linear_elasticity-linear_elastic_tractions>`, :ref:`lin.vis <linear_elasticity-linear_viscoelastic>`, :ref:`lin.ela.opt <homogenization-linear_elasticity_opt>`, :ref:`ela.shi.per <linear_elasticity-elastic_shifted_periodic>`, :ref:`nod.lcb <linear_elasticity-nodal_lcbcs>`, :ref:`mix.mes <linear_elasticity-mixed_mesh>`, :ref:`wed.mes <linear_elasticity-wedge_mesh>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`
   * - ev_surface_moment
...
.. list-table:: Large deformation terms
   ...
   * - dw_tl_he_mooney_rivlin
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`hyp <large_deformation-hyperelastic>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`bal <large_deformation-balloon>`
   * - dw_tl_he_neohook
     ...
     - .. math::
            \int_{\Omega} S_{ij}(\ul{u}) \delta E_{ij}(\ul{u};\ul{v})
     - :ref:`hyp <large_deformation-hyperelastic>`, :ref:`act.fib <large_deformation-active_fibres>`, :ref:`per.tl <large_deformation-perfusion_tl>`, :ref:`com.ela.mat <large_deformation-compare_elastic_materials>`, :ref:`bal <large_deformation-balloon>`
   * - dw_tl_he_neohook_ad
