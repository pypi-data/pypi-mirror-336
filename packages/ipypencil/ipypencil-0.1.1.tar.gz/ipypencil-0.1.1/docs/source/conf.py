...
# -*- coding: utf-8 -*-
#
# ipypencil documentation build configuration file
#
...
project = 'ipypencil'
copyright = '2025, Matthias Fischer'
...
_version_py = os.path.join(repo, 'ipypencil', '_version.py')
version_ns = {}
...
htmlhelp_basename = 'ipypencildoc'
...
latex_documents = [
    (master_doc, 'ipypencil.tex', 'ipypencil Documentation',
     'Matthias Fischer', 'manual'),
]
