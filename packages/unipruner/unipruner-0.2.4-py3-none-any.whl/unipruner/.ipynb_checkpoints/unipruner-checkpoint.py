...
def get_expcon(logger):
    ...
    for i in ['media', 'binPM1', 'binPM2', 'binPM3', 'binPM4', 'authors']: 
    ...
    expcon['binPM1'] = exceldb.parse('binPM1')
    expcon['binPM2'] = exceldb.parse('binPM2')
    expcon['binPM3'] = exceldb.parse('binPM3')
    expcon['binPM4'] = exceldb.parse('binPM4')
    ...
    if force_inclusion != '-':
        ...
        for rid in forced_rids: 
            ...
            if rid not in modeled_rids:
                ...
                logger.info(f"Introduced reaction {rid} as orphan.")
            else:
