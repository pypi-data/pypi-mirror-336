...
class EasyVen:
    def setup( self,venv_name ):
        ...
        return self.bch_path, self.dst_path, self.cur_path, self.src_path, self.arc_path, self.lcl_path, self.bin_path, self.lib_path

if __name__ == "__main__":
    even = EasyVen()
    bch_path, dst_path, cur_path, src_path, arc_path, lcl_path, bin_path, lib_path = even.setup( venv_name = "kohya_env" )