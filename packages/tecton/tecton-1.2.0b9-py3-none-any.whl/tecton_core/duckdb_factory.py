...
def create_connection(duckdb_config: Optional[DuckDBConfig] = None) -> "DuckDBPyConnection":
    ...
    # pyiceberg is not a global dependency
    from tecton_core.iceberg_catalog import bucket_transform_general
    ...
    connection.create_function(BUCKET_TRANSFORM_FUN, bucket_transform_general, return_type=INTEGER)
    return connection
