...
class basic_data:
	...
	def __init__(self):
		...
		#액션들에대한 설명
		self.vars["action_name_vs_manual"] = {
		...
		self.vars["parameter_vs_parameter_option"]={
		...
		self.vars["action_name_vs_parameter_set_id"] = {
		...
		self.vars["parameter_set_id_vs_parameters"] = {'AutoFill': ['AutoFillSection', 'AutoFillItem'],
		...
		#모든 액션이름들
		self.vars["all_action_name"] = list(self.vars["action_name_vs_manual"].keys())

		#모든 파라미터그룹이름들
		self.vars["all_parameter_set_id"] = list(self.vars["parameter_set_id_vs_parameters"].keys())
