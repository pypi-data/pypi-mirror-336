...
class scolor:
	...
	def change_56color_no_to_color_name_kor(self, input_56color_no):
		...
		:return:
		"""
		result = self.vars["56color_vs_color_kor"][int(input_56color_no)]
		return result
	...
	def change_56color_to_color_kor(self, input_56color):
		...
		:return:
		"""
		result = self.vars["56color_vs_color_kor"][int(input_56color)]
		return result

	def change_56color_to_color_name(self, input_56color):
		"""
		엑셀의 56가지 색의 번호중하나를 입력하면 색이름으로 바꿔주는 것
		:param input_56color:
		:return:
		"""
		result = self.change_56color_to_color_kor(input_56color)
		return result

	def change_56color_to_rgb(self, i_no):
		"""
		엑셀 56색의 번호 -> rgb 리스트
	...
	def change_hsl_as_bright_level(self, input_hsl, strong_level=50):
		"""
	...
	def change_hsl_as_bright_up_by_0to100(self, input_hsl, strong_level=50):
		"""
		입력받은 input_hsl값을 명도가 높은 쪽으로 이동시키는것
	...
	def change_hsl_as_dark_level1(self, input_hsl, strong_level=0.5):
		"""
	...
	def change_hsl_as_dark_up_by_0to1(self, input_hsl, strong_level=0.5):
		"""
		입력받은 input_hsl값을 어두운 쪽으로 이동시키는것
	...
	def change_hsl_as_gray_level1(self, input_hsl, strong_level=0.5):
		"""
		입력받은 input_hsl값을 어두운 쪽으로 이동시키는것
	...
	def change_hsl_as_gray_up_by_0to1(self, input_hsl, strong_level=0.5):
		"""
		입력받은 input_hsl값을 어두운 쪽으로 이동시키는것
	...
	def change_hsl_as_high_bright(self, input_hsl):
		"""
	...
	def change_hsl_as_high_color(self, input_hsl):
		"""
	...
	def change_hsl_as_pastel_level1(self, input_hsl, strong_level=0.5):
		"""
	...
	def change_scolor_to_rgb_for_pastel_style(self, input_scolor, strong_level=0.5):
		input_hsl = self.change_scolor_to_hsl(input_scolor)
		hsl = self.change_hsl_as_pastel_level1(input_hsl, strong_level)
		rgb = self.change_hsl_to_rgb(hsl)
		return rgb

	def change_hsl_as_pastel_style(self, input_hsl, strong_level=0.5):
		"""
		입력받은 input_hsl값을 파스텔톤으로 적용시키는것
	...
	def change_hsl_as_vivid_by_0to1(self, input_hsl, strong_level=0.5):
		"""
		level1 : 0~1사이의값
		입력받은 input_hsl값을 어두운 쪽으로 이동시키는것
		bright = [100,100], sharp = [50,100], graish = [100,0], dark = [0,0], black = [50, 0]
	...
	def change_hsl_as_vivid_level1(self, input_hsl, strong_level=0.5):
		"""
		level1 : 0~1사이의값
		입력받은 input_hsl값을 어두운 쪽으로 이동시키는것
		bright = [100,100], sharp = [50,100], graish = [100,0], dark = [0,0], black = [50, 0]
	...
	def change_hsl_by_color_style(self, input_hsl, color_style="파스텔", style_step=5):
		"""
		...
		step_1 = self.vars["sl_10_by_작은step"][style_step]
		h = int(input_hsl[0])
	...
	def change_hsl_to_10_rgb_set_step_by_s(self, input_hsl, step=10):
		"""
	...
	def change_hsl_to_2_near_bo_by_h_level100(self, input_hsl, h_step=36):
		"""
		level100 : -100 ~ 100사이의 값
		근접보색조합 : 보색의 근처색
		분열보색조합 : Split Complementary
	...
	def change_hsl_to_2_side_color_by_h_level100(self, input_hsl, h_step=36):
		"""
		level100 : -100 ~ 100사이의 값
		근접색조합 : 양쪽 근처색
	...
	def change_hsl_to_2_side_color_by_l_level100(self, input_hsl, l_step=30):
		"""
		level100 : -100 ~ 100사이의 값
		명도차가 큰 2가지 1가지색
	...
	def change_hsl_to_2_side_color_by_s_level100(self, input_hsl, s_step=30):
		"""
		level100 : -100 ~ 100사이의 값
		채도차가 큰 2가지 1가지색
	...
	def change_hsl_to_2near_bo_hsl(self, input_hsl, h_step=36):
		"""
		근접보색조합 : 보색의 근처색
		분열보색조합 : Split Complementary
		근접보색조합 : 보색의 강한 인상이 부담스러울때 보색의 근처에 있는 색을 사용
	...
	def change_hsl_to_2near_bo_rgb(self, input_hsl, h_step=36):
		"""
		근접보색조합 : 보색의 양쪽 근처색
		분열보색조합 : Split Complementary
		근접보색조합 : 보색의 강한 인상이 부담스러울때 보색의 근처에 있는 색을 사용
	...
	def change_hsl_to_2near_rgb(self, input_hsl, h_step=36):
		"""
	...
	def change_hsl_to_bright_high(self, input_hsl):
		"""
		입력된 input_hsl값 -> 고명도로 바꾸는 것
		"""
		input_hsl[2] = 80
	...
	def change_hsl_to_color_high(self, input_hsl):
		"""
		입력된 input_hsl값 -> 고채도로 바꾸는 것
		"""
		input_hsl[1] = 80
	...
	def change_hsl_to_contrast_high(self, input_hsl):
		"""
	...
	def change_hsl_to_contrast_low(self, input_hsl):
		"""
	...
	def change_hsl_to_contrast_middle(self, input_hsl):
		"""
		입력된 input_hsl값 -> 중채도로 바꾸는 것
		"""
		input_hsl[0] = 50
	...
	def change_hsl_to_rgb_by_pccs_style(self, input_hsl, color_style="파스텔", style_step=5):
		...
		step_1 = self.vars["sl_10_by_작은step"][style_step]  # 스타일을 얼마나 강하게 적용할것인가를 나타내는것
	...
	def change_hsl_to_rgb_for_4_tetra_style(self, input_hsl):
		"""
		4가지 꼭지의 rgb값
	...
	def change_hsl_to_triangle_style(self, input_hsl):
		"""
		변경 : hsl -> rgb(120도 3개의 색으로 구분)
	...
	def change_input_color_to_hsl(self, input_color):
		...
		if type(input_color) == type("string"):  # 문자열 형식일때 scolor형식으로 해석
			hsl = self.change_scolor_to_hsl(input_color)
	...
	def change_rgb_to_12_rgb_for_pccs_list(self, input_rgb):
		"""
		pccs : 일본색체연구서가 빌표한 12가지 색으로 구분한것
		어떤 입력된 색의 기본적인 PCSS 12색을 돌려준다
		pccs톤, input_rgb로 넘어온 색을 pcss톤 12개로 만들어서 돌려준다
	...
	def change_rgb_to_close_56color(self, input_rgb):
		"""
		...
		var_56_rgb = self.vars["56color_vs_rgb"]
	...
	def change_rgb_to_hex(self, input_rgb):
		"""
	...
	def change_scolor_as_bright_by_0to1(self, input_scolor, step1=.3):
		"""
		scolor값을 0~1사이의 밝음정도로 색을 바꾸는 것
	...
	def change_scolor_as_dark_by_0to1(self, input_scolor, step1=.3):
		"""
		scolor값을 0~1사이의 어두운정도로 색을 바꾸는 것
	...
	def change_scolor_to_5_pastel_rgb(self, input_scolor):
		"""
		...
		result = []
		h, s, l = self.change_scolor_to_hsl(input_scolor)
	...
	def change_scolor_to_any_color(self, input_scolor):
		...
		color56 = self.change_rgb_to_close_56color(rgb)
	...
	def change_scolor_to_close_56color(self, input_scolor):
		"""
		...
		result = self.change_rgb_to_close_56color(rgb_value)
		return result

	def change_scolor_to_close_56color_no(self, input_scolor):
		"""
		scolor형식 : 12, "red", "red45", "red++"
	...
	def change_scolor_to_hsl(self, input_scolor):
		...
		if type(input_scolor) == type([]):  # 리스트형태 일때는 rgb로 인식
			...
			if value_only:
				...
				h_value, s_value, l_value = self.vars["basic_20color_name_eng_vs_hsl"][color_name]
	...
	def change_scolor_to_nth_near_rgb_set(self, input_scolor="red", step=10):
		"""
		...
		for no in range(0, 100, int(100 / step)):
			temp = self.change_scolor_to_rgb(input_scolor + str(no))
			result.append(temp)
		return result

	def change_scolor_to_pastel_style_by_level1(self, input_scolor, step1=.3):
		"""
		** 추후 사용하지 말아주세요
		control의 의미는 입력의 자료형태를 그대로 유지하면서 미세 조정을 하는것인데, 이것은 다른 의미이므로 사용을 저제 하여 주시기 바랍니다
		...
		"""
		hsl = self.change_scolor_to_hsl(input_scolor)
		result = self.change_hsl_as_pastel_level1(hsl, step1)
		return result
	...
	def change_scolor_to_rgb_with_tone(self, input_scolor="red45", color_style="파스텔", style_step=5):
		"""
		입력된 기본 값을 스타일에 맞도록 바꾸고, 스타일을 강하게 할것인지 아닌것인지를 보는것
		color_style : pccs의 12가지 사용가능, 숫자로 사용가능, +-의 형태로도 사용가능
		입력예 : 기본색상, 적용스타일, 변화정도,("red45, 파스텔, 3)
		...
		basic_hsl = self.change_scolor_to_hsl(input_scolor)
		# 스타일을 적용하는것
		aaa = self.vars["color_tone_12_names_vs_no"][color_style]
		step_2 = self.vars["sl_small_step_vs_sl_no"][aaa]
		# 스타일을 얼마나 강하게 적용할것인가를 나타내는것
		step_1 = self.vars["basic_9color_sl_big_step"][str(style_step)]
	...
	def change_scolor_to_vivid_style_by_level1(self, input_scolor, step1=.3):
		"""
		** 추후 사용하지 말아주세요
		control의 의미는 입력의 자료형태를 그대로 유지하면서 미세 조정을 하는것인데, 이것은 다른 의미이므로 사용을 저제 하여 주시기 바랍니다
		...
		"""
		hsl = self.change_scolor_to_hsl(input_scolor)
		result = self.change_hsl_as_vivid_level1(hsl, step1)
		return result
	...
	def control_hsl_by_color_style(self, input_hsl, color_style="파스텔", style_step=5):
		"""
		hsl값을 색의 스타일과 강도로써 조정하는 것
	...
	def control_hsl_to_high_bright(self, input_hsl):
		"""
		입력된 input_hsl값 -> 중명도로 바꾸는 것
		:param input_hsl: [h,s,l]형식의 값
		"""
	...
	def control_hsl_to_high_color_contrast(self, input_hsl):
		"""
		입력된 input_hsl값 -> 중채도로 바꾸는 것
		:param input_hsl: [h,s,l]형식의 값
		"""
	...
	def control_hsl_to_low_bright(self, input_hsl):
		"""
		입력된 input_hsl값 -> 저명도로 바꾸는 것 (저명도 : 명도값이 20%정도)
		:param input_hsl: [h,s,l]형식의 값
		"""
	...
	def control_hsl_to_low_color_contrast(self, input_hsl):
		"""
		입력된 input_hsl값 -> 저채도로 바꾸는 것
		:param input_hsl: [h,s,l]형식의 값
		"""
	...
	def control_hsl_to_middle_bright(self, input_hsl):
		"""
		입력된 input_hsl값 -> 중명도로 바꾸는 것
		:param input_hsl: [h,s,l]형식의 값
		"""
	...
	def control_hsl_to_middle_color_contrast(self, input_hsl):
		"""
		입력된 input_hsl값 -> 중채도로 바꾸는 것
		:param input_hsl: [h,s,l]형식의 값
		"""
	...
	def control_scolor_to_bright_style_by_level1(self, input_scolor, step1=.3):
		"""
		입력으로 들어오는 scolor를 밝아지는 스타일로 조정하는 것
		:param input_scolor: solor형태의 색깔입력, (12, "red", "red45", "red++")
		:param step1:
		:return:
		"""
	...
	def control_scolor_to_dark_style_by_level1(self, input_scolor, step1=.3):
		"""
		입력으로 들어오는 scolor를 어두어지는 스타일로 조정하는 것
	...
	def data_for_12_color_name(self):
		"""
		12가지 영어 색깔이름을 돌려준다
		"""
		result = self.vars["color_12_basic"]
		return result
	...
	def data_for_12_color_tone_kor(self):
		...
		칼라톤에 대한 한글이름
		"""
		result = self.vars["color_12_kor_basic"]
		return result
	...
	def data_for_12_hsl(self):
		...
		:return:
		"""
		result = self.vars["basic_12color_hsl"]
		return result
	...
	def data_for_12_hsl_for_pccs(self, hsl):
		...
		"""
		result = []
		for one_value in self.vars["basic_12color_hsl"]:
			temp = self.change_hsl_to_rgb([hsl[0], one_value[0], one_value[1]])
			result.append(temp)
		return result

	def data_for_12_pastel_color(self):
		"""
	...
	def data_for_12_pccs_name(self):
		"""
	...
	def data_for_12_pccs_name_kor(self):
		"""
	...
	def data_for_12_rgb(self):
		"""
		기본 12가지 색에 대한 rgb 리스트 값
		"""
		result = self.vars["basic_12color_rgb"]
		return result
	...
	def data_for_46_excel_rgb(self):
		"""
		엑셀 기본 46 rgb 값
		"""
		result = self.vars["rgb_46_for_excel46"]
		return result
	...
	def data_for_56_excel_rgb(self):
		...
		엑셀 기본 56 rgb 값
		"""
		result = self.vars["rgb_56_for_excel56"]
		return result
	...
	def data_for_8_pastel_rgb(self):
		...
		"""
		color_set = self.vars["basic_12color_hsl"][:-4]
		result = []
	...
	def data_for_all_color_name(self):
		"""
		모든 색깔의 이름들
		"""
	...
	def data_for_pccs_by_hsl_12(self, input_hsl):
		"""
		12가지 스타일의 input_hsl을 돌려주는 것이다
	...
	def get_faber_rgb_set(self, start_color=11, code=5):
		"""
		...
		:return:
		"""
		h_list = self.vars["basic_12color_hsl"]
	...
	def get_highlight_7_color_set(self):
		"""
		하이ㅏ이트에 사용가능한 7가지 rgb값
		:return:
		"""
		result = []
	...
	def get_johannes_rgb_set(self, start_color=11, num_color=4, stongness=5):
		"""
	...
	def get_nth_hsl_set_for_hsl_control_by_h(self, input_hsl, input_nth=10):
		"""
	...
	def get_nth_hsl_set_for_hsl_control_by_l(self, input_hsl, input_nth=10):
		"""
	...
	def get_nth_hsl_set_for_hsl_control_by_s(self, input_hsl, input_nth=10):
		"""
	...
	def get_nth_rgb_from_input_hsl_by_step_of_s(self, input_hsl, step=10):
		"""
		위쪽으로 5개, 아래로 5개의 채도가 비슷한 색을 돌려준다
		채도의 특성상 비슷한 부분이 많아서 10단위로 만든다
	...
	def get_nth_rgb_set_for_hsl_control_by_h(self, input_hsl, input_nth=10):
		"""
		입력으로 들어오는 갯수만큼의 h값을 변화시키면서 만드는 것
		sl은 그대로를 유지한다
		결과값 : rgb
	...
	def get_nth_rgb_set_for_hsl_control_by_l(self, input_hsl, input_nth=10):
		"""
		입력으로 들어오는 갯수만큼의 l값을 변화시키면서 만드는 것
		sl은 그대로를 유지한다
		결과값 : rgb
	...
	def get_nth_rgb_set_for_hsl_control_by_s(self, input_hsl, input_nth=10):
		"""
		입력으로 들어오는 갯수만큼의 s값을 변화시키면서 만드는 것
		sl은 그대로를 유지한다
		결과값 : rgb
	...
	def is_scolor_style(self, input_scolor):
		...
		result1 = self.xre.is_match_all("[한글&영어:2~10][숫자:0~7]", str(input_scolor))
		result2 = self.xre.is_match_all("[한글&영어:2~10][+-:0~7]", str(input_scolor))
	...
	def split_two_scolor_to_nth_rgb(self, scolor_1, scolor_2, step=10):
		"""
		두가지색을 기준으로 몇단계로 색을 만들어주는 기능
		예를들어, 발강 ~파랑사이의 색을 10단계로 만들어 주는 기능
	...
	def get_good_contrast_rgb_set(self):
		"""
