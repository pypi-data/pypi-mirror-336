...
class SearchItemsLocationType(BaseModel):
    """
    Attributes:
        value (Optional[str]): Select a location to associate with this item.To use a location, the Multi-Location
    ...
    @classmethod
    def from_dict(cls: Type["SearchItemsLocationType"], src_dict: Dict[str, Any]):
