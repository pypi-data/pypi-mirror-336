...
from ..models.create_vendor_response_subscriptions_list_subscriptions_subscription import (
    CreateVendorResponseSubscriptionsListSubscriptionsSubscription,
)
import datetime


class CreateVendorResponseSubscriptionsListSubscriptionsArrayItemRef(BaseModel):
    """
    Attributes:
        last_modified_date (Optional[datetime.datetime]): The Subscriptions list subscriptions last modified date
                Example: 2024-05-09T16:33:02+05:30.
        subscribed (Optional[bool]): The Subscriptions list subscriptions subscribed
        subscription (Optional[CreateVendorResponseSubscriptionsListSubscriptionsSubscription]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateVendorResponseSubscriptionsListSubscriptionsArrayItemRef"],
