...
from ..models.create_basic_contact_request_company import (
    CreateBasicContactRequestCompany,
)
from ..models.create_basic_contact_request_subsidiary import (
    CreateBasicContactRequestSubsidiary,
)


class CreateBasicContactRequest(BaseModel):
    """
    Attributes:
        last_name (str): The last name of the contact Example: Smith.
        company (Optional[CreateBasicContactRequestCompany]):
        ...
        subsidiary (Optional[CreateBasicContactRequestSubsidiary]):
    ...
    company: Optional["CreateBasicContactRequestCompany"] = Field(
    ...
    subsidiary: Optional["CreateBasicContactRequestSubsidiary"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CreateBasicContactRequest"], src_dict: Dict[str, Any]):
