...
from ..models.update_vendor_response_subscriptions_list_subscriptions_subscription import (
    UpdateVendorResponseSubscriptionsListSubscriptionsSubscription,
)
import datetime


class UpdateVendorResponseSubscriptionsListSubscriptionsArrayItemRef(BaseModel):
    """
    Attributes:
        ...
        subscription (Optional[UpdateVendorResponseSubscriptionsListSubscriptionsSubscription]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["UpdateVendorResponseSubscriptionsListSubscriptionsArrayItemRef"],
