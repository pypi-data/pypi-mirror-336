...
class SearchItemsDistributionNetworkType(BaseModel):
    """
    Attributes:
        value (Optional[str]): Choose the appropriate network to determine the distribution categories available to you.
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchItemsDistributionNetworkType"], src_dict: Dict[str, Any]
    ):
