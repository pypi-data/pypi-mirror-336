...
class SearchItemsDistributionCategoryType(BaseModel):
    """
    Attributes:
        value (Optional[str]): Choose the appropriate category. Once a distribution category is defined on the item
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchItemsDistributionCategoryType"], src_dict: Dict[str, Any]
    ):
