...
from ..models.create_vendor_request_address_2_country import (
    CreateVendorRequestAddress2Country,
)


class CreateVendorRequestAddress2(BaseModel):
    """
    Attributes:
        ...
        country (Optional[CreateVendorRequestAddress2Country]): The Address 2 country Example: _unitedStates.
    ...
    country: Optional["CreateVendorRequestAddress2Country"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CreateVendorRequestAddress2"], src_dict: Dict[str, Any]):
