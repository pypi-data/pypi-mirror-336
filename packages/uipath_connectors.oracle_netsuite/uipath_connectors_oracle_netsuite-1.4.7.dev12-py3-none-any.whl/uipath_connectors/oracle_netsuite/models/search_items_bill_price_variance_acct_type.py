...
class SearchItemsBillPriceVarianceAcctType(BaseModel):
    """
    Attributes:
        value (Optional[str]): Select the account to post to for variances in billing prices associated with this item.
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchItemsBillPriceVarianceAcctType"], src_dict: Dict[str, Any]
    ):
