...
from ..models.create_customer_response_address_2_country import (
    CreateCustomerResponseAddress2Country,
)


class CreateCustomerResponseAddress2(BaseModel):
    """
    Attributes:
        ...
        country (Optional[CreateCustomerResponseAddress2Country]): The Address 2 country Example: _india.
    ...
    country: Optional["CreateCustomerResponseAddress2Country"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateCustomerResponseAddress2"], src_dict: Dict[str, Any]
    ):
