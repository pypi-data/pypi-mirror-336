...
from ..models.create_customer_request_address_2_country import (
    CreateCustomerRequestAddress2Country,
)


class CreateCustomerRequestAddress2(BaseModel):
    """
    Attributes:
        addr1 (Optional[str]): The Address 2 addr 1 Example: gfgdsfg.
        addr2 (Optional[str]): The Address 2 addr 2 Example: tegf.
        city (Optional[str]): The Address 2 city Example: vizag.
        country (Optional[CreateCustomerRequestAddress2Country]): The Address 2 country Example: _india.
        ...
        state (Optional[str]): The Address 2 state Example: Telangana.
        zip_ (Optional[str]): The Address 2 zip Example: 6365656.
    """
    ...
    country: Optional["CreateCustomerRequestAddress2Country"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CreateCustomerRequestAddress2"], src_dict: Dict[str, Any]):
