...
class SearchItemsCustomFormType(BaseModel):
    """
    Attributes:
        value (Optional[str]): References an existing custom form for this record type. To ensure that field
    ...
    @classmethod
    def from_dict(cls: Type["SearchItemsCustomFormType"], src_dict: Dict[str, Any]):
