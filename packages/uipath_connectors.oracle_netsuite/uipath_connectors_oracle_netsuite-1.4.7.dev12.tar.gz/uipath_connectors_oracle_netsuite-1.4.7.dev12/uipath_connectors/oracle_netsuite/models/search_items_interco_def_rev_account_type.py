...
class SearchItemsIntercoDefRevAccountType(BaseModel):
    """
    Attributes:
        value (Optional[str]): Select the account to use for intercompany deferred revenue. This account is used to
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchItemsIntercoDefRevAccountType"], src_dict: Dict[str, Any]
    ):
