...
from ..models.create_customer_response_address_1_country import (
    CreateCustomerResponseAddress1Country,
)


class CreateCustomerResponseAddress1(BaseModel):
    """
    Attributes:
        ...
        country (Optional[CreateCustomerResponseAddress1Country]): The Address 1 country Example: _india.
    ...
    country: Optional["CreateCustomerResponseAddress1Country"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateCustomerResponseAddress1"], src_dict: Dict[str, Any]
    ):
