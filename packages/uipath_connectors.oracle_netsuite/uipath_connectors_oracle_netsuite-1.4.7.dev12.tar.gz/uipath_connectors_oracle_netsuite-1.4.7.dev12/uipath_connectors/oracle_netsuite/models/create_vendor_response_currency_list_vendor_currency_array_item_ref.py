...
from ..models.create_vendor_response_currency_list_vendor_currency_currency import (
    CreateVendorResponseCurrencyListVendorCurrencyCurrency,
)


class CreateVendorResponseCurrencyListVendorCurrencyArrayItemRef(BaseModel):
    """
    Attributes:
        balance (Optional[int]): The Currency list vendor currency balance
        currency (Optional[CreateVendorResponseCurrencyListVendorCurrencyCurrency]):
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateVendorResponseCurrencyListVendorCurrencyArrayItemRef"],
