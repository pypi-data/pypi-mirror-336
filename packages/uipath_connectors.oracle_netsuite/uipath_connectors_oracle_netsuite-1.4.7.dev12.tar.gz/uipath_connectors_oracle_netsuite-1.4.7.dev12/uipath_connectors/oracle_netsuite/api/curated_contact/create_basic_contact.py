...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateBasicContactResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateBasicContactResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Contact
     ...
     Creates and associates a contact to either a customer or a vendor
...
def sync(
    *,
    ...
    Returns:
        Union[CreateBasicContactResponse, DefaultError]
    """
