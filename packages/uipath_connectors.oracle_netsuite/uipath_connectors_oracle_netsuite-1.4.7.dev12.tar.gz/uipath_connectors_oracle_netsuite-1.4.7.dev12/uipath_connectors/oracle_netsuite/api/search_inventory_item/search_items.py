    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = SearchItems.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        mpn (Optional[str]): The manufacturer part number of the product
        upc_code (Optional[str]): The UPC code of the product
