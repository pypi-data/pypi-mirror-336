...
def sync_detailed(
    *,
    ...
    """Execute SuiteQL Query
     ...
     Execute a suiteQL query on Nestuite database. Only SELECT queries are supported.

    Args:
        limit (Optional[str]): The number of records to return
        offset (Optional[str]): The number of records to skip
        body (ExecuteSuiteQLQueryRequest):
