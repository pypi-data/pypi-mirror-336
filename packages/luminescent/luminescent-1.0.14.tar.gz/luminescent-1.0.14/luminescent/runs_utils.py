...
def make_simulation_movie(path, every=None, **kwargs):
    ...
    for i, fn in enumerate(fns):
        ...
        if i == 0:
            ...
            video = cv2.VideoWriter(
                MOVIE, 0x7634706d, every, (width, height))
...
def make_training_movie(every=2, **kwargs):
    1
    # path = lastrun(**kwargs)
    ...
    #     path, "training_video.mp4"), 0x7634706d, every, (width, height))
