#!/usr/bin/env python
"""
Package metadata for federated_content_connector.
"""
import os
import re
import sys
...
VERSION = get_version('federated_content_connector', '__init__.py')
...
setup(
    ...
    url='https://github.com/openedx/federated-content-connector',
    packages=find_packages(
        include=['federated_content_connector', 'federated_content_connector.*'],
        exclude=["*tests"],
    ),
    ...
    entry_points={
        'lms.djangoapp': [
            "federated_content_connector = federated_content_connector.apps:FederatedContentConnectorConfig",
        ],
    }
)
