...
def bounding_box(points: list[sp.Point2D]) -> tuple[sp.Point2D, sp.Expr, sp.Expr]:
...
# def revolve(center: sp.Point2D, point: sp.Point2D, angle: sp.S) -> sp.Point2D:
# def revolve(center: sp.Point2D, point: sp.Point2D, angle: sp.Expr) -> sp.Point2D:
def revolve(center: sp.Point2D, point: sp.Point2D, angle: Angle) -> sp.Point2D:
...
def shape_node_positions(edges: int, radius: sp.S, direction: sp.Point2D) -> list[sp.Point2D]:
    ...
    for _ in range(edges-1):
        revolved_position: sp.Point2D = revolve(center=_type(0, 0),
                                                point=positions[-1],
                                                angle=angle)
