...
class Svahnar(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Svahnar client instance.

        This automatically infers the `api_key` argument from the `SVAHNAR_API_KEY` environment variable if it is not provided.
        """
        if api_key is None:
            api_key = os.environ.get("SVAHNAR_API_KEY")
...
class AsyncSvahnar(AsyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncSvahnar client instance.
