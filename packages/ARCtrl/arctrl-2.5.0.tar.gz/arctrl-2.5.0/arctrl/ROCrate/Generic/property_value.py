...
class LDPropertyValue:
    ...
    def validate_component(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1477:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1476(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Component", pv.AdditionalType, ObjectExpr1477()) if LDPropertyValue.validate(pv, context) else False
    ...
    def validate_parameter_value(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1479:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1478(x: str, y: str) -> bool:
                    return x == y
        ...
        class ObjectExpr1481:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1480(x_1: str, y_1: str) -> bool:
                    return x_1 == y_1
        ...
        return (True if contains("ParameterValue", pv.AdditionalType, ObjectExpr1479()) else contains("ProcessParameterValue", pv.AdditionalType, ObjectExpr1481())) if LDPropertyValue.validate(pv, context) else False

    @staticmethod
    def validate_characteristic_value(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1483:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1482(x: str, y: str) -> bool:
                    return x == y
        ...
        class ObjectExpr1485:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1484(x_1: str, y_1: str) -> bool:
                    return x_1 == y_1
        ...
        return (True if contains("CharacteristicValue", pv.AdditionalType, ObjectExpr1483()) else contains("MaterialAttributeValue", pv.AdditionalType, ObjectExpr1485())) if LDPropertyValue.validate(pv, context) else False
    ...
    def validate_factor_value(pv: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1487:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1486(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("FactorValue", pv.AdditionalType, ObjectExpr1487()) if LDPropertyValue.validate(pv, context) else False
            ...
            if match_value is not None:
                if match_value_1 is not None:
                    if match_value_2 is not None:
                        def _arrow1488(__unit: None=None) -> bool:
    ...
    def validate_pub_med_id(pv: LDNode, context: LDContext | None=None) -> bool:
        if LDPropertyValue.validate(pv, context):
            ...
            if match_value is not None:
                if match_value_1 is not None:
                    if match_value_2 is not None:
                        def _arrow1489(__unit: None=None) -> bool:
                            value: str = match_value_1
                            id: str = match_value_2
    ...
    def gen_id(name: str, value: str | None=None, property_id: str | None=None, prefix: str | None=None) -> str:
        ...
        def _arrow1491(__unit: None=None) -> str:
            value_2: str = value
        ...
        return clean((_arrow1490() if (property_id is not None) else (((("#" + prefix_1) + "_") + name) + "")) if (value is None) else (_arrow1491() if (property_id is None) else _arrow1492()))
...
LDPropertyValue_reflection = _expr1493
