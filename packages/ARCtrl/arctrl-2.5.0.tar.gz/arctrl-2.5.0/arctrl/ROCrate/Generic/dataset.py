...
class LDDataset:
    ...
    def try_get_measurement_method_as_defined_term(lp: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        if match_value is not None:
            def _arrow1542(__unit: None=None) -> bool:
    ...
    def try_get_variable_measured_as_property_value(lp: LDNode, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        (pattern_matching_result, n_1) = (None, None)
        if match_value is not None:
            def _arrow1547(__unit: None=None) -> bool:
                n: LDNode = match_value
    ...
    def validate_investigation(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1549:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1548(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Investigation", lp.AdditionalType, ObjectExpr1549()) if LDDataset.validate(lp, context) else False
    ...
    def validate_study(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1551:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1550(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Study", lp.AdditionalType, ObjectExpr1551()) if LDDataset.validate(lp, context) else False

    @staticmethod
    def validate_assay(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1553:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1552(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Assay", lp.AdditionalType, ObjectExpr1553()) if LDDataset.validate(lp, context) else False
