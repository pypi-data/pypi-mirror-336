...
def encoder(dc: DataContext) -> IEncodable:
    ...
    def _arrow2760(oa: OntologyAnnotation, dc: Any=dc) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2763(oa_1: OntologyAnnotation, dc: Any=dc) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2764(oa_2: OntologyAnnotation, dc: Any=dc) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2768(value: str, dc: Any=dc) -> IEncodable:
    ...
    def _arrow2774(value_2: str, dc: Any=dc) -> IEncodable:
    ...
    def _arrow2777(value_4: str, dc: Any=dc) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("data", encoder_1(dc)), try_include("explication", _arrow2760, DataContext__get_Explication(dc)), try_include("unit", _arrow2763, DataContext__get_Unit(dc)), try_include("objectType", _arrow2764, DataContext__get_ObjectType(dc)), try_include("description", _arrow2768, DataContext__get_Description(dc)), try_include("generatedBy", _arrow2774, DataContext__get_GeneratedBy(dc)), try_include("label", _arrow2777, DataContext__get_Label(dc))]))
...
def _arrow2792(get: IGetters) -> DataContext:
    data: Data
    object_arg: IRequiredGetter = get.Required
    data = object_arg.Field("data", decoder_1)
    def _arrow2783(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("explication", OntologyAnnotation_decoder)

    def _arrow2787(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("unit", OntologyAnnotation_decoder)

    def _arrow2788(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("objectType", OntologyAnnotation_decoder)

    def _arrow2789(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("label", string)

    def _arrow2790(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("description", string)

    def _arrow2791(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("generatedBy", string)

    return DataContext__ctor_Z780A8A2A(data.ID, data.Name, data.DataType, data.Format, data.SelectorFormat, _arrow2783(), _arrow2787(), _arrow2788(), _arrow2789(), _arrow2790(), _arrow2791(), data.Comments)


decoder: Decoder_1[DataContext] = object(_arrow2792)
