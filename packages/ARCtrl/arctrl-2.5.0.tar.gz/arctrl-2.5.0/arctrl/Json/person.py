...
def ROCrate_Affiliation_encoder(affiliation: str) -> IEncodable:
    ...
    def _arrow2320(__unit: None=None, affiliation: Any=affiliation) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = of_array([("@type", ObjectExpr2317()), ("@id", _arrow2320()), ("name", ObjectExpr2323()), ("@context", context_jsonvalue)])
...
def _arrow2328(get: IGetters) -> str:
    object_arg: IRequiredGetter = get.Required
    return object_arg.Field("name", string)


ROCrate_Affiliation_decoder: Decoder_1[str] = object(_arrow2328)
...
def ROCrate_encoder(oa: Person) -> IEncodable:
    ...
    def _arrow2332(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2335(value_2: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2337(value_4: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2339(value_6: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2341(value_8: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr2340(IEncodable):
            def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                return helpers_5.encode_string(value_8)

        return ObjectExpr2340()

    def _arrow2343(value_10: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2345(value_12: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2347(value_14: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2349(value_16: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2350(affiliation: str, oa: Any=oa) -> IEncodable:
        return ROCrate_Affiliation_encoder(affiliation)

    def _arrow2351(oa_1: OntologyAnnotation, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2352(comment: Comment, oa: Any=oa) -> IEncodable:
        return ROCrate_encoderDisambiguatingDescription(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2332()), ("@type", ObjectExpr2333()), try_include("orcid", _arrow2335, oa.ORCID), try_include("firstName", _arrow2337, oa.FirstName), try_include("lastName", _arrow2339, oa.LastName), try_include("midInitials", _arrow2341, oa.MidInitials), try_include("email", _arrow2343, oa.EMail), try_include("phone", _arrow2345, oa.Phone), try_include("fax", _arrow2347, oa.Fax), try_include("address", _arrow2349, oa.Address), try_include("affiliation", _arrow2350, oa.Affiliation), try_include_seq("roles", _arrow2351, oa.Roles), try_include_seq("comments", _arrow2352, oa.Comments), ("@context", context_jsonvalue_1)]))
    ...
    return ObjectExpr2353()


def _arrow2365(get: IGetters) -> Person:
    def _arrow2354(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("orcid", string)
    ...
    def _arrow2357(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("midInitials", string)
    ...
    def _arrow2359(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("phone", string)

    def _arrow2360(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("fax", string)

    def _arrow2361(__unit: None=None) -> str | None:
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("address", string)

    def _arrow2362(__unit: None=None) -> str | None:
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("affiliation", ROCrate_Affiliation_decoder)

    def _arrow2363(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_19: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_ROCrate_decoderDefinedTerm)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("roles", arg_19)

    def _arrow2364(__unit: None=None) -> Array[Comment] | None:
        arg_21: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoderDisambiguatingDescription)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_21)

    return Person(_arrow2354(), _arrow2355(), _arrow2356(), _arrow2357(), _arrow2358(), _arrow2359(), _arrow2360(), _arrow2361(), _arrow2362(), _arrow2363(), _arrow2364())


ROCrate_decoder: Decoder_1[Person] = object(_arrow2365)
...
def ROCrate_encodeAuthorListString(author_list: str) -> IEncodable:
    def encode_single(name: str, author_list: Any=author_list) -> IEncodable:
        ...
        def _arrow2371(value_1: str, name: Any=name) -> IEncodable:
        ...
        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@type", ObjectExpr2367()), try_include("name", _arrow2371, name), ("@context", context_minimal_json_value)]))
...
def _arrow2381(get: IGetters) -> str:
    def _arrow2380(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("name", string)

    return default_arg(_arrow2380(), "")


ROCrate_decodeAuthorListString: Decoder_1[str] = map_3(ctor, array_3(object(_arrow2381)))
...
def ISAJson_encoder(id_map: Any | None, person: Person) -> IEncodable:
    def f(person_1: Person, id_map: Any=id_map, person: Any=person) -> IEncodable:
        ...
        def _arrow2385(value: str, person_1: Any=person_1) -> IEncodable:
            class ObjectExpr2384(IEncodable):
                def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                    return helpers.encode_string(value)

            return ObjectExpr2384()

        def _arrow2387(value_2: str, person_1: Any=person_1) -> IEncodable:
            class ObjectExpr2386(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr2386()

        def _arrow2389(value_4: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2391(value_6: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2393(value_8: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2396(value_10: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2399(value_12: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2401(value_14: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2403(value_16: str, person_1: Any=person_1) -> IEncodable:
        ...
        def _arrow2405(oa: OntologyAnnotation, person_1: Any=person_1) -> IEncodable:
            return OntologyAnnotation_encoder(oa)

        def _arrow2406(comment: Comment, person_1: Any=person_1) -> IEncodable:
            return encoder_1(comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2385, ROCrate_genID(person_2)), try_include("firstName", _arrow2387, person_2.FirstName), try_include("lastName", _arrow2389, person_2.LastName), try_include("midInitials", _arrow2391, person_2.MidInitials), try_include("email", _arrow2393, person_2.EMail), try_include("phone", _arrow2396, person_2.Phone), try_include("fax", _arrow2399, person_2.Fax), try_include("address", _arrow2401, person_2.Address), try_include("affiliation", _arrow2403, person_2.Affiliation), try_include_seq("roles", _arrow2405, person_2.Roles), try_include_seq("comments", _arrow2406, person_2.Comments)]))
    ...
    if id_map is not None:
        def _arrow2408(p_1: Person, id_map: Any=id_map, person: Any=person) -> str:
            return ROCrate_genID(p_1)

        return encode(_arrow2408, f, person, id_map)
...
def _arrow2419(get: IGetters) -> Person:
    def _arrow2409(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("lastName", string)

    def _arrow2410(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("firstName", string)

    def _arrow2411(__unit: None=None) -> str | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("midInitials", string)

    def _arrow2412(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("email", string)

    def _arrow2413(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("phone", string)

    def _arrow2414(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("fax", string)

    def _arrow2415(__unit: None=None) -> str | None:
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("address", string)

    def _arrow2416(__unit: None=None) -> str | None:
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("affiliation", string)

    def _arrow2417(__unit: None=None) -> Array[OntologyAnnotation] | None:
        arg_17: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("roles", arg_17)

    def _arrow2418(__unit: None=None) -> Array[Comment] | None:
        arg_19: Decoder_1[Array[Comment]] = resize_array(decoder_1)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Person_setOrcidFromComments(Person(None, _arrow2409(), _arrow2410(), _arrow2411(), _arrow2412(), _arrow2413(), _arrow2414(), _arrow2415(), _arrow2416(), _arrow2417(), _arrow2418()))


ISAJson_decoder: Decoder_1[Person] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2419)
