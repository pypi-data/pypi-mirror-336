...
IContext_reflection = _expr1658

def _arrow1665(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1659()), ("arc", ObjectExpr1660()), ("MaterialAttribute", ObjectExpr1661()), ("ArcMaterialAttribute", ObjectExpr1662()), ("characteristicType", ObjectExpr1663())])
...
context_jsonvalue: IEncodable = _arrow1665()
