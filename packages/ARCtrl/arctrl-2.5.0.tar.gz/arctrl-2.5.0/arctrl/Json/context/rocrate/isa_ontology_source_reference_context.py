...
IContext_reflection = _expr1696

def _arrow1705(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1697()), ("OntologySourceReference", ObjectExpr1698()), ("description", ObjectExpr1699()), ("name", ObjectExpr1700()), ("file", ObjectExpr1701()), ("version", ObjectExpr1702()), ("comments", ObjectExpr1703())])
    ...
    return ObjectExpr1704()


context_jsonvalue: IEncodable = _arrow1705()
