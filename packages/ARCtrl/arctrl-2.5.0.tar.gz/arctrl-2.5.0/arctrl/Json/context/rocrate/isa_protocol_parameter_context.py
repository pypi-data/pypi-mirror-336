...
def _arrow1781(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1771()), ("arc", ObjectExpr1773()), ("ProtocolParameter", ObjectExpr1774()), ("ArcProtocolParameter", ObjectExpr1776()), ("parameterName", ObjectExpr1777())])
