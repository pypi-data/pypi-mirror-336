...
class ARC:
    ...
    def try_load_async(arc_path: str) -> Async[FSharpResult_2[ARC, Array[str]]]:
        def _arrow3597(__unit: None=None) -> Async[FSharpResult_2[ARC, Array[str]]]:
            def _arrow3596(_arg: Array[str]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                arc: ARC = ARC.from_file_paths(to_array(_arg))
                contracts: Array[Contract] = arc.GetReadContracts()
                def _arrow3595(_arg_1: FSharpResult_2[Array[Contract], Array[str]]) -> Async[FSharpResult_2[ARC, Array[str]]]:
                ...
                return singleton.Bind(full_fill_contract_batch_async(arc_path, contracts), _arrow3595)

            return singleton.Bind(get_all_file_paths_async(arc_path), _arrow3596)
    ...
    def GetAssayRemoveContracts(self, assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3600(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3599:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3598(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(assay_identifier, i.AssayIdentifiers, ObjectExpr3599())
        ...
        def _arrow3603(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3602(__unit: None=None) -> IEnumerable_1[Contract]:
                ...
                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(isa)), delay(_arrow3601))

            return append(singleton_1(ARCtrl_ArcAssay__ArcAssay_ToDeleteContract(assay)), delay(_arrow3602))

        return to_array(delay(_arrow3603))
    ...
    def GetAssayRenameContracts(self, old_assay_identifier: str, new_assay_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3606(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3605:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3604(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_assay_identifier, i.AssayIdentifiers, ObjectExpr3605())
        ...
        def _arrow3608(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3607(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton_1(Contract.create_rename(old_assay_folder_path, new_assay_folder_path)), delay(_arrow3607))

        return to_array(delay(_arrow3608))
    ...
    def GetStudyRenameContracts(self, old_study_identifier: str, new_study_identifier: str) -> Array[Contract]:
        ...
        if match_value is None:
            ...
            def _arrow3611(__unit: None=None) -> bool:
                i: ArcInvestigation = match_value
                class ObjectExpr3610:
                    @property
                    def Equals(self) -> Callable[[str, str], bool]:
                        def _arrow3609(x: str, y: str) -> bool:
                            return x == y
                ...
                return contains(old_study_identifier, i.StudyIdentifiers, ObjectExpr3610())
        ...
        renamed_paths: Array[str] = map(mapping, paths, None)
        this.SetFilePaths(renamed_paths)
        def _arrow3613(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3612(__unit: None=None) -> IEnumerable_1[Contract]:
                return this.GetUpdateContracts()

            return append(singleton_1(Contract.create_rename(old_study_folder_path, new_study_folder_path)), delay(_arrow3612))

        return to_array(delay(_arrow3613))
    ...
    def WriteAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3615(__unit: None=None) -> Async[None]:
            def _arrow3614(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
            ...
            return singleton.Bind(this.TryWriteAsync(arc_path), _arrow3614)

        return singleton.Delay(_arrow3615)

    def UpdateAsync(self, arc_path: str) -> Async[None]:
        this: ARC = self
        def _arrow3617(__unit: None=None) -> Async[None]:
            def _arrow3616(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryUpdateAsync(arc_path), _arrow3616)

        return singleton.Delay(_arrow3617)

    def RemoveAssayAsync(self, arc_path: str, assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3619(__unit: None=None) -> Async[None]:
            def _arrow3618(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveAssayAsync(arc_path, assay_identifier), _arrow3618)
    ...
    def RenameAssayAsync(self, arc_path: str, old_assay_identifier: str, new_assay_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3621(__unit: None=None) -> Async[None]:
            def _arrow3620(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRenameAssayAsync(arc_path, old_assay_identifier, new_assay_identifier), _arrow3620)

        return singleton.Delay(_arrow3621)

    def RemoveStudyAsync(self, arc_path: str, study_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3623(__unit: None=None) -> Async[None]:
            def _arrow3622(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRemoveStudyAsync(arc_path, study_identifier), _arrow3622)
    ...
    def RenameStudyAsync(self, arc_path: str, old_study_identifier: str, new_study_identifier: str) -> Async[None]:
        this: ARC = self
        def _arrow3625(__unit: None=None) -> Async[None]:
            def _arrow3624(_arg: FSharpResult_2[Array[Contract], Array[str]]) -> Async[None]:
                result: FSharpResult_2[Array[Contract], Array[str]] = _arg
                if result.tag == 1:
                    def mapping(e: str) -> str:
                        return e
            ...
            return singleton.Bind(this.TryRenameStudyAsync(arc_path, old_study_identifier, new_study_identifier), _arrow3624)

        return singleton.Delay(_arrow3625)

    @staticmethod
    def load_async(arc_path: str) -> Async[ARC]:
        def _arrow3627(__unit: None=None) -> Async[ARC]:
            def _arrow3626(_arg: FSharpResult_2[ARC, Array[str]]) -> Async[ARC]:
            ...
            return singleton.Bind(ARC.try_load_async(arc_path), _arrow3626)
    ...
    def MakeDataFilesAbsolute(self, __unit: None=None) -> None:
        this: ARC = self
        class ObjectExpr3628:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        files_paths: Any = of_seq(this.FileSystem.Tree.ToFilePaths(), ObjectExpr3628())
        ...
        def update_column_option(data_name_function: Callable[[Data], str], col: CompositeColumn | None=None) -> None:
            ...
            if col is not None:
                def _arrow3629(__unit: None=None, data_name_function: Any=data_name_function, col: Any=col) -> bool:
    ...
    def GetUpdateContracts(self, __unit: None=None) -> Array[Contract]:
        this: ARC = self
        match_value: ArcInvestigation | None = this.ISA
        def _arrow3630(__unit: None=None) -> bool:
            inv: ArcInvestigation = match_value
            return inv.StaticHash == 0

        def _arrow3631(__unit: None=None) -> Array[Contract]:
            inv_1: ArcInvestigation = match_value
            return this.GetWriteContracts()

        def _arrow3645(__unit: None=None) -> Array[Contract]:
            inv_2: ArcInvestigation = match_value
            def _arrow3644(__unit: None=None) -> IEnumerable_1[Contract]:
                hash_1: int = inv_2.GetLightHashCode() or 0
                def _arrow3643(__unit: None=None) -> IEnumerable_1[Contract]:
                    inv_2.StaticHash = hash_1 or 0
                    def _arrow3636(s: ArcStudy) -> IEnumerable_1[Contract]:
                        hash_2: int = s.GetLightHashCode() or 0
                        def _arrow3635(__unit: None=None) -> IEnumerable_1[Contract]:
                            ...
                            if match_value_1 is not None:
                                if DataMap__get_StaticHash(match_value_1) == 0:
                                    ...
                                    def _arrow3634(__unit: None=None) -> bool:
                            ...
                            if pattern_matching_result == 0:
                                ...
                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForStudy_Z721C83C5(dm_2, s.Identifier)), delay(_arrow3632))

                            elif pattern_matching_result == 1:
                                def _arrow3633(__unit: None=None) -> IEnumerable_1[Contract]:
                                    DataMap__set_StaticHash_Z524259A4(dm_3, safe_hash(dm_3))
                                    return empty()

                                return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForStudy_Z721C83C5(dm_3, s.Identifier)), delay(_arrow3633))

                            elif pattern_matching_result == 2:
                                return empty()


                        return append(ARCtrl_ArcStudy__ArcStudy_ToCreateContract_6FCE9E49(s, True) if (s.StaticHash == 0) else (singleton_1(ARCtrl_ArcStudy__ArcStudy_ToUpdateContract(s)) if (s.StaticHash != hash_2) else empty()), delay(_arrow3635))

                    def _arrow3642(__unit: None=None) -> IEnumerable_1[Contract]:
                        def _arrow3641(a: ArcAssay) -> IEnumerable_1[Contract]:
                            hash_3: int = a.GetLightHashCode() or 0
                            def _arrow3640(__unit: None=None) -> IEnumerable_1[Contract]:
                                ...
                                if match_value_2 is not None:
                                    if DataMap__get_StaticHash(match_value_2) == 0:
                                        ...
                                        def _arrow3639(__unit: None=None) -> bool:
                                ...
                                if pattern_matching_result_1 == 0:
                                    ...
                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToCreateContractForAssay_Z721C83C5(dm_6, a.Identifier)), delay(_arrow3637))

                                elif pattern_matching_result_1 == 1:
                                    def _arrow3638(__unit: None=None) -> IEnumerable_1[Contract]:
                                        DataMap__set_StaticHash_Z524259A4(dm_7, safe_hash(dm_7))
                                        return empty()

                                    return append(singleton_1(ARCtrl_DataMap__DataMap_ToUpdateContractForAssay_Z721C83C5(dm_7, a.Identifier)), delay(_arrow3638))

                                elif pattern_matching_result_1 == 2:
                                    return empty()


                            return append(ARCtrl_ArcAssay__ArcAssay_ToCreateContract_6FCE9E49(a, True) if (a.StaticHash == 0) else (singleton_1(ARCtrl_ArcAssay__ArcAssay_ToUpdateContract(a)) if (a.StaticHash != hash_3) else empty()), delay(_arrow3640))

                        return collect(_arrow3641, inv_2.Assays)

                    return append(collect(_arrow3636, inv_2.Studies), delay(_arrow3642))

                return append(singleton_1(ARCtrl_ArcInvestigation__ArcInvestigation_ToUpdateContract(inv_2)) if (inv_2.StaticHash != hash_1) else empty(), delay(_arrow3643))

            return to_array(delay(_arrow3644))

        return (_arrow3631() if _arrow3630() else _arrow3645()) if (match_value is not None) else this.GetWriteContracts()
    ...
    def GetGitInitContracts(self, branch: str | None=None, repository_address: str | None=None, default_gitignore: bool | None=None) -> Array[Contract]:
        ...
        def _arrow3649(__unit: None=None) -> IEnumerable_1[Contract]:
            def _arrow3648(__unit: None=None) -> IEnumerable_1[Contract]:
                def _arrow3647(__unit: None=None) -> IEnumerable_1[Contract]:
                    ...
                    return append(singleton_1(gitignore_contract) if default_gitignore_1 else empty(), delay(_arrow3646))

                return append(singleton_1(gitattributes_contract), delay(_arrow3647))

            return append(singleton_1(Init_createInitContract_6DFDD678(branch)), delay(_arrow3648))

        return to_array(delay(_arrow3649))
    ...
    def GetRegisteredPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        ...
        def mapping_3(s_1: ArcStudy) -> Any:
            ...
            def _arrow3657(__unit: None=None, s_1: Any=s_1) -> IEnumerable_1[str]:
                def _arrow3656(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3655(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3654(table: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3653(kv: Any) -> IEnumerable_1[str]:
                                ...
                                def _arrow3652(__unit: None=None) -> IEnumerable_1[str]:
                                    ...
                                    return append(singleton_1(((((("" + study_foldername) + "/") + "resources") + "/") + text_value) + ""), delay(_arrow3651))

                                return append(singleton_1(text_value), delay(_arrow3652))

                            return collect(_arrow3653, table.Values)

                        return collect(_arrow3654, s_1.Tables)

                    return append(singleton_1(((("" + study_foldername) + "/") + "README.md") + ""), delay(_arrow3655))

                return append(singleton_1(((("" + study_foldername) + "/") + "isa.study.xlsx") + ""), delay(_arrow3656))
            ...
            return of_seq(to_list(delay(_arrow3657)), ObjectExpr3658())

        class ObjectExpr3659:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives
        ...
        def mapping_4(a: ArcAssay) -> Any:
            ...
            def _arrow3666(__unit: None=None, a: Any=a) -> IEnumerable_1[str]:
                def _arrow3665(__unit: None=None) -> IEnumerable_1[str]:
                    def _arrow3664(__unit: None=None) -> IEnumerable_1[str]:
                        def _arrow3663(table_1: ArcTable) -> IEnumerable_1[str]:
                            def _arrow3662(kv_1: Any) -> IEnumerable_1[str]:
                                ...
                                def _arrow3661(__unit: None=None) -> IEnumerable_1[str]:
                                    ...
                                    return append(singleton_1(((((("" + assay_foldername) + "/") + "dataset") + "/") + text_value_1) + ""), delay(_arrow3660))

                                return append(singleton_1(text_value_1), delay(_arrow3661))

                            return collect(_arrow3662, table_1.Values)

                        return collect(_arrow3663, a.Tables)

                    return append(singleton_1(((("" + assay_foldername) + "/") + "README.md") + ""), delay(_arrow3664))

                return append(singleton_1(((("" + assay_foldername) + "/") + "isa.assay.xlsx") + ""), delay(_arrow3665))
            ...
            return of_seq(to_list(delay(_arrow3666)), ObjectExpr3667())
        ...
        class ObjectExpr3669:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        include_files: Any = union_many(to_enumerable([of_seq(to_enumerable(["isa.investigation.xlsx", "README.md"]), ObjectExpr3650()), union_many(map(mapping_3, registered_studies, None), ObjectExpr3659()), union_many(map(mapping_4, registered_assays, None), ObjectExpr3668())]), ObjectExpr3669())
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        fs_copy: FileSystem = this._fs.Copy()
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3670(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow3670)(tree_1)

            else: 
                return tree_1


        def _arrow3672(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            def _arrow3671(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow3671)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3672()), FileSystemTree.from_file_paths([]))

    def GetAdditionalPayload(self, IgnoreHidden: bool | None=None) -> FileSystemTree:
        this: ARC = self
        ignore_hidden: bool = default_arg(IgnoreHidden, True)
        class ObjectExpr3673:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        registered_payload: Any = of_seq(FileSystemTree.to_file_paths()(this.GetRegisteredPayload()), ObjectExpr3673())
        def binder(tree_1: FileSystemTree) -> FileSystemTree | None:
            if ignore_hidden:
                def _arrow3674(n_1: str, tree_1: Any=tree_1) -> bool:
                    return not starts_with_exact(n_1, ".")

                return FileSystemTree.filter_folders(_arrow3674)(tree_1)

            else: 
                return tree_1


        def _arrow3676(__unit: None=None) -> FileSystemTree | None:
            tree: FileSystemTree
            def predicate(p: str) -> bool:
            ...
            tree = FileSystemTree.from_file_paths(paths)
            def _arrow3675(n: str) -> bool:
                return not starts_with_exact(n, ".")

            return FileSystemTree.filter_files(_arrow3675)(tree) if ignore_hidden else tree

        return default_arg(bind(binder, _arrow3676()), FileSystemTree.from_file_paths([]))

    @staticmethod
    def DefaultContracts() -> Any:
        class ObjectExpr3677:
            @property
            def Compare(self) -> Callable[[str, str], int]:
                return compare_primitives

        return of_seq_1(to_enumerable([(".gitignore", gitignore_contract), (".gitattributes", gitattributes_contract)]), ObjectExpr3677())
    ...
    def from_rocrate_json_string(s: str) -> ARC:
        try: 
            def _arrow3679(__unit: None=None) -> ArcInvestigation:
    ...
    def GetValidationPackagesConfigWriteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3682:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3681(x: str, y: str) -> bool:
                    return x == y
        ...
        if not contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3682()):
    ...
    def GetValidationPackagesConfigDeleteContract(self, vpc: ValidationPackagesConfig) -> Contract:
        this: ARC = self
        paths: Array[str] = this.FileSystem.Tree.ToFilePaths()
        class ObjectExpr3684:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow3683(x: str, y: str) -> bool:
                    return x == y
        ...
        if contains_2(ValidationPackagesConfigHelper_ConfigFilePath, paths, ObjectExpr3684()):
            def predicate(p: str) -> bool:
