...
LDRef_reflection = _expr1407

def LDRef__ctor_Z721C83C5(id: str) -> LDRef:
    return LDRef(id)


def _expr1412() -> TypeInfo:
...
class LDGraph(DynamicObj):
    ...
    def TryGetNode(self, id: str) -> LDNode | None:
        ...
        out_arg: LDNode = None
        def _arrow1408(__unit: None=None) -> LDNode:
            return out_arg

        def _arrow1409(v: LDNode) -> None:
            nonlocal out_arg
            out_arg = v

        match_value = (try_get_value(this.mappings, id, FSharpRef(_arrow1408, _arrow1409)), out_arg)
    ...
    def set_context(context: LDContext) -> Callable[[__G], None]:
        def _arrow1410(roc: __G | None=None) -> None:
    ...
    def try_get_context(__unit: None=None) -> Callable[[__F], LDContext | None]:
        def _arrow1411(roc: __F | None=None) -> LDContext | None:
...
class LDNode(DynamicObj):
    ...
    def GetPropertyValues(self, property_name: str, filter: Callable[[Any, LDContext | None], bool] | None=None, context: LDContext | None=None) -> Array[Any]:
        this: LDNode = self
        def _arrow1414(_arg: Any=None) -> Callable[[LDContext | None], bool]:
            def _arrow1413(_arg_1: LDContext | None=None) -> bool:
                return True

            return _arrow1413

        filter_1: Callable[[Any, LDContext | None], bool] = default_arg(map(curry2, filter), _arrow1414)
        match_value: Any | None = this.TryGetProperty(property_name, context)
        ...
        if pattern_matching_result == 0:
            ...
            en: IEnumerator[Any] = get_enumerator(e)
            def _arrow1417(__unit: None=None) -> IEnumerable_1[Any]:
                def _arrow1415(__unit: None=None) -> bool:
                    return en.System_Collections_IEnumerator_MoveNext()

                def _arrow1416(__unit: None=None) -> IEnumerable_1[Any]:
                ...
                return enumerate_while(_arrow1415, delay(_arrow1416))

            return list(to_list(delay(_arrow1417)))
    ...
    def TryGetPropertyAsSingleNode(self, property_name: str, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        if match_value is not None:
            if isinstance(value_3(match_value), LDNode):
                ...
                def _arrow1418(__unit: None=None) -> bool:
            ...
            if pattern_matching_result == 0:
                ...
                if match_value is None:
                    ...
                    if filter is None:
                        ...
                        def _arrow1419(f: Callable[[LDNode, LDContext | None], bool], o: Any=o) -> Callable[[LDNode, LDContext | None], bool]:
                            return curry2(f)

                        f_1: Callable[[LDNode, LDContext | None], bool] = map(_arrow1419, filter)
                        return n
                ...
                if filter is None:
                    ...
                    def _arrow1420(f: Callable[[LDNode, LDContext | None], bool], o: Any=o) -> Callable[[LDNode, LDContext | None], bool]:
                        return curry2(f)

                    f_3: Callable[[LDNode, LDContext | None], bool] = map(_arrow1420, filter)
                    return n_1
    ...
    def HasProperty(self, property_name: str, context: LDContext | None=None) -> bool:
        ...
        def _arrow1421(__unit: None=None) -> bool:
            v_2: Any = value_3(v)
            return False
        ...
        return (_arrow1421() if equals(value_3(v), None) else (_arrow1422() if is_iterable(value_3(v)) else True)) if (v is not None) else False
    ...
    def set_context(context: LDContext) -> Callable[[__C], None]:
        def _arrow1423(roc: __C | None=None) -> None:
            roc.SetContext(context)
    ...
    def try_get_context(__unit: None=None) -> Callable[[__B], LDContext | None]:
        def _arrow1424(roc: __B | None=None) -> LDContext | None:
            return roc.TryGetContext()
    ...
    def MergeAppendInto_InPlace(self, other: LDNode, flatten_to: LDGraph | None=None) -> None:
        ...
        if flatten_to is None:
            def _arrow1425(x: Any=None) -> Any:
                return x

            flatten_to_singleton = _arrow1425
        ...
        if flatten_to is None:
            def _arrow1426(x_1: Array[Any]) -> Array[Any]:
                return x_1

            flatten_to_ra = _arrow1426

        else: 
            graph_1: LDGraph = flatten_to
            def _arrow1427(a: Array[Any]) -> Array[Any]:
                return ResizeArray_map(flatten_to_singleton, a)

            flatten_to_ra = _arrow1427

        flatten_to_any: Callable[[Any], Any]
        if flatten_to is None:
            def _arrow1428(x_2: Any=None) -> Any:
                return x_2

            flatten_to_any = _arrow1428
            ...
            def f_2(o_1: Any=None) -> Any:
                if isinstance(o_1, LDNode):
                    ...
                    if active_pattern_result is not None:
                        ...
                        def _arrow1432(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[Any]:
                            def _arrow1429(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(e)

                            def _arrow1430(enumerator: IEnumerator[Any]) -> bool:
                                return enumerator.System_Collections_IEnumerator_MoveNext()

                            def _arrow1431(enumerator_1: IEnumerator[Any]) -> Any:
                                return enumerator_1.System_Collections_IEnumerator_get_Current()

                            return map_1(f_2, enumerate_from_functions(_arrow1429, _arrow1430, _arrow1431))

                        return list(to_list(delay(_arrow1432)))
        ...
        def action(pn: str) -> None:
            ...
            if match_value is None:
                ...
                if pattern_matching_result == 0:
                    def _arrow1442(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                        def _arrow1433(v_1: Any=None) -> Any:
                            return v_1

                        def _arrow1434(__unit: None=None) -> IEnumerator[Any]:
                            return get_enumerator(e2)

                        def _arrow1435(enumerator_2: IEnumerator[Any]) -> bool:
                            return enumerator_2.System_Collections_IEnumerator_MoveNext()

                        def _arrow1436(enumerator_3: IEnumerator[Any]) -> Any:
                            return enumerator_3.System_Collections_IEnumerator_get_Current()

                        def _arrow1441(__unit: None=None) -> IEnumerable_1[Any]:
                            def _arrow1437(v_2: Any=None) -> Any:
                                return v_2

                            def _arrow1438(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(e1)

                            def _arrow1439(enumerator_4: IEnumerator[Any]) -> bool:
                                return enumerator_4.System_Collections_IEnumerator_MoveNext()

                            def _arrow1440(enumerator_5: IEnumerator[Any]) -> Any:
                                return enumerator_5.System_Collections_IEnumerator_get_Current()

                            return map_1(_arrow1437, enumerate_from_functions(_arrow1438, _arrow1439, _arrow1440))

                        return append(map_1(_arrow1433, enumerate_from_functions(_arrow1434, _arrow1435, _arrow1436)), delay(_arrow1441))

                    class ObjectExpr1443:
                        @property
                    ...
                    l: Array[Any] = flatten_to_ra(list(List_distinctBy(to_equalitor, to_list(delay(_arrow1442)), ObjectExpr1443())))
                    ...
                    if active_pattern_result_3 is not None:
                        ...
                        def _arrow1448(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                            def _arrow1444(this_val_1: Any=None) -> IEnumerable_1[Any]:
                            ...
                            def _arrow1445(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(these_vals)

                            def _arrow1446(enumerator_6: IEnumerator[Any]) -> bool:
                                return enumerator_6.System_Collections_IEnumerator_MoveNext()

                            def _arrow1447(enumerator_7: IEnumerator[Any]) -> Any:
                                return enumerator_7.System_Collections_IEnumerator_get_Current()

                            return collect(_arrow1444, enumerate_from_functions(_arrow1445, _arrow1446, _arrow1447))

                        l_1: Array[Any] = list(to_list(delay(_arrow1448)))
                        if not is_contained:
                        ...
                        if active_pattern_result_4 is not None:
                            ...
                            def _arrow1455(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                                def _arrow1451(other_val_2: Any=None) -> IEnumerable_1[Any]:
                                    def _expr1449():
                                        nonlocal is_contained_1
                                        is_contained_1 = True
                                        return empty()

                                    def _arrow1450(__unit: None=None) -> IEnumerable_1[Any]:
                                        return singleton_2(other_val_2)

                                    return append(_expr1449() if equals(to_equalitor(this_val), to_equalitor(other_val_2)) else empty(), delay(_arrow1450))

                                def _arrow1452(__unit: None=None) -> IEnumerator[Any]:
                                    return get_enumerator(other_vals)

                                def _arrow1453(enumerator_8: IEnumerator[Any]) -> bool:
                                    return enumerator_8.System_Collections_IEnumerator_MoveNext()

                                def _arrow1454(enumerator_9: IEnumerator[Any]) -> Any:
                                    return enumerator_9.System_Collections_IEnumerator_get_Current()

                                return collect(_arrow1451, enumerate_from_functions(_arrow1452, _arrow1453, _arrow1454))

                            l_2: Array[Any] = list(to_list(delay(_arrow1455)))
    ...
    def Compact_InPlace(self, context: LDContext | None=None, set_context: bool | None=None) -> None:
        ...
        if context_1 is not None:
            ...
            def _arrow1457(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow1456(st: str) -> IEnumerable_1[str]:
                    match_value: str | None = context_2.TryGetTerm(st)
                    return singleton_2(st) if (match_value is None) else singleton_2(match_value)

                return collect(_arrow1456, this.SchemaType)

            new_types: Array[str] = list(to_list(delay(_arrow1457)))
        ...
        def compact_value_in_place(o: Any=None) -> Any:
            ...
            if pattern_matching_result == 0:
                ...
                en: IEnumerator[Any] = get_enumerator(e)
                def _arrow1460(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow1458(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow1459(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(compact_value_in_place(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow1458, delay(_arrow1459))

                l: Array[Any] = list(to_list(delay(_arrow1460)))
                if len(l) == 1:
                    return l[0]
    ...
    def Flatten(self, graph: LDGraph | None=None) -> LDGraph:
        ...
        def flatten_value(o: Any=None) -> Any:
            if isinstance(o, LDNode):
                ...
                def _arrow1463(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow1461(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow1462(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(flatten_value(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow1461, delay(_arrow1462))

                return list(to_list(delay(_arrow1463)))
    ...
    def Unflatten(self, graph: LDGraph) -> None:
        ...
        def unflatten_value(o: Any=None) -> Any:
            if isinstance(o, LDRef):
                ...
                en: IEnumerator[Any] = get_enumerator(o)
                def _arrow1466(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow1464(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow1465(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(unflatten_value(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow1464, delay(_arrow1465))

                return list(to_list(delay(_arrow1466)))
    ...
    def remove_context(__unit: None=None) -> Callable[[__A], bool]:
        def _arrow1467(roc: __A | None=None) -> bool:
    ...
    def try_from_dynamic_obj(dyn_obj: DynamicObj) -> LDNode | None:
        ...
        if pattern_matching_result_1 == 0:
            def _arrow1468(__unit: None=None) -> Array[str] | None:
            ...
            roc: LDNode = LDNode(id, st, _arrow1468())
