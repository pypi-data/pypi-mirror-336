...
def encode(encoder: Callable[[Any, Any, Any, _A], IEncodable], obj: Any) -> IEncodable:
    ...
    oa_table: Any = Dictionary([], ObjectExpr3366())
    ...
    cell_table: Any = Dictionary([], ObjectExpr3367())
    ...
    class ObjectExpr3368(IEncodable):
...
def decode(decoder: Callable[[Array[str], Array[OntologyAnnotation], Array[CompositeCell]], __A]) -> Decoder_1[Any]:
    def _arrow3370(get: IGetters, decoder: Any=decoder) -> __B:
        ...
        def _arrow3369(__unit: None=None) -> Array[CompositeCell]:
