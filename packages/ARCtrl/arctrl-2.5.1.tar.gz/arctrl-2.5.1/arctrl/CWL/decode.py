...
def _arrow552(value_2: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow551(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLOutput]:
            def _arrow550(key: str) -> IEnumerable_1[CWLOutput]:
                ...
                def _arrow549(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                    ...
                    def _arrow548(__unit: None=None) -> IEnumerable_1[CWLOutput]:
                        return singleton(output)

                    return append(_expr547() if (output_source is not None) else empty_1(), delay(_arrow548))

                return append(_expr546() if (output_binding is not None) else empty_1(), delay(_arrow549))

            return collect(_arrow550, dict_1.keys())

        return list(to_array(delay(_arrow551)))

    return object(getter, value_2)


Decode_outputArrayDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow552

def _arrow553(value: YAMLElement) -> Array[CWLOutput]:
    def getter(get: IGetters) -> Array[CWLOutput]:
        object_arg: IRequiredGetter = get.Required
...
Decode_outputsDecoder: Callable[[YAMLElement], Array[CWLOutput]] = _arrow553

def Decode_dockerRequirementDecoder(get: IGetters) -> DockerRequirement:
    def _arrow554(__unit: None=None, get: Any=get) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("dockerPull", string)

    def _arrow556(__unit: None=None, get: Any=get) -> Any | None:
        object_arg_1: IOptionalGetter = get.Optional
        def arg_3(value_1: YAMLElement) -> Any:
            def key_decoder(x: str, value_1: Any=value_1) -> str:
                return x

            def _arrow555(value_2: YAMLElement, value_1: Any=value_1) -> str:
                return string(value_2)

            return map_1(key_decoder, _arrow555, value_1)
    ...
    return DockerRequirement(_arrow554(), _arrow556(), _arrow557())
    ...
    def arg_1(value_6: YAMLElement, get: Any=get) -> Array[SoftwarePackage]:
        def decoder(value_5: YAMLElement, value_6: Any=value_6) -> SoftwarePackage:
            def getter(get2: IGetters, value_5: Any=value_5) -> SoftwarePackage:
                def _arrow560(__unit: None=None, get2: Any=get2) -> str:
                    object_arg_1: IRequiredGetter = get2.Required
                    return object_arg_1.Field("package", string)

                def _arrow562(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_2: IOptionalGetter = get2.Optional
                    def arg_5(value_1: YAMLElement) -> Array[str]:
                        def _arrow561(value_2: YAMLElement, value_1: Any=value_1) -> str:
                            return string(value_2)

                        return resizearray(_arrow561, value_1)

                    return object_arg_2.Field("version", arg_5)

                def _arrow564(__unit: None=None, get2: Any=get2) -> Array[str] | None:
                    object_arg_3: IOptionalGetter = get2.Optional
                    def arg_7(value_3: YAMLElement) -> Array[str]:
                        def _arrow563(value_4: YAMLElement, value_3: Any=value_3) -> str:
                            return string(value_4)

                        return resizearray(_arrow563, value_3)

                    return object_arg_3.Field("specs", arg_7)

                return SoftwarePackage(_arrow560(), _arrow562(), _arrow564())
...
def Decode_resourceRequirementDecoder(get: IGetters) -> ResourceRequirementInstance:
    def _arrow565(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg: IOptionalGetter = get.Optional
    ...
    def _arrow566(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_1: IOptionalGetter = get.Optional
    ...
    def _arrow567(__unit: None=None, get: Any=get) -> YAMLElement | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    return ResourceRequirementInstance__ctor_D76FC00(some(_arrow565()), some(_arrow566()), some(_arrow567()), some(_arrow568()), some(_arrow569()), some(_arrow570()), some(_arrow571()), some(_arrow572()))
...
def Decode_schemaDefRequirementDecoder(get: IGetters) -> Array[SchemaDefRequirementType]:
    ...
    def _arrow574(__unit: None=None, get: Any=get) -> Array[Any]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value_2: YAMLElement) -> Array[Any]:
            def decoder(value: YAMLElement, value_2: Any=value_2) -> Any:
                ...
                def _arrow573(value_1: YAMLElement, value: Any=value) -> str:
                    return string(value_1)

                return map_1(key_decoder, _arrow573, value)

            return resizearray(decoder, value_2)

        return object_arg.Field("types", arg_1)

    return ResizeArray_map(f, _arrow574())
...
def _arrow575(value_2: YAMLElement) -> Array[Requirement]:
...
Decode_requirementArrayDecoder: Callable[[YAMLElement], Array[Requirement]] = _arrow575

def _arrow576(value: YAMLElement) -> Array[Requirement] | None:
...
Decode_requirementsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow576

def _arrow577(value: YAMLElement) -> Array[Requirement] | None:
    def getter(get: IGetters) -> Array[Requirement] | None:
        object_arg: IOptionalGetter = get.Optional
...
Decode_hintsDecoder: Callable[[YAMLElement], Array[Requirement] | None] = _arrow577

def _arrow582(value_5: YAMLElement) -> InputBinding | None:
...
Decode_inputBindingDecoder: Callable[[YAMLElement], InputBinding | None] = _arrow582

def _arrow589(value_1: YAMLElement) -> Array[CWLInput]:
    def getter(get: IGetters) -> Array[CWLInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow588(__unit: None=None, get: Any=get) -> IEnumerable_1[CWLInput]:
            def _arrow587(key: str) -> IEnumerable_1[CWLInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                ...
                def _arrow586(__unit: None=None) -> IEnumerable_1[CWLInput]:
                    def _expr584():
                        set_optional_property("optional", True, input)
                        return empty_1()

                    def _arrow585(__unit: None=None) -> IEnumerable_1[CWLInput]:
                        return singleton(input)

                    return append(_expr584() if pattern_input[1] else empty_1(), delay(_arrow585))

                return append(_expr583() if (input_binding is not None) else empty_1(), delay(_arrow586))
...
Decode_inputArrayDecoder: Callable[[YAMLElement], Array[CWLInput]] = _arrow589

def _arrow590(value: YAMLElement) -> Array[CWLInput] | None:
...
Decode_inputsDecoder: Callable[[YAMLElement], Array[CWLInput] | None] = _arrow590

def _arrow592(value_2: YAMLElement) -> Array[str] | None:
    def getter(get: IGetters) -> Array[str] | None:
        object_arg: IOptionalGetter = get.Optional
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow591(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow591, value)
...
Decode_baseCommandDecoder: Callable[[YAMLElement], Array[str] | None] = _arrow592

def _arrow593(value_1: YAMLElement) -> str:
...
Decode_versionDecoder: Callable[[YAMLElement], str] = _arrow593

def _arrow594(value_1: YAMLElement) -> str:
    def getter(get: IGetters) -> str:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> str:
            return string(value)
...
Decode_classDecoder: Callable[[YAMLElement], str] = _arrow594

def Decode_stringOptionFieldDecoder(field: str) -> Callable[[YAMLElement], str | None]:
    def _arrow595(value_1: YAMLElement, field: Any=field) -> str | None:
...
def Decode_stringFieldDecoder(field: str) -> Callable[[YAMLElement], str]:
    def _arrow596(value_1: YAMLElement, field: Any=field) -> str:
        def getter(get: IGetters) -> str:
            object_arg: IRequiredGetter = get.Required
            def arg_1(value: YAMLElement, get: Any=get) -> str:
                return string(value)
...
def _arrow600(value_1: YAMLElement) -> Array[StepInput]:
    def getter(get: IGetters) -> Array[StepInput]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow599(__unit: None=None, get: Any=get) -> IEnumerable_1[StepInput]:
            def _arrow598(key: str) -> IEnumerable_1[StepInput]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                def _arrow597(__unit: None=None) -> str | None:
                ...
                return singleton(StepInput(key, _arrow597(), Decode_stringOptionFieldDecoder("default")(value), Decode_stringOptionFieldDecoder("valueFrom")(value)))

            return collect(_arrow598, dict_1.keys())

        return list(to_array(delay(_arrow599)))

    return object(getter, value_1)


Decode_inputStepDecoder: Callable[[YAMLElement], Array[StepInput]] = _arrow600

def _arrow602(value_2: YAMLElement) -> Array[str]:
    def getter(get: IGetters) -> Array[str]:
        object_arg: IRequiredGetter = get.Required
        def arg_1(value: YAMLElement, get: Any=get) -> Array[str]:
            def _arrow601(value_1: YAMLElement, value: Any=value) -> str:
                return string(value_1)

            return resizearray(_arrow601, value)
...
Decode_outputStepsDecoder: Callable[[YAMLElement], Array[str]] = _arrow602

def _arrow610(value_1: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        dict_1: Any = get.Overflow.FieldList(empty())
        def _arrow609(__unit: None=None, get: Any=get) -> IEnumerable_1[WorkflowStep]:
            def _arrow608(key: str) -> IEnumerable_1[WorkflowStep]:
                value: YAMLElement = get_item_from_dict(dict_1, key)
                run: str = Decode_stringFieldDecoder("run")(value)
                def _arrow603(get_1: IGetters) -> Array[StepInput]:
                    object_arg: IRequiredGetter = get_1.Required
                    return object_arg.Field("in", Decode_inputStepDecoder)

                inputs: Array[StepInput] = object(_arrow603, value)
                ...
                def _arrow607(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                    def _expr605():
                        wf_step.Hints = hints
                        return empty_1()

                    def _arrow606(__unit: None=None) -> IEnumerable_1[WorkflowStep]:
                        return singleton(wf_step)

                    return append(_expr605() if (hints is not None) else empty_1(), delay(_arrow606))

                return append(_expr604() if (requirements is not None) else empty_1(), delay(_arrow607))

            return collect(_arrow608, dict_1.keys())

        return list(to_array(delay(_arrow609)))

    return object(getter, value_1)


Decode_stepArrayDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow610

def _arrow611(value: YAMLElement) -> Array[WorkflowStep]:
    def getter(get: IGetters) -> Array[WorkflowStep]:
        object_arg: IRequiredGetter = get.Required
...
Decode_stepsDecoder: Callable[[YAMLElement], Array[WorkflowStep]] = _arrow611
