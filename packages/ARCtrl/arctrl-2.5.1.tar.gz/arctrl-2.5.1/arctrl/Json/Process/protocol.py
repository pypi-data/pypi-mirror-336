...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, oa: Protocol) -> IEncodable:
    ...
    def _arrow2455(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2458(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2459(oa_1: OntologyAnnotation, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2461(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2463(value_6: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2465(value_8: str, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2466(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_2(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2455()), ("@type", list_1_1(singleton(ObjectExpr2456()))), try_include("name", _arrow2458, oa.Name), try_include("protocolType", _arrow2459, oa.ProtocolType), try_include("description", _arrow2461, oa.Description), try_include("uri", _arrow2463, oa.Uri), try_include("version", _arrow2465, oa.Version), try_include_list_opt("components", ROCrate_encoder_1, oa.Components), try_include_list_opt("comments", _arrow2466, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2479(get: IGetters) -> Protocol:
    def _arrow2471(__unit: None=None) -> FSharpList[Component]:
        ...
        list_2: FSharpList[Component] = default_arg(_arrow2468(), empty())
        ...
        list_4 = append(default_arg(_arrow2469(), empty()), list_2)
        def _arrow2470(__unit: None=None) -> FSharpList[Component] | None:
        ...
        return append(default_arg(_arrow2470(), empty()), list_4)

    components: FSharpList[Component] | None = Option_fromValueWithDefault(empty(), _arrow2471())
    def _arrow2472(__unit: None=None) -> str | None:
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("@id", Decode_uri)

    def _arrow2473(__unit: None=None) -> str | None:
    ...
    def _arrow2478(__unit: None=None) -> FSharpList[Comment] | None:
        arg_19: Decoder_1[FSharpList[Comment]] = list_1_2(ROCrate_decoder_2)
        object_arg_9: IOptionalGetter = get.Optional
        return object_arg_9.Field("comments", arg_19)

    return Protocol(_arrow2472(), _arrow2473(), _arrow2474(), _arrow2475(), _arrow2476(), _arrow2477(), None, components, _arrow2478())


ROCrate_decoder: Decoder_1[Protocol] = object(_arrow2479)
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, process_name: str | None, id_map: Any | None, oa: Protocol) -> IEncodable:
    def f(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2483(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2485(value_2: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2484(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr2484()

        def _arrow2486(oa_2: OntologyAnnotation, oa_1: Any=oa_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2488(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2490(value_6: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2489(IEncodable):
                def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_3.encode_string(value_6)

            return ObjectExpr2489()

        def _arrow2492(value_8: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2493(value_10: ProtocolParameter, oa_1: Any=oa_1) -> IEncodable:
            return encoder(id_map, value_10)

        def _arrow2494(c: Component, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, c)

        def _arrow2495(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2483, ROCrate_genID(study_name, assay_name, process_name, oa_1)), try_include("name", _arrow2485, oa_1.Name), try_include("protocolType", _arrow2486, oa_1.ProtocolType), try_include("description", _arrow2488, oa_1.Description), try_include("uri", _arrow2490, oa_1.Uri), try_include("version", _arrow2492, oa_1.Version), try_include_list_opt("parameters", _arrow2493, oa_1.Parameters), try_include_list_opt("components", _arrow2494, oa_1.Components), try_include_list_opt("comments", _arrow2495, oa_1.Comments)]))
        class ObjectExpr2496(IEncodable):
        ...
        return ObjectExpr2496()

    if id_map is not None:
        def _arrow2497(p_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, process_name: Any=process_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(study_name, assay_name, process_name, p_1)

        return encode(_arrow2497, f, oa, id_map)
...
def _arrow2507(get: IGetters) -> Protocol:
    def _arrow2498(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2499(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2500(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_2: IOptionalGetter = get.Optional
    ...
    def _arrow2503(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("version", string)

    def _arrow2504(__unit: None=None) -> FSharpList[ProtocolParameter] | None:
        arg_13: Decoder_1[FSharpList[ProtocolParameter]] = list_1_2(decoder)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("parameters", arg_13)

    def _arrow2505(__unit: None=None) -> FSharpList[Component] | None:
        arg_15: Decoder_1[FSharpList[Component]] = list_1_2(ISAJson_decoder_1)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("components", arg_15)

    def _arrow2506(__unit: None=None) -> FSharpList[Comment] | None:
        arg_17: Decoder_1[FSharpList[Comment]] = list_1_2(ISAJson_decoder_2)
        object_arg_8: IOptionalGetter = get.Optional
        return object_arg_8.Field("comments", arg_17)

    return Protocol(_arrow2498(), _arrow2499(), _arrow2500(), _arrow2501(), _arrow2502(), _arrow2503(), _arrow2504(), _arrow2505(), _arrow2506())


ISAJson_decoder: Decoder_1[Protocol] = object(_arrow2507)
