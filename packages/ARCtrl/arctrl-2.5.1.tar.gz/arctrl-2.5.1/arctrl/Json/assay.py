...
def encoder(assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2856(__unit: None=None, assay: Any=assay) -> IEncodable:
    ...
    def _arrow2857(oa: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2858(oa_1: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2859(oa_2: OntologyAnnotation, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2860(dm: DataMap, assay: Any=assay) -> IEncodable:
        return encoder_4(dm)

    def _arrow2861(table: ArcTable, assay: Any=assay) -> IEncodable:
        return encoder_5(table)

    def _arrow2862(person: Person, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2863(comment: Comment, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2856()), try_include("MeasurementType", _arrow2857, assay.MeasurementType), try_include("TechnologyType", _arrow2858, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2859, assay.TechnologyPlatform), try_include("DataMap", _arrow2860, assay.DataMap), try_include_seq("Tables", _arrow2861, assay.Tables), try_include_seq("Performers", _arrow2862, assay.Performers), try_include_seq("Comments", _arrow2863, assay.Comments)]))
...
def _arrow2873(get: IGetters) -> ArcAssay:
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, assay: ArcAssay) -> IEncodable:
    ...
    def _arrow2877(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        value: str = assay.Identifier
    ...
    def _arrow2878(oa: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa)

    def _arrow2879(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2880(oa_2: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return OntologyAnnotation_encoder(oa_2)

    def _arrow2881(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2882(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2883(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_6(person)

    def _arrow2884(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, assay: Any=assay) -> IEncodable:
        return encoder_7(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2877()), try_include("MeasurementType", _arrow2878, assay.MeasurementType), try_include("TechnologyType", _arrow2879, assay.TechnologyType), try_include("TechnologyPlatform", _arrow2880, assay.TechnologyPlatform), try_include_seq("Tables", _arrow2881, assay.Tables), try_include("DataMap", _arrow2882, assay.DataMap), try_include_seq("Performers", _arrow2883, assay.Performers), try_include_seq("Comments", _arrow2884, assay.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcAssay]:
    def _arrow2894(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcAssay:
        ...
        return ArcAssay.create(_arrow2886(), _arrow2887(), _arrow2888(), _arrow2889(), _arrow2890(), _arrow2891(), _arrow2892(), _arrow2893())

    return object(_arrow2894)
...
def ROCrate_encoder(study_name: str | None, a: ArcAssay) -> IEncodable:
    ...
    def _arrow2898(__unit: None=None, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2902(__unit: None=None, study_name: Any=study_name, a: Any=a) -> IEncodable:
    ...
    def _arrow2904(oa: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderPropertyValue(oa)

    def _arrow2905(oa_1: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_1)

    def _arrow2906(oa_2: OntologyAnnotation, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa_2)

    def _arrow2907(oa_3: Person, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_1(oa_3)

    def _arrow2908(oa_4: Data, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_2(oa_4)

    def _arrow2910(__unit: None=None, study_name: Any=study_name, a: Any=a) -> Callable[[Process], IEncodable]:
        assay_name: str | None = a.Identifier
        def _arrow2909(oa_5: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, assay_name, oa_5)

        return _arrow2909

    def _arrow2911(comment: Comment, study_name: Any=study_name, a: Any=a) -> IEncodable:
        return ROCrate_encoder_4(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2898()), ("@type", list_1_1(singleton(ObjectExpr2899()))), ("additionalType", ObjectExpr2900()), ("identifier", _arrow2902()), ("filename", ObjectExpr2903()), try_include("measurementType", _arrow2904, a.MeasurementType), try_include("technologyType", _arrow2905, a.TechnologyType), try_include("technologyPlatform", _arrow2906, a.TechnologyPlatform), try_include_seq("performers", _arrow2907, a.Performers), try_include_list("dataFiles", _arrow2908, data_files), try_include_list("processSequence", _arrow2910(), processes), try_include_seq("comments", _arrow2911, a.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2920(get: IGetters) -> ArcAssay:
    def _arrow2913(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    identifier: str = default_arg(_arrow2913(), create_missing_identifier())
    ...
    def _arrow2917(__unit: None=None) -> OntologyAnnotation | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("technologyPlatform", OntologyAnnotation_ROCrate_decoderDefinedTerm)

    def _arrow2918(__unit: None=None) -> Array[Person] | None:
        arg_12: Decoder_1[Array[Person]] = resize_array(ROCrate_decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("performers", arg_12)

    def _arrow2919(__unit: None=None) -> Array[Comment] | None:
        arg_14: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_3)
        object_arg_6: IOptionalGetter = get.Optional
        return object_arg_6.Field("comments", arg_14)

    return ArcAssay(identifier, _arrow2915(), _arrow2916(), _arrow2917(), tables, None, _arrow2918(), _arrow2919())


ROCrate_decoder: Decoder_1[ArcAssay] = object(_arrow2920)
...
def ISAJson_encoder(study_name: str | None, id_map: Any | None, a: ArcAssay) -> IEncodable:
    def f(a_1: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> IEncodable:
        ...
        def _arrow2921(ps: FSharpList[Process], a_1: Any=a_1) -> IEncodable:
            return encoder_9(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow2921, Option_fromValueWithDefault(empty(), processes))
        ...
        def _arrow2925(value_5: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2926(oa_2: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_2)

        def _arrow2927(oa_3: OntologyAnnotation, a_1: Any=a_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow2929(value_7: str, a_1: Any=a_1) -> IEncodable:
        ...
        def _arrow2931(__unit: None=None, a_1: Any=a_1) -> Callable[[Process], IEncodable]:
            assay_name: str | None = a_1.Identifier
            def _arrow2930(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_2(study_name, assay_name, id_map, oa_4)

            return _arrow2930

        def _arrow2932(comment: Comment, a_1: Any=a_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("filename", ObjectExpr2923()), try_include("@id", _arrow2925, ROCrate_genID(a_1)), try_include("measurementType", _arrow2926, a_1.MeasurementType), try_include("technologyType", _arrow2927, a_1.TechnologyType), try_include("technologyPlatform", _arrow2929, map(mapping, a_1.TechnologyPlatform)), encoced_data_files, encoded_materials, encoded_characteristics, encoded_units, try_include_list("processSequence", _arrow2931(), processes), try_include_seq("comments", _arrow2932, a_1.Comments)]))
    ...
    if id_map is not None:
        def _arrow2934(a_2: ArcAssay, study_name: Any=study_name, id_map: Any=id_map, a: Any=a) -> str:
            return ROCrate_genID(a_2)

        return encode(_arrow2934, f, a, id_map)
...
def _arrow2941(get: IGetters) -> ArcAssay:
    def _arrow2935(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Assay_tryIdentifierFromFileName, _arrow2935()), create_missing_identifier())
    def mapping(arg_4: FSharpList[Process]) -> Array[ArcTable]:
        a: ArcTables = ARCtrl_ArcTables__ArcTables_fromProcesses_Static_62A3309D(arg_4)
        return a.Tables

    def _arrow2936(__unit: None=None) -> FSharpList[Process] | None:
        arg_3: Decoder_1[FSharpList[Process]] = list_1_2(ISAJson_decoder_1)
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("processSequence", arg_3)

    tables: Array[ArcTable] | None = map(mapping, _arrow2936())
    ...
    def _arrow2940(__unit: None=None) -> Array[Comment] | None:
        arg_12: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_2)
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("comments", arg_12)

    return ArcAssay(identifier, _arrow2937(), _arrow2938(), _arrow2939(), tables, None, None, _arrow2940())


ISAJson_decoder: Decoder_1[ArcAssay] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2941)
