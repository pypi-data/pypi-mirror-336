...
def encoder(study: ArcStudy) -> IEncodable:
    ...
    def _arrow2950(__unit: None=None, study: Any=study) -> IEncodable:
    ...
    def _arrow2952(value_1: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2954(value_3: str, study: Any=study) -> IEncodable:
        class ObjectExpr2953(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_3)

        return ObjectExpr2953()

    def _arrow2956(value_5: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2958(value_7: str, study: Any=study) -> IEncodable:
        class ObjectExpr2957(IEncodable):
            def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                return helpers_4.encode_string(value_7)

        return ObjectExpr2957()

    def _arrow2959(oa: Publication, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2960(person: Person, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2961(oa_1: OntologyAnnotation, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2962(table: ArcTable, study: Any=study) -> IEncodable:
        return encoder_7(table)

    def _arrow2963(dm: DataMap, study: Any=study) -> IEncodable:
        return encoder_8(dm)

    def _arrow2965(value_9: str, study: Any=study) -> IEncodable:
    ...
    def _arrow2966(comment: Comment, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2950()), try_include("Title", _arrow2952, study.Title), try_include("Description", _arrow2954, study.Description), try_include("SubmissionDate", _arrow2956, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2958, study.PublicReleaseDate), try_include_seq("Publications", _arrow2959, study.Publications), try_include_seq("Contacts", _arrow2960, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2961, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2962, study.Tables), try_include("DataMap", _arrow2963, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2965, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow2966, study.Comments)]))
...
def _arrow2980(get: IGetters) -> ArcStudy:
    ...
    return ArcStudy(_arrow2968(), _arrow2969(), _arrow2970(), _arrow2971(), _arrow2972(), _arrow2973(), _arrow2974(), _arrow2975(), _arrow2976(), _arrow2977(), _arrow2978(), _arrow2979())


decoder: Decoder_1[ArcStudy] = object(_arrow2980)
...
def encoder_compressed(string_table: Any, oa_table: Any, cell_table: Any, study: ArcStudy) -> IEncodable:
    ...
    def _arrow2984(__unit: None=None, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        value: str = study.Identifier
    ...
    def _arrow2986(value_1: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        class ObjectExpr2985(IEncodable):
            def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                return helpers_1.encode_string(value_1)

        return ObjectExpr2985()

    def _arrow2988(value_3: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        class ObjectExpr2987(IEncodable):
            def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                return helpers_2.encode_string(value_3)

        return ObjectExpr2987()

    def _arrow2990(value_5: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2992(value_7: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
    ...
    def _arrow2993(oa: Publication, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_5(oa)

    def _arrow2994(person: Person, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_6(person)

    def _arrow2995(oa_1: OntologyAnnotation, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return OntologyAnnotation_encoder(oa_1)

    def _arrow2996(table: ArcTable, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_1(string_table, oa_table, cell_table, table)

    def _arrow2997(dm: DataMap, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_compressed_2(string_table, oa_table, cell_table, dm)

    def _arrow2999(value_9: str, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        class ObjectExpr2998(IEncodable):
            def Encode(self, helpers_5: IEncoderHelpers_1[Any]) -> Any:
                return helpers_5.encode_string(value_9)

        return ObjectExpr2998()

    def _arrow3000(comment: Comment, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table, study: Any=study) -> IEncodable:
        return encoder_9(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("Identifier", _arrow2984()), try_include("Title", _arrow2986, study.Title), try_include("Description", _arrow2988, study.Description), try_include("SubmissionDate", _arrow2990, study.SubmissionDate), try_include("PublicReleaseDate", _arrow2992, study.PublicReleaseDate), try_include_seq("Publications", _arrow2993, study.Publications), try_include_seq("Contacts", _arrow2994, study.Contacts), try_include_seq("StudyDesignDescriptors", _arrow2995, study.StudyDesignDescriptors), try_include_seq("Tables", _arrow2996, study.Tables), try_include("DataMap", _arrow2997, study.DataMap), try_include_seq("RegisteredAssayIdentifiers", _arrow2999, study.RegisteredAssayIdentifiers), try_include_seq("Comments", _arrow3000, study.Comments)]))
...
def decoder_compressed(string_table: Array[str], oa_table: Array[OntologyAnnotation], cell_table: Array[CompositeCell]) -> Decoder_1[ArcStudy]:
    def _arrow3014(get: IGetters, string_table: Any=string_table, oa_table: Any=oa_table, cell_table: Any=cell_table) -> ArcStudy:
        def _arrow3002(__unit: None=None) -> str:
            object_arg: IRequiredGetter = get.Required
            return object_arg.Field("Identifier", string)

        def _arrow3003(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("Title", string)

        def _arrow3004(__unit: None=None) -> str | None:
            object_arg_2: IOptionalGetter = get.Optional
            return object_arg_2.Field("Description", string)

        def _arrow3005(__unit: None=None) -> str | None:
            object_arg_3: IOptionalGetter = get.Optional
            return object_arg_3.Field("SubmissionDate", string)

        def _arrow3006(__unit: None=None) -> str | None:
            object_arg_4: IOptionalGetter = get.Optional
            return object_arg_4.Field("PublicReleaseDate", string)

        def _arrow3007(__unit: None=None) -> Array[Publication] | None:
            arg_11: Decoder_1[Array[Publication]] = resize_array(decoder_2)
            object_arg_5: IOptionalGetter = get.Optional
            return object_arg_5.Field("Publications", arg_11)

        def _arrow3008(__unit: None=None) -> Array[Person] | None:
            arg_13: Decoder_1[Array[Person]] = resize_array(decoder_3)
            object_arg_6: IOptionalGetter = get.Optional
            return object_arg_6.Field("Contacts", arg_13)

        def _arrow3009(__unit: None=None) -> Array[OntologyAnnotation] | None:
            arg_15: Decoder_1[Array[OntologyAnnotation]] = resize_array(OntologyAnnotation_decoder)
            object_arg_7: IOptionalGetter = get.Optional
            return object_arg_7.Field("StudyDesignDescriptors", arg_15)

        def _arrow3010(__unit: None=None) -> Array[ArcTable] | None:
            arg_17: Decoder_1[Array[ArcTable]] = resize_array(decoder_compressed_1(string_table, oa_table, cell_table))
            object_arg_8: IOptionalGetter = get.Optional
            return object_arg_8.Field("Tables", arg_17)

        def _arrow3011(__unit: None=None) -> DataMap | None:
            arg_19: Decoder_1[DataMap] = decoder_compressed_2(string_table, oa_table, cell_table)
            object_arg_9: IOptionalGetter = get.Optional
            return object_arg_9.Field("DataMap", arg_19)

        def _arrow3012(__unit: None=None) -> Array[str] | None:
            arg_21: Decoder_1[Array[str]] = resize_array(string)
            object_arg_10: IOptionalGetter = get.Optional
            return object_arg_10.Field("RegisteredAssayIdentifiers", arg_21)

        def _arrow3013(__unit: None=None) -> Array[Comment] | None:
            arg_23: Decoder_1[Array[Comment]] = resize_array(decoder_6)
            object_arg_11: IOptionalGetter = get.Optional
            return object_arg_11.Field("Comments", arg_23)

        return ArcStudy(_arrow3002(), _arrow3003(), _arrow3004(), _arrow3005(), _arrow3006(), _arrow3007(), _arrow3008(), _arrow3009(), _arrow3010(), _arrow3011(), _arrow3012(), _arrow3013())

    return object(_arrow3014)
...
def ROCrate_encoder(assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    ...
    def _arrow3018(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3022(__unit: None=None, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3024(value_4: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3026(value_6: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3028(value_8: str, assays: Any=assays, s: Any=s) -> IEncodable:
    ...
    def _arrow3029(oa: OntologyAnnotation, assays: Any=assays, s: Any=s) -> IEncodable:
        return OntologyAnnotation_ROCrate_encoderDefinedTerm(oa)

    def _arrow3031(value_10: str, assays: Any=assays, s: Any=s) -> IEncodable:
        class ObjectExpr3030(IEncodable):
            def Encode(self, helpers_7: IEncoderHelpers_1[Any]) -> Any:
                return helpers_7.encode_string(value_10)

        return ObjectExpr3030()

    def _arrow3033(value_12: str, assays: Any=assays, s: Any=s) -> IEncodable:
        class ObjectExpr3032(IEncodable):
            def Encode(self, helpers_8: IEncoderHelpers_1[Any]) -> Any:
                return helpers_8.encode_string(value_12)

        return ObjectExpr3032()

    def _arrow3034(oa_1: Publication, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_1(oa_1)

    def _arrow3035(oa_2: Person, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_2(oa_2)

    def _arrow3037(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[Process], IEncodable]:
        study_name: str | None = s.Identifier
        def _arrow3036(oa_3: Process) -> IEncodable:
            return ROCrate_encoder_3(study_name, None, oa_3)

        return _arrow3036

    def _arrow3039(__unit: None=None, assays: Any=assays, s: Any=s) -> Callable[[ArcAssay], IEncodable]:
        study_name_1: str | None = s.Identifier
        def _arrow3038(a_1: ArcAssay) -> IEncodable:
            return ROCrate_encoder_4(study_name_1, a_1)

        return _arrow3038

    def _arrow3040(oa_4: Data, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_5(oa_4)

    def _arrow3041(comment: Comment, assays: Any=assays, s: Any=s) -> IEncodable:
        return ROCrate_encoder_6(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3018()), ("@type", list_1_1(singleton(ObjectExpr3019()))), ("additionalType", ObjectExpr3020()), ("identifier", _arrow3022()), try_include("filename", _arrow3024, file_name), try_include("title", _arrow3026, s.Title), try_include("description", _arrow3028, s.Description), try_include_seq("studyDesignDescriptors", _arrow3029, s.StudyDesignDescriptors), try_include("submissionDate", _arrow3031, s.SubmissionDate), try_include("publicReleaseDate", _arrow3033, s.PublicReleaseDate), try_include_seq("publications", _arrow3034, s.Publications), try_include_seq("people", _arrow3035, s.Contacts), try_include_list("processSequence", _arrow3037(), processes), try_include_seq("assays", _arrow3039(), assays_1), try_include_list("dataFiles", _arrow3040, get_data(processes)), try_include_seq("comments", _arrow3041, s.Comments), ("@context", context_jsonvalue)]))
    class ObjectExpr3042(IEncodable):
    ...
    return ObjectExpr3042()


def _arrow3053(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3043(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("filename", string)

    identifier: str = default_arg(bind(Study_tryIdentifierFromFileName, _arrow3043()), create_missing_identifier())
    ...
    def _arrow3052(__unit: None=None) -> Array[Comment] | None:
        arg_22: Decoder_1[Array[Comment]] = resize_array(ROCrate_decoder_5)
        object_arg_10: IOptionalGetter = get.Optional
        return object_arg_10.Field("comments", arg_22)

    return (ArcStudy(identifier, _arrow3045(), _arrow3046(), _arrow3047(), _arrow3048(), _arrow3049(), _arrow3050(), _arrow3051(), tables, None, assay_identifiers, _arrow3052()), default_arg(assays, empty()))


ROCrate_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = object(_arrow3053)
...
def ISAJson_encoder(id_map: Any | None, assays: FSharpList[ArcAssay] | None, s: ArcStudy) -> IEncodable:
    def f(s_1: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> IEncodable:
        ...
        def _arrow3054(ps: FSharpList[Process], s_1: Any=s_1) -> IEncodable:
            return encoder_12(id_map, ps)

        encoded_materials: tuple[str, IEncodable | None] = try_include("materials", _arrow3054, Option_fromValueWithDefault(empty(), processes))
        encoded_protocols: tuple[str, IEncodable | None]
        value_5: FSharpList[Protocol] = get_protocols(processes)
        def _arrow3056(__unit: None=None, s_1: Any=s_1) -> Callable[[Protocol], IEncodable]:
            study_name: str | None = s_1.Identifier
            def _arrow3055(oa_1: Protocol) -> IEncodable:
                return ISAJson_encoder_1(study_name, None, None, id_map, oa_1)

            return _arrow3055

        encoded_protocols = try_include_list("protocols", _arrow3056(), value_5)
        ...
        def _arrow3060(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3063(__unit: None=None, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3065(value_9: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3073(value_11: str, s_1: Any=s_1) -> IEncodable:
            class ObjectExpr3072(IEncodable):
                def Encode(self, helpers_4: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_4.encode_string(value_11)

            return ObjectExpr3072()

        def _arrow3075(value_13: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3078(value_15: str, s_1: Any=s_1) -> IEncodable:
        ...
        def _arrow3081(oa_2: Publication, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_2)

        def _arrow3082(person_2: Person, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, person_2)

        def _arrow3083(oa_3: OntologyAnnotation, s_1: Any=s_1) -> IEncodable:
            return OntologyAnnotation_ISAJson_encoder(id_map, oa_3)

        def _arrow3085(__unit: None=None, s_1: Any=s_1) -> Callable[[Process], IEncodable]:
            study_name_1: str | None = s_1.Identifier
            def _arrow3084(oa_4: Process) -> IEncodable:
                return ISAJson_encoder_4(study_name_1, None, id_map, oa_4)

            return _arrow3084

        def _arrow3087(__unit: None=None, s_1: Any=s_1) -> Callable[[ArcAssay], IEncodable]:
            study_name_2: str | None = s_1.Identifier
            def _arrow3086(a_2: ArcAssay) -> IEncodable:
                return ISAJson_encoder_5(study_name_2, id_map, a_2)

            return _arrow3086

        def _arrow3088(comment: Comment, s_1: Any=s_1) -> IEncodable:
            return ISAJson_encoder_6(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow3060()), ("filename", ObjectExpr3061()), ("identifier", _arrow3063()), try_include("title", _arrow3065, study.Title), try_include("description", _arrow3073, study.Description), try_include("submissionDate", _arrow3075, study.SubmissionDate), try_include("publicReleaseDate", _arrow3078, study.PublicReleaseDate), try_include_seq("publications", _arrow3081, study.Publications), try_include_seq("people", _arrow3082, study.Contacts), try_include_seq("studyDesignDescriptors", _arrow3083, study.StudyDesignDescriptors), encoded_protocols, encoded_materials, try_include_list("processSequence", _arrow3085(), processes), try_include_seq("assays", _arrow3087(), assays_1), encoded_factors, encoded_characteristics, encoded_units, try_include_seq("comments", _arrow3088, study.Comments)]))
    ...
    if id_map is not None:
        def _arrow3091(s_2: ArcStudy, id_map: Any=id_map, assays: Any=assays, s: Any=s) -> str:
            return ROCrate_genID(s_2)

        return encode(_arrow3091, f, s, id_map)
...
def _arrow3102(get: IGetters) -> tuple[ArcStudy, FSharpList[ArcAssay]]:
    def _arrow3092(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("identifier", string)

    def def_thunk(__unit: None=None) -> str:
        def _arrow3093(__unit: None=None) -> str | None:
            object_arg_1: IOptionalGetter = get.Optional
            return object_arg_1.Field("filename", string)

        return default_arg(bind(Study_tryIdentifierFromFileName, _arrow3093()), create_missing_identifier())

    identifier: str = default_arg_with(_arrow3092(), def_thunk)
    ...
    def _arrow3101(__unit: None=None) -> Array[Comment] | None:
        arg_25: Decoder_1[Array[Comment]] = resize_array(ISAJson_decoder_5)
        object_arg_11: IOptionalGetter = get.Optional
        return object_arg_11.Field("comments", arg_25)

    return (ArcStudy(identifier, _arrow3095(), _arrow3096(), _arrow3097(), _arrow3098(), _arrow3099(), None if (len(persons) == 0) else persons, _arrow3100(), tables, None, assay_identifiers, _arrow3101()), default_arg(assays, empty()))


ISAJson_decoder: Decoder_1[tuple[ArcStudy, FSharpList[ArcAssay]]] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow3102)
