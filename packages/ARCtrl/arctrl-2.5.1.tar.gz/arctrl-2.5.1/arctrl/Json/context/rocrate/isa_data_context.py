...
IContext_reflection = _expr1608

def _arrow1617(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1609()), ("Data", ObjectExpr1610()), ("type", ObjectExpr1611()), ("encodingFormat", ObjectExpr1612()), ("usageInfo", ObjectExpr1613()), ("name", ObjectExpr1614()), ("comments", ObjectExpr1615())])
...
context_jsonvalue: IEncodable = _arrow1617()
