...
IContext_reflection = _expr1590

def _arrow1596(__unit: None=None) -> IEncodable:
    class ObjectExpr1591(IEncodable):
    ...
    class ObjectExpr1593(IEncodable):
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1591()), ("Comment", ObjectExpr1592()), ("name", ObjectExpr1593()), ("value", ObjectExpr1594())])
    class ObjectExpr1595(IEncodable):
    ...
    return ObjectExpr1595()


context_jsonvalue: IEncodable = _arrow1596()
