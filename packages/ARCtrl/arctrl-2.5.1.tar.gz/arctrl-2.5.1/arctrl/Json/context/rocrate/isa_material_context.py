...
def _arrow1686(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1679()), ("bio", ObjectExpr1680()), ("Material", ObjectExpr1681()), ("type", ObjectExpr1682()), ("name", ObjectExpr1683()), ("characteristics", ObjectExpr1684())])
    ...
    return ObjectExpr1685()


context_jsonvalue: IEncodable = _arrow1686()
