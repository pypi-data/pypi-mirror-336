...
def _arrow1746(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1734()), ("bio", ObjectExpr1735()), ("Process", ObjectExpr1736()), ("name", ObjectExpr1737()), ("executesProtocol", ObjectExpr1738()), ("parameterValues", ObjectExpr1739()), ("performer", ObjectExpr1740()), ("date", ObjectExpr1741()), ("inputs", ObjectExpr1742()), ("outputs", ObjectExpr1743()), ("comments", ObjectExpr1744())])
...
context_jsonvalue: IEncodable = _arrow1746()
