...
IContext_reflection = _expr1774

def _arrow1781(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1775()), ("arc", ObjectExpr1776()), ("ProtocolParameter", ObjectExpr1777()), ("ArcProtocolParameter", ObjectExpr1778()), ("parameterName", ObjectExpr1779())])
...
context_jsonvalue: IEncodable = _arrow1781()
