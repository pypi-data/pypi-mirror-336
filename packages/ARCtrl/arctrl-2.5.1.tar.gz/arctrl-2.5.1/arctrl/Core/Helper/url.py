...
def _arrow496(tsr: str) -> Callable[[str], str]:
    def _arrow495(local_tan: str) -> str:
        return OntobeeDPBOParser(tsr, local_tan)

    return _arrow495


def _arrow498(tsr_1: str) -> Callable[[str], str]:
    def _arrow497(local_tan_1: str) -> str:
        return MSParser(tsr_1, local_tan_1)

    return _arrow497


def _arrow500(tsr_2: str) -> Callable[[str], str]:
    def _arrow499(local_tan_2: str) -> str:
        return POParser(tsr_2, local_tan_2)

    return _arrow499


def _arrow502(tsr_3: str) -> Callable[[str], str]:
    def _arrow501(local_tan_3: str) -> str:
        return ROParser(tsr_3, local_tan_3)

    return _arrow501


def _arrow504(tsr_4: str) -> Callable[[str], str]:
    def _arrow503(local_tan_4: str) -> str:
        return BioregistryParser(tsr_4, local_tan_4)

    return _arrow503


def _arrow506(tsr_5: str) -> Callable[[str], str]:
    def _arrow505(local_tan_5: str) -> str:
        return BioregistryParser(tsr_5, local_tan_5)

    return _arrow505


def _arrow508(tsr_6: str) -> Callable[[str], str]:
    def _arrow507(local_tan_6: str) -> str:
        return BioregistryParser(tsr_6, local_tan_6)

    return _arrow507


def _arrow510(tsr_7: str) -> Callable[[str], str]:
    def _arrow509(local_tan_7: str) -> str:
        return BioregistryParser(tsr_7, local_tan_7)

    return _arrow509


def _arrow512(tsr_8: str) -> Callable[[str], str]:
    def _arrow511(local_tan_8: str) -> str:
        return BioregistryParser(tsr_8, local_tan_8)

    return _arrow511


def _arrow514(tsr_9: str) -> Callable[[str], str]:
    def _arrow513(local_tan_9: str) -> str:
        return BioregistryParser(tsr_9, local_tan_9)

    return _arrow513


def _arrow516(tsr_10: str) -> Callable[[str], str]:
    def _arrow515(local_tan_10: str) -> str:
        return BioregistryParser(tsr_10, local_tan_10)

    return _arrow515


def _arrow518(tsr_11: str) -> Callable[[str], str]:
    def _arrow517(local_tan_11: str) -> str:
        return BioregistryParser(tsr_11, local_tan_11)

    return _arrow517


def _arrow520(tsr_12: str) -> Callable[[str], str]:
    def _arrow519(local_tan_12: str) -> str:
        return BioregistryParser(tsr_12, local_tan_12)

    return _arrow519


def _arrow522(tsr_13: str) -> Callable[[str], str]:
    def _arrow521(local_tan_13: str) -> str:
        return BioregistryParser(tsr_13, local_tan_13)

    return _arrow521


def _arrow524(tsr_14: str) -> Callable[[str], str]:
    def _arrow523(local_tan_14: str) -> str:
        return BioregistryParser(tsr_14, local_tan_14)

    return _arrow523


uri_parser_collection: Any = Dictionary_ofSeq(to_enumerable([("DPBO", _arrow496), ("MS", _arrow498), ("PO", _arrow500), ("RO", _arrow502), ("ENVO", _arrow504), ("CHEBI", _arrow506), ("GO", _arrow508), ("OBI", _arrow510), ("PATO", _arrow512), ("PECO", _arrow514), ("TO", _arrow516), ("UO", _arrow518), ("EFO", _arrow520), ("NCIT", _arrow522), ("OMP", _arrow524)]))
