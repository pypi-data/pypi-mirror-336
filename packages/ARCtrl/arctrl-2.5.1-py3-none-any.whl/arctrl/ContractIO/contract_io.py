...
def fulfill_read_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3444(__unit: None=None, e_1: Any=e_1) -> str:
            arg_4: str = str(e_1)
            return to_text(printf("Error reading contract %s: %s"))(c.Path)(arg_4)

        return FSharpResult_2(1, _arrow3444())

    def _arrow3450(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3447(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            ...
            if pattern_matching_result == 0:
                ...
                def _arrow3445(_arg: FsWorkbook) -> Async[FSharpResult_2[Contract, str]]:
                    return singleton.Return(FSharpResult_2(0, Contract(c.Operation, c.Path, c.DTOType, DTO_2(0, _arg))))

                return singleton.Bind(read_file_xlsx_async(path), _arrow3445)

            elif pattern_matching_result == 1:
                path_1: str = combine(base_path, c.Path)
                def _arrow3446(_arg_1: str) -> Async[FSharpResult_2[Contract, str]]:
                    return singleton.Return(FSharpResult_2(0, Contract(c.Operation, c.Path, c.DTOType, DTO_2(1, _arg_1))))

                return singleton.Bind(read_file_text_async(path_1), _arrow3446)
        ...
        def _arrow3449(_arg_2: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3448(__unit: None=None) -> str:
                arg_2: str = str(_arg_2)
                return to_text(printf("Error reading contract %s: %s"))(c.Path)(arg_2)

            return singleton.Return(FSharpResult_2(1, _arrow3448()))

        return singleton.TryWith(singleton.Delay(_arrow3447), _arrow3449)

    return catch_with(f, singleton.Delay(_arrow3450))
...
def fullfill_contract_batch_async_by(contract_f: Callable[[str, Contract], Async[FSharpResult_2[Contract, str]]], base_path: str, cs: Array[Contract]) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
    def _arrow3452(__unit: None=None, contract_f: Any=contract_f, base_path: Any=base_path, cs: Any=cs) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
        def _arrow3451(_arg: Array[FSharpResult_2[Contract, str]]) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
        ...
        return singleton.Bind(start_sequential(curry2(contract_f)(base_path), cs), _arrow3451)

    return singleton.Delay(_arrow3452)


def fulfill_write_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3453(__unit: None=None, e_1: Any=e_1) -> str:
            arg_4: str = str(e_1)
            return to_text(printf("Error writing contract %s: %s"))(c.Path)(arg_4)

        return FSharpResult_2(1, _arrow3453())

    def _arrow3463(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3460(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            ...
            if match_value is None:
                ...
                def _arrow3455(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path_2, ""), _arrow3454)

                return singleton.Bind(ensure_directory_of_file_async(path_2), _arrow3455)
                ...
                def _arrow3457(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path, t), _arrow3456)

                return singleton.Bind(ensure_directory_of_file_async(path), _arrow3457)
                ...
                def _arrow3459(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_xlsx_async(path_1, wb), _arrow3458)

                return singleton.Bind(ensure_directory_of_file_async(path_1), _arrow3459)

            else: 
                return singleton.Return(FSharpResult_2(1, to_text(printf("Contract %s is not an ISA contract"))(c.Path)))


        def _arrow3462(_arg_6: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3461(__unit: None=None) -> str:
                arg_2: str = str(_arg_6)
                return to_text(printf("Error writing contract %s: %s"))(c.Path)(arg_2)

            return singleton.Return(FSharpResult_2(1, _arrow3461()))

        return singleton.TryWith(singleton.Delay(_arrow3460), _arrow3462)

    return catch_with(f, singleton.Delay(_arrow3463))


def fulfill_update_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3464(__unit: None=None, e_1: Any=e_1) -> str:
            arg_4: str = str(e_1)
            return to_text(printf("Error updating contract %s: %s"))(c.Path)(arg_4)

        return FSharpResult_2(1, _arrow3464())

    def _arrow3474(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3471(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            match_value: DTO_2 | None = c.DTO
            if match_value is None:
                path_2: str = combine(base_path, c.Path)
                def _arrow3466(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path_2, ""), _arrow3465)

                return singleton.Bind(ensure_directory_of_file_async(path_2), _arrow3466)
                ...
                def _arrow3468(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_text_async(path, t), _arrow3467)

                return singleton.Bind(ensure_directory_of_file_async(path), _arrow3468)
                ...
                def _arrow3470(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                    ...
                    return singleton.Bind(write_file_xlsx_async(path_1, wb), _arrow3469)

                return singleton.Bind(ensure_directory_of_file_async(path_1), _arrow3470)

            else: 
                return singleton.Return(FSharpResult_2(1, to_text(printf("Contract %s is not an ISA contract"))(c.Path)))


        def _arrow3473(_arg_6: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3472(__unit: None=None) -> str:
                arg_2: str = str(_arg_6)
                return to_text(printf("Error updating contract %s: %s"))(c.Path)(arg_2)

            return singleton.Return(FSharpResult_2(1, _arrow3472()))

        return singleton.TryWith(singleton.Delay(_arrow3471), _arrow3473)

    return catch_with(f, singleton.Delay(_arrow3474))


def fullfill_rename_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3475(__unit: None=None, e_1: Any=e_1) -> str:
            arg_5: str = str(e_1)
            return to_text(printf("Error renaming contract %s: %s"))(c.Path)(arg_5)

        return FSharpResult_2(1, _arrow3475())

    def _arrow3480(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3477(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            match_value: DTO_2 | None = c.DTO
            ...
            if pattern_matching_result == 0:
                ...
                return singleton.Bind(rename_file_or_directory_async(old_path, new_path), _arrow3476)

            elif pattern_matching_result == 2:
                return singleton.Return(FSharpResult_2(1, to_text(printf("Rename Contract %s does not contain new Path"))(c.Path)))


        def _arrow3479(_arg_1: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3478(__unit: None=None) -> str:
                arg_3: str = str(_arg_1)
                return to_text(printf("Error renaming contract %s: %s"))(c.Path)(arg_3)

            return singleton.Return(FSharpResult_2(1, _arrow3478()))

        return singleton.TryWith(singleton.Delay(_arrow3477), _arrow3479)

    return catch_with(f, singleton.Delay(_arrow3480))


def fullfill_delete_contract_async(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e_1: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3481(__unit: None=None, e_1: Any=e_1) -> str:
            arg_3: str = str(e_1)
            return to_text(printf("Error deleting contract %s: %s"))(c.Path)(arg_3)

        return FSharpResult_2(1, _arrow3481())

    def _arrow3486(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
        def _arrow3483(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
            path: str = combine(base_path, c.Path)
            def _arrow3482(__unit: None=None) -> Async[FSharpResult_2[Contract, str]]:
                return singleton.Return(FSharpResult_2(0, c))

            return singleton.Bind(delete_file_or_directory_async(path), _arrow3482)

        def _arrow3485(_arg_1: Exception) -> Async[FSharpResult_2[Contract, str]]:
            def _arrow3484(__unit: None=None) -> str:
                arg_1: str = str(_arg_1)
                return to_text(printf("Error deleting contract %s: %s"))(c.Path)(arg_1)

            return singleton.Return(FSharpResult_2(1, _arrow3484()))

        return singleton.TryWith(singleton.Delay(_arrow3483), _arrow3485)

    return catch_with(f, singleton.Delay(_arrow3486))
...
def full_fill_contract(base_path: str, c: Contract) -> Async[FSharpResult_2[Contract, str]]:
    def f(e: Exception, base_path: Any=base_path, c: Any=c) -> FSharpResult_2[Contract, str]:
        def _arrow3487(__unit: None=None, e: Any=e) -> str:
            arg_2: str = str(e)
            return to_text(printf("Error fulfilling contract %s: %s"))(c.Path)(arg_2)

        return FSharpResult_2(1, _arrow3487())

    def _arrow3488(__unit: None=None, base_path: Any=base_path, c: Any=c) -> Async[FSharpResult_2[Contract, str]]:
    ...
    return catch_with(f, singleton.Delay(_arrow3488))


def full_fill_contract_batch_async(base_path: str, cs: Array[Contract]) -> Async[FSharpResult_2[Array[Contract], Array[str]]]:
    def _arrow3489(base_path_1: str, c: Contract, base_path: Any=base_path, cs: Any=cs) -> Async[FSharpResult_2[Contract, str]]:
        return full_fill_contract(base_path_1, c)

    return fullfill_contract_batch_async_by(_arrow3489, base_path, cs)
