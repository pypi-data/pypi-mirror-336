...
def to_fs_columns(dc: Array[DataContext]) -> FSharpList[FSharpList[FsCell]]:
    ...
    def _arrow1331(__unit: None=None, dc: Any=dc) -> IEnumerable_1[FSharpList[FsCell]]:
        def _arrow1329(__unit: None=None) -> IEnumerable_1[FSharpList[FsCell]]:
            def _arrow1328(dc_4: DataContext) -> FSharpList[FsCell]:
                dc_3: DataContext = dc_4
                def _arrow1327(__unit: None=None) -> IEnumerable_1[FsCell]:
                    def _arrow1319(__unit: None=None) -> FSharpList[FsCell]:
                    ...
                    def _arrow1326(__unit: None=None) -> IEnumerable_1[FsCell]:
                        def _arrow1325(__unit: None=None) -> IEnumerable_1[FsCell]:
                            def _arrow1324(__unit: None=None) -> IEnumerable_1[FsCell]:
                                def _arrow1323(__unit: None=None) -> IEnumerable_1[FsCell]:
                                    def _arrow1322(__unit: None=None) -> IEnumerable_1[FsCell]:
                                        ...
                                        return append(create_text(DataContext__get_GeneratedBy(dc_3)), delay(_arrow1321))

                                    return append(create_text(DataContext__get_Description(dc_3)), delay(_arrow1322))

                                return append(create_term(DataContext__get_ObjectType(dc_3)), delay(_arrow1323))

                            return append(create_term(DataContext__get_Unit(dc_3)), delay(_arrow1324))

                        return append(create_term(DataContext__get_Explication(dc_3)), delay(_arrow1325))

                    return append(_arrow1319(), delay(_arrow1326))

                return to_list(delay(_arrow1327))

            return map_1(_arrow1328, dc)

        return append(singleton_1(headers), delay(_arrow1329))

    return transpose(to_list(delay(_arrow1331)))
