...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2546(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2550(value_3: str, oa: Any=oa) -> IEncodable:
        class ObjectExpr2549(IEncodable):
            def Encode(self, helpers_3: IEncoderHelpers_1[Any]) -> Any:
                return helpers_3.encode_string(value_3)

        return ObjectExpr2549()

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2546()), ("@type", list_1_1(singleton(ObjectExpr2547()))), ("additionalType", ObjectExpr2548()), try_include("name", _arrow2550, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2555(get: IGetters) -> Source:
    ...
    def _arrow2552(__unit: None=None) -> str | None:
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("@id", Decode_uri)

    def _arrow2553(__unit: None=None) -> str | None:
        object_arg_5: IOptionalGetter = get.Optional
        return object_arg_5.Field("name", string)

    def _arrow2554(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2552(), _arrow2553(), _arrow2554())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2555)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2559(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2561(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2562(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2559, ROCrate_genID(oa_1)), try_include("name", _arrow2561, oa_1.Name), try_include_list_opt("characteristics", _arrow2562, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2564(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2564, f, oa, id_map)
...
def _arrow2568(get: IGetters) -> Source:
    ...
    def _arrow2567(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2565(), _arrow2566(), _arrow2567())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2568)
