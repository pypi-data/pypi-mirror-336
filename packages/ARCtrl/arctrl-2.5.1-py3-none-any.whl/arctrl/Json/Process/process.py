...
def ROCrate_encoder(study_name: str | None, assay_name: str | None, oa: Process) -> IEncodable:
    ...
    def _arrow2642(__unit: None=None, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    class ObjectExpr2643(IEncodable):
    ...
    def _arrow2645(value_2: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2646(oa_1: Protocol, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(study_name, assay_name, oa.Name, oa_1)

    def _arrow2647(author_list: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encodeAuthorListString(author_list)

    def _arrow2649(value_4: str, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2650(value_6: ProcessInput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_3(value_6)

    def _arrow2651(value_7: ProcessOutput, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_4(value_7)

    def _arrow2652(comment: Comment, study_name: Any=study_name, assay_name: Any=assay_name, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_5(comment)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2642()), ("@type", list_1_1(singleton(ObjectExpr2643()))), try_include("name", _arrow2645, oa.Name), try_include("executesProtocol", _arrow2646, oa.ExecutesProtocol), try_include_list_opt("parameterValues", ROCrate_encoder_2, oa.ParameterValues), try_include("performer", _arrow2647, oa.Performer), try_include("date", _arrow2649, oa.Date), try_include_list_opt("inputs", _arrow2650, oa.Inputs), try_include_list_opt("outputs", _arrow2651, oa.Outputs), try_include_list_opt("comments", _arrow2652, oa.Comments), ("@context", context_jsonvalue)]))
...
def _arrow2663(get: IGetters) -> Process:
    def _arrow2654(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2655(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2656(__unit: None=None) -> Protocol | None:
        object_arg_2: IOptionalGetter = get.Optional
        return object_arg_2.Field("executesProtocol", ROCrate_decoder_1)

    def _arrow2657(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
...
def ISAJson_encoder(study_name: str | None, assay_name: str | None, id_map: Any | None, oa: Process) -> IEncodable:
    def f(oa_1: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2667(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2669(value_2: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2670(oa_2: Protocol, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(study_name, assay_name, oa_1.Name, id_map, oa_2)

        def _arrow2671(oa_3: ProcessParameterValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_3)

        def _arrow2673(value_4: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2675(value_6: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2676(oa_4: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_4)

        def _arrow2677(oa_5: Process, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder(study_name, assay_name, id_map, oa_5)

        def _arrow2678(value_8: ProcessInput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, value_8)

        def _arrow2679(value_9: ProcessOutput, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_4(id_map, value_9)

        def _arrow2680(comment: Comment, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_5(id_map, comment)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2667, ROCrate_genID(oa_1)), try_include("name", _arrow2669, oa_1.Name), try_include("executesProtocol", _arrow2670, oa_1.ExecutesProtocol), try_include_list_opt("parameterValues", _arrow2671, oa_1.ParameterValues), try_include("performer", _arrow2673, oa_1.Performer), try_include("date", _arrow2675, oa_1.Date), try_include("previousProcess", _arrow2676, oa_1.PreviousProcess), try_include("nextProcess", _arrow2677, oa_1.NextProcess), try_include_list_opt("inputs", _arrow2678, oa_1.Inputs), try_include_list_opt("outputs", _arrow2679, oa_1.Outputs), try_include_list_opt("comments", _arrow2680, oa_1.Comments)]))
        class ObjectExpr2681(IEncodable):
        ...
        return ObjectExpr2681()

    if id_map is not None:
        def _arrow2682(p: Process, study_name: Any=study_name, assay_name: Any=assay_name, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(p)

        return encode(_arrow2682, f, oa, id_map)
...
def _arrow2695(__unit: None=None) -> Decoder_1[Process]:
    def decode(__unit: None=None) -> Decoder_1[Process]:
        def _arrow2694(get: IGetters) -> Process:
            def _arrow2683(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2684(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2685(__unit: None=None) -> Protocol | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("executesProtocol", ISAJson_decoder_1)

            def _arrow2686(__unit: None=None) -> FSharpList[ProcessParameterValue] | None:
                arg_7: Decoder_1[FSharpList[ProcessParameterValue]] = list_1_2(ISAJson_decoder_2)
                object_arg_3: IOptionalGetter = get.Optional
                return object_arg_3.Field("parameterValues", arg_7)

            def _arrow2687(__unit: None=None) -> str | None:
                object_arg_4: IOptionalGetter = get.Optional
