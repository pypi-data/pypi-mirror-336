...
def _arrow2580(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2581(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2582(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2583(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2580, ROCrate_decoder_1), map(_arrow2581, ROCrate_decoder_2), map(_arrow2582, ROCrate_decoder_3), map(_arrow2583, ROCrate_decoder_4)]))
...
def _arrow2585(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2586(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2587(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2588(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2585, ISAJson_decoder_1), map(_arrow2586, ISAJson_decoder_2), map(_arrow2587, ISAJson_decoder_3), map(_arrow2588, ISAJson_decoder_4)]))
