...
def encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1937(value: str, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1939(value_2: str, comment: Any=comment) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("name", _arrow1937, comment.Name), try_include("value", _arrow1939, comment.Value)]))
    ...
    return ObjectExpr1940()


def _arrow1943(get: IGetters) -> Comment:
    ...
    return Comment(_arrow1941(), _arrow1942())


decoder: Decoder_1[Comment] = object(_arrow1943)
...
def ROCrate_encoder(comment: Comment) -> IEncodable:
    ...
    def _arrow1947(__unit: None=None, comment: Any=comment) -> IEncodable:
        value: str = ROCrate_genID(comment)
        class ObjectExpr1946(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr1946()
    ...
    def _arrow1950(value_2: str, comment: Any=comment) -> IEncodable:
    ...
    def _arrow1952(value_4: str, comment: Any=comment) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow1947()), ("@type", ObjectExpr1948()), try_include("name", _arrow1950, comment.Name), try_include("value", _arrow1952, comment.Value), ("@context", context_jsonvalue)]))
...
def _arrow1956(get: IGetters) -> Comment:
    ...
    return Comment(_arrow1954(), _arrow1955())


ROCrate_decoder: Decoder_1[Comment] = object(_arrow1956)
...
def ISAJson_encoder(id_map: Any | None, comment: Comment) -> IEncodable:
    def f(comment_1: Comment, id_map: Any=id_map, comment: Any=comment) -> IEncodable:
        ...
        def _arrow1961(value: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        def _arrow1963(value_2: str, comment_1: Any=comment_1) -> IEncodable:
        ...
        def _arrow1965(value_4: str, comment_1: Any=comment_1) -> IEncodable:
            class ObjectExpr1964(IEncodable):
                def Encode(self, helpers_2: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_2.encode_string(value_4)

            return ObjectExpr1964()

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow1961, ROCrate_genID(comment_1)), try_include("name", _arrow1963, comment_1.Name), try_include("value", _arrow1965, comment_1.Value)]))
    ...
    if id_map is None:
        ...
        def _arrow1967(c: Comment, id_map: Any=id_map, comment: Any=comment) -> str:
            return ROCrate_genID(c)

        return encode(_arrow1967, f, comment, id_map)
