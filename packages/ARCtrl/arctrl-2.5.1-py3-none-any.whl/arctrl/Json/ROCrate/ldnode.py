...
def generic_encoder(obj: Any=None) -> IEncodable:
    if str(type(obj)) == "<class \'str\'>":
        ...
        def _arrow1886(__unit: None=None, obj: Any=obj) -> IEnumerable_1[IEncodable]:
            def _arrow1883(__unit: None=None) -> IEnumerator[Any]:
                return get_enumerator(obj)

            def _arrow1884(enumerator: IEnumerator[Any]) -> bool:
                return enumerator.System_Collections_IEnumerator_MoveNext()

            def _arrow1885(enumerator_1: IEnumerator[Any]) -> Any:
                return enumerator_1.System_Collections_IEnumerator_get_Current()

            return map(generic_encoder, enumerate_from_functions(_arrow1883, _arrow1884, _arrow1885))

        return list_1(to_list(delay(_arrow1886)))
...
def encoder(obj: LDNode) -> IEncodable:
    def _arrow1899(__unit: None=None, obj: Any=obj) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow1888(__unit: None=None) -> IEncodable:
            value: str = obj.Id
        ...
        def _arrow1898(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            def _arrow1890(value_1: str) -> IEncodable:
            ...
            def _arrow1897(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                def _arrow1892(value_3: str) -> IEncodable:
                ...
                def _arrow1896(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                    def _arrow1893(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                    ...
                    def _arrow1895(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                        def _arrow1894(kv: Any) -> IEnumerable_1[tuple[str, IEncodable]]:
                            l: str = kv[0].lower()
                        ...
                        return collect(_arrow1894, obj.GetProperties(True))

                    return append(_arrow1893(), delay(_arrow1895))

                return append(singleton(("additionalType", resize_array_or_singleton(_arrow1892, obj.AdditionalType))) if (len(obj.AdditionalType) != 0) else empty(), delay(_arrow1896))

            return append(singleton(("@type", resize_array_or_singleton(_arrow1890, obj.SchemaType))), delay(_arrow1897))

        return append(singleton(("@id", _arrow1888())), delay(_arrow1898))

    values: FSharpList[tuple[str, IEncodable]] = to_list(delay(_arrow1899))
...
def get_decoder(expect_object: bool) -> Decoder_1[Any]:
    def decode(expect_object_1: bool, expect_object: Any=expect_object) -> Decoder_1[Any]:
        class ObjectExpr1903(Decoder_1[LDNode]):
        ...
        decode_object: Decoder_1[LDNode] = ObjectExpr1903()
        class ObjectExpr1905(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow1904(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow1904())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr1905()
        if expect_object_1:
            def _arrow1906(value_4: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_4

            return map_1(_arrow1906, decode_object)

        else: 
            def _arrow1908(value_5: LDValue, expect_object_1: Any=expect_object_1) -> Any:
                return value_5

            def _arrow1909(value_6: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_6

            def _arrow1910(value_7: LDRef, expect_object_1: Any=expect_object_1) -> Any:
                return value_7

            def _arrow1911(value_8: Array[Any], expect_object_1: Any=expect_object_1) -> Any:
                return value_8

            def _arrow1912(value_9: str, expect_object_1: Any=expect_object_1) -> Any:
                return value_9

            def _arrow1913(value_10: int, expect_object_1: Any=expect_object_1) -> Any:
                return value_10

            def _arrow1914(value_11: Decimal, expect_object_1: Any=expect_object_1) -> Any:
                return value_11

            return one_of(of_array([map_1(_arrow1908, decoder_2), map_1(_arrow1909, decode_object), map_1(_arrow1910, decoder_3), map_1(_arrow1911, resize_array), map_1(_arrow1912, string), map_1(_arrow1913, int_1), map_1(_arrow1914, decimal)]))


    return decode(expect_object)


def _arrow1915(value: Any=None) -> LDNode:
    return value


decoder: Decoder_1[LDNode] = map_1(_arrow1915, get_decoder(True))
