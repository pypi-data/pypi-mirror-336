...
IContext_reflection = _expr1618

def _arrow1627(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1619()), ("Factor", ObjectExpr1620()), ("factorName", ObjectExpr1621()), ("annotationValue", ObjectExpr1622()), ("termSource", ObjectExpr1623()), ("termAccession", ObjectExpr1624()), ("comments", ObjectExpr1625())])
...
context_jsonvalue: IEncodable = _arrow1627()
