...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow455(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr454(IRequiredGetter):
            ...
            return ObjectExpr454()

        self.required: IRequiredGetter = _arrow455()
        def _arrow458(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr457(IOptionalGetter):
            ...
            return ObjectExpr457()

        self.optional: IOptionalGetter = _arrow458()
        def _arrow460(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr459(IMultipleOptionalGetter):
        ...
        self.multiple_optional: IMultipleOptionalGetter = _arrow460()
        def _arrow463(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr462(IOverflowGetter):
        ...
        self.overflow: IOverflowGetter = _arrow463()
