...
class LDDataset:
    ...
    def validate_investigation(lp: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1544:
            ...
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1543(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Investigation", lp.AdditionalType, ObjectExpr1544()) if LDDataset.validate(lp, context) else False
    ...
    def validate_study(lp: LDNode, context: LDContext | None=None) -> bool:
        ...
        return contains("Study", lp.AdditionalType, ObjectExpr1546()) if LDDataset.validate(lp, context) else False
    ...
    def validate_assay(lp: LDNode, context: LDContext | None=None) -> bool:
        ...
        return contains("Assay", lp.AdditionalType, ObjectExpr1548()) if LDDataset.validate(lp, context) else False
...
LDDataset_reflection = _expr1551
