...
def encoder(dm: DataMap) -> IEncodable:
    ...
    class ObjectExpr3384(IEncodable):
    ...
    return ObjectExpr3384()


def _arrow3386(get: IGetters) -> DataMap:
    def _arrow3385(__unit: None=None) -> Array[DataContext]:
        arg_1: Decoder_1[Array[DataContext]] = resize_array(decoder_1)
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("dataContexts", arg_1)

    return DataMap__ctor_4E3220A7(_arrow3385())


decoder: Decoder_1[DataMap] = object(_arrow3386)
