...
class LabProcess(LDNode):
    ...
    def get_name() -> Callable[[LabProcess], str]:
        def _arrow1532(lp: LabProcess) -> str:
            return lp.GetName()
    ...
    def get_agent() -> Callable[[LabProcess], str]:
        def _arrow1533(lp: LabProcess) -> str:
            return lp.GetAgent()
    ...
    def get_object() -> Callable[[LabProcess], str]:
        def _arrow1534(lp: LabProcess) -> str:
            return lp.GetObject()
    ...
    def get_result() -> Callable[[LabProcess], str]:
        def _arrow1535(lp: LabProcess) -> str:
            return lp.GetResult()

        return _arrow1535


LabProcess_reflection = _expr1536
