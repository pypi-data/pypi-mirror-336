...
class LDSample:
    ...
    def validate_sample(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1502:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1501(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Sample", s.AdditionalType, ObjectExpr1502()) if LDSample.validate(s, context) else False
    ...
    def validate_source(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1504:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1503(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Source", s.AdditionalType, ObjectExpr1504()) if LDSample.validate(s, context) else False

    @staticmethod
    def validate_material(s: LDNode, context: LDContext | None=None) -> bool:
        class ObjectExpr1506:
            @property
            def Equals(self) -> Callable[[str, str], bool]:
                def _arrow1505(x: str, y: str) -> bool:
                    return x == y
        ...
        return contains("Material", s.AdditionalType, ObjectExpr1506()) if LDSample.validate(s, context) else False
