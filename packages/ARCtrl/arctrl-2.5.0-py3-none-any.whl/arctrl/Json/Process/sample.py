...
def ROCrate_encoder(oa: Sample) -> IEncodable:
    ...
    def _arrow2591(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    class ObjectExpr2592(IEncodable):
    ...
    def _arrow2595(value_5: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2596(x: IEncodable, oa: Any=oa) -> IEncodable:
        return x

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2591()), ("@type", list_1_2(singleton(ObjectExpr2592()))), ("additionalType", ObjectExpr2593()), try_include("name", _arrow2595, oa.Name), try_include_list("additionalProperties", _arrow2596, additional_properties), ("@context", context_jsonvalue)]))
...
class ObjectExpr2599(Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]]):
    def Decode(self, s: IDecoderHelpers_1[Any], json: Any) -> FSharpResult_2[tuple[MaterialAttributeValue | None, FactorValue | None], tuple[str, ErrorReason_1[__A_]]]:
        def _arrow2598(__unit: None=None) -> str:
        ...
        if (_arrow2598() if s.has_property("additionalType", json) else "") == "FactorValue":
...
ROCrate_additionalPropertyDecoder: Decoder_1[tuple[MaterialAttributeValue | None, FactorValue | None]] = ObjectExpr2599()

def _arrow2603(get: IGetters) -> Sample:
    ...
    def _arrow2602(__unit: None=None) -> FSharpList[Source] | None:
        arg_15: Decoder_1[FSharpList[Source]] = list_1_3(ROCrate_decoder_3)
        object_arg_7: IOptionalGetter = get.Optional
        return object_arg_7.Field("derivesFrom", arg_15)

    return Sample(_arrow2600(), _arrow2601(), pattern_input[0], pattern_input[1], _arrow2602())


ROCrate_decoder: Decoder_1[Sample] = object(_arrow2603)
...
def ISAJson_encoder(id_map: Any | None, oa: Sample) -> IEncodable:
    def f(oa_1: Sample, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2607(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2609(value_2: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2608(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr2608()

        def _arrow2610(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        def _arrow2611(fv: FactorValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_2(id_map, fv)

        def _arrow2612(oa_3: Source, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_3(id_map, oa_3)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2607, ROCrate_genID(oa_1)), try_include("name", _arrow2609, oa_1.Name), try_include_list_opt("characteristics", _arrow2610, oa_1.Characteristics), try_include_list_opt("factorValues", _arrow2611, oa_1.FactorValues), try_include_list_opt("derivesFrom", _arrow2612, oa_1.DerivesFrom)]))
        class ObjectExpr2613(IEncodable):
        ...
        return ObjectExpr2613()

    if id_map is not None:
        def _arrow2614(s_1: Sample, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2614, f, oa, id_map)
...
def _arrow2620(get: IGetters) -> Sample:
    def _arrow2615(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2616(__unit: None=None) -> str | None:
        object_arg_1: IOptionalGetter = get.Optional
        return object_arg_1.Field("name", string)

    def _arrow2617(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    def _arrow2618(__unit: None=None) -> FSharpList[FactorValue] | None:
        arg_7: Decoder_1[FSharpList[FactorValue]] = list_1_3(ISAJson_decoder_2)
        object_arg_3: IOptionalGetter = get.Optional
        return object_arg_3.Field("factorValues", arg_7)

    def _arrow2619(__unit: None=None) -> FSharpList[Source] | None:
        arg_9: Decoder_1[FSharpList[Source]] = list_1_3(ISAJson_decoder_3)
        object_arg_4: IOptionalGetter = get.Optional
        return object_arg_4.Field("derivesFrom", arg_9)

    return Sample(_arrow2615(), _arrow2616(), _arrow2617(), _arrow2618(), _arrow2619())


ISAJson_decoder: Decoder_1[Sample] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2620)
