...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2510(__unit: None=None, oa: Any=oa) -> IEncodable:
        value: str = ROCrate_genID(oa)
        class ObjectExpr2509(IEncodable):
            def Encode(self, helpers: IEncoderHelpers_1[Any]) -> Any:
                return helpers.encode_string(value)

        return ObjectExpr2509()

    class ObjectExpr2511(IEncodable):
        def Encode(self, helpers_1: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            return helpers_1.encode_string("Material")

    class ObjectExpr2512(IEncodable):
        def Encode(self, helpers_2: IEncoderHelpers_1[Any], oa: Any=oa) -> Any:
            return helpers_2.encode_string("Material")

    def _arrow2514(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2515(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2516(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2510()), ("@type", list_1_1(singleton(ObjectExpr2511()))), ("additionalType", ObjectExpr2512()), try_include("name", _arrow2514, oa.Name), try_include("type", _arrow2515, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2516, oa.DerivesFrom), ("@context", context_jsonvalue)]))
    class ObjectExpr2517(IEncodable):
    ...
    return ObjectExpr2517()


def _arrow2524(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2523(get: IGetters) -> Material:
            ...
            def _arrow2520(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2521(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2522(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2518(), _arrow2519(), _arrow2520(), _arrow2521(), _arrow2522())

        return object(_arrow2523)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2524()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2528(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2530(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2531(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2532(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2528, ROCrate_genID(oa)), try_include("name", _arrow2530, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2531, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2532, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2534(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2534, f, c, id_map)
...
def _arrow2541(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2540(get: IGetters) -> Material:
            def _arrow2535(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2536(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2537(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2538(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2539(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2535(), _arrow2536(), _arrow2537(), _arrow2538(), _arrow2539())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2540)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2541()
