...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr2040(), None)
            ...
            pattern_input_1 = (ObjectExpr2041(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow2043(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow2045(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow2043, oa_1.Name), map(_arrow2045, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr2046(), None)
    ...
    def _arrow2050(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2053(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2055(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2057(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2059(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2061(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2063(value_19: str, pv: Any=pv) -> IEncodable:
        ...
        return ObjectExpr2062()

    def _arrow2064(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow2065(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow2067(value_21: str, pv: Any=pv) -> IEncodable:
        ...
        return ObjectExpr2066()

    def _arrow2069(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2050()), ("@type", ObjectExpr2051()), ("additionalType", _arrow2053()), try_include("alternateName", _arrow2055, pv.AlternateName()), try_include("measurementMethod", _arrow2057, pv.MeasurementMethod()), try_include("description", _arrow2059, pv.Description()), try_include("category", _arrow2061, pattern_input[0]), try_include("categoryCode", _arrow2063, pattern_input[1]), try_include("value", _arrow2064, pattern_input_1[0]), try_include("valueCode", _arrow2065, pattern_input_1[1]), try_include("unit", _arrow2067, pattern_input_2[0]), try_include("unitCode", _arrow2069, pattern_input_2[1]), ("@context", context_jsonvalue)]))
    class ObjectExpr2070(IEncodable):
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow2072(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow2071(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow2071(), unit)

    return object(_arrow2072)
