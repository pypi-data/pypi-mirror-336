...
def _arrow1779(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1760()), ("bio", ObjectExpr1761()), ("Protocol", ObjectExpr1762()), ("name", ObjectExpr1763()), ("protocolType", ObjectExpr1764()), ("description", ObjectExpr1765()), ("version", ObjectExpr1766()), ("components", ObjectExpr1767()), ("reagents", ObjectExpr1769()), ("computationalTools", ObjectExpr1770()), ("uri", ObjectExpr1772()), ("comments", ObjectExpr1775())])
...
context_jsonvalue: IEncodable = _arrow1779()
