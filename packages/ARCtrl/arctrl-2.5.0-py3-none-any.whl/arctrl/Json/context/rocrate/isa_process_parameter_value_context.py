...
def _arrow1758(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1748()), ("additionalType", ObjectExpr1749()), ("ProcessParameterValue", ObjectExpr1750()), ("category", ObjectExpr1751()), ("categoryCode", ObjectExpr1752()), ("value", ObjectExpr1753()), ("valueCode", ObjectExpr1754()), ("unit", ObjectExpr1755()), ("unitCode", ObjectExpr1756())])
