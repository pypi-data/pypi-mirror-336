...
IContext_reflection = _expr1706

def _arrow1711(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1707()), ("Organization", ObjectExpr1708()), ("name", ObjectExpr1709())])
...
context_jsonvalue: IEncodable = _arrow1711()
