...
def _arrow1808(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1802()), ("bio", ObjectExpr1803()), ("Source", ObjectExpr1804()), ("name", ObjectExpr1805()), ("characteristics", ObjectExpr1806())])
