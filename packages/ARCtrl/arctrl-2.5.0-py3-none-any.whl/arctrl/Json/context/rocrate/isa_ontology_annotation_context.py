...
IContext_reflection = _expr1687

def _arrow1695(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1688()), ("OntologyAnnotation", ObjectExpr1689()), ("annotationValue", ObjectExpr1690()), ("termSource", ObjectExpr1691()), ("termAccession", ObjectExpr1692()), ("comments", ObjectExpr1693())])
...
context_jsonvalue: IEncodable = _arrow1695()
