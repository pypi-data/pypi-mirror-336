...
def DataMap__GetExplicationColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow767(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Explication(dc)

    return DataMapAux_getOntologyColumn(_arrow767, this.data_contexts_0040108)


def DataMap__SetExplicationColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow768(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Explication_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow768, cells, this.data_contexts_0040108)


def DataMap__GetUnitColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow769(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_Unit(dc)

    return DataMapAux_getOntologyColumn(_arrow769, this.data_contexts_0040108)


def DataMap__SetUnitColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow770(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Unit_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow770, cells, this.data_contexts_0040108)


def DataMap__GetObjectTypeColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow771(dc: DataContext, this: Any=this) -> OntologyAnnotation | None:
        return DataContext__get_ObjectType(dc)

    return DataMapAux_getOntologyColumn(_arrow771, this.data_contexts_0040108)


def DataMap__SetDataTypeColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow772(dc: DataContext, oa: OntologyAnnotation | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_ObjectType_279AAFF2(dc, oa)

    DataMapAux_setOntologyColumn(_arrow772, cells, this.data_contexts_0040108)


def DataMap__GetLabelColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow773(dc: DataContext, this: Any=this) -> str | None:
        return dc.Name

    return DataMapAux_getStringColumn(_arrow773, this.data_contexts_0040108)


def DataMap__SetLabelColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow774(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        dc.Name = s

    DataMapAux_setStringColumn(_arrow774, cells, this.data_contexts_0040108)


def DataMap__GetDescriptionColumn(this: DataMap) -> Array[CompositeCell]:
    def _arrow775(dc: DataContext, this: Any=this) -> str | None:
        return DataContext__get_Description(dc)

    return DataMapAux_getStringColumn(_arrow775, this.data_contexts_0040108)


def DataMap__SetDescriptionColumn_C98E589(this: DataMap, cells: Array[CompositeCell]) -> None:
    def _arrow776(dc: DataContext, s: str | None=None, this: Any=this, cells: Any=cells) -> None:
        DataContext__set_Description_6DFDD678(dc, s)

    DataMapAux_setStringColumn(_arrow776, cells, this.data_contexts_0040108)
...
def DataMap_getDataContext_Z58338566(row: int, SkipValidation: Any | None=None) -> Callable[[DataMap], DataContext]:
    def _arrow777(dm: DataMap, row: Any=row, SkipValidation: Any=SkipValidation) -> DataContext:
