...
class ObjectExpr66(Decoder_1[str]):
...
string: Decoder_1[str] = ObjectExpr66()

class ObjectExpr67(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
...
char: Decoder_1[str] = ObjectExpr67()

class ObjectExpr70(Decoder_1[str]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[str, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, str]
            out_arg: str = "00000000-0000-0000-0000-000000000000"
            def _arrow68(__unit: None=None) -> str:
                return out_arg

            def _arrow69(v: str) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_1(helpers.as_string(value_1), FSharpRef(_arrow68, _arrow69)), out_arg)
...
guid: Decoder_1[str] = ObjectExpr70()

class ObjectExpr71(Decoder_1[None]):
...
unit: Decoder_1[None] = ObjectExpr71()

class ObjectExpr74(Decoder_1[int8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow72(__unit: None=None) -> int8:
                return out_arg

            def _arrow73(v: int8) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 8, FSharpRef(_arrow72, _arrow73)), out_arg)
...
sbyte: Decoder_1[int8] = ObjectExpr74()

class ObjectExpr77(Decoder_1[uint8]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint8, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow75(__unit: None=None) -> uint8:
                return out_arg

            def _arrow76(v: uint8) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 8, FSharpRef(_arrow75, _arrow76)), out_arg)
...
byte: Decoder_1[uint8] = ObjectExpr77()

class ObjectExpr80(Decoder_1[int16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow78(__unit: None=None) -> int16_1:
                return out_arg

            def _arrow79(v: int16_1) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 16, FSharpRef(_arrow78, _arrow79)), out_arg)
...
int16: Decoder_1[int16_1] = ObjectExpr80()

class ObjectExpr83(Decoder_1[uint16_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint16_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow81(__unit: None=None) -> uint16_1:
                return out_arg

            def _arrow82(v: uint16_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 16, FSharpRef(_arrow81, _arrow82)), out_arg)
...
uint16: Decoder_1[uint16_1] = ObjectExpr83()

class ObjectExpr86(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            out_arg: int = 0
            def _arrow84(__unit: None=None) -> int:
                return out_arg

            def _arrow85(v: int) -> None:
                nonlocal out_arg
                out_arg = v or 0

            match_value = (try_parse_2(helpers.as_string(value_2), 511, False, 32, FSharpRef(_arrow84, _arrow85)), out_arg)
...
int_1: Decoder_1[int] = ObjectExpr86()

class ObjectExpr89(Decoder_1[uint32_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint32_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow87(__unit: None=None) -> uint32_1:
                return out_arg

            def _arrow88(v: uint32_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_2(helpers.as_string(value_2), 511, True, 32, FSharpRef(_arrow87, _arrow88)), out_arg)
...
uint32: Decoder_1[uint32_1] = ObjectExpr89()

class ObjectExpr92(Decoder_1[int64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[int64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow90(__unit: None=None) -> int64_1:
                return out_arg

            def _arrow91(v: int64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, False, 64, FSharpRef(_arrow90, _arrow91)), out_arg)
...
int64: Decoder_1[int64_1] = ObjectExpr92()

class ObjectExpr95(Decoder_1[uint64_1]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_2: Any) -> FSharpResult_2[uint64_1, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_2):
            ...
            def _arrow93(__unit: None=None) -> uint64_1:
                return out_arg

            def _arrow94(v: uint64_1) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_3(helpers.as_string(value_2), 511, True, 64, FSharpRef(_arrow93, _arrow94)), out_arg)
...
uint64: Decoder_1[uint64_1] = ObjectExpr95()

class ObjectExpr99(Decoder_1[int]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[int, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow97(__unit: None=None) -> int:
                return out_arg

            def _arrow98(v: int) -> None:
                nonlocal out_arg
                out_arg = v

            parse_result = (try_parse_4(helpers.as_string(value_1), FSharpRef(_arrow97, _arrow98)), out_arg)
...
bigint: Decoder_1[int] = ObjectExpr99()

class ObjectExpr100(Decoder_1[bool]):
...
bool_1: Decoder_1[bool] = ObjectExpr100()

class ObjectExpr101(Decoder_1[float]):
...
float_1: Decoder_1[float] = ObjectExpr101()

class ObjectExpr102(Decoder_1[float32_1]):
...
float32: Decoder_1[float32_1] = ObjectExpr102()

class ObjectExpr105(Decoder_1[Decimal]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Decimal, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_number(value_1):
            ...
            def _arrow103(__unit: None=None) -> Decimal:
                return out_arg

            def _arrow104(v: Decimal) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_5(helpers.as_string(value_1), FSharpRef(_arrow103, _arrow104)), out_arg)
...
decimal: Decoder_1[Decimal] = ObjectExpr105()

class ObjectExpr108(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            ...
            def _arrow106(__unit: None=None) -> Any:
                return out_arg

            def _arrow107(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_6(helpers.as_string(value_1), FSharpRef(_arrow106, _arrow107)), out_arg)
...
datetime_local: Decoder_1[Any] = ObjectExpr108()

class ObjectExpr111(Decoder_1[Any]):
    def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> FSharpResult_2[Any, tuple[str, ErrorReason_1[__A_]]]:
        if helpers.is_string(value_1):
            match_value: tuple[bool, Any]
            out_arg: Any = create(0)
            def _arrow109(__unit: None=None) -> Any:
                return out_arg

            def _arrow110(v: Any) -> None:
                nonlocal out_arg
                out_arg = v

            match_value = (try_parse_7(helpers.as_string(value_1), FSharpRef(_arrow109, _arrow110)), out_arg)
...
timespan: Decoder_1[Any] = ObjectExpr111()
...
def decode_maybe_null(helpers: IDecoderHelpers_1[Any], path: str, decoder: Decoder_1[Any], value_1: Any) -> FSharpResult_2[Any | None, tuple[str, ErrorReason_1[_JSONVALUE]]]:
    if helpers.is_null_value(value_1):
        ...
        if match_value.tag == 1:
            def _arrow112(__unit: None=None, helpers: Any=helpers, path: Any=path, decoder: Any=decoder, value_1: Any=value_1) -> tuple[str, ErrorReason_1[_JSONVALUE]]:
            ...
            return FSharpResult_2(1, _arrow112())
...
def optional(field_name: str, decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr113(Decoder_1[_VALUE_ | None]):
...
def map2(ctor: Callable[[_A, _B], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr114(Decoder_1[_OUTPUT_]):
...
def optional_at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr115(Decoder_1[_VALUE_ | None]):
...
def at(field_names: FSharpList[str], decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr117(Decoder_1[_VALUE_]):
...
def index(requested_index: int, decoder: Decoder_1[Any]) -> Decoder_1[Any]:
    ...
    return ObjectExpr118()


def option(decoder: Decoder_1[Any]) -> Decoder_1[Any | None]:
    class ObjectExpr119(Decoder_1[_VALUE_ | None]):
    ...
    return ObjectExpr119()


def list_1(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr121(Decoder_1[FSharpList[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[FSharpList[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    if match_value.tag == 1:
                        def _arrow120(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                        ...
                        x: tuple[str, ErrorReason_1[__A_]] | None = _arrow120()
                        error = x
    ...
    return ObjectExpr121()


def resize_array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr123(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                ...
                while (error is None) if (i < len(tokens)) else False:
                    ...
                    match_value: FSharpResult_2[_VALUE_, tuple[str, ErrorReason_1[__A_]]] = decoder.Decode(helpers, value_2)
                    if match_value.tag == 1:
                        def _arrow122(__unit: None=None) -> tuple[str, ErrorReason_1[__A_]]:
                            tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                            return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])
...
def seq(decoder: Decoder_1[Any]) -> Decoder_1[IEnumerable_1[Any]]:
    class ObjectExpr125(Decoder_1[IEnumerable_1[_VALUE_]]):
                ...
                def folder(acc: FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[IEnumerable_1[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow124(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow124())
...
def array(decoder: Decoder_1[Any]) -> Decoder_1[Array[Any]]:
    class ObjectExpr127(Decoder_1[Array[_VALUE_]]):
        def Decode(self, helpers: IDecoderHelpers_1[Any], value_1: Any, decoder: Any=decoder) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
            if helpers.is_array(value_1):
                i: int = -1
                tokens: Array[__A_] = helpers.as_array(value_1)
                def folder(acc: FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[_VALUE_], tuple[str, ErrorReason_1[__A_]]]:
                    ...
                    if acc.tag == 0:
                        ...
                        if match_value.tag == 0:
                            ...
                            def _arrow126(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                tupled_arg: tuple[str, ErrorReason_1[__A_]] = match_value.fields[0]
                                return Helpers_prependPath((".[" + int32_to_string(i)) + "]", tupled_arg[0], tupled_arg[1])

                            return FSharpResult_2(1, _arrow126())
...
class ObjectExpr128(Decoder_1[FSharpList[str]]):
...
keys: Decoder_1[FSharpList[str]] = ObjectExpr128()

def key_value_pairs(decoder: Decoder_1[Any]) -> Decoder_1[FSharpList[tuple[str, _VALUE]]]:
    class ObjectExpr129(Decoder_1[FSharpList[tuple[str, _VALUE_]]]):
...
def nil(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr131(Decoder_1[_A_]):
...
def succeed(output: Any | None=None) -> Decoder_1[Any]:
    class ObjectExpr132(Decoder_1[_A_]):
...
def fail(msg: str) -> Decoder_1[Any]:
    class ObjectExpr133(Decoder_1[_A_]):
...
def all(decoders: FSharpList[Decoder_1[Any]]) -> Decoder_1[FSharpList[Any]]:
    class ObjectExpr135(Decoder_1[FSharpList[_A_]]):
...
def map3(ctor: Callable[[_A, _B, _C], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr137(Decoder_1[_OUTPUT_]):
...
def map4(ctor: Callable[[_A, _B, _C, _D], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr138(Decoder_1[_OUTPUT_]):
...
def map5(ctor: Callable[[_A, _B, _C, _D, _E], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr139(Decoder_1[_OUTPUT_]):
...
def map6(ctor: Callable[[_A, _B, _C, _D, _E, _F], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr140(Decoder_1[_OUTPUT_]):
...
def map7(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr141(Decoder_1[_OUTPUT_]):
...
def map8(ctor: Callable[[_A, _B, _C, _D, _E, _F, _G, _H], _OUTPUT], d1: Decoder_1[Any], d2: Decoder_1[Any], d3: Decoder_1[Any], d4: Decoder_1[Any], d5: Decoder_1[Any], d6: Decoder_1[Any], d7: Decoder_1[Any], d8: Decoder_1[Any]) -> Decoder_1[Any]:
    class ObjectExpr142(Decoder_1[_OUTPUT_]):
...
def and_map(__unit: None=None) -> Callable[[Decoder_1[_A], Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
    def _arrow144(d: Decoder_1[_A]) -> Callable[[Decoder_1[Callable[[_A], _B]]], Decoder_1[_B]]:
        def _arrow143(d_1: Decoder_1[Callable[[_A], _B]]) -> Decoder_1[_B]:
...
def _expr149(gen0: TypeInfo, gen1: TypeInfo) -> TypeInfo:
...
class Getters_2(Generic[_JSONVALUE, _T]):
    def __init__(self, helpers: IDecoderHelpers_1[Any], value_1: Any) -> None:
        ...
        def _arrow146(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr145(IRequiredGetter):
        ...
        self.required: IRequiredGetter = _arrow146()
        def _arrow148(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr147(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow148()
...
def object(builder: Callable[[IGetters], _VALUE]) -> Decoder_1[Any]:
    class ObjectExpr150(Decoder_1[_VALUE_]):
