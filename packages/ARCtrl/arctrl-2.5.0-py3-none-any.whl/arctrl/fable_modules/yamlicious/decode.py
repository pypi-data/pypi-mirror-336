...
def int_1(value: YAMLElement) -> int:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: int = 0
        def _arrow452(__unit: None=None, value: Any=value) -> int:
            return out_arg

        def _arrow453(v_1: int, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1 or 0

        match_value = (try_parse(v.Value, 511, False, 32, FSharpRef(_arrow452, _arrow453)), out_arg)
        if match_value[0]:
...
def float_1(value: YAMLElement) -> float:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: float = 0.0
        def _arrow455(__unit: None=None, value: Any=value) -> float:
            return out_arg

        def _arrow456(v_1: float, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_1(v.Value, FSharpRef(_arrow455, _arrow456)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow460(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow461(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow460, _arrow461)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return of_list(map_1(mapping, value.fields[0]), ObjectExpr462())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr463()), ObjectExpr464())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow465(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow466(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow465, _arrow466)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow467(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow468(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow467, _arrow468)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def _expr481() -> TypeInfo:
    return class_type("YAMLicious.Decode.Getter", None, Getter)


class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow472(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr471(IRequiredGetter):
            ...
            return ObjectExpr471()

        self.required: IRequiredGetter = _arrow472()
        def _arrow474(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr473(IOptionalGetter):
            ...
            return ObjectExpr473()

        self.optional: IOptionalGetter = _arrow474()
        def _arrow476(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr475(IMultipleOptionalGetter):
            ...
            return ObjectExpr475()

        self.multiple_optional: IMultipleOptionalGetter = _arrow476()
        def _arrow480(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr479(IOverflowGetter):
            ...
            return ObjectExpr479()

        self.overflow: IOverflowGetter = _arrow480()
