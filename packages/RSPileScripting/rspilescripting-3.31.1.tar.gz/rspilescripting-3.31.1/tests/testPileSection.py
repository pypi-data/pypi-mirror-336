...
class TestPileProperties(unittest.TestCase):
	...
	def testDrivenHPileCrossSection(self):
		for hpileTypeMetric in HPileTypeMetric:
			self.pileSection.DrivenCapacity.HPile.setHPileTypeMetric(hpileTypeMetric)
			self.assertEqual(self.pileSection.DrivenCapacity.HPile.getHPileTypeMetric(), hpileTypeMetric)

		for hpileTypeImperial in HPileTypeImperial:
			self.pileSection.DrivenCapacity.HPile.setHPileTypeImperial(hpileTypeImperial)
			self.assertEqual(self.pileSection.DrivenCapacity.HPile.getHPileTypeImperial(), hpileTypeImperial)

		for hpilePerimeter in HPilePerimeter:
			self.pileSection.DrivenCapacity.HPile.setHPilePerimeter(hpilePerimeter)
			self.assertEqual(self.pileSection.DrivenCapacity.HPile.getHPilePerimeter(), hpilePerimeter)

		for hpileArea in HPileArea:
			self.pileSection.DrivenCapacity.HPile.setHPileArea(hpileArea)
			self.assertEqual(self.pileSection.DrivenCapacity.HPile.getHPileArea(), hpileArea)
	...
	def testDrivenHPileUserSelectedAreaCrossSection(self):
		self.pileSection.DrivenCapacity.HPile.UserSelectedArea.setAreaOfTip(5.0)
		self.assertEqual(self.pileSection.DrivenCapacity.HPile.UserSelectedArea.getAreaOfTip(), 5.0)
	#endregion
