...
install_controller_play = [
    {
            ...
            },
        {
            ...
            "copy":{
                ...
                "content": "{{py_env}}/site-packages/qd2_orchestrator/rabbit_mq_installation.sh"
            }
        },
        {
...
def get_controller_play(host, ns_user, ns_pwd):
...
def install(config_file, inv_file):
    ...
    with  open("config_test.yaml","r") as config_file:
        config_data = yaml.safe_load(config_file)
    config_array = config_data["config"]
    ip_controller = config_array["ip_controller"]
    ns_user = config_array["netsquid_user"]
    ns_pwd = config_array["netsquid_pwd"]
    icp = get_controller_play(ip_controller, ns_user, ns_pwd)
    rmqp = get_rmq_play(ip_controller)
