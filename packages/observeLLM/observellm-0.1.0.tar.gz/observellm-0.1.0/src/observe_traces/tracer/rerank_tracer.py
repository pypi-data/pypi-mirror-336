...
def calculate_pinecone_rerank_price(model_name: str, tokens_data: Dict[str, int]) -> Dict[str, float]:
    pricing = {
...
def calculate_cohere_rerank_price(model_name: str, tokens_data: Dict[str, int]) -> Dict[str, float]:
    pricing = {
...
def calculate_jina_rerank_price(model_name: str, tokens_data: Dict[str, int]) -> Dict[str, float]:
    pricing = {
...
def calculate_voyage_rerank_price(model_name: str, tokens_data: Dict[str, int]) -> Dict[str, float]:
    pricing = {
...
def parse_pinecone_rerank_tokens(response_data: Dict[str, Any]) -> Dict[str, int]:
        ...
        async def wrapper(*args, **kwargs):
            ...
            try:
                ...
                try:
                    ...
                    span_id = await _LangfuseService.create_span_for_reranking(trace_id = trace_id, span_data=span_data, name=f"{provider.capitalize()} Reranking")
