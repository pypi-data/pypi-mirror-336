...
from file_parser.type.file import parse_pdf, parse_docx, parse_pdf_with_images, parse_docx_with_images, parse_csv, parse_csv_without_template, parse_xlsx, parse_xlsx_without_template, download_and_extract_headers_xlsx, parse_pptx, parse_txt
    ...
    async def process_file(self, file_url: str, input: Optional[str] = None, sent_from: Optional[str] = None) -> Any:
        ...
        try:
            ...
            if file_path.endswith('.pdf'):
                text= parse_pdf_with_images(temp_file_path) if sent_from == 'vaia_client' else parse_pdf(temp_file_path)
