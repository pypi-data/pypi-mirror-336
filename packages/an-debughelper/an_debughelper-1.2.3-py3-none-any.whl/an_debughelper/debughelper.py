# -*- coding: utf-8 -*-
"""DBHL_20250326_00.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1Bxul4TIWkKDUMz_MSzkqRdaHuIu5tNxk
...
class DebugHelper:
    ...
    def installer( self, command, shell = False, back = 0 ):
        self.log_step( f"command : { command }", success = None, back = back )
        result = subprocess.run( command, shell = shell, capture_output=True, text=True )
        self.log_step( f"result  : { result.returncode }", success = None, back = back )
        self.log_step( f"stdout  :\n{ result.stdout     }", success = None, back = back )
        self.log_step( f"stderr  :\n{ result.stderr     }", success = None, back = back )
        ...
        if not result:
            for line in stdout.split("\n"):
                if "release" in line:
                    ...
                    break
        self.debugger.installer( command = "nvcc --version", shell = True )
