...
class Log:
    ...
    def tostring(self, acharsep : str = '\r\n')->str:
        """return the Valuelst in string
        ...
        -------
        str
            the Valuelst in string separated by aChar (default '\n\r')
        """
        return acharsep.join(self._LogLst)
    
    def getlogtag(self, asep : str = '')->str:
        """Get log tag formated %Y-%m-%d %H:%M:%S
