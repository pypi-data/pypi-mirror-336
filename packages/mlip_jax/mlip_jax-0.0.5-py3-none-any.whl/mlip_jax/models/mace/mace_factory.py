...
def create_mace_force_field(
    ...
    Args:
        ...
        l_max: Highest harmonic order included in the Spherical Harmonics series.
               Default is 3.
        correlation: Maximum correlation order, by default it is 2.
    ...
    interaction_irreps = "o3_full" if include_pseudotensors else "o3_restricted"
    ...
    mace_kwargs = dict(
        ...
        off_diagonal=False,
        max_ell=l_max,
        hidden_irreps="0e",  # TODO consider removing as model factory input
