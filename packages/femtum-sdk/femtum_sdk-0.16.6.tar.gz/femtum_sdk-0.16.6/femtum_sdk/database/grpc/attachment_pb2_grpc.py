...
class AttachmentServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Delete = channel.unary_unary(
                '/Trimming.AttachmentService/Delete',
                request_serializer=attachment__pb2.DeleteAttachmentRequest.SerializeToString,
...
def add_AttachmentServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Delete': grpc.unary_unary_rpc_method_handler(
                    servicer.Delete,
                    request_deserializer=attachment__pb2.DeleteAttachmentRequest.FromString,
                    response_serializer=attachment__pb2.OptionalAttachment.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'Trimming.AttachmentService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('Trimming.AttachmentService', rpc_method_handlers)
...
class AttachmentService(object):
    ...
    def Delete(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Trimming.AttachmentService/Delete',
            attachment__pb2.DeleteAttachmentRequest.SerializeToString,
