...
class AvailableTargetsRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[AvailableTargetProperties]]
    ...
    fields: NotRequired[Nullable[List[AvailableTargetProperties]]]
...
class AvailableTargetsRequest(BaseModel):
    ...
    search_fields: Annotated[
        Optional[List[AvailableTargetProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[AvailableTargetProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[AvailableTargetProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
