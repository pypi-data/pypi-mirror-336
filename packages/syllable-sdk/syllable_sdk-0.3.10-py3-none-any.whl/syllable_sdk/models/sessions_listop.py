...
class SessionsListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[SessionProperties]]
    ...
    fields: NotRequired[Nullable[List[SessionProperties]]]
...
class SessionsListRequest(BaseModel):
    ...
    search_fields: Annotated[
        Optional[List[SessionProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[SessionProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[SessionProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
