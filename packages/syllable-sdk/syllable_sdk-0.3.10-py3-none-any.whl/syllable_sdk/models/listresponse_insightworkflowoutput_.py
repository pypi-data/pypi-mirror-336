...
class ListResponseInsightWorkflowOutputTypedDict(TypedDict):
    items: List[InsightWorkflowOutputTypedDict]
    page: int
    page_size: int
...
class ListResponseInsightWorkflowOutput(BaseModel):
    items: List[InsightWorkflowOutput]
