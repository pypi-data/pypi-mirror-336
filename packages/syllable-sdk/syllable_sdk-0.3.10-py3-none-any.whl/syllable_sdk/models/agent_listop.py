...
class AgentListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[AgentProperties]]
    ...
    fields: NotRequired[Nullable[List[AgentProperties]]]
...
class AgentListRequest(BaseModel):
    ...
    order_by: Annotated[
        OptionalNullable[AgentProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[AgentProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
