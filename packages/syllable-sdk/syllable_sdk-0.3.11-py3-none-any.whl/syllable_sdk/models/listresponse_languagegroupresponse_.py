...
class ListResponseLanguageGroupResponseTypedDict(TypedDict):
    items: List[LanguageGroupResponseTypedDict]
    page: int
    page_size: int
...
class ListResponseLanguageGroupResponse(BaseModel):
    items: List[LanguageGroupResponse]
