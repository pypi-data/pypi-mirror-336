...
class ListResponseCustomMessageResponseTypedDict(TypedDict):
    items: List[CustomMessageResponseTypedDict]
    page: int
    page_size: int
...
class ListResponseCustomMessageResponse(BaseModel):
    items: List[CustomMessageResponse]
