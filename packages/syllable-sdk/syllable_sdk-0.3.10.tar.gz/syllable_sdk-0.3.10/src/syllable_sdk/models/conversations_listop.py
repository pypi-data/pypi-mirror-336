...
class ConversationsListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[ConversationProperties]]
    ...
    fields: NotRequired[Nullable[List[ConversationProperties]]]
...
class ConversationsListRequest(BaseModel):
    ...
    search_fields: Annotated[
        Optional[List[ConversationProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[ConversationProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[ConversationProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
