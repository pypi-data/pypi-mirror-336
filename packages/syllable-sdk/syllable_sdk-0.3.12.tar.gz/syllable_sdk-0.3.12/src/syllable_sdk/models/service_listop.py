...
class ServiceListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[ServiceProperties]]
    ...
    fields: NotRequired[Nullable[List[ServiceProperties]]]
...
class ServiceListRequest(BaseModel):
    ...
    search_fields: Annotated[
        Optional[List[ServiceProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[ServiceProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[ServiceProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
