...
class ListResponseInsightToolOutputTypedDict(TypedDict):
    items: List[InsightToolOutputTypedDict]
    page: int
    page_size: int
...
class ListResponseInsightToolOutput(BaseModel):
    items: List[InsightToolOutput]
