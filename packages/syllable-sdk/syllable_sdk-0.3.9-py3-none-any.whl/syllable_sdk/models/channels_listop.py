...
class ChannelsListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[ChannelProperties]]
    ...
    fields: NotRequired[Nullable[List[ChannelProperties]]]
...
class ChannelsListRequest(BaseModel):
    page: Annotated[
    ...
    search_fields: Annotated[
        Optional[List[ChannelProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[ChannelProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[ChannelProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
