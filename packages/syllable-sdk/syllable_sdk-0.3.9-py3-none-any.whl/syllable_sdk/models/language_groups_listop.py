...
class LanguageGroupsListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[LanguageGroupProperties]]
    ...
    fields: NotRequired[Nullable[List[LanguageGroupProperties]]]
...
class LanguageGroupsListRequest(BaseModel):
    page: Annotated[
    ...
    search_fields: Annotated[
        Optional[List[LanguageGroupProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = None
    r"""String names of fields to search. Correspond by index to search field values"""
    ...
    order_by: Annotated[
        OptionalNullable[LanguageGroupProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[LanguageGroupProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
