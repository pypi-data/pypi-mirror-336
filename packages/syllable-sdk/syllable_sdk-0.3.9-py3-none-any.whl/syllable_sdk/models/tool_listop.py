...
class ToolListRequestTypedDict(TypedDict):
    ...
    order_by: NotRequired[Nullable[ToolProperties]]
    ...
    fields: NotRequired[Nullable[List[ToolProperties]]]
...
class ToolListRequest(BaseModel):
    ...
    order_by: Annotated[
        OptionalNullable[ToolProperties],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The field whose value should be used to order the results"""
    ...
    fields: Annotated[
        OptionalNullable[List[ToolProperties]],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""The fields to include in the response"""
