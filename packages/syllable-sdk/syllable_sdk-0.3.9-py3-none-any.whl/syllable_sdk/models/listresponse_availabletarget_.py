...
class ListResponseAvailableTargetTypedDict(TypedDict):
    items: List[AvailableTargetTypedDict]
    page: int
    page_size: int
...
class ListResponseAvailableTarget(BaseModel):
    items: List[AvailableTarget]
