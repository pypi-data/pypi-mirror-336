...
All work happens directly on [GitHub](https://github.com/GlobalFishingWatch/gfw-api-python-client). Both core team members and external contributors send pull requests which go through the same review process.


## Branch Organization

We will do our best to keep the [`main` branch](https://github.com/GlobalFishingWatch/gfw-api-python-client/tree/main) in good shape, with tests passing at all times.

If you send a pull request, please do it against the [`develop` branch](https://github.com/GlobalFishingWatch/gfw-api-python-client/tree/develop).
...
The core team reviews all pull requests. We will review your pull request and either merge it, request changes to it, or close it with an explanation. We'll do our best to provide updates and feedback throughout the process.


## Style Guide

Look at [PEP 8 - Style Guide for Python Code](https://peps.python.org/pep-0008/), [Google - Python Style Guide](https://google.github.io/styleguide/pyguide.html) and [Black - Code style guide](https://black.readthedocs.io/en/stable/the_black_code_style/current_style.html), they will guide you in the right direction.
...
The commit message formatting can be added using a typical git workflow or through the use of a CLI wizard ([Commitizen](https://github.com/commitizen-tools/commitizen)). To use the wizard, run `cz commit` in your terminal after staging your changes in git.
