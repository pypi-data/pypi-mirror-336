...
class TestDefaultApi(unittest.TestCase):
    ...
    def test_preview_calibration_tiff_get(self) -> None:
        """Test case for preview_calibration_tiff_get

        Get last preview image in TIFF format for calibration with PyFAI/Dioptas
        """
        pass

    def test_preview_image_jpeg_get(self) -> None:
        """Test case for preview_image_jpeg_get

        Get last preview image in JPEG format using default settings
        """
        pass

    def test_preview_image_jpeg_post(self) -> None:
        """Test case for preview_image_jpeg_post

        Get last preview image in JPEG format using custom settings
        """
        pass

    def test_preview_image_tiff_get(self) -> None:
        """Test case for preview_image_tiff_get
