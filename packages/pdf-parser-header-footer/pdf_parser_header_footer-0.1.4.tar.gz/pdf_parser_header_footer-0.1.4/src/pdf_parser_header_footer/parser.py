            ...
            if self.config.generate_json:
                ...
                if result:
                    ...
                    if self.config.parse_to_markdown:
                        ...
                        classifier = TitleClassifier().load("src/pdf_parser_header_footer/resources/title_classifier_model.pkl")
                        newlines_classifier = LineJoinerClassifier().load("src/pdf_parser_header_footer/resources/line_joiner_model.pkl")
