...
setup(
    ...
    description="A Gradient-based Prompt Optimizer for Text Generation",  # Optional
    ...
    url="https://github.com/WenliangZhoushan/GreaterPrompt",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Wenliang Zheng",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="wenliangz2004@gmail.com",  # Optional
    ...
    # larger catalog.
    keywords="greaterprompt, gradient-based, prompt, optimizer, text, generation",  # Optional
