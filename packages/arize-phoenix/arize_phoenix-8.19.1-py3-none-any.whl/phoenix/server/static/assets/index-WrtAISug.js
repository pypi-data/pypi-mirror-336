import{r as t,j as o,bp as z,l as c,P as w,R as P,E as b,cy as k,ei as S,ej as F,ek as L,el as l,w as C,em as E}from"./vendor-CwC1K6mo.js";import{c as R,x as I,D as j,K as A,M as T}from"./vendor-arizeai-B7-2AIAM.js";import{L as _,r as D,d as O,e as G,F as M,f as N,P as V,h as U,M as m,g as W,D as q,i as K,E as B,j as J,k as $,p as H,l as Y,n as p,o as Q,q as X,s as Z,S as oo,t as lo,v as ao,w as ro,x as co,y as go,z as eo,A as u,B as f,C as y,G as bo,H as no,I as io,J as so,K as to,N as mo,O as po,Q as uo,U as fo,V as yo,W as vo,X as ho,Y as xo,Z as zo,_ as wo,$ as Po,a0 as ko,a1 as So,a2 as Fo,a3 as Lo,a4 as Co,a5 as Eo,a6 as Ro,a7 as Io,a8 as jo,a9 as Ao,aa as To,ab as _o,ac as Do,ad as Oo,ae as Go,af as Mo,ag as No,ah as Vo}from"./pages-eLqonMjF.js";import{z as Uo,dU as Wo,bC as qo,R as Ko,dV as Bo,dW as Jo}from"./components-C28SkolB.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-D3xhkqGE.js";import"./vendor-shiki-CK18CSqG.js";import"./vendor-recharts-B_VgO7bY.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(r){if(r.ep)return;r.ep=!0;const g=i(r);fetch(r.href,g)}})();const v="arize-phoenix-feature-flags",d={__RESET__:!1};function $o(){const a=localStorage.getItem(v);if(!a)return d;try{const e=JSON.parse(a);return Object.assign({},d,e)}catch{return d}}const h=t.createContext(null);function Ho(){const a=P.useContext(h);if(a===null)throw new Error("useFeatureFlags must be used within a FeatureFlagsProvider");return a}function Yo(a){const[e,i]=t.useState($o()),s=r=>{localStorage.setItem(v,JSON.stringify(r)),i(r)};return o(h.Provider,{value:{featureFlags:e,setFeatureFlags:s},children:o(Qo,{children:a.children})})}function Qo(a){const{children:e}=a,{featureFlags:i,setFeatureFlags:s}=Ho(),[r,g]=t.useState(!1);return z("ctrl+shift+f",()=>g(!0)),c(w,{children:[e,o(j,{type:"modal",isDismissable:!0,onDismiss:()=>g(!1),children:r&&o(R,{title:"Feature Flags",children:o(Uo,{height:"size-1000",padding:"size-100",children:Object.keys(i).map(n=>o(I,{isSelected:i[n],onChange:x=>s({...i,[n]:x}),children:n},n))})})})]})}const Xo=b`
  :root {
