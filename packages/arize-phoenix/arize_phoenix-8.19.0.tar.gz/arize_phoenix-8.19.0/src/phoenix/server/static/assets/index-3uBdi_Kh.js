import{r as t,j as o,bp as z,l as c,O as w,R as P,E as b,cy as k,ei as S,ej as F,ek as L,el as l,w as C,em as E}from"./vendor-DzTYZE0m.js";import{c as R,x as I,D as j,M as A,N as T}from"./vendor-arizeai-MSqbWSh7.js";import{L as _,r as D,d as O,e as G,F as M,f as N,P as V,h as U,M as m,g as q,D as B,i as W,E as J,j as K,k as $,p as H,l as Y,n as p,o as Q,q as X,s as Z,S as oo,t as lo,v as ao,w as ro,x as co,y as go,z as eo,A as u,B as f,C as y,G as bo,H as no,I as io,J as so,K as to,N as mo,O as po,Q as uo,U as fo,V as yo,W as vo,X as ho,Y as xo,Z as zo,_ as wo,$ as Po,a0 as ko,a1 as So,a2 as Fo,a3 as Lo,a4 as Co,a5 as Eo,a6 as Ro,a7 as Io,a8 as jo,a9 as Ao,aa as To,ab as _o,ac as Do,ad as Oo,ae as Go,af as Mo,ag as No,ah as Vo}from"./pages-CQ49cFqk.js";import{z as Uo,dS as qo,bB as Bo,R as Wo,dT as Jo,dU as Ko}from"./components-DLQsAsXI.js";import"./vendor-three-C5WAXd5r.js";import"./vendor-codemirror-BkyHpLbv.js";import"./vendor-shiki-43FrwhkU.js";import"./vendor-recharts-BNpDMM_n.js";(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const g of r)if(g.type==="childList")for(const n of g.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&s(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const g={};return r.integrity&&(g.integrity=r.integrity),r.referrerPolicy&&(g.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?g.credentials="include":r.crossOrigin==="anonymous"?g.credentials="omit":g.credentials="same-origin",g}function s(r){if(r.ep)return;r.ep=!0;const g=i(r);fetch(r.href,g)}})();const v="arize-phoenix-feature-flags",d={__RESET__:!1};function $o(){const a=localStorage.getItem(v);if(!a)return d;try{const e=JSON.parse(a);return Object.assign({},d,e)}catch{return d}}const h=t.createContext(null);function Ho(){const a=P.useContext(h);if(a===null)throw new Error("useFeatureFlags must be used within a FeatureFlagsProvider");return a}function Yo(a){const[e,i]=t.useState($o()),s=r=>{localStorage.setItem(v,JSON.stringify(r)),i(r)};return o(h.Provider,{value:{featureFlags:e,setFeatureFlags:s},children:o(Qo,{children:a.children})})}function Qo(a){const{children:e}=a,{featureFlags:i,setFeatureFlags:s}=Ho(),[r,g]=t.useState(!1);return z("ctrl+shift+f",()=>g(!0)),c(w,{children:[e,o(j,{type:"modal",isDismissable:!0,onDismiss:()=>g(!1),children:r&&o(R,{title:"Feature Flags",children:o(Uo,{height:"size-1000",padding:"size-100",children:Object.keys(i).map(n=>o(I,{isSelected:i[n],onChange:x=>s({...i,[n]:x}),children:n},n))})})})]})}const Xo=b`
  :root {
...
`;function bl(){const{theme:a="dark"}=A();return o(k,{styles:b(ol,Zo,a==="dark"?ll:al,rl(a),Xo,cl,gl,el)})}const nl=S(F(c(l,{path:"/",errorElement:o(Mo,{}),children:[o(l,{path:"/login",element:o(_,{})}),o(l,{path:"/reset-password",element:o(O,{}),loader:D}),o(l,{path:"/reset-password-with-token",element:o(G,{})}),o(l,{path:"/forgot-password",element:o(M,{})}),o(l,{element:o(Go,{}),loader:N,children:c(l,{element:o(Oo,{}),children:[o(l,{path:"/profile",handle:{crumb:()=>"profile"},element:o(V,{})}),o(l,{index:!0,loader:U}),c(l,{path:"/model",handle:{crumb:()=>"model"},element:o(K,{}),children:[o(l,{index:!0,element:o(m,{})}),o(l,{element:o(m,{}),children:o(l,{path:"dimensions",children:o(l,{path:":dimensionId",element:o(B,{}),loader:q})})}),o(l,{path:"embeddings",children:o(l,{path:":embeddingDimensionId",element:o(J,{}),loader:W,handle:{crumb:a=>a.embedding.name}})})]}),c(l,{path:"/projects",handle:{crumb:()=>"projects"},element:o(go,{}),children:[o(l,{index:!0,element:o($,{})}),c(l,{path:":projectId",loader:H,handle:{crumb:a=>a.project.name},element:o(co,{}),children:[o(l,{index:!0,element:o(Y,{})}),c(l,{element:o(ro,{}),children:[o(l,{path:"traces",element:o(Q,{}),children:o(l,{path:":traceId",element:o(p,{})})}),o(l,{path:"spans",element:o(X,{}),children:o(l,{path:":traceId",element:o(p,{})})}),o(l,{path:"sessions",element:o(lo,{}),children:o(l,{path:":sessionId",element:o(oo,{}),loader:Z})}),o(l,{path:"config",element:o(ao,{})})]})]})]}),c(l,{path:"/datasets",handle:{crumb:()=>"datasets"},children:[o(l,{index:!0,element:o(eo,{})}),c(l,{path:":datasetId",loader:u,handle:{crumb:a=>a.dataset.name},children:[c(l,{element:o(so,{}),loader:u,children:[o(l,{index:!0,element:o(y,{}),loader:f}),o(l,{path:"experiments",element:o(y,{}),loader:f}),o(l,{path:"examples",element:o(io,{}),loader:bo,children:o(l,{path:":exampleId",element:o(no,{})})})]}),o(l,{path:"compare",handle:{crumb:()=>"compare"},loader:to,element:o(mo,{})})]})]}),c(l,{path:"/playground",handle:{crumb:()=>"Playground"},children:[o(l,{index:!0,element:o(po,{})}),o(l,{path:"spans/:spanId",element:o(fo,{}),loader:uo,handle:{crumb:a=>a.span.__typename==="Span"?`span ${a.span.spanId}`:"span unknown"}})]}),c(l,{path:"/prompts",handle:{crumb:()=>"prompts"},children:[o(l,{index:!0,element:o(vo,{}),loader:yo}),c(l,{path:":promptId",loader:ho,shouldRevalidate:()=>!0,handle:{crumb:a=>a.prompt.__typename==="Prompt"?a.prompt.name:"unknown"},children:[c(l,{element:o(Lo,{}),children:[o(l,{index:!0,element:o(xo,{})}),o(l,{path:"versions",loader:zo,element:o(ko,{}),children:o(l,{path:":versionId",loader:wo,element:o(Po,{})})}),o(l,{path:"config",element:o(Fo,{}),loader:So})]}),o(l,{path:"playground",element:o(Eo,{}),loader:Co,handle:{crumb:()=>"playground"}})]})]}),o(l,{path:"/apis",element:o(Ro,{}),handle:{crumb:()=>"APIs"}}),o(l,{path:"/support",element:o(Io,{}),handle:{crumb:()=>"support"}}),c(l,{path:"/settings",element:o(Do,{}),handle:{crumb:()=>"settings"},children:[o(l,{path:"general",loader:jo,element:o(Ao,{}),handle:{crumb:()=>"general"}}),o(l,{path:"providers",loader:To,element:o(_o,{}),handle:{crumb:()=>"providers"}})]})]})})]})),{basename:window.Config.basename});function il(){return o(L,{router:nl})}function sl(){return o(No,{children:o(qo,{children:o(tl,{})})})}function tl(){const{theme:a}=Bo();return o(T,{theme:a,mountGlobalStyles:!1,children:c(C.RelayEnvironmentProvider,{environment:Wo,children:[o(bl,{}),o(Yo,{children:o(Jo,{children:o(Vo,{children:o(t.Suspense,{children:o(Ko,{children:o(il,{})})})})})})]})})}const dl=document.getElementById("root"),ml=E.createRoot(dl);ml.render(o(sl,{}));
