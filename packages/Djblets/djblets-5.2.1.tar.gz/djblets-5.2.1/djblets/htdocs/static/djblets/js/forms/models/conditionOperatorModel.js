...
Djblets.Forms.ConditionOperator = Backbone.Model.extend({
  ...
  createValueField(fieldName) {
    ...
    console.assert(valueField, 'This operator does not have a custom valueField.');
  ...
  parse(data) {
    return {
      ...
      valueField: Djblets.Forms.ConditionChoice.parseValueFieldData(data.valueField)
    };
  }
});

//# sourceMappingURL=conditionOperatorModel.js.map