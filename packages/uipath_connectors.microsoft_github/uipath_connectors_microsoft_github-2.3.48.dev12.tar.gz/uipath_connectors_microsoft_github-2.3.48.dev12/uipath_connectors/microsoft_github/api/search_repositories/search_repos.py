    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = SearchRepos.from_dict(response_200_item_data)
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        query (str): The query contains one or more search keywords and qualifiers. Qualifiers
            allow you to limit your search to specific areas of GitHub.
        sort (Optional[str]): Sorts the results of your query by number of stars, forks, or help-
            wanted-issues or how recently the items were updated
        order (Optional[str]): Determines whether the first search result returned is the highest
