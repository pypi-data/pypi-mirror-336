...
class CreateIssueResponseAssignee(BaseModel):
    """
    Attributes:
        ...
        login (Optional[str]): The username that this issue should be assigned to. Only users with push access can
                modify the assignee of new issues, otherwise the assignee will be silently dropped. Example: octocat.
        name (Optional[str]):
    ...
    @classmethod
    def from_dict(cls: Type["CreateIssueResponseAssignee"], src_dict: Dict[str, Any]):
