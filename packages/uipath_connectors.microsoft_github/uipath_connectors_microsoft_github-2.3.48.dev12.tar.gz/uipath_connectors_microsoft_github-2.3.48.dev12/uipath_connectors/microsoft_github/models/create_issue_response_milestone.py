...
from ..models.create_issue_response_milestone_creator import (
    CreateIssueResponseMilestoneCreator,
)
from ..models.create_issue_response_milestone_state import (
    CreateIssueResponseMilestoneState,
)
import datetime


class CreateIssueResponseMilestone(BaseModel):
    """
    Attributes:
        ...
        creator (Optional[CreateIssueResponseMilestoneCreator]):
        ...
        number (Optional[int]): The number of the milestone for this issue or use null to remove the current milestone.
                Only users with push access can modify the milestone for issues. Example: 42.0.
        open_issues (Optional[int]):  Example: 4.0.
        state (Optional[CreateIssueResponseMilestoneState]): The state of the milestone. Example: open.
    ...
    creator: Optional["CreateIssueResponseMilestoneCreator"] = Field(
    ...
    state: Optional["CreateIssueResponseMilestoneState"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CreateIssueResponseMilestone"], src_dict: Dict[str, Any]):
