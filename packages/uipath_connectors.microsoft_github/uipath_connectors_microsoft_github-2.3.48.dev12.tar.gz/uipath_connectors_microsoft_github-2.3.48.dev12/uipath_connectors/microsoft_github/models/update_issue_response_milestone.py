...
from ..models.update_issue_response_milestone_creator import (
    UpdateIssueResponseMilestoneCreator,
)
from ..models.update_issue_response_milestone_state import (
    UpdateIssueResponseMilestoneState,
)
import datetime


class UpdateIssueResponseMilestone(BaseModel):
    """
    Attributes:
        ...
        creator (Optional[UpdateIssueResponseMilestoneCreator]):
        ...
        state (Optional[UpdateIssueResponseMilestoneState]): The state of the milestone. Example: open.
    ...
    creator: Optional["UpdateIssueResponseMilestoneCreator"] = Field(
    ...
    state: Optional["UpdateIssueResponseMilestoneState"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["UpdateIssueResponseMilestone"], src_dict: Dict[str, Any]):
