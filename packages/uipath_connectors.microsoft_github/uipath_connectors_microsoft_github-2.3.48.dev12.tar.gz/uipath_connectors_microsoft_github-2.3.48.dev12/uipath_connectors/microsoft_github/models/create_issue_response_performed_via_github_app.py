...
from ..models.create_issue_response_performed_via_github_app_owner import (
    CreateIssueResponsePerformedViaGithubAppOwner,
)
from ..models.create_issue_response_performed_via_github_app_permissions import (
    CreateIssueResponsePerformedViaGithubAppPermissions,
)
import datetime


class CreateIssueResponsePerformedViaGithubApp(BaseModel):
    r"""
    Attributes:
        ...
        owner (Optional[CreateIssueResponsePerformedViaGithubAppOwner]):
        ...
        permissions (Optional[CreateIssueResponsePerformedViaGithubAppPermissions]):
    ...
    owner: Optional["CreateIssueResponsePerformedViaGithubAppOwner"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateIssueResponsePerformedViaGithubApp"], src_dict: Dict[str, Any]
    ):
