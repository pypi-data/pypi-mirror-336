...
from ..models.update_issue_response_repository_template_repository_owner import (
    UpdateIssueResponseRepositoryTemplateRepositoryOwner,
)
from ..models.update_issue_response_repository_template_repository_permissions import (
    UpdateIssueResponseRepositoryTemplateRepositoryPermissions,
)


class UpdateIssueResponseRepositoryTemplateRepository(BaseModel):
    """
    Attributes:
        ...
        owner (Optional[UpdateIssueResponseRepositoryTemplateRepositoryOwner]):
        permissions (Optional[UpdateIssueResponseRepositoryTemplateRepositoryPermissions]):
    ...
    owner: Optional["UpdateIssueResponseRepositoryTemplateRepositoryOwner"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["UpdateIssueResponseRepositoryTemplateRepository"],
