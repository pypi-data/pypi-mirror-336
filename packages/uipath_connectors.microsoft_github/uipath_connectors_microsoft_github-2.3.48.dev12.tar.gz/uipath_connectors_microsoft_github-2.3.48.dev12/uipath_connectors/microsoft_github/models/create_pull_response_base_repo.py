...
from ..models.create_pull_response_base_repo_license import (
    CreatePullResponseBaseRepoLicense,
)
from ..models.create_pull_response_base_repo_owner import (
    CreatePullResponseBaseRepoOwner,
)
from ..models.create_pull_response_base_repo_permissions import (
    CreatePullResponseBaseRepoPermissions,
)
import datetime


class CreatePullResponseBaseRepo(BaseModel):
    """
    Attributes:
        ...
        license_ (Optional[CreatePullResponseBaseRepoLicense]):
        ...
        owner (Optional[CreatePullResponseBaseRepoOwner]):
        permissions (Optional[CreatePullResponseBaseRepoPermissions]):
    ...
    license_: Optional["CreatePullResponseBaseRepoLicense"] = Field(
    ...
    owner: Optional["CreatePullResponseBaseRepoOwner"] = Field(
        alias="owner", default=None
    )
    permissions: Optional["CreatePullResponseBaseRepoPermissions"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CreatePullResponseBaseRepo"], src_dict: Dict[str, Any]):
