...
from ..models.search_issues_repository_license import SearchIssuesRepositoryLicense
from ..models.search_issues_repository_organization import (
    SearchIssuesRepositoryOrganization,
)
from ..models.search_issues_repository_owner import SearchIssuesRepositoryOwner
from ..models.search_issues_repository_permissions import (
    SearchIssuesRepositoryPermissions,
)
from ..models.search_issues_repository_template_repository import (
    SearchIssuesRepositoryTemplateRepository,
)
import datetime


class SearchIssuesRepository(BaseModel):
    """
    Attributes:
        ...
        license_ (Optional[SearchIssuesRepositoryLicense]):
        ...
        organization (Optional[SearchIssuesRepositoryOrganization]):
        owner (Optional[SearchIssuesRepositoryOwner]):
        permissions (Optional[SearchIssuesRepositoryPermissions]):
        ...
        template_repository (Optional[SearchIssuesRepositoryTemplateRepository]):
    ...
    license_: Optional["SearchIssuesRepositoryLicense"] = Field(
    ...
    organization: Optional["SearchIssuesRepositoryOrganization"] = Field(
        alias="organization", default=None
    )
    owner: Optional["SearchIssuesRepositoryOwner"] = Field(alias="owner", default=None)
    permissions: Optional["SearchIssuesRepositoryPermissions"] = Field(
    ...
    template_repository: Optional["SearchIssuesRepositoryTemplateRepository"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["SearchIssuesRepository"], src_dict: Dict[str, Any]):
