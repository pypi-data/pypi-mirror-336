...
from ..models.search_issues_milestone_creator import SearchIssuesMilestoneCreator
from ..models.search_issues_milestone_state import SearchIssuesMilestoneState
import datetime


class SearchIssuesMilestone(BaseModel):
    """
    Attributes:
        ...
        creator (Optional[SearchIssuesMilestoneCreator]):
        ...
        state (Optional[SearchIssuesMilestoneState]): The state of the milestone. Example: open.
    ...
    creator: Optional["SearchIssuesMilestoneCreator"] = Field(
    ...
    state: Optional["SearchIssuesMilestoneState"] = Field(alias="state", default=None)
    ...
    @classmethod
    def from_dict(cls: Type["SearchIssuesMilestone"], src_dict: Dict[str, Any]):
