...
from ..models.search_repos_license import SearchReposLicense
from ..models.search_repos_owner import SearchReposOwner
from ..models.search_repos_permissions import SearchReposPermissions
from ..models.search_repos_text_matches_array_item_ref import (
    SearchReposTextMatchesArrayItemRef,
)
import datetime


class SearchRepos(BaseModel):
    """
    Attributes:
        ...
        license_ (Optional[SearchReposLicense]):
        ...
        owner (Optional[SearchReposOwner]):
        permissions (Optional[SearchReposPermissions]):
        ...
        text_matches (Optional[list['SearchReposTextMatchesArrayItemRef']]):
    ...
    license_: Optional["SearchReposLicense"] = Field(alias="license", default=None)
    ...
    owner: Optional["SearchReposOwner"] = Field(alias="owner", default=None)
    permissions: Optional["SearchReposPermissions"] = Field(
    ...
    text_matches: Optional[list["SearchReposTextMatchesArrayItemRef"]] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["SearchRepos"], src_dict: Dict[str, Any]):
