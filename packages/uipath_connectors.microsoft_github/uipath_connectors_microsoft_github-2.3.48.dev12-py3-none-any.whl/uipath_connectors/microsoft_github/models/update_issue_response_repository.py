...
from ..models.update_issue_response_repository_license import (
    UpdateIssueResponseRepositoryLicense,
)
from ..models.update_issue_response_repository_organization import (
    UpdateIssueResponseRepositoryOrganization,
)
from ..models.update_issue_response_repository_owner import (
    UpdateIssueResponseRepositoryOwner,
)
from ..models.update_issue_response_repository_permissions import (
    UpdateIssueResponseRepositoryPermissions,
)
from ..models.update_issue_response_repository_template_repository import (
    UpdateIssueResponseRepositoryTemplateRepository,
)
import datetime


class UpdateIssueResponseRepository(BaseModel):
    """
    Attributes:
        ...
        license_ (Optional[UpdateIssueResponseRepositoryLicense]):
        ...
        organization (Optional[UpdateIssueResponseRepositoryOrganization]):
        owner (Optional[UpdateIssueResponseRepositoryOwner]):
        permissions (Optional[UpdateIssueResponseRepositoryPermissions]):
        ...
        template_repository (Optional[UpdateIssueResponseRepositoryTemplateRepository]):
    ...
    license_: Optional["UpdateIssueResponseRepositoryLicense"] = Field(
    ...
    organization: Optional["UpdateIssueResponseRepositoryOrganization"] = Field(
        alias="organization", default=None
    )
    owner: Optional["UpdateIssueResponseRepositoryOwner"] = Field(
        alias="owner", default=None
    )
    permissions: Optional["UpdateIssueResponseRepositoryPermissions"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["UpdateIssueResponseRepository"], src_dict: Dict[str, Any]):
