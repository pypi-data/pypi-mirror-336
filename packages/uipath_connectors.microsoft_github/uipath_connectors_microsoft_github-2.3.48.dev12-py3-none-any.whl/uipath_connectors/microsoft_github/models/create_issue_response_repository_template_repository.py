...
from ..models.create_issue_response_repository_template_repository_owner import (
    CreateIssueResponseRepositoryTemplateRepositoryOwner,
)
from ..models.create_issue_response_repository_template_repository_permissions import (
    CreateIssueResponseRepositoryTemplateRepositoryPermissions,
)


class CreateIssueResponseRepositoryTemplateRepository(BaseModel):
    """
    Attributes:
        ...
        owner (Optional[CreateIssueResponseRepositoryTemplateRepositoryOwner]):
        permissions (Optional[CreateIssueResponseRepositoryTemplateRepositoryPermissions]):
    ...
    owner: Optional["CreateIssueResponseRepositoryTemplateRepositoryOwner"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateIssueResponseRepositoryTemplateRepository"],
