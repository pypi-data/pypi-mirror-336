...
from ..models.create_repo_response_template_repository_owner import (
    CreateRepoResponseTemplateRepositoryOwner,
)
from ..models.create_repo_response_template_repository_permissions import (
    CreateRepoResponseTemplateRepositoryPermissions,
)
import datetime


class CreateRepoResponseTemplateRepository(BaseModel):
    """
    Attributes:
        ...
        owner (Optional[CreateRepoResponseTemplateRepositoryOwner]):
        permissions (Optional[CreateRepoResponseTemplateRepositoryPermissions]):
    ...
    owner: Optional["CreateRepoResponseTemplateRepositoryOwner"] = Field(
        alias="owner", default=None
    )
    permissions: Optional["CreateRepoResponseTemplateRepositoryPermissions"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateRepoResponseTemplateRepository"], src_dict: Dict[str, Any]
    ):
