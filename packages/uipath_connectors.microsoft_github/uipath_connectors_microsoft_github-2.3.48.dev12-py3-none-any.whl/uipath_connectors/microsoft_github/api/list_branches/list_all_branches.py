    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListAllBranches.from_dict(response_200_item_data)
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        ref (Optional[str]): The exact reference of the branch to filter. For example, to just get
            the main (or master) branch, provide "main" (or "master") as the value.
