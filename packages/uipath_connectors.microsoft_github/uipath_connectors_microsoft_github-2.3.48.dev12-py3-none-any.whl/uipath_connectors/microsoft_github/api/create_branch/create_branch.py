...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateBranchResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateBranchResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Create Branch
     ...
     Creates a branch from an existing repository in Github
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CreateBranchResponse, DefaultError]
    """
