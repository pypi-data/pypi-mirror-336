...
class MUSES(Dataset):
    ...
    def __init__(self, root: str = Path.db_root_dir('MUSES'), split: str = 'train', transform = None, modals = ['img'], case = None) -> None:
        super().__init__()
        ...
        self.modals = modals
        self.files = sorted(glob.glob(os.path.join(*[root, split, '*', 'img', '*', '*'])))
...
if __name__ == '__main__':
    ...
    for case in cases:
        ...
        trainset = MUSES(transform=traintransform, split='val', case=case)
