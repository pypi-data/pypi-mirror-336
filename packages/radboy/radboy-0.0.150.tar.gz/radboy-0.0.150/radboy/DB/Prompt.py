...
{Fore.light_magenta}Price({i.Price}){Fore.medium_violet_red}*{Fore.light_slate_blue}Total({total}):{i.Price*total}
{Fore.grey_70}+CRV({i.CRV})*Total({total}){Fore.slate_blue_1}\n\t=TotalCRV({crv})+TotalPrice({total*i.Price})=NetPrice({(total*i.Price)+crv})
{Fore.grey_70}+Tax({i.Tax}) w/o CRV({i.CRV})*Total({total}){Fore.slate_blue_1}\n\t=TaxNoCRVTotal({tax})+TotalPrice({total*i.Price})=NetPrice({(total*i.Price)+tax})
{Fore.grey_70}+Tax({i.Tax}) w/ CRV({i.CRV})*Total({total}){Fore.slate_blue_1}\n\t=TaxCRVTotal({tax_crv})+TotalPrice({total*i.Price})=NetPrice({(total*i.Price)+tax_crv})
