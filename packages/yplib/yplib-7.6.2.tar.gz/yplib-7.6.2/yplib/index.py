...
def to_print_file_thread(*args, file_path=None, file_name=None, mode='a'):
    ...
    """
    if not hasattr(__THREAD_LOCAL_INDEX_DATA, 'to_print_file_thread'):
        __THREAD_LOCAL_INDEX_DATA.to_print_file_thread = None
    if file_path is not None:
        __THREAD_LOCAL_INDEX_DATA.to_print_file_thread = file_path
    file_path = __THREAD_LOCAL_INDEX_DATA.to_print_file_thread
