...
class ImportPlanner:
    ...
    def run(self):
        ...
        for operation in satisfiable_operations:
            if 'fields' not in operation.object_data.keys():
                operation.object_data['fields'] = {'path': '0'}
            elif 'path' not in operation.object_data['fields'].keys():
                operation.object_data['fields']['path'] = '0'
        ...
        with transaction.atomic():
            ...
            for operation in operation_order:
                operation.object_data['fields'].pop('path')
