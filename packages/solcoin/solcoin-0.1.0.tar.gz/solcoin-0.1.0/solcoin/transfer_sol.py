...
def make_transfer(client, private_key_base58_string, receiver_public_key_string, sol_amount):
    ...
    return client.send_raw_transaction(serialized_tx), int(sol_amount* 10**9)
