...
from ..models.update_host_pool_response_host_pool_type import (
    UpdateHostPoolResponseHostPoolType,
)
from ..models.update_host_pool_response_load_balancer_type import (
    UpdateHostPoolResponseLoadBalancerType,
)
from ..models.update_host_pool_response_personal_desktop_assignment_type import (
    UpdateHostPoolResponsePersonalDesktopAssignmentType,
)


class UpdateHostPoolResponse(BaseModel):
    """
    Attributes:
        description (Optional[str]): A brief summary of the host pool's purpose and contents.
        host_pool_type (Optional[UpdateHostPoolResponseHostPoolType]): Specifies whether the host pool is personal or
                shared. Default: UpdateHostPoolResponseHostPoolType.PERSONAL.
        ...
        load_balancer_type (Optional[UpdateHostPoolResponseLoadBalancerType]): Type of load balancing used for
                distributing user sessions. Default: UpdateHostPoolResponseLoadBalancerType.DEPTH_FIRST.
        ...
        personal_desktop_assignment_type (Optional[UpdateHostPoolResponsePersonalDesktopAssignmentType]): The method
                used to assign personal desktops to users. Default:
                UpdateHostPoolResponsePersonalDesktopAssignmentType.AUTOMATIC.
    ...
    host_pool_type: Optional["UpdateHostPoolResponseHostPoolType"] = Field(
        alias="hostPoolType", default=UpdateHostPoolResponseHostPoolType.PERSONAL
    )
    id: Optional[str] = Field(alias="id", default=None)
    is_validation_environment: Optional[bool] = Field(
        alias="isValidationEnvironment", default=None
    )
    load_balancer_type: Optional["UpdateHostPoolResponseLoadBalancerType"] = Field(
        alias="loadBalancerType",
        default=UpdateHostPoolResponseLoadBalancerType.DEPTH_FIRST,
    )
    ...
    personal_desktop_assignment_type: Optional[
        ...
        default=UpdateHostPoolResponsePersonalDesktopAssignmentType.AUTOMATIC,
    )
    ...
    @classmethod
    def from_dict(cls: Type["UpdateHostPoolResponse"], src_dict: Dict[str, Any]):
