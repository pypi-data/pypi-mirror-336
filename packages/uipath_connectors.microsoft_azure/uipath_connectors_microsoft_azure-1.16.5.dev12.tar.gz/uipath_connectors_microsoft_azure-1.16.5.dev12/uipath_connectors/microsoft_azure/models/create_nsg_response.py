...
from ..models.create_nsg_response_properties import CreateNSGResponseProperties


class CreateNSGResponse(BaseModel):
    """
    Attributes:
        ...
        properties (Optional[CreateNSGResponseProperties]):
    ...
    properties: Optional["CreateNSGResponseProperties"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["CreateNSGResponse"], src_dict: Dict[str, Any]):
