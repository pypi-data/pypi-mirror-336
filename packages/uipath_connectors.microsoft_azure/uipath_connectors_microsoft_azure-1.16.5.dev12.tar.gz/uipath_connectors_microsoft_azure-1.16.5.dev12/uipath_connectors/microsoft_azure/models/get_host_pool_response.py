...
from ..models.get_host_pool_response_host_pool_type import (
    GetHostPoolResponseHostPoolType,
)
from ..models.get_host_pool_response_load_balancer_type import (
    GetHostPoolResponseLoadBalancerType,
)
from ..models.get_host_pool_response_personal_desktop_assignment_type import (
    GetHostPoolResponsePersonalDesktopAssignmentType,
)


class GetHostPoolResponse(BaseModel):
    """
    Attributes:
        description (Optional[str]): A brief summary of the host pool's purpose and contents.
        host_pool_type (Optional[GetHostPoolResponseHostPoolType]): Specifies whether the host pool is personal or
                shared. Default: GetHostPoolResponseHostPoolType.PERSONAL.
        ...
        load_balancer_type (Optional[GetHostPoolResponseLoadBalancerType]): Type of load balancing used for distributing
                user sessions. Default: GetHostPoolResponseLoadBalancerType.DEPTH_FIRST.
        ...
        personal_desktop_assignment_type (Optional[GetHostPoolResponsePersonalDesktopAssignmentType]): The method used
                to assign personal desktops to users. Default: GetHostPoolResponsePersonalDesktopAssignmentType.AUTOMATIC.
    ...
    host_pool_type: Optional["GetHostPoolResponseHostPoolType"] = Field(
        alias="hostPoolType", default=GetHostPoolResponseHostPoolType.PERSONAL
    )
    id: Optional[str] = Field(alias="id", default=None)
    is_validation_environment: Optional[bool] = Field(
        alias="isValidationEnvironment", default=None
    )
    load_balancer_type: Optional["GetHostPoolResponseLoadBalancerType"] = Field(
        alias="loadBalancerType",
        default=GetHostPoolResponseLoadBalancerType.DEPTH_FIRST,
    )
    ...
    personal_desktop_assignment_type: Optional[
        ...
        default=GetHostPoolResponsePersonalDesktopAssignmentType.AUTOMATIC,
    )
    ...
    @classmethod
    def from_dict(cls: Type["GetHostPoolResponse"], src_dict: Dict[str, Any]):
