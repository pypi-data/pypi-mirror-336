...
from ..models.list_network_interface_ip_configurations_array_item_ref import (
    ListNetworkInterfaceIpConfigurationsArrayItemRef,
)
from ..models.list_network_interface_tags import ListNetworkInterfaceTags


class ListNetworkInterface(BaseModel):
    """
    Attributes:
        accelerated_networking_enabled (Optional[bool]): Indicates if accelerated networking is enabled.
        ip_configurations (Optional[list['ListNetworkInterfaceIpConfigurationsArrayItemRef']]):
        ip_forwarding_enabled (Optional[bool]): Indicates if IP forwarding is enabled for the interface.
        location (Optional[str]): The geographical location where the resource is deployed. Example: westus.
        nsg_name (Optional[str]): The name of the associated network security group.
        name (Optional[str]): The name of the network interface. Example: test-wus-proxy-private-endpoint-nic.
        ...
        tags (Optional[ListNetworkInterfaceTags]):
    ...
    ip_configurations: Optional[
        list["ListNetworkInterfaceIpConfigurationsArrayItemRef"]
    ...
    tags: Optional["ListNetworkInterfaceTags"] = Field(alias="Tags", default=None)
    ...
    @classmethod
    def from_dict(cls: Type["ListNetworkInterface"], src_dict: Dict[str, Any]):
