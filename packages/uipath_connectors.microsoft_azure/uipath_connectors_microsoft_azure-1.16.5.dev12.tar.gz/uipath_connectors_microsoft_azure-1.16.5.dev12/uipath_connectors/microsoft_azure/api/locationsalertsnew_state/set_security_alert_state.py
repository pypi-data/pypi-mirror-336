...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/locations/{asc_location}/alerts/{alert_name}/newState/{new_state}".format(
...
def sync_detailed(
    ...
    *,
    ...
    """Set Security Alert State
     ...
     Sets the security state to one of the following: activate, dismiss, in progress, or resolved.
    ...
    Args:
        ...
        new_state (str): The new state of the security alert
