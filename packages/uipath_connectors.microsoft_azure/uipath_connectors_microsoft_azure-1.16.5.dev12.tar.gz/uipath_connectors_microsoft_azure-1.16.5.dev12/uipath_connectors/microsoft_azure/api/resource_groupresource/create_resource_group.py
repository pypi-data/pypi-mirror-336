...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/resourceGroup/resource/{resource_group_name}".format(
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateResourceGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateResourceGroupResponse, DefaultError]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CreateResourceGroupResponse, DefaultError]
    """
