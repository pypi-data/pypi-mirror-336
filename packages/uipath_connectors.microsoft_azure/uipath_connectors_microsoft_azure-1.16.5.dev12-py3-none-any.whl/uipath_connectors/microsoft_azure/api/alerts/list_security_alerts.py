    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListSecurityAlerts.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListSecurityAlerts"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List Security Alerts
     ...
     List the security alerts by subscription level or resource group level or/and location level
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['ListSecurityAlerts']]
    """
