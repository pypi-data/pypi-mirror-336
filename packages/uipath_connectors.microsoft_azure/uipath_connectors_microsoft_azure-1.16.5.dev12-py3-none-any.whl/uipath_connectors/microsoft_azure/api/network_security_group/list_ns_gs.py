    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListNSGs.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListNSGs"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List NSGs
     ...
     Gets the list of network security group within the current subscription matching the filter
    criteria.
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['ListNSGs']]
    """
