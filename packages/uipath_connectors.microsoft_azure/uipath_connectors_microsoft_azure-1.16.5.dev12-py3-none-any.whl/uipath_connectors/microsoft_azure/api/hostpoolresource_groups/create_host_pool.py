...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateHostPoolResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateHostPoolResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        host_pool_name (str): The name of the host pool.
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[CreateHostPoolResponse, DefaultError]
    """
