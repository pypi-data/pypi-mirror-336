...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/networkSecurityGroups/{network_security_group}/resourceGroups/{resource_group_name}/securityRules".format(
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = GetSecurityRuleList.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["GetSecurityRuleList"]]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, list['GetSecurityRuleList']]
    """
