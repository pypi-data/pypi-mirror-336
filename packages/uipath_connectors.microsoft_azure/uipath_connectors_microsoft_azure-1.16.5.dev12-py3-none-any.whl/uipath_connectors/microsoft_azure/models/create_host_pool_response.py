...
from ..models.create_host_pool_response_host_pool_type import (
    CreateHostPoolResponseHostPoolType,
)
from ..models.create_host_pool_response_load_balancer_type import (
    CreateHostPoolResponseLoadBalancerType,
)
from ..models.create_host_pool_response_personal_desktop_assignment_type import (
    CreateHostPoolResponsePersonalDesktopAssignmentType,
)


class CreateHostPoolResponse(BaseModel):
    """
    Attributes:
        description (Optional[str]): A brief summary of the host pool's purpose and contents.
        host_pool_type (Optional[CreateHostPoolResponseHostPoolType]): Specifies whether the host pool is personal or
                shared. Default: CreateHostPoolResponseHostPoolType.PERSONAL.
        ...
        load_balancer_type (Optional[CreateHostPoolResponseLoadBalancerType]): Type of load balancing used for
                distributing user sessions. Default: CreateHostPoolResponseLoadBalancerType.DEPTH_FIRST.
        ...
        personal_desktop_assignment_type (Optional[CreateHostPoolResponsePersonalDesktopAssignmentType]): The method
                used to assign personal desktops to users. Default:
                CreateHostPoolResponsePersonalDesktopAssignmentType.AUTOMATIC.
    ...
    host_pool_type: Optional["CreateHostPoolResponseHostPoolType"] = Field(
        alias="hostPoolType", default=CreateHostPoolResponseHostPoolType.PERSONAL
    )
    id: Optional[str] = Field(alias="id", default=None)
    is_validation_environment: Optional[bool] = Field(
        alias="isValidationEnvironment", default=None
    )
    load_balancer_type: Optional["CreateHostPoolResponseLoadBalancerType"] = Field(
        alias="loadBalancerType",
        default=CreateHostPoolResponseLoadBalancerType.DEPTH_FIRST,
    )
    ...
    personal_desktop_assignment_type: Optional[
        ...
        default=CreateHostPoolResponsePersonalDesktopAssignmentType.AUTOMATIC,
    )
    ...
    @classmethod
    def from_dict(cls: Type["CreateHostPoolResponse"], src_dict: Dict[str, Any]):
