# encoding: utf-8
#
#Copyright (C) 2017-2024, P. R. Wiecha, A. Arbouet
#
...
def visu_structure_electron(struct, x0=None, y0=None, 
    ...
    if x0 is None and y0 is None and type(struct) == core.simulation:
        if struct.efield.field_generator.__name__ == fields.fast_electron.__name__:
            elpos = []
    ...
    plt.scatter(x0, y0, color=color_e_pos, marker=marker_e_pos, s=scale_e_pos*np.int32(step), lw=3)    
...
def CL(sim, field_index, r=10000., tetamin=0, tetamax=np.pi, Nteta=30, 
    ...
    Notes
    -----
    For details of the CL computation:
...
def EELS(sim, field_index):       
    ...
    Arnaud Arbouet et al. New J. Phys. 16 113012 (2014)
    
    and Appendix of:
    P. Wiecha et al. CPC 270, 108142 (2022)
    """
    from pyGDM2 import tools
