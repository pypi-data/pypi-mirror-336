...
class Counter:
    @overload
    def __init__(self, value: float = 0.0, flags: Counter.Flags = Flags.kDefaults, k: Counter.OneK = Counter.OneK.kIs1000) -> None: ...
    ...
    kDefaults: Counter.Flags = Flags.kDefaults

    kIsRate: Counter.Flags = Flags.kIsRate

    kAvgThreads: Counter.Flags = Flags.kAvgThreads

    kAvgThreadsRate: Counter.Flags = Flags.kAvgThreadsRate

    kIsIterationInvariant: Counter.Flags = Flags.kIsIterationInvariant

    kIsIterationInvariantRate: Counter.Flags = Flags.kIsIterationInvariantRate

    kAvgIterations: Counter.Flags = Flags.kAvgIterations

    kAvgIterationsRate: Counter.Flags = Flags.kAvgIterationsRate

    kInvert: Counter.Flags = Flags.kInvert
