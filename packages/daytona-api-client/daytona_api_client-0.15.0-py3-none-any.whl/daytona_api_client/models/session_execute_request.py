...
class SessionExecuteRequest(BaseModel):
    ...
    var_async: Optional[StrictBool] = Field(default=None, description="Whether to execute the command asynchronously", alias="async")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["command", "async"]
