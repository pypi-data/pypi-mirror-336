...
class WorkspaceApi:
    ...
    def resize_workspace(
        ...
        _param = self._resize_workspace_serialize(
            workspace_id=workspace_id,
            body=body,
            x_daytona_organization_id=x_daytona_organization_id,
            _request_auth=_request_auth,
    ...
    @validate_call
    def resize_workspace_with_http_info(
        self,
        workspace_id: Annotated[StrictStr, Field(description="ID of the workspace")],
        body: Dict[str, Any],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    @validate_call
    def resize_workspace_without_preload_content(
        self,
        workspace_id: Annotated[StrictStr, Field(description="ID of the workspace")],
        body: Dict[str, Any],
        x_daytona_organization_id: Annotated[Optional[StrictStr], Field(description="Use with JWT to specify the organization ID")] = None,
    ...
    def _resize_workspace_serialize(
        self,
        workspace_id,
        body,
        x_daytona_organization_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/workspace/{workspaceId}/resize',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
