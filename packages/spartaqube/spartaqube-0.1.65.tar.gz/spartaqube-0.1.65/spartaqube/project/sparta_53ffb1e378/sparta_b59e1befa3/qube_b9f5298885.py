...
def sparta_fd2ce101b7(json_data,userObj):
	B=json_data[_C]
	if int(B)==1:
	...
	try:G,H=sparta_24574ab67a(A,B);D={_A:1,_D:H,_E:G,_B:A}
	except:D={_A:-1,_F:_G}
	return D
def sparta_50433c3c44(json_data,userObj):
	A=json_data
	try:D=A[_B];E=A[_C];B=os.path.dirname(D);F,G=sparta_24574ab67a(B,E);C={_A:1,_D:G,_E:F,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_4f087e8ea1(json_data,userObj):
	A=json_data
	try:B=A[_B];D=A[_C];E,F=sparta_24574ab67a(B,D);C={_A:1,_D:F,_E:E,_B:B}
	except:C={_A:-1,_F:_G}
	return C
def sparta_24574ab67a(currentPath,typeexplorer=None):
...
def sparta_4233ab4ed0(currentPath):
