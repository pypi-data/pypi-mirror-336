...
main_api=sparta_4c7896ad88()['api']
...
def sparta_14c28d1bf8(path):A=Path(path).resolve();return str(A)
def sparta_b1f86957ee(textOutputArr):
	A=textOutputArr
	...
	return A
def sparta_a2c278e353(input2JsonEncode,dateFormat=None):
...
def sparta_68e697881e(file_path):
	A=file_path
