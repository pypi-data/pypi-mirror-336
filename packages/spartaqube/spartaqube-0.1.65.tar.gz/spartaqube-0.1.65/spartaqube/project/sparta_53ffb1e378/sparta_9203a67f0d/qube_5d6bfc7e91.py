...
def sparta_c5e4ba8bc9(user_obj):
	B=user_obj
	...
	return A
def sparta_a851263200(json_data,user_obj):
...
def sparta_09f55907ff(json_data,user_obj):
...
def sparta_47a183bce4(json_data,user_obj):
	...
	return{_C:1}
def sparta_8c021310e2(json_data,user_obj):
