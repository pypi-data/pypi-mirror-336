...
class Windows:
    ...
    def add_event_to_csv(self,
        ...
        csv_writer.writerow([
            ...
            event.TimeArray.midnight.datetime.strftime(
                '%Y%m%d'),              # Night
...
if __name__ == '__main__':
    ...
    Transits = Windows(
        table=test.table,
        directory='/media/chamaeleontis/Observatory_main/ESO_scheduling/PTO_developement/Hritam_partial_P117',
        large_program=False,
