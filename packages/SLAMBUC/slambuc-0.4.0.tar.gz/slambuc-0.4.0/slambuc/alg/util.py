...
def ihierarchical_edges(dag: nx.DiGraph, source: int) -> Generator[int]:
    """
...
def ihierarchical_nodes(dag: nx.DiGraph, source: int) -> Generator[int]:
    """
...
def par_subgraph_cost(dag: nx.DiGraph, barr: int, nodes: set[int], N: int = 1) -> int:
    """
