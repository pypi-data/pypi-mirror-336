...
from slambuc.alg.chain.path.min import min_chain_partitioning
...
def run_test(runtime: list, memory: list, rate: list, M: int = math.inf, N: int = math.inf,
    ...
    barr, opt_cost, opt_lat = min_chain_partitioning(runtime, memory, rate, M, N, L, start, end, delay, unit)
