...
from gateway.apis.cluster_api import ClusterApi
from gateway.apis.query_api import QueryApi
...
class GatewayClient:
    def __init__(self, base_url, apikey, client = None):
        ...
        Attributes:
            ...
            cluster_api (ClusterApi): An instance of ClusterApi for interacting with the Clusters API endpoints.
            query_api (QueryApi): An instance of QueryApi for interacting with the Queries API endpoints.
        """
        self.client = client
        ...
        self.cluster_api = ClusterApi(base_url, self.apikey, client=self.client)
        self.query_api = QueryApi(base_url, self.apikey, client=self.client)