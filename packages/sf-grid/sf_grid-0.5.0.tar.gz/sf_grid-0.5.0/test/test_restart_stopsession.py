...
class TestRestartStopSession(unittest.TestCase):
    ...
    def test_repl_restart_and_stop_session(self):
        # Initialize containers for sim=airgen
        ...
        # Start session using sample airgen session config
        ...
        # Stop the session
        self.repl.do_session("stop @local")
