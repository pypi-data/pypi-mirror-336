...
class DSPMetadataResponse(BaseModel):
    ...
    __properties = ["success", "error", "created", "dspConfig", "labels", "featureLabels", "windowCount", "featureCount", "includedSamples", "windowSizeMs", "windowIncreaseMs", "padZeros", "frequency", "outputConfig", "fftUsed", "resamplingAlgorithmVersion"]
