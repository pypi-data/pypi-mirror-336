...
class JobsApi(object):
    ...
    @validate_arguments
    def optimize_job(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], continuation_job_id : Annotated[Optional[StrictInt], Field(description="Tuner coordinator job ID")] = None, **kwargs) -> StartJobResponse:  # noqa: E501
        """Optimize model
        ...
        :param project_id: Project ID (required)
        :type project_id: int
        :param continuation_job_id: Tuner coordinator job ID
        :type continuation_job_id: int
        :param async_req: Whether to execute the request asynchronously.
        :type async_req: bool, optional
        :param _preload_content: if False, the urllib3.HTTPResponse object will
                                 be returned without reading/decoding response
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self._optimize_job_with_http_info(project_id, continuation_job_id, **kwargs)  # noqa: E501

    @validate_arguments
    def _optimize_job_with_http_info(self, project_id : Annotated[StrictInt, Field(..., description="Project ID")], continuation_job_id : Annotated[Optional[StrictInt], Field(description="Tuner coordinator job ID")] = None, **kwargs):  # noqa: E501
        """Optimize model 
        ...
        # process the query parameters
        _query_params = []
        if _params.get('continuation_job_id') is not None:  # noqa: E501
            _query_params.append(('continuationJobId', _params['continuation_job_id']))
