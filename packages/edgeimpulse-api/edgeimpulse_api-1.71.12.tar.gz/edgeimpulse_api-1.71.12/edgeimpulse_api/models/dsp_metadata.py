...
class DSPMetadata(BaseModel):
    ...
    __properties = ["created", "dspConfig", "labels", "featureLabels", "windowCount", "featureCount", "includedSamples", "windowSizeMs", "windowIncreaseMs", "padZeros", "frequency", "outputConfig", "fftUsed", "resamplingAlgorithmVersion"]
