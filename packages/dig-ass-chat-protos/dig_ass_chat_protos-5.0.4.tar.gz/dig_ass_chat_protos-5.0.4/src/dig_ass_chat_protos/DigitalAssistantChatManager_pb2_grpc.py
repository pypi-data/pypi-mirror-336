...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in dig_ass_chat_protos/DigitalAssistantChatManager_pb2_grpc.py depends on'
...
class DigitalAssistantChatManagerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetChatResponse = channel.unary_unary(
                '/dig.ass.manager.v1.DigitalAssistantChatManager/GetChatResponse',
...
def add_DigitalAssistantChatManagerServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('dig.ass.manager.v1.DigitalAssistantChatManager', rpc_method_handlers)
