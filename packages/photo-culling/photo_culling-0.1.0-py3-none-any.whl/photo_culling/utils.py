...
def get_subimage(img: Image, frac_pos, resolution):
...
def resize_img_with_padding(img: Image, target_res: tuple[int, int]):
    """
    ...
    # Create new black image with target resolution
