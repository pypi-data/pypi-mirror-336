...
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64649);
/* harmony import */ var _jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_jupyterlab_coreutils__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _lumino_coreutils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(21961);
...
async function main() {
  const mimeExtensionsMods = [
    __webpack_require__(91977),
    __webpack_require__(99929),
    __webpack_require__(28025),
    __webpack_require__(34166),
  ];
  const mimeExtensions = await Promise.all(mimeExtensionsMods);

  // Load the base plugins available on all pages
  let baseMods = [
      __webpack_require__(47911),
  __webpack_require__(6053),
  __webpack_require__(1582),
  __webpack_require__(29473),
  __webpack_require__(35425),
  __webpack_require__(22494),
  __webpack_require__(32161),
  
      (__webpack_require__(84237)["default"].filter)(({id}) => [
...
'@jupyterlab/application-extension:top-spacer',
      ...
      (__webpack_require__(69105)["default"].filter)(({id}) => [
...
'@jupyterlab/apputils-extension:utilityCommands',
      ...
      __webpack_require__(34106),
  
      (__webpack_require__(81467)["default"].filter)(({id}) => [
...
'@jupyterlab/completer-extension:manager',
      ...
      (__webpack_require__(5561)["default"].filter)(({id}) => [
...
'@jupyterlab/console-extension:tracker',
      ...
      __webpack_require__(61127),
  
      (__webpack_require__(47957)["default"].filter)(({id}) => [
...
'@jupyterlab/docmanager-extension:manager',
      ...
      (__webpack_require__(13051)["default"].filter)(({id}) => [
       '@jupyterlab/documentsearch-extension:plugin',
      ].includes(id)),
      
      (__webpack_require__(82685)["default"].filter)(({id}) => [
       '@jupyterlab/filebrowser-extension:factory',
'@jupyterlab/filebrowser-extension:default-file-browser',
      ].includes(id)),
      
      (__webpack_require__(93649)["default"].filter)(({id}) => [
       '@jupyterlab/fileeditor-extension:plugin',
'@jupyterlab/fileeditor-extension:widget-factory',
      ].includes(id)),
      
      (__webpack_require__(36425)["default"].filter)(({id}) => [
       '@jupyterlab/help-extension:resources',
      ].includes(id)),
      __webpack_require__(69697),
  __webpack_require__(30327),
  __webpack_require__(15554),
  
      (__webpack_require__(55262)["default"].filter)(({id}) => [
       '@jupyterlab/mainmenu-extension:plugin',
      ].includes(id)),
      __webpack_require__(29619),
  __webpack_require__(67183),
  __webpack_require__(32166),
  
      (__webpack_require__(13577)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:widget-factory',
      ...
      __webpack_require__(80267),
  __webpack_require__(60504),
  __webpack_require__(86662),
  __webpack_require__(84552),
  __webpack_require__(2883),
  __webpack_require__(80838),
  __webpack_require__(90235),
  __webpack_require__(42019),
  __webpack_require__(39802),
  __webpack_require__(64997),
...
'@jupyterlab/filebrowser-extension:share-file',
      ...
      __webpack_require__(79514),
  
      (__webpack_require__(35450)["default"].filter)(({id}) => [
       '@jupyterlab/running-extension:plugin',
      ].includes(id)),
      __webpack_require__(45406),
    ...
    case '/notebooks': {
      baseMods = baseMods.concat([
        __webpack_require__(79038),
  __webpack_require__(16634),
  
      (__webpack_require__(62230)["default"].filter)(({id}) => [
...
'@jupyterlab/notebook-extension:update-raw-mimetype',
      ...
      (__webpack_require__(45068)["default"].filter)(({id}) => [
       '@jupyterlab/toc-extension:registry',
'@jupyterlab/toc-extension:tracker',
      ].includes(id)),
      
      (__webpack_require__(85207)["default"].filter)(({id}) => [
...
'@jupyterlab/fileeditor-extension:search',
  ...
  const NotebookApp = (__webpack_require__(73144).NotebookApp);

  pluginRegistry.registerPlugins(mods);
  const IServiceManager = (__webpack_require__(637).IServiceManager);
...
//# sourceMappingURL=8781.6d6b0a7673f4c6f0a407.js.map?v=6d6b0a7673f4c6f0a407