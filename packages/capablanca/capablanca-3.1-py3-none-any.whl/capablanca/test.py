...
def main():
    ...
    helper = argparse.ArgumentParser(prog="test_approx", description="The Capablanca Testing Application using randomly generated, large sparse matrices.")
    ...
    helper.add_argument('--version', action='version', version='%(prog)s 3.1')
    ...
    for i in range(num_tests):
        ...
        output = f"{i + 1}-Capablanca Test: {answer}" 
        utils.println(output, logger, args.log)
