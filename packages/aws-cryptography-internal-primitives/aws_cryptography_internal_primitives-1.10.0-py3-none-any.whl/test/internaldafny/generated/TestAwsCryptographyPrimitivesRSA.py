...
class default__:
    ...
    def RSAEncryptTests():
        ...
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(52,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        d_2_keys_: Wrappers.Result
        out1_: Wrappers.Result
        out1_ = (d_1_client_).GenerateRSAKeyPair(AwsCryptographyPrimitivesTypes.GenerateRSAKeyPairInput_GenerateRSAKeyPairInput(2048))
        d_2_keys_ = out1_
        if not((d_2_keys_).is_Success):
            raise _dafny.HaltException("test/TestRSA.dfy(54,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
        default__.BasicRSAEncryptTest(AwsCryptographyPrimitivesTypes.RSAEncryptInput_RSAEncryptInput(AwsCryptographyPrimitivesTypes.RSAPaddingMode_OAEP__SHA256(), (((d_2_keys_).value).publicKey).pem, _dafny.Seq([97, 115, 100, 102])), (d_2_keys_).value)
    ...
    def GetRSAKeyModulusLength():
        ...
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(68,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        d_2_valueOrError1_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_2_valueOrError1_ = UTF8.default__.Encode(default__.RSA__PUBLIC__2048)
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(72,25): " + _dafny.string_of(d_2_valueOrError1_))
        d_3_publicKey2048_: _dafny.Seq
        d_3_publicKey2048_ = (d_2_valueOrError1_).Extract()
        d_4_valueOrError2_: Wrappers.Result = None
        d_4_valueOrError2_ = (d_1_client_).GetRSAKeyModulusLength(AwsCryptographyPrimitivesTypes.GetRSAKeyModulusLengthInput_GetRSAKeyModulusLengthInput(d_3_publicKey2048_))
        if not(not((d_4_valueOrError2_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(73,22): " + _dafny.string_of(d_4_valueOrError2_))
        d_5_length2048_: AwsCryptographyPrimitivesTypes.GetRSAKeyModulusLengthOutput
        d_5_length2048_ = (d_4_valueOrError2_).Extract()
        if not(((d_5_length2048_).length) == (2048)):
            raise _dafny.HaltException("test/TestRSA.dfy(75,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
        d_6_valueOrError3_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_6_valueOrError3_ = UTF8.default__.Encode(default__.RSA__PUBLIC__3072)
        if not(not((d_6_valueOrError3_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(78,25): " + _dafny.string_of(d_6_valueOrError3_))
        d_7_publicKey3072_: _dafny.Seq
        d_7_publicKey3072_ = (d_6_valueOrError3_).Extract()
        d_8_valueOrError4_: Wrappers.Result = None
        d_8_valueOrError4_ = (d_1_client_).GetRSAKeyModulusLength(AwsCryptographyPrimitivesTypes.GetRSAKeyModulusLengthInput_GetRSAKeyModulusLengthInput(d_7_publicKey3072_))
        if not(not((d_8_valueOrError4_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(79,22): " + _dafny.string_of(d_8_valueOrError4_))
        d_9_length3072_: AwsCryptographyPrimitivesTypes.GetRSAKeyModulusLengthOutput
        d_9_length3072_ = (d_8_valueOrError4_).Extract()
        if not(((d_9_length3072_).length) == (3072)):
            raise _dafny.HaltException("test/TestRSA.dfy(81,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
        d_10_valueOrError5_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_10_valueOrError5_ = UTF8.default__.Encode(default__.RSA__PUBLIC__4096)
        if not(not((d_10_valueOrError5_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(84,25): " + _dafny.string_of(d_10_valueOrError5_))
        d_11_publicKey4096_: _dafny.Seq
        d_11_publicKey4096_ = (d_10_valueOrError5_).Extract()
        d_12_valueOrError6_: Wrappers.Result = None
        d_12_valueOrError6_ = (d_1_client_).GetRSAKeyModulusLength(AwsCryptographyPrimitivesTypes.GetRSAKeyModulusLengthInput_GetRSAKeyModulusLengthInput(d_11_publicKey4096_))
        if not(not((d_12_valueOrError6_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(85,22): " + _dafny.string_of(d_12_valueOrError6_))
        d_13_length4096_: AwsCryptographyPrimitivesTypes.GetRSAKeyModulusLengthOutput
        d_13_length4096_ = (d_12_valueOrError6_).Extract()
        if not(((d_13_length4096_).length) == (4096)):
            raise _dafny.HaltException("test/TestRSA.dfy(87,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
    ...
    def BasicRSADecryptTests(input, expectedOutput):
        ...
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(95,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        d_2_valueOrError1_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        out1_: Wrappers.Result
        out1_ = (d_1_client_).RSADecrypt(input)
        d_2_valueOrError1_ = out1_
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(96,18): " + _dafny.string_of(d_2_valueOrError1_))
        d_3_output_: _dafny.Seq
        d_3_output_ = (d_2_valueOrError1_).Extract()
        if not((d_3_output_) == (expectedOutput)):
            raise _dafny.HaltException("test/TestRSA.dfy(98,4): " + _dafny.string_of(_dafny.Seq("expectation violation")))
    ...
    def BasicRSAEncryptTest(input, keypair):
        ...
        d_0_valueOrError0_ = out0_
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(107,18): " + _dafny.string_of(d_0_valueOrError0_))
        d_1_client_: AtomicPrimitives.AtomicPrimitivesClient
        d_1_client_ = (d_0_valueOrError0_).Extract()
        d_2_valueOrError1_: Wrappers.Result = Wrappers.Result.default(_dafny.Seq)()
        out1_: Wrappers.Result
        out1_ = (d_1_client_).RSAEncrypt(input)
        d_2_valueOrError1_ = out1_
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(108,18): " + _dafny.string_of(d_2_valueOrError1_))
        d_3_output_: _dafny.Seq
        d_3_output_ = (d_2_valueOrError1_).Extract()
        d_4_decryptInput_: AwsCryptographyPrimitivesTypes.RSADecryptInput
        d_4_decryptInput_ = AwsCryptographyPrimitivesTypes.RSADecryptInput_RSADecryptInput((input).padding, ((keypair).privateKey).pem, d_3_output_)
        default__.BasicRSADecryptTests(d_4_decryptInput_, (input).plaintext)

    @staticmethod
    def TestingPemParsingInRSAEncryptionForRSAKeyPairStoredInPEM():
        d_0_allPadding_: _dafny.Set
        def iife0_():
            coll0_ = _dafny.Set()
            ...
            for compr_0_ in AwsCryptographyPrimitivesTypes.RSAPaddingMode.AllSingletonConstructors:
                d_1_p_: AwsCryptographyPrimitivesTypes.RSAPaddingMode = compr_0_
                coll0_ = coll0_.union(_dafny.Set([d_1_p_]))
            return _dafny.Set(coll0_)
        d_0_allPadding_ = iife0_()
        
        d_2_valueOrError0_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_2_valueOrError0_ = UTF8.default__.Encode(default__.StaticPublicKeyFromGenerateRSAKeyPair())
        if not(not((d_2_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(122,51): " + _dafny.string_of(d_2_valueOrError0_))
        d_3_PublicKeyFromGenerateRSAKeyPairPemBytes_: _dafny.Seq
        d_3_PublicKeyFromGenerateRSAKeyPairPemBytes_ = (d_2_valueOrError0_).Extract()
        d_4_valueOrError1_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_4_valueOrError1_ = UTF8.default__.Encode(default__.StaticPrivateKeyFromGenerateRSAKeyPair())
        if not(not((d_4_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(123,52): " + _dafny.string_of(d_4_valueOrError1_))
        d_5_PrivateKeyFromGenerateRSAKeyPairPemBytes_: _dafny.Seq
        d_5_PrivateKeyFromGenerateRSAKeyPairPemBytes_ = (d_4_valueOrError1_).Extract()
        d_6_KeyFromGenerateRSAKeyPair_: AwsCryptographyPrimitivesTypes.GenerateRSAKeyPairOutput
        d_6_KeyFromGenerateRSAKeyPair_ = AwsCryptographyPrimitivesTypes.GenerateRSAKeyPairOutput_GenerateRSAKeyPairOutput(AwsCryptographyPrimitivesTypes.RSAPublicKey_RSAPublicKey(2048, d_3_PublicKeyFromGenerateRSAKeyPairPemBytes_), AwsCryptographyPrimitivesTypes.RSAPrivateKey_RSAPrivateKey(2048, d_5_PrivateKeyFromGenerateRSAKeyPairPemBytes_))
        d_7_paddingSeq_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = SortedSets.default__.SetToSequence(d_0_allPadding_)
        d_7_paddingSeq_ = out0_
        hi0_ = len(d_7_paddingSeq_)
        for d_8_paddingIdx_ in range(0, hi0_):
            d_9_padding_: AwsCryptographyPrimitivesTypes.RSAPaddingMode
            d_9_padding_ = (d_7_paddingSeq_)[d_8_paddingIdx_]
            default__.BasicRSAEncryptTest(AwsCryptographyPrimitivesTypes.RSAEncryptInput_RSAEncryptInput(d_9_padding_, ((d_6_KeyFromGenerateRSAKeyPair_).publicKey).pem, _dafny.Seq([97, 115, 100, 102])), d_6_KeyFromGenerateRSAKeyPair_)
    ...
    def TestingPemParsingInRSAEncryptionForOnlyRSAPrivateKeyStoredInPEM():
        ...
        d_2_valueOrError0_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_2_valueOrError0_ = UTF8.default__.Encode(default__.StaticPublicKeyFromTestVectors())
        if not(not((d_2_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(155,44): " + _dafny.string_of(d_2_valueOrError0_))
        d_3_PublicKeyFromTestVectorsPemBytes_: _dafny.Seq
        d_3_PublicKeyFromTestVectorsPemBytes_ = (d_2_valueOrError0_).Extract()
        d_4_valueOrError1_: Wrappers.Result = Wrappers.Result.default(UTF8.ValidUTF8Bytes.default)()
        d_4_valueOrError1_ = UTF8.default__.Encode(default__.StaticPrivateKeyFromTestVectors())
        if not(not((d_4_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("test/TestRSA.dfy(156,45): " + _dafny.string_of(d_4_valueOrError1_))
        d_5_PrivateKeyFromTestVectorsPemBytes_: _dafny.Seq
        d_5_PrivateKeyFromTestVectorsPemBytes_ = (d_4_valueOrError1_).Extract()
        d_6_KeyFromTestVectorsPair_: AwsCryptographyPrimitivesTypes.GenerateRSAKeyPairOutput
        d_6_KeyFromTestVectorsPair_ = AwsCryptographyPrimitivesTypes.GenerateRSAKeyPairOutput_GenerateRSAKeyPairOutput(AwsCryptographyPrimitivesTypes.RSAPublicKey_RSAPublicKey(4096, d_3_PublicKeyFromTestVectorsPemBytes_), AwsCryptographyPrimitivesTypes.RSAPrivateKey_RSAPrivateKey(4096, d_5_PrivateKeyFromTestVectorsPemBytes_))
        d_7_paddingSeq_: _dafny.Seq
        out0_: _dafny.Seq
        out0_ = SortedSets.default__.SetToSequence(d_0_allPadding_)
        d_7_paddingSeq_ = out0_
        ...
        for d_8_paddingIdx_ in range(0, hi0_):
            d_9_padding_: AwsCryptographyPrimitivesTypes.RSAPaddingMode
            d_9_padding_ = (d_7_paddingSeq_)[d_8_paddingIdx_]
            default__.BasicRSAEncryptTest(AwsCryptographyPrimitivesTypes.RSAEncryptInput_RSAEncryptInput(d_9_padding_, ((d_6_KeyFromTestVectorsPair_).publicKey).pem, _dafny.Seq([97, 115, 100, 102])), d_6_KeyFromTestVectorsPair_)
