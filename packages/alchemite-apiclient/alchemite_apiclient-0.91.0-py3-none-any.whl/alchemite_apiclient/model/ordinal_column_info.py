...
def lazy_import():
    ...
    globals()['ColumnInfoBase'] = ColumnInfoBase
    globals()['OrdinalColumnInfoAllOf'] = OrdinalColumnInfoAllOf
    globals()['OrdinalColumnInfoStats'] = OrdinalColumnInfoStats


class OrdinalColumnInfo(ModelComposed):
    ...
    def openapi_types():  # noqa
        ...
        return {
            ...
            'mode': (float, none_type,),  # noqa: E501
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """OrdinalColumnInfo - a model defined in OpenAPI

        Keyword Args:
            name (str): The unique name of the column.
            data_type (str): defaults to "ordinal", must be one of ["ordinal", ]  # noqa: E501
            num_samples (int): The number of non-missing values appearing in this column in the dataset.. defaults to 0, must be one of [0, ]  # noqa: E501
        ...
        data_type = kwargs.get('data_type', "ordinal")
