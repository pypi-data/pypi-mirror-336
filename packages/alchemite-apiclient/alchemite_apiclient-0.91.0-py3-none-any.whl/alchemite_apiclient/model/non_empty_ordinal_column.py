...
class NonEmptyOrdinalColumn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, num_samples, ordinals_present, mode, max, min, mean, *args, **kwargs):  # noqa: E501
        """NonEmptyOrdinalColumn - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, num_samples, ordinals_present, mode, max, min, mean, *args, **kwargs):  # noqa: E501
        """NonEmptyOrdinalColumn - a model defined in OpenAPI
