...
class EmptyOrdinalColumn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, ordinals_present, mode, max, min, mean, *args, **kwargs):  # noqa: E501
        """EmptyOrdinalColumn - a model defined in OpenAPI
        ...
        self.ordinals_present = ordinals_present
        self.mode = mode
        self.max = max
        self.min = min
        self.mean = mean
    ...
    @convert_js_args_to_python_args
    def __init__(self, ordinals_present, mode, max, min, mean, *args, **kwargs):  # noqa: E501
        """EmptyOrdinalColumn - a model defined in OpenAPI
