...
class Model(ModelNormal):
    ...
    def _from_openapi_data(cls, name, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            ...
            validation_metric (float, none_type): The median of validation metrics (whether R^2 for continuous and ordinal columns or MCC for categorical columns) across the target columns in the validation set.. [optional]  # noqa: E501
