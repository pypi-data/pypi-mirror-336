...
class EmptyContinuousColumn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, max, min, mean, *args, **kwargs):  # noqa: E501
        """EmptyContinuousColumn - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, max, min, mean, *args, **kwargs):  # noqa: E501
        """EmptyContinuousColumn - a model defined in OpenAPI
