...
class NonEmptyContinuousColumn(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, num_samples, max, min, mean, *args, **kwargs):  # noqa: E501
        """NonEmptyContinuousColumn - a model defined in OpenAPI
    ...
    @convert_js_args_to_python_args
    def __init__(self, num_samples, max, min, mean, *args, **kwargs):  # noqa: E501
        """NonEmptyContinuousColumn - a model defined in OpenAPI
