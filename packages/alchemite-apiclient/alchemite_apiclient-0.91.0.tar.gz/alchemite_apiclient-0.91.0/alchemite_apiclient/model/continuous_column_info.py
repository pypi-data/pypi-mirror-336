...
def lazy_import():
    ...
    globals()['ContinuousColumnInfoAllOf'] = ContinuousColumnInfoAllOf
    globals()['ContinuousColumnInfoStats'] = ContinuousColumnInfoStats


class ContinuousColumnInfo(ModelComposed):
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """ContinuousColumnInfo - a model defined in OpenAPI

        Keyword Args:
            name (str): The unique name of the column.
            data_type (str): defaults to "continuous", must be one of ["continuous", ]  # noqa: E501
