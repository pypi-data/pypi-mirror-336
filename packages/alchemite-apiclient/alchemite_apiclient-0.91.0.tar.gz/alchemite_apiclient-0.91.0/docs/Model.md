...
**validation_metric** | **float, none_type** | The median of validation metrics (whether R^2 for continuous and ordinal columns or MCC for categorical columns) across the target columns in the validation set. | [optional] [readonly] 
