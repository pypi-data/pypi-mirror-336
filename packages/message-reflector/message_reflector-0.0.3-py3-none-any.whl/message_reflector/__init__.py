...
def message_reflector(message: str, id: str, delay_ms: int = 1000, key: str = None):
    """
    ...
    message_data = _component_func(message=message, id=id, delay_ms=delay_ms, key=key, default=None)
