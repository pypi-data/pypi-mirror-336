...
if not _RELEASE:
    ...
    build_dir = os.path.join(parent_dir, "message_reflector/frontend/build")
...
def message_reflector(message: str, previous_message: str, delay_ms: int = 1000, key: str = None):
    """
    ...
    message_data = _component_func(message=message, previous_message=previous_message, delay_ms=delay_ms, key=key, default=None)
