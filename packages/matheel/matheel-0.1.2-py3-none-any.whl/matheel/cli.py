...
@click.option('--pooling', default='mean', type=click.Choice(['mean', 'cls', 'max']), help='Pooling Type')
...
def main(zipfile, ws, wl, wj, model, pooling, threshold, num):
    """Matheel CLI - Compute Code Similarity"""
    results = get_sim_list(zipfile, ws, wl, wj, model, pooling, threshold, num)
