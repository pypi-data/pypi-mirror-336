...
from ..error import ttypes as error_ttypes
from ..type import ttypes as type_ttypes
from ..userstore import ttypes as userstore_ttypes
...
class Processor(Iface, TProcessor):
    ...
    def process_getSyncState(self, seqid, iprot, oprot):
        ...
        except error_ttypes.EDAMUserException as userException:
            result.userException = userException
        except error_ttypes.EDAMSystemException as systemException:
    ...
    def process_getLinkedNotebookSyncState(self, seqid, iprot, oprot):
        ...
        try:
            ...
            result.systemException = systemException
        except error_ttypes.EDAMNotFoundException as notFoundException:
  ...
  """
    ...
    thrift_spec = (
        ...
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'systemException',
         (error_ttypes.EDAMSystemException, error_ttypes.EDAMSystemException.thrift_spec),
         None,),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.userException = error_ttypes.EDAMUserException()
                    self.userException.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    self.systemException = error_ttypes.EDAMSystemException()
  ...
  """
    ...
    thrift_spec = (
        ...
        (2, TType.STRUCT, 'linkedNotebook',
         (type_ttypes.LinkedNotebook, type_ttypes.LinkedNotebook.thrift_spec), None,),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.linkedNotebook = type_ttypes.LinkedNotebook()
  ...
  """
    ...
    thrift_spec = (
        ...
        (3, TType.STRUCT, 'notFoundException', (
            error_ttypes.EDAMNotFoundException, error_ttypes.EDAMNotFoundException.thrift_spec),
         None,),  # 3
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                ...
                if ftype == TType.STRUCT:
                    self.notFoundException = error_ttypes.EDAMNotFoundException()
  ...
  """
    ...
    thrift_spec = (
        (0, TType.LIST, 'success',
         (TType.STRUCT, (type_ttypes.Notebook, type_ttypes.Notebook.thrift_spec)), None,),
        # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.Notebook, type_ttypes.Notebook.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'systemException',
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.Notebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        ...
        (2, TType.STRUCT, 'notebook',
         (type_ttypes.Notebook, type_ttypes.Notebook.thrift_spec), None,),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.notebook = type_ttypes.Notebook()
...
class listTags_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.LIST, 'success',
         (TType.STRUCT, (type_ttypes.Tag, type_ttypes.Tag.thrift_spec)), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'systemException',
...
class getTag_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (type_ttypes.Tag, type_ttypes.Tag.thrift_spec), None,),
        # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
...
class createTag_args(object):
  ...
  """
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'authenticationToken', None, None,),  # 1
        (2, TType.STRUCT, 'tag', (type_ttypes.Tag, type_ttypes.Tag.thrift_spec), None,),
        # 2
    )
...
class listSearches_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.LIST, 'success',
         (TType.STRUCT, (type_ttypes.SavedSearch, type_ttypes.SavedSearch.thrift_spec)),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i218 in range(_size214):
                        _elem219 = type_ttypes.SavedSearch()
                        _elem219.read(iprot)
...
class getSearch_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.SavedSearch, type_ttypes.SavedSearch.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'systemException',
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.SavedSearch()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        ...
        (2, TType.STRUCT, 'search',
         (type_ttypes.SavedSearch, type_ttypes.SavedSearch.thrift_spec), None,),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.search = type_ttypes.SavedSearch()
...
class getNote_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (type_ttypes.Note, type_ttypes.Note.thrift_spec),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
...
class getNoteApplicationData_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (type_ttypes.LazyMap, type_ttypes.LazyMap.thrift_spec),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.LazyMap()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class createNote_args(object):
  ...
  """
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.STRING, 'authenticationToken', None, None,),  # 1
        (2, TType.STRUCT, 'note', (type_ttypes.Note, type_ttypes.Note.thrift_spec), None,),
        # 2
    )
...
class getResource_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.Resource, type_ttypes.Resource.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'systemException',
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.Resource()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        ...
        (2, TType.STRUCT, 'resource',
         (type_ttypes.Resource, type_ttypes.Resource.thrift_spec), None,),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.resource = type_ttypes.Resource()
...
class getResourceAttributes_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.ResourceAttributes, type_ttypes.ResourceAttributes.thrift_spec),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.ResourceAttributes()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
  ...
  """
    ...
    thrift_spec = (
        ...
        (2, TType.STRUCT, 'sharedNotebook',
         (type_ttypes.SharedNotebook, type_ttypes.SharedNotebook.thrift_spec), None,),  # 2
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.sharedNotebook = type_ttypes.SharedNotebook()
...
class createSharedNotebook_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.SharedNotebook, type_ttypes.SharedNotebook.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'notFoundException', (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.SharedNotebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class setSharedNotebookRecipientSettings_args(object):
  ...
  """
    ...
    thrift_spec = (
        ...
        (3, TType.STRUCT, 'recipientSettings', (type_ttypes.SharedNotebookRecipientSettings,
                                                type_ttypes.SharedNotebookRecipientSettings.thrift_spec),
         None,),  # 3
    )
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.recipientSettings = type_ttypes.SharedNotebookRecipientSettings()
...
class listSharedNotebooks_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (
            TType.STRUCT, (type_ttypes.SharedNotebook, type_ttypes.SharedNotebook.thrift_spec)),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i253 in range(_size249):
                        _elem254 = type_ttypes.SharedNotebook()
                        _elem254.read(iprot)
...
class createLinkedNotebook_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.LinkedNotebook, type_ttypes.LinkedNotebook.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'notFoundException', (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.LinkedNotebook()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
...
class listLinkedNotebooks_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.LIST, 'success', (
            TType.STRUCT, (type_ttypes.LinkedNotebook, type_ttypes.LinkedNotebook.thrift_spec)),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
            ...
            if fid == 0:
                if ftype == TType.LIST:
                    ...
                    for _i267 in range(_size263):
                        _elem268 = type_ttypes.LinkedNotebook()
                        _elem268.read(iprot)
...
class authenticateToSharedNotebook_result(object):
  ...
  """
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (userstore_ttypes.AuthenticationResult,
                                      userstore_ttypes.AuthenticationResult.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'notFoundException', (
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = userstore_ttypes.AuthenticationResult()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
