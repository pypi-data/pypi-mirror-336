...
class AuthenticationResult(object):
    ...
    thrift_spec = (
        ...
        (4, TType.STRUCT, 'user', (type_ttypes.User, type_ttypes.User.thrift_spec), None,),
        # 4
    ...
    def __init__(self, currentTime=None, authenticationToken=None, expiration=None, user=None, publicUserInfo=None,
                 noteStoreUrl=None, webApiUrlPrefix=None, secondFactorRequired=None, secondFactorDeliveryHint=None, ):
...
class BootstrapSettings(object):
    ...
    def __init__(self, serviceHost=None, marketingUrl=None, supportUrl=None, accountEmailDomain=None,
                 enableFacebookSharing=None, enableGiftSubscriptions=None, enableSupportTickets=None,
                 enableSharedNotebooks=None, enableSingleNoteSharing=None, enableSponsoredAccounts=None,
                 enableTwitterSharing=None, enableLinkedInSharing=None, enablePublicNotebooks=None, ):
