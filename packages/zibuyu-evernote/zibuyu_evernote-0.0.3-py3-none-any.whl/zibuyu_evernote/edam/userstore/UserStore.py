...
class Iface(object):
    ...
    def authenticateLongSession(self, username, password, consumerKey, consumerSecret, deviceIdentifier,
                                deviceDescription, supportsTwoFactor):
        """
        This is used to check a username and password in order to create a
...
class Client(Iface):
    ...
    def authenticateLongSession(self, username, password, consumerKey, consumerSecret, deviceIdentifier,
        ...
        Parameters:
         ...
         - supportsTwoFactor
        """
        self.send_authenticateLongSession(username, password, consumerKey, consumerSecret, deviceIdentifier,
                                          deviceDescription, supportsTwoFactor)
        return self.recv_authenticateLongSession()

    def send_authenticateLongSession(self, username, password, consumerKey, consumerSecret, deviceIdentifier,
                                     deviceDescription, supportsTwoFactor):
    ...
    def recv_authenticateLongSession(self, ):
        ...
        raise TApplicationException(TApplicationException.MISSING_RESULT,
                                    "authenticateLongSession failed: unknown result");
    ...
    def send_completeTwoFactorAuthentication(self, authenticationToken, oneTimeCode, deviceIdentifier,
                                             deviceDescription):
    ...
    def recv_completeTwoFactorAuthentication(self, ):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(TApplicationException.MISSING_RESULT,
                                    "completeTwoFactorAuthentication failed: unknown result");
    ...
    def recv_authenticateToBusiness(self, ):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(TApplicationException.MISSING_RESULT,
                                    "authenticateToBusiness failed: unknown result");
    ...
    def recv_refreshAuthentication(self, ):
        ...
        if result.systemException is not None:
            raise result.systemException
        raise TApplicationException(TApplicationException.MISSING_RESULT,
                                    "refreshAuthentication failed: unknown result");
...
class Processor(Iface, TProcessor):
    ...
    def process_authenticate(self, seqid, iprot, oprot):
        ...
        result = authenticate_result()
        try:
            result.success = self._handler.authenticate(args.username, args.password, args.consumerKey,
                                                        args.consumerSecret, args.supportsTwoFactor)
    ...
    def process_authenticateLongSession(self, seqid, iprot, oprot):
        ...
        result = authenticateLongSession_result()
        try:
            result.success = self._handler.authenticateLongSession(args.username, args.password, args.consumerKey,
                                                                   args.consumerSecret, args.deviceIdentifier,
                                                                   args.deviceDescription, args.supportsTwoFactor)
        except error_ttypes.EDAMUserException as userException:
            result.userException = userException
        except error_ttypes.EDAMSystemException as systemException:
            result.systemException = systemException
    ...
    def process_completeTwoFactorAuthentication(self, seqid, iprot, oprot):
        ...
        result = completeTwoFactorAuthentication_result()
        try:
            result.success = self._handler.completeTwoFactorAuthentication(args.authenticationToken, args.oneTimeCode,
...
class authenticateLongSession_args(object):
    ...
    def __init__(self, username=None, password=None, consumerKey=None, consumerSecret=None, deviceIdentifier=None,
                 deviceDescription=None, supportsTwoFactor=None, ):
        self.username = username
        self.password = password
        self.consumerKey = consumerKey
        self.consumerSecret = consumerSecret
...
class getUser_result(object):
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success', (type_ttypes.User, type_ttypes.User.thrift_spec),
         None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
...
class getPremiumInfo_result(object):
    ...
    thrift_spec = (
        (0, TType.STRUCT, 'success',
         (type_ttypes.PremiumInfo, type_ttypes.PremiumInfo.thrift_spec), None,),  # 0
        (1, TType.STRUCT, 'userException',
         (error_ttypes.EDAMUserException, error_ttypes.EDAMUserException.thrift_spec),
         None,),  # 1
        (2, TType.STRUCT, 'systemException',
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 0:
                if ftype == TType.STRUCT:
                    self.success = type_ttypes.PremiumInfo()
                    self.success.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 1:
