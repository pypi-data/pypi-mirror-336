...
from ..userstore import ttypes
from ..type import ttypes
from ..error import ttypes
...
class SyncChunk(object):
    ...
    thrift_spec = (
        ...
        (3, TType.I32, 'updateCount', None, None,),  # 3
        (4, TType.LIST, 'notes',
         (TType.STRUCT, (type_ttypes.Note, type_ttypes.Note.thrift_spec)), None,),  # 4
        (5, TType.LIST, 'notebooks',
         (TType.STRUCT, (type_ttypes.Notebook, type_ttypes.Notebook.thrift_spec)), None,),
        # 5
        (6, TType.LIST, 'tags',
         (TType.STRUCT, (type_ttypes.Tag, type_ttypes.Tag.thrift_spec)), None,),  # 6
        (7, TType.LIST, 'searches',
         (TType.STRUCT, (type_ttypes.SavedSearch, type_ttypes.SavedSearch.thrift_spec)),
         None,),  # 7
        (8, TType.LIST, 'resources',
         (TType.STRUCT, (type_ttypes.Resource, type_ttypes.Resource.thrift_spec)), None,),
        # 8
        ...
        (13, TType.LIST, 'linkedNotebooks', (
            TType.STRUCT,
            (type_ttypes.LinkedNotebook, type_ttypes.LinkedNotebook.thrift_spec)),
         None,),  # 13
        (14, TType.LIST, 'expungedLinkedNotebooks', (TType.STRING, None), None,),  # 14
    )

    def __init__(self, currentTime=None, chunkHighUSN=None, updateCount=None, notes=None, notebooks=None, tags=None,
                 searches=None, resources=None, expungedNotes=None, expungedNotebooks=None, expungedTags=None,
                 expungedSearches=None, linkedNotebooks=None, expungedLinkedNotebooks=None, ):
        self.currentTime = currentTime
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i22 in range(_size18):
                        _elem23 = type_ttypes.SavedSearch()
                        _elem23.read(iprot)
                ...
                if ftype == TType.LIST:
                    ...
                    for _i58 in range(_size54):
                        _elem59 = type_ttypes.LinkedNotebook()
                        _elem59.read(iprot)
...
class SyncChunkFilter(object):
    ...
    def __init__(self, includeNotes=None, includeNoteResources=None, includeNoteAttributes=None, includeNotebooks=None,
                 includeTags=None, includeSearches=None, includeResources=None, includeLinkedNotebooks=None,
                 includeExpunged=None, includeNoteApplicationDataFullMap=None,
                 includeResourceApplicationDataFullMap=None, includeNoteResourceApplicationDataFullMap=None,
                 requireNoteContentClass=None, ):
...
class NoteFilter(object):
    ...
    def __init__(self, order=None, ascending=None, words=None, notebookGuid=None, tagGuids=None, timeZone=None,
                 inactive=None, emphasized=None, ):
        self.order = order
...
class NoteList(object):
    ...
    thrift_spec = (
        ...
        (3, TType.LIST, 'notes',
         (TType.STRUCT, (type_ttypes.Note, type_ttypes.Note.thrift_spec)), None,),  # 3
    ...
    def __init__(self, startIndex=None, totalNotes=None, notes=None, stoppedWords=None, searchedWords=None,
                 updateCount=None, ):
...
class NoteMetadata(object):
    ...
    thrift_spec = (
        ...
        None,  # 13
        (14, TType.STRUCT, 'attributes',
         (type_ttypes.NoteAttributes, type_ttypes.NoteAttributes.thrift_spec), None,),  # 14
        None,  # 15
        None,  # 16
        None,  # 17
        None,  # 18
    ...
    def __init__(self, guid=None, title=None, contentLength=None, created=None, updated=None, deleted=None,
                 updateSequenceNum=None, notebookGuid=None, tagGuids=None, attributes=None, largestResourceMime=None,
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.attributes = type_ttypes.NoteAttributes()
...
class NotesMetadataResultSpec(object):
    ...
    def __init__(self, includeTitle=None, includeContentLength=None, includeCreated=None, includeUpdated=None,
                 includeDeleted=None, includeUpdateSequenceNum=None, includeNotebookGuid=None, includeTagGuids=None,
                 includeAttributes=None, includeLargestResourceMime=None, includeLargestResourceSize=None, ):
...
class RelatedResult(object):
    ...
    thrift_spec = (
        None,  # 0
        (1, TType.LIST, 'notes',
         (TType.STRUCT, (type_ttypes.Note, type_ttypes.Note.thrift_spec)), None,),  # 1
        (2, TType.LIST, 'notebooks',
         (TType.STRUCT, (type_ttypes.Notebook, type_ttypes.Notebook.thrift_spec)), None,),
        # 2
        (3, TType.LIST, 'tags',
         (TType.STRUCT, (type_ttypes.Tag, type_ttypes.Tag.thrift_spec)), None,),  # 3
        (4, TType.LIST, 'containingNotebooks', (TType.STRUCT, (
            type_ttypes.NotebookDescriptor, type_ttypes.NotebookDescriptor.thrift_spec)),
         None,),  # 4
    )
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i187 in range(_size183):
                        _elem188 = type_ttypes.NotebookDescriptor()
                        _elem188.read(iprot)
...
class RelatedResultSpec(object):
    ...
    def __init__(self, maxNotes=None, maxNotebooks=None, maxTags=None, writableNotebooksOnly=None,
                 includeContainingNotebooks=None, ):
