...
def test_mangle_id():
    ...
    result = _mangle_id("test_file.csv", data, {})
...
def test_mangle_indent():
    ...
    data = [row[:] for row in SAMPLE_ASSAY_DATA]  # Make a copy
    result = _mangle_indent("test_file.csv", data, {})
...
def test_mangle_person():
    ...
    result = _mangle_person("test_file.csv", data, people)
...
def test_mangle_assay():
    ...
    with (
        ...
        result = _mangle_assay("test_file.csv", people, data)
