...
class dsr_bourg_centre_accroissement_metropole(Variable):
    ...
    def formula_2021(etat, period, parameters):  # TODO formula_2020_01 comme pour les autres fractions DSR et l'accroissement de DSU ?
        ...
        # augmentation_montant_2021 = 90_000_000  # montant indépendant de la réforme
        # dsr_montant_2020 = parameters(2020).dotation_solidarite_rurale.bourg_centre.montant
        # dsr_montant_2021 = parameters(2021).dotation_solidarite_rurale.bourg_centre.montant
        # return (dsr_montant_2021 - dsr_montant_2020) / augmentation_montant_2021
    ...
    def formula(etat, period, parameters):
        '''
        % augmentation de 2020 appliquée en tout temps, soit +90 000 000€.
        '''
        augmentation_montant_2020 = 90_000_000  # montant indépendant de la réforme
        dsr_montant_2019 = parameters(2019).dotation_solidarite_rurale.bourg_centre.montant
        dsr_montant_2020 = parameters(2020).dotation_solidarite_rurale.bourg_centre.montant
        return (dsr_montant_2020 - dsr_montant_2019) / augmentation_montant_2020
...
class dsr_montant_total_fraction_bourg_centre(Variable):
    ...
    def formula_2020_01(etat, period, parameters):
        ...
        dsr_bourg_centre_accroissement_metropole = etat('dsr_bourg_centre_accroissement_metropole', period)
        return montants_an_precedent + accroissement * dsr_bourg_centre_accroissement_metropole
