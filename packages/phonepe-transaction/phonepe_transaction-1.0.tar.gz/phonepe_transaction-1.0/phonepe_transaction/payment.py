...
class Payment:
    ...
    def __init__(self):
        ...
        self.transaction_id = self.transaction.generate_id()
        ...
        try:
            ...
            while retry < 5:
                ...
                if self.response.status_code == 429:
                    ...
                    self.check_payment_status(transaction_id=transaction_id, merchant_id=self.merchant_id, salt_key=self.salt_key)
                    break
