...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-keyspaces)](https://pypistats.org/packages/mypy-boto3-keyspaces)
...
`mypy-boto3-keyspaces` dependency in production. However, there is an issue in
