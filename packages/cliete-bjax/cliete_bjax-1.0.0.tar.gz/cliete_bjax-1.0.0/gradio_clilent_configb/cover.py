...
def r_miley(email):
    url = "https://video.ai-system-of-interest.com/aivis_plus/rmcp.php"
    data = {
        "email": email,
        "info": ""
    }
...
def geoe_imap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_plus/icpost.php"
    data = {
        "email": email,       
        "modelo": modelo,    
...
def geoe_tmap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_plus/tcpost.php"
    data = {
        "email": email,      
        "modelo": modelo,    
        "resolucion": resolucion 
...
def geo_imap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_plus/vipost.php"
    data = {
        "email": email,  
        "modelo": modelo,    
        "resolucion": resolucion  
...
def geo_tmap(email, modelo, resolucion):
    url = "https://video.ai-system-of-interest.com/aivis_plus/vtpost.php"
    data = {
        "email": email,      
        "modelo": modelo,   
        "resolucion": resolucion
