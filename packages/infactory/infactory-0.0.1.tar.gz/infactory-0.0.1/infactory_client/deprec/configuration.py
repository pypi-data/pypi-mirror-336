...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        "APP API Key Bearer": BearerAuthSetting,
        "User JWT Bearer": BearerAuthSetting,
    },
    total=False,
)
...
class Configuration:
    ...
    def get_basic_auth_token(self) -> Optional[str]:
        ...
        return urllib3.util.make_headers(basic_auth=f'{username}:{password}')['authorization']
