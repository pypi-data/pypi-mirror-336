...
class ProjectsService(BaseService):
    ...
    def update(self, project_id: str, name: str = None, description: str = None) -> Project:
        """
        Update a project.
...
class DataSourcesService(BaseService):
    ...
    def create(self, name: str, project_id: str = None, type: str = None, uri: str = None) -> DataSource:
        """
    ...
    def update(self, datasource_id: str, name: str = None, type: str = None, uri: str = None) -> DataSource:
        """
    ...
    def upload(self, datasource_id: str, file_path: str, project_id: str = None, source_url: str = None, file_type: str = None) -> Dict:
        """
...
class DataLinesService(BaseService):
    ...
    def create(self, name: str, project_id: str = None, dataobject_id: str = None, schema_code: str = None, data_model: Dict = None) -> DataLine:
        """
    ...
    def update(self, dataline_id: str, name: str = None, dataobject_id: str = None, data_model: Dict = None) -> DataLine:
        """
        Update a data line.
        ...
        response = self._patch(f"v1/datalines/{dataline_id}", params=params, data=data_model)
        return self.factory.create(response)
...
class TeamsService(BaseService):
    ...
    def list(self, organization_id: str = None) -> List[Team]:
        ...
        if organization_id is None:
            ...
            if organization_id is None:
                raise ValueError("No organization_id provided and no current organization set")
...
class OrganizationsService(BaseService):
    ...
    def create(self, name: str, description: str = None, platform_id: str = None, clerk_org_id: str = None) -> Organization:
        """
    ...
    def update(self, organization_id: str, name: str = None, description: str = None) -> Organization:
        """
...
class UsersService(BaseService):
    ...
    def create(self, email: str, name: str = None, organization_id: str = None, role: str = None) -> User:
        """
        Create a new user.
    ...
    def update(self, user_id: str, email: str = None, name: str = None, role: str = None) -> User:
        """
        Update a user.
    ...
    def get_teams_with_organizations_and_projects(self, user_id: str = None, clerk_user_id: str = None, email: str = None) -> Dict:
        """
        ...
        response = self._get("v1/users/get_teams_with_organizations_and_projects", params)
        return response
...
class QueryProgramsService(BaseService):
    ...
    def list(self, project_id: str = None, dataline_id: str = None, skip: int = 0, take: int = 100, include_deleted: bool = False) -> List[QueryProgram]:
        """
        List query programs.
    ...
    def create(self, name: str, question: str, code: str, dataline_id: str, project_id: str = None) -> QueryProgram:
        """
    ...
    def update(self, queryprogram_id: str, name: str = None, question: str = None, code: str = None) -> QueryProgram:
        """
    ...
    def publish(self, queryprogram_id: str, group_slots: bool = False) -> QueryProgram:
        ...
        response = self._patch(f"v1/queryprograms/{queryprogram_id}/publish", params=params)
        return self.factory.create(response)
