...
class FrontendSiteSettings:
    ...
    #: also added to `NEW_AUTO_TEST_ALLOWED_INITIAL_BUILD_IDS`, as otherwise
    #: the user is not allowed to use the image. The last item in this list
    #: will be the default image id.
    ...
    student_payment_main_option: Maybe["t.Literal['coupon', 'stripe']"] = (
        Nothing
    )
    ...
    #: Whether the `is_admin` global permission should be enabled. Users with a
    ...
    #: teachers.
    assignment_description_on_teachers_submissions_page: Maybe["bool"] = (
        Nothing
    )
    ...
    hide_code_editor_output_viewer_with_only_quiz_steps: Maybe["bool"] = (
        Nothing
    )
    ...
    simple_submission_navigate_to_latest_editor_session: Maybe["bool"] = (
        Nothing
    )
    ...
    default_submission_page_tab: Maybe[
        "t.Literal['auto-test', 'code', 'feedback-overview', 'peer-feedback', 'smart']"
    ] = Nothing
    ...
    #: Should teachers have the option to enter student view to restrict their
    #: course permissions and interact with their course as a student.
    student_view_enabled: Maybe["bool"] = Nothing
    ...
    #: Whether to enable the "Try out" functionality in Pearson templates.
    pearson_try_out_coding_question_enabled: Maybe["bool"] = Nothing
    ...
    data_parser: t.ClassVar = rqa.Lazy(
        lambda: rqa.FixedMapping(
            ...
            rqa.OptionalArgument(
                ...
                doc="The IDs of the currently recent base images for AutoTest 2.0. These are the images that we want users to use for new AutoTest 2.0 configurations. Make sure that if you add something to this list it is also added to `NEW_AUTO_TEST_ALLOWED_INITIAL_BUILD_IDS`, as otherwise the user is not allowed to use the image. The last item in this list will be the default image id.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                "RUBRICS_ENABLED",
                rqa.SimpleValue.bool,
                doc="If enabled teachers can use rubrics on CodeGrade. Disabling this feature will not delete existing rubrics.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Should rubrics be submitted incrementally, so if a user selects a item should this be automatically be submitted to the server, or should it only be possible to submit a complete rubric at once. This feature is useless if `rubrics` is not set to `true`.",
            ),
            rqa.OptionalArgument(
                "REGISTER_ENABLED",
                rqa.SimpleValue.bool,
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Can AutoTest configurations be created and run using the 2.0 infrastructure.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Whether the `is_admin` global permission should be enabled. Users with a global role with this permission automatically get all permissions, everywhere. Users with a tenant role with this permission automatically get all permissions within their tenant.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Whether the gradebook on the course management page is enabled.",
            ),
            rqa.OptionalArgument(
                "ASSIGNMENT_DESCRIPTION_ENABLED",
                rqa.SimpleValue.bool,
                doc="Wether the description on the assignment management page is enabled.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Whether AutoTest 2.0 configuration importing from other assignments is enabled.",
            ),
            rqa.OptionalArgument(
                "ASSIGNMENT_GRADING_SCALE_POINTS_ENABLED",
                rqa.SimpleValue.bool,
                doc="Whether it should be possible to set the maximum scale points for an assignment using point-based scale. This is different from the assignment max grade and can not be used with percentage-based scales.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Can teacher edit their students' work through the code editor.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Whether assignment importing is done in stages, where we first select course.",
            ),
            rqa.OptionalArgument(
                "SECTIONS_IN_SUBMISSION_LIST_ENABLED",
                rqa.SimpleValue.bool,
                doc="Whether to show the sections the users are a part of in the submission list. This also applies to groups.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.int,
                doc="The maximum amount of plagiarism cases that can be exported at a time.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc='Whether to show the "submissions per page" input on the submissions page.',
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                "ANALYTICS_ENABLED",
                rqa.SimpleValue.bool,
                doc="Whether the Analytics tab should be available on assignments in this tenant.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                ...
                rqa.SimpleValue.bool,
                doc="Should teachers have the option to enter student view to restrict their course permissions and interact with their course as a student.",
            ),
            rqa.OptionalArgument(
            ...
            rqa.OptionalArgument(
                "PEARSON_TRY_OUT_CODING_QUESTION_ENABLED",
                rqa.SimpleValue.bool,
                doc='Whether to enable the "Try out" functionality in Pearson templates.',
            ),
            rqa.OptionalArgument(
    ...
    def __post_init__(self) -> None:
        ...
        self.student_view_enabled = maybe_from_nullable(
            self.student_view_enabled
        )
        ...
        self.pearson_try_out_coding_question_enabled = maybe_from_nullable(
            self.pearson_try_out_coding_question_enabled
        )
    ...
    def to_dict(self) -> t.Dict[str, t.Any]:
        ...
        if self.student_view_enabled.is_just:
            res["STUDENT_VIEW_ENABLED"] = to_dict(
                self.student_view_enabled.value
            )
        ...
        if self.pearson_try_out_coding_question_enabled.is_just:
            res["PEARSON_TRY_OUT_CODING_QUESTION_ENABLED"] = to_dict(
                self.pearson_try_out_coding_question_enabled.value
            )
    ...
    def from_dict(
        ...
        res = cls(
            ...
            student_view_enabled=parsed.STUDENT_VIEW_ENABLED,
            ...
            pearson_try_out_coding_question_enabled=parsed.PEARSON_TRY_OUT_CODING_QUESTION_ENABLED,
