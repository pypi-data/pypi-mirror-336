...
from common_api_test_engine.core.DBClient import DBClient
from common_api_test_engine.core.runner import TestRunner

try:
    global_func = importlib.import_module('global_func')
except ModuleNotFoundError:
    from common_api_test_engine.core import tools as global_func
