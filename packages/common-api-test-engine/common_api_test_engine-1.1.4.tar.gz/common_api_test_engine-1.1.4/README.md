...
Version: 1.1.1
Author: dawnpopo
Author-email: 1916364638@qq.com
Classifier: Programming Language :: Python :: 3
Requires-Python: >=3.7
Description-Content-Type: text/markdown

# 接口自动化平台用例执行引擎 — common_api_test_engine

## 前言

​		   common_api_test_engine主要是为接口自动化平台 开发的一个Http接口用例执行的引擎。

安装命令:
   ```python
pip install common_api_test_engine
```
...
> 	},
> "request": {
>  'json': {"mobile_phone": "${{user_mobile}}","pwd": "123456"},
> 	},
...
关于common_api_test_engine的基本使用就给大家介绍到这里啦，大家可以去研究一下，用来编写测试平台
