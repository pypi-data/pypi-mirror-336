...
def sync_detailed(
    *,
    ...
    """Forward Event (Calendar Event)

     Forward an event from calendar

    Args:
        id (str): The event to forward
        calendar_id (Optional[str]): The calendar in which respective event is present
        apply_on_series (Optional[bool]): Forward all occurances of given event Default: False.
        body (ForwardEventRequest):
