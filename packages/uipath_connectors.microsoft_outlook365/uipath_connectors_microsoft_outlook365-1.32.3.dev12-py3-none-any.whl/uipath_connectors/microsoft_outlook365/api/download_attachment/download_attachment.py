...
def sync_detailed(
    *,
    ...
    Args:
        file_name (Optional[str]): File name of attachment to download
        id (str): The ID of the email from which you want to download the attachment
        exclude_inline_attachments (Optional[bool]): Indicates whether to exclude the inline
