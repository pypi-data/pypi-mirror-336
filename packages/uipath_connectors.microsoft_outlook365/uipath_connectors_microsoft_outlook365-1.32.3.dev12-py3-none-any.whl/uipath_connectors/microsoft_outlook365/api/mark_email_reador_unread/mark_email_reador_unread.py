...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/markEmailReadorUnread/{id}".format(
            id=id,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = MarkEmailReadorUnreadResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, MarkEmailReadorUnreadResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str): The ID of email to mark as read or unread
        body (MarkEmailReadorUnreadRequest):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, MarkEmailReadorUnreadResponse]
    """
