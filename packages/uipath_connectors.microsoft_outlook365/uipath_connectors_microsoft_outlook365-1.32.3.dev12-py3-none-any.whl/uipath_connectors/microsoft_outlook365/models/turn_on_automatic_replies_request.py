...
from ..models.turn_on_automatic_replies_request_automatic_replies_setting import (
...
class TurnOnAutomaticRepliesRequest(BaseModel):
    """
    Attributes:
        automatic_replies_setting (Optional[TurnOnAutomaticRepliesRequestAutomaticRepliesSetting]):
    """
