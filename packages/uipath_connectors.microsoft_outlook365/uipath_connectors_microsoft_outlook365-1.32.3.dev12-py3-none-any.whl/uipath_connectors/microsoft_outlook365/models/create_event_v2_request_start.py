...
class CreateEventV2RequestStart(BaseModel):
    """
    Attributes:
        date_time (datetime.datetime): The date and time when the event is scheduled to start Default:
    ...
    @classmethod
    def from_dict(cls: Type["CreateEventV2RequestStart"], src_dict: Dict[str, Any]):
