...
class MoveEmailResponseBody(BaseModel):
    """
    Attributes:
        content (Optional[str]): The main content or message body of the email. Example: <html><head>
                ...
                class="WordSection1"><p class="MsoNormal"><span lang="EN-US">Test1</span></p><p class="MsoNormal"><span
                lang="EN-US">&nbsp;</span></p></div></body></html>.
        content_type (Optional[str]): The format of the email body, such as HTML or plain text. Example: html.
    """
    ...
    @classmethod
    def from_dict(cls: Type["MoveEmailResponseBody"], src_dict: Dict[str, Any]):
