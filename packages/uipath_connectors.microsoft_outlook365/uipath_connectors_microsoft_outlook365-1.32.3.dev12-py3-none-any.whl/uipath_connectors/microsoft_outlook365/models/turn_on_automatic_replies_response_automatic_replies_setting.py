...
from ..models.turn_on_automatic_replies_response_automatic_replies_setting_scheduled_end_date_time import (
    TurnOnAutomaticRepliesResponseAutomaticRepliesSettingScheduledEndDateTime,
)
from ..models.turn_on_automatic_replies_response_automatic_replies_setting_scheduled_start_date_time import (
    TurnOnAutomaticRepliesResponseAutomaticRepliesSettingScheduledStartDateTime,
)


class TurnOnAutomaticRepliesResponseAutomaticRepliesSetting(BaseModel):
    """
    Attributes:
        ...
        scheduled_end_date_time (Optional[TurnOnAutomaticRepliesResponseAutomaticRepliesSettingScheduledEndDateTime]):
        scheduled_start_date_time
                (Optional[TurnOnAutomaticRepliesResponseAutomaticRepliesSettingScheduledStartDateTime]):
    ...
    @classmethod
    def from_dict(
        cls: Type["TurnOnAutomaticRepliesResponseAutomaticRepliesSetting"],
