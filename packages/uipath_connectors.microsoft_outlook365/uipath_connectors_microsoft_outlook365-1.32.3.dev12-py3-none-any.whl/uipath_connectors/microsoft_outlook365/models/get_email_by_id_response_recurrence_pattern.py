...
class GetEmailByIDResponseRecurrencePattern(BaseModel):
    """
    Attributes:
        day_of_month (Optional[int]):
        first_day_of_week (Optional[str]):
        index (Optional[str]):
    ...
    @classmethod
    def from_dict(
        cls: Type["GetEmailByIDResponseRecurrencePattern"], src_dict: Dict[str, Any]
    ):
