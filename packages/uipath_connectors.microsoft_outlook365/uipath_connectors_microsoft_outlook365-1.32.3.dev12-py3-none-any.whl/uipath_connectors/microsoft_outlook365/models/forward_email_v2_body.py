...
class ForwardEmailV2Body(BaseModel):
    """
    Attributes:
        body (ForwardEmailV2Request):
        file (Optional[File]): The attachment to be sent with the email
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "ForwardEmailV2Request" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["ForwardEmailV2Body"], src_dict: Dict[str, Any]):
