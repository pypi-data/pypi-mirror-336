...
class CreateEventV2Body(BaseModel):
    """
    Attributes:
        body (CreateEventV2Request):
        file (Optional[File]): Attachment for event
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "CreateEventV2Request" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["CreateEventV2Body"], src_dict: Dict[str, Any]):
