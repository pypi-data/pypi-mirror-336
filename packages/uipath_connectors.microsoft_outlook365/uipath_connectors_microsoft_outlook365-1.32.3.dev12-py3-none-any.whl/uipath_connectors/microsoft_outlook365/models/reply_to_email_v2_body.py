...
class ReplyToEmailV2Body(BaseModel):
    """
    Attributes:
        body (ReplyToEmailV2Request):
        file (Optional[File]): The attachments to be sent with the reply email
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "ReplyToEmailV2Request" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["ReplyToEmailV2Body"], src_dict: Dict[str, Any]):
