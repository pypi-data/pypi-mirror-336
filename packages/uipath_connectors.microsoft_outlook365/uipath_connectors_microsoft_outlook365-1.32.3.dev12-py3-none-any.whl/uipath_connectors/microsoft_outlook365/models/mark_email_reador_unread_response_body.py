...
class MarkEmailReadorUnreadResponseBody(BaseModel):
    """
    Attributes:
        content (Optional[str]): The main content or message body of the email. Example: <html><head>
                ...
                body, p, td
                        ...
                        font-size:11px}
                -->
                </style></head><body><p><img src="" border="0"></p><table width="100%" border="0" cellspacing="2"
                ...
                style="color:#999999">NetSuite</a> — One System. No Limits.</font> </td></tr></tbody></table></body></html>.
        content_type (Optional[str]): The format type of the email's body content, such as HTML or plain text. Example:
                html.
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["MarkEmailReadorUnreadResponseBody"], src_dict: Dict[str, Any]
    ):
