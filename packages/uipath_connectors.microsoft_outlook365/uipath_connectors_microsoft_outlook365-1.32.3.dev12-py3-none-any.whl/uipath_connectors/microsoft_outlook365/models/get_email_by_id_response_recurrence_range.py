...
class GetEmailByIDResponseRecurrenceRange(BaseModel):
    """
    Attributes:
        end_date (Optional[datetime.datetime]):
        number_of_occurrences (Optional[int]):
        recurrence_time_zone (Optional[str]):
    ...
    @classmethod
    def from_dict(
        cls: Type["GetEmailByIDResponseRecurrenceRange"], src_dict: Dict[str, Any]
    ):
