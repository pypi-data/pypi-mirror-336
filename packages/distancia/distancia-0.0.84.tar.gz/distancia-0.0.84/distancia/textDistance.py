...
class OverlapCoefficient(Distance):
...
class BagOfWordsDistance(Distance):
...
try:
    if gensim_installed:
     ...
     class FastTextDistance(Distance):
...
class AlignmentBasedMeasures(Distance):
...
class SoftJaccardSimilarity(Distance):
