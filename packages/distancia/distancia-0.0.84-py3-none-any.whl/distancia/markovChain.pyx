...
cdef class MarkovChainKullbackLeibler(Distance):
    # Attributs de classe
    cdef object _type
    cdef object _kl_divergence
    ...
    def kl_divergence(self, value):
        self._kl_divergence = value
...
cdef class MarkovChainWasserstein(Distance):
    # Attributs de classe
    cdef object _num_states
    cdef object __compute_wasserstein_greedy
    cdef object _type
    cdef object _compute
    cdef object _cost_matrix
    ...
    def _compute_wasserstein_greedy(self, pi_P, pi_Q):
        ...
        for i in range(n):
            for j in range(n):
                ...
                total_cost += (flow_amount * self._cost_matrix[i][j])
    ...
    def example(self):
        P = [[0.9, 0.1], [0.2, 0.8]]
        Q = [[0.85, 0.15], [0.25, 0.75]]
        print('Wasserstein Distance:', self.compute(P, Q))


    # Propriétés pour accéder aux attributs depuis Python
    @property
    def _compute_wasserstein_greedy(self):
        return self.__compute_wasserstein_greedy
    @_compute_wasserstein_greedy.setter
    def _compute_wasserstein_greedy(self, value):
        self.__compute_wasserstein_greedy = value
    @property
    def type(self):
        return self._type
    @type.setter
    ...
    @cost_matrix.setter
    def cost_matrix(self, value):
        self._cost_matrix = value
...
#TVD
cdef class MarkovChainTotalVariation(Distance):
    # Attributs de classe
    cdef object _type
    cdef object _total_variation_distance
    ...
    def total_variation_distance(self):
        return self._total_variation_distance
    @total_variation_distance.setter
    def total_variation_distance(self, value):
        self._total_variation_distance = value
...
cdef class MarkovChainHellinger(Distance):
    # Attributs de classe
    cdef object _type
    cdef object _hellinger_distance
    ...
    def hellinger_distance(self):
        return self._hellinger_distance
    @hellinger_distance.setter
    def hellinger_distance(self, value):
        self._hellinger_distance = value
...
cdef class MarkovChainJensenShannon(Distance):
    # Attributs de classe
    cdef object _type
    cdef object _jensen_shannon_divergence
    cdef object _kl_divergence
    ...
    def jensen_shannon_divergence(self):
        return self._jensen_shannon_divergence
    @jensen_shannon_divergence.setter
    def jensen_shannon_divergence(self, value):
        self._jensen_shannon_divergence = value
    @property
    def kl_divergence(self):
        return self._kl_divergence
    @kl_divergence.setter
...
cdef class MarkovChainFrobenius(Distance):
    # Attributs de classe
    cdef object _type
...
cdef class MarkovChainSpectral(Distance):
    # Attributs de classe
    cdef object _eigenvalues_2x2
    cdef object _num_states
    cdef object _characteristic_polynomial
    cdef object _type
    cdef object _matrix_trace
    ...
    def matrix_trace(self, matrix):
		...
		'
        return sum((matrix[i][i] for i in range(self._num_states)))
    ...
    def eigenvalues_2x2(self):
        return self._eigenvalues_2x2
    @eigenvalues_2x2.setter
    def eigenvalues_2x2(self, value):
        self._eigenvalues_2x2 = value
    @property
    def type(self):
        return self._type
    @type.setter
    ...
    @characteristic_polynomial.setter
    def characteristic_polynomial(self, value):
        self._characteristic_polynomial = value
    @property
    def num_states(self):
        return self._num_states
    @num_states.setter
    ...
    def matrix_trace(self):
        return self._matrix_trace
    @matrix_trace.setter
    def matrix_trace(self, value):
        self._matrix_trace = value
