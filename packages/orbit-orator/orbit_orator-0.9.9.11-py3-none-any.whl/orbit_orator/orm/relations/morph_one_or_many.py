...
class MorphOneOrMany(HasOneOrMany):
    ...
    def first_or_new(self, _attributes=None, **attributes):
        """
        Get the first related record matching the attributes or instantiate it.
        ...
        instance.set_attribute(self.get_plain_morph_type(), self._morph_name)
    ...
    def update_or_create(self, _attributes=None, _values=None, **attributes):
        """
