...
from ashdisperse.ashdisperse import setup, solve
from ashdisperse.core import AshDisperseResult
from ashdisperse.interface import (load_inputs, save_inputs, set_met,
                                   set_parameters, advected_settling_trajectories, estimate_dispersal_distance)
...
def __initialize__():
    ...
    params.emission.add_profile(0, 10000, 10)
    ...
    metdata = resource_filename(__name__, "./data/era5.nc")
