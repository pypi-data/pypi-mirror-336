...
class PipelineParallelLLMReplicaController(BaseLLMReplicaController):
    ...
    def __init__(
        ...
        self.pending_step_outputs: List[PendingStepOutput] = []
    ...
    def _init_zmq_sockets(self):
        ...
        self.microbatch_socket = ZmqSocket(self.zmq_context, ZmqConstants.PULL)
    ...
    def _append_pending_step_output(
        ...
        self.pending_step_outputs.append(
            PendingStepOutput(scheduler_output, sampler_outputs)
        )

    @synchronized
    def _get_pending_step_outputs(
        self,
    ) -> List[PendingStepOutput]:
    ...
    def _microbatch_watch_loop(self) -> None:
        ...
        while True:
            ...
            while (
                ...
                step_microbatch_outputs = recv_step_microbatch_outputs(
    ...
    def _output_loop(self) -> None:
        ...
        while True:
            ...
            while (
                ...
                step_output = recv_step_outputs(self.output_socket)
            ...
            for request_output in all_request_outputs:
                self.output_queue.put(request_output)
