...
from vajra.config import LlmReplicaControllerConfig, ModelConfig, WorkerConfig
...
def get_model(replica_controller_config: LlmReplicaControllerConfig) -> nn.Module:
    ...
    worker_config: WorkerConfig = replica_controller_config.worker_config

    model_class = _get_model_architecture(model_config.hf_config)
    use_native_execution_backend: bool = worker_config.use_native_execution_backend
