...
void InitCommInfoPybindClass(py::module_& m) {
  py::class_<CommInfo>(m, "CommInfo")
      .def(py::init<std::string, std::string, std::size_t, std::size_t,
                    std::size_t>(),
           py::arg("distributed_init_method"), py::arg("engine_ip_address"),
           py::arg("enqueue_socket_port"), py::arg("output_socket_port"),
           py::arg("microbatch_socket_port"))
...
void InitSamplerOutputPybindClass(py::module_& m) {
  py::class_<SamplerOutput, std::shared_ptr<SamplerOutput>>(m, "SamplerOutput")
...
void InitUserSequenceParamsPybindClass(py::module_& m) {
  py::class_<UserSequenceParams, MutableUserSequenceParamsPtr>(
      ...
      .def(py::init([](std::string seq_id, std::string prompt,
                       TokenIds prompt_token_ids, double arrival_time,
...
void InitSequenceParamsPybindClass(py::module_& m) {
  py::class_<SequenceParams>(m, "SequenceParams")
      .def(py::init([](std::string seq_id, std::string prompt,
                       ...
                       TokenId eos_token_id, double arrival_time,
                       SamplingParams sampling_params) {
