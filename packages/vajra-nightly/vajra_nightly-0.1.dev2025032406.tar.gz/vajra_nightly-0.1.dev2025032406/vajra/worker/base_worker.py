...
from vajra.datatypes import CommInfo, SamplerOutputs, SchedulerOutput  # type: ignore
...
class BaseWorker(ABC):
    ...
    def _init_zmq_sockets(self) -> None:
        ...
        additional sockets can be added as needed by the worker (see PipelineParallelWorker)
