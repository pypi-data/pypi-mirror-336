...
from vajra._native.model_executor.layers import (
    ColumnParallelLinear as ColumnParallelLinearC,  # type: ignore
)
from vajra._native.model_executor.layers import (
    RowParallelLinear as RowParallelLinearC,  # type: ignore
)
from vajra._native.model_executor.layers import (
    VocabParallelEmbedding as VocabParallelEmbeddingC,  # type: ignore
)
