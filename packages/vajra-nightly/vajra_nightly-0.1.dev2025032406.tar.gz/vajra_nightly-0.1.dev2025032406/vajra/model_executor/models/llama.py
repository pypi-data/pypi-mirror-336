...
class LlamaAttention(nn.Module):
    ...
    def __init__(
        ...
        if use_native_execution_backend:
            ...
            self.native_handle = LlamaAttentionC(
                ...
                AttentionWrapper.get_instance().native_handle,
            )
    ...
    def forward(
        ...
        attn_output = AttentionWrapper.get_instance().forward(
            q,
            k,
            v,
            kv_cache,
...
class LlamaForCausalLM(nn.Module):
    ...
    def __init__(
        ...
        self.model = LlamaModel(
            self.config, use_native_execution_backend=use_native_execution_backend
        )
