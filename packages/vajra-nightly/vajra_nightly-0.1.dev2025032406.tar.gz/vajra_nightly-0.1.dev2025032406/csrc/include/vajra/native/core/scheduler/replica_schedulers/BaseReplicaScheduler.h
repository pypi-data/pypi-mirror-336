...
namespace vajra {
//==============================================================================
constexpr std::size_t MAX_NUM_SKIPPED_SEQS = 10;
//==============================================================================
...
class BaseReplicaScheduler {
 public:
  ...
  std::pair<std::shared_ptr<SchedulerOutput>, MutableSequences> Schedule();
 ...
 protected:
  ...
  std::shared_ptr<BatchFormationTracker> GetBatchFormationTracker();
  ...
  std::unordered_map<std::string, int> seq_block_counter_;
