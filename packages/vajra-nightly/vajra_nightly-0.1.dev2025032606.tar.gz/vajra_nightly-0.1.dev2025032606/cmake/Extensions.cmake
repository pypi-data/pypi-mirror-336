...
target_include_directories(vajra_common INTERFACE
  ...
  ${CMAKE_CURRENT_SOURCE_DIR}/csrc/third_party/hashpp/include
...
define_vajra_extension(_native "${NATIVE_SRC};${COMMON_SRC};${PROTO_SRCS};csrc/vajra/native/pybind.cpp;" "_kernels_common")
define_vajra_static(_native_static "${NATIVE_SRC};${COMMON_SRC};${PROTO_SRCS}" "_kernels_common")
