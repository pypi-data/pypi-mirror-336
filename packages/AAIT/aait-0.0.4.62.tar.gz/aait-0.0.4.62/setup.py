...
VERSION = "0.0.4.62"  # la version doit être supérieure à la précédente sinon la publication sera refusée
...
# Dépendances
INSTALL_REQUIRES = ["torch==2.2.2", "sentence-transformers==3.3.1", "gpt4all[cuda]==2.8.2", "sacremoses==0.1.1",
