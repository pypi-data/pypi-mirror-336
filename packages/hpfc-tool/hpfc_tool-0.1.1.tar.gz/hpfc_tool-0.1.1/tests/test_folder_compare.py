...
from src.folder_compare.core import FolderCompare  # noqa: E402


class TestFolderCompare(unittest.TestCase):
    """Test functionality of FolderCompare class"""
    ...
    def test_basic_comparison(self):
        ...
        comparer = FolderCompare(self.test_dir1, self.test_dir2)
    ...
    def test_empty_directories(self):
        ...
        try:
            comparer = FolderCompare(empty_dir1, empty_dir2)
            results = comparer.compare()
    ...
    def test_identical_directories(self):
        ...
        try:
            ...
            comparer = FolderCompare(temp_dir, clone_dir)
            results = comparer.compare()
...
class TestFolderCompareReport(unittest.TestCase):
