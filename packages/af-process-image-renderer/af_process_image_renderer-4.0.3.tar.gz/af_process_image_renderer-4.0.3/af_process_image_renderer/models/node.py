...
class Node(object):
    ...
    def __init__(self, sub_class=None, id=None, name=None, loc_name=None, desc=None, loc_desc=None, icon_id=None, assignment_rule=None, ebp=None, auto_start=None, group_name=None, group_execution_context=None, sys_in_params=None, sys_out_params=None, in_param_conns=None, out_param_conns=None, sys_in_param_conns=None, sys_out_param_conns=None, user_attributes=None):  # noqa: E501
