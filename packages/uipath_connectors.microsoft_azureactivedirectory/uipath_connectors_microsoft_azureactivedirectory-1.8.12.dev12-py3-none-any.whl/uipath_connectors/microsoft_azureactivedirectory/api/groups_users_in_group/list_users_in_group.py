    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListUsersInGroup.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListUsersInGroup"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['ListUsersInGroup']]
    """
