...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateAssignedGroupResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateAssignedGroupResponse, DefaultError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[CreateAssignedGroupResponse, DefaultError]
    """
