...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/groupLifecyclePolicies/{id}".format(
            id=id,
        ),
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = UpdateLifecyclePolicyResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, UpdateLifecyclePolicyResponse]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, UpdateLifecyclePolicyResponse]
    """
