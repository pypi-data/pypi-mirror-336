...
from ..models.update_lifecycle_policy_request_managed_group_types import (
...
class UpdateLifecyclePolicyRequest(BaseModel):
    ...
    Attributes:
        ...
        managed_group_types (Optional[UpdateLifecyclePolicyRequestManagedGroupTypes]): The group type for which the
    ...
    managed_group_types: Optional["UpdateLifecyclePolicyRequestManagedGroupTypes"] = (
    ...
    @classmethod
    def from_dict(cls: Type["UpdateLifecyclePolicyRequest"], src_dict: Dict[str, Any]):
