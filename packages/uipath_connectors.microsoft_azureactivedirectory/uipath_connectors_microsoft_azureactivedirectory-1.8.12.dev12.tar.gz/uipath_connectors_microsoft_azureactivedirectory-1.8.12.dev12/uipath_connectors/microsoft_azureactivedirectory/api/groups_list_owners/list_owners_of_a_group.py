    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListOwnersOfAGroup.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListOwnersOfAGroup"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List Owners of a Group
     ...
     List all users that are owner of a group
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['ListOwnersOfAGroup']]
    """
