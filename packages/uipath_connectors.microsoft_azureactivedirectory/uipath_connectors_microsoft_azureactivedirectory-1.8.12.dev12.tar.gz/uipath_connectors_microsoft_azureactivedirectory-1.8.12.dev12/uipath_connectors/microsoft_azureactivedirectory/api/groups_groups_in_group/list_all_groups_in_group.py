...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/groups/{id}/groupsInGroup".format(
            id=id,
        ),
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListAllGroupsInGroup.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListAllGroupsInGroup"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """List All Groups in Group
     ...
     List all groups that are direct member of the specified group
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, list['ListAllGroupsInGroup']]
    """
