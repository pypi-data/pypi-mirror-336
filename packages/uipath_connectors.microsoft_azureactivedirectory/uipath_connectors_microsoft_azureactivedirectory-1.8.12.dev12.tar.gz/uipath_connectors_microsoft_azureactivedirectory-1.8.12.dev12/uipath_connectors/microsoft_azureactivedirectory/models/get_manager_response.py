...
class GetManagerResponse(BaseModel):
    ...
    Attributes:
        ...
        odata_id (Optional[str]): The Odata ID Example:
                https://graph.microsoft.com/v1.0/$metadata#directoryObjects/$entity.
    """
    ...
    odata_id: Optional[str] = Field(alias="odata_id", default=None)

    def to_dict(self) -> Dict[str, Any]:
        return self.model_dump(exclude_none=True, by_alias=True)

    @classmethod
    def from_dict(cls: Type["GetManagerResponse"], src_dict: Dict[str, Any]):
