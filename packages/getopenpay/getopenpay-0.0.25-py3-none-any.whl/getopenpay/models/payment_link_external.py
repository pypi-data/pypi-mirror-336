...
class PaymentLinkExternal(BaseModel):
  ...
  line_items: List[PaymentLinkLineItemExternal]
  mode: CheckoutMode = Field(
    description='The mode of the checkout sessions created by this payment link.'
  )
  ...
  __properties: ClassVar[List[str]] = [
    'account_id', 'account_name', 'active', 'checkout_preferences', 'coupon_id', 'created_at',
    'currency', 'customer_email', 'customer_id', 'id', 'is_deleted', 'line_items', 'mode', 'object',
    'secure_token', 'success_url', 'trial_end', 'trial_from_price', 'trial_period_days',
    'updated_at', 'url'
  ]
    ...
    _obj = cls.model_validate(
      {
        ...
        'checkout_preferences':
          CheckoutPreferencesOutput.from_dict(obj.get('checkout_preferences'))
