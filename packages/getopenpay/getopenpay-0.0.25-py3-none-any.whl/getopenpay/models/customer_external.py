...
class CustomerExternal(BaseModel):
  ...
  language: Optional[CustomerLanguage] = Field(
    default=None, description='Language of the customer.'
  )
  ...
  mrr: Optional[List[CustomerTotalAmount]] = None
  notes: Optional[StrictStr]
  object: Optional[ObjectName] = None
  phone_number: Optional[StrictStr] = None
  shipping_addresses: Optional[List[CompleteAddress]] = None
  ...
  total_refunds: Optional[List[CustomerTotalAmount]] = None
  total_spent: Optional[List[CustomerTotalAmount]] = None
  updated_at: datetime = Field(
    description="DateTime at which the object was updated, in 'ISO 8601' format."
  )
  __properties: ClassVar[List[str]] = [
    'account_id', 'address', 'balance_atoms', 'billing_email', 'business_name', 'created_at',
    'custom_fields', 'discount', 'email', 'first_name', 'id', 'invoice_settings', 'is_deleted',
    'language', 'last_name', 'last_successful_payment_intent', 'metadata', 'mrr', 'notes', 'object',
    'phone_number', 'shipping_addresses', 'should_send_payment_receipt', 'status',
    'subscribed_to_products', 'subscriptions', 'total_refunds', 'total_spent', 'updated_at'
  ]
    ...
    _obj = cls.model_validate(
      {
        ...
        'shipping_addresses':
          [CompleteAddress.from_dict(_item) for _item in obj.get('shipping_addresses')]
          if obj.get('shipping_addresses') is not None else None,
