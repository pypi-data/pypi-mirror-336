...
class DeleteSubscriptionRequest(BaseModel):
  ...
  full_refund: Optional[StrictBool] = Field(
    default=False, description='Flag to decide whether full refund should be given or not.'
  )
  is_preview: Optional[StrictBool] = Field(
    default=False,
    description="Whether the request is in preview mode (subscriptions won't actually be deleted)"
  )
  ...
  __properties: ClassVar[List[str]] = [
    'cancel_unpaid_invoices', 'cancellation_details', 'full_refund', 'is_preview', 'prorate'
  ]
