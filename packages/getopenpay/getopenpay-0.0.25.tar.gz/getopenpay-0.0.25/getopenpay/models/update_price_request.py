...
class UpdatePriceRequest(BaseModel):
  ...
  __properties: ClassVar[List[str]] = [
    ...
    'internal_description', 'is_active', 'is_exclusive', 'listed_exclusively_for_customers', 'meta',
    'meter_id', 'name', 'price_tiers', 'price_type', 'pricing_model',
    'transform_quantity_divide_by', 'trial_period_days', 'unit_amount_atom', 'usage_type'
  ]
