...
class UpdateSubscriptionRequest(BaseModel):
  ...
  proration_behavior: Optional[ProrationEnum] = Field(
    default=None, description='Determines how to handle prorations when the billable items changes'
  )
  trial_end: Optional[datetime] = None
  trial_period_days: Optional[StrictInt] = None
  __properties: ClassVar[List[str]] = [
    'cancel_at_end', 'collection_method', 'coupon_id', 'custom_fields', 'description', 'is_preview',
    'items', 'net_d', 'new_period_end', 'payment_method_id', 'preview_renewal_invoices',
    'promotion_code', 'proration_behavior', 'trial_end', 'trial_period_days'
  ]
