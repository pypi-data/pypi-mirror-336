...
class SubscriptionExternal(BaseModel):
  ...
  collection_method: CollectionMethodEnum = Field(
    description='Invoices that are generated from this subscription have this collection method.'
  )
  ...
  __properties: ClassVar[List[str]] = [
    'account_id', 'billing_interval', 'billing_interval_count', 'cancel_at_end',
    'cancellation_details', 'cancelled_at', 'collection_method', 'contract_auto_renew',
    'contract_start', 'created_at', 'currency', 'current_period_end', 'current_period_start',
    'custom_fields', 'customer_id', 'default_payment_method_id', 'description', 'discount', 'id',
    'initial_start', 'is_deleted', 'metadata', 'name', 'net_d', 'object', 'pause_at_end',
    'pause_for_cycles', 'paused_at', 'remaining_billing_cycles', 'renews_at', 'resumes_at',
    'status', 'subscription_items', 'total_billing_cycles', 'trial_end', 'trial_start', 'updated_at'
  ]
