...
class BillingMeterEventExternal(BaseModel):
  ...
  status: BillingMeterEventStatus = Field(description='Status of the billing meter event.')
  updated_at: datetime = Field(
    description="DateTime at which the object was updated, in 'ISO 8601' format."
  )
  __properties: ClassVar[List[str]] = [
    'account_id', 'created_at', 'event_datetime', 'event_name', 'id', 'identifier', 'is_deleted',
    'object', 'payload', 'status', 'updated_at'
  ]
