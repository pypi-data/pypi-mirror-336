...
class BillingMeterExternal(BaseModel):
  ...
  aggregation_formula: Optional[BillingMeterAggregationFormula] = Field(
    default=None,
    description=
  ...
  event_name: Annotated[str, Field(strict=True)] = Field(
    description=
    'The name of the meter event to record usage for. Corresponds with the event_name field on meter events.'
  )
  event_payload_customer_mapping_key: Optional[StrictStr] = Field(
    default='customer_id',
    description='The key in the usage event payload to use for mapping the event to a customer.'
  )
  event_payload_value_key: Optional[StrictStr] = Field(
    default='value',
    description=
  ...
  __properties: ClassVar[List[str]] = [
    'account_id', 'aggregation_formula', 'created_at', 'display_name', 'event_name',
    'event_payload_customer_mapping_key', 'event_payload_value_key', 'id', 'is_active',
    'is_deleted', 'object', 'updated_at'
  ]
    ...
    _obj = cls.model_validate(
      {
        ...
        'event_payload_customer_mapping_key':
          obj.get('event_payload_customer_mapping_key')
          if obj.get('event_payload_customer_mapping_key') is not None else 'customer_id',
        'event_payload_value_key':
          obj.get('event_payload_value_key')
          if obj.get('event_payload_value_key') is not None else 'value',
        'id': obj.get('id'),
