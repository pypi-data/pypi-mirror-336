...
class PromoCodeQueryParams(BaseModel):
  ...
  __properties: ClassVar[List[str]] = [
    'code', 'coupon_id', 'created_at', 'expand', 'expires_at', 'is_active', 'page_number',
    'page_size', 'search', 'sort_descending', 'sort_key', 'updated_at'
  ]
    ...
    _obj = cls.model_validate(
      {
        ...
        'expires_at':
          DateTimeFilter.from_dict(obj.get('expires_at'))
          if obj.get('expires_at') is not None else None,
