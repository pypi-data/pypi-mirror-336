...
class CreateCheckoutSessionRequest(BaseModel):
  ...
  __properties: ClassVar[List[str]] = [
    'checkout_preferences', 'client_reference_id', 'coupon_id', 'currency', 'customer_email',
    'customer_id', 'line_items', 'mode', 'return_url', 'success_url', 'trial_end',
    'trial_from_price', 'trial_period_days'
  ]
