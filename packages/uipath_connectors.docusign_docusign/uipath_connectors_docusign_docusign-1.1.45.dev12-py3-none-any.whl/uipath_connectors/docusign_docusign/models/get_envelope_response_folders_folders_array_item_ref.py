...
from ..models.get_envelope_response_folders_folders_owner import (
    GetEnvelopeResponseFoldersFoldersOwner,
)


class GetEnvelopeResponseFoldersFoldersArrayItemRef(BaseModel):
    """
    Attributes:
        ...
        name (Optional[str]):
        owner (Optional[GetEnvelopeResponseFoldersFoldersOwner]):
    ...
    owner: Optional["GetEnvelopeResponseFoldersFoldersOwner"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["GetEnvelopeResponseFoldersFoldersArrayItemRef"],
