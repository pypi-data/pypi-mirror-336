...
from ..models.get_template_response_recipients_notaries_signing_group_id_metadata import (
    GetTemplateResponseRecipientsNotariesSigningGroupIdMetadata,
)


class GetTemplateResponseRecipientsNotariesArrayItemRef(BaseModel):
    """
    Attributes:
        access_code (Optional[str]):
        add_access_code_to_email (Optional[str]):
        agent_can_edit_email (Optional[str]):
        agent_can_edit_name (Optional[str]):
        allow_system_override_for_locked_recipient (Optional[str]):
        auto_navigation (Optional[str]):
        auto_responded_reason (Optional[str]):
        bulk_recipients_uri (Optional[str]):
        ...
        is_bulk_recipient (Optional[str]):
        last_name (Optional[str]):
        live_oak_start_url (Optional[str]):
        locked_recipient_phone_auth_editable (Optional[str]):
        locked_recipient_sms_editable (Optional[str]):
        name (Optional[str]):
        notary_id (Optional[str]):
        notary_signers (Optional[list[str]]):
        notary_type (Optional[str]):
        note (Optional[str]):
        ...
        signing_group_id_metadata (Optional[GetTemplateResponseRecipientsNotariesSigningGroupIdMetadata]):
    ...
    live_oak_start_url: Optional[str] = Field(alias="liveOakStartURL", default=None)
    ...
    notary_signers: Optional[list[str]] = Field(alias="notarySigners", default=None)
    notary_type: Optional[str] = Field(alias="notaryType", default=None)
    ...
    @classmethod
    def from_dict(
        cls: Type["GetTemplateResponseRecipientsNotariesArrayItemRef"],
