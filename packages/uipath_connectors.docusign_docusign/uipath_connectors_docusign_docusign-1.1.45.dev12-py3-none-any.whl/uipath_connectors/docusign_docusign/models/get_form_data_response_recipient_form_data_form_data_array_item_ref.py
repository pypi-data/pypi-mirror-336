...
from ..models.get_form_data_response_recipient_form_data_form_data_error_details import (
    GetFormDataResponseRecipientFormDataFormDataErrorDetails,
)


class GetFormDataResponseRecipientFormDataFormDataArrayItemRef(BaseModel):
    """
    Attributes:
        error_details (Optional[GetFormDataResponseRecipientFormDataFormDataErrorDetails]):
    ...
    @classmethod
    def from_dict(
        cls: Type["GetFormDataResponseRecipientFormDataFormDataArrayItemRef"],
