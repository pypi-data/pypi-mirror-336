...
class ListAllEnvelopeRecipientsRecipientAuthenticationStatusYahooResult(BaseModel):
    """
    Attributes:
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsRecipientAuthenticationStatusYahooResult"],
