...
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_currency_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsCurrencyTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended (Optional[list['ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata (Optional[ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsCurrencyTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsCurrencyTabsMergeField"],
