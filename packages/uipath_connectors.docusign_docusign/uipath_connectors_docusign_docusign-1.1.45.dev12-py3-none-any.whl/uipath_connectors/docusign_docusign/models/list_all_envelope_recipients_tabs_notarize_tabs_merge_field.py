...
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_notarize_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsNotarizeTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended (Optional[list['ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata (Optional[ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsNotarizeTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsNotarizeTabsMergeField"],
