...
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_approve_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsApproveTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended (Optional[list['ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata (Optional[ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsApproveTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsApproveTabsMergeField"],
