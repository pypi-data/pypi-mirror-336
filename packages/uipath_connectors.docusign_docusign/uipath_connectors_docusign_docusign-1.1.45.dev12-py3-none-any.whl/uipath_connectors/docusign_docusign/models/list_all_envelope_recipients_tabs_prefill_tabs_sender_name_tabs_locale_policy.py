...
class ListAllEnvelopeRecipientsTabsPrefillTabsSenderNameTabsLocalePolicy(BaseModel):
    """
    Attributes:
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsPrefillTabsSenderNameTabsLocalePolicy"],
