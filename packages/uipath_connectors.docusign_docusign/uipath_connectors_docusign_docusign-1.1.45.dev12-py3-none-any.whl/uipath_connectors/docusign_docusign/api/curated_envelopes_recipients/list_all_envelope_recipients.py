...
def _get_kwargs(
    *,
    ...
    params["includeAnchorTabLocations"] = include_anchor_tab_locations

    params["includeMetadata"] = include_metadata

    params["includeTabs"] = include_tabs
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/curatedEnvelopesRecipients",
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListAllEnvelopeRecipients.from_dict(
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListAllEnvelopeRecipients"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """List All Envelope Recipients
     ...
     Retrieve the list of recipients of an envelope
    ...
    Args:
        ...
        include_anchor_tab_locations (Optional[bool]): Whether to include all tabs with anchor tab
            properties in the response? Should be used along with "include tabs" property.
        include_metadata (Optional[bool]): Whether to include metadata associated with the
            recipients?
        include_tabs (Optional[bool]): Whether to include the  information about the tabs,
            including prefill tabs, associated with the documents?
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, list['ListAllEnvelopeRecipients']]
    """
