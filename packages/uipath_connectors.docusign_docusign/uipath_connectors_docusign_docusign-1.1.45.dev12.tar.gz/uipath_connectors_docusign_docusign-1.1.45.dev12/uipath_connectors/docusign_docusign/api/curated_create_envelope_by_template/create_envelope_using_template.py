...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/curatedCreateEnvelopeByTemplate",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateEnvelopeUsingTemplateResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateEnvelopeUsingTemplateResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Envelope using Template
     ...
     Create an envelope using a template and save it as draft or send it to the recipient
...
def sync(
    *,
    ...
    Returns:
        Union[CreateEnvelopeUsingTemplateResponse, DefaultError]
    """
