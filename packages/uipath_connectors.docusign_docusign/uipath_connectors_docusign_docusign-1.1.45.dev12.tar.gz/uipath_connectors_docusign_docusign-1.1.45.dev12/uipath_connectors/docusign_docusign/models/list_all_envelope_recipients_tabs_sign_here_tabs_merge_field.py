...
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_sign_here_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsSignHereTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended (Optional[list['ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata (Optional[ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsSignHereTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsSignHereTabsMergeField"],
