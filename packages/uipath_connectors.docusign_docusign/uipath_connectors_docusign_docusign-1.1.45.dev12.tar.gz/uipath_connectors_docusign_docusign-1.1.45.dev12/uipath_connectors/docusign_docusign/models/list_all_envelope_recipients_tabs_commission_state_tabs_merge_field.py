...
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_commission_state_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended
                (Optional[list['ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsCommissionStateTabsMergeField"],
