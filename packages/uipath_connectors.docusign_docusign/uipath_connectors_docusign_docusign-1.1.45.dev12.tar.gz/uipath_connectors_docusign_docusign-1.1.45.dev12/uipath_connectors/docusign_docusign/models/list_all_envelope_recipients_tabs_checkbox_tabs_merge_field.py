...
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_checkbox_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsCheckboxTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended (Optional[list['ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata (Optional[ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsCheckboxTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsCheckboxTabsMergeField"],
