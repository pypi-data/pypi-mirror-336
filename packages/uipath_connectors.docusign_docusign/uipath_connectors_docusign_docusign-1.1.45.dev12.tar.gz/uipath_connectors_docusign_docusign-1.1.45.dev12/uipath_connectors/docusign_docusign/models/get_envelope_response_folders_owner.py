...
from ..models.get_envelope_response_folders_owner_error_details import (
    GetEnvelopeResponseFoldersOwnerErrorDetails,
)


class GetEnvelopeResponseFoldersOwner(BaseModel):
    """
    Attributes:
        ...
        email (Optional[str]):
        error_details (Optional[GetEnvelopeResponseFoldersOwnerErrorDetails]):
    ...
    error_details: Optional["GetEnvelopeResponseFoldersOwnerErrorDetails"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["GetEnvelopeResponseFoldersOwner"], src_dict: Dict[str, Any]
    ):
