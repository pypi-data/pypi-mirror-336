...
class ListAllEnvelopeRecipientsRecipientAuthenticationStatusOfacResult(BaseModel):
    """
    Attributes:
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsRecipientAuthenticationStatusOfacResult"],
