...
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_allow_sender_to_edit_metadata import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldAllowSenderToEditMetadata,
)
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_configuration_type_metadata import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldConfigurationTypeMetadata,
)
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_path_extended_array_item_ref import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldPathExtendedArrayItemRef,
)
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_path_extended_metadata import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldPathExtendedMetadata,
)
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_path_metadata import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldPathMetadata,
)
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_row_metadata import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldRowMetadata,
)
from ..models.list_all_envelope_recipients_tabs_full_name_tabs_merge_field_write_back_metadata import (
    ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldWriteBackMetadata,
)


class ListAllEnvelopeRecipientsTabsFullNameTabsMergeField(BaseModel):
    """
    Attributes:
        allow_sender_to_edit (Optional[str]):  Example: string.
        allow_sender_to_edit_metadata
                (Optional[ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldAllowSenderToEditMetadata]):
        configuration_type (Optional[str]):  Example: string.
        configuration_type_metadata
                (Optional[ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldConfigurationTypeMetadata]):
        path (Optional[str]):  Example: string.
        path_extended (Optional[list['ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldPathExtendedArrayItemRef']]):
        path_extended_metadata (Optional[ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldPathExtendedMetadata]):
        path_metadata (Optional[ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldPathMetadata]):
        row (Optional[str]):  Example: string.
        row_metadata (Optional[ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldRowMetadata]):
        write_back (Optional[str]):  Example: string.
        write_back_metadata (Optional[ListAllEnvelopeRecipientsTabsFullNameTabsMergeFieldWriteBackMetadata]):
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsFullNameTabsMergeField"],
