...
class ListAllEnvelopeRecipientsTabsCommissionExpirationTabsLocalePolicy(BaseModel):
    """
    Attributes:
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsTabsCommissionExpirationTabsLocalePolicy"],
