...
class ListAllEnvelopeRecipientsRecipientAuthenticationStatusGoogleResult(BaseModel):
    """
    Attributes:
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsRecipientAuthenticationStatusGoogleResult"],
