...
class ListAllEnvelopeRecipientsRecipientAuthenticationStatusOpenIDResult(BaseModel):
    """
    Attributes:
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsRecipientAuthenticationStatusOpenIDResult"],
