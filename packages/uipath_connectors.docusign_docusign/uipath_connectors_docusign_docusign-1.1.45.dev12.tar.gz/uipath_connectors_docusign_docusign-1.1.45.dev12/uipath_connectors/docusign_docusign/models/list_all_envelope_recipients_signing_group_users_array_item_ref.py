...
from ..models.list_all_envelope_recipients_signing_group_users_error_details import (
    ListAllEnvelopeRecipientsSigningGroupUsersErrorDetails,
)


class ListAllEnvelopeRecipientsSigningGroupUsersArrayItemRef(BaseModel):
    """
    Attributes:
        account_id (Optional[str]):  Example: string.
        account_name (Optional[str]):  Example: string.
        activation_access_code (Optional[str]):  Example: string.
        email (Optional[str]):  Example: string.
        error_details (Optional[ListAllEnvelopeRecipientsSigningGroupUsersErrorDetails]):
        login_status (Optional[str]):  Example: string.
        membership_id (Optional[str]):  Example: string.
        send_activation_email (Optional[str]):  Example: string.
        uri (Optional[str]):  Example: string.
        user_id (Optional[str]):  Example: string.
        user_name (Optional[str]):  Example: string.
        user_status (Optional[str]):  Example: string.
        user_type (Optional[str]):  Example: string.
    """
    ...
    @classmethod
    def from_dict(
        cls: Type["ListAllEnvelopeRecipientsSigningGroupUsersArrayItemRef"],
