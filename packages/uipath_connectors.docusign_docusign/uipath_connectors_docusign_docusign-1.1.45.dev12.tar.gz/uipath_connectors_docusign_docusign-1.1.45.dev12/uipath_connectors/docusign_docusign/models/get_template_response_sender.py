...
from ..models.get_template_response_sender_error_details import (
    GetTemplateResponseSenderErrorDetails,
)


class GetTemplateResponseSender(BaseModel):
    """
    Attributes:
        ...
        email (Optional[str]):
        error_details (Optional[GetTemplateResponseSenderErrorDetails]):
    ...
    error_details: Optional["GetTemplateResponseSenderErrorDetails"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["GetTemplateResponseSender"], src_dict: Dict[str, Any]):
