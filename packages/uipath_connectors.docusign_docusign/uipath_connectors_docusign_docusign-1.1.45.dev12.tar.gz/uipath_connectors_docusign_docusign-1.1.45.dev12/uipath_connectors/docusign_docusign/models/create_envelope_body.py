...
class CreateEnvelopeBody(BaseModel):
    ...
    Attributes:
        ...
        file (File): Upload document which to be attached to the Envelope
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "CreateEnvelopeRequest" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["CreateEnvelopeBody"], src_dict: Dict[str, Any]):
