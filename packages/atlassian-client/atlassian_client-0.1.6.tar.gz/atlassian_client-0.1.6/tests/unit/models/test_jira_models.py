...
from src.atlassian_client.models.jira import (
    JiraComment,
    JiraIssue,
    JiraIssueType,
    JiraPriority,
...
try:
    from src.atlassian_client.jira.client import JiraClient  # noqa: F401
except ImportError:
    pass
...
class TestJiraProject:
    ...
    def test_from_api_response_with_empty_data(self):
        ...
        from src.atlassian_client.models.constants import (
            EMPTY_STRING,
...
class TestJiraTransition:
    ...
    def test_from_api_response_with_empty_data(self):
        ...
        from src.atlassian_client.models.constants import EMPTY_STRING, JIRA_DEFAULT_ID
...
class TestRealJiraData:
    ...
    def test_real_jira_issue(self, use_real_jira_data, default_jira_issue_key):
        ...
        from src.atlassian_client.jira.config import JiraConfig
        from src.atlassian_client.jira.issues import IssuesMixin
    ...
    def test_real_jira_project(self, use_real_jira_data):
        ...
        from src.atlassian_client.jira.config import JiraConfig
        from src.atlassian_client.jira.projects import ProjectsMixin
    ...
    def test_real_jira_transitions(self, use_real_jira_data, default_jira_issue_key):
        ...
        from src.atlassian_client.jira.config import JiraConfig
        from src.atlassian_client.models.jira import JiraTransition
    ...
    def test_real_jira_worklog(self, use_real_jira_data, default_jira_issue_key):
        ...
        from src.atlassian_client.jira.config import JiraConfig
        from src.atlassian_client.models.jira import JiraWorklog
