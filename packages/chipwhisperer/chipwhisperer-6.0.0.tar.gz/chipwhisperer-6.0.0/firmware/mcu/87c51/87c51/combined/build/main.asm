...
;	-----------------------------------------
_main:
;	main.c:40: inituart(248);	// 4800 baud with 7.37 MHz clock
	mov	dpl,#0xf8
	lcall	_inituart
;	main.c:41: trigger_low();
	anl	_P1,#0xfe
;	main.c:44: putchar('\n');
	mov	dpl,#0x0a
	lcall	_putchar
;	main.c:46: mode = get_mode();
	mov	a,_P3
	swap	a
	rl	a
;	main.c:49: switch(mode)
	anl	a,#(0x1f&0x07)
	mov	r7,a
	add	a,#0xff - 0x05
	jc	00107$
...
00120$:
	...
	sjmp	00106$
00101$:
;	main.c:52: main_print();
	lcall	_main_print
;	main.c:54: case MODE_PASSCHECK:
00102$:
;	main.c:55: main_passcheck();
	lcall	_main_passcheck
;	main.c:57: case MODE_GLITCHLOOP:
00103$:
;	main.c:58: main_glitchloop();
	lcall	_main_glitchloop
;	main.c:60: case MODE_XOR:
00104$:
;	main.c:61: main_xor();
	lcall	_main_xor
;	main.c:63: case MODE_AES:
00105$:
;	main.c:64: main_aes();
	lcall	_main_aes
;	main.c:66: case MODE_TEA:
00106$:
;	main.c:67: main_tea();
	lcall	_main_tea
;	main.c:71: }
