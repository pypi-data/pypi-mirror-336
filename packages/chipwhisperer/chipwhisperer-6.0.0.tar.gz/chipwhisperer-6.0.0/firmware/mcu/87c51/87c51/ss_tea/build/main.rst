      ...
      0000B4 22               [24]  485 	ret
                                    ...
                                    490 ;key                       Allocated to stack - _bp +12
      ...
      0000BB 24 1B            [12]  501 	add	a,#0x1b
      ...
      0000CE                        512 00104$:
                                    513 ;	main.c:37: if(simpleserial_get(input, key, 8, 16))
      0000CE E5 08            [12]  514 	mov	a,_bp
      0000D0 24 0C            [12]  515 	add	a,#0x0c
      ...
      0000EC 74 10            [12]  532 	mov	a,#0x10
      0000EE C0 E0            [24]  533 	push	acc
      0000F0 03               [12]  534 	rr	a
      0000F1 C0 E0            [24]  535 	push	acc
      0000F3 A8 08            [24]  536 	mov	r0,_bp
      0000F5 08               [12]  537 	inc	r0
      0000F6 E6               [12]  538 	mov	a,@r0
      0000F7 C0 E0            [24]  539 	push	acc
      0000F9 08               [12]  540 	inc	r0
      0000FA E6               [12]  541 	mov	a,@r0
      0000FB C0 E0            [24]  542 	push	acc
      0000FD 08               [12]  543 	inc	r0
      0000FE E6               [12]  544 	mov	a,@r0
      0000FF C0 E0            [24]  545 	push	acc
      000101 8A 82            [24]  546 	mov	dpl,r2
      000103 8D 83            [24]  547 	mov	dph,r5
      000105 8E F0            [24]  548 	mov	b,r6
      000107 12 04 5E         [24]  549 	lcall	_simpleserial_get
      00010A AD 82            [24]  550 	mov	r5,dpl
      00010C AE 83            [24]  551 	mov	r6,dph
      00010E E5 81            [12]  552 	mov	a,sp
      000110 24 FB            [12]  553 	add	a,#0xfb
      000112 F5 81            [12]  554 	mov	sp,a
      000114 D0 03            [24]  555 	pop	ar3
      000116 D0 07            [24]  556 	pop	ar7
      000118 ED               [12]  557 	mov	a,r5
      000119 4E               [12]  558 	orl	a,r6
      00011A 60 B2            [24]  559 	jz	00104$
                                    560 ;	main.c:40: trigger_high();
      00011C 43 90 01         [24]  561 	orl	_P1,#0x01
                                    562 ;	main.c:41: tea_encrypt(input, key);
      00011F A8 08            [24]  563 	mov	r0,_bp
      000121 08               [12]  564 	inc	r0
      000122 A6 07            [24]  565 	mov	@r0,ar7
      000124 08               [12]  566 	inc	r0
      000125 76 00            [12]  567 	mov	@r0,#0x00
      000127 08               [12]  568 	inc	r0
      000128 76 40            [12]  569 	mov	@r0,#0x40
      00012A 8B 04            [24]  570 	mov	ar4,r3
      00012C 8C 02            [24]  571 	mov	ar2,r4
      00012E 7C 00            [12]  572 	mov	r4,#0x00
      000130 7F 40            [12]  573 	mov	r7,#0x40
      000132 C0 03            [24]  574 	push	ar3
      000134 A8 08            [24]  575 	mov	r0,_bp
      000136 08               [12]  576 	inc	r0
      000137 E6               [12]  577 	mov	a,@r0
      000138 C0 E0            [24]  578 	push	acc
      00013A 08               [12]  579 	inc	r0
      00013B E6               [12]  580 	mov	a,@r0
      00013C C0 E0            [24]  581 	push	acc
      00013E 08               [12]  582 	inc	r0
      00013F E6               [12]  583 	mov	a,@r0
      000140 C0 E0            [24]  584 	push	acc
      000142 8A 82            [24]  585 	mov	dpl,r2
      000144 8C 83            [24]  586 	mov	dph,r4
      000146 8F F0            [24]  587 	mov	b,r7
      000148 12 05 F6         [24]  588 	lcall	_tea_encrypt
      00014B 15 81            [12]  589 	dec	sp
      00014D 15 81            [12]  590 	dec	sp
      00014F 15 81            [12]  591 	dec	sp
      000151 D0 03            [24]  592 	pop	ar3
                                    593 ;	main.c:42: trigger_low();
      000153 53 90 FE         [24]  594 	anl	_P1,#0xfe
                                    595 ;	main.c:43: simpleserial_put(input, 8);
      000156 7F 00            [12]  596 	mov	r7,#0x00
      000158 7E 40            [12]  597 	mov	r6,#0x40
      00015A 74 08            [12]  598 	mov	a,#0x08
      00015C C0 E0            [24]  599 	push	acc
      00015E 8B 82            [24]  600 	mov	dpl,r3
      000160 8F 83            [24]  601 	mov	dph,r7
      000162 8E F0            [24]  602 	mov	b,r6
      000164 12 05 7F         [24]  603 	lcall	_simpleserial_put
      000167 15 81            [12]  604 	dec	sp
      000169 02 00 CE         [24]  605 	ljmp	00104$
      00016C 85 08 81         [24]  606 	mov	sp,_bp
      00016F D0 08            [24]  607 	pop	_bp
      000171 22               [24]  608 	ret
                                    609 	.area CSEG    (CODE)
                                    610 	.area CONST   (CODE)
                                    611 	.area XINIT   (CODE)
