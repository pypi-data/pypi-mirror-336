...
_main:
	...
	add	a,#0x1b
	mov	sp,a
;	main.c:27: inituart(248);	// 4800 baud
	mov	dpl,#0xf8
	lcall	_inituart
;	main.c:28: trigger_low();
	anl	_P1,#0xfe
;	main.c:31: putchar('\n');
	mov	dpl,#0x0a
	lcall	_putchar
;	main.c:34: while(1)
00104$:
;	main.c:37: if(simpleserial_get(input, key, 8, 16))
	mov	a,_bp
	add	a,#0x0c
	mov	r7,a
	mov	r0,_bp
	...
	orl	a,r6
	jz	00104$
;	main.c:40: trigger_high();
	orl	_P1,#0x01
;	main.c:41: tea_encrypt(input, key);
	mov	r0,_bp
	inc	r0
	mov	@r0,ar7
	inc	r0
	...
	dec	sp
	pop	ar3
;	main.c:42: trigger_low();
	anl	_P1,#0xfe
;	main.c:43: simpleserial_put(input, 8);
	mov	r7,#0x00
	mov	r6,#0x40
	mov	a,#0x08
	push	acc
