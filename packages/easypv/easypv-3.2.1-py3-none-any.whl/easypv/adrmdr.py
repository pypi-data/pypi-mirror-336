...
title_all="药械妆不良反应报表统计分析工具 adrmdr_"+version_now
title_all2="药械妆不良反应报表统计分析工具 adrmdr_"+version_now
# 第二部分：函数模块 ##################################################################
...
def CLEAN_qx(data):
		...
		data.loc[((data["年龄"]=="未填写")|data["年龄"].isnull()), "年龄"] = -1 
