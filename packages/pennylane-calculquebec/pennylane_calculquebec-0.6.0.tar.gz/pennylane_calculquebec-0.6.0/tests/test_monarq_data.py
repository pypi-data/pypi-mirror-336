...
def test_get_broken_qubits_and_couplers(mock_get_qubits_and_couplers, mock_get_connectivity):
    # nothing is broken
...
def test_get_readout1_and_cz_fidelities(mock_get_qubits_and_couplers, mock_get_connectivity, mock_is_last_update_expired):
    # before caching
...
def test_get_coupler_noise(mock_is_last_update_expired, mock_get_connectivity, mock_get_qubits_and_couplers):
    # before cache
