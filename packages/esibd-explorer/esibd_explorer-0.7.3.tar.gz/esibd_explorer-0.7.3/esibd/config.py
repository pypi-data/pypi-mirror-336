...
ABOUTHTML       = f"""<p>{PROGRAM_NAME} controls all aspects of an ESIBD experiment, including ion beam guiding and steering, beam energy analysis, deposition monitoring, and data analysis.<br>
                    ...
                    Read the docs online at <a href='http://esibd-explorer.rtfd.io/'>http://esibd-explorer.rtfd.io/</a> or <a href='{(Path(__file__).parent / 'docs/index.html').resolve()}'>offline</a> for more details.<br><br>
...
PROGRAM_VERSION   = version.parse('0.7.3') # major.minor.patch/micro
