...
kp.plot_embedding(adata, color='leiden', title='UMAP by cluster')
...
kp.plot_embedding(adata, basis='umap', color='leiden', title='UMAP by cluster (without X_ prefix)')

# Filtering by a single group
groups = {'condition': ['treatment']}
print("Plotting with single group filter...")
kp.plot_embedding(adata, 
                 groups=groups,
                 color='leiden', 
