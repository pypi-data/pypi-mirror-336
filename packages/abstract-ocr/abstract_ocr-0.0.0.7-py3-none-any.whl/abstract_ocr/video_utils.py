...
def derive_all_video_meta(video_file_path,output_dir=None,video_text_path=None):
    ...
    video_json = {"video_file_path":video_file_path,'thumbnail_texts':thumbnail_texts,"video_info":video_info,"video_text":video_text,"text_contants":text_contants}
