...
class MetaboMix():
    ...
    def __init__(self,settings_json: str | dict) -> None:
        self.settings: RecipeHolder = RecipeHolder(settings_json,available_tools=RecipeHolder.available_tools,available_integrations=RecipeHolder.available_integrations)
