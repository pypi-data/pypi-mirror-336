...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/hubs/general/CreateCalendarEvents",
        "params": params,
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateCalendarEventResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateCalendarEventResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Create Event (Calendar Event)
     ...
     Create an event in calendar and send invites to attendees
    ...
    Args:
        ...
        send_notifications (Optional[str]): Whether to send notifications about the creation of
            the new event. Note that some emails might still be sent. The default is false.Valid
            values: all, externalOnly, none. Default: 'all'.
...
def sync(
    *,
    ...
    Returns:
        Union[CreateCalendarEventResponse, DefaultError]
    """
