...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/hubs/general/calendars-primary-events/{id}".format(
            id=id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get Event by ID (Calendar Event)
     ...
     Get a calendar event details based on calendar event ID

    Args:
        id (str): The ID of the calendar event
        max_attendees (Optional[str]): The maximum number of attendees to include in the response.
            If there are more than the specified number of attendees, only the participant is
            returned.
        time_zone (Optional[str]): Time zone used in the response. Optional. The default is the
