...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = TurnOnAutomaticRepliesResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, TurnOnAutomaticRepliesResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Turn On Automatic Replies
     ...
     Turn on automatic replies to email messages
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, TurnOnAutomaticRepliesResponse]
    """
