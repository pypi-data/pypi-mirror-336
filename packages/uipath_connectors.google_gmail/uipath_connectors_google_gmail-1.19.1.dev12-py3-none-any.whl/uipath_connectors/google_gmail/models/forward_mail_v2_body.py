...
class ForwardMailV2Body(BaseModel):
    """
    Attributes:
        body (ForwardMailV2Request):
        file (Optional[File]): The attachments to be sent with the forwarded email
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "ForwardMailV2Request" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["ForwardMailV2Body"], src_dict: Dict[str, Any]):
