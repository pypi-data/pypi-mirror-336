...
class RemoveGmailLabelResponse(BaseModel):
    """
    Attributes:
        id (Optional[str]): Unique identifier for the specific email message. Example: 19488b1fa00ba1a8.
    ...
    @classmethod
    def from_dict(cls: Type["RemoveGmailLabelResponse"], src_dict: Dict[str, Any]):
