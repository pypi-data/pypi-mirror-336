...
@pytest.mark.parametrize('blockage_model,center_ref,side_ref', [
    (SelfSimilarityDeficit,
     [9.943, 9.915684, 9.865418, 9.763897, 9.542707, 11.041249, 10.450819, 10.233233, 10.133212, 10.083602],
     [9.938289, 9.905028, 9.836523, 9.662802, 9.060236, 13.145629, 10.917318, 10.331529, 10.161474, 10.094069]),
    (SelfSimilarityDeficit2020,
     [9.937128, 9.907163, 9.852059, 9.742072, 9.551456, 10.280608, 10.444519, 10.254883, 10.146441, 10.092053],
     [9.931709, 9.89535, 9.821447, 9.6399, 9.072077, 13.105229, 10.907386, 10.354307, 10.176411, 10.103666]),
    (VortexCylinder,
    ...
    (VortexDipole,
     ...
     [9.944808, 9.913676, 9.84628, 9.652978, 8.598016, 12.759618, 11.347018, 10.340151, 10.151684, 10.085465]),
    (RankineHalfBody,
     [9.949202, 9.924034, 9.876704, 9.780608, 9.633199, 10.008154, 10.365033, 10.216741, 10.121995, 10.075302],
    ...
    (HybridInduction,
     ...
     [9.931709, 9.89535, 9.821447, 9.6399, 9.072077, 12.759618, 11.347018, 10.340151, 10.151684, 10.085465]),
    (Rathmann,
     [9.950432, 9.926598, 9.882538, 9.792603, 9.597037, 10.041663, 10.397465, 10.204838, 10.116258, 10.072778],
     [9.94641, 9.917526, 9.858037, 9.707178, 9.190401, 10.027376, 10.796607, 10.2879, 10.140223, 10.081689]),
    (RathmannScaled,
     [9.929791, 9.897708, 9.838744, 9.719092, 9.456743, 10.056169, 10.535845, 10.277511, 10.159648, 10.101453],
     [9.924278, 9.88539, 9.805788, 9.60523, 8.908535, 10.036907, 11.07395, 10.388211, 10.191891, 10.113556]),
])
def test_blockage_map(setup, blockage_model, center_ref, side_ref):
    ...
    flow_map = wm(x=[0], y=[0], wd=[270], ws=[10]).flow_map(XYGrid(x=xy[::], y=xy[[190, 250]]))
    X_j, Y_j = flow_map.XY
    ...
    if debug:
        ...
        c = ax1.contourf(X_j_full, Y_j_full, WS_eff_full)
        plt.colorbar(c)
        ax1.plot(X_j.T[::50], Y_j.T[::50], '.-')
        c = ax2.plot(WS_eff.x, WS_eff[0], label='Center')[0].get_color()
        ax2.plot(WS_eff.x[::50], center_ref, 'x', color=c)
        c = ax2.plot(WS_eff.x, WS_eff[1], label='Side')[0].get_color()
        ax2.plot(WS_eff.x[::50], side_ref, '.', color=c)
    ...
    npt.assert_array_almost_equal(WS_eff[0][::50], center_ref)
    npt.assert_array_almost_equal(WS_eff[1][::50], side_ref)


@pytest.mark.parametrize('blockage_model,center_ref,side_ref', [
    (SelfSimilarityDeficit,
     [9.943, 9.915684, 9.865418, 9.763897, 9.542707, 11.041249, 10.450819, 6.223921, 6.782925, 7.226399],
     [9.938289, 9.905028, 9.836523, 9.662802, 9.060236, 4.560631, 5.505472, 6.223921, 6.782925, 7.226399]),
    (SelfSimilarityDeficit2020,
     [9.937128, 9.907163, 9.852059, 9.742072, 9.551456, 10.280608, 10.444519, 6.223921, 6.782925, 7.226399],
    ...
    (VortexDipole,
     [9.949202, 9.924034, 9.876704, 9.780608, 9.633199, 10.008154, 10.365033, 6.223921, 6.782925, 7.226399],
     [9.944808, 9.913676, 9.84628, 9.652978, 8.598016, 4.560631, 5.505472, 6.223921, 6.782925, 7.226399]),
    (RankineHalfBody,
     [9.949202, 9.924034, 9.876704, 9.780608, 9.633199, 10.008154, 10.365033, 6.223921, 6.782925, 7.226399],
     [9.944808, 9.913676, 9.84628, 9.652978, 8.598016, 4.560631, 5.505472, 6.223921, 6.782925, 7.226399]),
    (HybridInduction,
     [9.937128, 9.907163, 9.852059, 9.742072, 9.551456, 10.008154, 10.365033, 6.223921, 6.782925, 7.226399],
     [9.931709, 9.89535, 9.821447, 9.6399, 9.072077, 4.560631, 5.505472, 6.223921, 6.782925, 7.226399]),
    (Rathmann,
     [9.950432, 9.926598, 9.882538, 9.792603, 9.597037, 10.041663, 10.397465, 6.223921, 6.782925, 7.226399],
     [9.94641, 9.917526, 9.858037, 9.707178, 9.190401, 4.560631, 5.505472, 6.223921, 6.782925, 7.226399]),
    (RathmannScaled,
     [9.929791, 9.897708, 9.838744, 9.719092, 9.456743, 10.056169, 10.535845, 6.223921, 6.782925, 7.226399],
