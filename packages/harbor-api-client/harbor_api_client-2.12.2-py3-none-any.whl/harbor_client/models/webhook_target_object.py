...
class WebhookTargetObject(object):
    ...
    def __init__(self, type=None, address=None, auth_header=None, skip_cert_verify=None, payload_format=None, _configuration=None):  # noqa: E501
    ...
    def payload_format(self):
        """Gets the payload_format of this WebhookTargetObject.  # noqa: E501

        The payload format of webhook, by default is Default for http type.  # noqa: E501

        :return: The payload_format of this WebhookTargetObject.  # noqa: E501
        :rtype: PayloadFormatType
        """
        return self._payload_format

    @payload_format.setter
    def payload_format(self, payload_format):
        """Sets the payload_format of this WebhookTargetObject.

        The payload format of webhook, by default is Default for http type.  # noqa: E501

        :param payload_format: The payload_format of this WebhookTargetObject.  # noqa: E501
