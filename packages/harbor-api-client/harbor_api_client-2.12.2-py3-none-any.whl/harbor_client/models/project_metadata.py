...
class ProjectMetadata(object):
    ...
    attribute_map = {
        ...
        'proxy_speed_kb': 'proxy_speed_kb'
    }

    def __init__(self, public=None, enable_content_trust=None, enable_content_trust_cosign=None, prevent_vul=None, severity=None, auto_scan=None, auto_sbom_generation=None, reuse_sys_cve_allowlist=None, retention_id=None, proxy_speed_kb=None, _configuration=None):  # noqa: E501
        ...
        if auto_sbom_generation is not None:
            self.auto_sbom_generation = auto_sbom_generation
        ...
        if proxy_speed_kb is not None:
            self.proxy_speed_kb = proxy_speed_kb
    ...
    @property
    def auto_sbom_generation(self):
        """Gets the auto_sbom_generation of this ProjectMetadata.  # noqa: E501

        Whether generating SBOM automatically when pushing a subject artifact. The valid values are \"true\", \"false\".  # noqa: E501

        :return: The auto_sbom_generation of this ProjectMetadata.  # noqa: E501
        :rtype: str
        """
        return self._auto_sbom_generation

    @auto_sbom_generation.setter
    def auto_sbom_generation(self, auto_sbom_generation):
        """Sets the auto_sbom_generation of this ProjectMetadata.

        Whether generating SBOM automatically when pushing a subject artifact. The valid values are \"true\", \"false\".  # noqa: E501

        :param auto_sbom_generation: The auto_sbom_generation of this ProjectMetadata.  # noqa: E501
        :type: str
        """

        self._auto_sbom_generation = auto_sbom_generation
    ...
    @property
    def proxy_speed_kb(self):
        """Gets the proxy_speed_kb of this ProjectMetadata.  # noqa: E501

        The bandwidth limit of proxy cache, in Kbps (kilobits per second). It limits the communication between Harbor and the upstream registry, not the client and the Harbor.  # noqa: E501

        :return: The proxy_speed_kb of this ProjectMetadata.  # noqa: E501
        :rtype: str
        """
        return self._proxy_speed_kb

    @proxy_speed_kb.setter
    def proxy_speed_kb(self, proxy_speed_kb):
        """Sets the proxy_speed_kb of this ProjectMetadata.

        The bandwidth limit of proxy cache, in Kbps (kilobits per second). It limits the communication between Harbor and the upstream registry, not the client and the Harbor.  # noqa: E501

        :param proxy_speed_kb: The proxy_speed_kb of this ProjectMetadata.  # noqa: E501
        :type: str
        """

        self._proxy_speed_kb = proxy_speed_kb
