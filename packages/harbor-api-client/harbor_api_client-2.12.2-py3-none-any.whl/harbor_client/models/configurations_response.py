...
class ConfigurationsResponse(object):
    ...
    attribute_map = {
        ...
        'ldap_group_attach_parallel': 'ldap_group_attach_parallel',
    ...
    def __init__(self, auth_mode=None, primary_auth_mode=None, ldap_base_dn=None, ldap_filter=None, ldap_group_base_dn=None, ldap_group_admin_dn=None, ldap_group_attribute_name=None, ldap_group_search_filter=None, ldap_group_search_scope=None, ldap_group_attach_parallel=None, ldap_scope=None, ldap_search_dn=None, ldap_timeout=None, ldap_uid=None, ldap_url=None, ldap_verify_cert=None, ldap_group_membership_attribute=None, project_creation_restriction=None, read_only=None, self_registration=None, token_expiration=None, uaa_client_id=None, uaa_client_secret=None, uaa_endpoint=None, uaa_verify_cert=None, http_authproxy_endpoint=None, http_authproxy_tokenreview_endpoint=None, http_authproxy_admin_groups=None, http_authproxy_admin_usernames=None, http_authproxy_verify_cert=None, http_authproxy_skip_search=None, http_authproxy_server_certificate=None, oidc_name=None, oidc_endpoint=None, oidc_client_id=None, oidc_groups_claim=None, oidc_admin_group=None, oidc_group_filter=None, oidc_scope=None, oidc_user_claim=None, oidc_verify_cert=None, oidc_auto_onboard=None, oidc_extra_redirect_parms=None, robot_token_duration=None, robot_name_prefix=None, notification_enable=None, quota_per_project_enable=None, storage_per_project=None, audit_log_forward_endpoint=None, skip_audit_log_database=None, scanner_skip_update_pulltime=None, scan_all_policy=None, session_timeout=None, banner_message=None, _configuration=None):  # noqa: E501
        ...
        self._ldap_group_attach_parallel = None
        ...
        self._scanner_skip_update_pulltime = None
        ...
        if primary_auth_mode is not None:
            self.primary_auth_mode = primary_auth_mode
        ...
        if ldap_group_attach_parallel is not None:
            self.ldap_group_attach_parallel = ldap_group_attach_parallel
        ...
        if scanner_skip_update_pulltime is not None:
            self.scanner_skip_update_pulltime = scanner_skip_update_pulltime
    ...
    @property
    def primary_auth_mode(self):
        """Gets the primary_auth_mode of this ConfigurationsResponse.  # noqa: E501

        The flag to indicate whether the current auth mode should consider as a primary one.  # noqa: E501

        :return: The primary_auth_mode of this ConfigurationsResponse.  # noqa: E501
        :rtype: BoolConfigItem
        """
        return self._primary_auth_mode

    @primary_auth_mode.setter
    def primary_auth_mode(self, primary_auth_mode):
        """Sets the primary_auth_mode of this ConfigurationsResponse.

        The flag to indicate whether the current auth mode should consider as a primary one.  # noqa: E501

        :param primary_auth_mode: The primary_auth_mode of this ConfigurationsResponse.  # noqa: E501
        :type: BoolConfigItem
        """

        self._primary_auth_mode = primary_auth_mode
    ...
    @property
    def ldap_group_attach_parallel(self):
        """Gets the ldap_group_attach_parallel of this ConfigurationsResponse.  # noqa: E501

        Attach LDAP user group information in parallel.  # noqa: E501

        :return: The ldap_group_attach_parallel of this ConfigurationsResponse.  # noqa: E501
        :rtype: BoolConfigItem
        """
        return self._ldap_group_attach_parallel

    @ldap_group_attach_parallel.setter
    def ldap_group_attach_parallel(self, ldap_group_attach_parallel):
        """Sets the ldap_group_attach_parallel of this ConfigurationsResponse.

        Attach LDAP user group information in parallel.  # noqa: E501

        :param ldap_group_attach_parallel: The ldap_group_attach_parallel of this ConfigurationsResponse.  # noqa: E501
        :type: BoolConfigItem
        """

        self._ldap_group_attach_parallel = ldap_group_attach_parallel
    ...
    @property
    def scanner_skip_update_pulltime(self):
        """Gets the scanner_skip_update_pulltime of this ConfigurationsResponse.  # noqa: E501

        Whether or not to skip update the pull time for scanner  # noqa: E501

        :return: The scanner_skip_update_pulltime of this ConfigurationsResponse.  # noqa: E501
        :rtype: BoolConfigItem
        """
        return self._scanner_skip_update_pulltime

    @scanner_skip_update_pulltime.setter
    def scanner_skip_update_pulltime(self, scanner_skip_update_pulltime):
        """Sets the scanner_skip_update_pulltime of this ConfigurationsResponse.

        Whether or not to skip update the pull time for scanner  # noqa: E501

        :param scanner_skip_update_pulltime: The scanner_skip_update_pulltime of this ConfigurationsResponse.  # noqa: E501
        :type: BoolConfigItem
        """

        self._scanner_skip_update_pulltime = scanner_skip_update_pulltime
    ...
    def banner_message(self):
        """Gets the banner_message of this ConfigurationsResponse.  # noqa: E501

        The banner message for the UI.It is the stringified result of the banner message object  # noqa: E501

        :return: The banner_message of this ConfigurationsResponse.  # noqa: E501
        :rtype: StringConfigItem
        """
    ...
    def banner_message(self, banner_message):
        """Sets the banner_message of this ConfigurationsResponse.

        The banner message for the UI.It is the stringified result of the banner message object  # noqa: E501

        :param banner_message: The banner_message of this ConfigurationsResponse.  # noqa: E501
        :type: StringConfigItem
        """
