...
class WebhookApi(object):
    ...
    def get_logs_of_webhook_task(self, project_name_or_id, webhook_policy_id, execution_id, task_id, **kwargs):  # noqa: E501
        """Get logs for a specific webhook task  # noqa: E501

        This endpoint returns the logs of a specific webhook task.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logs_of_webhook_task(project_name_or_id, webhook_policy_id, execution_id, task_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_logs_of_webhook_task_with_http_info(project_name_or_id, webhook_policy_id, execution_id, task_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_logs_of_webhook_task_with_http_info(project_name_or_id, webhook_policy_id, execution_id, task_id, **kwargs)  # noqa: E501
            return data

    def get_logs_of_webhook_task_with_http_info(self, project_name_or_id, webhook_policy_id, execution_id, task_id, **kwargs):  # noqa: E501
        """Get logs for a specific webhook task  # noqa: E501

        This endpoint returns the logs of a specific webhook task.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_logs_of_webhook_task_with_http_info(project_name_or_id, webhook_policy_id, execution_id, task_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_name_or_id', 'webhook_policy_id', 'execution_id', 'task_id', 'x_request_id', 'x_is_resource_name']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_logs_of_webhook_task" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_name_or_id' is set
        if self.api_client.client_side_validation and ('project_name_or_id' not in params or
                                                       params['project_name_or_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project_name_or_id` when calling `get_logs_of_webhook_task`")  # noqa: E501
        # verify the required parameter 'webhook_policy_id' is set
        if self.api_client.client_side_validation and ('webhook_policy_id' not in params or
                                                       params['webhook_policy_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `webhook_policy_id` when calling `get_logs_of_webhook_task`")  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('execution_id' not in params or
            ...
            raise ValueError("Missing the required parameter `execution_id` when calling `get_logs_of_webhook_task`")  # noqa: E501
        # verify the required parameter 'task_id' is set
        if self.api_client.client_side_validation and ('task_id' not in params or
                                                       params['task_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `task_id` when calling `get_logs_of_webhook_task`")  # noqa: E501

        if self.api_client.client_side_validation and ('x_request_id' in params and
                                                       len(params['x_request_id']) < 1):
            raise ValueError("Invalid value for parameter `x_request_id` when calling `get_logs_of_webhook_task`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}/executions/{execution_id}/tasks/{task_id}/log', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_executions_of_webhook_policy(self, project_name_or_id, webhook_policy_id, **kwargs):  # noqa: E501
        """List executions for a specific webhook policy  # noqa: E501

        This endpoint returns the executions of a specific webhook policy.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_executions_of_webhook_policy(project_name_or_id, webhook_policy_id, async_req=True)
        >>> result = thread.get()
        ...
        :param str sort: Sort the resource list in ascending or descending order. e.g. sort by field1 in ascending order and field2 in descending order with \"sort=field1,-field2\"
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_executions_of_webhook_policy_with_http_info(project_name_or_id, webhook_policy_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_executions_of_webhook_policy_with_http_info(project_name_or_id, webhook_policy_id, **kwargs)  # noqa: E501
            return data

    def list_executions_of_webhook_policy_with_http_info(self, project_name_or_id, webhook_policy_id, **kwargs):  # noqa: E501
        """List executions for a specific webhook policy  # noqa: E501

        This endpoint returns the executions of a specific webhook policy.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_executions_of_webhook_policy_with_http_info(project_name_or_id, webhook_policy_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_name_or_id', 'webhook_policy_id', 'x_request_id', 'x_is_resource_name', 'page', 'page_size', 'q', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_executions_of_webhook_policy" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_name_or_id' is set
        if self.api_client.client_side_validation and ('project_name_or_id' not in params or
                                                       params['project_name_or_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project_name_or_id` when calling `list_executions_of_webhook_policy`")  # noqa: E501
        # verify the required parameter 'webhook_policy_id' is set
        if self.api_client.client_side_validation and ('webhook_policy_id' not in params or
                                                       params['webhook_policy_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `webhook_policy_id` when calling `list_executions_of_webhook_policy`")  # noqa: E501

        if self.api_client.client_side_validation and ('x_request_id' in params and
                                                       len(params['x_request_id']) < 1):
            raise ValueError("Invalid value for parameter `x_request_id` when calling `list_executions_of_webhook_policy`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_executions_of_webhook_policy`, must be a value less than or equal to `100`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}/executions', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def list_tasks_of_webhook_execution(self, project_name_or_id, webhook_policy_id, execution_id, **kwargs):  # noqa: E501
        """List tasks for a specific webhook execution  # noqa: E501

        This endpoint returns the tasks of a specific webhook execution.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_tasks_of_webhook_execution(project_name_or_id, webhook_policy_id, execution_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_tasks_of_webhook_execution_with_http_info(project_name_or_id, webhook_policy_id, execution_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_tasks_of_webhook_execution_with_http_info(project_name_or_id, webhook_policy_id, execution_id, **kwargs)  # noqa: E501
            return data

    def list_tasks_of_webhook_execution_with_http_info(self, project_name_or_id, webhook_policy_id, execution_id, **kwargs):  # noqa: E501
        """List tasks for a specific webhook execution  # noqa: E501

        This endpoint returns the tasks of a specific webhook execution.   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_tasks_of_webhook_execution_with_http_info(project_name_or_id, webhook_policy_id, execution_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_name_or_id', 'webhook_policy_id', 'execution_id', 'x_request_id', 'x_is_resource_name', 'page', 'page_size', 'q', 'sort']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_tasks_of_webhook_execution" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_name_or_id' is set
        if self.api_client.client_side_validation and ('project_name_or_id' not in params or
                                                       params['project_name_or_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project_name_or_id` when calling `list_tasks_of_webhook_execution`")  # noqa: E501
        # verify the required parameter 'webhook_policy_id' is set
        if self.api_client.client_side_validation and ('webhook_policy_id' not in params or
                                                       params['webhook_policy_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `webhook_policy_id` when calling `list_tasks_of_webhook_execution`")  # noqa: E501
        # verify the required parameter 'execution_id' is set
        if self.api_client.client_side_validation and ('execution_id' not in params or
                                                       params['execution_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `execution_id` when calling `list_tasks_of_webhook_execution`")  # noqa: E501

        if self.api_client.client_side_validation and ('x_request_id' in params and
                                                       len(params['x_request_id']) < 1):
            raise ValueError("Invalid value for parameter `x_request_id` when calling `list_tasks_of_webhook_execution`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_tasks_of_webhook_execution`, must be a value less than or equal to `100`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/projects/{project_name_or_id}/webhook/policies/{webhook_policy_id}/executions/{execution_id}/tasks', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
