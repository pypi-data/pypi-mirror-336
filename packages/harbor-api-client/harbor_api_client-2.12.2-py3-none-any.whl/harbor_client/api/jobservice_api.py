...
class JobserviceApi(object):
    ...
    def action_get_job_log(self, job_id, **kwargs):  # noqa: E501
        """Get job log by job id  # noqa: E501

        Get job log by job id, it is only used by administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.action_get_job_log(job_id, async_req=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async_req'):
            return self.action_get_job_log_with_http_info(job_id, **kwargs)  # noqa: E501
        else:
            (data) = self.action_get_job_log_with_http_info(job_id, **kwargs)  # noqa: E501
            return data

    def action_get_job_log_with_http_info(self, job_id, **kwargs):  # noqa: E501
        """Get job log by job id  # noqa: E501

        Get job log by job id, it is only used by administrator  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.action_get_job_log_with_http_info(job_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method action_get_job_log" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if self.api_client.client_side_validation and ('job_id' not in params or
            ...
            raise ValueError("Missing the required parameter `job_id` when calling `action_get_job_log`")  # noqa: E501

        if self.api_client.client_side_validation and ('x_request_id' in params and
                                                       len(params['x_request_id']) < 1):
            raise ValueError("Invalid value for parameter `x_request_id` when calling `action_get_job_log`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/jobservice/jobs/{job_id}/log', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
