...
class PermissionsApi(object):
    ...
    def get_permissions(self, **kwargs):  # noqa: E501
        """Get system or project level permissions info.  # noqa: E501

        This endpoint is for retrieving resource and action info that only provides for admin user(system admin and project admin).   # noqa: E501
    ...
    def get_permissions_with_http_info(self, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and ('x_request_id' in params and
            ...
            raise ValueError("Invalid value for parameter `x_request_id` when calling `get_permissions`, length must be greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
