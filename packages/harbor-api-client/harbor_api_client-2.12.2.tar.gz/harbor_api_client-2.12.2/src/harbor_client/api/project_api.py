...
class ProjectApi(object):
    ...
    def list_artifacts_of_project(self, project_name_or_id, **kwargs):  # noqa: E501
        """List artifacts  # noqa: E501

        List artifacts of the specified project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_artifacts_of_project(project_name_or_id, async_req=True)
        >>> result = thread.get()
        ...
        :param bool with_sbom_overview: Specify whether the SBOM overview is included in returning artifacts, when this option is true, the SBOM overview will be included in the response
        ...
        :param bool latest_in_repository: Specify whether only the latest pushed artifact of each repository is included inside the returning artifacts. Only works when either artifact_type or media_type is included in the query.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.list_artifacts_of_project_with_http_info(project_name_or_id, **kwargs)  # noqa: E501
        else:
            (data) = self.list_artifacts_of_project_with_http_info(project_name_or_id, **kwargs)  # noqa: E501
            return data

    def list_artifacts_of_project_with_http_info(self, project_name_or_id, **kwargs):  # noqa: E501
        """List artifacts  # noqa: E501

        List artifacts of the specified project  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_artifacts_of_project_with_http_info(project_name_or_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_name_or_id', 'x_request_id', 'x_is_resource_name', 'q', 'sort', 'page', 'page_size', 'x_accept_vulnerabilities', 'with_tag', 'with_label', 'with_scan_overview', 'with_sbom_overview', 'with_immutable_status', 'with_accessory', 'latest_in_repository']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method list_artifacts_of_project" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_name_or_id' is set
        if self.api_client.client_side_validation and ('project_name_or_id' not in params or
                                                       params['project_name_or_id'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `project_name_or_id` when calling `list_artifacts_of_project`")  # noqa: E501

        if self.api_client.client_side_validation and ('x_request_id' in params and
                                                       len(params['x_request_id']) < 1):
            raise ValueError("Invalid value for parameter `x_request_id` when calling `list_artifacts_of_project`, length must be greater than or equal to `1`")  # noqa: E501
        if self.api_client.client_side_validation and ('page_size' in params and params['page_size'] > 100):  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `list_artifacts_of_project`, must be a value less than or equal to `100`")  # noqa: E501
        collection_formats = {}
        ...
        if 'with_sbom_overview' in params:
            query_params.append(('with_sbom_overview', params['with_sbom_overview']))  # noqa: E501
        ...
        if 'latest_in_repository' in params:
            query_params.append(('latest_in_repository', params['latest_in_repository']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/projects/{project_name_or_id}/artifacts', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
