...
class ScanApi(object):
    ...
    def get_report_log(self, project_name, repository_name, reference, report_id, **kwargs):  # noqa: E501
        ...
        :param str repository_name: The name of the repository. If it contains slash, encode it twice over with URL encoding. e.g. a/b -> a%2Fb -> a%252Fb (required)
    ...
    def scan_artifact_with_http_info(self, project_name, repository_name, reference, **kwargs):  # noqa: E501
        ...
        all_params = ['project_name', 'repository_name', 'reference', 'x_request_id', 'scan_type']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def stop_scan_artifact(self, project_name, repository_name, reference, scan_type, **kwargs):  # noqa: E501
        """Cancelling a scan job for a particular artifact  # noqa: E501

        Cancelling a scan job for a particular artifact  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stop_scan_artifact(project_name, repository_name, reference, scan_type, async_req=True)
        >>> result = thread.get()
        ...
        :param str repository_name: The name of the repository. If it contains slash, encode it twice over with URL encoding. e.g. a/b -> a%2Fb -> a%252Fb (required)
        :param str reference: The reference of the artifact, can be digest or tag (required)
        :param ScanType scan_type: The scan type: Vulnerabilities, SBOM (required)
        :param str x_request_id: An unique ID for the request
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.stop_scan_artifact_with_http_info(project_name, repository_name, reference, scan_type, **kwargs)  # noqa: E501
        else:
            (data) = self.stop_scan_artifact_with_http_info(project_name, repository_name, reference, scan_type, **kwargs)  # noqa: E501
            return data

    def stop_scan_artifact_with_http_info(self, project_name, repository_name, reference, scan_type, **kwargs):  # noqa: E501
        """Cancelling a scan job for a particular artifact  # noqa: E501

        Cancelling a scan job for a particular artifact  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.stop_scan_artifact_with_http_info(project_name, repository_name, reference, scan_type, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['project_name', 'repository_name', 'reference', 'scan_type', 'x_request_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('scan_type' not in params or
                                                       params['scan_type'] is None):  # noqa: E501
            raise ValueError("Missing the required parameter `scan_type` when calling `stop_scan_artifact`")  # noqa: E501
