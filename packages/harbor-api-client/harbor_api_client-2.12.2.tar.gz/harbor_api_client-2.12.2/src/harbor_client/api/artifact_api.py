...
class ArtifactApi(object):
    ...
    def get_artifact(self, project_name, repository_name, reference, **kwargs):  # noqa: E501
        ...
        :param bool with_sbom_overview: Specify whether the SBOM overview is included in returning artifact, when this option is true, the SBOM overview will be included in the response
    ...
    def get_artifact_with_http_info(self, project_name, repository_name, reference, **kwargs):  # noqa: E501
        ...
        all_params = ['project_name', 'repository_name', 'reference', 'x_request_id', 'page', 'page_size', 'x_accept_vulnerabilities', 'with_tag', 'with_label', 'with_scan_overview', 'with_sbom_overview', 'with_accessory', 'with_signature', 'with_immutable_status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def list_artifacts_with_http_info(self, project_name, repository_name, **kwargs):  # noqa: E501
        ...
        all_params = ['project_name', 'repository_name', 'x_request_id', 'q', 'sort', 'page', 'page_size', 'x_accept_vulnerabilities', 'with_tag', 'with_label', 'with_scan_overview', 'with_sbom_overview', 'with_signature', 'with_immutable_status', 'with_accessory']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
