...
class ScannerRegistration(object):
    ...
    def __init__(self, uuid=None, name=None, description=None, url=None, disabled=False, is_default=False, auth='', access_credential=None, skip_cert_verify=False, use_internal_addr=False, create_time=None, update_time=None, adapter=None, vendor=None, version=None, health='', capabilities=None, _configuration=None):  # noqa: E501
    ...
    def capabilities(self):
        """Gets the capabilities of this ScannerRegistration.  # noqa: E501

        Indicates the capabilities of the scanner, e.g. support_vulnerability or support_sbom.  # noqa: E501

        :return: The capabilities of this ScannerRegistration.  # noqa: E501
    ...
    def capabilities(self, capabilities):
        """Sets the capabilities of this ScannerRegistration.

        Indicates the capabilities of the scanner, e.g. support_vulnerability or support_sbom.  # noqa: E501

        :param capabilities: The capabilities of this ScannerRegistration.  # noqa: E501
