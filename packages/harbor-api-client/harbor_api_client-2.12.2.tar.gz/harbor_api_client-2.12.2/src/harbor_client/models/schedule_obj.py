...
class ScheduleObj(object):
    ...
    def type(self):
        ...
        The schedule type. The valid values are 'Hourly', 'Daily', 'Weekly', 'Custom', 'Manual', 'None' and 'Schedule'. 'Manual' means to trigger it right away, 'Schedule' means to trigger it by a specified cron schedule and 'None' means to cancel the schedule.   # noqa: E501
    ...
    def type(self, type):
        ...
        :type: str
        """
        allowed_values = ["Hourly", "Daily", "Weekly", "Custom", "Manual", "None", "Schedule"]  # noqa: E501
