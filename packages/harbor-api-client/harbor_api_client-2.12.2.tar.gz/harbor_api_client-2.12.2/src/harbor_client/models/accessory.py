...
class Accessory(object):
    ...
    attribute_map = {
        ...
        'subject_artifact_repo': 'subject_artifact_repo',
        'size': 'size',
        'digest': 'digest',
        'type': 'type',
        'icon': 'icon',
    ...
    def __init__(self, id=None, artifact_id=None, subject_artifact_id=None, subject_artifact_digest=None, subject_artifact_repo=None, size=None, digest=None, type=None, icon=None, creation_time=None, _configuration=None):  # noqa: E501
        ...
        self._subject_artifact_digest = None
        self._subject_artifact_repo = None
        self._size = None
        self._digest = None
        self._type = None
        self._icon = None
        ...
        if subject_artifact_digest is not None:
            self.subject_artifact_digest = subject_artifact_digest
        if subject_artifact_repo is not None:
            self.subject_artifact_repo = subject_artifact_repo
        if size is not None:
            self.size = size
    ...
    def subject_artifact_id(self):
        ...
        Going to be deprecated, use repo and digest for insteand. The subject artifact id of the accessory.  # noqa: E501
    ...
    @property
    def subject_artifact_digest(self):
        """Gets the subject_artifact_digest of this Accessory.  # noqa: E501

        The subject artifact digest of the accessory  # noqa: E501

        :return: The subject_artifact_digest of this Accessory.  # noqa: E501
        :rtype: str
        """
        return self._subject_artifact_digest

    @subject_artifact_digest.setter
    def subject_artifact_digest(self, subject_artifact_digest):
        """Sets the subject_artifact_digest of this Accessory.

        The subject artifact digest of the accessory  # noqa: E501

        :param subject_artifact_digest: The subject_artifact_digest of this Accessory.  # noqa: E501
        :type: str
        """

        self._subject_artifact_digest = subject_artifact_digest

    @property
    def subject_artifact_repo(self):
        """Gets the subject_artifact_repo of this Accessory.  # noqa: E501

        The subject artifact repository name of the accessory  # noqa: E501

        :return: The subject_artifact_repo of this Accessory.  # noqa: E501
        :rtype: str
        """
        return self._subject_artifact_repo

    @subject_artifact_repo.setter
    def subject_artifact_repo(self, subject_artifact_repo):
        """Sets the subject_artifact_repo of this Accessory.

        The subject artifact repository name of the accessory  # noqa: E501

        :param subject_artifact_repo: The subject_artifact_repo of this Accessory.  # noqa: E501
        :type: str
        """

        self._subject_artifact_repo = subject_artifact_repo
