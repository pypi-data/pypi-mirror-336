...
class Container(object):
    ...
    def __init__(self, namespace=None, name=None, container_id=None, latest_version=None, versions=None, is_scratchpad=None, is_demo=False, local_vars_configuration=None):  # noqa: E501
