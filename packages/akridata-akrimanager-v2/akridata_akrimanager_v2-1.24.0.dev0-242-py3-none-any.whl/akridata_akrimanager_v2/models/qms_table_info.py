...
class QMSTableInfo(object):
    ...
    def __init__(self, table_name=None, abs_table_name=None, table_type=None, pipeline_id=None, catalog_name=None, schema_name=None, alias_name=None, join_conditions=None, local_vars_configuration=None):  # noqa: E501
