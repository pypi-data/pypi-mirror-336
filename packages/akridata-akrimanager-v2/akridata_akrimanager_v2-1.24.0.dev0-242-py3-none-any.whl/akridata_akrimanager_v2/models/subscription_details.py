...
class SubscriptionDetails(object):
    ...
    def __init__(self, org_id=None, status=None, plan=None, num_users=None, valid_till=None, cancellation_scheduled_at=None, deactivated_at=None, deleted=False, local_vars_configuration=None):  # noqa: E501
