...
class MakeQueryViewRequest(object):
    ...
    def __init__(self, projections=None, where_conditions=None, where_conditions_post=None, order_by=None, sequence_params=None, resultset_params=None, coreset_params=None, limit=1000, query_type=None, pe_cat_only_on_file_path=False, rate_limit_pe=True, view_id=None, view_name=None, udf_validation_mode=None, local_vars_configuration=None):  # noqa: E501
