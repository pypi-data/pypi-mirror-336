...
class CreateCatalogTable(object):
    ...
    def __init__(self, dataset_id=None, pipeline_id=None, catalog_table=None, schema_provider=None, import_data_format=None, udts_info=None, file_type=None, task_type=None, add_identifier_column=False, import_feature_details=None, table_type=None, is_internal=False, add_import_ts=False, local_vars_configuration=None):  # noqa: E501
