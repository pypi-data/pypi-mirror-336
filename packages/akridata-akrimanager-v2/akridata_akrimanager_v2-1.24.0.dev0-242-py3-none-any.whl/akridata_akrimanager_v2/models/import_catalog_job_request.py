...
class ImportCatalogJobRequest(object):
    ...
    def __init__(self, table_name=None, description=None, dataset_id=None, file_list=None, create_table=False, import_feature_details=None, notify=False, data_format=None, udts_info=None, file_type=None, task_type=None, import_identifier=None, create_update_view_details=None, callback_context=None, local_vars_configuration=None):  # noqa: E501
