    ...
    BaseTrain.name():
        [
            Image(kind=Accelerator.NVIDIA,
                  name="iregistry.baidu-int.com/windmill-public/train/pytorch:20250326_1742965552583"),
    ...
    def __call__(self,
        ...
        train = ContainerStep(name=Train.name(),
                              ...
                              command=f'cd /root && '
                                      ...
                                      f'python3 -m gaea_operator.nodes.train.mllm_sft '
...
class Eval(BaseEval):
    ...
    def __call__(self,
        ...
        eval = ContainerStep(name=Eval.name(),
                             ...
                             command=f'cd /root && '
                                     f'package_path=$(python3 -c "import site; print(site.getsitepackages()[0])") && '
                                     f'python3 -m gaea_operator.nodes.eval.mllm_sft '
...
if __name__ == "__main__":
    ...
    ppl.compile(save_path="mllm_sft_pipeline.yaml")
