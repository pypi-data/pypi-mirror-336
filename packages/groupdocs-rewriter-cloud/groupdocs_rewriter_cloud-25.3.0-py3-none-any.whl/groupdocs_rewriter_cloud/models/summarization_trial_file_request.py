...
class SummarizationTrialFileRequest(BaseModel):
    """
    ...
    min_length: Optional[StrictInt] = Field(default=None, description="Minimum length of the target text", alias="minLength")
    format: Optional[TrialSupportedFormats] = None
    __properties: ClassVar[List[str]] = ["language", "url", "origin", "originalName", "savingMode", "summarizationDegree", "minLength", "format"]
