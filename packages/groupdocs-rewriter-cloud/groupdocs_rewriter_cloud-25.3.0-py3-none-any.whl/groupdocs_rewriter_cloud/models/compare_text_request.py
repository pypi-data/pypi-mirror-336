...
class CompareTextRequest(BaseModel):
    ...
    alternative_text: Optional[StrictStr] = Field(default=None, description="Modified text", alias="alternativeText")
    origin: Optional[StrictStr] = Field(default=None, description="Information about SDK user, like a User-Agent")
    __properties: ClassVar[List[str]] = ["originalText", "alternativeText", "origin"]
