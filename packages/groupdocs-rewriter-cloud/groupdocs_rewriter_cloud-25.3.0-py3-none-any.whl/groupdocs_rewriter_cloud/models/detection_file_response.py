...
class DetectionFileResponse(BaseModel):
    ...
    is_paraphrased_or_generated: Optional[StrictBool] = Field(default=None, alias="isParaphrasedOrGenerated")
    per_paragraph_probability: Optional[List[Union[StrictFloat, StrictInt]]] = Field(default=None, alias="perParagraphProbability")
    __properties: ClassVar[List[str]] = ["status", "message", "probability", "isParaphrasedOrGenerated", "perParagraphProbability"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isParaphrasedOrGenerated": obj.get("isParaphrasedOrGenerated"),
            "perParagraphProbability": obj.get("perParagraphProbability")
        })
        return _obj
