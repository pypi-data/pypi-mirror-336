...
class GenerateResponse(BaseModel):
    ...
    generate_result: Optional[StrictStr] = Field(default=None, alias="generateResult")
    __properties: ClassVar[List[str]] = ["status", "message", "generateResult"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if generate_result (nullable) is None
        # and model_fields_set contains the field
        if self.generate_result is None and "generate_result" in self.model_fields_set:
            _dict['generateResult'] = None
