...
class CloudTextRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["language", "handler", "text", "action", "jobofferurl", "cvurl", "coverletterurl", "texts", "suggestions", "diversity", "tokenize", "origin", "originaltext", "alternativetext", "requestId", "userEmail"]
