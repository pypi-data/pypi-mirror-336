...
class DetectionTrialFileRequest(BaseModel):
    ...
    min_length: Optional[StrictInt] = Field(default=None, description="Minimum length of the source text", alias="minLength")
    format: Optional[TrialSupportedFormats] = None
    __properties: ClassVar[List[str]] = ["language", "url", "origin", "originalName", "savingMode", "minLength", "format"]
