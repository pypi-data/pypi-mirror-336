...
class DetectionOcrRequest(BaseModel):
    """
    DetectionOcrRequest
    """ # noqa: E501
    ...
    min_length: Optional[StrictInt] = Field(default=None, description="Minimum length of the original text to detect", alias="minLength")
    __properties: ClassVar[List[str]] = ["language", "url", "origin", "originalName", "savingMode", "format", "minLength"]
