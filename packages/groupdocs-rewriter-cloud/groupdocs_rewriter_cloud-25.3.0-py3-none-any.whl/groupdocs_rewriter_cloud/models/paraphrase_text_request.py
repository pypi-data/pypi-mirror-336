...
class ParaphraseTextRequest(BaseModel):
    ...
    suggestions: Optional[StrictStr] = Field(default=None, description="Number of variants for rewriting")
    diversity_degree: Optional[DegreeEnum] = Field(default=None, alias="diversityDegree")
    tokenize: Optional[StrictBool] = Field(default=None, description="Determines whether to return a tokens list")
    __properties: ClassVar[List[str]] = ["language", "text", "texts", "origin", "suggestions", "diversityDegree", "tokenize"]
    ...
    def suggestions_validate_enum(cls, value):
        ...
        if value not in set(['One', 'Two', 'Three']):
