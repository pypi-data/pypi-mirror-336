...
class SummarizationOcrRequest(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["language", "url", "origin", "originalName", "savingMode", "outputFormat", "summarizationDegree", "format", "minLength"]
