...
class CommentAnalyzer:
    ...
    def csvPredict(self, input_csv, output_path, text_column='body'):
        """
        ...
        Parameters:
            ...
            text_column (str, optional): Name of column containing comments. Defaults to 'body'.
        """
        try:
            # Read input CSV
            ...
            if text_column not in df.columns:
                # If only one column exists, use it regardless of name
                if len(df.columns) == 1:
            ...
            df['sentiment'] = df[text_column].progress_apply(self.predict)
