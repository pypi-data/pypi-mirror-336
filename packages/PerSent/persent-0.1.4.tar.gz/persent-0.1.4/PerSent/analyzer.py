...
class AdvancedPersianSentimentAnalyzer:
    ...
    def _emotion_analysis(self, text):
        """تحلیل احساسات پیشرفته با مدیریت خطا"""
        try:
            ...
            return {
                ...
                for item in results
                if item['label'] in ['ترس', 'تعجب', 'خشم', 'تحقیر', 'شادی', 'غم', 'انزجار']
            }
        except Exception as e:
            print(f"Error in emotion analysis: {str(e)}")
            return {label: 0.0 for label in ['ترس', 'تعجب', 'خشم', 'تحقیر', 'شادی', 'غم', 'انزجار']}
    ...
    def predict(self, text, mode=0, threshold=0.3):
        """
