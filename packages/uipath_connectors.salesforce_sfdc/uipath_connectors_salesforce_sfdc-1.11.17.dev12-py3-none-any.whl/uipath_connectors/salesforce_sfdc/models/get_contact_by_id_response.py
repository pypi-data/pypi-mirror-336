...
class GetContactByIDResponse(BaseModel):
    ...
    Attributes:
        ...
        last_name (Optional[str]): Last name of the contact Example: last name test create.
        ...
        name (Optional[str]):  Example: Rose Gonzalez.
        owner_id (Optional[str]): Type upto 3 characters of the name to select the contact owner or pass owner ID
                Example: testId.
    ...
    @classmethod
    def from_dict(cls: Type["GetContactByIDResponse"], src_dict: Dict[str, Any]):
