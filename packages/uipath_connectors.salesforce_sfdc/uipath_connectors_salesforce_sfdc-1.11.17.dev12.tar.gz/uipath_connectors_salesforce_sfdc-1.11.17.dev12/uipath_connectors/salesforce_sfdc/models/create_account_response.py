...
class CreateAccountResponse(BaseModel):
    """
    Attributes:
        name (str): Name of the account Example: test account create.
        ...
        id (Optional[str]): ID of the account that gets created in Salesforce Example: 0014x00001LErO3AAL.
    ...
    @classmethod
    def from_dict(cls: Type["CreateAccountResponse"], src_dict: Dict[str, Any]):
