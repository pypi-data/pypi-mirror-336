...
def _get_kwargs(
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/curated_upload_attachments",
    }
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = UploadAttachmentResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, UploadAttachmentResponse]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, UploadAttachmentResponse]
    """
