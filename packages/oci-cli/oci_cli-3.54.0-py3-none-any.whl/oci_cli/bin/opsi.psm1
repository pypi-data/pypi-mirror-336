...
function GetOciCommandsToLongParams_opsi() {
    $ociCommandsToLongParams = @{
        ...
        'opsi operations-insights-warehouses create' = 'compartment-id cpu-allocated defined-tags display-name freeform-tags from-json help max-wait-seconds storage-allocated-in-gbs wait-for-state wait-interval-seconds'
        ...
        'opsi operations-insights-warehouses update' = 'cpu-allocated defined-tags display-name force freeform-tags from-json help if-match max-wait-seconds operations-insights-warehouse-id storage-allocated-in-gbs wait-for-state wait-interval-seconds'
