...
async def test_authenticate_request_success(auth_proxy):
    ...
    authenticated, auth_headers = await auth_proxy._authenticate_request(
...
async def test_authenticate_request_multiple_plugins_any_mode(auth_proxy):
    ...
    auth_proxy.auth_plugins["mock-fail"] = MagicMock()
    auth_proxy.auth_plugins["mock-fail"].authenticate.return_value = False
    auth_proxy.auth_plugins["mock-fail"].get_auth_headers.return_value = {}
