class TestnetConstants:
    ...
    # Binance Endpoints
    class Binance:
        RESTAPI_SPOT_URL = "https://testnet.binance.vision"
        RESTAPI_FUTURES_URL = "https://testnet.binancefuture.com"
    ...
    # Bybit Endpoints
    class Bybit:
        RESTAPI_SPOT_URL = "https://api-testnet.bybit.com"
        RESTAPI_FUTURES_URL = "https://api-testnet.bybit.com"
        WEBSOCKET_SPOT_URL = "wss://stream-testnet.bybit.com/v5/public/spot"
        WEBSOCKET_FUTURES_URL = "wss://stream-testnet.bybit.com/v5/public/futures"
        PUBLIC_CHANNELS = {
            "ticker": "tickers",
            "trade": "publicTrade",
