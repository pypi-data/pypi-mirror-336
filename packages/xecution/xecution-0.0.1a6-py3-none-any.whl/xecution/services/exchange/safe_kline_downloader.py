...
class SafeKlineDownloader:
    ...
    async def download(self, start_time: int, total_needed: int):
        # 預先建立所有請求參數
    ...
    async def download_reverse(self, total_needed: int = 1000):
        """
        ...
        logging.info(f"Retrieved {len(total_data)} {self.symbol} historical data")
        return total_data
