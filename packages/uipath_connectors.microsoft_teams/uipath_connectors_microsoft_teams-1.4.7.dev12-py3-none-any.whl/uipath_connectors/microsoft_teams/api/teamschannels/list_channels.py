    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListChannels.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListChannels"]]]:
    return Response(
    ...
    *,
    ...
    Args:
        team_id (str): Type the name to retrieve the team from the dropdown or type a custom team
            ...
            activity
        expand (Optional[str]): Retrieves related resources.
        where (Optional[str]): The CEQL search expression
        filter_ (Optional[str]): Odata filter
        select (Optional[str]): Provide the comma-separated list of fields that needs to be
            specifically retrieved in the response. You can specify a subset or a superset of the
            default properties to be retrieved in the response
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, list['ListChannels']]
    """
