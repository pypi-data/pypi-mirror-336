...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/normalised-teams/{team_id}/channels/{channel_id}/messages/{message_id}/replies-v2/drive/item".format(
            team_id=team_id,
...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = ReplyToChannelMessageResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, ReplyToChannelMessageResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Reply to Channel Message
     ...
     Reply to a message in a team channel with an option to attach SharePoint files
    ...
    Args:
        ...
        message_id (str): TThe ID of the message to send a reply to in teams. This can also be
            retrieved from output of “Send Channel Message” activity
        body (ReplyToChannelMessageBody):
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, ReplyToChannelMessageResponse]
    """
