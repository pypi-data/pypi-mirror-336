...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = CreateOneOnOneChatResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[CreateOneOnOneChatResponse, DefaultError]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Get Individual Chat
     ...
     Retrieve the individual chat ID for use in 'List All Chat Messages' activity
...
def sync(
    *,
    ...
    Returns:
        Union[CreateOneOnOneChatResponse, DefaultError]
    """
