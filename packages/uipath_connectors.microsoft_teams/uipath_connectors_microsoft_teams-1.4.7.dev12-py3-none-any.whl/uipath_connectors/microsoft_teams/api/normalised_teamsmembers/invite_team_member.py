...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/normalised-teams/{team_id}/members".format(
            team_id=team_id,
        ),
    }
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, InviteTeamMemberResponse]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    """Invite User to Team
     ...
     Add a guest Microsoft account user or your organization’s Azure AD user to the team
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, InviteTeamMemberResponse]
    """
