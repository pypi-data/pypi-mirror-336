...
class CreateIndividualChatMessageBody(BaseModel):
    """
    Attributes:
        body (CreateIndividualChatMessageRequest):
        file (Optional[File]): Image attachment to be uploaded
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "CreateIndividualChatMessageRequest" = Field(alias="body")
    ...
    @classmethod
    def from_dict(
        cls: Type["CreateIndividualChatMessageBody"], src_dict: Dict[str, Any]
    ):
