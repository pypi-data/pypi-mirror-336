...
class ListChannelMessagesFromUser(BaseModel):
    """
    Attributes:
        display_name (Optional[str]):  Example: UiPath Developer.
        id (Optional[str]):  Example: f7ef94d2-c232-4bf8-a216-ff591ad0dd3a.
        odata_type (Optional[str]):  Example: #microsoft.graph.teamworkUserIdentity.
    ...
    @classmethod
    def from_dict(cls: Type["ListChannelMessagesFromUser"], src_dict: Dict[str, Any]):
