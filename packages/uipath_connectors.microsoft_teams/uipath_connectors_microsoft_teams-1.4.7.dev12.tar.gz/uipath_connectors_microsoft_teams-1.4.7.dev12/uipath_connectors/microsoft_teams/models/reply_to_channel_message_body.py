...
class ReplyToChannelMessageBody(BaseModel):
    """
    Attributes:
        body (ReplyToChannelMessageRequest):
        file (Optional[File]): Image attachment to be uploaded
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "ReplyToChannelMessageRequest" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["ReplyToChannelMessageBody"], src_dict: Dict[str, Any]):
