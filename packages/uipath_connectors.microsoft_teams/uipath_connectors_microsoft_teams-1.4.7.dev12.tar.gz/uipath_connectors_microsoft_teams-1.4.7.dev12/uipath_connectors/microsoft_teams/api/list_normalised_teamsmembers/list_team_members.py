...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/list-normalised-teams/{team_id}/members".format(
            team_id=team_id,
        ),
        "params": params,
    }
    ...
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        ...
        for response_200_item_data in _response_200:
            response_200_item = ListTeamMembers.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, list["ListTeamMembers"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        select (Optional[str]): Filters properties
        next_page (Optional[str]): The page number of resources to retrieve
        where (Optional[str]): Add a filter using fields such as “email”, “displayName” etc. For
            example, “email = 'admin@M365x987948.OnMicrosoft.com'”
...
def sync(
    ...
    *,
    ...
    Returns:
        Union[DefaultError, list['ListTeamMembers']]
    """
