...
def _parse_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SendMessageToChannelAsBotResponse.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[DefaultError, SendMessageToChannelAsBotResponse]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    """Send Bot Channel Message
     ...
     Send bot message to a channel. Works only if the bot was 'included' while creating connection
...
def sync(
    *,
    ...
    Returns:
        Union[DefaultError, SendMessageToChannelAsBotResponse]
    """
