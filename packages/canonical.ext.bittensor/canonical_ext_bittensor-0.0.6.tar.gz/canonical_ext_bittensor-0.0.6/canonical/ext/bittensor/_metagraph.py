...
from .models import MinerNeuron
from .models import NeuronList
from .models import ValidatorNeuron
...
class Metagraph(PollingExternalState):
    ...
    ) -> MinerNeuron | ValidatorNeuron:
        adapter: pydantic.TypeAdapter[MinerNeuron|ValidatorNeuron] = (
            pydantic.TypeAdapter(ValidatorNeuron|MinerNeuron)
        )
