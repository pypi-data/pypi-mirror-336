...
class default__:
    ...
    def TestCreateKeyStore():
        ...
        if not(not((d_0_valueOrError0_).IsFailure())):
            raise _dafny.HaltException("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(19,21): " + _dafny.string_of(d_0_valueOrError0_))
        ...
        if not(not((d_2_valueOrError1_).IsFailure())):
            raise _dafny.HaltException("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(20,21): " + _dafny.string_of(d_2_valueOrError1_))
        ...
        if not(not((d_6_valueOrError2_).IsFailure())):
            raise _dafny.HaltException("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(33,20): " + _dafny.string_of(d_6_valueOrError2_))
        d_7_keyStore_: KeyStore.KeyStoreClient
        d_7_keyStore_ = (d_6_valueOrError2_).Extract()
        d_8_valueOrError3_: Wrappers.Result = None
        out3_: Wrappers.Result
        out3_ = (d_7_keyStore_).CreateKeyStore(AwsCryptographyKeyStoreTypes.CreateKeyStoreInput_CreateKeyStoreInput())
        d_8_valueOrError3_ = out3_
        if not(not((d_8_valueOrError3_).IsFailure())):
            raise _dafny.HaltException("dafny/AwsCryptographyKeyStore/test/TestCreateKeyStore.dfy(36,23): " + _dafny.string_of(d_8_valueOrError3_))
        d_9_keyStoreArn_: AwsCryptographyKeyStoreTypes.CreateKeyStoreOutput
        d_9_keyStoreArn_ = (d_8_valueOrError3_).Extract()
        if not((AwsArnParsing.default__.ParseAmazonDynamodbTableName((d_9_keyStoreArn_).tableArn)).is_Success):
        ...
        if not(((AwsArnParsing.default__.ParseAmazonDynamodbTableName((d_9_keyStoreArn_).tableArn)).value) == (Fixtures.default__.branchKeyStoreName)):
