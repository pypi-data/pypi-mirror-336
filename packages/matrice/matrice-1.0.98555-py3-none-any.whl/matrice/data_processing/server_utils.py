...
def get_number_of_partition_batches(
    rpc: Any, dataset_id: str, partition: int, request_batch_size: int = 1
) -> int:
...
def get_partition_items(
    ...
    number_of_partition_pages = get_number_of_partition_batches(rpc, dataset_id, partition, request_batch_size)
...
def get_number_of_dataset_batches(
    rpc: Any, dataset_id: str, dataset_version: str, request_batch_size: int = 1
) -> int:
...
def get_dataset_items(
    ...
    number_of_dataset_pages = get_number_of_dataset_batches(rpc, dataset_id, dataset_version, request_batch_size)
