...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mediatailor)](https://pypistats.org/packages/mypy-boto3-mediatailor)
...
`mypy-boto3-mediatailor` dependency in production. However, there is an issue
