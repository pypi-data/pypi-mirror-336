...
@mcp.tool(description="Use this to send a short audio message to the user concisely (one 10-15 word sentence) summarizing what you've done and why. Use this tool after _every_ time you generated a code snippet or ran a command as well as when you give control back to the user.")
