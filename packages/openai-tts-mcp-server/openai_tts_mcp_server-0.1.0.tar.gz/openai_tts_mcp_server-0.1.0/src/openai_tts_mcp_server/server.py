...
@mcp.tool(description="Use this to send a short audio message to the user concisely (one 10-15 word sentence) summarizing what you've done and why. Use this tool every time you generated a code snippet or ran a command. Moreover, you should never give control back to the user without having called this tool. For example, \"Added confetti animation to make it more fun\".")
def summarize_v6(text: str) -> dict[str, str]:
    try:
