...
class SaveAsymEgressKey(object):
    """
    ...
    def __init__(self, client_reference_information=None, client_request_action=None, key_information=None):
        """
        SaveAsymEgressKey - a model defined in Swagger
        """
    ...
    def client_request_action(self):
        """
        Gets the client_request_action of this SaveAsymEgressKey.
        Client request action. 

        :return: The client_request_action of this SaveAsymEgressKey.
        :rtype: str
        """
    ...
    def client_request_action(self, client_request_action):
        """
        Sets the client_request_action of this SaveAsymEgressKey.
        Client request action. 
    ...
    def key_information(self):
        """
        Gets the key_information of this SaveAsymEgressKey.

        :return: The key_information of this SaveAsymEgressKey.
    ...
    def key_information(self, key_information):
        """
        Sets the key_information of this SaveAsymEgressKey.
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SaveAsymEgressKey):
            return False
