...
def llm_tracing(provider: str):
    ...
    def decorator(func):
        ...
        async def wrapper(
            self, model_name, system_prompt, user_prompt, user_query, **params
        ):
            ...
            try:
                ...
                tracing_service.add_llm_span(
                    span_name="groq", data_to_log=trace_data
                )
                ...
                tracing_service.add_error_span(
                    span_name="Error.LLMCall.Operation", error_data=error_trace
                )
                raise e
