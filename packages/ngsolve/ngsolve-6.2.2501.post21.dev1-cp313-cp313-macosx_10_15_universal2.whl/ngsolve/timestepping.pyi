...
class CrankNicolson:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', 'time', '_lin_solver_cls', 'bfmstar', 'gfu_old', '_lin_solver_args', 'dt')
...
class Newmark:
    ...
    __static_attributes__: typing.ClassVar[tuple] = ('c', 'time', '_lin_solver_cls', 'gfv_old', 'bfmstar', 'gfu_old', 'gfa_old', '_lin_solver_args', 'dt')
