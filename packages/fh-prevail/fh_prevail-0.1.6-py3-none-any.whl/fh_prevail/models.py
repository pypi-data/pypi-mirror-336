...
class UR2CUTE(BaseEstimator):
    ...
    def fit(self, df, target_col):
        ...
        self.target_col_ = target_col  # Store the target column name for later use in predict
        ...
        # Option to set threshold automatically based on training target zeros
    ...
    def predict(self, df):
        ...
        """
        # Get the target column name that was stored during fit
