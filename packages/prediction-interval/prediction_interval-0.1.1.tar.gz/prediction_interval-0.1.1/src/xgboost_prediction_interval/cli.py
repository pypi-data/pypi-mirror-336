...
def cli(args: Optional[Sequence[str]] = None) -> None:
    p = ArgumentParser(description="Create Prediction Intervals for XGBoost models using Quantile Regression and Conformalized Quantile Regression", conflict_handler="resolve")
    p.add_argument(
        "-V",
        "--version",
        action="version",
