"""
    Tests to display a new container wit hthe data quality metrics
"""
from examples.synthesizers.multitable.anonymizer import config
...
def get_quality_scores(config: Settings, summary: BaseDescription):
    ...
    for score, values in scores.items():
        ...
        scores_info.append({'name': score, 'submetrics': submetrics})
