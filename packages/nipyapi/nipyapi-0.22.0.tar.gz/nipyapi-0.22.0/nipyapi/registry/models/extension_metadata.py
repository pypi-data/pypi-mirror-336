...
class ExtensionMetadata(object):
    ...
    def __init__(self, link=None, name=None, display_name=None, type=None, description=None, deprecation_notice=None, tags=None, restricted=None, provided_service_apis=None, bundle_info=None, has_additional_details=None, link_docs=None):
        """
