...
class RemoteProcessGroupsApi(object):
    ...
    def update_remote_process_group_input_port_run_status(self, id, port_id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_input_port_run_status(id, port_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_remote_process_group_input_port_run_status_with_http_info(id, port_id, body, **kwargs)
        else:
            (data) = self.update_remote_process_group_input_port_run_status_with_http_info(id, port_id, body, **kwargs)
            return data

    def update_remote_process_group_input_port_run_status_with_http_info(self, id, port_id, body, **kwargs):
        """
        Updates run status of a remote port
        Note: This endpoint is subject to change as NiFi and it's REST API evolve.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_input_port_run_status_with_http_info(id, port_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_remote_process_group_input_port_run_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_remote_process_group_input_port_run_status`")
        # verify the required parameter 'port_id' is set
        if ('port_id' not in params) or (params['port_id'] is None):
            raise ValueError("Missing the required parameter `port_id` when calling `update_remote_process_group_input_port_run_status`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_remote_process_group_input_port_run_status`")
    ...
    def update_remote_process_group_output_port_run_status(self, id, port_id, body, **kwargs):
        """
        Updates run status of a remote port
        Note: This endpoint is subject to change as NiFi and it's REST API evolve.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_output_port_run_status(id, port_id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_remote_process_group_output_port_run_status_with_http_info(id, port_id, body, **kwargs)
        else:
            (data) = self.update_remote_process_group_output_port_run_status_with_http_info(id, port_id, body, **kwargs)
            return data

    def update_remote_process_group_output_port_run_status_with_http_info(self, id, port_id, body, **kwargs):
        """
        Updates run status of a remote port
        Note: This endpoint is subject to change as NiFi and it's REST API evolve.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_output_port_run_status_with_http_info(id, port_id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_remote_process_group_output_port_run_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        if ('id' not in params) or (params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `update_remote_process_group_output_port_run_status`")
        # verify the required parameter 'port_id' is set
        if ('port_id' not in params) or (params['port_id'] is None):
            raise ValueError("Missing the required parameter `port_id` when calling `update_remote_process_group_output_port_run_status`")
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_remote_process_group_output_port_run_status`")
    ...
    def update_remote_process_group_run_status(self, id, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_run_status(id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_remote_process_group_run_status_with_http_info(id, body, **kwargs)
        else:
            (data) = self.update_remote_process_group_run_status_with_http_info(id, body, **kwargs)
            return data
    ...
    def update_remote_process_group_run_status_with_http_info(self, id, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_run_status_with_http_info(id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_remote_process_group_run_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_remote_process_group_run_status`")
    ...
    def update_remote_process_group_run_statuses(self, id, body, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_run_statuses(id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_remote_process_group_run_statuses_with_http_info(id, body, **kwargs)
        else:
            (data) = self.update_remote_process_group_run_statuses_with_http_info(id, body, **kwargs)
            return data

    def update_remote_process_group_run_statuses_with_http_info(self, id, body, **kwargs):
        """
        Updates run status of all remote process groups in a process group (recursively)
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_remote_process_group_run_statuses_with_http_info(id, body, callback=callback_function)
        ...
        for key, val in iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method update_remote_process_group_run_statuses" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'id' is set
        ...
        # verify the required parameter 'body' is set
        if ('body' not in params) or (params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `update_remote_process_group_run_statuses`")
