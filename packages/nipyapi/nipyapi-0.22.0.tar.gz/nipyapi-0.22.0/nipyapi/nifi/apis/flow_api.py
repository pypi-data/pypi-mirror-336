...
class FlowApi(object):
    ...
    def download_reporting_task_snapshot(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.download_reporting_task_snapshot(callback=callback_function)
    ...
    def download_reporting_task_snapshot_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.download_reporting_task_snapshot_with_http_info(callback=callback_function)
    ...
    def get_reporting_task_snapshot(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_task_snapshot(callback=callback_function)
    ...
    def get_reporting_task_snapshot_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_reporting_task_snapshot_with_http_info(callback=callback_function)
    ...
    def get_version_differences(self, registry_id, bucket_id, flow_id, version_a, version_b, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_version_differences(registry_id, bucket_id, flow_id, version_a, version_b, callback=callback_function)
        ...
        :param str bucket_id: The bucket id. (required)
        :param str flow_id: The flow id. (required)
        :param int version_a: The base version. (required)
        :param int version_b: The compared version. (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_version_differences_with_http_info(registry_id, bucket_id, flow_id, version_a, version_b, **kwargs)
        else:
            (data) = self.get_version_differences_with_http_info(registry_id, bucket_id, flow_id, version_a, version_b, **kwargs)
            return data

    def get_version_differences_with_http_info(self, registry_id, bucket_id, flow_id, version_a, version_b, **kwargs):
        """
        Gets the differences between two versions of the same versioned flow, the basis of the comparison will be the first version
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_version_differences_with_http_info(registry_id, bucket_id, flow_id, version_a, version_b, callback=callback_function)
        ...
        all_params = ['registry_id', 'bucket_id', 'flow_id', 'version_a', 'version_b', 'offset', 'limit']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        # verify the required parameter 'bucket_id' is set
        if ('bucket_id' not in params) or (params['bucket_id'] is None):
            raise ValueError("Missing the required parameter `bucket_id` when calling `get_version_differences`")
        # verify the required parameter 'flow_id' is set
        if ('flow_id' not in params) or (params['flow_id'] is None):
            raise ValueError("Missing the required parameter `flow_id` when calling `get_version_differences`")
        ...
        return self.api_client.call_api('/flow/registries/{registry-id}/buckets/{bucket-id}/flows/{flow-id}/{version-a}/diff/{version-b}', 'GET',
                                        path_params,
                                        query_params,
                                        header_params,
                                        body=body_params,
