...
class ProvenanceEventsApi(object):
    ...
    def submit_replay_latest_event(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.submit_replay_latest_event(body, callback=callback_function)
    ...
    def submit_replay_latest_event_with_http_info(self, body, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.submit_replay_latest_event_with_http_info(body, callback=callback_function)
