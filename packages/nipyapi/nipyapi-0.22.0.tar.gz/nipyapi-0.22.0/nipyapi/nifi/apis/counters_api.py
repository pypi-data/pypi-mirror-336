...
class CountersApi(object):
    ...
    def get_counters(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_counters(callback=callback_function)
    ...
    def get_counters_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_counters_with_http_info(callback=callback_function)
    ...
    def update_counter(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_counter(id, callback=callback_function)
    ...
    def update_counter_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_counter_with_http_info(id, callback=callback_function)
