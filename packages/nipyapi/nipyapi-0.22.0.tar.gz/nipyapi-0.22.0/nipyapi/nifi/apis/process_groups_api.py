...
class ProcessGroupsApi(object):
    ...
    def upload_process_group(self, id, group_name, position_x, position_y, client_id, file, **kwargs):
        """
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_process_group(id, group_name, position_x, position_y, client_id, file, callback=callback_function)

        :param callback function: The callback function
            for asynchronous request. (optional)
        :param str id: The process group id. (required)
        :param str group_name: The process group name. (required)
        :param float position_x: The process group X position. (required)
        :param float position_y: The process group Y position. (required)
        :param str client_id: The client id. (required)
        :param file file: The binary content of the versioned flow definition file being uploaded. (required)
        :param bool disconnected_node_acknowledged: Acknowledges that this node is disconnected to allow for mutable requests to proceed.
        :return: ProcessGroupEntity
                 If the method is called asynchronously,
                 returns the request thread.
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.upload_process_group_with_http_info(id, group_name, position_x, position_y, client_id, file, **kwargs)
        else:
            (data) = self.upload_process_group_with_http_info(id, group_name, position_x, position_y, client_id, file, **kwargs)
            return data

    def upload_process_group_with_http_info(self, id, group_name, position_x, position_y, client_id, file, **kwargs):
        """
        Uploads a versioned flow definition and creates a process group
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.upload_process_group_with_http_info(id, group_name, position_x, position_y, client_id, file, callback=callback_function)
        ...
        all_params = ['id', 'group_name', 'position_x', 'position_y', 'client_id', 'file', 'disconnected_node_acknowledged']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('group_name' not in params) or (params['group_name'] is None):
            raise ValueError("Missing the required parameter `group_name` when calling `upload_process_group`")
        # verify the required parameter 'position_x' is set
        if ('position_x' not in params) or (params['position_x'] is None):
            raise ValueError("Missing the required parameter `position_x` when calling `upload_process_group`")
        # verify the required parameter 'position_y' is set
        if ('position_y' not in params) or (params['position_y'] is None):
            raise ValueError("Missing the required parameter `position_y` when calling `upload_process_group`")
        # verify the required parameter 'client_id' is set
        if ('client_id' not in params) or (params['client_id'] is None):
            raise ValueError("Missing the required parameter `client_id` when calling `upload_process_group`")
        # verify the required parameter 'file' is set
        if ('file' not in params) or (params['file'] is None):
            raise ValueError("Missing the required parameter `file` when calling `upload_process_group`")
    ...
    def upload_template_with_http_info(self, id, template, **kwargs):
        ...
        all_params = ['id', 'template', 'disconnected_node_acknowledged']
        all_params.append('callback')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
