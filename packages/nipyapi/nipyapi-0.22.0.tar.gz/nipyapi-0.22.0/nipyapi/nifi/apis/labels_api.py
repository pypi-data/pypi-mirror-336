...
class LabelsApi(object):
    ...
    def get_label(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_label(id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.get_label_with_http_info(id, **kwargs)
        else:
            (data) = self.get_label_with_http_info(id, **kwargs)
            return data
    ...
    def get_label_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_label_with_http_info(id, callback=callback_function)
    ...
    def remove_label(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_label(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.remove_label_with_http_info(id, **kwargs)
        else:
            (data) = self.remove_label_with_http_info(id, **kwargs)
            return data
    ...
    def remove_label_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_label_with_http_info(id, callback=callback_function)
    ...
    def update_label(self, id, body, **kwargs):
        """
        Updates a label
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_label(id, body, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.update_label_with_http_info(id, body, **kwargs)
        else:
            (data) = self.update_label_with_http_info(id, body, **kwargs)
            return data

    def update_label_with_http_info(self, id, body, **kwargs):
        """
        Updates a label
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.update_label_with_http_info(id, body, callback=callback_function)
