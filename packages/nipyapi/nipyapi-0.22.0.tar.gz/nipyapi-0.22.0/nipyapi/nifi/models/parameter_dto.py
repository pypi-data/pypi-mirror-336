...
class ParameterDTO(object):
    ...
    def __init__(self, name=None, description=None, sensitive=None, value=None, value_removed=None, provided=None, referencing_components=None, parameter_context=None, inherited=None):
        """
