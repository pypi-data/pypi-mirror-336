...
class SystemDiagnosticsApi(object):
    ...
    def get_jmx_metrics(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_jmx_metrics(callback=callback_function)
    ...
    def get_jmx_metrics_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_jmx_metrics_with_http_info(callback=callback_function)
    ...
    def get_system_diagnostics(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_system_diagnostics(callback=callback_function)
    ...
    def get_system_diagnostics_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_system_diagnostics_with_http_info(callback=callback_function)
