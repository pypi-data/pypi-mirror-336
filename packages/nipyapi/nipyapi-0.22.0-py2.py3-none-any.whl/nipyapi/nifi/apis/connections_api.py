...
class ConnectionsApi(object):
    ...
    def delete_connection(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_connection(id, callback=callback_function)
        ...
        if kwargs.get('callback'):
            return self.delete_connection_with_http_info(id, **kwargs)
        else:
            (data) = self.delete_connection_with_http_info(id, **kwargs)
            return data
    ...
    def delete_connection_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.delete_connection_with_http_info(id, callback=callback_function)
    ...
    def get_connection(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_connection(id, callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.get_connection_with_http_info(id, **kwargs)
        else:
            (data) = self.get_connection_with_http_info(id, **kwargs)
            return data
    ...
    def get_connection_with_http_info(self, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.get_connection_with_http_info(id, callback=callback_function)
