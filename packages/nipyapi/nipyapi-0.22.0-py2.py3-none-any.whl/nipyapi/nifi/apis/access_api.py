...
class AccessApi(object):
    ...
    def knox_logout(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.knox_logout(callback=callback_function)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('callback'):
            return self.knox_logout_with_http_info(**kwargs)
        else:
            (data) = self.knox_logout_with_http_info(**kwargs)
            return data

    def knox_logout_with_http_info(self, **kwargs):
        """
        Performs a logout in the Apache Knox.
        Note: This endpoint is subject to change as NiFi and it's REST API evolve.
        This method makes a synchronous HTTP request by default. To make an
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.knox_logout_with_http_info(callback=callback_function)
    ...
    def log_out_complete(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.log_out_complete(callback=callback_function)
    ...
    def log_out_complete_with_http_info(self, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.log_out_complete_with_http_info(callback=callback_function)
