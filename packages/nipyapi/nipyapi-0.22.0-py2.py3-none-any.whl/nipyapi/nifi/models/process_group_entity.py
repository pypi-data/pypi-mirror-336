...
class ProcessGroupEntity(object):
    ...
    swagger_types = {
        ...
        'process_group_update_strategy': 'str',
    ...
    attribute_map = {
        ...
        'process_group_update_strategy': 'processGroupUpdateStrategy',
    ...
    def __init__(self, revision=None, id=None, uri=None, position=None, permissions=None, bulletins=None, disconnected_node_acknowledged=None, component=None, status=None, versioned_flow_snapshot=None, running_count=None, stopped_count=None, invalid_count=None, disabled_count=None, active_remote_port_count=None, inactive_remote_port_count=None, versioned_flow_state=None, up_to_date_count=None, locally_modified_count=None, stale_count=None, locally_modified_and_stale_count=None, sync_failure_count=None, local_input_port_count=None, local_output_port_count=None, public_input_port_count=None, public_output_port_count=None, parameter_context=None, process_group_update_strategy=None, input_port_count=None, output_port_count=None):
        ...
        self._process_group_update_strategy = None
        ...
        if process_group_update_strategy is not None:
          self.process_group_update_strategy = process_group_update_strategy
    ...
    @property
    def process_group_update_strategy(self):
        """
        Gets the process_group_update_strategy of this ProcessGroupEntity.
        Determines the process group update strategy

        :return: The process_group_update_strategy of this ProcessGroupEntity.
        :rtype: str
        """
        return self._process_group_update_strategy

    @process_group_update_strategy.setter
    def process_group_update_strategy(self, process_group_update_strategy):
        """
        Sets the process_group_update_strategy of this ProcessGroupEntity.
        Determines the process group update strategy

        :param process_group_update_strategy: The process_group_update_strategy of this ProcessGroupEntity.
        :type: str
        """
        allowed_values = ["DIRECT_CHILDREN", "ALL_DESCENDANTS"]
        if process_group_update_strategy not in allowed_values:
            raise ValueError(
                "Invalid value for `process_group_update_strategy` ({0}), must be one of {1}"
                .format(process_group_update_strategy, allowed_values)
            )
