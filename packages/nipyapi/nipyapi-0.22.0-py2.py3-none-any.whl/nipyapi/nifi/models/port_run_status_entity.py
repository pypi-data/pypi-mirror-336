...
class PortRunStatusEntity(object):
    """
    ...
    def revision(self):
        ...
        :return: The revision of this PortRunStatusEntity.
        :rtype: RevisionDTO
        """
    ...
    def revision(self, revision):
        """
        Sets the revision of this PortRunStatusEntity.
        The revision for this request/response. The revision is required for any mutable flow requests and is included in all responses.

        :param revision: The revision of this PortRunStatusEntity.
        :type: RevisionDTO
        """
    ...
    def state(self):
        """
        Gets the state of this PortRunStatusEntity.
        The run status of the Port.

        :return: The state of this PortRunStatusEntity.
        :rtype: str
        """
        return self._state
    ...
    def state(self, state):
        """
        Sets the state of this PortRunStatusEntity.
        The run status of the Port.

        :param state: The state of this PortRunStatusEntity.
        :type: str
        """
    ...
    def disconnected_node_acknowledged(self):
        """
        Gets the disconnected_node_acknowledged of this PortRunStatusEntity.
        Acknowledges that this node is disconnected to allow for mutable requests to proceed.

        :return: The disconnected_node_acknowledged of this PortRunStatusEntity.
        :rtype: bool
        """
    ...
    def disconnected_node_acknowledged(self, disconnected_node_acknowledged):
        """
        Sets the disconnected_node_acknowledged of this PortRunStatusEntity.
        Acknowledges that this node is disconnected to allow for mutable requests to proceed.

        :param disconnected_node_acknowledged: The disconnected_node_acknowledged of this PortRunStatusEntity.
        :type: bool
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, PortRunStatusEntity):
            return False
