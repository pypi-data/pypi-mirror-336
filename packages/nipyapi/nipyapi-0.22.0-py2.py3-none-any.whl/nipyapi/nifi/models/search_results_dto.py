...
class SearchResultsDTO(object):
    ...
    swagger_types = {
        ...
        'parameter_provider_node_results': 'list[ComponentSearchResultDTO]',
    ...
    attribute_map = {
        ...
        'parameter_provider_node_results': 'parameterProviderNodeResults',
        'parameter_results': 'parameterResults'
    }

    def __init__(self, processor_results=None, connection_results=None, process_group_results=None, input_port_results=None, output_port_results=None, remote_process_group_results=None, funnel_results=None, label_results=None, controller_service_node_results=None, parameter_context_results=None, parameter_provider_node_results=None, parameter_results=None):
        """
        ...
        self._parameter_provider_node_results = None
        ...
        if parameter_provider_node_results is not None:
          self.parameter_provider_node_results = parameter_provider_node_results
    ...
    @property
    def parameter_provider_node_results(self):
        """
        Gets the parameter_provider_node_results of this SearchResultsDTO.
        The parameter provider nodes that matched the search

        :return: The parameter_provider_node_results of this SearchResultsDTO.
        :rtype: list[ComponentSearchResultDTO]
        """
        return self._parameter_provider_node_results

    @parameter_provider_node_results.setter
    def parameter_provider_node_results(self, parameter_provider_node_results):
        """
        Sets the parameter_provider_node_results of this SearchResultsDTO.
        The parameter provider nodes that matched the search

        :param parameter_provider_node_results: The parameter_provider_node_results of this SearchResultsDTO.
        :type: list[ComponentSearchResultDTO]
        """

        self._parameter_provider_node_results = parameter_provider_node_results
