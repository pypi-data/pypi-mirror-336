...
class PoliciesApi(object):
    ...
    def remove_access_policy(self, version, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_access_policy(version, id, callback=callback_function)
    ...
    def remove_access_policy_with_http_info(self, version, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_access_policy_with_http_info(version, id, callback=callback_function)
