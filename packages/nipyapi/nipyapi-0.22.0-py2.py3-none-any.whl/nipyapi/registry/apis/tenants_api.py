...
class TenantsApi(object):
    ...
    def remove_user(self, version, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_user(version, id, callback=callback_function)
    ...
    def remove_user_with_http_info(self, version, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_user_with_http_info(version, id, callback=callback_function)
    ...
    def remove_user_group(self, version, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_user_group(version, id, callback=callback_function)
    ...
    def remove_user_group_with_http_info(self, version, id, **kwargs):
        ...
        >>>     pprint(response)
        >>>
        >>> thread = api.remove_user_group_with_http_info(version, id, callback=callback_function)
