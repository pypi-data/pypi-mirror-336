...
@overload
def absorber(value: mitsuba.Color1f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of an ideal absorber
...
@overload
def depolarizer(value: mitsuba.Color1f = 1.0) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of an ideal depolarizer
...
@overload
def diattenuator(x: mitsuba.Color1f, y: mitsuba.Color1f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of a linear diattenuator, which
    attenuates the electric field components at 0 and 90 degrees by 'x'
    and 'y', * respectively.
...
@overload
def left_circular_polarizer() -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of a (left) circular polarizer.
...
@overload
def linear_polarizer(value: mitsuba.Color1f = 1.0) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of a linear polarizer which transmits
    linear polarization at 0 degrees.
...
@overload
def linear_retarder(phase: mitsuba.Color1f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of a linear retarder which has its fast
    axis aligned horizontally.
...
@overload
def right_circular_polarizer() -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of a (right) circular polarizer.
...
@overload
def rotate_mueller_basis(M: mitsuba.scalar_mono_polarized.Spectrum, in_forward: mitsuba.Vector3f, in_basis_current: mitsuba.Vector3f, in_basis_target: mitsuba.Vector3f, out_forward: mitsuba.Vector3f, out_basis_current: mitsuba.Vector3f, out_basis_target: mitsuba.Vector3f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
...
@overload
def rotate_mueller_basis_collinear(M: mitsuba.scalar_mono_polarized.Spectrum, forward: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Return the Mueller matrix for some new reference frames. This version
    applies the same rotation to the input/output frames.
...
def rotate_stokes_basis_m(wi: mitsuba.Vector3f, basis_current: mitsuba.Vector3f, basis_target: mitsuba.Vector3f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Gives the Mueller matrix that aligns the reference frames (defined by
    their respective basis vectors) of two collinear stokes vectors.
...
@overload
def rotated_element(theta: mitsuba.Color1f, M: mitsuba.scalar_mono_polarized.Spectrum) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Applies a counter-clockwise rotation to the mueller matrix of a given
    element.
    """
...
@overload
def rotator(theta: mitsuba.Color1f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Constructs the Mueller matrix of an ideal rotator, which performs a
    counter-clockwise rotation of the electric field by 'theta' radians
    (when facing the light beam from the sensor side).
...
@overload
def specular_reflection(cos_theta_i: mitsuba.Color1f, eta) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Calculates the Mueller matrix of a specular reflection at an interface
    between two dielectrics or conductors.
...
@overload
def specular_transmission(cos_theta_i: mitsuba.Color1f, eta: mitsuba.Color1f) -> mitsuba.scalar_mono_polarized.Spectrum:
    """
    Calculates the Mueller matrix of a specular transmission at an
    interface between two dielectrics or conductors.
