...
#define MI_EXTERN_STRUCT(Name)                                                  \
    MI_EXTERN_LIB template struct Name<float, Color<float, 1>>;                 \
    MI_EXTERN_LIB template struct Name<double, Color<double, 1>>;               \
    MI_EXTERN_LIB template struct Name<float, MuellerMatrix<Color<float, 1>>>;  \
    MI_EXTERN_LIB template struct Name<double, MuellerMatrix<Color<double, 1>>>; \
...
#define MI_EXTERN_CLASS(Name)                                                   \
    MI_EXTERN_LIB template class Name<float, Color<float, 1>>;                  \
    MI_EXTERN_LIB template class Name<double, Color<double, 1>>;                \
    MI_EXTERN_LIB template class Name<float, MuellerMatrix<Color<float, 1>>>;   \
    MI_EXTERN_LIB template class Name<double, MuellerMatrix<Color<double, 1>>>; \
...
#define MI_INSTANTIATE_STRUCT(Name)                                             \
    template struct Name<float, Color<float, 1>>;                               \
    template struct Name<double, Color<double, 1>>;                             \
    template struct Name<float, MuellerMatrix<Color<float, 1>>>;                \
    template struct Name<double, MuellerMatrix<Color<double, 1>>>;              \
...
#define MI_INSTANTIATE_CLASS(Name)                                              \
    template class Name<float, Color<float, 1>>;                                \
    template class Name<double, Color<double, 1>>;                              \
    template class Name<float, MuellerMatrix<Color<float, 1>>>;                 \
    template class Name<double, MuellerMatrix<Color<double, 1>>>;               \
