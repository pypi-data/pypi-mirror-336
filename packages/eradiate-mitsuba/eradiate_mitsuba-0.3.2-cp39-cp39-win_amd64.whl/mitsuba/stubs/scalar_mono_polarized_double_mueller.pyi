...
@overload
def absorber(value: float) -> mitsuba.Matrix4f64:
    """
...
@overload
def absorber(value: mitsuba.Color1d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of an ideal absorber
...
@overload
def depolarizer(value: float = 1.0) -> mitsuba.Matrix4f64:
    """
...
@overload
def depolarizer(value: mitsuba.Color1d = 1.0) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of an ideal depolarizer
...
@overload
def diattenuator(x: float, y: float) -> mitsuba.Matrix4f64:
    """
...
@overload
def diattenuator(x: mitsuba.Color1d, y: mitsuba.Color1d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of a linear diattenuator, which
    attenuates the electric field components at 0 and 90 degrees by 'x'
    and 'y', * respectively.
...
@overload
def left_circular_polarizer() -> mitsuba.Matrix4f64:
    """
...
@overload
def left_circular_polarizer() -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of a (left) circular polarizer.
...
@overload
def linear_polarizer(value: float = 1.0) -> mitsuba.Matrix4f64:
    """
...
@overload
def linear_polarizer(value: mitsuba.Color1d = 1.0) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of a linear polarizer which transmits
    linear polarization at 0 degrees.
...
@overload
def linear_retarder(phase: float) -> mitsuba.Matrix4f64:
    """
...
@overload
def linear_retarder(phase: mitsuba.Color1d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of a linear retarder which has its fast
    axis aligned horizontally.
...
@overload
def right_circular_polarizer() -> mitsuba.Matrix4f64:
    """
...
@overload
def right_circular_polarizer() -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of a (right) circular polarizer.
...
@overload
def rotate_mueller_basis(M: mitsuba.Matrix4f64, in_forward: mitsuba.Vector3d, in_basis_current: mitsuba.Vector3d, in_basis_target: mitsuba.Vector3d, out_forward: mitsuba.Vector3d, out_basis_current: mitsuba.Vector3d, out_basis_target: mitsuba.Vector3d) -> mitsuba.Matrix4f64:
    """
...
@overload
def rotate_mueller_basis(M: mitsuba.scalar_mono_polarized_double.Spectrum, in_forward: mitsuba.Vector3d, in_basis_current: mitsuba.Vector3d, in_basis_target: mitsuba.Vector3d, out_forward: mitsuba.Vector3d, out_basis_current: mitsuba.Vector3d, out_basis_target: mitsuba.Vector3d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Return the Mueller matrix for some new reference frames. This version
    rotates the input/output frames independently.
...
@overload
def rotate_mueller_basis_collinear(M: mitsuba.Matrix4f64, forward: mitsuba.Vector3d, basis_current: mitsuba.Vector3d, basis_target: mitsuba.Vector3d) -> mitsuba.Matrix4f64:
    """
    Return the Mueller matrix for some new reference frames. This version
...
@overload
def rotate_mueller_basis_collinear(M: mitsuba.scalar_mono_polarized_double.Spectrum, forward: mitsuba.Vector3d, basis_current: mitsuba.Vector3d, basis_target: mitsuba.Vector3d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Return the Mueller matrix for some new reference frames. This version
    applies the same rotation to the input/output frames.
...
def rotate_stokes_basis(wi: mitsuba.Vector3d, basis_current: mitsuba.Vector3d, basis_target: mitsuba.Vector3d) -> mitsuba.Matrix4f64:
    """
...
def rotate_stokes_basis_m(wi: mitsuba.Vector3d, basis_current: mitsuba.Vector3d, basis_target: mitsuba.Vector3d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Gives the Mueller matrix that aligns the reference frames (defined by
    their respective basis vectors) of two collinear stokes vectors.
...
@overload
def rotated_element(theta: float, M: mitsuba.Matrix4f64) -> mitsuba.Matrix4f64:
    """
...
@overload
def rotated_element(theta: mitsuba.Color1d, M: mitsuba.scalar_mono_polarized_double.Spectrum) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Applies a counter-clockwise rotation to the mueller matrix of a given
    element.
    """
...
@overload
def rotator(theta: float) -> mitsuba.Matrix4f64:
    """
...
@overload
def rotator(theta: mitsuba.Color1d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Constructs the Mueller matrix of an ideal rotator, which performs a
    counter-clockwise rotation of the electric field by 'theta' radians
    (when facing the light beam from the sensor side).
...
@overload
def specular_reflection(cos_theta_i: float, eta: mitsuba.Complex2f64) -> mitsuba.Matrix4f64:
    """
...
@overload
def specular_reflection(cos_theta_i: mitsuba.Color1d, eta) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Calculates the Mueller matrix of a specular reflection at an interface
    between two dielectrics or conductors.
...
@overload
def specular_transmission(cos_theta_i: float, eta: float) -> mitsuba.Matrix4f64:
    """
...
@overload
def specular_transmission(cos_theta_i: mitsuba.Color1d, eta: mitsuba.Color1d) -> mitsuba.scalar_mono_polarized_double.Spectrum:
    """
    Calculates the Mueller matrix of a specular transmission at an
    interface between two dielectrics or conductors.
...
def stokes_basis(w: mitsuba.Vector3d) -> mitsuba.Vector3d:
    """
...
def unit_angle(a: mitsuba.Vector3d, b: mitsuba.Vector3d) -> float: ...
