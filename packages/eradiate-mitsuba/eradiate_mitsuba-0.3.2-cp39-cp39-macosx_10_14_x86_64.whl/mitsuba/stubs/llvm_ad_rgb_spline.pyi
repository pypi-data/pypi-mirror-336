...
@overload
def eval_1d(min: float, max: float, values: numpy.ndarray[numpy.float32], x: mitsuba.Float) -> mitsuba.Float:
    """
...
@overload
def eval_1d(nodes: numpy.ndarray[numpy.float32], values: numpy.ndarray[numpy.float32], x: mitsuba.Float) -> mitsuba.Float:
    """
...
def eval_2d(nodes1: numpy.ndarray[numpy.float32], nodes2: numpy.ndarray[numpy.float32], values: numpy.ndarray[numpy.float32], x: mitsuba.Float, y: mitsuba.Float) -> mitsuba.Float:
    """
...
@overload
def eval_spline_weights(min: float, max: float, size: int, x: mitsuba.Float) -> Tuple[mitsuba.Bool, mitsuba.Int, List[mitsuba.Float]]:
    """
...
@overload
def eval_spline_weights(nodes: numpy.ndarray[numpy.float32], x: mitsuba.Float) -> Tuple[mitsuba.Bool, mitsuba.Int, List[mitsuba.Float]]:
    """
    Compute weights to perform a spline-interpolated lookup on a
...
@overload
def invert_1d(min: float, max_: float, values: numpy.ndarray[numpy.float32], y: mitsuba.Float, eps: float = 9.999999974752427e-07) -> mitsuba.Float:
    """
...
@overload
def invert_1d(nodes: numpy.ndarray[numpy.float32], values: numpy.ndarray[numpy.float32], y: mitsuba.Float, eps: float = 9.999999974752427e-07) -> mitsuba.Float:
    """
...
@overload
def sample_1d(min: float, max: float, values: numpy.ndarray[numpy.float32], cdf: numpy.ndarray[numpy.float32], sample: mitsuba.Float, eps: float = 9.999999974752427e-07) -> Tuple[mitsuba.Float, mitsuba.Float, mitsuba.Float]:
    """
...
@overload
def sample_1d(nodes: numpy.ndarray[numpy.float32], values: numpy.ndarray[numpy.float32], cdf: numpy.ndarray[numpy.float32], sample: mitsuba.Float, eps: float = 9.999999974752427e-07) -> Tuple[mitsuba.Float, mitsuba.Float, mitsuba.Float]:
    """
