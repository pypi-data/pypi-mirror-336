...
@overload
def eval_1d(min: float, max: float, values: numpy.ndarray[numpy.float64], x: float) -> float:
    """
...
@overload
def eval_1d(nodes: numpy.ndarray[numpy.float64], values: numpy.ndarray[numpy.float64], x: float) -> float:
    """
...
def eval_2d(nodes1: numpy.ndarray[numpy.float64], nodes2: numpy.ndarray[numpy.float64], values: numpy.ndarray[numpy.float64], x: float, y: float) -> float:
    """
...
@overload
def eval_spline_weights(nodes: numpy.ndarray[numpy.float64], x: float) -> Tuple[bool, int, List[float]]:
    """
    Compute weights to perform a spline-interpolated lookup on a
...
@overload
def integrate_1d(min: float, max: float, values: numpy.ndarray[numpy.float64]) -> mitsuba.ArrayXf64:
    """
...
@overload
def integrate_1d(nodes: numpy.ndarray[numpy.float64], values: numpy.ndarray[numpy.float64]) -> mitsuba.ArrayXf64:
    """
...
@overload
def invert_1d(min: float, max_: float, values: numpy.ndarray[numpy.float64], y: float, eps: float = 9.999999974752427e-07) -> float:
    """
...
@overload
def invert_1d(nodes: numpy.ndarray[numpy.float64], values: numpy.ndarray[numpy.float64], y: float, eps: float = 9.999999974752427e-07) -> float:
    """
...
@overload
def sample_1d(min: float, max: float, values: numpy.ndarray[numpy.float64], cdf: numpy.ndarray[numpy.float64], sample: float, eps: float = 9.999999974752427e-07) -> Tuple[float, float, float]:
    """
...
@overload
def sample_1d(nodes: numpy.ndarray[numpy.float64], values: numpy.ndarray[numpy.float64], cdf: numpy.ndarray[numpy.float64], sample: float, eps: float = 9.999999974752427e-07) -> Tuple[float, float, float]:
    """
