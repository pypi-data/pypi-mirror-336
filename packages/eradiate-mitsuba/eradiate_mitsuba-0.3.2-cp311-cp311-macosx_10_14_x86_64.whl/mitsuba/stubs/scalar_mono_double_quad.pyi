...
def chebyshev(n: int) -> mitsuba.ArrayXf64:
    """
...
def composite_simpson(n: int) -> Tuple[mitsuba.ArrayXf64, mitsuba.ArrayXf64]:
    """
...
def composite_simpson_38(n: int) -> Tuple[mitsuba.ArrayXf64, mitsuba.ArrayXf64]:
    """
...
def gauss_legendre(n: int) -> Tuple[mitsuba.ArrayXf64, mitsuba.ArrayXf64]:
    """
...
def gauss_lobatto(n: int) -> Tuple[mitsuba.ArrayXf64, mitsuba.ArrayXf64]:
    """
