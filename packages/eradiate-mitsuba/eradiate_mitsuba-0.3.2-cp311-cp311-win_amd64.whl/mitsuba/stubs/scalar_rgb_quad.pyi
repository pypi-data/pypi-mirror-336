...
def chebyshev(n: int) -> mitsuba.ArrayXf:
    """
...
def composite_simpson(n: int) -> Tuple[mitsuba.ArrayXf, mitsuba.ArrayXf]:
    """
...
def composite_simpson_38(n: int) -> Tuple[mitsuba.ArrayXf, mitsuba.ArrayXf]:
    """
...
def gauss_legendre(n: int) -> Tuple[mitsuba.ArrayXf, mitsuba.ArrayXf]:
    """
...
def gauss_lobatto(n: int) -> Tuple[mitsuba.ArrayXf, mitsuba.ArrayXf]:
    """
