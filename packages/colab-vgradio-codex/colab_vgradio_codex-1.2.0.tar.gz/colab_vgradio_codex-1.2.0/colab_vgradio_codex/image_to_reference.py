...
def get_credits_from_api(jwt_token, text_content, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, request_type, style, duration, resolution, movement_amplitude, aspect_ratio, sample_count, schedule_mode, model_version, creditos):
    ...
    try:
        ...
        if creditos <= credits:
            task_id, response_contents, video_url, additional_id = enviar_tarea(jwt_token, text_content, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, request_type, style, duration, resolution, movement_amplitude, aspect_ratio, sample_count, schedule_mode, model_version)
            ...
            print("Generate Image to Video Refrence...")
            ...
            task_id, response_contents, video_url, additional_id = enviar_tarea(jwt_token1, text_content, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, request_type, style, duration, resolution, movement_amplitude, aspect_ratio, sample_count, schedule_mode, model_version)
            os.environ["TASK_ID"] = task_id
            os.environ["VIDEO_URL"] = video_url
            os.environ["ADDITIONAL_ID"] = additional_id
...
def enviar_tarea(jwt_token, text_content, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, request_type, style, duration, resolution, movement_amplitude, aspect_ratio, sample_count, schedule_mode, model_version):
        ...
        "input": {
            "prompts": [
                {"type": "text", "content": text_content},
                {
                    ...
                    "src_imgs": [f"ssupload:?id={src_image_id}"],
                    "selected_region": {
                        "top_left": {"x": 0, "y": 0},
...
def img_to_reference(text_content, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, request_type, style, duration, resolution, movement_amplitude, aspect_ratio, sample_count, schedule_mode, model_version, creditos):
    ...
    if API_KEY:
        ...
        jwt_token=API_KEY
        # Llamar a la función y mostrar el resultado
        credits = get_credits_from_api(jwt_token, text_content, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, request_type, style, duration, resolution, movement_amplitude, aspect_ratio, sample_count, schedule_mode, model_version, creditos)
