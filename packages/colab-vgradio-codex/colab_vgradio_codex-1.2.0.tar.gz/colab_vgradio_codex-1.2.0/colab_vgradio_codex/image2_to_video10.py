...
def get_credits_from_api(jwt_token, content, image_id1, image_id2, width1, height1, width2, height2, enhance, types, style, duration, model, sample_count, schedule_mode, model_version, creditos):
    ...
    try:
        ...
        if creditos <= credits:
            task_id, response_contents, video_url, additional_id = enviar_tarea(jwt_token, content, image_id1, image_id2, width1, height1, width2, height2, enhance, types, style, duration, model, sample_count, schedule_mode, model_version)
            ...
            task_id, response_contents, video_url, additional_id = enviar_tarea(jwt_token1, content, image_id1, image_id2, width1, height1, width2, height2, enhance, types, style, duration, model, sample_count, schedule_mode, model_version)
            os.environ["TASK_ID"] = task_id
            os.environ["VIDEO_URL"] = video_url
            os.environ["ADDITIONAL_ID"] = additional_id
            print("Generate Image 2 to Video...")
...
def enviar_tarea(jwt_token, content, image_id1, image_id2, width1, height1, width2, height2, enhance, types, style, duration, model, sample_count, schedule_mode, model_version):
...
def img2_to_video10(content, image_id1, image_id2, width1, height1, width2, height2, enhance, types, style, duration, model, sample_count, schedule_mode, model_version, creditos):
    ...
    if API_KEY:
        ...
        jwt_token=API_KEY
        # Llamar a la función y mostrar el resultado
        credits = get_credits_from_api(jwt_token, content, image_id1, image_id2, width1, height1, width2, height2, enhance, types, style, duration, model, sample_count, schedule_mode, model_version, creditos)
