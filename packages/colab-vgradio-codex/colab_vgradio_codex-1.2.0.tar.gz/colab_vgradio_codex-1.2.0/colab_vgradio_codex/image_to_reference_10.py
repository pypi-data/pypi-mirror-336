...
def get_credits_from_api(jwt_token, content_text, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, task_type, style, duration, sample_count, model_version, creditos):
    ...
    try:
        ...
        if creditos <= credits:
            task_id, response_contents, video_url, additional_id = enviar_tarea(jwt_token, content_text, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, task_type, style, duration, sample_count, model_version)
            ...
            task_id, response_contents, video_url, additional_id = enviar_tarea(jwt_token1, content_text, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, task_type, style, duration, sample_count, model_version)
            os.environ["TASK_ID"] = task_id
            os.environ["VIDEO_URL"] = video_url
            os.environ["ADDITIONAL_ID"] = additional_id
...
def enviar_tarea(jwt_token, content_text, image_id, src_image_id, bottom_right_x, bottom_right_y, enhance, task_type, style, duration, sample_count, model_version):
...
def img_to_reference_10(content_text, image_id, bottom_right_x, bottom_right_y, enhance, task_type, style, duration, sample_count, model_version, creditos):
    ...
    if API_KEY:
        ...
        jwt_token=API_KEY
        # Llamar a la función y mostrar el resultado
        credits = get_credits_from_api(jwt_token, content_text, image_id, image_id, bottom_right_x, bottom_right_y, enhance, task_type, style, duration, sample_count, model_version, creditos)
