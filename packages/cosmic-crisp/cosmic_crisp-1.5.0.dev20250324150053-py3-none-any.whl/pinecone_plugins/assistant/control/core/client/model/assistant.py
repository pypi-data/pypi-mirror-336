...
class Assistant(ModelNormal):
    ...
    def _from_openapi_data(cls, name, status, *args, **kwargs):  # noqa: E501
        """Assistant - a model defined in OpenAPI

        Args:
            name (str): The name of the assistant. Resource name must be 1-45 characters long, start and end with an alphanumeric character, and consist only of lower case alphanumeric characters or '-'. 
            status (str):
        ...
        Keyword Args:
            ...
            instructions (str, none_type): Description or directive for the assistant to apply to all responses.. [optional]  # noqa: E501
            metadata ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type): [optional]  # noqa: E501
            host (str): The host where the assistant is deployed.. [optional]  # noqa: E501
