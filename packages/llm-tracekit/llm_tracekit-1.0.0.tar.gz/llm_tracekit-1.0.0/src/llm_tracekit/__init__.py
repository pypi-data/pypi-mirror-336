...
# Imports for exporting to Coralogix
try:
    import os
    ...
    EXPORT_MODULES_LOADED = True
except ImportError:
    EXPORT_MODULES_LOADED = False
...
def setup_export_to_coralogix(
    ...
    """
    if not EXPORT_MODULES_LOADED:
        raise ModuleNotFoundError(
            "Required dependencies not installed. Please install optional export group"
        )
