...
#     title: str,
# ):
#     """Given a list of items autogenerated using MCAT-RAS and ras-stac, this function creates a new collection in the STAC_API and adds the items to the collection."""
