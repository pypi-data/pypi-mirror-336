...
class Buffering(BufferingHiddenBase):
    ...
    def register_to(self, module: nn.Module, name: str):
        module.register_buffer(name, typeattr(self, _is_buffering_method)[__class__.get_content.__code__.co_name](self), typeattr(self, _is_buffering_method)[__class__.get_persistent.__code__.co_name](self))
    
    @bufferingmethod
    @hidden
    def modify_generically(self, func: Callable[[Any], Any], *args, **kwargs): pass
    
    @bufferingmethod
    @hidden
    def copy_generically(self, func: Callable[[Any], Any], *args, **kwargs): pass
    
    @bufferingmethod
    @hidden
    @staticmethod
    def standard_type(): pass
    
    @bufferingmethod
    @hidden
    def get_apparent_type(self) -> Any: pass
    
    @bufferingmethod
    @hidden
    def set_apparent_type(self, value): pass
    
    @bufferingmethod
    @hidden
    def get_attr(self, name: str) -> Any: pass

    @bufferingmethod
    @hidden
    def set_attribute(self, name: str, value): pass
    
    @bufferingmethod
    @hidden
    def delete_attribute(self, name: str): pass
    
    @bufferingmethod
    @hidden
    def get_content(self) -> Any: pass
    
    @bufferingmethod
    @hidden
    def get_persistent(self) -> bool: pass
            ...
            if (first_frame and first_frame.f_code.co_name == 'register_parameter') and (second_frame and second_frame.f_code.co_name == '__setattr__'):
                ...
                if module_self is not None and isinstance(module_self, nn.Module):
                    ...
                    if len(co_varnames) > 1:
                        ...
                        typeattr(self, _is_buffering_method)[__class__.register_to.__code__.co_name](self, module_self, last_name)
                        return False
        attr = typeattr(self, _is_buffering_method)[__class__.get_attr.__code__.co_name](self, name)
        return attr
    ...
    def __setattr__(self, name: str, value):
        if name == '__class__':
            ...
            typeattr(self, _is_buffering_method)[__class__.set_attribute.__code__.co_name](self, name, value)
    
    def __delattr__(self, name: str):
        typeattr(self, _is_buffering_method)[__class__.delete_attribute.__code__.co_name](self, name)
    
    def __repr__(self) -> str:
        return f"<unregistered buffer of {typeattr(self, _is_buffering_method)[__class__.get_content.__code__.co_name](self).__repr__()}>"
    
    @property
    def __class__(self):
        apparent_type = None
        standard_type = typeattr(self, _is_buffering_method)[__class__.standard_type.__code__.co_name]()
        i = pyreflex.overriding_depth()
        ...
        if second_frame and (second_frame.f_code.co_name == '__setattr__' or 
            ...
            apparent_type = typeattr(self, _is_buffering_method)[__class__.get_apparent_type.__code__.co_name](self)
            ...
            if module_self is not None and isinstance(module_self, nn.Module):
                ...
                if len(co_varnames) > 3:
                    ...
                    if call_instruction.argval is not None and call_instruction.argval <= 2:
                        ...
                        frame_locals[persistent_name] = typeattr(self, _is_buffering_method)[__class__.get_persistent.__code__.co_name](self)
                    frame_locals[tensor_name] =  typeattr(self, _is_buffering_method)[__class__.get_content.__code__.co_name](self)
        ...
        return apparent_type if apparent_type else typeattr(self, _is_buffering_method)[__class__.get_apparent_type.__code__.co_name](self)
    
    @__class__.setter
    def __class__(self, value):
        # The `__class__` should be set through the stored content.
        typeattr(self, _is_buffering_method)[__class__.set_apparent_type.__code__.co_name](self, value)
    
    def __copy__(self):
        from copy import copy
        return typeattr(self, _is_buffering_method)[__class__.copy_generically.__code__.co_name](self, copy)
    
    def __deepcopy__(self, memodict={}):
        from copy import deepcopy
        return typeattr(self, _is_buffering_method)[__class__.copy_generically.__code__.co_name](self, deepcopy, memodict)
...
class Buffer(Buffering):
    ...
    @bufferingmethod
    @hidden
    def modify_generically(self, func: Callable[[Any], Any], *args, **kwargs):
    ...
    @bufferingmethod
    @hidden
    def copy_generically(self, func: Callable[[Any], Any], *args, **kwargs):
        content = object.__getattribute__(self, '__content')
        result = func(content, *args, **kwargs)
        if isinstance(result, torch.Tensor) or issubclass(type(result), Buffering):
    ...
    @bufferingmethod
    @hidden
    def get_apparent_type(self) -> Any:
        return object.__getattribute__(self, '__content').__class__
    
    @bufferingmethod
    @hidden
    def set_apparent_type(self, value):
            ...
            def when_function(func):
                if name.endswith('_'):
                    def required_function(instance, *args, **kwargs):
                        return typeattr(instance, _is_buffering_method)[__class__.modify_generically.__code__.co_name](instance, func, *args, **kwargs)
                else:
                    def required_function(instance, *args, **kwargs):
                        return typeattr(instance, _is_buffering_method)[__class__.copy_generically.__code__.co_name](instance, func, *args, **kwargs)
    ...
    # def __copy__(self):
    #     from copy import copy
    #     return Buffer(copy(object.__getattribute__(self, '__content')), object.__getattribute__(self, '__persistent'))
    
    # def __deepcopy__(self, memodict={}):
    #     from copy import deepcopy
    #     return Buffer(deepcopy(object.__getattribute__(self, '__content'), memodict), object.__getattribute__(self, '__persistent'))
...
# def _content_named_forward_inplace(content, *args, **kwargs):
#     # Specifically, when the method name ends with "_", it means it is an inplace operation
#     try:
#         return content.__getattribute__(pyreflex.function_name(3)[:-1])(*args, **kwargs)
#     except AttributeError:
#         return content


def _named_forward_copy(instance, *args, **kwargs):
    return typeattr(instance, _is_buffering_method)[Buffering.copy_generically.__code__.co_name](instance, _content_named_forward, *args, **kwargs)


def _named_forward_modify(instance, *args, **kwargs):
    # Originally using `_content_named_forward_inplace`.
    return typeattr(instance, _is_buffering_method)[Buffering.modify_generically.__code__.co_name](instance, _content_named_forward, *args, **kwargs)
...
class BufferObject(Buffering):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        object.__setattr__(instance, '_contents', cls.tensors())
        return instance
    ...
    def with_persistent(self, value):
    ...
    def set_attribute(self, name: str, value):
        ...
        # elif isinstance(value, torch.Tensor) or isinstance(value, Buffering):
        #     for hook in torch.nn.modules.module._global_buffer_registration_hooks.values():
    ...
    #     instance = type(self).__new__(type(self))
    #     object.__setattr__(instance, '__persistent', object.__getattribute__(self, '__persistent'))
    #     for name, tensor in object.__getattribute__(self, '_contents').items():
    #         object.__getattribute__(instance, '_contents')[name] = copy(tensor)
    #     self_dict: dict = object.__getattribute__(self, '__dict__')
    #     try:
    #         self_dict.pop('_contents'), self_dict.pop('__persistent'), self_dict.pop('__class')
    #     except: pass
    #     for name, value in self_dict.items():
    #         type(self).__setattr__(instance, name, copy(value))
    #     return instance
    ...
    #     object.__setattr__(instance, '__persistent', object.__getattribute__(self, '__persistent'))
    #     for name, tensor in object.__getattribute__(self, '_contents').items():
    #         object.__getattribute__(instance, '_contents')[name] = deepcopy(tensor, memodict)
    #     self_dict: dict = object.__getattribute__(self, '__dict__')
    #     try:
    #         self_dict.pop('_contents'), self_dict.pop('__persistent'), self_dict.pop('__class')
    #     except: pass
    #     for name, value in self_dict.items():
    #         type(self).__setattr__(instance, name, deepcopy(value, memodict))
    #     return instance
...
class BufferDict(BufferObject):
    ...
    def __setitem__(self, key: str, value):
        # if value is None or isinstance(value, torch.Tensor) or isinstance(value, Buffering):
        #     for hook in torch.nn.modules.module._global_buffer_registration_hooks.values():
        #         output = hook(self, key, value)
        #         if output is not None:
        #             value = output
        #     object.__getattribute__(self, '_contents')[key] = value
        # else:
        #     raise TypeError(f"`{type(self).__name__}` instance does not accept instance from other than `{torch.Tensor.__name__}`, `{Buffering.__name__}`, and `NoneType`")
        object.__getattribute__(self, '_contents')[key] = value
...
class BufferList(BufferObject):
    ...
    def __setitem__(self, index: int, value):
        # if value is None or isinstance(value, torch.Tensor) or isinstance(value, Buffering):
        #     for hook in torch.nn.modules.module._global_buffer_registration_hooks.values():
        #         output = hook(self, f'_{index}', value)
        #         if output is not None:
        #             value = output
    ...
    def insert(self, index: int, buffer: Any):
        # if buffer is None or isinstance(buffer, torch.Tensor) or isinstance(buffer, Buffering):
        #     for hook in torch.nn.modules.module._global_buffer_registration_hooks.values():
        #         output = hook(self, f'_{index}', buffer)
        #         if output is not None:
        #             buffer = output
    ...
    #     instance = type(self).__new__(type(self))
    #     object.__setattr__(instance, '__persistent', object.__getattribute__(self, '__persistent'))
    #     for value in object.__getattribute__(self, '_contents'):
    #         object.__getattribute__(instance, '_contents').append(copy(value))
    #     self_dict: dict = object.__getattribute__(self, '__dict__')
    #     try:
    #         self_dict.pop('_contents'), self_dict.pop('__persistent'), self_dict.pop('__class')
    #     except: pass
    ...
    #     object.__setattr__(instance, '__persistent', object.__getattribute__(self, '__persistent'))
    #     for value in object.__getattribute__(self, '_contents'):
    #         object.__getattribute__(instance, '_contents').append(deepcopy(value, memodict))
    #     self_dict: dict = object.__getattribute__(self, '__dict__')
    #     try:
    #         self_dict.pop('_contents'), self_dict.pop('__persistent'), self_dict.pop('__class')
    #     except: pass
