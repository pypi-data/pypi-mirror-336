...
class SearchIssuebyJQLOperationsLinkGroupsGroupsArrayItemRef(BaseModel):
    """
    Attributes:
        header (Optional[SearchIssuebyJQLOperationsLinkGroupsGroupsHeader]):
        id (Optional[str]):
        links (Optional[list['SearchIssuebyJQLOperationsLinkGroupsGroupsLinksArrayItemRef']]):
    ...
    header: Optional["SearchIssuebyJQLOperationsLinkGroupsGroupsHeader"] = Field(
        alias="header", default=None
    )
    id: Optional[str] = Field(alias="id", default=None)
    links: Optional[
        list["SearchIssuebyJQLOperationsLinkGroupsGroupsLinksArrayItemRef"]
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchIssuebyJQLOperationsLinkGroupsGroupsArrayItemRef"],
