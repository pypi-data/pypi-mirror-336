...
from ..models.get_comments_update_author_avatar_urls import (
    GetCommentsUpdateAuthorAvatarUrls,
)


class GetCommentsUpdateAuthor(BaseModel):
    """
    Attributes:
        ...
        avatar_urls (Optional[GetCommentsUpdateAuthorAvatarUrls]):
    ...
    avatar_urls: Optional["GetCommentsUpdateAuthorAvatarUrls"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["GetCommentsUpdateAuthor"], src_dict: Dict[str, Any]):
