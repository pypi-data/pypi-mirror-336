...
class SearchIssuebyJQLChangelog(BaseModel):
    """
    Attributes:
        histories (Optional[list['SearchIssuebyJQLChangelogHistoriesArrayItemRef']]):
    ...
    histories: Optional[list["SearchIssuebyJQLChangelogHistoriesArrayItemRef"]] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["SearchIssuebyJQLChangelog"], src_dict: Dict[str, Any]):
