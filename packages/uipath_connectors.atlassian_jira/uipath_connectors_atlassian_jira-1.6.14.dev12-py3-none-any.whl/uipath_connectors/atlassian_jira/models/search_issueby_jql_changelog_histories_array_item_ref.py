...
class SearchIssuebyJQLChangelogHistoriesArrayItemRef(BaseModel):
    """
    Attributes:
        author (Optional[SearchIssuebyJQLChangelogHistoriesAuthor]):
        created (Optional[datetime.datetime]): The date on which the change took place.
        history_metadata (Optional[SearchIssuebyJQLChangelogHistoriesHistoryMetadata]):
        id (Optional[str]): The ID of the changelog.
        items (Optional[list['SearchIssuebyJQLChangelogHistoriesItemsArrayItemRef']]):
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    author: Optional["SearchIssuebyJQLChangelogHistoriesAuthor"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchIssuebyJQLChangelogHistoriesArrayItemRef"],
