...
from ..models.add_attachment_response_author_avatar_urls import (
    AddAttachmentResponseAuthorAvatarUrls,
)


class AddAttachmentResponseAuthor(BaseModel):
    """
    Attributes:
        ...
        avatar_urls (Optional[AddAttachmentResponseAuthorAvatarUrls]):
    ...
    avatar_urls: Optional["AddAttachmentResponseAuthorAvatarUrls"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["AddAttachmentResponseAuthor"], src_dict: Dict[str, Any]):
