...
class SearchIssuebyJQLFieldsCreator(BaseModel):
    """
    Attributes:
        account_id (Optional[str]):
        account_type (Optional[str]):
        active (Optional[bool]):
        avatar_urls (Optional[SearchIssuebyJQLFieldsCreatorAvatarUrls]):
    ...
    avatar_urls: Optional["SearchIssuebyJQLFieldsCreatorAvatarUrls"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["SearchIssuebyJQLFieldsCreator"], src_dict: Dict[str, Any]):
