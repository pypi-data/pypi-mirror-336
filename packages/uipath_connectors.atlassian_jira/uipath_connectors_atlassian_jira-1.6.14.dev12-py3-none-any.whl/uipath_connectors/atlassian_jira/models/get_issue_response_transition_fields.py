...
from ..models.get_issue_response_transition_fields_schema import (
    GetIssueResponseTransitionFieldsSchema,
)


class GetIssueResponseTransitionFields(BaseModel):
    """
    Attributes:
        ...
        schema (Optional[GetIssueResponseTransitionFieldsSchema]):
    """
    ...
    schema: Optional["GetIssueResponseTransitionFieldsSchema"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["GetIssueResponseTransitionFields"], src_dict: Dict[str, Any]
    ):
