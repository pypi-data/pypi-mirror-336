...
class SearchIssuebyJQLTransitionsFields(BaseModel):
    """
    Attributes:
        ...
        schema (Optional[SearchIssuebyJQLTransitionsFieldsSchema]):
    """
    ...
    schema: Optional["SearchIssuebyJQLTransitionsFieldsSchema"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchIssuebyJQLTransitionsFields"], src_dict: Dict[str, Any]
    ):
