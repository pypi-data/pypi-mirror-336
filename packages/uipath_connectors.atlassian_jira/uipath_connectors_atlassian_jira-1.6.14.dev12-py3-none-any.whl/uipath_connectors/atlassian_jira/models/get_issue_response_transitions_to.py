...
from ..models.get_issue_response_transitions_to_status_category import (
    GetIssueResponseTransitionsToStatusCategory,
)


class GetIssueResponseTransitionsTo(BaseModel):
    """
    Attributes:
        ...
        status_category (Optional[GetIssueResponseTransitionsToStatusCategory]):
    """
    ...
    status_category: Optional["GetIssueResponseTransitionsToStatusCategory"] = Field(
    ...
    @classmethod
    def from_dict(cls: Type["GetIssueResponseTransitionsTo"], src_dict: Dict[str, Any]):
