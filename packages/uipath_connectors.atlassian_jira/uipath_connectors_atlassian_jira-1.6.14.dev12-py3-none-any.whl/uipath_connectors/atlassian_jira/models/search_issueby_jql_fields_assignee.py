...
from ..models.search_issueby_jql_fields_assignee_avatar_urls import (
    SearchIssuebyJQLFieldsAssigneeAvatarUrls,
)


class SearchIssuebyJQLFieldsAssignee(BaseModel):
    """
    Attributes:
        account_id (Optional[str]):
        account_type (Optional[str]):
        active (Optional[bool]):
        avatar_urls (Optional[SearchIssuebyJQLFieldsAssigneeAvatarUrls]):
    ...
    avatar_urls: Optional["SearchIssuebyJQLFieldsAssigneeAvatarUrls"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchIssuebyJQLFieldsAssignee"], src_dict: Dict[str, Any]
    ):
