...
from ..models.search_issueby_jql_fields_reporter_avatar_urls import (
    SearchIssuebyJQLFieldsReporterAvatarUrls,
)


class SearchIssuebyJQLFieldsReporter(BaseModel):
    """
    Attributes:
        account_id (Optional[str]):
        account_type (Optional[str]):
        active (Optional[bool]):
        avatar_urls (Optional[SearchIssuebyJQLFieldsReporterAvatarUrls]):
    ...
    avatar_urls: Optional["SearchIssuebyJQLFieldsReporterAvatarUrls"] = Field(
    ...
    @classmethod
    def from_dict(
        cls: Type["SearchIssuebyJQLFieldsReporter"], src_dict: Dict[str, Any]
    ):
