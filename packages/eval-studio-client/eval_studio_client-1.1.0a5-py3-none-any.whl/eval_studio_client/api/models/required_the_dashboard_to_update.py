...
class RequiredTheDashboardToUpdate(BaseModel):
    """
    The Dashboard's `name` field is used to identify the Dashboard to update. Format: dashboards/{dashboard}
    """ # noqa: E501
    create_time: Optional[datetime] = Field(default=None, description="Output only. Timestamp when the Dashboard was created.", alias="createTime")
    creator: Optional[StrictStr] = Field(default=None, description="Output only. Name of the user or service that requested creation of the Dashboard.")
    update_time: Optional[datetime] = Field(default=None, description="Output only. Optional. Timestamp when the Dashboard was last updated.", alias="updateTime")
    updater: Optional[StrictStr] = Field(default=None, description="Output only. Optional. Name of the user or service that requested update of the Dashboard.")
    delete_time: Optional[datetime] = Field(default=None, description="Output only. Optional. Set when the Dashboard is deleted. When set Dashboard should be considered as deleted.", alias="deleteTime")
    ...
    __properties: ClassVar[List[str]] = ["createTime", "creator", "updateTime", "updater", "deleteTime", "deleter", "displayName", "description", "status", "leaderboards", "createOperation", "demo"]
