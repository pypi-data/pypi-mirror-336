...
class TestV1GetLeaderboardReportResponse(unittest.TestCase):
    """V1GetLeaderboardReportResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> V1GetLeaderboardReportResponse:
        """Test V1GetLeaderboardReportResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1GetLeaderboardReportResponse`
        """
        model = V1GetLeaderboardReportResponse()
        if include_optional:
            return V1GetLeaderboardReportResponse(
                leaderboard_report = eval_studio_client.api.models.v1_leaderboard_report.v1LeaderboardReport(
                    results = [
    ...
    def testV1GetLeaderboardReportResponse(self):
        """Test V1GetLeaderboardReportResponse"""
