...
class TestV1Evaluator(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1Evaluator:
        """Test V1Evaluator
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1Evaluator`
        """
        model = V1Evaluator()
        if include_optional:
            return V1Evaluator(
