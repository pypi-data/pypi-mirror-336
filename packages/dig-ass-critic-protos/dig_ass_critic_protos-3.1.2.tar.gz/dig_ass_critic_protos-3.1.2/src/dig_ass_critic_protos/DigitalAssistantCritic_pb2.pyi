...
class DigitalAssistantCriticResponse(_message.Message):
    __slots__ = ("Score",)
    SCORE_FIELD_NUMBER: _ClassVar[int]
    Score: float
    def __init__(self, Score: _Optional[float] = ...) -> None: ...

class DigitalAssistantCriticRequest(_message.Message):
    ...
    Chat: ChatItem
    RequestId: str
    def __init__(self, Text: _Optional[str] = ..., Chat: _Optional[_Union[ChatItem, _Mapping]] = ..., RequestId: _Optional[str] = ...) -> None: ...
