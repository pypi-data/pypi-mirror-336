...
from ablelabs.neon.common.notable.nanophilia.enums import WasherSource
...
class WasherDryerAPI(MessengerClient):
    ...
    async def prime(self, source: WasherSource, sec: float):
        pass

    @run_server_func(RobotRouter.deck_module_washer_dryer_recovery)
    async def recovery(self, source: WasherSource, sec: float):
        pass
