...
class RobotRouter(MessengerServer):
    ...
    async def deck_module_washer_dryer_prime(self, source: WasherSource, sec: float):
        pass

    async def deck_module_washer_dryer_recovery(self, source: WasherSource, sec: float):
        pass
