...
class BatchPostingWindow(NextGenWindow):
    ...
    def post_batch(self, row: ListItemWrapper):
    ...
    def run_batch_lookup(self, trn: str, amount: Decimal, fill_amount: bool = False) -> None | BatchPostingRow:
        ...
        Returns:
            None | BatchPositngRow: Returns BatchPostingRow object or raises an exception if row not found
