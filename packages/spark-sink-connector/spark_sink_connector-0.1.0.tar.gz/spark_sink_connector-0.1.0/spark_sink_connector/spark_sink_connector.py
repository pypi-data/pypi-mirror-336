...
class SparkSinkConnector:
    ...
    def write_delta_to_s3(self, partition_key: str, output_mode: ConnectorOutputMode,
        ...
        Args:
            ...
            output_mode: Output mode (append or overwrite)
    ...
    def write_hudi_to_s3(self, partition_key: str, output_mode: ConnectorOutputMode,
                         bucket_name: str) -> 'SparkSinkConnector':
        """
        ...
        # TODO: Implement Hudi writing logic
        self.logger.info(self.dataframe.show())
        # self.logger.info(f"✅ Data written to {bucket_name} in Hudi format.")
        return self
