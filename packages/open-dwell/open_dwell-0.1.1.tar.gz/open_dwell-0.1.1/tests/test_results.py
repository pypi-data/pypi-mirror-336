...
def test_single_phase_non_isothermal_outputs():
    """ Test results from single_phase_non_isothermal/main_validation_single_phase_of_CO2.py. """
    generated_file = "single_phase_non_isothermal/stored_primary_variables.pkl"
...
def test_two_phase_isothermal_outputs():
    """ Test results from two_phase/main_full_column_of_water_variable_K_2-comp_validation_scenario2.py. """
    generated_file = "two_phase/stored_primary_variables.pkl"
