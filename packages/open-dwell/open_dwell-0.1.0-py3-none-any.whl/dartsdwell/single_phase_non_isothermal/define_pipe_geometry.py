...
class PipeGeometry:
    def __init__(self, pipe_name: str, segments_lengths, pipe_ID: float,
                 inclination_angle: float = 0, wall_roughness: float = 5e-5*meter(),
                 verbose: bool = False):
        """
        ...
        self.D = self.z_p - self.z_m   # Distance between the centroids of neighboring interfaces
