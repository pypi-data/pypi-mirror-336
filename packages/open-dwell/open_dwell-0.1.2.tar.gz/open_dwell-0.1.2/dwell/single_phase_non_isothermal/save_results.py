...
def add_to_df(primary_variables, column_name, primary_variables_df):
    """
    Add the primary variables of a wellbore to a DataFrame in which some results are already stored by the function save_in_df.
    ...
    # df.to_excel("results.xlsx", sheet_name="Primary variables")
