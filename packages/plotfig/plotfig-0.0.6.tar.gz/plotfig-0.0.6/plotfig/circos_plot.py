...
def plot_symmetric_circle_figure(
    ...
    colorbar_pos=(0, 0),
    manual_colorbar=False,
    manual_colorbar_pos=[1, 0.4, 0.01, 0.2],
    manual_cmap="bwr",
    manual_colorbar_name="",
    manual_colorbar_label_fontsize=10,
    manual_colorbar_fontsize=10,
    manual_colorbar_rotation=-90,
    manual_colorbar_pad=20,
    manual_colorbar_draw_border=True,
    manual_colorbar_tickline=False,
    manual_colorbar_nticks=False,
):
    # 设置默认值
    if vmax is None:
