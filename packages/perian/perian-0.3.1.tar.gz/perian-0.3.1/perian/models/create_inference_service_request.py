...
class CreateInferenceServiceRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instance_type_id", "auto_failover_instance_type", "timeout_seconds", "os_storage_config", "requirements", "docker_run_parameters", "docker_registry_credentials", "container_port"]
