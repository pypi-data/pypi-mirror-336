...
class InferenceServiceView(BaseModel):
    """
    Inference Service view data model.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "status", "started_at", "done_at", "logs", "errors", "price", "docker_metadata", "requirement_metadata", "runtime_metadata", "created_at", "updated_at", "container_port", "server_ip"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of InferenceServiceView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of InferenceServiceView from a dict"""
        if obj is None:
            return None
