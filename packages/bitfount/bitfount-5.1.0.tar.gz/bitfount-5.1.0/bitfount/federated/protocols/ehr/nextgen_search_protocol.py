...
from bitfount.federated.authorisation_checkers import ProtocolContext
...
class _WorkerSide(BaseWorkerProtocol):
    ...
    algorithm: Sequence[_NextGenQueryWorkerSide | _CSVWorkerSide]
    ...
    async def run(
        ...
        **kwargs: Any,
        ...
        query_algo, csv_output_algo = self.algorithm
...
class NextGenSearchProtocol(BaseProtocolFactory):
    ...
    def __init__(
        self,
        *,
        algorithm: Sequence[NextGenPatientQueryAlgorithm | _SimpleCSVAlgorithm],
        rename_columns: Optional[Mapping[str, str]] = None,
        **kwargs: Any,
    ) -> None:
    ...
    def modeller(self, mailbox: _ModellerMailbox, **kwargs: Any) -> _ModellerSide:
        ...
        algorithms = cast(
            Sequence[NextGenPatientQueryAlgorithm | _SimpleCSVAlgorithm],
            self.algorithms,
        )
        modeller_algos = []
