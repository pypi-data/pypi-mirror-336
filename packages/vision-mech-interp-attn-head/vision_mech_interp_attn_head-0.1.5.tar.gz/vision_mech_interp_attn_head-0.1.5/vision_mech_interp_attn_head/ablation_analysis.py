    ...
    for layer in range(num_layers):
        for head in range(num_heads):
            ...
            scenario_results = pd.DataFrame({
                ...
                "Chirp_Start_Time_Real": targets[:, 0],  # Include ground truth
                "Chirp_Start_Freq_Real": targets[:, 1],  # Include ground truth
                "Chirp_End_Freq_Real": targets[:, 2]     # Include ground truth
            })
