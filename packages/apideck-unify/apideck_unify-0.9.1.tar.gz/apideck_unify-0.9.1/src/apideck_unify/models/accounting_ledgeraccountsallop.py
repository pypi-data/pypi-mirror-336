...
class AccountingLedgerAccountsAllGlobals(BaseModel):
...
class AccountingLedgerAccountsAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[LedgerAccountsFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[LedgerAccountsSortTypedDict]
    r"""Apply sorting"""
...
class AccountingLedgerAccountsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
