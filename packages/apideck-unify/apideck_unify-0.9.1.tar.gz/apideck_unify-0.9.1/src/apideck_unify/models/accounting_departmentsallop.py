...
class AccountingDepartmentsAllGlobals(BaseModel):
...
class AccountingDepartmentsAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[AccountingDepartmentsFilterTypedDict]
    r"""Apply filters"""


class AccountingDepartmentsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
    ...
    filter_: Annotated[
        Optional[AccountingDepartmentsFilter],
