...
class AccountingDepartmentsOneGlobals(BaseModel):
...
class AccountingDepartmentsOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingDepartmentsOneRequest(BaseModel):
    id: Annotated[
