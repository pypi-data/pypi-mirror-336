...
class AccountingSubsidiariesAllGlobals(BaseModel):
...
class AccountingSubsidiariesAllRequestTypedDict(TypedDict):
...
class AccountingSubsidiariesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
