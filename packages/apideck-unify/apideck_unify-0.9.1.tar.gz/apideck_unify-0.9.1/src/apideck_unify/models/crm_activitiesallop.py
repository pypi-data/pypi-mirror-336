...
class CrmActivitiesAllGlobals(BaseModel):
...
class CrmActivitiesAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[ActivitiesFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[ActivitiesSortTypedDict]
    r"""Apply sorting"""
...
class CrmActivitiesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
