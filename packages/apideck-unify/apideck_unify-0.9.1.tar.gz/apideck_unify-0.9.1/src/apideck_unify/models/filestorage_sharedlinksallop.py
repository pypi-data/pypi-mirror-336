...
class FileStorageSharedLinksAllGlobals(BaseModel):
...
class FileStorageSharedLinksAllRequestTypedDict(TypedDict):
...
class FileStorageSharedLinksAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
