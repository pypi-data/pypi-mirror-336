...
from .ecommercecustomer import EcommerceCustomer, EcommerceCustomerTypedDict
...
class GetEcommerceCustomersResponseTypedDict(TypedDict):
    r"""Customers"""
    ...
    data: List[EcommerceCustomerTypedDict]
