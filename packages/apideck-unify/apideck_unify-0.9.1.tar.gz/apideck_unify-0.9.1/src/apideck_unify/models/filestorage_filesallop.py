...
class FileStorageFilesAllGlobals(BaseModel):
...
class FileStorageFilesAllRequestTypedDict(TypedDict):
    ...
    r"""Apply filters"""
    sort: NotRequired[FilesSortTypedDict]
    r"""Apply sorting"""
...
class FileStorageFilesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
