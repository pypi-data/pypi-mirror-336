...
class IssueTrackingCollectionTicketCommentsOneGlobals(BaseModel):
...
class IssueTrackingCollectionTicketCommentsOneRequestTypedDict(TypedDict):
    id: str
...
class IssueTrackingCollectionTicketCommentsOneRequest(BaseModel):
    id: Annotated[
