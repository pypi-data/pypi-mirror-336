...
class AccountingProfitAndLossOneGlobals(BaseModel):
...
class AccountingProfitAndLossOneRequestTypedDict(TypedDict):
...
class AccountingProfitAndLossOneRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
