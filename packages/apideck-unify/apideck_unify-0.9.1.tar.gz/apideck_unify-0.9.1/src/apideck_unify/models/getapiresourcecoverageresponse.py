...
from .apiresourcecoverage import APIResourceCoverage, APIResourceCoverageTypedDict
...
class GetAPIResourceCoverageResponseTypedDict(TypedDict):
    r"""ApiResources"""
    ...
    data: APIResourceCoverageTypedDict
...
class GetAPIResourceCoverageResponse(BaseModel):
    ...
    def serialize_model(self, handler):
        optional_fields = ["_raw", "meta", "links"]
