...
class CrmOpportunitiesAllGlobals(BaseModel):
...
class CrmOpportunitiesAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[OpportunitiesFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[OpportunitiesSortTypedDict]
    r"""Apply sorting"""
...
class CrmOpportunitiesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
