...
class FileStorageFilesOneGlobalsTypedDict(TypedDict):
...
class FileStorageFilesOneGlobals(BaseModel):
...
class FileStorageFilesOneRequestTypedDict(TypedDict):
    id: str
...
class FileStorageFilesOneRequest(BaseModel):
    id: Annotated[
...
class FileStorageFilesOneResponseTypedDict(TypedDict):
...
class FileStorageFilesOneResponse(BaseModel):
