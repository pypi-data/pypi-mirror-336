...
class AccountingJournalEntriesAllGlobals(BaseModel):
...
class AccountingJournalEntriesAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[JournalEntriesFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[JournalEntriesSortTypedDict]
    r"""Apply sorting"""
...
class AccountingJournalEntriesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class AccountingJournalEntriesAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingJournalEntriesAllResponse]]
