...
class CrmNotesAllGlobals(BaseModel):
...
class CrmNotesAllRequestTypedDict(TypedDict):
...
class CrmNotesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class CrmNotesAllResponse(BaseModel):
    next: Callable[[], Optional[CrmNotesAllResponse]]
