...
class AccountingJournalEntriesOneGlobals(BaseModel):
...
class AccountingJournalEntriesOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingJournalEntriesOneRequest(BaseModel):
    id: Annotated[
