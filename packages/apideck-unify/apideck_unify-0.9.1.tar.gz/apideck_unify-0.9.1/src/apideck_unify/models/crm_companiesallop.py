...
class CrmCompaniesAllGlobalsTypedDict(TypedDict):
...
class CrmCompaniesAllGlobals(BaseModel):
...
class CrmCompaniesAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[CompaniesFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[CompaniesSortTypedDict]
    r"""Apply sorting"""
...
class CrmCompaniesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class CrmCompaniesAllResponse(BaseModel):
    next: Callable[[], Optional[CrmCompaniesAllResponse]]
