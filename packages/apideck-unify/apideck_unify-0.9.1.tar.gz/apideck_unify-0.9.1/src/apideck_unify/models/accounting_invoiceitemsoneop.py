...
from .invoiceitemfilter import InvoiceItemFilter, InvoiceItemFilterTypedDict
...
class AccountingInvoiceItemsOneGlobals(BaseModel):
...
class AccountingInvoiceItemsOneRequestTypedDict(TypedDict):
    id: str
    ...
    filter_: NotRequired[InvoiceItemFilterTypedDict]
    r"""Apply filters"""


class AccountingInvoiceItemsOneRequest(BaseModel):
    id: Annotated[
