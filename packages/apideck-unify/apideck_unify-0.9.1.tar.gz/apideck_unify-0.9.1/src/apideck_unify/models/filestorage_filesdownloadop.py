...
class FileStorageFilesDownloadGlobalsTypedDict(TypedDict):
...
class FileStorageFilesDownloadGlobals(BaseModel):
...
class FileStorageFilesDownloadResponse(BaseModel):
