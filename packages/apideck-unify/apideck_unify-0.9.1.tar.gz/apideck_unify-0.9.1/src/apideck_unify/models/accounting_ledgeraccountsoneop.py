...
class AccountingLedgerAccountsOneGlobals(BaseModel):
...
class AccountingLedgerAccountsOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingLedgerAccountsOneRequest(BaseModel):
    id: Annotated[
