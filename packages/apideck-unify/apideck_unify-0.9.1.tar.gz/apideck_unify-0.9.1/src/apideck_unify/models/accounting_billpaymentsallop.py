...
class AccountingBillPaymentsAllGlobals(BaseModel):
...
class AccountingBillPaymentsAllRequestTypedDict(TypedDict):
...
class AccountingBillPaymentsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
