...
class HrisTimeOffRequestsAllGlobals(BaseModel):
...
class HrisTimeOffRequestsAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[TimeOffRequestsFilterTypedDict]
    r"""Apply filters"""
...
class HrisTimeOffRequestsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
    ...
    filter_: Annotated[
        Optional[TimeOffRequestsFilter],
