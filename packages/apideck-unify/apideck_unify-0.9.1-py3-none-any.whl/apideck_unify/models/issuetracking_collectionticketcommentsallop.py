...
class IssueTrackingCollectionTicketCommentsAllGlobals(BaseModel):
...
class IssueTrackingCollectionTicketCommentsAllRequestTypedDict(TypedDict):
    collection_id: str
    r"""The collection ID"""
    ticket_id: str
    ...
    sort: NotRequired[CommentsSortTypedDict]
    r"""Apply sorting"""
...
class IssueTrackingCollectionTicketCommentsAllRequest(BaseModel):
