...
class AccountingTrackingCategoriesAllGlobals(BaseModel):
...
class AccountingTrackingCategoriesAllRequestTypedDict(TypedDict):
...
class AccountingTrackingCategoriesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
