...
class AccountingTrackingCategoriesOneGlobals(BaseModel):
...
class AccountingTrackingCategoriesOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingTrackingCategoriesOneRequest(BaseModel):
    id: Annotated[
