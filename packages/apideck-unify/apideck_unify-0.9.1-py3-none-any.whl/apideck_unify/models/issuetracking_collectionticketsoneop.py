...
class IssueTrackingCollectionTicketsOneGlobals(BaseModel):
...
class IssueTrackingCollectionTicketsOneRequestTypedDict(TypedDict):
    ticket_id: str
...
class IssueTrackingCollectionTicketsOneRequest(BaseModel):
    ticket_id: Annotated[
