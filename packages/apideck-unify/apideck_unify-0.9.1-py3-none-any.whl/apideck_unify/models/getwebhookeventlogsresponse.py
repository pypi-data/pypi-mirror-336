...
from .webhookeventlog import WebhookEventLog, WebhookEventLogTypedDict
...
class GetWebhookEventLogsResponseTypedDict(TypedDict):
    r"""EventLogs"""
    ...
    data: List[WebhookEventLogTypedDict]
