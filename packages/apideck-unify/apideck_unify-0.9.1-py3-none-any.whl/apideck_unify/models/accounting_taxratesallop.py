...
class AccountingTaxRatesAllGlobals(BaseModel):
...
class AccountingTaxRatesAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[TaxRatesFilterTypedDict]
    r"""Apply filters"""
...
class AccountingTaxRatesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
