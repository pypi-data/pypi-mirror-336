...
class EcommerceOrdersAllGlobals(BaseModel):
...
class EcommerceOrdersAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[EcommerceOrdersFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[OrdersSortTypedDict]
    r"""Apply sorting"""
...
class EcommerceOrdersAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
    ...
    filter_: Annotated[
        Optional[EcommerceOrdersFilter],
