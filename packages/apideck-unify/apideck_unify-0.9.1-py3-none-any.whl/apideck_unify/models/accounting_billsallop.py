...
from .billssort import BillsSort, BillsSortTypedDict
...
class AccountingBillsAllGlobalsTypedDict(TypedDict):
...
class AccountingBillsAllGlobals(BaseModel):
...
class AccountingBillsAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[BillsFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[BillsSortTypedDict]
    r"""Apply sorting"""
...
class AccountingBillsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class AccountingBillsAllResponseTypedDict(TypedDict):
    http_meta: HTTPMetadataTypedDict
    get_bills_response: NotRequired[GetBillsResponseTypedDict]
    r"""Bills"""
...
class AccountingBillsAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingBillsAllResponse]]

    http_meta: Annotated[Optional[HTTPMetadata], pydantic.Field(exclude=True)] = None

    get_bills_response: Optional[GetBillsResponse] = None
    r"""Bills"""
