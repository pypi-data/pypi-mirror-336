...
class AccountingInvoiceItemsAllGlobals(BaseModel):
...
class AccountingInvoiceItemsAllRequestTypedDict(TypedDict):
...
class AccountingInvoiceItemsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
