...
class FileStorageUploadSessionsOneGlobalsTypedDict(TypedDict):
...
class FileStorageUploadSessionsOneGlobals(BaseModel):
...
class FileStorageUploadSessionsOneRequestTypedDict(TypedDict):
    id: str
...
class FileStorageUploadSessionsOneRequest(BaseModel):
    id: Annotated[
