...
class AccountingBillPaymentsOneGlobals(BaseModel):
...
class AccountingBillPaymentsOneRequestTypedDict(TypedDict):
    id: str
...
class AccountingBillPaymentsOneRequest(BaseModel):
    id: Annotated[
