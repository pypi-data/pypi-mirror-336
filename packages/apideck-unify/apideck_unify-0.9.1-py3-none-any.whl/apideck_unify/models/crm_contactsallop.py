...
class CrmContactsAllGlobals(BaseModel):
...
class CrmContactsAllRequestTypedDict(TypedDict):
    ...
    r"""Apply filters"""
    sort: NotRequired[ContactsSortTypedDict]
    r"""Apply sorting"""
...
class CrmContactsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
