...
class AccountingPaymentsAllGlobals(BaseModel):
...
class AccountingPaymentsAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[PaymentsFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[PaymentsSortTypedDict]
    r"""Apply sorting"""
...
class AccountingPaymentsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class AccountingPaymentsAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingPaymentsAllResponse]]
