...
class IssueTrackingCollectionUsersAllGlobals(BaseModel):
...
class IssueTrackingCollectionUsersAllRequestTypedDict(TypedDict):
    collection_id: str
    r"""The collection ID"""
...
class IssueTrackingCollectionUsersAllRequest(BaseModel):
