...
from .creditnotessort import CreditNotesSort, CreditNotesSortTypedDict
...
class AccountingCreditNotesAllGlobals(BaseModel):
...
class AccountingCreditNotesAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[CreditNotesFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[CreditNotesSortTypedDict]
    r"""Apply sorting"""
...
class AccountingCreditNotesAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
