...
from .collectionssort import CollectionsSort, CollectionsSortTypedDict
...
class IssueTrackingCollectionsAllGlobals(BaseModel):
...
class IssueTrackingCollectionsAllRequestTypedDict(TypedDict):
    ...
    sort: NotRequired[CollectionsSortTypedDict]
    r"""Apply sorting"""
...
class IssueTrackingCollectionsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
