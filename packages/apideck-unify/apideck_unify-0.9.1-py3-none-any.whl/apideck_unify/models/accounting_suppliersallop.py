...
class AccountingSuppliersAllGlobals(BaseModel):
...
class AccountingSuppliersAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[SuppliersFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[SuppliersSortTypedDict]
    r"""Apply sorting"""
...
class AccountingSuppliersAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
...
class AccountingSuppliersAllResponse(BaseModel):
    next: Callable[[], Optional[AccountingSuppliersAllResponse]]
