...
class AccountingAgedDebtorsOneGlobals(BaseModel):
...
class AccountingAgedDebtorsOneRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[AgedReportFilterTypedDict]
    r"""Apply filters"""
...
class AccountingAgedDebtorsOneRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
