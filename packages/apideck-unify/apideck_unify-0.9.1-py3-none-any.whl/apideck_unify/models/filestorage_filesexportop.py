...
class FileStorageFilesExportGlobalsTypedDict(TypedDict):
...
class FileStorageFilesExportGlobals(BaseModel):
...
class FileStorageFilesExportRequest(BaseModel):
    id: Annotated[
...
class FileStorageFilesExportResponse(BaseModel):
