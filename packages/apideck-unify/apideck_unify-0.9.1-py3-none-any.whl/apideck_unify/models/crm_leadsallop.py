...
class CrmLeadsAllGlobals(BaseModel):
...
class CrmLeadsAllRequestTypedDict(TypedDict):
    ...
    filter_: NotRequired[LeadsFilterTypedDict]
    r"""Apply filters"""
    sort: NotRequired[LeadsSortTypedDict]
    r"""Apply sorting"""
...
class CrmLeadsAllRequest(BaseModel):
    raw: Annotated[
        Optional[bool],
