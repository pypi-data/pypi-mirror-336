...
from .accountingdepartment import AccountingDepartment, AccountingDepartmentTypedDict
...
class GetAccountingDepartmentsResponseTypedDict(TypedDict):
    r"""Departments"""
    ...
    data: List[AccountingDepartmentTypedDict]
...
class GetAccountingDepartmentsResponse(BaseModel):
    r"""Departments"""
    ...
    data: List[AccountingDepartment]
