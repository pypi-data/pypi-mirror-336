...
class FileStorageFoldersCopyGlobals(BaseModel):
...
class FileStorageFoldersCopyRequestTypedDict(TypedDict):
    id: str
    r"""ID of the record you are acting upon."""
    copy_folder_request: CopyFolderRequestTypedDict
    consumer_id: NotRequired[str]
    r"""ID of the consumer which you want to get or push data from"""
    app_id: NotRequired[str]
    r"""The ID of your Unify application"""
...
class FileStorageFoldersCopyRequest(BaseModel):
    id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]
    r"""ID of the record you are acting upon."""

    copy_folder_request: Annotated[
        CopyFolderRequest,
