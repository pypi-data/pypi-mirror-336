...
class Vectocore:
    ...
    def extream_search(self, question: str, index_name="", max_count=10, mode="VECTOR", find_index_prompt="", doc_only=False):
        params = {
...
class Lens:
    ...
    def chat(self, question, stream=False, index_name=None, custom_data=None, model=None, text_only_ref=False):
    ...
    def chat_with_status(self, question, stream=False, index_name=None, custom_data=None, model=None, text_only_ref=False):
        params = {"command": "lensChatWithStatus", "question": question, "numOfRef": self.num_of_ref}
        if self.role is not None:
            params["role"] = self.role
        if self.rule is not None:
            params["rule"] = self.rule
