...
class CLIWrapper(CLIWrapperBase):
    ...
    def init_storage_node__deploy(self, subparser):
        ...
        argument = subcommand.add_argument('--isolate-cores', help='Isolate cores in kernel args for provided cpu mask', dest='isolate_cores', required=False, action='store_true')
