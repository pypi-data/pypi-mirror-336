...
class HTTPHandler[T: HTTPResponseDirective](BaseHandler, ABC):
    ...
    def convert_type(self, value: Any, annotation: Type, parameters: dict[str, Any] | None = None) -> Any:
        if isinstance(value, Morsel):
            if annotation == Morsel:
                return value
            else:
                return super().convert_type(value.value, annotation, parameters)

        return super().convert_type(value, annotation, parameters)
