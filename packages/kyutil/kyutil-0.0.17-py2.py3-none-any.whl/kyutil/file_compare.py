...
from .iso_utils import get_diff
from .reg_exp import LORAX_LOG_PKG
from .repo import IsoRepo
from .config import ROOT_PATH_TMP, REPODATA_PATH, DOWNLOAD_ROOT_PATH
    ...
    for i in range(2):
        ...
        for _ in lines:
            if _.endswith("rpm"):
                continue
            file_hash = _.split("  ")
            hashs[i][os.path.relpath(file_hash[-1], mount_dirs[i])] = file_hash[0]
    return hashs
