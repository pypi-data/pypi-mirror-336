...
class device_array(base_array):
    ...
    @staticmethod
    def for_device(device: _shortfin_tracy.lib.local.ScopedDevice, shape: Sequence[int], dtype: DType) -> object: ...

    @staticmethod
    def for_host(device: _shortfin_tracy.lib.local.ScopedDevice, shape: Sequence[int], dtype: DType) -> object: ...

    def for_transfer(self) -> object: ...

    @property
    def device(self) -> _shortfin_tracy.lib.local.ScopedDevice: ...
...
class storage:
    ...
    @staticmethod
    def allocate_host(device: _shortfin_tracy.lib.local.ScopedDevice, allocation_size: int) -> storage: ...

    @staticmethod
    def allocate_device(device: _shortfin_tracy.lib.local.ScopedDevice, allocation_size: int) -> storage: ...
