  ...
  constructor(props: AppProps) {
    ...
    if ('selectedVariable' in this.chartTemplate) {
      ...
      for (const key in this.chartTemplate['selectedVariable']) {
        const keyWithRoot = `${this.props.systemConfig['root_name']}.${key}`;
        if (props.variableData?.[keyWithRoot]?.value) {
          selectedVariable[keyWithRoot] = props.variableData[keyWithRoot].value;
        } else {
          selectedVariable[keyWithRoot] =
