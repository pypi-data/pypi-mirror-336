...
def generate_shell_command(user_command, gemini_api_key, gemini_model_config):
    ...
    " Assume the username is 'Subhan' and explicitly replace all occurrences of %USERPROFILE% or %APPDATA% with 'C:\\Users\\Subhan\\'."
    ...
    " Otherwise, commands should run from the user's directory, assumed to be 'C:\\Users\\Subhan\\'."
