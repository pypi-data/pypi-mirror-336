...
from .utils.env_state import is_envvar_false, get_app_setting
...
class HttpV2Registry:
    ...
    def _check_http_v2_enabled(cls):
        logger.info("VICTORIA -- inside _check_http_v2_enabled. Python minor version: %s, env var status: %s", sys.version_info.minor, get_app_setting(PYTHON_ENABLE_INIT_INDEXING))
        ...
        logger.info("VICTORIA -- extension base module imported: %s. http_v2_enabled: %s", cls._ext_base, cls._ext_base.HttpV2FeatureChecker.http_v2_enabled())
