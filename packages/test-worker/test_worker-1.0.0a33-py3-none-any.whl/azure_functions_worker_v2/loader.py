...
@attach_message_to_exception(
    ...
    message="Cannot find module. Please check the requirements.txt file for the missing module. For more info, please refer the troubleshooting guide: {}. Current sys.path: {}".format(MODULE_NOT_FOUND_TS_URL, sys.path),
    debug_logs="Error in index_function_app. Sys Path: {}, Sys Module: {}, python-packages Path exists: {}".format(sys.path, sys.modules, os.path.exists(CUSTOMER_PACKAGES_PATH)))
