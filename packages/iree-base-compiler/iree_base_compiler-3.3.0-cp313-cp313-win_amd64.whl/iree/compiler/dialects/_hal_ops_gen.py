...
def command_buffer_copy_buffer(command_buffer, source_buffer, source_offset, target_buffer, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return CommandBufferCopyBufferOp(command_buffer=command_buffer, source_buffer=source_buffer, source_offset=source_offset, target_buffer=target_buffer, target_offset=target_offset, length=length, loc=loc, ip=ip)
...
def command_buffer_fill_buffer(command_buffer, target_buffer, target_offset, length, pattern, *, loc=None, ip=None) -> _ods_ir.Operation:
  return CommandBufferFillBufferOp(command_buffer=command_buffer, target_buffer=target_buffer, target_offset=target_offset, length=length, pattern=pattern, loc=loc, ip=ip)
...
class CommandBufferUpdateBufferOp(_ods_ir.OpView):
  ...
  def __init__(self, command_buffer, source_buffer, source_size, source_offset, target_buffer, target_offset, length, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def command_buffer_update_buffer(command_buffer, source_buffer, source_size, source_offset, target_buffer, target_offset, length, *, loc=None, ip=None) -> _ods_ir.Operation:
  return CommandBufferUpdateBufferOp(command_buffer=command_buffer, source_buffer=source_buffer, source_size=source_size, source_offset=source_offset, target_buffer=target_buffer, target_offset=target_offset, length=length, loc=loc, ip=ip)
...
class DeviceQueueAllocaOp(_ods_ir.OpView):
  ...
  def __init__(self, device, queue_affinity, wait_fence, signal_fence, pool, memory_types, buffer_usage, result_size, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def device_queue_alloca(device, queue_affinity, wait_fence, signal_fence, pool, memory_types, buffer_usage, result_size, *, loc=None, ip=None) -> _ods_ir.Value:
  return DeviceQueueAllocaOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, pool=pool, memory_types=memory_types, buffer_usage=buffer_usage, result_size=result_size, loc=loc, ip=ip).result
...
class DeviceQueueCopyOp(_ods_ir.OpView):
  ...
  def __init__(self, device, queue_affinity, wait_fence, signal_fence, source_buffer, source_offset, target_buffer, target_offset, length, flags, *, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('I64Attr')) else
      _ods_ir.AttrBuilder.get('I64Attr')(flags, context=_ods_context))
    _ods_successors = None
    super().__init__(self.OPERATION_NAME, self._ODS_REGIONS, self._ODS_OPERAND_SEGMENTS, self._ODS_RESULT_SEGMENTS, attributes=attributes, results=results, operands=operands, successors=_ods_successors, regions=regions, loc=loc, ip=ip)
...
def device_queue_dealloca(device, queue_affinity, wait_fence, signal_fence, buffer, *, loc=None, ip=None) -> _ods_ir.Operation:
  return DeviceQueueDeallocaOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, buffer=buffer, loc=loc, ip=ip)
...
class DeviceQueueExecuteIndirectOp(_ods_ir.OpView):
  ...
  def __init__(self, device, queue_affinity, wait_fence, signal_fence, command_buffer, binding_buffers, binding_offsets, binding_lengths, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def device_queue_execute_indirect(device, queue_affinity, wait_fence, signal_fence, command_buffer, binding_buffers, binding_offsets, binding_lengths, *, loc=None, ip=None) -> _ods_ir.Operation:
  return DeviceQueueExecuteIndirectOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, command_buffer=command_buffer, binding_buffers=binding_buffers, binding_offsets=binding_offsets, binding_lengths=binding_lengths, loc=loc, ip=ip)
...
def device_queue_execute(device, queue_affinity, wait_fence, signal_fence, command_buffers, *, loc=None, ip=None) -> _ods_ir.Operation:
  return DeviceQueueExecuteOp(device=device, queue_affinity=queue_affinity, wait_fence=wait_fence, signal_fence=signal_fence, command_buffers=command_buffers, loc=loc, ip=ip)
...
class ExecutableConditionOp(_ods_ir.OpView):
  ...
  def __init__(self, function_type, *, arg_attrs=None, res_attrs=None, loc=None, ip=None):
    ...
    not _ods_ir.AttrBuilder.contains('anonymous_857')) else
      _ods_ir.AttrBuilder.get('anonymous_857')(function_type, context=_ods_context))
...
class ExecutableCreateOp(_ods_ir.OpView):
  ...
  def __init__(self, device, executable_target, constants, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def executable_create(device, executable_target, constants, *, loc=None, ip=None) -> _ods_ir.Value:
  return ExecutableCreateOp(device=device, executable_target=executable_target, constants=constants, loc=loc, ip=ip).result
...
class FenceAwaitOp(_ods_ir.OpView):
  ...
  def __init__(self, timeout_millis, fences, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def fence_await(timeout_millis, fences, *, loc=None, ip=None) -> _ods_ir.Value:
  return FenceAwaitOp(timeout_millis=timeout_millis, fences=fences, loc=loc, ip=ip).result
...
class FenceJoinOp(_ods_ir.OpView):
  ...
  def __init__(self, fences, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def fence_join(fences, *, loc=None, ip=None) -> _ods_ir.Value:
  return FenceJoinOp(fences=fences, loc=loc, ip=ip).result
...
class TensorImportOp(_ods_ir.OpView):
  ...
  def __init__(self, target, source, target_encoding, target_dims, *, wait_fence=None, name=None, affinity=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def tensor_import(target, source, target_encoding, target_dims, *, wait_fence=None, name=None, affinity=None, loc=None, ip=None) -> _ods_ir.Value:
  return TensorImportOp(target=target, source=source, target_encoding=target_encoding, target_dims=target_dims, wait_fence=wait_fence, name=name, affinity=affinity, loc=loc, ip=ip).result
