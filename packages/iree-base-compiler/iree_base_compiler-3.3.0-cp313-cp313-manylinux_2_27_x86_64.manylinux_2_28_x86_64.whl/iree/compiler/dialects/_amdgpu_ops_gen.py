...
class DPPOp(_ods_ir.OpView):
  ...
  def __init__(self, old, src, kind, *, permArgument=None, row_mask=None, bank_mask=None, bound_ctrl=None, loc=None, ip=None):
    ...
    if permArgument is not None: attributes["permArgument"] = (permArgument if (
        ...
        not _ods_ir.AttrBuilder.contains('anonymous_488')) else
          _ods_ir.AttrBuilder.get('anonymous_488')(permArgument, context=_ods_context))
...
def ext_packed_fp8(source, index, *, loc=None, ip=None) -> _ods_ir.Value:
  return ExtPackedFp8Op(source=source, index=index, loc=loc, ip=ip).result
