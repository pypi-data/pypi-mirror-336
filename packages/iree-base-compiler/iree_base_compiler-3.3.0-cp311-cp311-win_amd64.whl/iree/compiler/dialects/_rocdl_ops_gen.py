...
@_ods_cext.register_operation(_Dialect)
class CvtScale32PkF32Bf8(_ods_ir.OpView):
...
def cvt_scalef32_pk_f32_bf8(res, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScale32PkF32Bf8(res=res, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScale32PkF32Fp8(_ods_ir.OpView):
...
def cvt_scalef32_pk_f32_fp8(res, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScale32PkF32Fp8(res=res, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF16Bf8(_ods_ir.OpView):
...
def cvt_scalef32_f16_bf8(res, old, src, scale, byte_sel, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF16Bf8(res=res, old=old, src=src, scale=scale, byteSel=byte_sel, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF16Fp8(_ods_ir.OpView):
...
def cvt_scalef32_f16_fp8(res, old, src, scale, byte_sel, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF16Fp8(res=res, old=old, src=src, scale=scale, byteSel=byte_sel, wordSel=word_sel, loc=loc, ip=ip).result
...
@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkBf8Bf16(_ods_ir.OpView):
...
def cvt_scalef32_pk_bf8_bf16(res, old, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkBf8Bf16(res=res, old=old, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkBf8F16(_ods_ir.OpView):
...
def cvt_scalef32_pk_bf8_f16(res, old, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkBf8F16(res=res, old=old, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkBf8F32(_ods_ir.OpView):
...
def cvt_scalef32_pk_bf8_f32(res, old, src_a, src_b, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkBf8F32(res=res, old=old, srcA=src_a, srcB=src_b, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkF16Bf8(_ods_ir.OpView):
...
def cvt_scalef32_pk_f16_bf8(res, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkF16Bf8(res=res, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkF16Fp8(_ods_ir.OpView):
...
def cvt_scalef32_pk_f16_fp8(res, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkF16Fp8(res=res, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkFp8Bf16(_ods_ir.OpView):
...
def cvt_scalef32_pk_fp8_bf16(res, old, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkFp8Bf16(res=res, old=old, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkFp8F16(_ods_ir.OpView):
...
def cvt_scalef32_pk_fp8_f16(res, old, src, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkFp8F16(res=res, old=old, src=src, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32PkFp8F32(_ods_ir.OpView):
...
def cvt_scalef32_pk_fp8_f32(res, old, src_a, src_b, scale, word_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32PkFp8F32(res=res, old=old, srcA=src_a, srcB=src_b, scale=scale, wordSel=word_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32SrBf8Bf16(_ods_ir.OpView):
...
def cvt_scalef32_sr_bf8_bf16(res, old, src, seed, scale, byte_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32SrBf8Bf16(res=res, old=old, src=src, seed=seed, scale=scale, byteSel=byte_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32SrBf8F16(_ods_ir.OpView):
...
def cvt_scalef32_sr_bf8_f16(res, old, src, seed, scale, byte_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32SrBf8F16(res=res, old=old, src=src, seed=seed, scale=scale, byteSel=byte_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32SrBf8F32(_ods_ir.OpView):
...
def cvt_scalef32_sr_bf8_f32(res, old, src, seed, scale, byte_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32SrBf8F32(res=res, old=old, src=src, seed=seed, scale=scale, byteSel=byte_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32SrFp8Bf16(_ods_ir.OpView):
...
def cvt_scalef32_sr_fp8_bf16(res, old, src, seed, scale, byte_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32SrFp8Bf16(res=res, old=old, src=src, seed=seed, scale=scale, byteSel=byte_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32SrFp8F16(_ods_ir.OpView):
...
def cvt_scalef32_sr_fp8_f16(res, old, src, seed, scale, byte_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32SrFp8F16(res=res, old=old, src=src, seed=seed, scale=scale, byteSel=byte_sel, loc=loc, ip=ip).result

@_ods_cext.register_operation(_Dialect)
class CvtScaleF32SrFp8F32(_ods_ir.OpView):
...
def cvt_scalef32_sr_fp8_f32(res, old, src, seed, scale, byte_sel, *, loc=None, ip=None) -> _ods_ir.Value:
  return CvtScaleF32SrFp8F32(res=res, old=old, src=src, seed=seed, scale=scale, byteSel=byte_sel, loc=loc, ip=ip).result
...
class GlobalLoadLDSOp(_ods_ir.OpView):
  ...
  def __init__(self, globalPtr, ldsPtr, size, offset, aux, *, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
def global_load_lds(global_ptr, lds_ptr, size, offset, aux, *, loc=None, ip=None) -> _ods_ir.Operation:
  return GlobalLoadLDSOp(globalPtr=global_ptr, ldsPtr=lds_ptr, size=size, offset=offset, aux=aux, loc=loc, ip=ip)
...
def ds_read_tr4_b64(res, ptr, *, loc=None, ip=None) -> _ods_ir.Value:
  return ds_read_tr4_b64(res=res, ptr=ptr, loc=loc, ip=ip).result
...
def ds_read_tr6_b96(res, ptr, *, loc=None, ip=None) -> _ods_ir.Value:
  return ds_read_tr6_b96(res=res, ptr=ptr, loc=loc, ip=ip).result
...
def ds_read_tr8_b64(res, ptr, *, loc=None, ip=None) -> _ods_ir.Value:
  return ds_read_tr8_b64(res=res, ptr=ptr, loc=loc, ip=ip).result
...
def ds_read_tr16_b64(res, ptr, *, loc=None, ip=None) -> _ods_ir.Value:
  return ds_read_tr16_b64(res=res, ptr=ptr, loc=loc, ip=ip).result
...
def mfma_f32_16x16x32_bf16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_f32_16x16x32_f16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_f32_32x32x16_bf16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_f32_32x32x16_f16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_i32_16x16x64_i8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_i32_32x32x32_i8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_scale_f32_16x16x128_f8f6f4(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def mfma_scale_f32_32x32x64_f8f6f4(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_16x16x32_bf16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_16x16x32_f16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_16x16x64_bf8_bf8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_16x16x64_bf8_fp8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_16x16x64_fp8_bf8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_16x16x64_fp8_fp8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_32x32x16_bf16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_32x32x16_f16(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_32x32x32_bf8_bf8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_32x32x32_bf8_fp8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_32x32x32_fp8_bf8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_f32_32x32x32_fp8_fp8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_i32_16x16x64_i8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def smfmac_i32_32x32x32_i8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def wmma_f32_16x16x16_bf8_fp8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def wmma_f32_16x16x16_fp8_bf8(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
...
def wmma_i32_16x16x32_iu4(res, args, *, loc=None, ip=None) -> _ods_ir.Value:
