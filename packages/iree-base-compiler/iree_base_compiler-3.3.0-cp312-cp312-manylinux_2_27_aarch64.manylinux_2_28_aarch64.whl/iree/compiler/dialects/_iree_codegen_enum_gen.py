...
class DispatchLoweringPassPipeline(IntEnum):
    ...
    LLVMGPUPackUnPack = 107
    LLVMGPUMatmulTensorCoreMmaSync = 108
    LLVMGPUVectorDistribute = 109
    LLVMGPUPadAndVectorDistribute = 110
    LLVMGPUWinogradVectorize = 111
    ...
    def __str__(self):
        ...
        if self is DispatchLoweringPassPipeline.LLVMGPUMatmulTensorCore:
            return "LLVMGPUMatmulTensorCore"
        if self is DispatchLoweringPassPipeline.LLVMGPUTransposeSharedMem:
            return "LLVMGPUTransposeSharedMem"
        if self is DispatchLoweringPassPipeline.LLVMGPUWarpReduction:
            return "LLVMGPUWarpReduction"
        if self is DispatchLoweringPassPipeline.LLVMGPUPackUnPack:
            return "LLVMGPUPackUnPack"
        if self is DispatchLoweringPassPipeline.LLVMGPUMatmulTensorCoreMmaSync:
            return "LLVMGPUMatmulTensorCoreMmaSync"
        if self is DispatchLoweringPassPipeline.LLVMGPUVectorDistribute:
            return "LLVMGPUVectorDistribute"
        if self is DispatchLoweringPassPipeline.LLVMGPUPadAndVectorDistribute:
            return "LLVMGPUPadAndVectorDistribute"
