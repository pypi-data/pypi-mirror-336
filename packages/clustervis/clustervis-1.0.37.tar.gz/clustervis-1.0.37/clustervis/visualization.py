...
def show_ensemble_classifier_plot(X, ensembleClassifier, colors, resolution, plotTitle, plotPath=None, filename=""):
    """
...
def show_base_classifier_plot(X, baseClassifier, colors, resolution, plotTitle, plotPath=None, filename=""):
    """
