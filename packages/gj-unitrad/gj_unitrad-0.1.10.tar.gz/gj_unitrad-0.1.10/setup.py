...
setup(
    ...
    author='yin',  # 作者姓名
    author_email='248024802@qq.com',  # 作者邮箱
    packages=find_packages(),  # 自动查找包目录
    python_requires='>3.9',  # python版本要求
    install_requires=['python-yaml', 'pandas', 'setuptools', 'aiohttp', 'matplotlib', 'requests', 'PIL'],  # 依赖库列表 (除开python自带的包外的其他依赖库(代码中如果缺少了对应的库会导致无法运行的包))
)
