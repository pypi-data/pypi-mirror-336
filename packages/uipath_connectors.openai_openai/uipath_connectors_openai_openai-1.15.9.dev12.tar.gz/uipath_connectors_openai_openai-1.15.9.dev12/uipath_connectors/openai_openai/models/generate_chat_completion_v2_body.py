...
class GenerateChatCompletionV2Body(BaseModel):
    """
    Attributes:
        body (GenerateChatCompletionV2Request):
        file (Optional[File]): Image file to be used for the completion request.
    """

    model_config = ConfigDict(extra="allow", populate_by_name=True)

    body: "GenerateChatCompletionV2Request" = Field(alias="body")
    ...
    @classmethod
    def from_dict(cls: Type["GenerateChatCompletionV2Body"], src_dict: Dict[str, Any]):
