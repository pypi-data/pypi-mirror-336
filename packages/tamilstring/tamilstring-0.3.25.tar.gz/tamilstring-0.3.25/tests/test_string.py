...
class TestBaseWord(unittest.TestCase):
    ...
    def test_add_obj(self):
        self.assertEqual("மெய்ம்மயக்கம", (String("மெய்ம்மயக்கம்",obj=True) + "அ").string ) 
        self.assertEqual("மெய்ம்மயக்கம", (String("மெய்ம்மயக்கம்",obj=True) + String("அ")).string )
        self.assertEqual("மெய்ம்மயக்கம்", (String("மெய்ம்ம்",obj=True) + "அயக்கம்").string )
        self.assertEqual("மெய்ம்மயக்கம்", (String("மெய்ம்ம்",obj=True) + String("அயக்கம்")).string )
        self.assertEqual("மெய்ம்மயக்கம்", (String("மெய்ம்",obj=True) + "மயக்கம்").string )
        self.assertEqual("மெய்ம்மயக்கம்", (String("மெய்ம்",obj=True) + String("மயக்கம்")).string )
    
    def test_subraction_single_letter(self):        
        self.assertEqual("மெய்ம்மயக்கம்", (String("மெய்ம்மயக்கம",obj=True) - "அ").string )
        self.assertEqual("மெய்ம்மயக்கம்", (String("மெய்ம்மயக்கம",obj=True) - Letter("அ")).string )
        self.assertEqual("மெய்ம்மயக்கஅ", (String("மெய்ம்மயக்கம",obj=True) - "ம்").string )
        self.assertEqual("மெய்ம்மயக்கஅ", (String("மெய்ம்மயக்கம",obj=True) - Letter("ம்")).string )
    ...
    #print(String("யென்னயென்னவேண்டும்").has_contain("என்ன"))
