...
class WatermarkResult:
    ...
    @overload
    def __init__(self, source_document_size : int, processing_time : TimeSpan, final_document_size : int, number_watermarks_applied : int) -> None:
        raise NotImplementedError()
    ...
    @property
    def processing_time(self) -> TimeSpan:
