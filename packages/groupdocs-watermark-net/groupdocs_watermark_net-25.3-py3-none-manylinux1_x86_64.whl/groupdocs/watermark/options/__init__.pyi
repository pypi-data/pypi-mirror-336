...
class LoadOptions:
    ...
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`groupdocs.watermark.options.LoadOptions` class.'''
        raise NotImplementedError()
    
    @overload
    def __init__(self, password : str) -> None:
        '''Initializes a new instance of the :py:class:`groupdocs.watermark.options.LoadOptions` class with a specified password.
    ...
    @property
    def format_family(self) -> Optional[groupdocs.watermark.common.FormatFamily]:
        '''Gets the format family of the document,
        indicating its type (e.g., Image, Pdf, Spreadsheet, etc.).'''
        raise NotImplementedError()
    
    @format_family.setter
    def format_family(self, value : Optional[groupdocs.watermark.common.FormatFamily]) -> None:
    ...
    @property
    def default(self) -> groupdocs.watermark.options.LoadOptions:
        '''Gets the default value for :py:class:`groupdocs.watermark.options.LoadOptions` class.'''
        raise NotImplementedError()


class OoxmlLoadOptions(LoadOptions):
    '''Represents document loading options for a OOXML document.'''
    
    @overload
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`groupdocs.watermark.options.OoxmlLoadOptions` class.'''
        raise NotImplementedError()
    
    @overload
    def __init__(self, password : str) -> None:
        '''Initializes a new instance of the :py:class:`groupdocs.watermark.options.OoxmlLoadOptions` class with a specified password.
    ...
    @property
    def DEFAULT(self) -> groupdocs.watermark.options.OoxmlLoadOptions:
        '''Gets the default value for :py:class:`groupdocs.watermark.options.LoadOptions` class.'''
        raise NotImplementedError()
...
class SaveOptions:
    ...
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`groupdocs.watermark.options.SaveOptions` class.'''
        raise NotImplementedError()
    
    @property
    def default(self) -> groupdocs.watermark.options.SaveOptions:
        '''Gets the default value for the :py:class:`groupdocs.watermark.options.SaveOptions` class.'''
        raise NotImplementedError()
...
class WatermarkOptions:
    ...
    def __init__(self) -> None:
        '''Initializes a new instance of the :py:class:`groupdocs.watermark.options.WatermarkOptions` class.'''
        raise NotImplementedError()
