...
class PagesSetup:
    ...
    @overload
    def __init__(self, all_pages : bool, first_page : bool, last_page : bool, odd_pages : bool, even_pages : bool, pages : List[int], page_number : Optional[int]) -> None:
        raise NotImplementedError()
    ...
    @page_number.setter
    def page_number(self, value : Optional[int]) -> None:
