...
from uni_model.model.uni_layer import UniLayerBase, DeprecatedUniLayer
from uni_model.utils.immute import immute


@dataclass(frozen=True)
class _UniLayerBaseMatMulBias(UniLayerBase):
	pass


@dataclass(frozen=True)
class UniLayerMatMulBias(DeprecatedUniLayer, _UniLayerBaseMatMulBias):
	op: ClassVar = "MatMulBias"
	_valid_input_range: ClassVar = range(3, 4)
	input_names: ClassVar = ["a", "b", "bias"]
	output_names: ClassVar = [""]
	suggestion: ClassVar = "UniLayerFullyConnected"
