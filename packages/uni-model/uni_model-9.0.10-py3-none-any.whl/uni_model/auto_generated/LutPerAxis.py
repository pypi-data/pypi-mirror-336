...
class LutPerAxis(Lut, Qtype, Dtype):
	...
	def __eq__(self, other):
		if self.value_n_bits != other.value_n_bits or not np.allclose(self.table, other.table) or self.table_n_bits != other.table_n_bits or self.axis != other.axis or self.min_maxes != other.min_maxes:
			return False
		return True

	def __hash__(self):
		return hash((self.value_n_bits, tuple(np.array(self.table, dtype='float32')), self.table_n_bits, self.axis, tuple(self.min_maxes)))
