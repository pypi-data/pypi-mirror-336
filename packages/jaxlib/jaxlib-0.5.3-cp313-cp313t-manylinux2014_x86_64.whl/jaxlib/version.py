...
_release_version: str = '0.5.3'

# The following line is overwritten by build scripts in distributions &
# releases. Do not modify this manually, or jax/jaxlib build will fail.
_git_hash: str = 'ed43119a86069a777a4e0c045c90bbbbe7accccd'
...
def _write_version(fname: str) -> None:
  ...
  old_version_string = "_release_version: str = '0.5.3'"
  ...
  if githash:
    old_githash_string = "_git_hash: str = 'ed43119a86069a777a4e0c045c90bbbbe7accccd'"
