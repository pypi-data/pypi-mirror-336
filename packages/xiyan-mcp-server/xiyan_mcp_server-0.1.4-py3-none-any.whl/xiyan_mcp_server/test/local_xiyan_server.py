...
use_q=False
if use_q:
    model_path = "/Users/luozhiling/models/xyan3bq/XiYanSQL-QwenCoder-3B-2502.Q4_K_S.gguf"
    model_name = '/'
    local_model = AutoModelForCausalLM.from_pretrained(model_name,gguf_file=model_path, device_map='cpu', torch_dtype=torch.float32)
    local_tokenizer = AutoTokenizer.from_pretrained(model_name,gguf_file=model_path)
else:
