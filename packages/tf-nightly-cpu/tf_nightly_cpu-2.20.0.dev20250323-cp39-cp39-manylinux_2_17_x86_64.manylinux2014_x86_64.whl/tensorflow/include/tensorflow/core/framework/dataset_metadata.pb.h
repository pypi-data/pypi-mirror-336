...
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_tensorflow_2fcore_2fframework_2fdataset_5fmetadata_2eproto;
...
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_EXPORT ::tensorflow::data::Metadata* Arena::CreateMaybeMessage<::tensorflow::data::Metadata>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace tensorflow {
namespace data {
...
class PROTOBUF_EXPORT Metadata final :
