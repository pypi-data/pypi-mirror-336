...
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xla_2fpjrt_2fdistributed_2fprotocol_2eproto;
namespace xla {
...
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_EXPORT ::xla::DeviceAttributeProto* Arena::CreateMaybeMessage<::xla::DeviceAttributeProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::DeviceProto* Arena::CreateMaybeMessage<::xla::DeviceProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::DeviceProto_AttributesEntry_DoNotUse* Arena::CreateMaybeMessage<::xla::DeviceProto_AttributesEntry_DoNotUse>(Arena*);
template<> PROTOBUF_EXPORT ::xla::GlobalTopologyProto* Arena::CreateMaybeMessage<::xla::GlobalTopologyProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::IntValuesProto* Arena::CreateMaybeMessage<::xla::IntValuesProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::LocalTopologyProto* Arena::CreateMaybeMessage<::xla::LocalTopologyProto>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace xla {

// ===================================================================

class PROTOBUF_EXPORT IntValuesProto final :
...
class PROTOBUF_EXPORT DeviceAttributeProto final :
...
class PROTOBUF_EXPORT DeviceProto final :
...
class PROTOBUF_EXPORT LocalTopologyProto final :
...
class PROTOBUF_EXPORT GlobalTopologyProto final :
