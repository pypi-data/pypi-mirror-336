        ...
        try:
            if access_token:
                ...
                headers_model = Headers_PM(
                    **{
                        "correlationid": headers.get(
                            "correlationid", str(uuid.uuid4())
                        ),
                        "userid": payload.get("custom:userId", ""),
                        "organizationid": payload.get("custom:orgId", ""),
            ...
            if (
                ...
                headers_model = Headers_PM(
                    **dict(
                        ...
                        organizationid=headers.get("organizationid", "Oh My God"),
            ...
            return (
                False,
                dict(detail="Unauthorized: Missing or invalid credentials."),
                401,
            )

        except JwtValidationError as e:
            return False, dict(detail=str(e)), 401
        except ValidationError as e:
            return False, dict(detail=str(e)), 401
        except Exception as e:
            return False, dict(detail=str(e)), 500
        ...
        if exc_type is not None:
            ...
            relevant_traceback = next(
                (
                    ...
                    if EnvStore().service_name in trace.filename
                ),
                None,
            )
