...
class SyncSQSPusher:
    ...
    def __construct_message_body(
        ...
        message_context = ContextUtils.get_headers_details().model_dump(mode="json")
    ...
    def post_message_to_fifo_queue(
        self, message_group_id: str, message_deduplication_id: str
    ) -> None:
        try:
            if not self.queue_url.endswith(".fifo"):
                APP_LOGGER.warning(
