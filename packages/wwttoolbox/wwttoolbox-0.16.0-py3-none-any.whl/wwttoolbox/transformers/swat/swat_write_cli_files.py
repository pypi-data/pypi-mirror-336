...
class SWATWriteCliFiles:
    ...
    def write_tmp(self):
        """Write tmp.cli file"""
        self._write_cli_file("tmp", "tmp.cli: Temperature file names")

    def write_hmd(self):
        """Write hmd.cli file"""
        self._write_cli_file("hmd", "hmd.cli: Relative humidity file names")

    def write_slr(self):
        """Write slr.cli file"""
        self._write_cli_file("slr", "slr.cli: Solar radiation file names")

    def write_pcp(self):
        """Write pcp.cli file"""
        self._write_cli_file("pcp", "pcp.cli: Precipitation file names")

    def write_wnd(self):
        """Write wnd.cli file"""
        self._write_cli_file("wnd", "wnd.cli: Wind speed file names")

    def _write_cli_file(self, type: str, headline: str):
        ...
        file_path = Path(self.folder_path) / f"{type}.cli"
