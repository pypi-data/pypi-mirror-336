...
def add_table_styles(html_content):
    """
    Add Bootstrap styling to HTML tables in the report.
    
    Parameters
    ----------
    html_content : str
        HTML content containing tables to style
        
    Returns
    -------
    str
        HTML content with styled tables
    """
    # Add Bootstrap classes to tables
    styled_html = html_content.replace('<table>', '<table class="table table-striped table-hover table-sm">')
...
def generate_html_report(
    ...
    """
    from freamon.utils.matplotlib_fixes import optimize_base64_image, safe_process_dataframe, _make_analysis_results_safe, configure_matplotlib_for_currency
    ...
    if "feature_importance" in analysis_results:
        ...
        # Add the feature importance section to HTML parts
    ...
    if "multivariate" in analysis_results:
        ...
        # Add the multivariate section to HTML parts
    ...
    if "time_series" in analysis_results:
        ...
        # Add the time series section to HTML parts
