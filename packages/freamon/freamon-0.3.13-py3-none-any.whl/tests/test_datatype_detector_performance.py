...
class TestDataTypeDetectorEdgeCases:
    ...
    def test_mixed_type_columns(self):
        ...
        # Our improved date detection may now detect this as datetime, which is acceptable
    ...
    def test_datetime_edge_cases(self):
        ...
        if result['mixed_formats']['logical_type'] == 'datetime':
            # Field may be called 'suggested_conversion' or be directly in detection results
            ...
            elif 'semantic_type' in result['mixed_formats']:
                # Our newer code might set this differently
                assert result['mixed_formats']['semantic_type'] in ['mixed_date_formats', 'datetime', 'month_year_format']
